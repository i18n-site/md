...
| Nietzsche         | Filsafat Superman, criticizing moral tradisional jeung agama       |
| marx       | komunisme |
...
Di dunya basa program anu lega, `Rust` , `Python` , `JavaScript` sareng `Go` masing-masing nempatan tempat anu unik.

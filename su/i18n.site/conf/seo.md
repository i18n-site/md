...
Teras jieun skrip dina [EdgeJS edge](//console.bce.baidu.com/cdn/#/cdn/ejs/list) sapertos kieu
...
Kusabab `R2` `cloudflare` diakses ku ngaran domain ngaropéa, gudang objék pihak-katilu kudu dipaké pikeun nempatkeun file statik.

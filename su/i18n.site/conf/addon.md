...
`htmIndex.js` bakal disuntik nepi ka ahir `.i18n/htm/index.js` .
...
Runtime `js` anu diwangun dumasar kana pamekaran sekundér tina [boa](https://github.com/boa-dev/boa) sareng fungsi anu diwangun nyaéta kieu :

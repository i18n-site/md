...
`en/demo2/v` nyaéta nomer vérsi proyék ayeuna, anu bakal dipintonkeun di sisi katuhu nami proyék dina garis sisi sidebar.
...
Disarankeun pikeun ngan ukur ngarobih nomer vérsi dokumén nalika apdet utama dileupaskeun (sapertos `v1` , `v2` ) pikeun ngahindarkeun seueur teuing nomer versi anu nyababkeun kacau dina halaman anu diindeks ku mesin pencari.
...
`v` kosong moal dipintonkeun dina outline sidebar, tapi salami aya `v` file, hiji indéks bebas bakal dihasilkeun pikeun file dina diréktori na subdirectories.

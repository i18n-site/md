...
Sanajan browser geus diwangun-di tarjamah, mesin pencari tetep teu bisa query sakuliah basa.
...
## <a rel=id href="#project" id="project"></a> Pedaran Proyék
...
Tarjamahkeun `Markdown` jeung `YAML` kana alat baris paréntah ( [kode sumber](https://github.com/i18n-site/rust/tree/main/i18) ) dina sababaraha basa.

Bisa sampurna ngajaga format tina `Markdown` Bisa ngaidentipikasi modifikasi file sareng ngan ukur narjamahkeun file anu dirobih.
...
Kami ngabagi " `UNIX` nyaéta File " sareng tiasa ngatur tarjamahan dina ratusan basa tanpa ngenalkeun solusi tingkat perusahaan anu rumit sareng pajeulit.

Anjeun tiasa nganggo alat anu paling akrab pikeun `Markdown` tarjamahan (tapi anjeun teu tiasa nambihan atanapi ngahapus paragraf), sareng nganggo cara anu paling akrab pikeun ngalakukeun kontrol versi.

Dasar kode tiasa didamel salaku sumber terbuka pikeun file basa, sareng kalayan bantosan prosés `Pull Request` , pangguna global tiasa ilubiung dina optimasi tarjamahan anu terus-terusan. Sambungan mulus [github](//github.com) Sareng komunitas open source anu sanés.
...
Statik murni, dioptimalkeun pikeun pangalaman maca, sareng terpadu sareng tarjamahan tina [i18](#i18) éta mangrupikeun pilihan anu pangsaéna pikeun ngawangun situs dokumén proyék.
...
Website ieu dikembangkeun dumasar kana kerangka ieu sareng kalebet pangguna, pamayaran sareng fungsi anu sanés ( [kode sumber](/i18n.site/src) ).

[→ Pikeun pituduh pamaké, mangga baca dokuméntasi proyék](/i18n.site) .
...
Wilujeng nyiptakeun masa depan tanpa wates babarengan.

<h1 style="justify-content:space-between">3Ti.Site · Pamikiran Tanpa Batas<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

3Ti.Site, Tarjamahan Markdown + generator situs statik multi-basa.

Éta ngamungkinkeun anjeun gancang ngawangun dokumén sareng blog internasional anu ngadukung [ratusan basa](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

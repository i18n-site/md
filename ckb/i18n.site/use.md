...
دوای جێبەجێکردن، فایلەکانی وەرگێڕان و کاش دروست دەبن تکایە لەبیرت بێت `git add . ` بکەیت بۆ کۆگاکە لە ناوەڕۆکی `md` .
...
بۆ خۆهۆستکردنی ناوەڕۆک، جگە لە بەکارهێنانی سێرڤەری خۆت `CDN` بژاردەیەکی دیکەی باو بریتییە لە بەکارهێنانی `S3` +
...
پرۆژەیەک دروست بکە و کۆگای `i18n-demo.github.io` ی سەرەوە بەستەوە.
...
پاشان، هەڵگرتنی شتەکانی فرۆشیارانی هەور لە + بەکاربهێنە `CDN` ئەم ناوەڕۆکەی خوارەوە بڵاوبکەرەوە `out/ol/htm` .
...
لەبەر ئەوەی تۆماری `MX` و `CNAME` `CNAME` ناتوانن پێکەوە بژین، ئەگەر بتەوێت لە یەک کاتدا ئیمەیڵی ناوی دۆمەین وەربگریت، پێویستە هاوکاری لەگەڵ `A` [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten)
...
ناوی دۆمەینەکە لە [هەوری CDN](https://cdn.console.aliyun.com/domain/list) زیاد بکە و ناوی دۆمەینەکە `*.xxx.com` بۆ `CNAME` لە هەوری عەلیبابا `CDN` ئاماژە بکە !

...
دەستکاری `md/.i18n/htm/ol.yml` بکە و بەهای [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) بگۆڕە `YOUR_NPM_PACKAGE` وەک ناوی پاکێجی `npm` ی خۆت هەر ناوێکی پاکێج لەسەر [npmjs.com](//npmjs.com)

پاشان دەستکاری `md/.i18n/htm/ol.package.json` بکە

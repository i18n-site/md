...
زانیاری نووسەر دەتوانرێت لە میتا زانیاری وتارەکەدا بنووسرێت، وەک:
...
سەیری پڕۆژەی دیمۆی [`begin.md`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/blog/news/begin.md?plain=1) و [`author.yml`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/author.yml) بکە

...
پرۆفایلی `i18n.site` `.i18n/conf.yml` یە.

جگە لە ڕێکخستنەکانی [`i18`](/i18) و `ignore:` و `i18n:` ، فایلە ڕێکخستنەکە بەم شێوەیەی خوارەوەیە:
...
لە نێوانیاندا `i18n: home` هاوتایە لەگەڵ `home: Home` لە `en/i18n.yml` .

`en/i18n.yml` وەرگێڕدراوە بۆ چەند زمانێک، وەک `zh/i18n.yml` .
...
ئەگەر ڕێڕەوێکی دیاریکراو دەستی پێ بگات و پێشگرەکەی ڕێڕەوەکەی بە `nav:` ڕێک نەخرا، ئەوا پەڕگەی `MarkDown` کە هاوتایە لەگەڵ ڕێڕەوەکە بە شێوازی پێشوەختە باردەکرێت و بە بەکارهێنانی قاڵبی `Md` ڕەندەر دەکرێت.

بۆ نموونە ئەگەر `/test` دەستی پێ بگات، و `nav:` بەبێ ئەم ڕێڕەو ڕێکخرابێت، و زمانی لاپەڕەکە ئینگلیزی بێت (کۆدی `en` )، `/en/test.md` بە شێوازی پێشوەختە باردەکرێت و بە بەکارهێنانی قاڵبی `Md` ڕەندەر دەکرێت.
...
`blog` سەرەوە دۆخی تاکە بابەتی `Doc` ە.
...
شێوازی نووسینەکەی سەرەوە یەکسانە بە `url: blog` و فایلە هاوبەشەکەی `en/blog/TOC` یە.

#### چەندین پڕۆژە

ڕێکخستنی `i18n:doc` لە `.i18n/conf.yml` دۆخی فرە پڕۆژەیە.
...
`i18n.site` `js` پێوەکراو `.i18n/hook/after.tran/TOC.js` لە کۆگای دیمۆدا جێبەجێ دەکات بۆ خوێندنەوەی پەڕگەی ئیندێکسی `doc` بەڕێوەبەرایەتی کە هاوتایە لەگەڵ ڕێکخستنی `TOC` قاڵب بۆ دروستکردنی هێڵکاری بەڕێوەبەرایەتی `json` .

ئەگەر قاڵبی `doc` بەکاربهێنیت، پێویستە ئەم پێوەکراوەت هەبێت.

ئەگەر پڕۆژەی `i18n.site` لە فۆڵدەرێکی بەتاڵەوە دەستپێکرد، لەبیرت بێت کە پڕۆژەی دیمۆی `.i18n` کۆپی بکەیت بۆ ناوەڕۆکەکەت.

قاڵبی `Doc` هێڵکاری خشتەی ناوەڕۆک بە پشتبەستن بە `json` ی دروستکراو پیشان دەدات.
...
##### ئاستی دایک و باوک تەنها ناونیشانەکە دەنووسێت نەک ناوەڕۆکەکە.

کاتێک چەندین ئاستی ئیندێنتیشن هەبێت، ئاستی دایک و باوک تەنها ناونیشانەکە دەنووسێت و ناوەڕۆکەکە نانووسێت. ئەگەرنا تایپۆگرافی تێکدەچێت.
...
دەتوانن بزانن کە `Deme Two` تاگلاینی پڕۆژەکەی لە خوارەوەی مینیوی دابەزین و ناوی پڕۆژەی هێڵکاری کەتەلۆگ : `Your Project slogan`
...
بەکارهێنەرانی چین و ژاپۆن و کۆریا، تکایە ئاگاداربن کە پێویستە لەبری قۆڵۆنی نیو پانایی `:` بەکاربهێنن.

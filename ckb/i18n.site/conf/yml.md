...
`en/i18n.yml` وەرگێڕدراوە بۆ چەندین زمان، وەک `zh/i18n.yml` .
...
`TOC` فایلەکان ئیندەنت کراون بۆ ئاماژەدان بە پەیوەندی پلەبەندی هێڵکارییەکە و پشتگیری لە ئیندێنتکردنی فرە ئاست.

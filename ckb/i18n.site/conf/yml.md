...
### `use: Toc` , قاڵبی تاکە پەڕگە لەگەڵ هێڵکاری
...
### `use: Md` , قاڵبی تاکە پەڕگە بەبێ هێڵکاری
...
### `use: Doc` , قاڵبی بەڵگەنامەی فرە فایل
...
ئەگەر `url` نەنووسرا، `url` بە پێشوەختە بەهای `i18n` ئەم یاسایە بۆ قاڵبەکانی تریش کاری پێدەکرێت.

شێوازی نووسینەکەی سەرەوە یەکسانە بە `url: xxx` و فایلە هاوبەشەکەی `en/xxx/TOC` یە.

#### ئیندێکسی خشتەی ناوەڕۆکی TOC

`i18n.site` `js` پێوەکراو `.i18n/hook/after.tran/TOC.js` لە کۆگای دیمۆدا جێبەجێ دەکات بۆ خوێندنەوەی پەڕگەی ئیندێکسی `TOC` بەڕێوەبەرایەتی کە هاوتایە لەگەڵ ڕێکخستنی `doc` قاڵب بۆ دروستکردنی هێڵکاری بەڕێوەبەرایەتی `json` .

...
ئێمە [vscode](https://code.visualstudio.com/) بەکاردەهێنین بۆ نووسینی `MarkDown` , هەروەها پلاگینی [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) دادەنێین بۆ پێشبینیکردن لە کاتی ڕاستەقینەدا لەکاتی نووسیندا.

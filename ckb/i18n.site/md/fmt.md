...
## وێنە/ڤیدیۆ/لینک بە چەند زمانێک

دوای ئەوەی `MarkDown` دەگۆڕدرێت بۆ `HTML` , `$LANG` لە تایبەتمەندیەکانی `src` و `href` بە [کۆدی زمانی](/i18/LANG_CODE) ئێستا دەگۆڕدرێت .

بەم گۆڕاوە دەتوانیت فرە زمانەوانی وێنە/ڤیدیۆ/لینکەکان بەدەست بهێنیت.
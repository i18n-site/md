# تایبەتمەندی بەرهەمەکە

## وەرگێڕانی یەکگرتوو `i18`

بەرنامەکە وەرگێڕانی بنیات `i18` ، تکایە سەیری [➔ `i18`](/i18) بکە بۆ بەکارهێنانی تایبەت.
...
بە شێوازی `i18n.site` ، ناوەڕۆکی ماڵپەڕەکە بۆ `npmjs.com` بڵاودەکرێتەوە، بە یارمەتی [jsdelivr.com](//jsdelivr.com) ، [unpkg.com](//unpkg.com) و چەندین `CDN` ناوەڕۆک کە لەسەر `npm` .
...
بنەماکە `CDN` : داواکارییەکە بە یارمەتی [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
> واز لە ڕازاندنەوەی ناپێویست دەهێنێت و ناوەڕۆک بە پاکترین شێوەی خۆی دەخاتە ڕوو.
...
جنۆکەیەکی بچووکی نازدار لە پەیجەکەدا هەڵدەفڕێت، چاوەکانی لەگەڵ ماوسەکەدا دەجوڵێن، [➔ کلیک لێرە بکە بۆ بینین](/404) , `404`

## کۆدی سەرچاوە کراوە

[کۆدەکە سەرچاوە کراوە](/i18n.site/src) ئەگەر ئارەزووی بەشداریکردنت لە پەرەپێدان هەیە، تکایە خۆت بە [لیستی پۆستەکان](//groups.google.com/u/2/g/i18n-site) بناسێنە.

زۆر پێداویستی بچووک هەیە کە گرنگن بەڵام بەپەلە نین تیمی پەرەپێدان بەپێی ئەو تەکنەلۆژیایەی کە تۆ لێی باشیت ئەرکی مەشقکردنت بۆ دیاری دەکات، و بەڵگەنامەکانی پەرەپێدان باشتر دەکات لەکاتی تەرخانکردنی پێداویستییەکان.

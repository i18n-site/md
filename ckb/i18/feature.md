...
سەرنجەکانی وەرگێڕان پێویستە زمانەکە لە دوای ` ``` ` ئاماژە ` ```rust ` , وەک :
...
ئێمە نەوەیەکی نوێی تەکنەلۆژیای وەرگێڕانمان پەرەپێداوە کە سوودە تەکنیکییەکانی مۆدێلی وەرگێڕانی ئامێری تەقلیدی و مۆدێلی زمانی گەورە تێکەڵ دەکات بۆ ئەوەی وەرگێڕانەکان ورد و نەرم و ڕەنگین بن.
...
[کلیک لێرە بکە بۆ ڕێگەدان و بە شێوەیەکی ئۆتۆماتیکی i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) و **وەرگرتنی بۆنوس $50** .
...
پشتگیری لە ڕێکخستنی [HOGO](https://github.com/gohugoio/hugo) جۆری بلۆگی ئیستاتیک دەکات، کە تەنها بواری `title` و `summary` و `description` وەرگێڕاوە.
...
چین و ژاپۆن و کۆریا پیتی گەورە و بچووکیان نییە، بەڵام ڕێکەوتننامەی ناونیشانی ئینگلیزی بریتییە لە نووسینەوەی پیتی یەکەم.
...
### زاراوەی ئینگلیزی بە زمانی چینی، ژاپۆنی، کۆری و چینی وەرنەگێڕدراون
...
وەرگێڕدراوە بۆ زمانی : `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす`
...
وەرگێڕدراوە بۆ زمانی : `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す`
...
تەنها کاتێک بۆشایی لە نێوان وشەی ئینگلیزی و دەقی چینی و ژاپۆنی و کۆریدا هەبێت یان درێژی ئینگلیزی لە 1 زیاتر بێت، وشەکە وەک زاراوەیەک سەیر دەکرێت.

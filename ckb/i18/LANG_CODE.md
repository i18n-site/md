...
| ژماره‌ی نهێنی | کۆد | زمان | ناوی پیشاندراو |
| - | - | - | - |
| 0 | `en` | ئینگلیزی | `English` |
| 1 | `zh` | چینی ئاسانکراو | `简体中文` |
| 2 | `de` | ئەڵمانی | `Deutsch` |
| 3 | `fr` | فەڕەنسی | `Français` |
| 4 | `es` | ئیسپانی | `Español` |
| 5 | `it` | ئیتاڵی | `Italiano` |
| 6 | `ja` | ژاپۆنی | `日本語` |
| 7 | `pl` | پۆڵەندی | `Polski` |
| 8 | `pt` | پورتوگالی | `Português(Brasil)` |
| 9 | `ru` | ڕووسی | `Русский` |

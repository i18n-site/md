...
Преден дел [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
[Вградена командна линија js boa_engine](https://docs.rs/boa_engine) , [вградена база на податоци fjall](https://github.com/fjall-rs/fjall) .

сервер [contabo](https://my.contabo.com) VPS

база на податоци [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

Испрати пошта до само-изграден SMTP [chasquid](https://github.com/albertito/chasquid)

...
1. Кога документите се додаваат/изменуваат, само додадените или изменетите документи се реиндексираат, со што се намалува количината на пресметки.
...
Во интеракцијата на предниот дел, лентата за [напредок](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) на вчитување на индексот може да се прикаже [за](//juejin.cn/post/7413586285954154522) да се / задоцнување при css за прв progress + .

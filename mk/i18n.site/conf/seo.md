...
На статичните страници, користете `link` за да означите врски до различни јазични верзии на оваа страница, како на пр :
...
Во конфигурацијата, ве молиме сменете го `i18n.site` на вредноста `host:` во `.i18n/htm/ol.yml` , повеќе складишта на објекти може да се конфигурираат под `s3` , а полето `region` е изборно (многу складишта на објекти не треба да го поставуваат ова поле).
...
Поставете ги правилата за пренасочување на следниов начин, модифицирајте го кодот „i18n.site“ во името на вашиот домен
...
Податоците се прикачуваат на Baidu Object Storage и врзани за Baidu Content Distribution Network.
...
Бидејќи `R2` `cloudflare` да се пристапи со приспособено име на домен, треба да се користи складиште на објекти од трета страна за поставување статични датотеки.

Овде го [backblaze.com](https://www.backblaze.com) како пример за да демонстрираме како да ги врзуваме објектите од трети страни што треба да се складираат на `cloudflare` .

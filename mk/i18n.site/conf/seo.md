...
Ако сте го измениле `~/.config/i18n.site.yml` и сакате повторно да поставите, користете ја следнава команда во root директориумот на проектот за да го исчистите кешот за прикачување :

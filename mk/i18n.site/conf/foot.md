...
* `conf.css` Икони и фонтови : подножјето

### Фонт На Икона

Иконата за подножјето се генерира со креирање `F` iconfont.cn [англиска верзија](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

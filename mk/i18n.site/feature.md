...
Поврзан код : [github.com/i18n-site/18x/src/lang.coffee](https://github.com/i18n-site/18x/blob/main/src/lang.coffee)
...
`i18n.site` стандардно ќе ја објави содржината на страницата на `npmjs.com` , со помош на [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) и други повеќекратни `CDN` содржини вчитани на `npm` .
...
Поврзан код : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)
...
Поврзан код : [github.com/i18n-site/font](https://github.com/i18n-site/font)
...
`404` страница има сладок мал лебдечки дух, неговите очи ќе се движат со глувчето, [➔ Кликнете овде за да видите](/404) ,

...
Уредете го `md/.i18n/htm/ol.yml` и сменете ја вредноста од [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) сопствено име на `npm` пакети.

Потоа изменете го `md/.i18n/htm/ol.package.json`

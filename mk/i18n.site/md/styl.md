...
| Ниче         | Филозофијата на Супермен, критикувајќи го традиционалниот морал и религијата       |
| Маркс       | комунизмот |
...
Во огромниот свет на програмски јазици, `Rust` `Python` , `JavaScript` и `Go` секој зазема уникатно место.

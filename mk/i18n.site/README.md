...
<button onclick="mailsub()">Кликнете на оваа е-пошта за да се претплатите на ажурирањата на производите</button> и <button onclick="webpush()">да го овозможите притисокот од прелистувачот</button> . Ќе ве известиме кога ќе се направат ажурирања на производот.

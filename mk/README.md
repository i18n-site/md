...
Со социјалните медиуми и е-поштата, луѓето се навикнати да се фокусираат на извори на информации на нивниот мајчин јазик.
...
" се претплатиме на филозофијата на `UNIX` "
...
[Кликнете овде за да ја овластите и автоматски да github следите i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) и **да добиете бонус $50** .
...
<button onclick="mailsub()">Кликнете на оваа е-пошта за да се претплатите на ажурирањата на производите</button> и <button onclick="webpush()">да овозможите притискање на прелистувачот</button> . Ќе ве известиме кога производите ќе се ажурираат.
...
>
> ГОСПОД го виде ова и рече: Сите луѓе имаат ист јазик и раса, сега, кога тоа е постигнато, сè ќе биде направено.
>
...
Сакаме да изградиме Интернет без јазична изолација.
Се надеваме дека целото човештво ќе се собере со заеднички сон.

Сајтот за превод и документација Markdown е само почеток.

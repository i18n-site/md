...
Ние " претплатиме на филозофијата на `UNIX` "

Можете да ги користите најпознатите алатки за уредување на `Markdown` (но не можете да додавате или бришете пасуси) и да го користите најпознатиот начин за контрола на верзијата.
...
[Кликнете овде за да ја овластите и автоматски i18n.site ја следите github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) и **да добиете бонус $50** .

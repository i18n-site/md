...
## <a rel=id href="#project" id="project"></a> Опис на проектот
...
Преведи `Markdown` `YAML` во алатка за командна линија ( [изворен код](https://github.com/i18n-site/rust/tree/main/i18) ) на повеќе јазици.

Може совршено да го одржува форматот на `Markdown` Може да идентификува модификации на датотеки и да преведува само променети датотеки.
...
Ја споделуваме " `UNIX` Сè е датотека " и можеме да управуваме со преводи на стотици јазици без да воведуваме сложени и незгодни решенија на ниво на претпријатие.

Можете да ги користите најпознатите алатки за `Markdown` на преводот (но не можете да додавате или бришете параграфи) и да го користите најпознатиот начин за контрола на верзијата.

Може да се создаде база на кодови како отворен извор за јазични датотеки и со помош на процесот на `Pull Request` , глобалните корисници можат да учествуваат во континуираната оптимизација на преводите. Беспрекорна врска [github](//github.com) други заедници со отворен код.

[→ За упатство за корисникот, прочитајте ја проектната документација](/i18) .
...
Чисто статичен, оптимизиран за искуство со читање и интегриран со преводот на [i18](#i18) тој е најдобриот избор за изградба на локација за проектен документ.

Основната предна рамка усвојува целосна архитектура на приклучок, која е лесна за секундарен развој.

Оваа веб-локација е развиена врз основа на оваа рамка и вклучува кориснички, функции за плаќање и други ( [изворниот код](/i18n.site/src) ) Детален туторијал ќе биде напишан подоцна.

[→ За упатство за корисникот, прочитајте ја проектната документација](/i18n.site) .
...
> Рекоа: Дојдете, изградете кула што допира до небото и прославете го човечкиот род.
>

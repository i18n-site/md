...
## <a rel=id href="#project" id="project"></a> Төслийн тодорхойлолт
...
`Markdown` болон `YAML` олон хэлээр командын мөрийн хэрэгсэлд ( [эх код](https://github.com/i18n-site/rust/tree/main/i18) ) орчуулна уу.

-ийн форматыг төгс хадгалж чадна `Markdown` Файлын өөрчлөлтийг тодорхойлж, зөвхөн өөрчлөгдсөн файлуудыг орчуулах боломжтой.
...
Бид "Бүх зүйл бол файл " `UNIX` " хуваалцдаг бөгөөд байгууллагын түвшний нарийн төвөгтэй, төвөгтэй шийдлүүдийг нэвтрүүлэхгүйгээр олон зуун хэл дээрх орчуулгыг удирдах боломжтой.

Та орчуулгыг `Markdown` тулд хамгийн сайн мэддэг хэрэгслүүдийг ашиглаж болно (гэхдээ догол мөр нэмэх, устгах боломжгүй), хувилбарын хяналтыг хамгийн сайн мэддэг аргыг ашиглана уу.

Кодын баазыг хэлний файлуудын нээлттэй эх сурвалж болгон үүсгэж болох ба `Pull Request` -ийн тусламжтайгаар дэлхийн хэрэглэгчид орчуулгыг тасралтгүй оновчтой болгоход оролцох боломжтой. Тогтворгүй холболт [github](//github.com) бусад нээлттэй эхийн нийгэмлэгүүд.

[→ Хэрэглэгчийн гарын авлагыг төслийн баримт бичгийг уншина уу](/i18) .
...
Цэвэр статик, уншихад тохиромжтой, орчуулгатай [i18](#i18)
...
Энэхүү вэб сайт нь энэхүү системд тулгуурлан бүтээгдсэн бөгөөд хэрэглэгч, төлбөр болон бусад функцуудыг багтаасан болно ( [эх код](/i18n.site/src) ).

[→ Хэрэглэгчийн гарын авлагыг төслийн баримт бичгийг уншина уу](/i18n.site) .
...
Markdown орчуулга, бичиг баримтын сайтууд нь зөвхөн эхлэл юм.
...
Бид нээлттэй эх сурвалж, хайрын хуваалцах гэдэгт итгэдэг,

...
`use: Blog` -ээс `i18n/conf.yml` гэдэг нь рендер хийхэд блогын загварыг ашиглахыг хэлнэ.

Блогын нийтлэлийн `markdown` файл нь мета мэдээллийг тохируулах шаардлагатай.

Мета мэдээлэл нь файлын эхэнд `---` -ээс эхэлж `---` ээр төгссөн байх ёстой. Дунд хэсэгт байгаа тохиргооны мэдээллийн формат нь `YAML` байна.

Демо файлыг дараах байдлаар тохируулсан:

...
Демо төслийг жишээ болгон авч үзвэл `md` лавлах дахь `.i18n/htm/foot.pug` вэбсайтын хөлийг тодорхойлдог.
...
**`foot.pug` -д `css` ба `js` ыг бүү бич** , тэгэхгүй бол алдаа гарна.
...
Footer дүрс нь iconfont.cn `F` фонт үүсгэснээр үүсдэг ( [Англи хувилбар](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

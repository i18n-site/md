...
Тэдгээрийн дотроос `i18n: home` `en/i18n.yml` -ийн `home: Home` той тохирч байна.
...
`TOC` файлууд нь тоймуудын шаталсан хамаарлыг харуулахын тулд доголтой бөгөөд олон түвшний доголтыг дэмждэг.

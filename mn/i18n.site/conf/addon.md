...
Орчуулгын тушаалын мөр `i18n.site` нь залгаасын багцын конвенцийн файлыг суулгаж, дараа нь ажиллуулна.
...
Орчуулга дууссаны дараа үүнийг дуудах бөгөөд дамжуулсан параметрүүд нь дараах байдалтай байна.
...
[boa](https://github.com/boa-dev/boa) -ийн хоёрдогч хөгжүүлэлт дээр суурилагдсан `js` ажиллах хугацаа нь дараах байдлаар бүтээгдсэн болно :

* `wPath(path, txt)` файл руу :

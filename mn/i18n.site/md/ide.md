...
Хүн бүр өөрийн дуртай редактортой байдаг `Markdown`

Бид бичихдээ `MarkDown` [vscode](https://code.visualstudio.com/) гадна [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) залгаасыг суулгаж бичиж байхдаа бодит цаг хугацаанд нь урьдчилан харах боломжтой.

...
`i18n.site` нь `i18` орчуулгын хэрэгсэлтэй. [Энд дарж хандалтын токеныг тохируулахын тулд `i18` баримтыг үзнэ үү](/i18/use) .
...
Ажиллаж `md` дараа орчуулга болон кэш `git add . ` үүснэ.

### Орон Нутгийн Урьдчилан Үзэх

`docker` суулгаж эхлүүлнэ ( `MAC` хэрэглэгч [orbstack](https://orbstack.dev) -г `docker` ын ажиллах хугацаа болгон ашиглахыг зөвлөж байна).
...
Жишээлбэл, `.i18n/htm/ol.yml` нь `out/ol` санг үүсгэнэ.
...
`md/.i18n/htm/ol.yml` засаж, `i18n.site` `v: //unpkg.com/i18n.site` ээр нь өөрийн `npm` багцын нэрээр өөрчил.

Зөвхөн дээр ашиглагдаагүй багцын нэрийг ашиглана уу [npmjs.com](//npmjs.com)

Багц `npm` дээр тулгуурлан нийтлэхдээ шинэ хувилбаруудыг цаг тухайд нь үзэхийн тулд `v:` -ийн угтвар `i18n.site` `/.v` **`//unpkg.com/` ашиглахаа мартуузай** .
...
Өөрийн серверийг ашиглахаас гадна өөр нэг нийтлэг сонголт бол `S3` `CDN` + ашиглах явдал юм.

Та `S3` серверт нэвтэрч, дараа нь дараах скриптийг лавлаж, өөрчлөх [rclone](https://rclone.org) бөгөөд хувилбар бүрд зөвхөн нэмэгдүүлсэн өөрчлөлтийг `S3` болгож хуулж болно.
...
Кодыг дарсны дараа `github page` амжилттай ажиллуулахыг хүлээнэ үү (доор үзүүлсэн шиг).
...
`github page` [cloudflare page](//pages.cloudflare.com) харьцуулахад энэ нь замыг дахин бичих боломжийг олгодог бөгөөд эх газрын Хятадад илүү ээлтэй бөгөөд ашиглахыг зөвлөж байна.
...
Захиалгат домэйн нэрийг холбосны дараа доор үзүүлсэн шиг нэг хуудасны програмыг дахин бичих замыг тохируулахын тулд домэйн нэр рүү очно уу.
...
`MX` бичлэг болон `CNAME` бичлэг зэрэг нь зэрэгцэн орших боломжгүй тул хэрэв та домэйн нэрийн имэйлийг нэгэн зэрэг хүлээн авахыг хүсвэл `CNAME` `A` [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) хамтран ажиллах хэрэгтэй.
...
Хэрэв та вэбсайтаа үндсэн вэбсайтаа үүсгэхийн тулд `i18n.site` ашигладаг бол ихэвчлэн pan-domain дахин чиглүүлэлт, өөрөөр хэлбэл `*.xxx.com` ээс ( `www.xxx.com` г оруулаад) `xxx.com` руу дахин чиглүүлэх хандалтыг тохируулах хэрэгтэй.
...
[Alibaba Cloud CDN](https://cdn.console.aliyun.com/domain/list) д домэйн нэрийг нэмж, Alibaba Cloud `CDN` `*.xxx.com` -ээс `CNAME` зааж өгнө үү.
...
! `out/ol/htm` `server` догол мөрөнд `/root/i18n/md/out/ol/htm` төстэй тохиргоог нэмнэ үү nginx
...
`.i18n` лавлах дор `i18n.site` тохиргооны файлууд, орчуулгын кэш гэх мэт байдаг. Дэлгэрэнгүйг дараагийн бүлгээс ["Тохиргоо"](/i18n.site/conf) -оос үзнэ үү.

...
HTML Markdown орчуулгыг дэмждэг, `MarkDown` д оруулсан HTML -ын `<pre>` ба `<code>` шошго дахь контентыг орчуулаагүй болно

## Математикийн Томьёог Таньж, Орчуулгыг Алгасаж Чаддаг

Математикийн томьёог таньж, орчуулгыг алгасаж байна.

Математикийн томьёо хэрхэн бичих талаар [" Github Математик илэрхийлэл бичих тухай"](https://docs.github.com/get-started/writing-on-github/working-with-advanced-formatting/writing-mathematical-expressions#about-writing-mathematical-expressions) хэсгээс үзнэ үү.
...
`git` , `vim` , `vscode` мэддэг програмистуудын хувьд эдгээр хэрэгслийг ашиглан баримт бичгийг засварлаж, хувилбаруудыг удирдах нь сургалтын зардлыг нэмэгдүүлэх нь дамжиггүй.
...
Бид орчуулгыг үнэн зөв, жигд, гоёмсог болгохын тулд уламжлалт машин орчуулгын загвар болон том хэлний загваруудын техникийн давуу талыг нэгтгэсэн шинэ үеийн орчуулгын технологийг хөгжүүлсэн.

Манай орчуулгын чанар ижил төстэй үйлчилгээтэй харьцуулахад хамаагүй дээр гэдгийг харалган туршилт харуулж байна.
...
Зөвхөн `title` , `summary` болон `description` талбаруудыг орчуулдаг статик блогын толгойн тохиргоог дэмждэг [HOGO](https://github.com/gohugoio/hugo)

## Хувьсагчийн Нэрийг Бүү Орчуул

`Markdown` имэйлийн загвар болгон ашигладаг, `YAML` хэлний файлын тохиргоо болгон ашигладаг бөгөөд хувьсах параметрүүд байх болно (жишээлбэл: цэнэглэх `${amount}` хүлээн авсан).

`${varname}` гэх мэт хувьсагчийн нэрийг англи хэлний орчуулга гэж үзэхгүй.
...
`i18` нь `MarkDown` ийн гарчгийг таних боломжтой бөгөөд том жижиг үсгийг том үсгээр бичнэ.
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` хэл рүү орчуулсан :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` хэл рүү орчуулсан :

`Falcon` -г `faucon` , `Llama` ыг `lama` гэж орчуулна. Зөв нэрийн хувьд тэдгээрийг орчуулах ёсгүй.

![](//p.3ti.site/1720199451.avif)

### DeepL Орчуулга

`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` хэл рүү орчуулсан :
...
`i18` олон хэлээр ажилладаг вэб сайт бүтээх командын мөрийн хэрэгсэл [`i18n.site`](/i18n.site) -д нэгдсэн.
...
<button onclick="mailsub()">Бүтээгдэхүүний шинэчлэлтийг бүртгүүлэхийн тулд энэ имэйлийг дарж</button> , <button onclick="webpush()">хөтөчийг идэвхжүүлнэ үү</button> .

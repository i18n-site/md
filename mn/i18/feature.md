...
Холимог HTML орчуулгыг дэмждэг Markdown `MarkDown` -д оруулсан HTML -ын `<pre>` ба `<code>` шошго дахь контентыг орчуулаагүй болно
...
`git` , `vim` , болон `vscode` ыг мэддэг програмистуудын хувьд эдгээр хэрэгслийг ашиглан баримт бичгийг засварлаж, хувилбаруудыг удирдах нь сургалтын зардлыг нэмэгдүүлэх нь дамжиггүй.
...
Бид орчуулгыг үнэн зөв, жигд, дэгжин болгохын тулд уламжлалт машин орчуулгын загвар болон том хэлний загваруудын техникийн давуу талыг нэгтгэсэн шинэ үеийн орчуулгын технологийг хөгжүүлсэн.
...
[Энд дарж github -г зөвшөөрч, автоматаар i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) , **$50 аваарай** .
...
`i18` `MarkDown` ийн гарчгийг таних боломжтой бөгөөд том жижиг үсгийг том үсгээр бичнэ.

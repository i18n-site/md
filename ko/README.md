<h1 style="justify-content:space-between">3Ti.Site · 경계 없는 생각<img src="//i-01.eu.org/i18n/logo.svg" style="margin-top:-1px;width:42px"></h1>
...
SF소설 『삼체』(중국어 발음: `3Ti` )는 투명한 사고와 번영하는 과학기술로 전자파를 이용해 소통하는 외계 문명을 가상화한 작품이다.

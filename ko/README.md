<h1 style="justify-content:space-between">3Ti.Site · 국경 없는 사고<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

3Ti.Site, 마크다운 번역 + 다국어 정적 사이트 생성기.

[수백 가지 언어를](https://github.com/i18n-site/node/blob/main/lang/src/index.js) 지원하는 국제 문서와 블로그를 빠르게 구축할 수 있습니다.
...
> 그 시대에는 천하 만민의 음성과 말이 하나가 되었느니라.
>
> 그들은 하늘 높이 탑을 쌓고 하나님의 문에 닿으며 마음을 하나로 모으고 영광을 자랑했습니다.
>
> 주님은 이렇게 선포하셨습니다. 언어와 혈통을 공유하면 하나의 종족이 된다. 탑은 시작에 불과합니다. 앞으로 며칠 안에 그들이 이루지 못할 일은 없을 것이다.
>
> 그리하여 그분은 강림하셨고, 사람들은 멀리 흩어졌고, 그들의 언어는 이제 서로 이해할 수 없게 되었습니다.
>
> 그때부터 다툼은 끝이 없었고, 세상에는 더 이상 하늘에 닿는 탑이 보이지 않았습니다.

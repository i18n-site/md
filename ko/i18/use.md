...
번역 외에도 프로그램은 다음과 같은 파일을 생성하므로 이들을 저장소에 추가하세요.
...
특히 `.i18n/cache/.gitignore`의 내용은 다음과 같습니다:
...
이는 `.i18n/cache/` 디렉토리(`.i18n/cache/.gitignore`를 제외)에 있는 모든 파일을 무시하는 것을 의미합니다.

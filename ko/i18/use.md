...
[i18n.site/payBill](//i18n.site/payBill) 결제를 위해 신용카드를 연결해야 합니다(재충전이 필요하지 않으며 웹사이트에서 사용량에 따라 자동으로 수수료를 공제합니다. [가격은 홈페이지를 참조하세요](/#price) ).
...
특정 파일을 무시하고 번역하지 않으려면(예: 완료되지 않은 초안) `ignore` 필드 구성을 사용할 수 있습니다.

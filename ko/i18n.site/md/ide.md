...
[vscode](https://code.visualstudio.com/) 사용하여 `MarkDown` 작성하고, 작성하는 동안 실시간으로 미리 볼 수 있도록 플러그인 [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) 도 설치합니다.

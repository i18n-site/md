...
지속적인 통합 환경을 사용하여 게시하는 경우 `nodejs` 설치할 필요가 없으며 로그인한 게시 권한 `~/.npmrc` 환경에 복사하기만 하면 됩니다.
...
처음 바인딩한 후 액세스하려면 몇 분 정도 기다려야 합니다.
...
에지 컴퓨팅을 사용하여 단일 페이지 애플리케이션에 맞게 경로를 다시 작성할 수 있습니다. 예를 들어 [Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) 다음과 같이 구성할 수 있습니다.

...
* / 구성 [atomgit](https://atomgit.com/i18n/18x) [github](https://github.com/i18n-site/18x)
* 구성 [atomgit](https://atomgit.com/i18n/plugin) [github](https://github.com/i18n-site/plugin) / svelte
...
* / 기본 [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* 직접 참조된 프런트엔드 라이브러리를 패키징할 필요 / [atomgit](https://atomgit.com/i18n/x) [github](https://github.com/i18n-site/x)
...
* 기본 [atomgit](https://atomgit.com/i18n/rust) / [github](https://github.com/i18n-site/rust)
...
* 온라인 [atomgit](https://atomgit.com/i18n-ops/ops) 스크립트 [github](https://github.com/i18n-ops/ops) /

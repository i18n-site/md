...
મિશ્રિત Markdown ના અનુવાદને સમર્થન આપે છે HTML `MarkDown` માં એમ્બેડ કરેલ HTML ના `<pre>` અને `<code>` ટૅગમાંની સામગ્રીનો અનુવાદ કરવામાં આવ્યો નથી
...
અનુવાદની ટિપ્પણીઓમાં ` ``` ` પછીની ભાષા સૂચવવી જરૂરી છે, જેમ કે ` ```rust ` :
...
સ્ટેટિક બ્લોગના હેડર કન્ફિગરેશનને સપોર્ટ કરે છે [HOGO](https://github.com/gohugoio/hugo) જે ફક્ત `title` , `summary` અને `description` ફીલ્ડનું ભાષાંતર કરે છે.

## ચલ નામોનો અનુવાદ કરશો નહીં

`Markdown` ઉપયોગ ઈમેઈલ ટેમ્પલેટ તરીકે થાય છે, `YAML` ઉપયોગ ભાષા ફાઈલ રૂપરેખાંકન તરીકે થાય છે અને ત્યાં વેરીએબલ પેરામીટર્સ હશે (ઉદાહરણ તરીકે: રિચાર્જ `${amount}` પ્રાપ્ત થયું છે).
...
`Falcon` નું ભાષાંતર `faucon` તરીકે થાય છે અને `Llama` નું `lama` તરીકે ભાષાંતર થાય છે. યોગ્ય સંજ્ઞાઓ તરીકે, તેઓનું ભાષાંતર કરવું જોઈએ નહીં.
...
ઉપરનું DeepL ભાષાંતર (યોગ્ય નામો ફરીથી લખીને `... ` ઉમેરવું):
...
ઉદાહરણ તરીકે: `C罗` `Cristiano Ronaldo` તરીકે ભાષાંતર કરવામાં આવશે.

...
વધુમાં, તમારે ચુકવણી માટે ક્રેડિટ કાર્ડ [i18n.site/payBill](//i18n.site/payBill) જરૂર છે (કોઈ રિચાર્જની જરૂર નથી, વેબસાઈટ આપમેળે ઉપયોગ અનુસાર ફી કપાત કરશે, [કિંમત માટે હોમપેજ જુઓ](/#price) ).
...
તેમાંથી, `.i18n/cache/.gitignore` ની સામગ્રી નીચે મુજબ છે :
...
આનો અર્થ એ છે કે ડિરેક્ટરી `.i18n/cache/` ( `.i18n/cache/.gitignore` સિવાય) માં બધી ફાઇલોને અવગણવામાં આવી છે.

જો તમારું સંસ્કરણ નિયંત્રણ સોફ્ટવેર `git` નથી, તો કૃપા કરીને આ ગોઠવણી અનુસાર તેને અવગણો.

## રૂપરેખાંકન ફાઇલ

`.i18n/conf.yml` એ `i18` આદેશ વાક્ય અનુવાદ સાધનની રૂપરેખાંકન ફાઇલ છે
...
તમે `fromTo` / સબડિરેક્ટરીઝ માટે રૂપરેખાંકિત કરી શકો છો એક પ્રદર્શન નીચે પ્રમાણે લખાયેલ છે :
...
આ રૂપરેખાંકન કોષ્ટકમાં, કેટલોગ `blog` અનુવાદની સ્રોત ભાષા `zh` છે, અને `blog/your_file_name.md` અનુવાદની સ્રોત ભાષા `ja` છે.
...
`ignore` `.gitignore` ફાઇલની જેમ [globset](https://docs.rs/globset/latest/globset/#syntax) સિન્ટેક્સનો ઉપયોગ કરે છે.

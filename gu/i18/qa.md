...
## લિંક `HTML` : `Markdown` રૂપાંતરિત કરવાથી `YAML` રીતે ટાળવું

અનુવાદ માટે `YAML` નું મૂલ્ય `MarkDown` તરીકે ગણવામાં આવે છે.

કેટલીકવાર `HTML` → `MarkDown` માંથી રૂપાંતર એ નથી હોતું જે આપણે જોઈએ છે, જેમ કે `<a href="/">Home</a>` ને `[Home](/)` માં રૂપાંતરિત કરવું.

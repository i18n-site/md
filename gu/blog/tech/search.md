...
તેનો ઑફલાઇન ઉપયોગ કરી શકાતો નથી, ઇન્ટ્રાનેટ પર ઉપયોગ કરી શકાતો નથી અને તેની મોટી મર્યાદાઓ છે. આ લેખમાં બહુ ચર્ચા નથી.
...
2. દસ્તાવેજો લોડ કરો અને ફ્લાય પર અનુક્રમણિકા બનાવો
   ...
   અનુક્રમણિકા બનાવવી એ ગણતરીપૂર્વકનું સઘન કાર્ય છે જ્યારે તમે તેને ઍક્સેસ કરો છો ત્યારે સ્પષ્ટપણે ક્ષતિઓ અને નબળા વપરાશકર્તા અનુભવનું કારણ બનશે.
...
* `/\p{P}/` એ { અભિવ્યક્તિ છે જે `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` સાથે મેળ ખાય છે. | } `.</p><ul><li> `split('.')` એ છે કારણ કે `Firefox` બ્રાઉઝર શબ્દ વિભાજન `. ` વિભાજિત કરતું નથી.</li>
...
દસ્તાવેજ `url` અને સંસ્કરણ નંબર `ver` ની એરેમાં પસાર કરો, અને કોષ્ટક `doc` માં દસ્તાવેજ અસ્તિત્વમાં છે કે કેમ તે શોધો. જો તે અસ્તિત્વમાં નથી, તો ઊંધી અનુક્રમણિકા બનાવો. તે જ સમયે, તે દસ્તાવેજો માટે ઇન્વર્ટેડ ઇન્ડેક્સ દૂર કરો જે પાસ થયા ન હતા.

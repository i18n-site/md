...
આ લેખ `i18n.site` શુદ્ધ ફ્રન્ટ-એન્ડ ફુલ-ટેક્સ્ટ સર્ચ વિઝિટના અમલીકરણને શેર કરશે [i18n.site](//i18n.site)

કોડ ઓપન સોર્સ [સર્ચ કર્નલ](//github.com/i18n-site/ie/tree/main/qy) / [ઇન્ટરફેસ](//github.com/i18n-site/plugin/tree/main/qy)

## સર્વરલેસ ફુલ-ટેક્સ્ટ સર્ચ સોલ્યુશન્સનું વિહંગાવલોકન

નાની વેબસાઇટ્સ જેમ કે દસ્તાવેજો/વ્યક્તિગત બ્લોગ્સ કે જે સંપૂર્ણ રીતે સ્થિર હોય છે, તે નિઃશંકપણે તમારા દ્વારા સંપૂર્ણ-ટેક્સ્ટ શોધ બેકએન્ડ બનાવવા માટે ખૂબ જ ભારે છે, અને સેવાઓ વિના સંપૂર્ણ-ટેક્સ્ટ શોધ નિઃશંકપણે વધુ સારું વજન છે.

હાલના સર્વરલેસ ફુલ-ટેક્સ્ટ સર્ચ સોલ્યુશન્સ બે વ્યાપક શ્રેણીઓમાં આવે છે.

એક તૃતીય-પક્ષ શોધ સેવા પ્રદાતા છે [algolia.com](//algolia.com) જે ફ્રન્ટ-એન્ડ પૂર્ણ-ટેક્સ્ટ શોધ ઘટકો પ્રદાન કરે છે.

આવી સેવાઓને ચૂકવણીની જરૂર છે અને વેબસાઇટ અનુપાલન સમસ્યાઓને કારણે મેઇનલેન્ડ ચાઇનામાં વપરાશકર્તાઓ માટે ઉપલબ્ધ નથી.

તેનો ઑફલાઇન ઉપયોગ કરી શકાતો નથી, ઇન્ટ્રાનેટ પર તેનો ઉપયોગ કરી શકાતો નથી અને તેમાં મોટી મર્યાદાઓ છે. આ લેખમાં બહુ ચર્ચા નથી.

બીજું શુદ્ધ ફ્રન્ટ-એન્ડ ફુલ-ટેક્સ્ટ શોધ છે.

જાણીતા શુદ્ધ ફ્રન્ટ-એન્ડ ફુલ-ટેક્સ્ટ શોધમાં અને [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) સમાવેશ થાય [lunrjs](https://lunrjs.com) .

`lunrjs` અનુક્રમણિકા બનાવવાની બે રીતો છે, પરંતુ બંનેની પોતાની સમસ્યાઓ છે.

1. પૂર્વ-બિલ્ટ ઇન્ડેક્સ ફાઇલો

   કારણ કે ઇન્ડેક્સમાં તમામ દસ્તાવેજોના શબ્દો છે, તે કદમાં મોટું છે.
   જ્યારે પણ દસ્તાવેજ ઉમેરવામાં આવે છે અથવા તેમાં ફેરફાર કરવામાં આવે છે, ત્યારે નવી ઇન્ડેક્સ ફાઇલ લોડ કરવી આવશ્યક છે.
...
[fusejs](https://www.fusejs.io) શોધવા માટે તાર વચ્ચેની સમાનતાની ગણતરી કરો.

આ સોલ્યુશનનું પ્રદર્શન અત્યંત નબળું છે અને તેનો સંપૂર્ણ-ટેક્સ્ટ શોધ માટે ઉપયોગ કરી શકાતો નથી (જુઓ [Fuse.js લાંબી ક્વેરી 10 સેકન્ડ કરતાં વધુ સમય લે છે, તેને કેવી રીતે ઑપ્ટિમાઇઝ કરવું?](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

[TinySearch](https://github.com/tinysearch/tinysearch) શોધવા માટે બ્લૂમ ફિલ્ટરનો ઉપયોગ કરો, ઉપસર્ગ શોધ માટે ઉપયોગ કરી શકાતો નથી (ઉદાહરણ તરીકે, `goo` દાખલ કરો, શોધ `good` , `google` ), અને સમાન સ્વચાલિત પૂર્ણતા અસર પ્રાપ્ત કરી શકતા નથી.

હાલના ઉકેલોની ખામીઓ પ્રત્યે અસંતોષને કારણે, `i18n.site` એક નવું શુદ્ધ ફ્રન્ટ-એન્ડ ફુલ-ટેક્સ્ટ સર્ચ સોલ્યુશન વિકસાવ્યું છે, જેમાં નીચેની સુવિધાઓ છે :
...
1. જ્યારે દસ્તાવેજો ઉમેરવામાં આવે છે/સંશોધિત કરવામાં આવે છે, ત્યારે માત્ર ઉમેરવામાં આવેલા અથવા સંશોધિત દસ્તાવેજોને જ ફરીથી અનુક્રમિત કરવામાં આવે છે, જે ગણતરીની માત્રામાં ઘટાડો કરે છે.
1. ઉપસર્ગ શોધને સપોર્ટ કરે છે, જે વપરાશકર્તા ટાઇપ કરી રહ્યો હોય ત્યારે વાસ્તવિક સમયમાં શોધ પરિણામો પ્રદર્શિત કરી શકે છે.
1. ઑફલાઇન ઉપલબ્ધ છે
...
5 ઑબ્જેક્ટ સ્ટોરેજ કોષ્ટકો `IndexedDB` માં બનાવવામાં આવ્યા હતા :
...
ફ્રન્ટ-એન્ડ ક્રિયાપ્રતિક્રિયામાં, પ્રથમ વખત લોડ કરતી વખતે લેગ ટાળવા માટે ઇન્ડેક્સનો લોડિંગ પ્રોગ્રેસ બાર પ્રદર્શિત કરી શકાય છે "એનિમેશન સાથે પ્રોગ્રેસ બાર, સિંગલ પર આધારિત progress + શુદ્ધ css અમલીકરણ" [અંગ્રેજી](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [ચાઇનીઝ](https://juejin.cn/post/7413586285954154522) .

### IndexedDB ઉચ્ચ સમવર્તી લેખન

પ્રોજેક્ટ IndexedDB ના અસુમેળ એન્કેપ્સ્યુલેશનના આધારે [idb](https://www.npmjs.com/package/idb) છે
...
શોધ પહેલા વપરાશકર્તા દ્વારા દાખલ કરાયેલા કીવર્ડ્સને સેગમેન્ટ કરશે.
...
ઊંધી પૂર્ણ-ટેક્સ્ટ શોધ, ઝડપી પ્રતિસાદ સાથે અને સર્વરની કોઈ જરૂર સાથે, આગળના છેડા પર સંપૂર્ણ રીતે લાગુ કરવામાં આવી છે.

તે નાના અને મધ્યમ કદની વેબસાઇટ્સ જેમ કે દસ્તાવેજો અને વ્યક્તિગત બ્લોગ્સ માટે ખૂબ જ યોગ્ય છે.
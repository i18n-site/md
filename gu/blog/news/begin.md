...
અડધા વર્ષથી વધુ વિકાસ પછી, ઓનલાઈન છે [https://i18n.site](//i18n.site)

હાલમાં, બે ઓપન સોર્સ કમાન્ડ લાઇન ટૂલ્સ અમલમાં છે:

* `i18` : MarkDown વાક્ય અનુવાદ સાધન
* `i18n.site` : મલ્ટિ-લેંગ્વેજ સ્ટેટિક ડોક્યુમેન્ટ સાઇટ જનરેટર, **વાંચન અનુભવ માટે ઑપ્ટિમાઇઝ**
...
Google ફોરમ દ્વારા અમારો સંપર્ક કરવા માટે મફત લાગે [groups.google.com/u/2/g/i18n-site](https://groups.google.com/u/2/g/i18n-site) :
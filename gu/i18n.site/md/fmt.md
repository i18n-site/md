...
પરંપરાગત `MarkDown` એન્કર પોઈન્ટ ટેક્સ્ટ સામગ્રીના આધારે જનરેટ થાય છે, બહુ-ભાષાના કિસ્સામાં, આ ઉકેલ શક્ય નથી.
...
## બહુવિધ ભાષાઓમાં ચિત્રો/વિડિયો/લિંક

`MarkDown` `HTML` માં રૂપાંતરિત કર્યા પછી, વિશેષતાઓ `src` અને `href` માં `$LANG` વર્તમાન [ભાષા કોડ](/i18/LANG_CODE) સાથે બદલવામાં આવશે.

આ વેરીએબલ સાથે, તમે ચિત્રો/વિડિયો/લિંકનું બહુભાષીકરણ પ્રાપ્ત કરી શકો છો.
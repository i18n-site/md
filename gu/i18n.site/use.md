...
સત્તાવાર પ્રકાશન માટે, બદલાયેલ ફાઇલોને નવા સંસ્કરણ નંબર નિર્દેશિકામાં કૉપિ કરવામાં આવશે.
...
પર સામગ્રી પ્રકાશિત કરવી [npmjs.com](//npmjs.com) ભલામણ કરેલ ડિફૉલ્ટ સોલ્યુશન છે (જુઓ [ફ્રન્ટ-એન્ડ હાઇ અવેલેબિલિટી](/i18n.site/feature#ha) ).
...
પેકેજ `npm` પર આધારિત પ્રકાશિત કરતી વખતે, `v:` મૂલ્યના ઉપસર્ગ માટે **`//unpkg.com/` ઉપયોગ કરવાનું સુનિશ્ચિત** કરો `i18n.site` નવા પ્રકાશનોને સમયસર જોવા માટે આ ઉપસર્ગ પાથ હેઠળ `/.v` ના કેશ સમયને ખાસ ઑપ્ટિમાઇઝ કર્યો છે.

અનુવાદ અને પ્રકાશિત કરવા માટે `md` ડિરેક્ટરીમાં `i18n.site --npm` અથવા `i18n.site -n` ચલાવો.

જો તમે પ્રકાશિત કરવા માટે સતત એકીકરણ પર્યાવરણનો ઉપયોગ કરો છો, તો `nodejs` ઇન્સ્ટોલ કરવાની કોઈ જરૂર નથી, ફક્ત લૉગ ઇન અને પ્રકાશન પરવાનગી `~/.npmrc` પર્યાવરણમાં કૉપિ કરો.

જો તમે `ol.yml` માં `v:` ના પેકેજનું નામ સંશોધિત કરો છો, તો કૃપા કરીને **પહેલા `.i18n/v/ol` કાઢી નાખવાની ખાતરી કરો** અને પછી તેને પ્રકાશિત કરો.
...
અગાઉના લેખમાં સામગ્રી પ્રકાશિત કરતી વખતે, `out/ol/htm` જનરેટ કરવામાં આવ્યું છે, કૃપા કરીને આ ડિરેક્ટરી દાખલ કરો અને ચલાવો :
...
પછી, મેઇનલેન્ડ + ક્લાઉડ વિક્રેતાઓના ઑબ્જેક્ટ સ્ટોરેજનો ઉપયોગ કરો `CDN` નીચેની સામગ્રીનો ઉપયોગ કરો `out/ol/htm` .
...
`.i18n` ડિરેક્ટરી હેઠળ `i18n.site` ની રૂપરેખાંકન ફાઈલો, અનુવાદ કેશ વગેરે છે. વિગતો માટે આગળનું પ્રકરણ ["રૂપરેખાંકન"](/i18n.site/conf) જુઓ.

...
`md/.i18n/htm/ol.yml` સંપાદિત કરો અને તમારા પોતાના `npm` પેકેજ નામ [npmjs.com](//npmjs.com) [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` ની કિંમત બદલો!

પછી `md/.i18n/htm/ol.package.json` સંશોધિત કરો

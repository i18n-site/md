...
* મુખ્ય [atomgit](https://atomgit.com/i18n/proto) / [github](https://github.com/i18n-site/site)
...
* યુનિવર્સલ બેઝ [atomgit](https://atomgit.com/i18n/lib) / [github](https://github.com/i18n-site/lib)
* બ્રાઉઝર [atomgit](https://atomgit.com/i18n/ie) લાઇબ્રેરી [github](https://github.com/i18n-site/ie) /
* સીધા સંદર્ભિત ફ્રન્ટ-એન્ડ લાઇબ્રેરીઓને પેકેજ કરવાની [atomgit](https://atomgit.com/i18n/x) / [github](https://github.com/i18n-site/x)
...
* સ્થાનિક [atomgit](https://atomgit.com/i18n-api/srv.docker) / [github](https://github.com/i18n-api/srv.docker)

## સંચાલન અને જાળવણી

* ઑનલાઇન [atomgit](https://atomgit.com/i18n-ops/ops) સ્ક્રિપ્ટ [github](https://github.com/i18n-ops/ops) /

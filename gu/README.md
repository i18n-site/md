...
## <a rel=id href="#project" id="project"></a> પરિયોજના નું વર્ણન

આ સાઇટ હાલમાં બે ઓપન સોર્સ કમાન્ડ લાઇન ટૂલ્સ પ્રદાન કરે છે:

* [i18 : MarkDown લાઇન અનુવાદ સાધન](/i18/feature)
* [i18n.site : -લેંગ્વેજ સ્ટેટિક વેબસાઇટ જનરેટર](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: માર્કડાઉન કમાન્ડ લાઇન અનુવાદ સાધન

બહુવિધ ભાષાઓમાં કમાન્ડ લાઇન ટૂલ ( [સોર્સ કોડ](https://github.com/i18n-site/rust/tree/main/i18) ) માં `YAML` કરો `Markdown`

ના ફોર્મેટને સંપૂર્ણ રીતે જાળવી શકે છે `Markdown` ફાઇલ ફેરફારોને ઓળખી શકે છે અને ફક્ત બદલાયેલ ફાઇલોનો અનુવાદ કરી શકે છે.
...
અમે એવરીથિંગ ઈઝ એ ફાઇલ " `UNIX` " શેર કરીએ છીએ અને જટિલ અને બોજારૂપ એન્ટરપ્રાઇઝ-લેવલ સોલ્યુશન્સ રજૂ કર્યા વિના સેંકડો ભાષાઓમાં અનુવાદોનું સંચાલન કરી શકીએ છીએ.

તમે અનુવાદને `Markdown` માટે સૌથી વધુ પરિચિત સાધનોનો ઉપયોગ કરી શકો છો (પરંતુ તમે ફકરા ઉમેરી અથવા કાઢી શકતા નથી), અને સંસ્કરણ નિયંત્રણ કરવા માટે સૌથી વધુ પરિચિત રીતનો ઉપયોગ કરી શકો છો.

ભાષાની ફાઇલો માટે ઓપન સોર્સ તરીકે કોડ બેઝ બનાવી શકાય છે, અને `Pull Request` પ્રક્રિયાની મદદથી, વૈશ્વિક વપરાશકર્તાઓ અનુવાદના સતત ઑપ્ટિમાઇઝેશનમાં ભાગ લઈ શકે છે. સીમલેસ કનેક્શન [github](//github.com) અન્ય ઓપન સોર્સ સમુદાયો.

[→ વપરાશકર્તા માર્ગદર્શિકા માટે, કૃપા કરીને પ્રોજેક્ટ દસ્તાવેજીકરણ વાંચો](/i18) .
...
કેવળ સ્થિર, વાંચન અનુભવ માટે ઑપ્ટિમાઇઝ અને [i18](#i18) પ્રોજેક્ટ દસ્તાવેજ સાઇટ બનાવવા માટે તે શ્રેષ્ઠ પસંદગી છે.
...
આ વેબસાઇટ આ ફ્રેમવર્કના આધારે વિકસાવવામાં આવી છે અને તેમાં વપરાશકર્તા, ચુકવણી અને અન્ય કાર્યોનો સમાવેશ થાય છે ( [સ્ત્રોત કોડ](/i18n.site/src) ).

[→ વપરાશકર્તા માર્ગદર્શિકા માટે, કૃપા કરીને પ્રોજેક્ટ દસ્તાવેજીકરણ વાંચો](/i18n.site) .

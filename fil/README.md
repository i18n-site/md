<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Mga internasyonal na solusyon<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Paglalarawan ng Proyekto
...
Isalin ang `Markdown` at `YAML` sa isang command line tool ( [source code](https://github.com/i18n-site/rust/tree/main/i18) ) sa maraming wika.

Maaaring ganap na mapanatili ang format ng `Markdown` Maaaring tukuyin ang mga pagbabago sa file at isalin lamang ang mga binagong file.
...
Ibinabahagi namin " pilosopiya `UNIX` Lahat ay isang File " at maaaring pamahalaan ang mga pagsasalin sa daan-daang wika nang hindi nagpapakilala ng mga kumplikado at masalimuot na solusyon sa antas ng negosyo.

Maaari mong gamitin ang pinakapamilyar na mga tool upang `Markdown` ang pagsasalin (ngunit hindi ka maaaring magdagdag o magtanggal ng mga talata), at gamitin ang pinakapamilyar na paraan upang gawin ang kontrol sa bersyon.

Ang isang code base ay maaaring gawin bilang isang open source para sa mga file ng wika, at sa tulong ng proseso ng `Pull Request` Walang putol na koneksyon [github](//github.com) At iba pang open source na komunidad.
...
Purong static, na-optimize para sa karanasan sa pagbabasa, at isinama sa pagsasalin ng [i18](#i18) ito ang pinakamahusay na pagpipilian para sa pagbuo ng site ng dokumento ng proyekto.
...
Ang website na ito ay binuo batay sa framework na ito at kasama ang user, pagbabayad at iba pang mga function ( [source code](/i18n.site/src) ).

[→ Para sa gabay sa gumagamit, pakibasa ang dokumentasyon ng proyekto](/i18n.site) .

...
Ang tradisyonal na `MarkDown` anchor point ay nabuo batay sa nilalaman ng teksto Sa kaso ng maraming wika, ang solusyon na ito ay hindi magagawa.
...
Hindi isasalin ang nilalaman sa `<pre>` elemento.

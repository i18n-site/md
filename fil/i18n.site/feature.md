...
Pagkatapos manu-manong magpalit ng wika ang user, maaalala ang pinili ng user.
...
Sa batayan na ito, idinagdag ang mga mirror source mula sa mainland China para payagan ang mga Chinese na user na magkaroon ng stable na access at makamit **ang mataas na front-end availability** .
...
Ang `404` page ay may cute na maliit na lumulutang na multo, ang mga mata nito ay gumagalaw gamit ang mouse, [➔ Mag-click dito para tingnan](/404) ,

...
Narito `en/` ay ang language code na naaayon sa translation source language na na-configure ng `.i18n/conf.yml` .
...
Sa proyekto ng demo, bilang karagdagan sa `en/demo2/v` , makikita mo rin na mayroong walang laman na `v` file sa `en/blog` at `en/demo1` na mga direktoryo.

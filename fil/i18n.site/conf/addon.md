...
Ang mga plug-in ay lahat ng `npm` na pakete.
...
Kung gusto mong ayusin ang bersyon, maaari mong isulat `i18n.addon/toc@0.1.3` .
...
Ang built-in na `js` runtime ay batay sa pangalawang pag-unlad [boa](https://github.com/boa-dev/boa) , at ang mga built-in na function ay ang mga sumusunod :

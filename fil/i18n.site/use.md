...
Kung gusto mong i-self-host ang nilalaman, i-edit muna `md/.i18n/htm/ol.yml` at baguhin ang `v: //unpkg.com/i18n.site` sa iyong prefix ng URL, gaya ng `v: //i18n-v.xxx.com` .
...
Pagkatapos, gamitin ang object storage ng cloud vendor sa mainland China + I-deploy ang sumusunod na content `CDN` `out/ol/htm`
...
Ang mga solusyon sa pag-optimize ng deployment na ito ay mas kumplikado at ipapakilala sa magkakahiwalay na mga kabanata sa hinaharap.

...
Kapag nag-publish batay sa package `npm` , **tiyaking gumamit `//unpkg.com/` para** sa prefix ng `v:` value na espesyal na na-optimize ng `i18n.site` ang oras ng cache na `/.v` sa ilalim ng prefix na path na ito upang makamit ang napapanahong pagtingin sa mga bagong release.

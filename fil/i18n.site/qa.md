...
## Hindi Sinasadyang Natanggal `.i18n/v` , Na Naging Dahilan Upang Mabigong Ma-Publish Ang Package `npm`
...
Sa ngayon, hanapin muna ang numero ng bersyon ng huling bersyon ng paglabas ng iyong proyekto sa [npmjs.com](//npmjs.com) gaya ng `0.1.9` .

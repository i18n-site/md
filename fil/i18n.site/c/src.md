...
* / -iisang [atomgit](https://atomgit.com/i18n/18x) [github](https://github.com/i18n-site/18x)
...
* Library base / [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* Hindi / kailangang mag-package [atomgit](https://atomgit.com/i18n/x) mga direktang naka-reference na mga library sa harap [github](https://github.com/i18n-site/x)
  Maginhawang mag-quote nang direkta sa markdown initialization script at gamitin ito sa naka-package na website nang sabay-sabay, upang maiwasan ang pagdoble ng code.
...
* Lokal / [atomgit](https://atomgit.com/i18n-api/srv.docker) [github](https://github.com/i18n-api/srv.docker)

## Operasyon at Pagpapanatili

* Online / [atomgit](https://atomgit.com/i18n-ops/ops) script [github](https://github.com/i18n-ops/ops)
* [atomgit](https://atomgit.com/i18n-ops/ubuntu) Configuration [github](https://github.com/i18n-ops/ubuntu) / ubuntu
* / nakaiskedyul na [atomgit](https://atomgit.com/i18n/cron) [github](https://github.com/i18n-cron/cron)

...
1. Sinusuportahan ang multi-language na paghahanap at maliit ang laki Ang laki ng search kernel pagkatapos ng packaging `gzip` ay `6.9KB` (para sa paghahambing, ang laki ng `lunrjs` ay `25KB` )
...
Sa front-end na pakikipag-ugnayan, ang index loading progress bar ay maaaring ipakita upang maiwasan ang lag kapag naglo-load sa unang pagkakataon Tingnan ang "Progress Bar na may Animation, Batay sa isang Single progress + Pure css Implementation" [English](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [Chinese](//juejin.cn/post/7413586285954154522) .

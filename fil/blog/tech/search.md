...
Sa front-end na pakikipag-ugnayan, [ang](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) pag-load [ng](https://juejin.cn/post/7413586285954154522) progress bar ng index / maaaring ipakita upang maiwasan ang lag kapag naglo css load sa unang progress + .
...
Kasabay nito, dahil ini-cache `service worker` ang lahat ng mga artikulo, kapag ang isang user ay nagsagawa ng paghahanap, ang buong website, kabilang ang paghahanap, ay available offline.

## Pag-Optimize Ng Display Ng Mga Dokumento Ng MarkDown

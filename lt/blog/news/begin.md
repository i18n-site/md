...
Vertimas gali puikiai išlaikyti `Markdown` formatą. Gali atpažinti failų modifikacijas ir išversti tik failus su pakeitimais.

Vertimas yra redaguojamas, o jį vėl išvertus mašininiu būdu, rankiniai vertimo pakeitimai nebus perrašyti (jei ši originalaus teksto pastraipa nebuvo pakeista).

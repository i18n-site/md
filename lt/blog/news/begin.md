...
* `i18` : MarkDown eilutės vertimo įrankis
* `i18n.site` Daugiakalbis statinių dokumentų svetainių generatorius : **optimizuotas skaitymo patirčiai**
...
Siųsti paštą į savarankiškai pastatytą [chasquid](https://github.com/albertito/chasquid) SMTP

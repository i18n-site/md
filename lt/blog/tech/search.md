...
Šio sprendimo našumas itin prastas ir jo negalima naudoti viso teksto paieškai (žr [. Fuse.js Ilga užklausa trunka ilgiau nei 10 sekundes, kaip ją optimizuoti?](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).
...
Sąveikos metu gali būti rodoma indekso [įkėlimo](https://juejin.cn/post/7413586285954154522) eigos juosta [,](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) kad / išvengta vėlavimo įkeliant css progress + .

### IndexedDB Aukštas Lygiagretusis Rašymas

Projektas [idb](https://www.npmjs.com/package/idb) remiantis asinchronine IndexedDB

IndexedDB skaitymas ir rašymas vyksta asinchroniškai. Kuriant indeksą dokumentai bus įkeliami vienu metu, kad būtų sukurta indeksas.

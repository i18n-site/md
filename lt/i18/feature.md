...
Palaiko mišraus HTML vertimą, `<pre>` ir `<code>` žymų HTML turinys, įterptas į `MarkDown` Markdown nėra verčiamas
...
Palaiko antraštės konfigūraciją [HOGO](https://github.com/gohugoio/hugo) tipo statinis tinklaraštis, kuris verčia tik laukus `title` , `summary` ir `description` .
...
Išversta į japonų `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Išversta į prancūzų `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Išversta į japonų `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

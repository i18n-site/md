...
Palaiko mišrų HTML Markdown , `<pre>` ir `<code>` žymų HTML turinys, įterptas į `MarkDown` nėra verčiamas
...
Vertimas turėtų būti atliekamas įvedant komandas ir užbaigiant vienu paspaudimu. Neturėtų būti sudėtingų aplinkos priklausomybių.
...
Klientas yra visiškai atviro kodo, o serverio pusė yra atvirojo kodo 90 [Spustelėkite čia, kad pamatytumėte šaltinio kodą](/i18n.site/src) .

...
| serijos numeris | kodas | kalba | rodomas pavadinimas |
| - | - | - | - |
| 0 | `en` | Anglų | `English` |
| 1 | `zh` | Supaprastinta kinų kalba | `简体中文` |
| 2 | `de` | vokiečių | `Deutsch` |
| 3 | `fr` | Prancūzų kalba | `Français` |
| 4 | `es` | ispanų | `Español` |
| 5 | `it` | italų | `Italiano` |
| 6 | `ja` | japonų | `日本語` |
| 7 | `pl` | lenkas | `Polski` |
...
| 81 | `zh-TW` | Tradicinis kinietiškas | `正體中文` |

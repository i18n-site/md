...
Kadangi `R2` `cloudflare` pasiekti naudojant tinkintą domeno pavadinimą, statiniams failams patalpinti reikia naudoti trečiosios šalies objektų saugyklą.

[backblaze.com](https://www.backblaze.com) pavyzdį, kad parodytume, kaip susieti trečiųjų šalių objektus, kurie turi būti saugomi `cloudflare` .

...
Kiekvienas turi savo mėgstamą redaktorių. Dalinamės `Markdown` geriausios praktikos pavyzdžiais.

Mes naudojame [vscode](https://code.visualstudio.com/) norėdami parašyti `MarkDown` , taip pat įdiegiame papildinį [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) , kad peržiūrėtume realiu laiku rašydami.

...
Tuo pačiu metu galite peržiūrėti toliau pateiktą konfigūraciją, modifikuoti failą ir sukonfigūruoti įkeltą failą, kad jis būtų automatiškai suspaustas iki `avif` , kad sumažintumėte vaizdo dydį.

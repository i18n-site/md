...
Susijęs kodas : [github.com/i18n-site/18x/src/lang.coffee](https://github.com/i18n-site/18x/blob/main/src/lang.coffee)
...
Susijęs kodas : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)

## Vieno Puslapio Programa, Itin Greitas Įkėlimas

Svetainėje naudojama vieno puslapio taikomosios programos architektūra, neatnaujinama perjungiant puslapius ir ypač greitai įkeliama.
...
`404` puslapyje yra mielas plūduriuojantis vaiduoklis, jo akys judės su pele, [➔ Spustelėkite čia, kad pamatytumėte](/404) ,

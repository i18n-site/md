...
Internet zlikwidował dystans w przestrzeni fizycznej, ale różnice językowe wciąż utrudniają ludzką jedność.
...
W obliczu eksplozji informacji i globalnego rynku, aby walczyć o rzadką uwagę, **obsługa wielu języków jest podstawową umiejętnością**.

Nawet jeśli jest to osobisty projekt open source, który chce wpłynąć na szerszą publiczność, powinien od początku wybrać odpowiednie technologie międzynarodowe.

## <a rel=id href="#project" id="project"></a> Opis projektu

Na tej stronie obecnie oferujemy dwa narzędzia wiersza poleceń open source:

* [Narzędzie do tłumaczenia wiersza poleceń i18: MarkDown](/i18/feature)
...
Możesz utworzyć repozytorium kodu dla plików językowych jako open source, korzystając z procesu `Pull Request`, aby globalni użytkownicy mogli uczestniczyć w ciągłej optymalizacji tłumaczeń. Łatwa integracja z [github](//github.com) i innymi społecznościami open source.
...
Pure static, zoptymalizowany pod kątem czytelnictwa, zintegrowany z tłumaczeniami [i18](#i18), jest idealnym wyborem do tworzenia dokumentacji projektów.
...
Nasza strona internetowa została opracowana na tym frameworku, zawiera funkcje użytkownika, płatności itp. ( [kod źródłowy](/i18n.site/src) ), szczegółowy przewodnik zostanie opracowany później.
...
> Powiedzieli: "Chodź, zbuduj wieżę do nieba, aby rozsławiać ludzkość".
>
> Pan zobaczył to i powiedział: "Ludzie mają ten sam język i rasę, teraz, gdy to się stało, wszystko jest możliwe".
>
> Potem przyszedł i sprawił, że ludzie nie mogli się zrozumieć, rozproszając ich po całym świecie.

<p style="text-align:right">— Biblia, Księga Rodzaju</p>

Chcemy budować Internet bez barier językowych.
Chcemy, aby cała ludzkość zjednoczyła się wokół wspólnych marzeń.

Tłumaczenie dokumentacji i stron Markdown to dopiero początek.
Synchronizacja publikacji treści w mediach społecznościowych;
Wsparcie dla dwujęzycznych komentarzy i czatów;
System biletów wielojęzycznych z possibility award;
Rynek sprzedaży komponentów front-end wielojęzycznych;
Mamy przed sobą jeszcze wiele planów.

Czekamy na spotkanie z Tobą, naszymi współtowarzyszami w morzu ludzi.

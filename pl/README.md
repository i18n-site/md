...
Przetłumacz `Markdown` i `YAML` na narzędzie wiersza poleceń ( [kod źródłowy](https://github.com/i18n-site/rust/tree/main/i18) ) w wielu językach.
...
Podzielamy `UNIX` " is a File " i potrafimy zarządzać tłumaczeniami na setki języków bez wprowadzania skomplikowanych i uciążliwych rozwiązań na poziomie przedsiębiorstwa.

Możesz użyć najbardziej znanych narzędzi do `Markdown` tłumaczenia (ale nie możesz dodawać ani usuwać akapitów) i korzystać z najbardziej znanego sposobu kontroli wersji.

Bazę kodu można utworzyć jako otwarte źródło plików językowych, a za pomocą procesu `Pull Request` użytkownicy z całego świata mogą uczestniczyć w ciągłej optymalizacji tłumaczeń. Bezproblemowe połączenie [github](//github.com) I inne społeczności open source.

[→ Aby zapoznać się z instrukcją obsługi, zapoznaj się z dokumentacją projektu](/i18) .
...
Całkowicie statyczny, zoptymalizowany pod kątem czytania i zintegrowany z tłumaczeniem [i18](#i18) jest najlepszym wyborem do tworzenia witryny z dokumentami projektu.
...
Ta strona internetowa została opracowana w oparciu o ten framework i zawiera funkcje użytkownika, płatności i inne ( [kod źródłowy](/i18n.site/src) ). Szczegółowy tutorial zostanie napisany później.

[→ Aby zapoznać się z instrukcją obsługi, zapoznaj się z dokumentacją projektu](/i18n.site) .
...
Nie możemy się doczekać spotkania ludzi o podobnych poglądach w rozległym morzu ludzi.

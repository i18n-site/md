...
Internet zlikwidował odległości w przestrzeni fizycznej, ale różnice językowe nadal stanowią barierę dla ludzkiej jedności.

Chociaż przeglądarki mają wbudowane funkcje tłumaczenia, wyszukiwarki wciąż nie potrafią przeprowadzać kereski w różnych językach.

Media społecznościowe, e-maile, ludzie przyzwyczaili się do skupiania na informacjach w swoim ojczystym języku.

W obliczu eksplozji informacji i globalnego rynku, aby walczyć o rzadką uwagę, **obsługa wielu języków jest podstawą**.

Nawet osobiste projekty open source, które chcą dotrzeć do szerszej publiczności, powinny od początku wybrać odpowiednie technologie międzynarodowe.

## <a rel=id href="#project" id="project"></a> Wprowadzenie do projektu

Na tej stronie oferujemy obecnie dwa narzędzia wiersza poleceń open source:

* [Narzędzie do tłumaczenia wiersza i18: MarkDown](/i18/feature)
* [i18n.site: generator statycznych stron wielojęzycznych](/i18n.site)
...
Potrafi doskonale zachować format `Markdown`. Potrafi identyfikować zmiany w plikach i tłumaczyć tylko zmodyfikowane pliki.
...
Wierzymy w filozofię `UNIX`: "Wszystko jest plikiem", co pozwala nam zarządzać tłumaczeniami na setki języków bez skomplikowanych rozwiązań korporacyjnych.

Możesz używać najbardziej znanych narzędzi do edycji `Markdown` (ale nie dodawać ani usuwać akapitów) i najbardziej znanego sposobu zarządzania wersjami.

Możesz utworzyć repozytorium open source dla plików językowych, korzystając z procesu `Pull Request`, aby globalni użytkownicy mogli uczestniczyć w ciągłym doskonaleniu tłumaczeń. Łatwa integracja z [github](//github.com) i innymi społecznościami open source.
...
### i18n.site: Generator statycznych stron wielojęzycznych

Narzędzie wiersza poleceń ( [kod źródłowy](https://github.com/i18n-site/rust/tree/main/i18n-site) ) do generowania statycznych stron wielojęzycznych.

Pure static, zoptymalizowany pod kątem czytelnictwa, zintegrowany z tłumaczeniami [i18](#i18), jest najlepszym wyborem do tworzenia dokumentacji projektów.

Architektura front-endu opiera się na pełnej architekturze wtyczek, co ułatwia dalszy rozwój. W razie potrzeby można zintegrować funkcje back-endu.

Ta strona została opracowana na podstawie tego frameworka, zawiera funkcje użytkownika, płatności itp. ( [kod źródłowy](/i18n.site/src) ). Szczegółowy przewodnik zostanie opracowany później.
...
> Powiedzieli: "Chodź, zbuduj wieżę, która sięga nieba, i rozsław imię ludzkości".
>
> Pan zobaczył to i powiedział: "Ludzie mają ten sam język i rasę. Teraz, gdy to się stało, wszystko jest możliwe".
>
> Potem przyszedł i sprawił, że ludzie nie mogli się wzajemnie zrozumieć, rozproszając ich po całym świecie.

<p style="text-align:right">— Biblia, Księga Rodzaju</p>

Chcemy budować Internet bez izolacji językowej.
Mamy nadzieję, że cała ludzkość zjednoczy się wokół wspólnych marzeń.

Tłumaczenie Markdown i generowanie stron dokumentacyjnych to dopiero początek.
Synchronizuj publikowanie treści w mediach społecznościowych;
Obsługa dwujęzycznych komentarzy i czatów;
System biletów wielojęzycznych, który może wypłacać nagrody;
Rynek sprzedaży komponentów front-end wielojęzycznych;
Chcemy zrobić znacznie więcej.

Czekamy na spotkanie z ludźmi o podobnych poglądach w morzu ludzi.

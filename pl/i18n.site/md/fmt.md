...
Rozwiązanie punktów kontrolnych zgodne z `i18n.site` polega na wstawieniu tekstu w stylu `<a rel=id href="#xxx" id="xxx"></a>` do `Markdown`, aby ręcznie stworzyć punkty kontrolne pozycjonowania.
...
Kotwice zazwyczaj umieszcza się w tytułach, na przykład:
...
Kod `pug` pozwala na wstawienie `HTML`.

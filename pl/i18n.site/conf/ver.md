...
Podając przykład demonstracyjny projektu:
...
Funkcja przeglądania historii dokumentów jest obecnie w fazie rozwoju.
...
W projekcie demonstracyjnym, oprócz `en/demo2/v`, można zauważyć, że w katalogach `en/blog` i `en/demo1` znajdują się puste pliki `v`.
...
Dzieląc indeksy różnych projektów, można uniknąć opóźnień w dostępie spowodowanych jednorazowym ładowaniem wszystkich indeksów plików na stronie.

...
W tym artykule podzielę się szczegółami implementacji wyszukiwania pełnotekstowego w `i18n.site` na poziomie front-end. Możesz doświadczyć efektu wyszukiwania, odwiedzając [i18n.site](//i18n.site).

Kod jest otwarty [jądro wyszukiwania](//github.com/i18n-site/ie/tree/main/qy) / [interfejs interaktywny](//github.com/i18n-site/plugin/tree/main/qy)

## Przegląd rozwiązań do wyszukiwania pełnotekstowego bez serwera

W przypadku małych witryn internetowych, takich jak dokumenty/blogi osobiste, które są czysto statyczne, samodzielne zbudowanie zaplecza wyszukiwania pełnotekstowego jest niewątpliwie zbyt trudne, a wyszukiwanie pełnotekstowe bez usług jest niewątpliwie lepszą wagą.

Istniejące rozwiązania do wyszukiwania pełnotekstowego bez serwera można podzielić na dwie główne kategorie.

Jedna z nich to usługi wyszukiwania pełnotekstowego od zewnętrznych dostawców, takie jak [algolia.com](//algolia.com), które oferują komponenty do wyszukiwania pełnotekstowego na poziomie front-end.

Takie usługi są płatne i ze względu na problemy z zgodnością stron internetowych nie są dostępne dla użytkowników w Chinach kontynentalnych.
...
Druga kategoria to wyszukiwanie pełnotekstowe na poziomie front-end.

Do bardziej znanych, pełnotekstowych wyszukiwań typu front-end należą [lunrjs](/0) i [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) .

`lunrjs` ma dwa sposoby budowania indeksów, ale oba mają swoje wady.
...
Z powodu niezadowolenia z istniejących rozwiązań, `i18n.site` opracowało nowe, całkowicie front-endowe rozwiązanie do wyszukiwania pełnotekstowego, które ma następujące cechy:
...
Wyszukiwanie pełnotekstowe zaimplementowane wyłącznie na poziomie front-end ma szybkie reakcje i nie wymaga serwera.

Jest bardzo odpowiednie dla małych i średnich stron internetowych, takich jak dokumenty i blogi osobiste.
...
Liczba kodów językowych jest stała, nowe języki będą dodawane na końcu.

| Numer | Kod | Język | Nazwa wyświetlana |
| - | - | - | - |
| 0 | `en` | Angielski | `English` |
| 1 | `zh` | Po chińsku uproszczony | `简体中文` |
...
| 60 | `su` | Sundajski | `Basa Sunda` |
| 61 | `be` | Białoruski | `Беларуская` |
| 62 | `ku` | Kurdyjski | `Kurdî(Navîn)` |
| 63 | `af` | Południowoafrykański | `Afrikaans` |
...
| 81 | `zh-TW` | Po chińsku tradycyjny | `正體中文` |
...
| 113 | `nso` | Sepet | `Sesotho sa Leboa` |
...
| 120 | `ti` | Tigre | `ትግር` |
| 121 | `ts` | Swahili | `Xitsonga` |
| 122 | `tk` | Turkmeński | `Türkmen Dili` |
| 123 | `ak` | Twi (Akan) | `Akan` |
| 124 | `xh` | Język bantu | `isiXhosa` |
| 125 | `yi` | Jidysz | `ייִדיש` |
| 126 | `zu` | Zuluski | `Isi-Zulu` |
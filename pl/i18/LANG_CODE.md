...
| numer seryjny | kod | język | wyświetlana nazwa |
| - | - | - | - |
| 0 | `en` | język angielski | `English` |
| 1 | `zh` | Chiński uproszczony | `简体中文` |
| 2 | `de` | Niemiecki | `Deutsch` |
| 3 | `fr` | Francuski | `Français` |
| 4 | `es` | hiszpański | `Español` |
| 5 | `it` | Włoski | `Italiano` |
| 6 | `ja` | język japoński | `日本語` |
| 7 | `pl` | Polski | `Polski` |
...
| 81 | `zh-TW` | Tradycyjne chińskie | `正體中文` |

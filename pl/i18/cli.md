...
Dzięki temu parametrowi można wyczyścić pliki, które powinny być usunięte w katalogach innych języków.
...
`-h` lub `--help` pozwala wyświetlić pomoc dotyczącą wiersza poleceń.
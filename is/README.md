<h1 style="justify-content:space-between">3Ti.Site · Hugsaðu landamæralaust<img src="//i-01.eu.org/i18n/logo.svg" style="margin-top:-1px;width:42px"></h1>
...
Vísindaskáldsagan „Three-Body“ (kínverskur framburður: `3Ti` ) skáldar upp geimverumenningu sem notar rafsegulbylgjur til að hafa samskipti, með gagnsærri hugsun og blómlegri vísindum og tækni.

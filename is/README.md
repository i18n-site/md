...
* [i18n.site : Multi-tunguage static website generator](/i18n.site)
...
Við gerum okkur áskrifendur " heimspeki `UNIX` Allt er skrá " og getum stjórnað þýðingum á hundruð tungumála án þess að kynna flóknar og fyrirferðarmiklar lausnir á fyrirtækisstigi.
...
Hægt er að búa til kóðagrunn sem opinn uppspretta fyrir tungumálaskrár og með hjálp `Pull Request` ferla geta alþjóðlegir notendur tekið þátt í stöðugri hagræðingu þýðinga. Óaðfinnanleg [github](//github.com) og önnur opinn uppspretta samfélög.
...
#### <a rel=id href="#price" id="price"></a> Mjög samkeppnishæf verð

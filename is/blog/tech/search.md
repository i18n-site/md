...
Kóði opinn : [Leitarkjarna](//github.com/i18n-site/ie/tree/main/qy) / [Gagnvirkt viðmót](//github.com/i18n-site/plugin/tree/main/qy)
...
Í fyrsta lagi, [algolia.com](//algolia.com) þriðju aðila leitarþjónustuveitendur veita framhliða íhluti fyrir leit í fullri texta.
...
Frammistaða þessarar lausnar er afar léleg og ekki er hægt að nota hana fyrir heildartextaleit (sjá [Fuse.js Löng fyrirspurn tekur meira en 10 sekúndur, hvernig á að fínstilla hana?](//stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).
...
Til að bæta viðbragðshraðann notar leitin `yield` rafallinn til að innleiða hleðslu á eftirspurn og skilar `limit` sinn sem spurt er um niðurstöðu.
...
Snúin heildartextaleit útfærð eingöngu á framendanum, engin þörf á netþjóni. Það er mjög hentugur fyrir litlar og meðalstórar vefsíður eins og skjöl og persónuleg blogg.

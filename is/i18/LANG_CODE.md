...
| 2 | `de` | þýska, Þjóðverji, þýskur | `Deutsch` |
| 3 | `fr` | franska | `Français` |
| 4 | `es` | spænska, spænskt | `Español` |
| 5 | `it` | ítalska | `Italiano` |
| 6 | `ja` | japönsku | `日本語` |
| 7 | `pl` | pólsku | `Polski` |
| 8 | `pt` | portúgalska | `Português(Brasil)` |
| 9 | `ru` | Rússneskt | `Русский` |
| 10 | `nl` | hollenska | `Nederlands` |
| 11 | `tr` | tyrkneska | `Türkçe` |
| 12 | `sv` | sænsku | `Svenska` |
| 13 | `cs` | tékkneska | `Čeština` |
| 14 | `uk` | úkraínska | `Українська` |
| 15 | `hu` | ungverska, Ungverji, ungverskt | `Magyar` |
...
| 34 | `et` | eistneska, eisti, eistneskur | `Eesti` |
...
| 122 | `tk` | Túrkmenska | `Türkmen Dili` |

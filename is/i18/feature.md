...
Þýðingar athugasemdir þurfa að gefa til kynna tungumálið á eftir ` ``` ` , svo : ` ```rust ` .
...
Styður uppsetningu [HOGO](https://github.com/gohugoio/hugo) á kyrrstæðum bloggi, sem þýðir aðeins reiti `title` , `summary` og `description` .
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` á japönsku :
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` á japönsku :

![](//p.3ti.site/1720199550.avif)

Þýðing á ofangreindu yfir á frönsku (einnig endurskrifa eiginnöfnin og bæta við staku `... ` ) DeepL

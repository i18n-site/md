...
[i18n.site/payBill](//i18n.site/payBill) þarf að binda kreditkort fyrir greiðslu (engin endurhleðsla er nauðsynleg, vefsíðan mun sjálfkrafa draga gjöld eftir notkun, [sjá heimasíðuna fyrir verðlagningu](/#price) ).
...
Ef þú vilt hunsa ákveðnar skrár og ekki þýða þær (svo sem ókláruð uppkast) geturðu notað `ignore` reitinnstillinguna.

...
`i18n.site` mun sjálfgefið birta innihald síðunnar í `npmjs.com` , með hjálp [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) og annað `CDN` innihald hlaðið á `npm` .
...
> Það yfirgefur óþarfa skraut og sýnir innihald í sinni hreinustu mynd.
...
`404` síða er með sætan fljótandi draug, augu hennar munu hreyfast með músinni, [➔ Smelltu hér til að skoða](/404) ,
...
Það eru margar litlar kröfur sem eru mikilvægar en ekki aðkallandi. Þróunarteymið mun úthluta verkefnum sem byggjast á tækninni sem þú ert góður í og bæta þróunarskjölin á sama tíma og kröfurnar eru úthlutaðar.
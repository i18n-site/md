...
Eftir að notandinn skiptir um tungumál handvirkt mun val notandans verða minnst.
...
`i18n.site` mun sjálfgefið birta innihald síðunnar í `npmjs.com` , með [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) og annað `CDN` innihald sem er hlaðið á `npm` .
...
Það er sætur lítill fljótandi draugur á `404` síðunni, sem augu hans munu hreyfast með músinni, [➔ Smelltu hér til að skoða](/404) ,
...
Það eru margar litlar kröfur sem eru mikilvægar en ekki aðkallandi. Þróunarteymið mun úthluta æfingaverkefnum í samræmi við þá tækni sem þú ert góður í og bæta þróunarskjölin á sama tíma og kröfurnar eru úthlutaðar.
...
Vegna þess að `cloudflare` er hægt að nálgast `R2` með sérsniðnu lénsheiti, þarf að nota hlutageymslu þriðja aðila til að setja fastar skrár.

Hér [backblaze.com](https://www.backblaze.com) við sem dæmi til að sýna hvernig á að binda hluti frá þriðja aðila til að geyma á `cloudflare` .

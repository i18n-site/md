...
Við notum [vscode](https://code.visualstudio.com/) til að skrifa `MarkDown` , og setjum einnig upp viðbótina [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) til að forskoða í rauntíma á meðan þú skrifar.

...
Notaðu [PicList](https://github.com/Kuingsmile/PicList) til að hlaða upp myndum, mundu að stilla upphleðslutakkann og hlaða upp skjámyndinni með einum smelli.

Það styður sjálfkrafa afritun skráarnafnsins á `Markdown` snið eftir upphleðslu, sem bætir skilvirkni til muna.

Á sama tíma geturðu vísað í eftirfarandi uppsetningu, breytt skránni og stillt upphlaðna skrá þannig að hún sé sjálfkrafa þjappað í `avif` til að minnka myndstærðina.

...
## Myndir/Myndbönd/Tenglar Á Mörgum Tungumálum

Eftir að `MarkDown` hefur verið breytt í `HTML` verður `$LANG` í eiginleikum `src` og `href` skipt út fyrir núverandi [tungumálakóða](/i18/LANG_CODE) .

Með þessari breytu geturðu náð fjöltyngingu mynda/myndbanda/tengla.
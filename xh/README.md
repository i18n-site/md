<h1 style="justify-content:space-between">3Ti.Isiza ⋅ Ukucinga Ngaphandle kwemida<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

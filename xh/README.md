...
Nokuba yiprojekthi yomthombo ovulekileyo wobuqu ofuna ukuba nefuthe kubaphulaphuli ababanzi, kufuneka yenze ukhetho lwetekhnoloji yamazwe ngamazwe kwasekuqaleni.
...
Isixhobo somgca womyalelo ( [ikhowudi yemvelaphi](https://github.com/i18n-site/rust/tree/main/i18) ) eguqulela `Markdown` kunye no `YAML` kwiilwimi ezininzi.
...
Guqula umbhalo wentsusa kwaye uguqulelwe ngoomatshini kwakhona, ukuguqulwa kwesandla kwinguqulelo akusayi kubhalwa ngaphezulu (ukuba lo mhlathi wombhalo wokuqala awulungiswanga).
...
Isiseko sekhowudi sinokudalwa njengomthombo ovulekileyo weefayile zolwimi, kwaye ngoncedo lweenkqubo `Pull Request` , abasebenzisi behlabathi banokuthatha inxaxheba ekuphuculeni okuqhubekayo kweenguqulelo. Unxibelelwano olungenamthungo [github](//github.com) nolunye umthombo ovulekileyo woluntu.

[→ Kwisikhokelo somsebenzisi, nceda ufunde amaxwebhu eprojekthi](/i18) .

## Uguqulelo Lomatshini Olusemgangathweni

Siphuhlise isizukulwana esitsha sobuchwepheshe boguqulo oludibanisa iingenelo zobugcisa zoomatshini boguqulo bemveli kunye nemizekelo yolwimi olukhulu ukwenza iinguqulelo zichaneke, zigudileyo kwaye zibe ntle.
...
[Cofa apha ukugunyazisa kwaye i18n.site ngokuzenzekelayo github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) kwaye **ufumane ibhonasi $50** .
...
Ixhasa izimvo ngeelwimi ezimbini kunye namagumbi okuncokola;

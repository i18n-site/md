<h1 style="display:flex;justify-content:space-between">i18n.site Izisombululo zamazwe ngamazwe<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Ngokuqhambuka kolwazi kunye nentengiso yehlabathi, ukuze kukhuphisane ingqalelo enqabileyo, **ukuxhasa iilwimi ezininzi sisakhono esisisiseko** .
...
## <a rel=id href="#project" id="project"></a> Inkcazo yeProjekthi
...
`Markdown` kwaye `YAML` kwisixhobo somgca womyalelo ( [ikhowudi yemvelaphi](https://github.com/i18n-site/rust/tree/main/i18) ) kwiilwimi ezininzi.
...
Sabelana " `UNIX` Yonke into yiFayile " kwaye inokulawula iinguqulelo kumakhulu eelwimi ngaphandle kokwazisa izisombululo ezintsonkothileyo nezinzima kwinqanaba leshishini.

Ungasebenzisa ezona zixhobo ziqhelekileyo `Markdown` uguqulo (kodwa awukwazi ukongeza okanye ukucima imihlathi), kwaye usebenzise eyona ndlela iqhelekileyo yokwenza ulawulo loguqulelo.

Isiseko sekhowudi singayilwa njengomthombo ovulekileyo weefayile zolwimi, kwaye ngoncedo `Pull Request` , abasebenzisi behlabathi banokuthatha inxaxheba kusenzelo oluqhubekayo lweenguqulelo. Uqhagamshelo olungenamthungo [github](//github.com)

[→ Kwisikhokelo somsebenzisi, nceda ufunde amaxwebhu eprojekthi](/i18) .

## Xindaya Inguqulelo Ekumgangatho Ophezulu

Siphuhlise isizukulwana esitsha sobuchwepheshe boguqulo oludibanisa uncedo lobuchule lwemodeli yoguqulelo lomatshini kunye neemodeli ezinkulu zolwimi ukwenza iinguqulelo ezichanekileyo, ezigudileyo kwaye ezintle.

Iimvavanyo ezingaboniyo zibonisa ukuba umgangatho wethu woguqulelo ungcono kakhulu xa uthelekiswa neenkonzo ezifanayo.

Ukufezekisa umgangatho ofanayo, isixa sokuhlela ngesandla esifunwa yiToliki kaGoogle `ChatGPT` ngamaxesha `2.67` kunye namaxesha `3.15` ngokulandelelanayo.
...
Ime ngokuthe ngqo, ilungiselelwe amava okufunda, kwaye idityaniswe noguqulo lwe [i18](#i18) lolona khetho lulungileyo lokwakha indawo yoxwebhu lweprojekthi.
...
Le webhusayithi iphuhliswe ngokusekelwe kwesi sikhokelo kwaye ibandakanya umsebenzisi, intlawulo kunye neminye imisebenzi ( [ikhowudi yomthombo](/i18n.site/src) Isifundo esicacileyo siya kubhalwa kamva.

[→ Kwisikhokelo somsebenzisi, nceda ufunde amaxwebhu eprojekthi](/i18n.site) .

## Soloko Ufumaneka

Nceda <button onclick="mailsub()">ucofe le imeyile ukuze ubhalisele uhlaziyo lwemveliso</button> kwaye <button onclick="webpush()">uvule umkhangeli zincwadi otyhalayo</button> Siya kukwazisa xa uhlaziyo lwemveliso lwenziwa.

Wamkelekile ukuba ulandele [X.COM: @i18nSite](https://x.com/i18nSite) zethu zentlalo / [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) .

...
Ixhasa ukuguqulelwa kwe-mixed HTML , umxholo kwi `<pre>` kunye Markdown `<code>` iithegi ze- HTML ezifakwe kwi `MarkDown` aziguqulelwanga
...
## Inkxaso Yoguqulelo `HOGO` Ubumbeko Lwesihloko
...
ITshayina, iJapan, kunye neKorea azinabo oonobumba abakhulu okanye abancinci, kodwa izihloko zesiNgesi zidla ngoonobumba abakhulu.

`i18` unokuqaphela isihloko ku `MarkDown` , kwaye uya kwenza ngokuzenzekelayo unobumba wokuqala xa eguqulela kulwimi olunovakalelo.
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` kwisiJapan :

![](//p.3ti.site/1720199550.avif)

DeepL okungasentla kwisiFrentshi (uphinde ubhale amagama afanelekileyo kwaye wongeze umnqakathi `... ` ):
...
Umxhasi ngumthombo ovuleleke ngokupheleleyo, kwaye icala 90 % [lekhowudi](/i18n.site/src) liyimvelaphi evulekileyo.

...
Nceda wongeze ubumbeko obufana noku kulandelayo kumhlathi we `server` nginx Nceda utshintshe `/root/i18n/md/out/ol/htm` kwindlela yeprojekthi yakho `out/ol/htm`

...
Kwiprojekthi yedemo, ukongeza kwi `en/demo2/v` , unokubona kwakhona ukuba kukho iifayile `v` ezingenanto kwi- `en/blog` kunye `en/demo1` yolawulo.

I `v` engenanto ayiyi kuboniswa kuluhlu lwebar esecaleni, kodwa okoko nje kukho ifayile `v` , isalathisi esizimeleyo siya kuveliswa kwiifayile kuluhlu kunye ne-subdirectories.

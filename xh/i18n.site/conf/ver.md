...
Nantsi i `en/` yikhowudi yolwimi ehambelana nolwimi lomthombo wokuguqulela olulungiselelwe ngu `.i18n/conf.yml` .

Ukuba ulwimi lwakho lwemvelaphi ayisosiNgesi, ngoko ke ifayile `v` kufuneka ibekwe kuluhlu lweprojekthi yolwimi lwakho lomthombo.
...
## Sebenzisa Iifayile Ezi `v` Ezingenanto Ukwahlula Izalathiso Zefayile Yeeprojekthi Ezahlukeneyo

Kwiprojekthi yedemo, ukongeza kwi `en/demo2/v` , unokubona kwakhona ukuba kukho iifayile `v` ezingenanto kwi `en/blog` kunye ne `en/demo1` yolawulo.
...
Ngokwahlula izalathiso zeeprojekthi ezahlukeneyo, unokunqanda ufikelelo olucothayo olubangelwa kukulayisha isalathiso sazo zonke iifayile kwindawo yonke ngaxeshanye.

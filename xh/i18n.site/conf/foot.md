...
* `foot.css` :
* `import.css` : `i18n.site` sihleli kwindawo yonke
* `conf.css` ii icon kunye :

### Ifonti Ye Icon

I icon esezantsi iveliswa ngokwenza ifonti `F` iconfont.cn [uguqulelo lwesiNgesi](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

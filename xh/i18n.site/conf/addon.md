...
* `i18n.addon/toc` :
  Veza isalathiso sikavimba weefayili `json` esekwe ku `TOC` , senziwa ngokungagqibekanga
...
Ixesha lokubaleka elakhelwe `js` lisekwe kuphuhliso lwesibini lwe [boa](https://github.com/boa-dev/boa) kwaye imisebenzi eyakhelweyo yile ilandelayo :

...
Antall språkkoder er fast, og nye språk vil bli lagt til ved behov.

| Nummer | Kode | Språk | Visningsnavn |
| - | - | - | - |
...
| 122 | `tk` | Turkmensk | `Türkmen Dili` |
| 123 | `ak` | Twi (Akan) | `Akan` |
| 124 | `xh` | Bantuspråk | `isiXhosa` |
| 125 | `yi` | Jiddisk | `ייִדיש` |

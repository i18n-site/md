...
I18N.SITE, en statisk nettstedsgenerator som støtter automatisk oversettelse til [mer enn hundre forskjellige språk](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

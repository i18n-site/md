...
Kommandolinje Markdown Yaml , hjelper deg med å bygge et internasjonalt dokumentnettsted som støtter [hundrevis av språk](/i18/LANG_CODE) ...
...
Oversett `Markdown` og `YAML` til et kommandolinjeverktøy ( [kildekode](https://github.com/i18n-site/rust/tree/main/i18) ) på flere språk.

Kan perfekt opprettholde formatet til `Markdown` Kan identifisere filendringer og bare oversette endrede filer.
...
Vi deler " `UNIX` Everything is a File " og kan administrere oversettelser på hundrevis av språk uten å introdusere komplekse og tungvinte løsninger på bedriftsnivå.

Du kan bruke de mest kjente verktøyene for `Markdown` oversettelsen (men du kan ikke legge til eller slette avsnitt), og bruke den mest kjente måten å utføre versjonskontroll på.

En kodebase kan opprettes som en åpen kildekode for språkfiler, og ved hjelp av `Pull Request` s prosess kan globale brukere delta i den kontinuerlige optimaliseringen av oversettelser. Sømløs [github](//github.com) og andre åpen kildekode-samfunn.

[→ For brukerveiledning, vennligst les prosjektdokumentasjonen](/i18) .
...
Rent statisk, optimert for leseopplevelse og integrert med oversettelsen av [i18](#i18) er det det beste valget for å bygge et prosjektdokumentnettsted.
...
Denne nettsiden er utviklet basert på dette rammeverket og inkluderer bruker-, betalings- og andre funksjoner ( [kildekode](/i18n.site/src) ) En detaljert opplæring vil bli skrevet senere.

[→ For brukerveiledning, vennligst les prosjektdokumentasjonen](/i18n.site) .

...
Ankere plasseres vanligvis i titler, som for eksempel:
...
Ved å kombinere disse to punktene kan man enkelt skrive `HTML` i `MarkDown` for å oppnå forskjellige visningseffekter.

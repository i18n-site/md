...
> گذشتگان برج هایی می ساختند که به آسمان می رسید و به دروازه خدا می رسید و اعتبار نسل بشر را ارتقا می داد.
>
> خداوند گفت که مردم قبیله خود را تشکیل می دهند و به یک زبان صحبت می کنند. ساختن برج فقط یک مقدمه است. حالا که این کار تمام شد، در آینده همه کارها را انجام خواهند داد.
>
> سپس خداوند آمد و مردم را در جاهای مختلف پراکنده کرد، زیرا نتوانستند یکدیگر را درک کنند.
>
> از آن زمان، اختلافات انسانی ادامه دارد و دیگر برج بابل در جهان وجود ندارد.

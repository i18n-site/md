...
با استفاده از رسانه های اجتماعی و ایمیل، مردم عادت کرده اند که بر منابع اطلاعاتی به زبان مادری خود تمرکز کنند.
...
ما در فلسفه `UNIX` مشترک " همه چیز یک فایل " است و می تواند ترجمه ها را به صدها زبان بدون معرفی راه حل های پیچیده و دست و پا گیر در سطح سازمانی مدیریت کند.
...
[اینجا را کلیک کنید تا github را به طور خودکار دنبال کنید i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) **$50 دریافت کنید** .
...
لطفاً <button onclick="mailsub()">روی این ایمیل کلیک کنید تا در بهروزرسانیهای محصول مشترک شوید</button> و <button onclick="webpush()">فشار مرورگر را فعال کنید</button> ، ما به شما اطلاع خواهیم داد.
...
>
> خداوند این را دید و گفت: همه انسانها زبان و نژاد یکسانی دارند، اکنون که این امر انجام شده است، همه چیز انجام خواهد شد.
>
...
ما می خواهیم اینترنت بدون جداسازی زبان بسازیم.
ما امیدواریم که همه بشریت با یک رویای مشترک گرد هم آیند.

سایت ترجمه و مستندسازی Markdown تازه شروع کار است.
...
به خلق آینده ای بدون مرز با هم خوش آمدید.
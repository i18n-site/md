...
ترجمه قابل ویرایش است، متن اصلی را تغییر دهید، و هنگامی که دوباره به صورت ماشینی ترجمه شود، تغییرات دستی در ترجمه بازنویسی نمی شود (اگر این پاراگراف از متن اصلی اصلاح نشده باشد).

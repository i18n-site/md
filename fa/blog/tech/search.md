...
1. از جستجوی پیشوند پشتیبانی می کند که می تواند نتایج جستجو را در زمان تایپ کاربر به صورت بلادرنگ نمایش دهد.
1. آفلاین موجود است
...
جدول فهرست متن اصلی را ذخیره نمی کند، فقط کلمات را ذخیره می کند، که باعث کاهش حجم ذخیره سازی می شود.

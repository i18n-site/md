...
اگر میخواهید به همه زبانهای پشتیبانیشده ترجمه کنید، لطفاً بعد از `:` آن را خالی بگذارید. برای مثال
...
به عنوان مثال، `_* ` در فایل تنظیمات بالا به این معنی است که فایل هایی که با `_` شروع می شوند ترجمه نمی شوند.

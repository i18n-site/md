...
علاوه بر ترجمه، برنامه فایل‌های زیر را نیز تولید می‌کند، لطفاً آنها را به مخزن اضافه کنید.
...
در میان آنها، محتوای `.i18n/cache/.gitignore` به شرح زیر است:
...
این بدان معناست که تمام فایل‌های دایرکتوری `.i18n/cache/` (به جز `.i18n/cache/.gitignore`) نادیده گرفته می‌شوند.

اگر نرم‌افزار کنترل نسخه شما `git` نیست، لطفاً طبق این پیکربندی آن را نادیده بگیرید.

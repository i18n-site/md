...
## پشتیبانی از پیکربندی هدر ترجمه `HOGO`
...
`i18` می تواند عنوان را در `MarkDown` تشخیص دهد و هنگام ترجمه به زبان حساس به حروف بزرگ، به طور خودکار حرف اول را بزرگ می کند.
...
کلاینت کاملاً منبع باز است و سمت 90 کد [منبع](/i18n.site/src) باز است.

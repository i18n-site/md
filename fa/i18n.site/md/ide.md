...
هرکسی ویرایشگر مورد علاقه خود را دارد `Markdown`

ما از `MarkDown` استفاده [vscode](https://code.visualstudio.com/) کنیم و همچنین پلاگین [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) را برای پیش نمایش در زمان نوشتن نصب می کنیم.

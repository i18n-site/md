...
هنوز پروژه آزمایشی را به عنوان مثال در نظر می گیریم، `.i18n/htm/foot.pug` در فهرست `md` ، پاورقی وب سایت را مشخص می کند.
...
با استفاده از `${I18N.xxx}` مشابه این روش نوشتن، همراه با `i18n.yml` ، می توانید بین المللی سازی چند زبانه فوتر را بدست آورید.

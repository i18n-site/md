...
فایل پیکربندی `.i18n/htm/ol.yml` را در پروژه آزمایشی به عنوان مثال در نظر بگیرید
...
در پیکربندی، لطفاً `i18n.site` به مقدار `host:` در `.i18n/htm/ol.yml` تغییر دهید، چندین ذخایر شی را می توان تحت `s3` پیکربندی کرد، و فیلد `region` اختیاری است (بسیاری از فروشگاه های شی نیازی به تنظیم این فیلد ندارند).
...
قانون تبدیل را مطابق شکل زیر اضافه کنید، ابتدا آن را قرار دهید (اولین اولویت کمترین اولویت را دارد):

...
اطلاعات نویسنده را می توان در متا اطلاعات مقاله نوشت، مانند:
...
پروژه آزمایشی [`begin.md`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/blog/news/begin.md?plain=1) و [`author.yml`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/author.yml) را ببینید

...
| 45 | `ms` | Malaysia | `Melayu` |
| 46 | `eu` | Baski | `Euskara` |
| 47 | `bs` | Bosnia | `Bosnian` |
| 48 | `lb` | Luxemburg | `Letzeburgesch` |
| 49 | `lv` | Latvia | `Latviešu` |
| 50 | `ka` | Georgia | `ქართული` |
| 51 | `sq` | Albania | `Shqip` |
| 52 | `mr` | Marathi | `मराठी` |
| 53 | `az` | Azerbaidžan | `Azərbaycan` |
| 54 | `mk` | Makedonia | `Македонски` |
| 55 | `tl` | Tagalog (Filippiini) | `Wikang Tagalog` |
| 56 | `cy` | Wales | `Cymraeg` |
| 57 | `bn` | Bengali | `বাংলা` |
| 58 | `ta` | Tamil | `தமிழ்` |
| 59 | `jv` | Jaava | `Basa Jawa` |
| 60 | `su` | Sunda | `Basa Sunda` |
| 61 | `be` | Valko-Venäjä | `Беларуская` |
| 62 | `ku` | Kurdi | `Kurdî(Navîn)` |
| 63 | `af` | Afrikaans | `Afrikaans` |
| 64 | `fy` | Friisi | `Frysk` |
| 65 | `tg` | Tadžikistan | `Toğikī` |
| 66 | `ur` | Urdu | `اردو` |
| 67 | `qu` | Quechua | `Kichwa` |
| 68 | `ml` | Malajalam | `മലയാളം` |
| 69 | `sw` | Swahili | `Kiswahili` |
| 70 | `ga` | Irlanti | `Gaeilge` |
| 71 | `uz` | Uzbeki | `Uzbek(Latin)` |
| 72 | `mi` | Maori | `Te Reo Māori` |
| 73 | `yo` | Joruba | `Èdè Yorùbá` |
| 74 | `kn` | Kannada | `ಕನ್ನಡ` |
| 75 | `am` | Amhara | `አማርኛ` |
| 76 | `hy` | Armenia | `Հայերեն` |
| 77 | `as` | Assam | `অসমীয়া` |
...
| 84 | `ee` | Ewe | `Eʋegbe` |
| 85 | `fil` | Filippiini (Tagalog) | `Filipino` |
| 86 | `gn` | Guarani | `Guarani` |
| 87 | `gu` | Gujarati | `ગુજરાતી` |
| 88 | `ha` | Hausa | `Hausa` |
| 89 | `haw` | Havaiji | `Hawaiian` |
| 90 | `hmn` | Hmong | `Hmong` |
...
| 105 | `my` | Burma | `မြန်မာ` |
| 106 | `ny` | Nyasa (Chichewa) | `ChiCheŵa` |
...
| 119 | `tt` | Tatar | `Татар` |
| 120 | `ti` | Tigrinja | `ትግር` |
| 121 | `ts` | Chonga | `Xitsonga` |
| 122 | `tk` | Turkmenistan | `Türkmen Dili` |
| 123 | `ak` | Twi (Akan) | `Akan` |
| 124 | `xh` | Bantu | `isiXhosa` |
| 125 | `yi` | Jiddiš | `ייִדיש` |

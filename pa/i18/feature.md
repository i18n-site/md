...
HTML Markdown ਦੇ ਅਨੁਵਾਦ ਦਾ ਸਮਰਥਨ ਕਰਦਾ ਹੈ, `MarkDown` ਵਿੱਚ ਸ਼ਾਮਲ HTML ਦੇ `<pre>` ਅਤੇ `<code>` ਟੈਗਾਂ ਵਿੱਚ ਸਮੱਗਰੀ ਅਨੁਵਾਦ ਨਹੀਂ ਕੀਤੀ ਗਈ ਹੈ
...
ਦੇ ਸਿਰਲੇਖ ਸੰਰਚਨਾ ਦਾ [HOGO](https://github.com/gohugoio/hugo) ਕਰਦਾ ਹੈ ਸਟੈਟਿਕ ਬਲੌਗ, ਅਤੇ ਸਿਰਫ `title` , `summary` , `brief` , ਅਤੇ `description` ਦਾ ਅਨੁਵਾਦ ਕਰਦਾ ਹੈ।
...
### ਜਦੋਂ ਅੰਗਰੇਜ਼ੀ ਵਿੱਚ ਅਨੁਵਾਦ ਕੀਤਾ ਜਾਂਦਾ ਹੈ, ਤਾਂ ਸਿਰਲੇਖ ਦਾ ਪਹਿਲਾ ਅੱਖਰ ਆਟੋਮੈਟਿਕਲੀ ਕੈਪੀਟਲ ਹੋ ਜਾਂਦਾ ਹੈ।
...
ਜਾਪਾਨੀ : ਵਿੱਚ `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` ਕੀਤਾ ਗਿਆ

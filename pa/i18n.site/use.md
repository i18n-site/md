...
ਅਸੀਂ ਪਹਿਲਾਂ ਡੈਮੋ ਰਿਪੋਜ਼ਟਰੀ ਨੂੰ ਕਲੋਨ ਕਰਦੇ ਹਾਂ ਅਤੇ ਕਮਾਂਡ ਨੂੰ ਹੇਠ ਲਿਖੇ ਅਨੁਸਾਰ ਚਲਾਉਂਦੇ ਹਾਂ:
...
`md/.i18n/htm/ol.yml` ਸੰਪਾਦਿਤ ਕਰੋ ਅਤੇ ਆਪਣੇ ਖੁਦ ਦੇ `npm` ਪੈਕੇਜ ਨਾਮ ਵਿੱਚ `i18n.site` `v: //unpkg.com/i18n.site` ਵਿੱਚ ਬਦਲੋ।

ਬਸ 'ਤੇ ਖਾਲੀ ਪੈਕੇਜ ਨਾਮ ਦੀ ਵਰਤੋਂ ਕਰੋ [npmjs.com](//npmjs.com)

ਪੈਕੇਜ `npm` ਦੇ ਆਧਾਰ 'ਤੇ ਪ੍ਰਕਾਸ਼ਿਤ ਕਰਦੇ ਸਮੇਂ, `v:` ਮੁੱਲ ਦੇ ਅਗੇਤਰ ਲਈ **`//unpkg.com/` ਵਰਤੋਂ ਕਰਨਾ ਯਕੀਨੀ** ਬਣਾਓ `i18n.site` ਨਵੇਂ ਰੀਲੀਜ਼ਾਂ ਨੂੰ ਸਮੇਂ ਸਿਰ ਦੇਖਣ ਲਈ ਇਸ ਅਗੇਤਰ ਮਾਰਗ ਦੇ ਅਧੀਨ `/.v` ਦੇ ਕੈਸ਼ ਸਮੇਂ ਨੂੰ ਵਿਸ਼ੇਸ਼ ਤੌਰ 'ਤੇ ਅਨੁਕੂਲਿਤ ਕੀਤਾ ਹੈ।
...
ਫਿਰ, `md/out/ol/v` ਡਾਇਰੈਕਟਰੀ ਵਿੱਚ ਸਮੱਗਰੀ ਨੂੰ `v:` ਵਿੱਚ ਸੈੱਟ ਕੀਤੇ URL ਪ੍ਰੀਫਿਕਸ ਪਾਥ ਲਈ ਕੌਂਫਿਗਰ ਕਰੋ।
...
ਉਪਰੋਕਤ ਤਸਵੀਰ ਵਿੱਚ ਨਿਯਮ ਹੇਠ ਲਿਖੇ ਅਨੁਸਾਰ ਹਨ, ਕਿਰਪਾ ਕਰਕੇ ਹੇਠਾਂ ਦਿੱਤੀ ਗਈ ਡੋਮੇਨ ਨਾਮ ਨਾਲ `i18n.site` ਬਦਲੋ।
...
ਫਿਰ, ਮੇਨਲੈਂਡ + ਵਿੱਚ ਕਲਾਉਡ ਵਿਕਰੇਤਾਵਾਂ ਦੇ ਆਬਜੈਕਟ ਸਟੋਰੇਜ ਦੀ ਵਰਤੋਂ ਕਰੋ `CDN` ਹੇਠਾਂ ਦਿੱਤੀ ਸਮੱਗਰੀ ਨੂੰ ਲਾਗੂ ਕਰੋ `out/ol/htm` !
...
ਜੇਕਰ ਤੁਸੀਂ ਆਪਣੀ ਮੁੱਖ ਵੈੱਬਸਾਈਟ ਦੇ ਤੌਰ 'ਤੇ ਵੈੱਬਸਾਈਟ ਬਣਾਉਣ ਲਈ `i18n.site` ਵਰਤੋਂ ਕਰਦੇ ਹੋ, ਤਾਂ ਤੁਹਾਨੂੰ ਆਮ ਤੌਰ 'ਤੇ ਪੈਨ-ਡੋਮੇਨ ਰੀਡਾਇਰੈਕਸ਼ਨ ਨੂੰ ਕੌਂਫਿਗਰ ਕਰਨ ਦੀ ਲੋੜ ਹੁੰਦੀ ਹੈ, ਯਾਨੀ, `*.xxx.com` ( `www.xxx.com` ਸਮੇਤ) ਤੋਂ `xxx.com` ਤੱਕ ਪਹੁੰਚ ਨੂੰ ਰੀਡਾਇਰੈਕਟ ਕਰਨ ਦੀ ਲੋੜ ਹੁੰਦੀ ਹੈ।

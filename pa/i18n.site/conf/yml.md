...
`use: Toc` ਦਾ ਮਤਲਬ ਹੈ ਇੱਕ `Toc` ਟੈਂਪਲੇਟ ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਰੈਂਡਰ ਕਰਨਾ, ਜੋ ਇੱਕ ਸਿੰਗਲ `Markdown` ਟੈਂਪਲੇਟ ਨੂੰ ਪੇਸ਼ ਕਰ ਰਿਹਾ ਹੈ।
...
ਉਪਰੋਕਤ ਲਿਖਣ ਦਾ ਤਰੀਕਾ `url: xxx` ਹੋਣ ਦੇ ਬਰਾਬਰ ਹੈ, ਅਤੇ ਇਸਦੀ ਸੰਬੰਧਿਤ ਫਾਈਲ `en/xxx/TOC` ਹੈ।

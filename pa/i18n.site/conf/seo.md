...
ਸੰਰਚਨਾ ਵਿੱਚ, ਕਿਰਪਾ ਕਰਕੇ `i18n.site` `.i18n/htm/ol.yml` ਵਿੱਚ `host:` ਦੇ ਮੁੱਲ ਵਿੱਚ ਬਦਲੋ, ਮਲਟੀਪਲ ਆਬਜੈਕਟ ਸਟੋਰਾਂ ਨੂੰ `s3` ਹੇਠਾਂ ਸੰਰਚਿਤ ਕੀਤਾ ਜਾ ਸਕਦਾ ਹੈ, ਅਤੇ `region` ਖੇਤਰ ਵਿਕਲਪਿਕ ਹੈ (ਬਹੁਤ ਸਾਰੇ ਆਬਜੈਕਟ ਸਟੋਰਾਂ ਨੂੰ ਇਸ ਖੇਤਰ ਨੂੰ ਸੈੱਟ ਕਰਨ ਦੀ ਲੋੜ ਨਹੀਂ ਹੈ)।
...
ਫਿਰ ਹੇਠ ਲਿਖੇ ਅਨੁਸਾਰ [ਕਿਨਾਰੇ EdgeJS](//console.bce.baidu.com/cdn/#/cdn/ejs/list) ਵਿੱਚ ਸਕ੍ਰਿਪਟ ਬਣਾਓ
...
`Debug` ਕਲਿੱਕ ਕਰੋ, ਫਿਰ ਪੂਰੇ ਨੈੱਟਵਰਕ 'ਤੇ ਪ੍ਰਕਾਸ਼ਿਤ ਕਰੋ 'ਤੇ ਕਲਿੱਕ ਕਰੋ।
...
ਉਦਾਹਰਨ ਲਈ, [ਹੁਆਵੇਈ DNS](https://www.huaweicloud.com) ਮੁਫ਼ਤ ਖੇਤਰੀ ਵਿਸ਼ਲੇਸ਼ਣ ਪ੍ਰਦਾਨ ਕਰਦਾ ਹੈ, ਜਿਸ ਨਾਲ ਮੁੱਖ ਭੂਮੀ ਚੀਨੀ ਟ੍ਰੈਫਿਕ Baidu ਸਮਾਰਟ ਕਲਾਊਡ ਰਾਹੀਂ ਜਾ ਸਕਦਾ ਹੈ, ਅਤੇ ਅੰਤਰਰਾਸ਼ਟਰੀ ਆਵਾਜਾਈ `cloudflare` ਰਾਹੀਂ ਜਾ ਸਕਦੀ ਹੈ।
...
ਕਿਉਂਕਿ `R2` ਇੱਕ ਕਸਟਮਾਈਜ਼ਡ ਡੋਮੇਨ ਨਾਮ ਦੁਆਰਾ ਐਕਸੈਸ `cloudflare` ਕੀਤਾ ਜਾ ਸਕਦਾ ਹੈ, ਇੱਕ ਥਰਡ-ਪਾਰਟੀ ਆਬਜੈਕਟ ਸਟੋਰੇਜ ਨੂੰ ਸਥਿਰ ਫਾਈਲਾਂ ਨੂੰ ਰੱਖਣ ਲਈ ਵਰਤਣ ਦੀ ਲੋੜ ਹੈ।

ਇੱਥੇ ਅਸੀਂ ਇਹ ਦਰਸਾਉਣ ਲਈ ਇੱਕ ਉਦਾਹਰਣ ਦੇ ਤੌਰ 'ਤੇ ਲੈਂਦੇ [backblaze.com](https://www.backblaze.com) ਕਿ `cloudflare` 'ਤੇ ਸਟੋਰ ਕੀਤੇ ਜਾਣ ਵਾਲੇ ਥਰਡ-ਪਾਰਟੀ ਆਬਜੈਕਟ ਨੂੰ ਕਿਵੇਂ ਬੰਨ੍ਹਣਾ ਹੈ।
...
`SSL` ਵਿੱਚੋਂ `cloudflare` ਨੂੰ ਸੋਧੋ → ਇਨਕ੍ਰਿਪਸ਼ਨ ਮੋਡ, `Full` 'ਤੇ ਸੈੱਟ ਕਰੋ
...
`Rewrite to` ਡਾਇਨਾਮਿਕ ਚੁਣੋ ਅਤੇ ਆਪਣੇ ਬਾਲਟੀ ਨਾਮ ਵਿੱਚ `your_bucketname` `concat("/file/your_bucketname",http.request.uri.path)` ।

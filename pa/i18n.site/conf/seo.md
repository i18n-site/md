...
ਇਸ ਤੋਂ ਇਲਾਵਾ, ਉੱਪਰ ਦਿੱਤੇ `cloudflare` ਪਰਿਵਰਤਨ ਨਿਯਮ ਵਿੱਚ, `index.html` ਨੂੰ `file/your_bucketname/index.html` ਵਿੱਚ ਬਦਲਿਆ ਗਿਆ ਹੈ, ਅਤੇ ਹੋਰ ਸੰਰਚਨਾਵਾਂ ਉਹੀ ਰਹਿੰਦੀਆਂ ਹਨ।

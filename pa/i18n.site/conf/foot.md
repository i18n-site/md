...
ਫੁੱਟਰ ਆਈਕਨ `F` ( [ਅੰਗਰੇਜ਼ੀ ਸੰਸਕਰਣ](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)) ਨਾਮਕ ਫੌਂਟ ਬਣਾ ਕੇ ਤਿਆਰ ਕੀਤਾ ਗਿਆ ਹੈ iconfont.cn
...
ਇਸ ਲਿਖਤ ਵਿਧੀ ਦੇ ਸਮਾਨ `${I18N.xxx}` ਵਰਤੋਂ ਕਰਦੇ ਹੋਏ, `i18n.yml` ਦੇ ਨਾਲ ਮਿਲਾ ਕੇ, ਤੁਸੀਂ ਫੁੱਟਰ ਦਾ ਬਹੁ-ਭਾਸ਼ੀ ਅੰਤਰਰਾਸ਼ਟਰੀਕਰਨ ਪ੍ਰਾਪਤ ਕਰ ਸਕਦੇ ਹੋ।

ਲਿੰਕ ਵਿੱਚ `class="a"` ਜੋੜਨਾ ਲਿੰਕ ਨੂੰ `MarkDown` ਵਿੱਚ ਤਬਦੀਲ ਹੋਣ ਤੋਂ ਰੋਕਣ ਲਈ ਹੈ। ਦੇਖੋ :

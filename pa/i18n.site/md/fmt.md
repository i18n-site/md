...
## ਕਈ ਭਾਸ਼ਾਵਾਂ ਵਿੱਚ ਤਸਵੀਰਾਂ/ਵੀਡੀਓ/ਲਿੰਕ

`MarkDown` `HTML` ਵਿੱਚ ਤਬਦੀਲ ਹੋਣ ਤੋਂ ਬਾਅਦ, `$LANG` ਗੁਣਾਂ ਵਿੱਚ `src` ਅਤੇ `href` ਨੂੰ ਮੌਜੂਦਾ [ਭਾਸ਼ਾ ਕੋਡ](/i18/LANG_CODE) ਨਾਲ ਬਦਲ ਦਿੱਤਾ ਜਾਵੇਗਾ।

ਇਸ ਵੇਰੀਏਬਲ ਦੇ ਨਾਲ, ਤੁਸੀਂ ਤਸਵੀਰਾਂ/ਵੀਡੀਓ/ਲਿੰਕਸ ਦੇ ਬਹੁਭਾਸ਼ਾਈਕਰਨ ਨੂੰ ਪ੍ਰਾਪਤ ਕਰ ਸਕਦੇ ਹੋ।
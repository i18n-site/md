...
ਐਂਕਰ ਪੁਆਇੰਟ ਹੱਲ `i18n.site` ਨਾਲ ਸਹਿਮਤ ਹੈ, ਪੋਜੀਸ਼ਨਿੰਗ ਐਂਕਰ ਪੁਆਇੰਟ ਨੂੰ ਹੱਥੀਂ ਬਣਾਉਣ ਲਈ `MarkDown` ਵਿੱਚ `<a rel=id href="#xxx" id="xxx"></a>` ਦੇ ਸਮਾਨ ਟੈਕਸਟ ਨੂੰ ਸ਼ਾਮਲ ਕਰਨਾ ਹੈ।

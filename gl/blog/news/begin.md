...
A tradución é editable; modifica o texto orixinal e, cando se volve traducir automaticamente, non se sobrescribirán as modificacións manuais da tradución (se non se modificou este parágrafo do texto orixinal).
...
As ferramentas de xestión de traducións existentes son demasiado pesadas Para os programadores que confían na xestión da versión `git` , aínda prefiren a liña de comandos.
...
Isto é só o comezo, hai moito máis que facer.

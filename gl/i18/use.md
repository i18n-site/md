...
A tradución é editable. Modifique o texto orixinal e tradúceo de novo automaticamente, as modificacións manuais da tradución non se sobrescribirán (se non se modificou este parágrafo do texto orixinal).

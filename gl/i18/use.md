...
windows Sistema, [fai clic aquí para descargar e instalar `git bash`](https://git-scm.com/download/win) primeiro.
...
Nesta táboa de configuración, a lingua de orixe da tradución do catálogo `blog` é `zh` e a lingua de orixe da tradución do `blog/your_file_name.md` é `ja` .

...
`Falcon` tradúcese como `faucon` e `Llama` tradúcese como `lama` . Como nomes propios, non se deben traducir.
...
O cliente é de código 90 e o % do código é de código aberto [Fai clic aquí para ver o código fonte](/i18n.site/src) .

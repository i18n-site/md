# i18n.site: Marco De Sitios Web Multilingüe Estático Puro

Xerador de sitios de documentos puramente estáticos en varios idiomas `i18n.site`

Actualmente está dispoñible inicialmente, pero aínda hai funcións importantes en desenvolvemento. Consulta [o plan de desenvolvemento](/i18n.site/c/roadmap) para obter máis información.
...
`i18n.site` o meu repensar o modelo de desenvolvemento do sitio web.

Este é un xerador de sitios de documentos e un marco de desenvolvemento de sitios web.

Un novo paradigma de desenvolvemento de sitios web que se `MarkDown` e utiliza compoñentes front-end para inxectar interactividade.

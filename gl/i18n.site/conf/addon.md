...
* `i18n.addon/toc` Índice : directorio
...
* `lang_li` Lista : idiomas, o primeiro idioma é o idioma de orixe
...
* `rDir(dirpath)` Le o directorio, o valor de retorno é unha matriz : list, lista : ficheiros

...
* `import.css` : 1Estilo `i18n.site` para todo o sitio
* `conf.css` : Iconas e fontes de pé

### Fonte Da Icona

A icona do pé xérase ao crear unha fonte chamada iconfont.cn ( [versión en inglés](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)`F` ).

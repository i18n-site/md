...
O método de escritura anterior equivale a ter `url: xxx` , e o seu ficheiro correspondente é `en/xxx/TOC` .
...
Os usuarios de China, Xapón e Corea, teñan en conta que deberían usar dous puntos de ancho medio `:` en lugar de dous puntos de ancho completo.

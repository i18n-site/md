...
Nas páxinas estáticas, use `link` para indicar ligazóns a versións en diferentes idiomas desta páxina, como :
...
A continuación, cree o script no [EdgeJS edge](//console.bce.baidu.com/cdn/#/cdn/ejs/list) do seguinte xeito
...
Dado que `cloudflare` acceder `R2` mediante un nome de dominio personalizado, é necesario utilizar un almacenamento de obxectos de terceiros para colocar ficheiros estáticos.

Aquí [backblaze.com](https://www.backblaze.com) como exemplo como unir obxectos de terceiros para almacenalos en `cloudflare` .

...
Se usas un ambiente de integración continua para publicar, non hai que instalar `nodejs` , só tes que copiar o permiso de publicación `~/.npmrc` iniciado no ambiente.
...
As regras da imaxe superior son as seguintes. Substitúe `i18n.site` na primeira liña de abaixo polo nome de dominio que vinculas.

...
* [Ferramenta de tradución da liña de i18 : MarkDown](/i18/feature)
...
Fai <button onclick="mailsub()">clic neste correo electrónico para subscribirte ás actualizacións de produtos</button> e <button onclick="webpush()">activar o push do navegador</button> Notificarémosche cando se actualicen os produtos.
...
Queremos construír unha Internet sen illamento lingüístico.
Agardamos que toda a humanidade se xunte cun soño común.

O sitio de tradución e documentación de Markdown son só o comezo.

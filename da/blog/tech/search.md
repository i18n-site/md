...
I front-end-interaktion kan indeksindlæsningens statuslinje vises for at undgå forsinkelsen ved indlæsning for første gang. Se "Progress Bar med animation, baseret på en enkelt progress + Ren css Implementering" [Engelsk](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [kinesisk](//juejin.cn/post/7413586285954154522) .

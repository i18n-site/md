...
`i18n.site` — это генератор сайтов документов и среда разработки веб-сайтов.
...
На основе разделения фронтенда и бекенда также происходит разделение статического контента и динамических данных.

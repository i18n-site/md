...
Решение для точки привязки, согласованное с `i18n.site` заключается в вставке текста, похожего на `<a rel=id href="#xxx" id="xxx"></a>` в `MarkDown` чтобы вручную создать точку привязки позиционирования.

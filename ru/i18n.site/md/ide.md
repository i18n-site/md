...
Мы используем [vscode](https://code.visualstudio.com/) для записи `MarkDown` , а также устанавливаем плагин [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) для предварительного просмотра в реальном времени во время записи.

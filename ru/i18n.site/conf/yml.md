...
`nav:` вариантов конфигурации, соответствующих меню навигации в верхней части домашней страницы.
...
Вышеупомянутый метод записи эквивалентен `url: xxx` , а соответствующий ему файл — `en/xxx/TOC` .
...
Например, если осуществляется доступ к `/test` , а `nav:` настроен без префикса этого пути, а текущий язык просмотра — английский (код `en` ), `/en/test.md` будет загружен по умолчанию и отображен с использованием шаблона `Md` .

...
Сопоставление между переводом и исходным текстом привязано к токену. Создайте новый токен в [i18n.site/token](//i18n.site/token) удалите `.i18h/hash` и переведите еще раз, чтобы очистить запутанное сопоставление (но это приведет к потере всех ручных корректировок перевода).

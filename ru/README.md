...
Мы придерживаемся философии `UNIX` " Всё — это файл " и можем управлять переводами на сотни языков, не внедряя сложные и громоздкие решения корпоративного уровня.

...
Мы придерживаемся философии `UNIX` " Все — это файл " , и мы можем управлять переводами на сотни языков без внедрения сложных и громоздких решений корпоративного уровня.

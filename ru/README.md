...
Переведите `Markdown` и `YAML` в инструмент командной строки ( [исходный код](https://github.com/i18n-site/rust/tree/main/i18) ) на нескольких языках.
...
Мы разделяем " `UNIX` Все есть файл " и можем управлять переводами на сотни языков, не внедряя сложные и громоздкие решения корпоративного уровня.

Вы можете использовать самые привычные инструменты для `Markdown` перевода (но вы не можете добавлять или удалять абзацы) и использовать самый привычный способ контроля версий.

База кода может быть создана как открытый исходный код для языковых файлов, и с помощью процесса `Pull Request` пользователи со всего мира могут участвовать в постоянной оптимизации переводов. Бесшовное соединение [github](//github.com) И другие сообщества с открытым исходным кодом.

[→ Руководство пользователя можно найти в проектной документации](/i18) .
...
Полностью статический, оптимизированный для чтения и интегрированный с переводом [i18](#i18) он является лучшим выбором для создания сайта проектной документации.
...
Этот веб-сайт разработан на основе этой платформы и включает в себя пользовательские, платежные и другие функции ( [исходный код](/i18n.site/src) ). Подробное руководство будет написано позже.

[→ Руководство пользователя можно найти в проектной документации](/i18n.site) .
...
Синхронизировать публикацию контента с социальными сетями;

...
Перевод доступен для редактирования; измените исходный текст, и при повторном машинном переводе внесенные вручную изменения в переводе не будут перезаписаны (если этот абзац исходного текста не был изменен).

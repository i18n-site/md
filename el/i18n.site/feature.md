...
Το πρόγραμμα έχει `i18` μετάφραση, ανατρέξτε στο [➔ `i18`](/i18) για συγκεκριμένη χρήση.
...
Σχετικός κωδικός : [github.com/i18n-site/18x/src/lang.coffee](https://github.com/i18n-site/18x/blob/main/src/lang.coffee)
...
`i18n.site` προεπιλογή, το περιεχόμενο `CDN` ιστότοπου θα δημοσιευτεί στο `npmjs.com` , με τη `npm` [unpkg.com](//unpkg.com) [jsdelivr.com](//jsdelivr.com)
...
`CDN` αρχή είναι: υποκλοπή του αιτήματος με τη βοήθεια του [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)

Σχετικός κωδικός : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)
...
> Εγκαταλείπει την περιττή διακόσμηση και παρουσιάζει περιεχόμενο στην πιο αγνή του μορφή.
...
Από προεπιλογή, [οι ορθογώνιες γραμματοσειρές διπλού άξονα Alimama](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) και άλλες γραμματοσειρές στο διαδίκτυο είναι ενεργοποιημένες στην ιστοσελίδα για να ενοποιήσουν την εμπειρία ανάγνωσης των χρηστών σε διαφορετικές πλατφόρμες.

Ταυτόχρονα, προκειμένου να βελτιωθεί η ταχύτητα φόρτωσης, οι γραμματοσειρές κόβονται σε φέτες σύμφωνα με στατιστικά στοιχεία συχνότητας word.

Σχετικός κωδικός : [github.com/i18n-site/font](https://github.com/i18n-site/font)
...
`404` ένα χαριτωμένο μικρό φάντασμα που επιπλέει στη σελίδα, τα μάτια του θα κινηθούν με το ποντίκι, [➔ Κάντε κλικ εδώ για να δείτε](/404) ,

## Κώδικας Ανοιχτού Κώδικα

[Ο κώδικας είναι ανοιχτού κώδικα](/i18n.site/src) [.](//groups.google.com/u/2/g/i18n-site)

Υπάρχουν πολλές μικρές απαιτήσεις που είναι σημαντικές αλλά όχι επείγουσες Η ομάδα ανάπτυξης θα αναθέσει εργασίες πρακτικής σύμφωνα με την τεχνολογία στην οποία είστε καλοί και θα βελτιώσει τα έγγραφα ανάπτυξης κατά την ανάθεση των απαιτήσεων.

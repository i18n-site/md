...
* Δεν [atomgit](https://atomgit.com/i18n/x) να πακετάρετε βιβλιοθήκες / με απευθείας αναφορά [github](https://github.com/i18n-site/x)
  Είναι βολικό να κάνετε απευθείας αναφορά στο σενάριο προετοιμασίας σήμανσης και να το χρησιμοποιείτε ταυτόχρονα στον ιστότοπο του πακέτου, ώστε να αποφευχθεί η επανάληψη κώδικα.

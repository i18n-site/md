...
Εάν χρησιμοποιείτε ένα περιβάλλον συνεχούς ενοποίησης για τη δημοσίευση, δεν χρειάζεται να εγκαταστήσετε `nodejs` , απλώς αντιγράψτε το δικαίωμα σύνδεσης και δημοσίευσης `~/.npmrc` στο περιβάλλον.

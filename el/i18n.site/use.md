...
Επεξεργαστείτε `md/.i18n/htm/ol.yml` και αλλάξτε την τιμή του [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) το δικό σας όνομα `npm` .

Στη συνέχεια, τροποποιήστε `md/.i18n/htm/ol.package.json`

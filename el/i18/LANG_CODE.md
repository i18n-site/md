...
| σειριακός αριθμός | κώδικας | Γλώσσα | εμφανιζόμενο όνομα |
| - | - | - | - |
| 0 | `en` | Αγγλικά | `English` |
| 1 | `zh` | Απλοποιημένα Κινέζικα | `简体中文` |
| 2 | `de` | Γερμανός | `Deutsch` |
| 3 | `fr` | γαλλική γλώσσα | `Français` |
| 4 | `es` | Ισπανικά | `Español` |
| 5 | `it` | ιταλικός | `Italiano` |
| 6 | `ja` | Ιαπωνικά | `日本語` |
...
| 81 | `zh-TW` | Παραδοσιακά κινεζικά | `正體中文` |
| 82 | `co` | Κορσικανός | `Corsu` |
| 83 | `dv` | Ντιβέχι | `ދިވެހިބަސް` |
| 84 | `ee` | Προβατίνα | `Eʋegbe` |
| 85 | `fil` | Φιλιππινέζικα (Tagalog) | `Filipino` |

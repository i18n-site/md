...
Λόγω των ελλείψεων των υπαρχουσών λύσεων, `i18n.site` έχει αναπτύξει μια νέα λύση αναζήτησης πλήρους κειμένου καθαρού front-end, η οποία έχει τα ακόλουθα χαρακτηριστικά :
...
1. Όταν προστίθενται/τροποποιούνται έγγραφα, μόνο τα προστιθέμενα ή τροποποιημένα έγγραφα αναπροσαρμόζονται στο ευρετήριο, μειώνοντας τον όγκο των υπολογισμών.
1. Υποστηρίζει αναζήτηση προθέματος, η οποία μπορεί να εμφανίζει αποτελέσματα αναζήτησης σε πραγματικό χρόνο ενώ ο χρήστης πληκτρολογεί.
...
Στην css στο μπροστινό μέρος, η γραμμή προόδου φόρτωσης του ευρετηρίου μπορεί να εμφανιστεί [για](//juejin.cn/post/7413586285954154522) να / η καθυστέρηση κατά τη φόρτωση για πρώτη φορά [,](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) progress + .

...
Η μετάφραση είναι επεξεργάσιμη, τροποποιήστε το πρωτότυπο κείμενο και όταν μεταφραστεί ξανά από μηχανής, οι μη αυτόματες τροποποιήσεις στη μετάφραση δεν θα αντικατασταθούν (εάν αυτή η παράγραφος του αρχικού κειμένου δεν έχει τροποποιηθεί).

...
1. Οι μεταδόσεις ή τα δεδομένα σας έχουν υποστεί μη εξουσιοδοτημένη πρόσβαση ή αλλοίωση
...
Αυτός ο ιστότοπος έχει το δικαίωμα να διακόψει ή να τερματίσει την υπηρεσία που σας παρέχεται ανά πάσα στιγμή και να διαγράψει τον λογαριασμό και το περιεχόμενό σας χωρίς καμία ευθύνη έναντι εσάς ή οποιουδήποτε τρίτου μέρους.

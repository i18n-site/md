...
I18N.SITE, μια δημιουργία στατικών τοποθεσιών που υποστηρίζει αυτόματη μετάφραση σε [100 διαφορετικές γλώσσες](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

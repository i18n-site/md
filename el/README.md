...
<button onclick="mailsub()">Κάντε κλικ σε αυτό το email για να εγγραφείτε στις ενημερώσεις προϊόντων</button> και <button onclick="webpush()">να ενεργοποιήσετε το πρόγραμμα περιήγησης</button> . Θα σας ειδοποιήσουμε όταν ενημερωθούν τα προϊόντα.
...
Θέλουμε να δημιουργήσουμε ένα Διαδίκτυο χωρίς γλωσσική απομόνωση.
Ελπίζουμε ότι όλη η ανθρωπότητα θα ενωθεί με ένα κοινό όνειρο.

Ο ιστότοπος μετάφρασης και τεκμηρίωσης Markdown είναι μόνο η αρχή.

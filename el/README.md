...
## <a rel=id href="#project" id="project"></a> Περιγραφή Έργου

Αυτή η τοποθεσία παρέχει επί του παρόντος δύο εργαλεία γραμμής εντολών ανοιχτού κώδικα:

* [i18 : MarkDown μετάφρασης γραμμής εντολών](/i18/feature)
* [i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Εργαλείο μετάφρασης γραμμής εντολών MarkDown

Μετάφραση `YAML` `Markdown` ένα εργαλείο γραμμής εντολών ( [πηγαίος κώδικας](https://github.com/i18n-site/rust/tree/main/i18) ) σε πολλές γλώσσες.
...
Μοιραζόμαστε " φιλοσοφία `UNIX` Everything is a File " και μπορούμε να διαχειριστούμε μεταφράσεις σε εκατοντάδες γλώσσες χωρίς να εισάγουμε πολύπλοκες και δυσκίνητες λύσεις σε εταιρικό επίπεδο.

Μπορείτε να χρησιμοποιήσετε τα πιο οικεία εργαλεία για `Markdown` τη μετάφραση (αλλά δεν μπορείτε να προσθέσετε ή να διαγράψετε παραγράφους) και να χρησιμοποιήσετε τον πιο οικείο τρόπο για να κάνετε έλεγχο έκδοσης.

Μια βάση κώδικα μπορεί να δημιουργηθεί ως ανοιχτός κώδικας για αρχεία γλώσσας και με τη βοήθεια της διαδικασίας του `Pull Request` , οι παγκόσμιοι χρήστες μπορούν να συμμετέχουν στη συνεχή βελτιστοποίηση των μεταφράσεων. Απρόσκοπτη σύνδεση [github](//github.com) άλλες κοινότητες ανοιχτού κώδικα.

[→ Για οδηγό χρήσης, διαβάστε την τεκμηρίωση του έργου](/i18) .
...
Καθαρά στατικό, βελτιστοποιημένο για εμπειρία ανάγνωσης και ενσωματωμένο με τη μετάφραση του [i18](#i18) είναι η καλύτερη επιλογή για τη δημιουργία τοποθεσίας εγγράφων έργου.
...
Αυτός ο ιστότοπος έχει αναπτυχθεί με βάση αυτό το πλαίσιο και περιλαμβάνει λειτουργίες χρήστη, πληρωμής και άλλες λειτουργίες ( [πηγαίος κώδικας](/i18n.site/src) ).

[→ Για οδηγό χρήσης, διαβάστε την τεκμηρίωση του έργου](/i18n.site) .
...
Συγχρονίστε τη δημοσίευση περιεχομένου με τα μέσα κοινωνικής δικτύωσης.

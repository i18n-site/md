...
Σας επιτρέπει να δημιουργείτε γρήγορα διεθνή έγγραφα και ιστολόγια που υποστηρίζουν [εκατοντάδες γλώσσες](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

...
Το Διαδίκτυο έχει εξαλείψει την απόσταση στον φυσικό χώρο, αλλά οι γλωσσικές διαφορές εξακολουθούν να εμποδίζουν την ανθρώπινη ενότητα.
...
Προσυπογράφουμε τη φιλοσοφία " `UNIX` "

Μπορείτε να χρησιμοποιήσετε τα πιο οικεία εργαλεία για να επεξεργαστείτε τη `Markdown` (αλλά δεν μπορείτε να προσθέσετε ή να διαγράψετε παραγράφους) και να χρησιμοποιήσετε τον πιο οικείο τρόπο για να κάνετε έλεγχο έκδοσης.
...
Υποστηρίζει δίγλωσσα σχόλια και δωμάτια συνομιλίας

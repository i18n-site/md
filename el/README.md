...
Το μυθιστόρημα επιστημονικής φαντασίας &quot;Three Body&quot; (Κινεζική προφορά: `3Tǐ` ) μυθιστορηματοποιεί έναν εξωγήινο πολιτισμό που χρησιμοποιεί ηλεκτρομαγνητικά κύματα για να επικοινωνήσει, με διαφανή σκέψη και ευημερούσα τεχνολογία.

...
## ୱିଣ୍ଡୋଜ୍ ପ୍ରଥମେ git bash ସଂସ୍ଥାପନ କରେ |
...
ସେମାନଙ୍କ ମଧ୍ୟରେ, `.i18n/cache/.gitignore` ର ବିଷୟବସ୍ତୁ ନିମ୍ନଲିଖିତ ଅଟେ :
...
ଏହାର ଅର୍ଥ ହେଉଛି `.i18n/cache/` ଡିରେକ୍ଟୋରୀରେ ଥିବା ସମସ୍ତ ଫାଇଲଗୁଡ଼ିକୁ ଅଣଦେଖା କରାଯାଇଛି `.i18n/cache/.gitignore`

ଯଦି ଆପଣଙ୍କର ସଂସ୍କରଣ ନିୟନ୍ତ୍ରଣ ସଫ୍ଟୱେର୍ `git` ନୁହେଁ, ଦୟାକରି ଏହାକୁ ଏହି ସଂରଚନା ଅନୁଯାୟୀ ଅଣଦେଖା କରନ୍ତୁ |
...
ଉଦାହରଣ ସ୍ୱରୂପ, ଯଦି ଆପଣ ଚାଇନିଜ୍ କୁ ଇଂରାଜୀରେ ଅନୁବାଦ କରିବାକୁ ଚାହୁଁଛନ୍ତି, ତେବେ ଏହି ରେଖା `zh: en` ପୁନ r ଲିଖନ କରନ୍ତୁ |
...
ବିଭିନ୍ନ ସବ୍ ଡିରେକ୍ଟୋରୀଗୁଡିକ ପାଇଁ ଆପଣ ଭିନ୍ନ `fromTo` ବିନ୍ୟାସ କରିପାରିବେ / ଏକ ପ୍ରଦର୍ଶନ : ଭାବରେ ଲେଖାଯାଇଛି |
...
ଏହି ବିନ୍ୟାସ ସାରଣୀରେ, କାଟାଲଗ୍ `blog` ଅନୁବାଦର ଉତ୍ସ ଭାଷା `zh` , ଏବଂ `blog/your_file_name.md` ଅନୁବାଦର ଉତ୍ସ ଭାଷା ହେଉଛି `ja` |
...
ଯେପର୍ଯ୍ୟନ୍ତ `.i18n/conf.yml` ସୃଷ୍ଟି ହୋଇଛି (ପ୍ରତ୍ୟେକ ଥର ଡେମୋ ପ୍ରୋଜେକ୍ଟ ଟେମ୍ପଲେଟରୁ ଆରମ୍ଭ କରିବାର କ need ଣସି ଆବଶ୍ୟକତା ନାହିଁ), `i18` ଭଲ କାମ କରିବ |

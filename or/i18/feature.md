...
ମିଶ୍ରିତ HTML ର ଅନୁବାଦକୁ ସମର୍ଥନ କରେ Markdown `MarkDown` ରେ ଏମ୍ବେଡ୍ ହୋଇଥିବା `<pre>` ଏବଂ `<code>` HTML ଥିବା ବିଷୟବସ୍ତୁ ଅନୁବାଦ ହୋଇନାହିଁ |
...
କମାଣ୍ଡ୍ ଇନପୁଟ୍ କରି ଏବଂ ଏହାକୁ ଗୋଟିଏ କ୍ଲିକ୍ ଦ୍ୱାରା ସମାପ୍ତ କରି ଅନୁବାଦ କରାଯିବା ଉଚିତ | କ complex ଣସି ଜଟିଳ ପରିବେଶ ନିର୍ଭରଶୀଳତା ରହିବା ଉଚିତ୍ ନୁହେଁ |
...
ଆମେ ଏକ ନୂତନ ପି generation ିର ଅନୁବାଦ ପ୍ରଯୁକ୍ତିକୁ ବିକଶିତ କରିଛୁ ଯାହା ପାରମ୍ପାରିକ ମେସିନ୍ ଅନୁବାଦ ମଡେଲ ଏବଂ ବୃହତ ଭାଷା ମଡେଲଗୁଡିକର ବ technical ଷୟିକ ସୁବିଧାକୁ ଏକତ୍ର କରି ଅନୁବାଦକୁ ସଠିକ୍, ସୁଗମ ଏବଂ ଚମତ୍କାର କରିବା ପାଇଁ ଏକତ୍ର କରିଛି |
...
## <a rel=id href="#price" id="price"></a> ବହୁତ ପ୍ରତିଯୋଗିତାମୂଳକ ମୂଲ୍ୟ |
...
[ପ୍ରାଧିକରଣ ଏବଂ ସ୍ୱୟଂଚାଳିତ i18n.site github ଅନୁସରଣ କରିବାକୁ ଏଠାରେ କ୍ଲିକ୍ କରନ୍ତୁ](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ଏବଂ **ବୋନସ୍ $50 ଗ୍ରହଣ କରନ୍ତୁ** |
...
ଉପରୋକ୍ତକୁ DeepL ଭାଷାରେ ଅନୁବାଦ କର (ସଠିକ୍ ନାମଗୁଡ଼ିକୁ ପୁନ r ଲିଖନ କରିବା ଏବଂ ଅଦ୍ଭୁତ `... ` ଯୋଡିବା):
...
କ୍ଲାଏଣ୍ଟ ସଂପୂର୍ଣ୍ଣ ଖୋଲା ଉତ୍ସ, ଏବଂ ସର୍ଭର ପାର୍ଶ୍ୱ% ଉତ୍ସ ହେଉଛି [ଉତ୍ସ](/i18n.site/src) ଉତ୍ସ 90

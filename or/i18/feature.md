...
ମିଶ୍ରିତ Markdown HTML ଅନୁବାଦକୁ ସମର୍ଥନ କରେ, `MarkDown` ରେ ଏମ୍ବେଡ୍ ହୋଇଥିବା `<pre>` ଏବଂ `<code>` ଟ୍ୟାଗରେ ଥିବା ବିଷୟବସ୍ତୁ ଅନୁବାଦ ହୋଇନାହିଁ HTML
...
ପ୍ରୋଗ୍ରାମର୍ମାନଙ୍କ ପାଇଁ ଯେଉଁମାନେ `git` , `vim` , ଏବଂ `vscode` ସହିତ ପରିଚିତ, ଡକ୍ୟୁମେଣ୍ଟ୍ ଏଡିଟ୍ କରିବା ଏବଂ ସଂସ୍କରଣ ପରିଚାଳନା ପାଇଁ ଏହି ଉପକରଣଗୁଡିକ ବ୍ୟବହାର କରିବା ନିଶ୍ଚିତ ଭାବରେ ଶିକ୍ଷଣ ମୂଲ୍ୟ ବୃଦ୍ଧି କରିବ |
...
ଆମେ ଏକ ନୂତନ ପି generation ିର ଅନୁବାଦ ପ୍ରଯୁକ୍ତିର ବିକାଶ କରିଛୁ ଯାହା ପାରମ୍ପାରିକ ମେସିନ୍ ଅନୁବାଦ ମଡେଲ ଏବଂ ବୃହତ ଭାଷା ମଡେଲଗୁଡିକର ବ technical ଷୟିକ ସୁବିଧାକୁ ଏକତ୍ର କରି ଅନୁବାଦଗୁଡ଼ିକୁ ସଠିକ୍, ଚିକ୍କଣ ଏବଂ ଚମତ୍କାର କରିବା ପାଇଁ ଏକତ୍ର କରିଛି |

ଦୃଷ୍ଟିହୀନ ପରୀକ୍ଷଣ ଦର୍ଶାଏ ଯେ ସମାନ ସେବା ତୁଳନାରେ ଆମର ଅନୁବାଦ ଗୁଣ ଯଥେଷ୍ଟ ଭଲ |
...
[ପ୍ରାଧିକରଣ ଏବଂ ସ୍ୱୟଂଚାଳିତ ଭାବରେ github ଅନୁସରଣ କରିବାକୁ ଏବଂ i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) **ବୋନସ୍ $50 ଗ୍ରହଣ କରିବାକୁ** କ୍ଲିକ୍ କରନ୍ତୁ |

ଟିପନ୍ତୁ: ବିଲ୍ ଯୋଗ୍ୟ ବର୍ଣ୍ଣ ସଂଖ୍ୟା = ଉତ୍ସ ଫାଇଲରେ [unicode ସଂଖ୍ୟା](https://en.wikipedia.org/wiki/Unicode) × ଅନୁବାଦରେ ଭାଷା ସଂଖ୍ୟା |

## ସମର୍ଥନ ଅନୁବାଦ `YAML`

ଟୁଲ୍ କେବଳ ଅଭିଧାନ ମୂଲ୍ୟଗୁଡ଼ିକୁ `YAML` ରେ ଅନୁବାଦ କରେ, ଅଭିଧାନ କିଗୁଡ଼ିକ ନୁହେଁ |

`YAML` ଅନୁବାଦ ଉପରେ ଆଧାର କରି, ଆପଣ ବିଭିନ୍ନ ପ୍ରୋଗ୍ରାମିଂ ଭାଷା ପାଇଁ ସହଜରେ ଆନ୍ତର୍ଜାତୀୟ ସମାଧାନ ଗଠନ କରିପାରିବେ |

## ଅନୁବାଦ `HOGO` ହେଡର୍ ବିନ୍ୟାସକରଣକୁ ସମର୍ଥନ କରନ୍ତୁ |

ଟାଇପ୍ ଷ୍ଟାଟିକ୍ ବ୍ଲଗ୍ ର ହେଡର୍ ବିନ୍ୟାସକୁ ସମର୍ଥନ କରେ, ଯାହା କେବଳ `title` , `summary` ଏବଂ `description` ଫିଲ୍ଡଗୁଡ଼ିକୁ ଅନୁବାଦ କରେ [HOGO](https://github.com/gohugoio/hugo)
...
ଫ୍ରେଞ୍ଚରେ ଅନୁବାଦ ହୋଇଛି `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

`Falcon` କୁ `faucon` ଏବଂ `Llama` `lama` ଭାବରେ ଅନୁବାଦ କରାଯାଇଛି | ଉପଯୁକ୍ତ ବିଶେଷ୍ୟ ଭାବରେ, ସେମାନେ ଅନୁବାଦ ହେବା ଉଚିତ୍ ନୁହେଁ |

...
ବିଦ୍ୟମାନ ଅନୁବାଦ ପରିଚାଳନା ଉପକରଣଗୁଡ଼ିକ `git` ଭାରୀ |
...
କମାଣ୍ଡ୍ ଲାଇନ୍ [boa_engine js](https://docs.rs/boa_engine) , [ଏମ୍ବେଡ୍ ହୋଇଥିବା ଡାଟାବେସ୍ fjall](https://github.com/fjall-rs/fjall) |

ସର୍ଭର [contabo](https://my.contabo.com) VPS

ଡାଟାବେସ୍ [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) ।

...
`i18n.site` ସାଇଟ ବିଷୟବସ୍ତୁକୁ ଡିଫଲ୍ଟ ଭାବରେ `npmjs.com` ରେ ପ୍ରକାଶ କରିବ, ଏବଂ ସାହାଯ୍ୟରେ, [unpkg.com](//unpkg.com) ଏବଂ `npm` ରେ ଲୋଡ୍ ହୋଇଥିବା ଅନ୍ୟ `CDN` ବିଷୟବସ୍ତୁ [jsdelivr.com](//jsdelivr.com)

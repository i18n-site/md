...
### `use: Toc` , ବାହ୍ୟରେଖା ସହିତ ଏକକ ଫାଇଲ୍ ଟେମ୍ପଲେଟ୍ |
...
### `use: Md` , ବାହ୍ୟରେଖା ବିନା ଏକକ ଫାଇଲ୍ ଟେମ୍ପଲେଟ୍ |
...
### `use: Doc` , ମଲ୍ଟି ଫାଇଲ୍ ଡକ୍ୟୁମେଣ୍ଟ୍ ଟେମ୍ପଲେଟ୍ |
...
ଉପରୋକ୍ତ ଲେଖା ପଦ୍ଧତି `url: xxx` ସହିତ ସମାନ, ଏବଂ ଏହାର ଅନୁରୂପ ଫାଇଲ୍ ହେଉଛି `en/xxx/TOC` |

#### ବିଷୟବସ୍ତୁ ସୂଚୀର TOC ସାରଣୀ |

`json` ଡିରେକ୍ଟୋରୀ ବାହ୍ୟରେଖା ସୃଷ୍ଟି କରିବାକୁ `doc` ଟେମ୍ପଲେଟ୍ ବିନ୍ୟାସ ସହିତ ଅନୁରୂପ `TOC` ଡିରେକ୍ଟୋରୀ ଇଣ୍ଡେକ୍ସ ଫାଇଲ୍ ପ read ିବା ପାଇଁ ଡେମୋ ଗୋଦାମରେ `js` ପ୍ଲଗ୍-ଇନ୍ `.i18n/hook/after.tran/TOC.js` ଏକଜେକ୍ୟୁଟ୍ `i18n.site` |
...
##### ପ୍ୟାରେଣ୍ଟ୍ ସ୍ତର କେବଳ ଟାଇଟଲ୍ ଲେଖେ, ବିଷୟବସ୍ତୁ ନୁହେଁ |

ଯେତେବେଳେ ସେଠାରେ ଏକାଧିକ ସ୍ତରର ଇଣ୍ଡେଣ୍ଟେସନ୍ ଥାଏ, ପ୍ୟାରେଣ୍ଟ୍ ସ୍ତର କେବଳ ଟାଇଟଲ୍ ଲେଖେ ଏବଂ ବିଷୟବସ୍ତୁ ନୁହେଁ | ଅନ୍ୟଥା, ଟାଇପୋଗ୍ରାଫି ମେସେଜ୍ ହୋଇଯିବ |
...
ଯଦି ଉତ୍ସ ଭାଷା ସଂଶୋଧିତ ହୁଏ, ତେବେ ଆପଣଙ୍କୁ ପ୍ରକଳ୍ପର ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ଭାଷାର `TOC` ଫାଇଲକୁ ଅନ୍ୟ ଭାଷାକୁ ସ୍ଥାନାନ୍ତର କରିବାକୁ ବ୍ୟାଚ୍ କରିବାକୁ ପଡିବ |
...
ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ପଥ ଆକ୍ସେସ୍ ହେବା ପାଇଁ, ଯଦି ପାଥ୍ ଉପସର୍ଗ `nav:` ରେ ବିନ୍ୟାସ ହୋଇନଥାଏ, ପଥ ସହିତ ଥିବା `MarkDown` ଫାଇଲ୍ ଡିଫଲ୍ଟ ଭାବରେ ଲୋଡ୍ ହେବ ଏବଂ `Md` ଟେମ୍ପଲେଟ୍ ବ୍ୟବହାର କରି ରେଣ୍ଡର୍ ହେବ |

ଉଦାହରଣ ସ୍ୱରୂପ, ଯଦି `/test` ଆକ୍ସେସ୍ ହୁଏ, ଏବଂ `nav:` ଏହି ପଥର ଉପସର୍ଗ ବିନା ବିନ୍ୟାସିତ ହୁଏ, ଏବଂ ସାମ୍ପ୍ରତିକ ବ୍ରାଉଜିଙ୍ଗ୍ ଭାଷା ହେଉଛି ଇଂରାଜୀ (କୋଡ୍ `en` ), `/en/test.md` ଡିଫଲ୍ଟ ଭାବରେ ଲୋଡ୍ ହେବ ଏବଂ ଟେମ୍ପଲେଟ୍ `Md` ବ୍ୟବହାର କରି ଉପସ୍ଥାପିତ ହେବ |

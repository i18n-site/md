...
ଆପଣ ଉପରୋକ୍ତ ବିନ୍ୟାସନରେ `use: Toc` `use: Md` କୁ ରୂପାନ୍ତର କରିପାରିବେ, `md` ଡିରେକ୍ଟୋରୀରେ `i18n.site` ପୁନର୍ବାର ଚଲାନ୍ତୁ, ଏବଂ ତାପରେ ମୂଳପୃଷ୍ଠାରେ ପରିବର୍ତ୍ତନଗୁଡିକ ଦେଖିବା ପାଇଁ ବିକାଶ ପୂର୍ବାବଲୋକନ URL ପରିଦର୍ଶନ କରନ୍ତୁ |

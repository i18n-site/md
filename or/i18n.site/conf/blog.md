...
ମେଟା ସୂଚନା ଫାଇଲର ପ୍ରାରମ୍ଭରେ ହେବା ଆବଶ୍ୟକ, `---` ରୁ ଆରମ୍ଭ ହୋଇ `---` ସହିତ ଶେଷ ହେବ | ମ middle ିରେ ବିନ୍ୟାସ ସୂଚନାର ଫର୍ମାଟ୍ ହେଉଛି `YAML` |

ନିମ୍ନଲିଖିତ ଭାବରେ ଏକ ଡେମୋ ଫାଇଲ୍ ବିନ୍ୟାସିତ ହୋଇଛି:
...
ବ୍ଲଗ୍ ର ଡାହାଣ ପାର୍ଶ୍ୱରେ ଥିବା ଡିରେକ୍ଟୋରୀ ଗଛର ବିନ୍ୟାସ ମଧ୍ୟ `TOC` ଫାଇଲ ଅଟେ (ପୂର୍ବ ଅଧ୍ୟାୟ ଦେଖନ୍ତୁ) କେବଳ `TOC` ରେ ତାଲିକାଭୁକ୍ତ ପ୍ରବନ୍ଧଗୁଡ଼ିକ ବ୍ଲଗ୍ ମୂଳପୃଷ୍ଠା ସୂଚକାଙ୍କରେ ଦେଖାଯିବ |
...
ତାପରେ ଉତ୍ସ ଭାଷା ଡିରେକ୍ଟୋରୀରେ `author.yml` ସଂପାଦନ କରନ୍ତୁ ଏବଂ ଲେଖକ ସୂଚନା ଯୋଡନ୍ତୁ, ଯେପରି :
...
`name` , `url` ଏବଂ `title` ସମସ୍ତ ଇଚ୍ଛାଧୀନ ଅଟେ | ଯଦି `name` ସେଟ୍ ହୋଇନାହିଁ, ତେବେ ମୁଖ୍ୟ ନାମ (ଏଠାରେ `marlowe` ) `name` ଭାବରେ ବ୍ୟବହୃତ ହେବ |

...
* `i18n.addon/toc` ଡିରେକ୍ଟୋରୀ ଡିରେକ୍ଟୋରୀ :
  ଡିଫଲ୍ଟ ଭାବରେ ସକ୍ଷମ ହୋଇଥିବା `TOC` ଉପରେ ଆଧାର କରି `json` ର ଡିରେକ୍ଟୋରୀ ସୂଚକାଙ୍କ ସୃଷ୍ଟି କରନ୍ତୁ |

* `i18n.addon/mouse` ମାଉସ୍ ପ୍ରଭାବ :

## ଫାଇଲ୍ ନାମ ସମ୍ମିଳନୀ |

ପ୍ଲଗ୍-ଇନ୍ ଗୁଡିକ ସମସ୍ତ `npm` ପ୍ୟାକେଜ୍ |
...
`.i18n/htm/index.js` ର ଶେଷ ପର୍ଯ୍ୟନ୍ତ `htmIndex.js` ଦିଆଯିବ |
...
* `lang_li` ଭାଷା ତାଲିକା, ପ୍ରଥମ ଭାଷା ହେଉଛି ଉତ୍ସ ଭାଷା :
...
ବିଲ୍ଟ-ଇନ୍ `js` ଚାଲିବା ସମୟ ଦ୍ secondary ିତୀୟ ବିକାଶ ଉପରେ ଆଧାରିତ [boa](https://github.com/boa-dev/boa) ଏବଂ ବିଲ୍ଟ-ଇନ୍ ଫଙ୍କସନ୍ ଗୁଡିକ ନିମ୍ନଲିଖିତ ଭାବରେ :

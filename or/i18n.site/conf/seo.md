...
ବିନ୍ୟାସନରେ, ଦୟାକରି `i18n.site` `.i18n/htm/ol.yml` ରେ `host:` ର ମୂଲ୍ୟକୁ ପରିବର୍ତ୍ତନ କରନ୍ତୁ, ଏକାଧିକ ଅବଜେକ୍ଟ ଷ୍ଟୋରଗୁଡିକ `s3` ତଳେ ବିନ୍ୟାସ ହୋଇପାରିବ ଏବଂ `region` ଫିଲ୍ଡ ଇଚ୍ଛାଧୀନ ଅଟେ (ଅନେକ ବସ୍ତୁ ଷ୍ଟୋର୍ଗୁଡିକ ଏହି କ୍ଷେତ୍ର ସେଟ୍ କରିବା ଆବଶ୍ୟକ କରନ୍ତି ନାହିଁ) |
...
କାରଣ `R2` କଷ୍ଟୋମାଇଜ୍ ଡୋମେନ୍ ନାମ ଦ୍ୱାରା ଆକ୍ସେସ୍ ହୋଇପାରିବ `cloudflare` , ଷ୍ଟାଟିକ୍ ଫାଇଲ୍ ରଖିବା ପାଇଁ ଏକ ତୃତୀୟ-ପକ୍ଷ ବସ୍ତୁ ଷ୍ଟୋରେଜ୍ ବ୍ୟବହାର କରାଯିବା ଆବଶ୍ୟକ |

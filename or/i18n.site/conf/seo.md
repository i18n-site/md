...
ବିନ୍ୟାସନରେ, ଦୟାକରି `i18n.site` `.i18n/htm/ol.yml` ରେ `host:` ର ମୂଲ୍ୟରେ ପରିବର୍ତ୍ତନ କରନ୍ତୁ, ଏକାଧିକ ଅବଜେକ୍ଟ ଷ୍ଟୋରଗୁଡିକ `s3` ତଳେ ବିନ୍ୟାସ ହୋଇପାରିବ ଏବଂ `region` ଟି ଫିଲ୍ଡ ଇଚ୍ଛାଧୀନ ଅଟେ (ଅନେକ ବସ୍ତୁ ଷ୍ଟୋର୍ଗୁଡିକ ଏହି କ୍ଷେତ୍ର ସେଟ୍ କରିବା ଆବଶ୍ୟକ କରନ୍ତି ନାହିଁ) |

ତାପରେ ପ୍ରୋଜେକ୍ଟକୁ ପୁନ ub ପ୍ରକାଶନ କରିବାକୁ `i18n.site -n` ଚଲାନ୍ତୁ |
...
ଉଦାହରଣ ସ୍ୱରୂପ, [ହୁଆୱାଇ DNS](https://www.huaweicloud.com) ମାଗଣା ଆଞ୍ଚଳିକ ବିଶ୍ଳେଷଣ ପ୍ରଦାନ କରେ, ଯାହା ସହିତ ଚାଇନା ଟ୍ରାଫିକ୍ Baidu ସ୍ମାର୍ଟ କ୍ଲାଉଡ୍ ଦେଇ ଯାଇପାରେ ଏବଂ ଆନ୍ତର୍ଜାତୀୟ ଟ୍ରାଫିକ୍ `cloudflare` ଦେଇ ଯାଇପାରେ |
...
ଡୋମେନ୍ ନାମକୁ `CNAME` ରୁ `f003.backblazeb2.com` କୁ `cloudflare` ରେ ପରିବର୍ତ୍ତନ କରନ୍ତୁ ଏବଂ ପ୍ରକ୍ସି ସକ୍ଷମ କରନ୍ତୁ |

...
## ଏକାଧିକ ଭାଷାରେ ଚିତ୍ର / ଭିଡିଓ / ଲିଙ୍କ୍ |

`MarkDown` `HTML` , `$LANG` ଗୁଣରେ ରୂପାନ୍ତରିତ ହେବା ପରେ `src` ଏବଂ `href` କୁ ସାମ୍ପ୍ରତିକ [ଭାଷା କୋଡ୍](/i18/LANG_CODE) ସହିତ ବଦଳାଯିବ |

ଏହି ଭେରିଏବଲ୍ ସହିତ, ଆପଣ ଚିତ୍ର / ଭିଡିଓ / ଲିଙ୍କ୍ ର ବହୁଭାଷୀକରଣ ହାସଲ କରିପାରିବେ |
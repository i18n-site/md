...
`i18n.site` ର ଏକ ବିଲ୍ଟ-ଇନ୍ `i18` ଅନୁବାଦ ଉପକରଣ ଅଛି, [ଆକ୍ସେସ୍ ଟୋକେନ୍ ବିନ୍ୟାସ କରିବାକୁ `i18` ଡକ୍ୟୁମେଣ୍ଟକୁ ଅନୁସରଣ କରିବାକୁ ଦୟାକରି ଏଠାରେ କ୍ଲିକ୍ କରନ୍ତୁ](/i18/use) |
...
ଚାଲିବା ପରେ, ଅନୁବାଦ ଏବଂ କ୍ୟାଚ୍ ଫାଇଲଗୁଡ଼ିକ ସୃଷ୍ଟି ହେବ ଦୟାକରି `git add . ` `md` ଡିରେକ୍ଟୋରୀରେ ଭଣ୍ଡାରରେ ଯୋଡିବାକୁ ମନେରଖ |

### ସ୍ଥାନୀୟ ପୂର୍ବାବଲୋକନ |

`docker` ସଂସ୍ଥାପନ ଏବଂ ଆରମ୍ଭ କରନ୍ତୁ ( `MAC` ବ୍ୟବହାରକାରୀ `docker` ପାଇଁ ଚାଲିବା ସମୟ ଭାବରେ ବ୍ୟବହାର [orbstack](https://orbstack.dev) ପରାମର୍ଶ ଦିଅନ୍ତି) |
...
ଉଦାହରଣ ସ୍ୱରୂପ, `.i18n/htm/ol.yml` `out/ol` ଡିରେକ୍ଟୋରୀ ସୃଷ୍ଟି କରିବ |
...
`ol` ହେଉଛି `online` ର ସଂକ୍ଷିପ୍ତକରଣ, ଅନଲାଇନ୍ ପରିବେଶକୁ ସୂଚାଇଥାଏ, `-n` ଅଫିସିଆଲ୍ ରିଲିଜ୍ ପାଇଁ ବ୍ୟବହୃତ ହୁଏ `npm`
...
`md/.i18n/htm/ol.yml` ସଂପାଦନ କରନ୍ତୁ ଏବଂ `v: //unpkg.com/i18n.site` ରେ `i18n.site` ଆପଣଙ୍କର `npm` ପ୍ୟାକେଜ୍ ନାମରେ ପରିବର୍ତ୍ତନ କରନ୍ତୁ |

କେବଳ ଅଣସଂରକ୍ଷିତ ପ୍ୟାକେଜ୍ ନାମ ବ୍ୟବହାର କରନ୍ତୁ ୱେବସାଇଟ୍ ଡୋମେନ୍ ନାମକୁ ବ୍ୟବହାର କରିବା ଏକ ଭଲ ପସନ୍ଦ [npmjs.com](//npmjs.com)

ପ୍ୟାକେଜ୍ `npm` ଉପରେ ଆଧାର କରି ପ୍ରକାଶନ କରିବାବେଳେ, `v:` ମୂଲ୍ୟର ଉପସର୍ଗ **ପାଇଁ `//unpkg.com/` ବ୍ୟବହାର କରିବାକୁ ନିଶ୍ଚିତ ହୁଅନ୍ତୁ** , ନୂତନ ପ୍ରକାଶନଗୁଡ଼ିକର ଠିକ୍ ସମୟରେ ଦେଖିବା ପାଇଁ ଏହି ଉପସର୍ଗ ପଥରେ `i18n.site` `/.v` କ୍ୟାଚ୍ ସମୟକୁ ବିଶେଷ ଭାବରେ ଅପ୍ଟିମାଇଜ୍ କରିଛି |

ଅନୁବାଦ ଏବଂ ପ୍ରକାଶନ କରିବାକୁ `md` ଡିରେକ୍ଟୋରୀରେ `i18n.site --npm` କିମ୍ବା `i18n.site -n` ଚଲାନ୍ତୁ |

ଯଦି ଆପଣ ପ୍ରକାଶନ ପାଇଁ ଏକ ନିରନ୍ତର ଏକୀକରଣ ପରିବେଶ ବ୍ୟବହାର କରନ୍ତି, ତେବେ ସଂସ୍ଥାପନ କରିବାର କ is ଣସି ଆବଶ୍ୟକତା ନାହିଁ `nodejs` କେବଳ ଲଗ୍ ଇନ୍ କପି କରନ୍ତୁ ଏବଂ ଅନୁମତି `~/.npmrc` କୁ ପରିବେଶକୁ ପ୍ରକାଶ କରନ୍ତୁ |
...
`CDN` host- ହୋଷ୍ଟ ବିଷୟବସ୍ତୁ ପାଇଁ, ଆପଣଙ୍କର ନିଜ ସର୍ଭର ବ୍ୟବହାର କରିବା ସହିତ, ଅନ୍ୟ ଏକ ସାଧାରଣ ବିକଳ୍ପ ହେଉଛି `S3` ବ୍ୟବହାର କରିବା +
...
`CDN` ବିନ୍ୟାସ କରିବାକୁ ମନେରଖନ୍ତୁ ଯାହା ଦ୍ 1 ାରା `/.v` ରେ ଶେଷ ହେଉଥିବା ପଥର କ୍ୟାଚ୍ ସମୟ `1s` ଅଟେ, ନଚେତ୍ ନୂତନ ଭାବରେ ପ୍ରକାଶିତ ବିଷୟବସ୍ତୁ ତୁରନ୍ତ ପ୍ରବେଶ ହୋଇପାରିବ ନାହିଁ |
...
କାରଣ ୱେବସାଇଟ୍ [ଗୋଟିଏ ପୃଷ୍ଠା ପ୍ରୟୋଗ](https://developer.mozilla.org/docs/Glossary/SPA) ସ୍ଥାପତ୍ୟ ବ୍ୟବହାର କରେ, URL ପଥଗୁଡ଼ିକୁ ପୁନ r ଲିଖନ କରିବାକୁ ମନେରଖ, ଯାହା `. ` ରୁ `index.html` ଧାରଣ କରେ ନାହିଁ |
...
ତା’ପରେ ଏହି ସଂସ୍ଥା ଅଧୀନରେ ଗୋଦାମ `i18n-demo.github.io` ସୃଷ୍ଟି କରନ୍ତୁ (ଦୟାକରି ଆପଣ ସୃଷ୍ଟି କରିଥିବା ସଂଗଠନ ନାମ ସହିତ `i18n-demo` ବଦଳାନ୍ତୁ):
...
`github page` ସହିତ ତୁଳନା କଲେ ଏହା ପଥ ପୁନ r ଲିଖନ ଯୋଗାଏ ଏବଂ ମଧ୍ୟପ୍ରଦେଶ ଚୀନ୍ ପାଇଁ ଅଧିକ ବନ୍ଧୁତ୍ୱପୂର୍ଣ୍ଣ ଏବଂ ଏହାକୁ ବ୍ୟବହାର କରିବାକୁ ପରାମର୍ଶ ଦିଆଯାଇଛି [cloudflare page](//pages.cloudflare.com)
...
ତା’ପରେ, ମଧ୍ୟପ୍ରଦେଶ ଚାଇନାରେ କ୍ଲାଉଡ୍ ବିକ୍ରେତାମାନଙ୍କର ଅବଜେକ୍ଟ ଷ୍ଟୋରେଜ୍ ବ୍ୟବହାର କରନ୍ତୁ `CDN` `out/ol/htm` ବିଷୟବସ୍ତୁକୁ ନିୟୋଜିତ କରନ୍ତୁ +
...
[ଆଲିବାବା CDN](https://cdn.console.aliyun.com/domain/list) ରେ ଡୋମେନ୍ ନାମ ଯୋଡନ୍ତୁ ଏବଂ ଆଲିବାବା କ୍ଲାଉଡ୍ `CDN` ରେ ଡୋମେନ୍ ନାମ `*.xxx.com` ରୁ `CNAME` ସୂଚିତ କରନ୍ତୁ |
...
ଦୟାକରି `server` ର ଅନୁଚ୍ଛେଦରେ ନିମ୍ନଲିଖିତ ପରି ଏକ ବିନ୍ୟାସ ଯୋଡନ୍ତୁ nginx ଦୟାକରି `/root/i18n/md/out/ol/htm` ନିଜ ପ୍ରୋଜେକ୍ଟର ପଥରେ ପରିବର୍ତ୍ତନ କରନ୍ତୁ `out/ol/htm`
...
`.i18n` ଡିରେକ୍ଟୋରୀରେ `i18n.site` ର ବିନ୍ୟାସ ଫାଇଲ, ଅନୁବାଦ କ୍ୟାଚ୍ ଇତ୍ୟାଦି ଅଛି | ବିବରଣୀ ପାଇଁ ପରବର୍ତ୍ତୀ ଅଧ୍ୟାୟ ["ବିନ୍ୟାସ" କୁ](/i18n.site/conf) ଦେଖନ୍ତୁ |

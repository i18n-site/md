...
לכל אחד יש את העורך המועדף שלו כאן אנו חולקים `Markdown` השיטות המומלצות שלנו.

אנו משתמשים ב- [vscode](https://code.visualstudio.com/) כדי לכתוב `MarkDown` ולהתקין את התוסף [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) לתצוגה מקדימה בזמן אמת בזמן הכתיבה.
...
הזן `code xxx.md` בשורת הפקודה כדי לקרוא ל `vscode` לפתיחת קובץ `Markdown` .

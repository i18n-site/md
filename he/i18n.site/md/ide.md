...
אנו משתמשים [vscode](https://code.visualstudio.com/) כדי לכתוב `MarkDown` , וגם מתקינים את התוסף [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) לתצוגה מקדימה בזמן אמת בזמן הכתיבה.

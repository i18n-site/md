...
אתה יכול להתייחס למימוש ב- [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) הקוד הוא כדלקמן :
...
## תמונות/סרטונים/קישורים במספר שפות

לאחר המרת `MarkDown` ל `HTML` , `$LANG` בתכונות `src` ו `href` יוחלפו [בקוד השפה](/i18/LANG_CODE) הנוכחי.

עם משתנה זה, אתה יכול להשיג רב לשוניות של תמונות/סרטונים/קישורים.
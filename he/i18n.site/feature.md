...
`i18n.site` יפרסם את תוכן האתר ל `npmjs.com` כברירת מחדל, בעזרת [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) ותוכן מרובה `CDN` אחר שנטען ב `npm` .
...
התמונה שלמעלה מציגה ריבוי שפות `RSS` [inoreader.com](//inoreader.com) מנוי `i18n.site` .
...
בעת גלילה על התוכן מימין, קווי המתאר משמאל ידגישו בו זמנית את הפרק הנקרא כעת.
...
לדף `404` יש רוח רפאים קטנה וחמודה מרחפת, העיניים שלו יזוזו עם העכבר, [➔ לחץ כאן לצפייה](/404) ,

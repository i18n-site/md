...
### `use: Doc` , תבנית מסמך מרובה קבצים
...
שיטת הכתיבה לעיל שווה ל `url: xxx` , והקובץ המתאים לה הוא `en/xxx/TOC` .

#### אינדקס תוכן העניינים של TOC

`i18n.site` יפעיל תוסף `js` `.i18n/hook/after.tran/TOC.js` במחסן ההדגמה כדי לקרוא את קובץ האינדקס של `TOC` ספריות המתאים לתצורת תבניות `doc` כדי ליצור את מתאר `json` הספריות.

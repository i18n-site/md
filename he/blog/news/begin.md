...
* `i18` : MarkDown תרגום שורת הפקודה
* `i18n.site` : מחולל אתרי מסמכים סטטיים במגוון שפות, **מותאם לחוויית קריאה**
...
חזית [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
שורת פקודה [מוטבעת js boa_engine](https://docs.rs/boa_engine) , [מסד נתונים מוטבע fjall](https://github.com/fjall-rs/fjall) .

שרת [contabo](https://my.contabo.com) VPS

מסד נתונים [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

שלח דואר ל-self-built SMTP [chasquid](https://github.com/albertito/chasquid)

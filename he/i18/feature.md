...
לסין, יפן וקוריאה אין אותיות רישיות או קטנות, אבל כותרות באנגלית בדרך כלל נותנות אותיות רישיות באות הראשונה.
...
אם אתה משתמש בגוגל או ב-DeepL, שניהם מתרגמים באופן שגוי מונחים באנגלית שאמורים להישאר מקוריים (קחו יפנית וצרפתית כדוגמאות).
...
הלקוח הוא קוד פתוח לחלוטין, וצד השרת הוא קוד 90 [לחץ כאן כדי להציג את קוד המקור](/i18n.site/src) .

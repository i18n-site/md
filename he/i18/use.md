...
ביניהם, התוכן של `.i18n/cache/.gitignore` הוא כדלקמן :
...
המשמעות היא שכל הקבצים בספרייה `.i18n/cache/` (למעט `.i18n/cache/.gitignore` ) מתעלמים.

אם תוכנת בקרת הגרסה שלך אינה `git` , אנא התעלם ממנה בהתאם לתצורה זו.

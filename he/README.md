...
במדיה החברתית ובמייל, אנשים רגילים להתמקד במקורות מידע בשפת האם שלהם.
...
* [כלי תרגום שורת i18 : MarkDown](/i18/feature)
...
אנו מנויים לפילוסופיה של `UNIX` הכל הוא " " לנהל תרגומים למאות שפות מבלי להציג פתרונות מורכבים ומסורבלים ברמת הארגון.
...
אנא <button onclick="mailsub()">לחץ על דוא"ל זה כדי להירשם לעדכוני מוצרים</button> ולאפשר <button onclick="webpush()">דחיפה של דפדפן</button> . אנו נודיע לך כאשר המוצרים יתעדכנו.
...
>
> ראה ה' את זה ואמר: "לכל בני האדם אותו שפה וגזע. עתה, לאחר שהדבר הושג, הכל ייעשה."
>
...
אתר תרגום ותיעוד Markdown הם רק ההתחלה.

<h1 style="display:flex;justify-content:space-between" style=";text-align:right;direction:rtl">i18n.site פתרונות בינלאומיים<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

שורת פקודה Markdown Yaml , עוזרת לך לבנות אתר מסמכים בינלאומי התומך [במאות שפות](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> תיאור פרויקט

אתר זה מספק כעת שני כלי שורת פקודה בקוד פתוח:

* [i18 : MarkDown תרגום שורת הפקודה](/i18/feature)
* [i18n.site : מחולל אתרים סטטי רב שפות](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: כלי תרגום שורת הפקודה MarkDown

תרגם `Markdown` ו- `YAML` לכלי שורת פקודה ( [קוד מקור](https://github.com/i18n-site/rust/tree/main/i18) ) במספר שפות.
...
אנו חולקים " הפילוסופיה `UNIX` הכל הוא קובץ " ויכולים לנהל תרגומים במאות שפות מבלי להציג פתרונות מורכבים ומסורבלים ברמת הארגון.

אתה יכול להשתמש בכלים המוכרים ביותר כדי `Markdown` את התרגום (אך לא ניתן להוסיף או למחוק פסקאות), ולהשתמש בדרך המוכרת ביותר לבצע בקרת גרסאות.

ניתן ליצור בסיס קוד כמקור פתוח לקבצי שפה, ובעזרת התהליך של `Pull Request` , משתמשים גלובליים יכולים להשתתף באופטימיזציה מתמשכת של התרגומים. חיבור חלק וקהילות קוד פתוח [github](//github.com) .

[→ למדריך למשתמש, אנא קרא את תיעוד הפרויקט](/i18) .
...
סטטי לחלוטין, מותאם לחוויית קריאה, ומשולב עם התרגום של [i18](#i18) זוהי הבחירה הטובה ביותר לבניית אתר מסמכי פרויקט.

המסגרת הקדמית הבסיסית מאמצת ארכיטקטורת פלאגין מלאה, שקל לפיתוח משני במידת הצורך, ניתן לשלב פונקציות אחורי.

אתר זה פותח על בסיס מסגרת זו וכולל פונקציות משתמש, תשלום ושאר פונקציות ( [קוד מקור](/i18n.site/src) הדרכה מפורטת תיכתב בהמשך).

[→ למדריך למשתמש, אנא קרא את תיעוד הפרויקט](/i18n.site) .

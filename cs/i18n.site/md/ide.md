...
Používáme [vscode](https://code.visualstudio.com/) k zápisu `MarkDown` a také instalujeme plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) pro náhled v reálném čase během psaní.

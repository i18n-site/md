...
* / knihovna [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* Není [atomgit](https://atomgit.com/i18n/x) / přímo odkazované front-end knihovny [github](https://github.com/i18n-site/x)
...
Tento backend je backendem samotného webu i18n.site, včetně uživatelských, platebních, zpráv push a dalších systémů.
...
* / skript [atomgit](https://atomgit.com/i18n-ops/ops) [github](https://github.com/i18n-ops/ops)
* Konfigurace [atomgit](https://atomgit.com/i18n-ops/ubuntu) [github](https://github.com/i18n-ops/ubuntu) / ubuntu

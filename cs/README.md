...
I18N.SITE, generátor statických stránek, který podporuje automatický překlad do [více než stovky různých jazyků](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

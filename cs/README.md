...
Díky sociálním sítím a e-mailu jsou lidé zvyklí zaměřovat se na informační zdroje ve svém mateřském jazyce.
...
Vyvinuli jsme novou generaci překladatelské technologie, která kombinuje technické výhody tradičních modelů strojového překladu a velkých jazykových modelů, aby byly překlady přesné, hladké a elegantní.
...
<button onclick="mailsub()">Kliknutím na tento e-mail se přihlásíte k odběru aktualizací produktů</button> a <button onclick="webpush()">povolíte push prohlížeč</button> . O aktualizacích produktů vás budeme informovat.
...
>
> PÁN to viděl a řekl: Všechny lidské bytosti mají stejný jazyk a rasu. Nyní, když se to stalo, bude vše hotovo.
>
...
Chceme vybudovat internet bez jazykové izolace.
Doufáme, že se celé lidstvo sejde se společným snem.

Stránky překladu a dokumentace Markdown jsou jen začátek.

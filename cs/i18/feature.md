...
Podporuje překlad smíšeného HTML Markdown , obsah ve značkách `<pre>` a `<code>` v HTML vložených do `MarkDown` není přeložen
...
Klient je zcela open source a na straně 90 je % kódu open source. [Kliknutím sem zobrazíte zdrojový kód](/i18n.site/src) .

<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Switshuxo swa matiko ya misava<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Command line Markdown #xitirhisiwa xa Yaml , xi ku pfuna ku aka sayiti ya matsalwa ya matiko ya misava, ku seketela [madzana ya tindzimi](/i18/LANG_CODE) ...
...
Internet yi herise mpfhuka lowu nga kona exibakabakeni lexi vonakaka, kambe ku hambana ka tindzimi ka ha kavanyeta vun’we bya vanhu.
...
## <a rel=id href="#project" id="project"></a> Nhlamuselo ya Phurojeke
...
Hundzuluxela `Markdown` na `YAML` eka xitirhisiwa xa layini ya swileriso ( [khodi ya xihlovo](https://github.com/i18n-site/rust/tree/main/i18) ) hi tindzimi to tala.
...
Hi avelana " `UNIX` Everything is a File " naswona hi nga lawula vuhundzuluxi hi madzana ya tindzimi handle ko nghenisa swintshuxo leswi rharhanganeke no tika swa xiyimo xa mabindzu.

U nga tirhisa switirhisiwa leswi tolovelekeke swinene ku `Markdown` vuhundzuluxeri (kambe a wu nge swi koti ku engetela kumbe ku susa tindzimana), naswona u tirhisa ndlela leyi tolovelekeke swinene yo endla vulawuri bya vuhundzuluxeri.

Xiseketelo xa khodi xi nga tumbuluxiwa tanihi xihlovo lexi pfulekeke xa tifayela ta ririmi, naswona hi ku pfuniwa hi endlelo ra `Pull Request` , vatirhisi va misava hinkwayo va nga nghenelela eka ku antswisiwa loku yaka emahlweni ka vuhundzuluxi. Seamless connection [github](//github.com) Na miganga yin'wana ya xihlovo lexi pfulekeke.

[→ Ku kuma nkongomiso wa mutirhisi, hi kombela u hlaya matsalwa ya phurojeke](/i18) .

## Vuhundzuluxeri Bya Xiyimo Xa Le Henhla Bya Xindaya
...
Ku fikelela khwalithi leyi fanaka, nhlayo ya ku hlela hi voko loku lavekaka hi Google Translate na `ChatGPT` i `2.67` minkarhi na `3.15` minkarhi ya hina hi ku landzelelana.
...
Purely static, optimized for reading experience, and integrated with the translation of [i18](#i18) i xihlawuhlawu lexinene xo aka sayiti ya matsalwa ya phurojeke.
...
Webusayiti leyi yi tumbuluxiwile hi ku ya hi rimba leri naswona yi katsa mutirhisi, ku hakela na mintirho yin’wana ( [source code](/i18n.site/src) ).

[→ Ku kuma nkongomiso wa mutirhisi, hi kombela u hlaya matsalwa ya phurojeke](/i18n.site) .
...
Nakambe [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) amukelekile ku landzelela ti social account / hina [X.COM: @i18nSite](https://x.com/i18nSite)

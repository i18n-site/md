...
windows System, hi kombela [u click laha ku download no install `git bash`](https://git-scm.com/download/win) ku sungula.
...
Ku engetela kwalaho, u fanele [i18n.site/payBill](//i18n.site/payBill) boha khadi ra xikweleti leswaku u hakela (a ku laveki ku hakela nakambe, webusayiti yi ta susa tihakelo hi ku tisungulela hi ku ya hi matirhiselo, [vona tluka ra le kaya ku kuma nxavo](/#price) ).

## Tirhisa

### Phurojeke Ya Demo

Hi kombela u languta eka phurojeke ya [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) ku dyondza ku lulamisiwa ka vuhundzuluxeri bya `i18` .
...
U nga lulamisa `fromTo` yo hambana ya tifayili letitsongo / hambana Nkombiso wu tsariwile hi ndlela leyi landzelaka : .
...
Eka tafula leri ra vuhlanganisi, ririmi ra xihlovo xa vuhundzuluxeri bya khathalogi `blog` i `zh` , naswona ririmi ra xihlovo xa vuhundzuluxeri bya `blog/your_file_name.md` i `ja` .
...
`ignore` yi tirhisa xivumbeko lexi fanaka `.gitignore` [globset](https://docs.rs/globset/latest/globset/#syntax)

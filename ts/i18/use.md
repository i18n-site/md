...
Ku [i18n.site/payBill](//i18n.site/payBill) , u fanele ku boha khadi ra xikweleti leswaku u hakela (a ku laveki ku hakela nakambe, webusayiti yi ta susa tihakelo hi ku tisungulela hi ku ya hi matirhiselo, [vona tluka ra le kaya ku kuma nxavo](/#price) ).
...
`fromTo` yo hambana yi nga lulamisiwa eka tifayili letitsongo to / Nkombiso wu tsariwile hi ndlela leyi landzelaka :
...
Eka tafula leri ra vukorhokeri, ririmi ra xihlovo xa vuhundzuluxeri bya xikombo `blog` i `zh` , naswona ririmi ra xihlovo xa vuhundzuluxeri bya xikombo `blog/your_file_name.md` i `ja` .

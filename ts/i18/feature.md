...
Ku seketela vuhundzuluxi bya mixed HTML Markdown , leswi nga eka tithegi ta `<pre>` na `<code>` ta HTML leti nghenisiweke eka `MarkDown` a swi hundzuluxiwanga
...
Mavonelo ya vuhundzuluxi ya fanele ku kombisa ririmi endzhaku ka ` ``` ` , ku fana ` ```rust ` :

Sweswi, yi seketela vuhundzuluxi bya tinhlamuselo hi tindzimi ta `toml` , `yaml` , `json5` , `go` , `rust` , `c` , `cpp` , `java` , `js` , `coffee` , `python` , `bash` , `php` [na tindzimi tin’wana](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) .
...
## Ku Hava Ku Cinca, Ku Hava Vuhundzuluxeri
...
Hi tumbuluxile xitukulwana lexintshwa xa thekinoloji ya vuhundzuluxi leyi hlanganisaka swipfuno swa xithekiniki swa timodeli ta ndhavuko ta vuhundzuluxi bya muchini na timodeli letikulu ta ririmi ku endla leswaku vuhundzuluxi byi va lebyi kongomeke, byi olova na ku saseka.
...
[Click laha ku pfumelela no landzelela i18n.site ku tisungulela github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) na **ku kuma bonus $50** .
...
Xitirhisiwa xi hundzuluxela ntsena mimpimo ya xihlamusela-marito eka `YAML` , ku nga ri swilotlelo swa xihlamusela-marito.

Hi ku ya hi vuhundzuluxeri bya `YAML` , u nga aka swintshuxo swa matiko ya misava hi ku olova eka tindzimi to hambana ta minongonoko.

## Seketela Vuhundzuluxi `HOGO` Vukorhokeri Bya Nhlokomhaka

Ku seketela ku lulamisiwa ka nhlokomhaka ya [HOGO](https://github.com/gohugoio/hugo) wa static blog, leyi hundzuluxelaka ntsena tinsimu ta `title` , `summary` na `description` .

## U Nga Hundzuluxeli Mavito Ya Swilo Leswi Cinca-Cincaka

`Markdown` yi tirhisiwa tanihi xifaniso xa imeyili, `YAML` yi tirhisiwa tanihi vukorhokeri bya fayili ya ririmi, naswona ku ta va na tipharamitha leti cinca-cincaka (xikombiso: ku chajiwa nakambe `${amount}` ku amukeriwile).
...
Ku hundzuluxeriwa hi `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Ku hundzuluxeriwa hi `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Ku hundzuluxeriwa hi `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Xitirhisiwa i xihlovo lexi pfulekeke hi ku helela, naswona tlhelo ra 90 % ya khodi i xihlovo lexi pfulekeke [Click laha ku vona khodi ya xihlovo](/i18n.site/src) .

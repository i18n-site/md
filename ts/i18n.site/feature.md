# Xivumbeko Xa Xiendliwa

## Vuhundzuluxi Lebyi Hlanganisiweke `I18`

Nongonoko wu na vuhundzuluxeri lebyi akiweke `i18` , hi kombela u vona [➔ `i18`](/i18) ku kuma matirhiselo yo karhi.
...
Hi ku tiyimisela `i18n.site` swilo swa sayiti swi ta kandziyisiwa eka `npmjs.com` , hi ku pfuniwa hi [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) na swilo swo tala `CDN` leswi layichiweke eka `npm` .
...
Nsinya wa nawu hi leswaku: kavanyeta xikombelo hi `CDN` pfuniwa hi [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)

Khodi leyi fambelanaka na [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) :
...
Hi ku tiyimisela, [Alimama dual-axis variable rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) na tifonto tin’wana ta inthanete ti pfuriwile eka pheji ya webu ku hlanganisa ntokoto wo hlaya wa vatirhisi eka tipulatifomo to hambana.
...
Khodi leyi fambelanaka na [github.com/i18n-site/font](https://github.com/i18n-site/font) :
...
Ku na xipoko lexitsongo xo saseka lexi papamalaka eka pheji, mahlo ya xona ya ta famba na mbeva, [➔ Click here to view](/404) , `404`

## Khodi Ya Xihlovo Lexi Pfulekeke

[Khodi i xihlovo lexi pfulekeke](/i18n.site/src) [.](//groups.google.com/u/2/g/i18n-site)

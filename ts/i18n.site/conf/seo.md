...
Eka ku lulamisa, hi kombela u cinca `i18n.site` ku ya eka ntikelo wa `host:` eka `.i18n/htm/ol.yml` , switolo swo tala swa swilo swi nga lulamisiwa ehansi ka `s3` , naswona nsimu ya `region` i ya ku hlawula (switolo swo tala swa swilo a swi lavi ku veka nsimu leyi).
...
Loko u lava ku nyika vukorhokeri etikweni-nkulu ra China naswona u tlhela u lava `cloudflare` vutleketli bya mahala bya matiko ya misava, u nga tirhisa `DNS` hi xiboho xa xifundzha.
...
Hikuva `R2` `cloudflare` fikeleleki hi vito ra domain leri endleriweke wena, vuhlayiselo bya swilo bya munhu wa vunharhu byi lava ku tirhisiwa ku veka tifayela leti nga cinciki.

Laha hi `cloudflare` [backblaze.com](https://www.backblaze.com)
...
Engetelani nawu wa ku hundzula tanihilaha swi kombisiweke hakona laha hansi, wu veke ku sungula (wo sungula wu na nkoka wa le hansi):

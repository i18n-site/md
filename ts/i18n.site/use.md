...
Endzhaku ko fambisa vuhundzuluxeri lebyi nga laha henhla, tidayirekitara `htm` na `v` ti ta endliwa ehansi ka xikombo xa `md/out/dev` .
...
Nghenisa `md` directory ivi u tsutsuma

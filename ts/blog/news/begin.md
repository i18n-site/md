...
Layini ya swileriso [js nghenisiwile Injhini boa_engine](https://docs.rs/boa_engine) , [database leyi nghenisiweke fjall](https://github.com/fjall-rs/fjall) .

sevha VPS [contabo](https://my.contabo.com)

database [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

Rhumela poso eka [chasquid](https://github.com/albertito/chasquid) tiyimeleke SMTP

## Tihlanganise Na Hina

Loko ku sunguriwa swilo leswintshwa, swiphiqo a swi papalateki.

Titwele [groups.google.com/u/2/g/i18n-site](https://groups.google.com/u/2/g/i18n-site) ntshunxekile ku hi tihlanganisa hi ku tirhisa Google Forum :
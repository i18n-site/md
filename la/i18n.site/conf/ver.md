...
Commendatur solum numerum versionis documenti mitigare cum maioris updates emissi sunt (ut `v1` , `v2` ), ne nimis multi numeri versionis clutter causantes in paginis per tormenta quaesita indicentur.
...
Exempli gratia, index fasciculi respondens `blog` in demo consilii [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) :
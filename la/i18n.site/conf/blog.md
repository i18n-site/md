...
A demo fasciculus sic configuratur:
...
Auctor informationis scribi potest in meta-information articuli, ut:
...
Si articulum ad cacumen suspendere debes, `i18n.site` curre et `xxx.yml` fasciculos infra `.i18n/data/blog` recense, et notam ad numerum negativum muta (multiplices numeri negativi a maximis ad minimos digesti erunt).
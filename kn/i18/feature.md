...
ಅನುವಾದ ಕಾಮೆಂಟ್ಗಳು ` ``` ` ನಂತರದ ಭಾಷೆಯನ್ನು ಸೂಚಿಸುವ ಅಗತ್ಯವಿದೆ, : ` ```rust ` .
...
`title` , `summary` ಮತ್ತು `description` ಕ್ಷೇತ್ರಗಳನ್ನು ಮಾತ್ರ ಭಾಷಾಂತರಿಸುವ [HOGO](https://github.com/gohugoio/hugo) ಟೈಪ್ ಸ್ಟ್ಯಾಟಿಕ್ ಬ್ಲಾಗ್ ಅನ್ನು ಬೆಂಬಲಿಸುತ್ತದೆ.

## ವೇರಿಯಬಲ್ ಹೆಸರುಗಳನ್ನು ಅನುವಾದಿಸಬೇಡಿ

`Markdown` ಅನ್ನು ಇಮೇಲ್ ಟೆಂಪ್ಲೇಟ್ ಆಗಿ ಬಳಸಲಾಗುತ್ತದೆ, `YAML` ಅನ್ನು ಭಾಷಾ ಫೈಲ್ ಕಾನ್ಫಿಗರೇಶನ್ ಆಗಿ ಬಳಸಲಾಗುತ್ತದೆ, ಮತ್ತು ವೇರಿಯಬಲ್ ಪ್ಯಾರಾಮೀಟರ್ಗಳು ಇರುತ್ತವೆ (ಉದಾಹರಣೆಗೆ: ರೀಚಾರ್ಜ್ `${amount}` ಅನ್ನು ಸ್ವೀಕರಿಸಲಾಗಿದೆ).

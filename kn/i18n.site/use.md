...
ಚಾಲನೆಯ ನಂತರ, ಅನುವಾದ ಮತ್ತು ಸಂಗ್ರಹ `git add . ` `md` ಡೈರೆಕ್ಟರಿಯಲ್ಲಿ ಸೇರಿಸಲು ದಯವಿಟ್ಟು ಮರೆಯದಿರಿ.
...
`dev.yml` ಮತ್ತು `ol.yml` ಡೀಫಾಲ್ಟ್ ಕಾನ್ಫಿಗರೇಶನ್ಗಳಾಗಿವೆ.
...
`md/.i18n/htm/ol.yml` ಸಂಪಾದಿಸಿ ಮತ್ತು `i18n.site` `v: //unpkg.com/i18n.site` ಸ್ವಂತ `npm` ಪ್ಯಾಕೇಜ್ ಹೆಸರಿಗೆ ಬದಲಾಯಿಸಿ.

ಕೇವಲ ಆಕ್ರಮಿಸದ ಪ್ಯಾಕೇಜ್ ಹೆಸರನ್ನು ಬಳಸಿ [npmjs.com](//npmjs.com)

ಪ್ಯಾಕೇಜ್ `npm` ಅನ್ನು ಆಧರಿಸಿ ಪ್ರಕಟಿಸುವಾಗ, `v:` ಮೌಲ್ಯದ ಪೂರ್ವಪ್ರತ್ಯಯಕ್ಕಾಗಿ **`//unpkg.com/` ಬಳಸಲು ಮರೆಯದಿರಿ** `i18n.site` ಹೊಸ ಬಿಡುಗಡೆಗಳ ಸಮಯೋಚಿತ ವೀಕ್ಷಣೆಯನ್ನು ಸಾಧಿಸಲು ಈ ಪೂರ್ವಪ್ರತ್ಯಯ ಮಾರ್ಗದ ಅಡಿಯಲ್ಲಿ `/.v` ರ ಸಂಗ್ರಹ ಸಮಯವನ್ನು ವಿಶೇಷವಾಗಿ ಆಪ್ಟಿಮೈಸ್ ಮಾಡಲಾಗಿದೆ.
...
`ol.yml` ರಲ್ಲಿ `v:` ರ ಪ್ಯಾಕೇಜ್ ಹೆಸರನ್ನು ನೀವು ಮಾರ್ಪಡಿಸಿದರೆ, ದಯವಿಟ್ಟು **ಮೊದಲು `.i18n/v/ol` ಅಳಿಸಲು ಮತ್ತು ನಂತರ ಅದನ್ನು ಪ್ರಕಟಿಸಲು ಮರೆಯದಿರಿ** .
...
ನೀವು ವಿಷಯವನ್ನು ಸ್ವಯಂ-ಹೋಸ್ಟ್ ಮಾಡಲು ಬಯಸಿದರೆ, ಮೊದಲು `md/.i18n/htm/ol.yml` ಸಂಪಾದಿಸಿ ಮತ್ತು `v: //unpkg.com/i18n.site` ನಿಮ್ಮ URL ಪೂರ್ವಪ್ರತ್ಯಯಕ್ಕೆ ಬದಲಾಯಿಸಿ, ಉದಾಹರಣೆಗೆ `v: //i18n-v.xxx.com` .
...
ನಂತರ, `md/out/ol/v` ಡೈರೆಕ್ಟರಿಯಲ್ಲಿರುವ ವಿಷಯವನ್ನು `v:` ರಲ್ಲಿ ಹೊಂದಿಸಲಾದ URL ಪೂರ್ವಪ್ರತ್ಯಯ ಮಾರ್ಗಕ್ಕೆ ಕಾನ್ಫಿಗರ್ ಮಾಡಿ.
...
ಸ್ವಯಂ ಹೋಸ್ಟ್ ಮಾಡಲು, ನಿಮ್ಮ ಸ್ವಂತ ಸರ್ವರ್ ಅನ್ನು ಬಳಸುವುದರ ಜೊತೆಗೆ, `S3` + `CDN` ಸಾಮಾನ್ಯ ಆಯ್ಕೆಯಾಗಿದೆ.
...
ವೆಬ್ಸೈಟ್ [ಒಂದೇ ಪುಟದ ಅಪ್ಲಿಕೇಶನ್](https://developer.mozilla.org/docs/Glossary/SPA) ಆರ್ಕಿಟೆಕ್ಚರ್ ಅನ್ನು ಬಳಸುವುದರಿಂದ, `. ` ರಿಂದ `index.html` ಹೊಂದಿರದ URL ಮಾರ್ಗಗಳನ್ನು ಪುನಃ ಬರೆಯಲು ಮರೆಯದಿರಿ.
...
ನಂತರ ಈ ಸಂಸ್ಥೆಯ ಅಡಿಯಲ್ಲಿ ವೇರ್ಹೌಸ್ `i18n-demo.github.io` ರಚಿಸಿ (ದಯವಿಟ್ಟು `i18n-demo` ನೀವು ರಚಿಸಿದ ಸಂಸ್ಥೆಯ ಹೆಸರಿನೊಂದಿಗೆ ಬದಲಾಯಿಸಿ):
...
[cloudflare page](//pages.cloudflare.com) `github page` ಹೋಲಿಸಿದರೆ, ಇದು ಮಾರ್ಗವನ್ನು ಪುನಃ ಬರೆಯುವುದನ್ನು ಒದಗಿಸುತ್ತದೆ ಮತ್ತು ಚೀನಾದ ಮುಖ್ಯ ಭೂಮಿಗೆ ಹೆಚ್ಚು ಸ್ನೇಹಿಯಾಗಿದೆ ಮತ್ತು ಇದನ್ನು ಬಳಸಲು ಶಿಫಾರಸು ಮಾಡಲಾಗಿದೆ.
...
ನಂತರ, ಚೀನಾದ ಮುಖ್ಯ ಭೂಭಾಗದಲ್ಲಿರುವ ಕ್ಲೌಡ್ ಮಾರಾಟಗಾರರ ವಸ್ತು ಸಂಗ್ರಹಣೆಯನ್ನು ಬಳಸಿ + ಕೆಳಗಿನ ವಿಷಯವನ್ನು ನಿಯೋಜಿಸಿ `CDN` `out/ol/htm`

ಏಕ-ಪುಟದ ಅಪ್ಲಿಕೇಶನ್ಗಳಿಗೆ ಹೊಂದಿಕೊಳ್ಳುವ ಮಾರ್ಗವನ್ನು ಪುನಃ ಬರೆಯಲು ನೀವು ಎಡ್ಜ್ ಕಂಪ್ಯೂಟಿಂಗ್ ಅನ್ನು ಬಳಸಬಹುದು ಉದಾಹರಣೆಗೆ, [Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) ಈ ರೀತಿ ಕಾನ್ಫಿಗರ್ ಮಾಡಬಹುದು:
...
ರೆಕಾರ್ಡ್ `MX` ಮತ್ತು ರೆಕಾರ್ಡ್ `CNAME` ಸಹ ಅಸ್ತಿತ್ವದಲ್ಲಿರಲು ಸಾಧ್ಯವಿಲ್ಲ, [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) ಅದೇ ಸಮಯದಲ್ಲಿ ಡೊಮೇನ್ ಹೆಸರಿನ ಇಮೇಲ್ಗಳನ್ನು ಸ್ವೀಕರಿಸಲು ಬಯಸಿದರೆ, ನೀವು `CNAME` ಹಂತಕ್ಕೆ ರೆಕಾರ್ಡ್ `A` ಗೆ ಸಹಕರಿಸಬೇಕು.

ಹೆಚ್ಚುವರಿಯಾಗಿ, ಚೀನಾದ ಮುಖ್ಯ ಭೂಭಾಗದಲ್ಲಿರುವ ಕ್ಲೌಡ್ ಮಾರಾಟಗಾರರ ಸಾಗರೋತ್ತರ ಟ್ರಾಫಿಕ್ ಶುಲ್ಕಗಳು ತುಲನಾತ್ಮಕವಾಗಿ ದುಬಾರಿಯಾಗಿರುವುದರಿಂದ, ನೀವು ವೆಚ್ಚವನ್ನು ಉತ್ತಮಗೊಳಿಸಲು ಬಯಸಿದರೆ, ನೀವು ಸಾಧಿಸಲು [Huawei DNS ನ ಉಚಿತ ಭೌಗೋಳಿಕ ರೆಸಲ್ಯೂಶನ್](https://support.huaweicloud.com/usermanual-dns/dns_usermanual_0041.html) ಮತ್ತು [Cloudflare for SaaS](https://developers.cloudflare.com/cloudflare-for-platforms/cloudflare-for-saas) ನ ಕಸ್ಟಮ್ ಡೊಮೇನ್ ಹೆಸರನ್ನು (ಕೆಳಗೆ ತೋರಿಸಿರುವಂತೆ) ಬಳಸಬಹುದು ಟ್ರಾಫಿಕ್ ಡೈವರ್ಶನ್──ಚೀನಾ ಬೈದು ಕ್ಲೌಡ್ `CDN` ಮುಖ್ಯ ಭೂಭಾಗದಲ್ಲಿ ಸಂಚಾರ , ಅಂತಾರಾಷ್ಟ್ರೀಯ ಸಂಚಾರ cloudflare .
...
[ಅಲಿಬಾಬಾ CDN](https://cdn.console.aliyun.com/domain/list) ಡೊಮೇನ್ ಹೆಸರನ್ನು ಸೇರಿಸಿ ಮತ್ತು ಅಲಿಬಾಬಾ ಕ್ಲೌಡ್ `CDN` ರಲ್ಲಿ ಡೊಮೇನ್ ಹೆಸರನ್ನು `*.xxx.com` ರಿಂದ `CNAME` ರವರೆಗೆ ಸೂಚಿಸಿ.
...
nginx ನ `server` ಪ್ಯಾರಾಗ್ರಾಫ್ನಲ್ಲಿ ಕೆಳಗಿನವುಗಳಿಗೆ ಹೋಲುವ ಸಂರಚನೆಯನ್ನು ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸ್ವಂತ ಯೋಜನೆ `out/ol/htm` ರ ಮಾರ್ಗಕ್ಕೆ `/root/i18n/md/out/ol/htm` :
...
`.i18n` ಡೈರೆಕ್ಟರಿ ಅಡಿಯಲ್ಲಿ `i18n.site` ರ ಕಾನ್ಫಿಗರೇಶನ್ ಫೈಲ್ಗಳು, ಅನುವಾದ ಸಂಗ್ರಹ, ಇತ್ಯಾದಿ. ವಿವರಗಳಿಗಾಗಿ ಮುಂದಿನ ಅಧ್ಯಾಯ ["ಕಾನ್ಫಿಗರೇಶನ್" ಅನ್ನು](/i18n.site/conf) ನೋಡಿ.

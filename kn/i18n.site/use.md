...
`md/.i18n/htm/ol.yml` ಸಂಪಾದಿಸಿ ಮತ್ತು `v: //unpkg.com/i18n.site` ರಲ್ಲಿ `i18n.site` ನಿಮ್ಮ ಸ್ವಂತ `npm` ಪ್ಯಾಕೇಜ್ ಹೆಸರಿಗೆ ಬದಲಾಯಿಸಿ.

ಕೇವಲ ಆಕ್ರಮಿಸದ ಪ್ಯಾಕೇಜ್ ಹೆಸರನ್ನು ಬಳಸಿ [npmjs.com](//npmjs.com)

ಪ್ಯಾಕೇಜ್ `npm` ಆಧರಿಸಿ ಪ್ರಕಟಿಸುವಾಗ, `v:` ಮೌಲ್ಯದ ಪೂರ್ವಪ್ರತ್ಯಯಕ್ಕಾಗಿ **`//unpkg.com/` ಬಳಸಲು ಮರೆಯದಿರಿ** `i18n.site` ಹೊಸ ಬಿಡುಗಡೆಗಳ ಸಮಯೋಚಿತ ವೀಕ್ಷಣೆಯನ್ನು ಸಾಧಿಸಲು ಈ ಪೂರ್ವಪ್ರತ್ಯಯ ಮಾರ್ಗದ ಅಡಿಯಲ್ಲಿ `/.v` ರ ಸಂಗ್ರಹ ಸಮಯವನ್ನು ವಿಶೇಷವಾಗಿ ಆಪ್ಟಿಮೈಸ್ ಮಾಡಲಾಗಿದೆ.

ಭಾಷಾಂತರಿಸಲು ಮತ್ತು ಪ್ರಕಟಿಸಲು `md` ಡೈರೆಕ್ಟರಿಯಲ್ಲಿ `i18n.site --npm` ಅಥವಾ `i18n.site -n` ರನ್ ಮಾಡಿ.

ನೀವು ಪ್ರಕಟಿಸಲು ನಿರಂತರ ಏಕೀಕರಣ ಪರಿಸರವನ್ನು ಬಳಸಿದರೆ, `nodejs` ಸ್ಥಾಪಿಸುವ ಅಗತ್ಯವಿಲ್ಲ, ಲಾಗ್ ಇನ್ ಮಾಡಿ ಮತ್ತು ಪ್ರಕಟಿಸುವ ಅನುಮತಿ `~/.npmrc` ಪರಿಸರಕ್ಕೆ ನಕಲಿಸಿ.
...
[cloudflare page](//pages.cloudflare.com) ಗೆ ಹೋಲಿಸಿದರೆ, ಇದು ಮಾರ್ಗವನ್ನು ಪುನಃ ಬರೆಯುವುದನ್ನು ಒದಗಿಸುತ್ತದೆ ಮತ್ತು `github page` ಮುಖ್ಯ ಭೂಮಿಗೆ ಹೆಚ್ಚು ಸ್ನೇಹಿಯಾಗಿದೆ ಮತ್ತು ಇದನ್ನು ಬಳಸಲು ಶಿಫಾರಸು ಮಾಡಲಾಗಿದೆ.
...
ನಂತರ, + ಮುಖ್ಯ ಭೂಭಾಗದಲ್ಲಿರುವ ಕ್ಲೌಡ್ ಮಾರಾಟಗಾರರ ವಸ್ತು ಸಂಗ್ರಹಣೆಯನ್ನು ಬಳಸಿ `CDN` ಕೆಳಗಿನ ವಿಷಯವನ್ನು ನಿಯೋಜಿಸಿ `out/ol/htm` .
...
ರೆಕಾರ್ಡ್ `MX` ಮತ್ತು ರೆಕಾರ್ಡ್ `CNAME` ಸಹ ಅಸ್ತಿತ್ವದಲ್ಲಿರಲು ಸಾಧ್ಯವಿಲ್ಲದ ಕಾರಣ, ನೀವು ಅದೇ ಸಮಯದಲ್ಲಿ ಡೊಮೇನ್ ಹೆಸರಿನ ಇಮೇಲ್ಗಳನ್ನು ಸ್ವೀಕರಿಸಲು ಬಯಸಿದರೆ, [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) `CNAME` ಹಂತಕ್ಕೆ ರೆಕಾರ್ಡ್ `A` ಗೆ ಸಹಕರಿಸಬೇಕು.
...
nginx ನ `server` ಪ್ಯಾರಾಗ್ರಾಫ್ನಲ್ಲಿ `/root/i18n/md/out/ol/htm` ಹೋಲುವ ಸಂರಚನೆಯನ್ನು ದಯವಿಟ್ಟು ನಿಮ್ಮ ಸ್ವಂತ ಯೋಜನೆ `out/ol/htm` ರ ಮಾರ್ಗಕ್ಕೆ ಬದಲಾಯಿಸಿ:

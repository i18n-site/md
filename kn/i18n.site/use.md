...
`md/.i18n/htm/ol.yml` ಸಂಪಾದಿಸಿ ಮತ್ತು [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` ರ ಮೌಲ್ಯವನ್ನು ನಿಮ್ಮದೇ [npmjs.com](//npmjs.com) `npm` ಪ್ಯಾಕೇಜ್ ಹೆಸರಿನಂತೆ ಬದಲಾಯಿಸಿ.

ನಂತರ `md/.i18n/htm/ol.package.json` ಮಾರ್ಪಡಿಸಿ

...
ಸ್ಥಾನಿಕ ಆಂಕರ್ ಪಾಯಿಂಟ್ ಅನ್ನು ಹಸ್ತಚಾಲಿತವಾಗಿ ರಚಿಸಲು `MarkDown` ರಲ್ಲಿ `<a rel=id href="#xxx" id="xxx"></a>` ಕ್ಕೆ ಹೋಲುವ ಪಠ್ಯವನ್ನು ಸೇರಿಸುವುದು `i18n.site` ನೊಂದಿಗೆ ಒಪ್ಪಿಕೊಂಡಿರುವ ಆಂಕರ್ ಪಾಯಿಂಟ್ ಪರಿಹಾರವಾಗಿದೆ.
...
## ಬಹು ಭಾಷೆಗಳಲ್ಲಿ ಚಿತ್ರಗಳು/ವೀಡಿಯೋಗಳು/ಲಿಂಕ್ಗಳು

`MarkDown` `HTML` ಗೆ ಪರಿವರ್ತಿಸಿದ ನಂತರ, `src` ಮತ್ತು `href` ಗುಣಲಕ್ಷಣಗಳಲ್ಲಿನ `$LANG` ಪ್ರಸ್ತುತ [ಭಾಷೆಯ ಕೋಡ್ನೊಂದಿಗೆ](/i18/LANG_CODE) ಬದಲಾಯಿಸಲಾಗುತ್ತದೆ.

ಈ ವೇರಿಯಬಲ್ನೊಂದಿಗೆ, ನೀವು ಚಿತ್ರಗಳು/ವೀಡಿಯೊಗಳು/ಲಿಂಕ್ಗಳ ಬಹುಭಾಷಾೀಕರಣವನ್ನು ಸಾಧಿಸಬಹುದು.
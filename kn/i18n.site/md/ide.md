...
ನಾವು `MarkDown` ಬರೆಯಲು [vscode](https://code.visualstudio.com/) ಮತ್ತು ಬರೆಯುವಾಗ ನೈಜ ಸಮಯದಲ್ಲಿ ಪೂರ್ವವೀಕ್ಷಣೆ ಮಾಡಲು ಪ್ಲಗ್-ಇನ್ [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ಅನ್ನು ಸ್ಥಾಪಿಸುತ್ತೇವೆ.
...
ಚಿತ್ರಗಳನ್ನು ಅಪ್ಲೋಡ್ ಮಾಡಲು [PicList](https://github.com/Kuingsmile/PicList) ಅಪ್ಲೋಡ್ ಶಾರ್ಟ್ಕಟ್ ಕೀಲಿಯನ್ನು ಹೊಂದಿಸಲು ಮರೆಯದಿರಿ ಮತ್ತು ಒಂದೇ ಕ್ಲಿಕ್ನಲ್ಲಿ ಸ್ಕ್ರೀನ್ಶಾಟ್ ಅನ್ನು ಅಪ್ಲೋಡ್ ಮಾಡಿ.

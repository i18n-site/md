...
`i18n.site` ರಿಫ್ರೆಶ್ ಮಾಡದ ಸಿಂಗಲ್ ಪೇಜ್ ಆರ್ಕಿಟೆಕ್ಚರ್ `sitemap.xml` ಅಳವಡಿಸಿಕೊಳ್ಳುತ್ತದೆ.
...
ಕಾನ್ಫಿಗರೇಶನ್ನಲ್ಲಿ, ದಯವಿಟ್ಟು `i18n.site` `.i18n/htm/ol.yml` ರಲ್ಲಿ `host:` ರ ಮೌಲ್ಯಕ್ಕೆ ಬದಲಾಯಿಸಿ, ಬಹು ಆಬ್ಜೆಕ್ಟ್ ಸ್ಟೋರ್ಗಳನ್ನು `s3` ಅಡಿಯಲ್ಲಿ ಕಾನ್ಫಿಗರ್ ಮಾಡಬಹುದು ಮತ್ತು `region` ಕ್ಷೇತ್ರವು ಐಚ್ಛಿಕವಾಗಿರುತ್ತದೆ (ಹಲವು ಆಬ್ಜೆಕ್ಟ್ ಸ್ಟೋರ್ಗಳು ಈ ಕ್ಷೇತ್ರವನ್ನು ಹೊಂದಿಸುವ ಅಗತ್ಯವಿಲ್ಲ).
...
ಮರುನಿರ್ದೇಶನ ನಿಯಮಗಳನ್ನು ಈ ಕೆಳಗಿನಂತೆ ಹೊಂದಿಸಿ, ದಯವಿಟ್ಟು ನಿಮ್ಮ ಡೊಮೇನ್ ಹೆಸರಿಗೆ "i18n.site" ಕೋಡ್ ಅನ್ನು ಮಾರ್ಪಡಿಸಿ
...
ಉದಾಹರಣೆಗೆ, [Huawei DNS](https://www.huaweicloud.com) `cloudflare`
...
`R2` ಕಸ್ಟಮೈಸ್ ಮಾಡಿದ ಡೊಮೇನ್ ಹೆಸರಿನ ಮೂಲಕ ಪ್ರವೇಶಿಸಲು `cloudflare` ಕಾರಣ, ಸ್ಥಿರ ಫೈಲ್ಗಳನ್ನು ಇರಿಸಲು ಮೂರನೇ ವ್ಯಕ್ತಿಯ ವಸ್ತು ಸಂಗ್ರಹಣೆಯನ್ನು ಬಳಸಬೇಕಾಗುತ್ತದೆ.
...
`Rewrite to` ಡೈನಾಮಿಕ್ ಅನ್ನು ಆಯ್ಕೆ ಮಾಡಿ ಮತ್ತು `your_bucketname` `concat("/file/your_bucketname",http.request.uri.path)` ನಿಮ್ಮ ಬಕೆಟ್ ಹೆಸರಿಗೆ ಮಾರ್ಪಡಿಸಿ.

...
`url:` `Markdown` ರ ಫೈಲ್ ಮಾರ್ಗವನ್ನು ಪ್ರತಿನಿಧಿಸುತ್ತದೆ ( `/` ರೂಟ್ ಡೈರೆಕ್ಟರಿ `/README.md` ಗೆ ಅನುರೂಪವಾಗಿದೆ, ಈ ಫೈಲ್ ಹೆಸರಿಗೆ ದೊಡ್ಡಕ್ಷರ ಪೂರ್ವಪ್ರತ್ಯಯ ಮತ್ತು ಸಣ್ಣ ಪ್ರತ್ಯಯ ಅಗತ್ಯವಿರುತ್ತದೆ).
...
ಉದಾಹರಣೆಗೆ, `/test` ಪ್ರವೇಶಿಸಿದರೆ ಮತ್ತು `nav:` ಈ ಮಾರ್ಗವಿಲ್ಲದೆ ಕಾನ್ಫಿಗರ್ ಮಾಡಿದ್ದರೆ ಮತ್ತು ಪುಟ ಭಾಷೆ ಇಂಗ್ಲಿಷ್ (ಕೋಡ್ `en` ) ಆಗಿದ್ದರೆ, `/en/test.md` ಪೂರ್ವನಿಯೋಜಿತವಾಗಿ ಲೋಡ್ ಮಾಡಲಾಗುತ್ತದೆ ಮತ್ತು ಟೆಂಪ್ಲೇಟ್ `Md` ಅನ್ನು ಬಳಸಿಕೊಂಡು ರೆಂಡರ್ ಮಾಡಲಾಗುತ್ತದೆ.
...
ಔಟ್ಲೈನ್ನ ಶ್ರೇಣೀಕೃತ ಸಂಬಂಧವನ್ನು ಸೂಚಿಸಲು ಮತ್ತು ಬಹು-ಹಂತದ ಇಂಡೆಂಟೇಶನ್ ಅನ್ನು ಬೆಂಬಲಿಸಲು `TOC` ಫೈಲ್ಗಳನ್ನು ಇಂಡೆಂಟ್ ಮಾಡಲಾಗಿದೆ.

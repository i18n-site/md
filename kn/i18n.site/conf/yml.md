...
### `use: Toc` , ಔಟ್ಲೈನ್ನೊಂದಿಗೆ ಏಕ ಫೈಲ್ ಟೆಂಪ್ಲೇಟ್
...
### `use: Md` , ಔಟ್ಲೈನ್ ಇಲ್ಲದೆ ಒಂದೇ ಫೈಲ್ ಟೆಂಪ್ಲೇಟ್
...
### `use: Doc` , ಬಹು-ಫೈಲ್ ಡಾಕ್ಯುಮೆಂಟ್ ಟೆಂಪ್ಲೇಟ್
...
ಮೇಲಿನ ಬರವಣಿಗೆಯ ವಿಧಾನವು `url: xxx` ಗೆ ಸಮನಾಗಿರುತ್ತದೆ ಮತ್ತು ಅದರ ಅನುಗುಣವಾದ ಫೈಲ್ `en/xxx/TOC` ಆಗಿದೆ.

#### TOC ಪರಿವಿಡಿ ಸೂಚ್ಯಂಕ

`json` ಡೈರೆಕ್ಟರಿ ಔಟ್ಲೈನ್ ಅನ್ನು ರಚಿಸಲು `doc` ಟೆಂಪ್ಲೇಟ್ ಕಾನ್ಫಿಗರೇಶನ್ಗೆ ಅನುಗುಣವಾದ `TOC` ಡೈರೆಕ್ಟರಿ ಸೂಚ್ಯಂಕ ಫೈಲ್ ಅನ್ನು ಓದಲು ಡೆಮೊ ವೇರ್ಹೌಸ್ನಲ್ಲಿ `i18n.site` `js` ಪ್ಲಗ್-ಇನ್ `.i18n/hook/after.tran/TOC.js` ಅನ್ನು ಕಾರ್ಯಗತಗೊಳಿಸುತ್ತದೆ.

ನೀವು `doc` ಟೆಂಪ್ಲೇಟ್ ಅನ್ನು ಬಳಸಿದರೆ, ನೀವು ಈ ಪ್ಲಗ್-ಇನ್ ಅನ್ನು ಹೊಂದಿರಬೇಕು.

ನೀವು ಖಾಲಿ ಫೋಲ್ಡರ್ನಿಂದ ಪ್ರಾಜೆಕ್ಟ್ `i18n.site` ಅನ್ನು ಪ್ರಾರಂಭಿಸಿದರೆ, ಡೆಮೊ ಪ್ರಾಜೆಕ್ಟ್ `.i18n` ಅನ್ನು ನಿಮ್ಮ ಡೈರೆಕ್ಟರಿಗೆ ನಕಲಿಸಲು ಮರೆಯದಿರಿ.

`Doc` ಟೆಂಪ್ಲೇಟ್ ರಚಿತವಾದ `json` ಅನ್ನು ಆಧರಿಸಿ ಪರಿವಿಡಿ ರೂಪರೇಖೆಯನ್ನು ನಿರೂಪಿಸುತ್ತದೆ.
...
ಉದಾಹರಣೆಗೆ, `/test` ಅನ್ನು ಪ್ರವೇಶಿಸಿದರೆ ಮತ್ತು ಈ ಮಾರ್ಗದ ಪೂರ್ವಪ್ರತ್ಯಯವಿಲ್ಲದೆ `nav:` ಕಾನ್ಫಿಗರ್ ಮಾಡಿದ್ದರೆ ಮತ್ತು ಪ್ರಸ್ತುತ ಬ್ರೌಸಿಂಗ್ ಭಾಷೆ ಇಂಗ್ಲಿಷ್ (ಕೋಡ್ `en` ) ಆಗಿದ್ದರೆ, `/en/test.md` ಪೂರ್ವನಿಯೋಜಿತವಾಗಿ ಲೋಡ್ ಮಾಡಲಾಗುತ್ತದೆ ಮತ್ತು ಟೆಂಪ್ಲೇಟ್ `Md` ಬಳಸಿಕೊಂಡು ರೆಂಡರ್ ಮಾಡಲಾಗುತ್ತದೆ.

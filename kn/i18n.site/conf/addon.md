...
`file` ಎಂಬುದು ಔಟ್ಪುಟ್ ಫೈಲ್ ಪಟ್ಟಿ, `path` ಫೈಲ್ ಪಾತ್ ಮತ್ತು `txt` ಫೈಲ್ ವಿಷಯವಾಗಿದೆ.

## ಅಂತರ್ನಿರ್ಮಿತ ಕಾರ್ಯಗಳು

ಅಂತರ್ನಿರ್ಮಿತ `js` ರನ್ಟೈಮ್ [boa](https://github.com/boa-dev/boa) ನ ದ್ವಿತೀಯ ಅಭಿವೃದ್ಧಿಯನ್ನು ಆಧರಿಸಿದೆ, ಮತ್ತು ಅಂತರ್ನಿರ್ಮಿತ ಕಾರ್ಯಗಳು ಈ :

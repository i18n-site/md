...
# ಶುದ್ಧ ಫ್ರಂಟ್-ಎಂಡ್ ತಲೆಕೆಳಗಾದ ಪೂರ್ಣ-ಪಠ್ಯ ಹುಡುಕಾಟ
...
* `/\p{P}/` ಎಂಬುದು ವಿರಾಮಚಿಹ್ನೆಗಳಿಗೆ ಹೊಂದಿಕೆಯಾಗುವ ನಿಯಮಿತ ಅಭಿವ್ಯಕ್ತಿಯಾಗಿದೆ: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` { | } . `.</p><ul><li> `split('.')` ಏಕೆಂದರೆ `Firefox` ಬ್ರೌಸರ್ ವರ್ಡ್ ಸೆಗ್ಮೆಂಟೇಶನ್ ವಿಭಾಗ `. ` ಅಲ್ಲ.</li>
...
ಡಾಕ್ಯುಮೆಂಟ್ `url` ಮತ್ತು ಆವೃತ್ತಿ ಸಂಖ್ಯೆ `ver` ರ ಶ್ರೇಣಿಯಲ್ಲಿ ಪಾಸ್ ಮಾಡಿ ಮತ್ತು ಡಾಕ್ಯುಮೆಂಟ್ ಟೇಬಲ್ `doc` ರಲ್ಲಿ ಅಸ್ತಿತ್ವದಲ್ಲಿದೆಯೇ ಎಂದು ಹುಡುಕಿ. ಅದು ಅಸ್ತಿತ್ವದಲ್ಲಿಲ್ಲದಿದ್ದರೆ, ತಲೆಕೆಳಗಾದ ಸೂಚಿಯನ್ನು ರಚಿಸಿ. ಅದೇ ಸಮಯದಲ್ಲಿ, ರವಾನಿಸದ ದಾಖಲೆಗಳಿಗಾಗಿ ತಲೆಕೆಳಗಾದ ಸೂಚಿಯನ್ನು ತೆಗೆದುಹಾಕಿ.

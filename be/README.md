...
* [i18n.site : шматмоўнага статычнага сайта](/i18n.site)
...
Мы прытрымліваемся філасофіі `UNIX` " Усё - гэта файл " і можам кіраваць перакладамі на сотні моў без увядзення складаных і грувасткіх рашэнняў на ўзроўні прадпрыемства.
...
База кода можа быць створана як адкрыты зыходны код для моўных файлаў, і з дапамогай `Pull Request` працэсаў глабальныя карыстальнікі могуць удзельнічаць у пастаяннай аптымізацыі перакладаў. Беспраблемнае злучэнне [github](//github.com) іншыя суполкі з адкрытым зыходным кодам.

[→ Каб атрымаць кіраўніцтва карыстальніка, прачытайце праектную дакументацыю](/i18) .

## Аўтаматычны Пераклад Лепшай Якасці

Мы распрацавалі новае пакаленне тэхналогіі перакладу, якая аб'ядноўвае тэхнічныя перавагі традыцыйных мадэляў машыннага перакладу і вялікіх моўных мадэляў, каб зрабіць пераклад дакладным, плаўным і элегантным.
...
[Націсніце тут i18n.site каб аўтарызавацца і аўтаматычна падпісвацца на github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) і **атрымліваць бонус $50** .
...
Базавая інтэрфейсная структура прымае поўную архітэктуру плагіна, якая лёгкая для другаснай распрацоўкі, у выпадку неабходнасці могуць быць інтэграваныя ўнутраныя функцыі.

Гэты вэб-сайт распрацаваны на аснове гэтай структуры і ўключае ў сябе карыстальніцкія, аплатныя і іншыя функцыі ( [падрабязны](/i18n.site/src) падручнік будзе напісаны пазней).

[→ Каб атрымаць кіраўніцтва карыстальніка, прачытайце праектную дакументацыю](/i18n.site) .

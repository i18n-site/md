...
## <a rel=id href="#project" id="project"></a> Апісанне праекта
...
Перакладзіце `Markdown` і `YAML` у інструмент каманднага радка ( [зыходны код](https://github.com/i18n-site/rust/tree/main/i18) ) на некалькіх мовах.
...
Мы падзяляем `UNIX` " is a File " і можам кіраваць перакладамі на сотні моў без увядзення складаных і грувасткіх рашэнняў карпаратыўнага ўзроўню.

Вы можаце выкарыстоўваць самыя знаёмыя інструменты для `Markdown` перакладу (але вы не можаце дадаваць або выдаляць абзацы), а таксама выкарыстоўваць самы знаёмы спосаб для кантролю версій.

База кода можа быць створана як адкрыты зыходны код для моўных файлаў, і з дапамогай працэсу `Pull Request` карыстальнікі могуць удзельнічаць у пастаяннай аптымізацыі перакладаў. Беспраблемнае злучэнне [github](//github.com) І іншыя суполкі з адкрытым зыходным кодам.

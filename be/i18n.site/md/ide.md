...
Мы выкарыстоўваем [vscode](https://code.visualstudio.com/) write `MarkDown` , а таксама ўсталёўваем плагін [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) для папярэдняга прагляду падчас запісу.
...
Увядзіце `code xxx.md` у камандным радку, каб выклікаць `vscode` , каб адкрыць файл `Markdown` .

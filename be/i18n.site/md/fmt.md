...
Традыцыйныя `MarkDown` апорных кропак ствараюцца на аснове тэкставага зместу. У выпадку шматмоўнасці гэтае рашэнне немагчыма.
...
## Малюнкі/Відэа/Спасылкі На Некалькіх Мовах

Пасля пераўтварэння `MarkDown` у `HTML` `$LANG` у атрыбутах `src` і `href` будзе заменены на бягучы [код мовы](/i18/LANG_CODE) .

З дапамогай гэтай зменнай вы можаце дасягнуць шматмоўнасці малюнкаў/відэа/спасылак.
...
Вышэйзгаданы метад запісу эквівалентны `url: xxx` , а адпаведны файл - `en/xxx/TOC` .
...
Напрыклад, калі доступ да `/test` , а `nav:` настроены без прэфікса гэтага шляху, а бягучая мова прагляду - англійская (код `en` ), `/en/test.md` будзе загружаны па змаўчанні і візуалізаваны з выкарыстаннем шаблона `Md` .

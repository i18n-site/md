...
Адрэдагуйце `md/.i18n/htm/ol.yml` і зменіце значэнне [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` у якасці ўласнага імя пакета `npm` [npmjs.com](//npmjs.com) любое незанятае імя пакета.

Затым змяніце `md/.i18n/htm/ol.package.json`

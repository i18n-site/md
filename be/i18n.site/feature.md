...
Вэб-сайт выкарыстоўвае аднастаронкавую архітэктуру прыкладання без абнаўлення пры пераключэнні старонак і вельмі хуткай загрузкі.
...
Ёсць шмат дробных патрабаванняў, якія з'яўляюцца важнымі, але не тэрміновымі. Каманда распрацоўшчыкаў будзе прызначаць практычныя задачы ў адпаведнасці з тэхналогіяй, якой вы валодаеце, і ўдасканальваць дакументы распрацоўкі пры прызначэнні патрабаванняў.
...
`i18n.site` будзе публікаваць змесціва сайта ў `npmjs.com` з дапамогай [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) і іншага змесціва `CDN` , загружанага на `npm` .
...
На старонцы `404` ёсць мілы маленькі плывучы прывід, вочы якога рухаюцца мышкай, [➔ Націсніце тут, каб праглядзець](/404) ,

...
Ёсць шмат дробных патрабаванняў, якія з'яўляюцца важнымі, але не тэрміновымі. Каманда распрацоўшчыкаў прызначыць практычныя задачы на аснове тэхналогій, якімі вы валодаеце, і ўдасканаліць дакументы распрацоўкі пры прызначэнні патрабаванняў.
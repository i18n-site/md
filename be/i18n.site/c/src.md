...
* [atomgit](https://atomgit.com/i18n/ie) бібліятэка / [github](https://github.com/i18n-site/ie)
* [atomgit](https://atomgit.com/i18n/x) неабходнасці пакаваць інтэрфейсныя бібліятэкі / на якія спасылаюцца непасрэдна [github](https://github.com/i18n-site/x)
...
* Запланаваныя задачы [github](https://github.com/i18n-cron/cron) / [atomgit](https://atomgit.com/i18n/cron)

...
У цяперашні час ён даступны першапачаткова, але яшчэ ёсць важныя функцыі ў стадыі [распрацоўкі](/i18n.site/c/roadmap) .
...
`i18n.site` - гэта маё пераасэнсаванне мадэлі распрацоўкі вэб-сайтаў.

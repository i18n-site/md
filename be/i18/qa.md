...
Гэта значыць, калі ўручную карэкціруеце пераклад, **не дадавайце і не выдаляйце радкі перакладу** , інакш суадносіны адлюстравання паміж перакладам і арыгінальным тэкстам будуць парушаны.
...
Адпаведнасць паміж перакладам і зыходным тэкстам прывязана да лексемы. Стварыце новую лексему ў [i18n.site/token](//i18n.site/token) выдаліце `.i18h/hash` і перакладзіце яшчэ раз, каб ачысціць блытаніну (але гэта прывядзе да страты ўсіх ручных карэкціровак перакладу).

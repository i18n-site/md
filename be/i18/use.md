...
Сярод іх змест `.i18n/cache/.gitignore` выглядае наступным чынам :
...
Гэта азначае, што ўсе файлы ў каталогу `.i18n/cache/` (акрамя `.i18n/cache/.gitignore` ) ігнаруюцца.

Калі ваша праграмнае забеспячэнне для кантролю версій не роўнае `git` , ігнаруйце яго ў адпаведнасці з гэтай канфігурацыяй.

...
Das heißt, wenn Sie die Übersetzung manuell anpassen, **fügen Sie keine Zeilen der Übersetzung hinzu oder löschen Sie sie nicht** , da sonst die Zuordnungsbeziehung zwischen der Übersetzung und dem Originaltext gestört wird.
...
Manchmal ist die Konvertierung von `HTML` → `MarkDown` nicht das, was wir wollen, z. B. wenn `<a href="/">Home</a>` in `[Home](/)` konvertiert wird.

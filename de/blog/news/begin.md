...
Die Übersetzung kann bearbeitet werden. Ändern Sie den Originaltext. Bei einer erneuten maschinellen Übersetzung werden die manuellen Änderungen an der Übersetzung nicht überschrieben (sofern dieser Absatz des Originaltexts nicht geändert wurde).

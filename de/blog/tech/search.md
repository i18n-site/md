...
Nach mehreren Wochen der Entwicklung unterstützt [i18n.site](//i18n.site) (ein rein statisches markdown multilingualtranslation & -Website-Erstellungstool) jetzt die reine Front-End-Volltextsuche.
...
Code Open Source : [Kernel durchsuchen](//github.com/i18n-site/ie/tree/main/qy) / [Interaktive Schnittstelle](//github.com/i18n-site/plugin/tree/main/qy)
...
Es kann nicht offline verwendet werden, kann nicht im Intranet verwendet werden und weist große Einschränkungen auf. In diesem Artikel wird nicht viel besprochen.
...
1. Unterstützt die Präfixsuche, die Suchergebnisse in Echtzeit anzeigen kann, während der Benutzer tippt.
1. Offline verfügbar
...
* `rindex` : Word id - Document id : Array von Zeilennummern
...
Die Anti-Shake-Funktion `debounce` wird auch in der Front-End-Interaktion verwendet (wie folgt implementiert), um die Häufigkeit von Benutzereingaben zu reduzieren, die Suchanfragen auslösen, und den Rechenaufwand zu reduzieren.

...
Wir verwenden [vscode](https://code.visualstudio.com/) zum Schreiben von `MarkDown` und installieren außerdem das Plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) um während des Schreibens eine Vorschau anzuzeigen.

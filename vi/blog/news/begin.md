...
Bản dịch có thể chỉnh sửa được; sửa đổi văn bản gốc và khi được dịch lại bằng máy, các sửa đổi thủ công đối với bản dịch sẽ không bị ghi đè (nếu đoạn này của văn bản gốc chưa được sửa đổi).
...
Các công cụ quản lý dịch thuật hiện có quá nặng đối với những lập trình viên dựa vào quản lý phiên bản `git` , họ vẫn thích dòng lệnh hơn.

<h1 style="display:flex;justify-content:space-between">⋅ Giải pháp quốc tế i18n.site<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> mô tả dự án
...
Dịch `Markdown` và `YAML` thành công cụ dòng lệnh ( [mã nguồn](https://github.com/i18n-site/rust/tree/main/i18) ) bằng nhiều ngôn ngữ.

Có thể duy trì hoàn hảo định dạng của `Markdown` Có thể xác định các sửa đổi tệp và chỉ dịch các tệp đã thay đổi.
...
Chúng tôi chia sẻ " `UNIX` Mọi thứ đều là Tệp " và có thể quản lý bản dịch bằng hàng trăm ngôn ngữ mà không cần đưa ra các giải pháp cấp doanh nghiệp phức tạp và rườm rà.

Bạn có thể sử dụng những công cụ quen thuộc nhất để `Markdown` bản dịch (nhưng bạn không thể thêm hoặc xóa đoạn văn) và sử dụng cách quen thuộc nhất để kiểm soát phiên bản.

Cơ sở mã có thể được tạo dưới dạng nguồn mở cho các tệp ngôn ngữ và với sự trợ giúp của quy trình `Pull Request` , người dùng toàn cầu có thể tham gia vào quá trình tối ưu hóa liên tục các bản dịch. Kết nối liền mạch [github](//github.com) Và các cộng đồng nguồn mở khác.
...
Hoàn toàn tĩnh, được tối ưu hóa cho trải nghiệm đọc và được tích hợp với bản dịch [i18](#i18) đây là lựa chọn tốt nhất để xây dựng trang tài liệu dự án.
...
Trang web này được phát triển dựa trên khuôn khổ này và bao gồm người dùng, thanh toán và các chức năng khác ( [mã nguồn](/i18n.site/src) ). Hướng dẫn chi tiết sẽ được viết sau.

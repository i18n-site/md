...
Chỉnh sửa `md/.i18n/htm/ol.yml` [npmjs.com](//npmjs.com) thay đổi giá trị từ [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` làm tên gói `npm` của riêng bạn.

Sau đó sửa đổi `md/.i18n/htm/ol.package.json`
...
Giả sử cổng máy chủ proxy của bạn là `7890` , bạn có thể viết:
...
Sau đó, sử dụng đối tượng lưu trữ của các nhà `CDN` + khai nội dung sau `out/ol/htm` .

...
Trong cấu hình, vui lòng thay đổi `i18n.site` thành giá trị `host:` trong `.i18n/htm/ol.yml` , nhiều cửa hàng đối tượng có thể được định cấu hình trong `s3` và trường `region` là tùy chọn (nhiều cửa hàng đối tượng không cần đặt trường này).

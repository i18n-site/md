...
Chúng tôi sử dụng [vscode](https://code.visualstudio.com/) để viết `MarkDown` và cũng cài đặt plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) để xem trước trong thời gian thực trong khi viết.

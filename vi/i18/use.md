...
Ngoài việc tạo ra bản dịch, chương trình sẽ tạo ra thư mục `.i18n/data`; vui lòng thêm nó vào kho lưu trữ.

Sau khi dịch các tệp mới, một tệp dữ liệu mới sẽ được tạo ra trong thư mục này. Đừng quên thực hiện `git add .` để追加.

...
### `use: Toc` ကောက်ကြောင်းပါသော ဖိုင်ပုံစံတစ်ခုတည်း
...
### `use: Md` ကောက်ကြောင်းမပါဘဲ ဖိုင်ပုံစံတစ်ခုတည်း
...
### `use: Doc` ၊ ဖိုင်ပေါင်းများစွာ စာရွက်စာတမ်းပုံစံ
...
`NB` သည် ၎င်းထံသို့ ဖြတ်သွားသည့် ကန့်သတ်ဘောင် `demo1,demo2` ဖြင့် နောက်တွင် လိုက်ပါသည်။
...
အထက်ပါ စာရေးနည်းသည် `url: xxx` နှင့် ညီမျှပြီး ၎င်း၏ သက်ဆိုင်ရာ ဖိုင်မှာ `en/xxx/TOC` ဖြစ်သည်။

#### TOC အကြောင်းအရာ အညွှန်းကိန်း

0 သည် `json` directory outline ကိုထုတ်ပေးရန်အတွက် `doc` directory outline ကိုထုတ်ပေးရန်အတွက် `TOC` directory index ဖိုင်ကိုဖတ်ရန် `i18n.site` `js` plug-in `.i18n/hook/after.tran/TOC.js` ကို execute လုပ်ပါမည်။

`doc` template ကိုအသုံးပြုပါက၊ ဤ plug-in ရှိရပါမည်။

အကယ်၍ သင်သည် ပရောဂျက် `i18n.site` အလွတ်ဖိုင်တွဲတစ်ခုမှ အစပြုပါက၊ သရုပ်ပြပရောဂျက် `.i18n` သင့်လမ်းညွှန်သို့ ကူးယူရန် မမေ့ပါနှင့်။

`Doc` ပုံစံပလိတ်သည် ထုတ်လုပ်ထားသော `json` ကိုအခြေခံ၍ အကြောင်းအရာဇယားကို ဖော်ပြပါမည်။
...
ဥပမာအားဖြင့်၊ `/test` ဝင်ရောက်ပြီး `nav:` ဤလမ်းကြောင်း၏ရှေ့ဆက်မပါပဲ ပြင်ဆင်သတ်မှတ်ထားပါက၊ လက်ရှိရှာဖွေနေသောဘာသာစကားမှာ အင်္ဂလိပ် (ကုဒ် `en` ) ၊ `/en/test.md` ပုံသေဖြင့်တင်ပြီး နမူနာပုံစံ `Md` အသုံးပြု၍ ပြန်ဆိုပါမည်။

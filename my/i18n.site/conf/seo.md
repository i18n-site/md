...
`i18n.site` ရှာဖွေမှုအညွှန်းပြုလုပ်ရာတွင် လွယ်ကူချောမွေ့စေရန်အတွက် စာမျက်နှာတစ်ခုတည်းကို ပြန်လည်စတင်ခြင်းမဟုတ်သော တည်ဆောက်မှုပုံစံကို အသုံးပြုပြီး သီးခြားအငြိမ်စာမျက်နှာနှင့် `sitemap.xml` ကို ကူးယူလေ့လာရန်အတွက် ရေးဆွဲပေးမည်ဖြစ်သည်။
...
`URL redirect` သွက်လက်သောလမ်းကြောင်းပြန်ညွှန်မှုကို ရွေးပါ၊ ကျေးဇူးပြု၍ လမ်းကြောင်း 1 တွင် `/en` သင်ရှာဖွေရေးအင်ဂျင်များပါ၀င်စေလိုသော မူရင်းဘာသာစကားသို့ ပြန်ညွှန်းခြင်းလမ်းကြောင်း `concat("/en",http.request.uri.path,".htm")` ကို ပြင်ဆင်ပါ။
...
သင်သည် တရုတ်ပြည်မကြီးတွင် ဝန်ဆောင်မှုများ ပေးဆောင်လိုပြီး `cloudflare` နိုင်ငံတကာ ၀င်ထွက်မှုကို လိုချင်ပါက၊ ဒေသဆိုင်ရာ ဆုံးဖြတ်ချက်ဖြင့် `DNS` အသုံးပြုနိုင်သည်။
...
### ဒိုမိန်းအမည်ကို အခြား `DNS` တွင် လက်ခံထားပါသည်၊ အသုံးပြုနည်း `cloudflare`
...
built `cloudflare` in object storage `R2` ကို စိတ်ကြိုက် domain name ဖြင့် ဝင်သုံး၍မရသောကြောင့်၊ static files များထားရှိရန် ပြင်ပမှ object storage ကို အသုံးပြုရန်လိုအပ်ပါသည်။

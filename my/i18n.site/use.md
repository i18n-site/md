...
`md/.i18n/htm/ol.yml` တည်းဖြတ်ပြီး [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` တန်ဖိုးကို သင့်ကိုယ်ပိုင် `npm` ပက်ကေ့ချ်အမည်အဖြစ် ဖွင့်ထားပါ [npmjs.com](//npmjs.com) ။

ပြီးရင် `md/.i18n/htm/ol.package.json` modify လုပ်ပါ။

...
`i18n.site` `i18` [ဝင်ရောက်နိုင်သော တိုကင်ကို ပြင်ဆင်သတ်မှတ်ရန် စာရွက်စာတမ်း `i18` ခုကို ကိုးကားရန် ဤနေရာကို နှိပ်ပါ](/i18/use) ။
...
ဒေသန္တရအကြိုကြည့်ရှုခြင်းကို `docker` ချောမွေ့စေရန်အတွက် `demo.i18n.site` ကုဒ်အခြေခံ clone ၏လမ်းညွှန်အမည်သည် `md` ဖြစ်ရပါမည်။

### ဘာသာပြန်ပါ။

ပထမဦးစွာ `md` directory ကိုရိုက်ထည့်ပြီး `i18n.site` run ပါ၊ ၎င်းသည် `en` မှ `zh` ဘာသာပြန်ပေးပါမည်။

<img src="https://p.3ti.site/1721114619.avif" style="width:350px">

လုပ်ဆောင်ပြီးနောက်၊ ဘာသာပြန်ခြင်းနှင့် ကက်ရှ်ဖိုင်များကို ထုတ်ပေးမည် ကျေးဇူးပြု၍ `git add . ` `md` directory ရှိ repository သို့ထည့်ရန် မမေ့ပါနှင့်။

### ပြည်တွင်းအကြိုကြည့်ရှုခြင်း။

`docker` ထည့်သွင်းပြီး စတင်ပါ ( အသုံးပြုသူ `MAC` `docker` အတွက် runtime အဖြစ် [orbstack](https://orbstack.dev) အသုံးပြုရန် အကြံပြုထားသည်။

ထို့နောက်၊ `docker` directory ကိုရိုက်ထည့်ကာ `./up.sh` run ပြီးနောက် စက်တွင်းအကြိုကြည့်ရှုရန် [https://127.0.0.1](https://127.0.0.1)

<img src="//p.3ti.site/1721104238.avif" style="width:360px">

### အကြောင်းအရာကို တင်ပါ။

`i18n.site` [သည် စာမျက်နှာတစ်ခုတည်း အက်ပလီကေးရှင်း](https://developer.mozilla.org/docs/Glossary/SPA) တည်ဆောက်ပုံကို လက်ခံပြီး ဝဘ်ဆိုက်ဝင်ပေါက် စာမျက်နှာနှင့် ဝဘ်ဆိုက်အကြောင်းအရာကို လွတ်လပ်စွာ အသုံးချသည်။

အထက်ဖော်ပြပါ ဘာသာပြန်ခြင်းကို လုပ်ဆောင်ပြီးနောက်၊ လမ်းညွှန် `htm` နှင့် `v` ကို `md/out/dev` လမ်းညွှန်အောက်တွင် ထုတ်ပေးပါမည်။

ဤတွင်၊ `dev` သည် `.i18n/htm/dev.yml` configuration file ကိုအခြေခံ၍ တည်ဆောက်ထားသည်ကို ဆိုလိုသည်။
...
ဥပမာအားဖြင့် `.i18n/htm/ol.yml` သည် `out/ol` directory ကိုဖန်တီးလိမ့်မည်။

`dev.yml` နှင့် `ol.yml` တို့သည် ပုံသေဖွဲ့စည်းပုံများဖြစ်သည်။
...
`ol` သည် `online` ၏ အတိုကောက်ဖြစ်ပြီး တရားဝင်ထုတ်လွှတ်ရန်အတွက် အသုံးပြုသည့် အွန်လိုင်းပတ်ဝန်းကျင်ကို ညွှန်ပြသည့် ၎င်းသည် ထုတ်ဝေရန်အတွက် command line parameters `-n` မှ `npm` အသုံးပြုသည့်အခါ ပုံသေဖွဲ့စည်းမှုဖိုင်လည်းဖြစ်သည်။

အသုံးပြုရန် configuration file name ကို သတ်မှတ်ရန် အခြား configuration files များကိုလည်း သင် ဖန်တီးနိုင်သည် `--htm_conf`
...
`md/.i18n/htm/ol.yml` တည်းဖြတ်ပြီး `i18n.site` in `v: //unpkg.com/i18n.site` ကို သင့်ကိုယ်ပိုင် `npm` ပက်ကေ့ခ်ျအမည်သို့ ပြောင်းပါ။

ပက်ကေ့ဂျ်အမည်အဖြစ် ဝဘ်ဆိုဒ်ဒိုမိန်းအမည်ကို အသုံးပြုခြင်းသည် ကောင်းသောရွေးချယ်မှုဖြစ်သည် [npmjs.com](//npmjs.com)

ပက်ကေ့ဂျ် `npm` ကို အခြေခံ၍ ထုတ်ဝေသည့်အခါ `v:` တန်ဖိုး၏ ရှေ့ဆက် **အတွက် `//unpkg.com/` အသုံးပြုရန်** `i18n.site` သည် အသစ်ထွက်ရှိမှုများကို အချိန်မီကြည့်ရှုနိုင်ရန် ဤရှေ့ဆက်လမ်းကြောင်းအောက်တွင် `/.v` ၏ cache အချိန်ကို အထူးကောင်းမွန်အောင်ပြုလုပ်ထားသည်။

ဘာသာပြန်ရန်နှင့် ထုတ်ဝေရန် `md` လမ်းညွှန်တွင် `i18n.site --npm` သို့မဟုတ် `i18n.site -n` ကိုဖွင့်ပါ။
...
`ol.yml` တွင် `v:` ခု၏ ပက်ကေ့ဂျ်အမည်ကို မွမ်းမံပါက **`.i18n/v/ol` အရင်ဖျက်ပြီး ထုတ်ဝေရန် သေချာပါစေ** ။

##### npm မှထုတ်ဝေသော ပရောက်စီဆာဗာ

တရုတ်ပြည်မကြီးရှိ သုံးစွဲသူများသည် ကွန်ရက်ပြဿနာများနှင့် ကြုံတွေ့ရပြီး `npm` ပက်ကေ့ဂျ်များကို မထုတ်ဝေနိုင်ပါက၊ ၎င်းတို့သည် ပရောက်စီဆာဗာကို configure လုပ်ရန် ပတ်၀န်းကျင် ပြောင်းလဲနိုင်သော ပုံစံ `https_proxy` ကို သတ်မှတ်နိုင်သည်။
...
အကြောင်းအရာကို ကိုယ်တိုင်လက်ခံဆောင်ရွက်ပေးလိုပါက ပထမဦးစွာ `md/.i18n/htm/ol.yml` တည်းဖြတ်ပြီး `v: //unpkg.com/i18n.site` သင်၏ URL ရှေ့ဆက်ဖြစ်သည့် `v: //i18n-v.xxx.com` သို့ပြောင်းပါ။
...
ထို့နောက်၊ `v:` တွင်သတ်မှတ်ထားသော `md/out/ol/v` directory မှအကြောင်းအရာကို URL ရှေ့ဆက်လမ်းကြောင်းသို့ configure လုပ်ပါ။
...
`/.v` တွင်အဆုံးသတ်သည့်လမ်းကြောင်း၏ ကက်ရှ်အချိန်သည် `1s` ဖြစ်စေရန် `CDN` ကို configure လုပ်ရန် မမေ့ပါနှင့်၊ သို့မဟုတ်ပါက အသစ်ထွက်ရှိထားသော အကြောင်းအရာကို ချက်ချင်းဝင်ရောက်နိုင်မည်မဟုတ်ပါ။
...
ဝဘ်ဆိုက် [သည် စာမျက်နှာတစ်ခုတည်း အပလီကေးရှင်း](https://developer.mozilla.org/docs/Glossary/SPA) တည်ဆောက်ပုံကို အသုံးပြုသောကြောင့်၊ `. ` မှ `index.html` မပါသော URL လမ်းကြောင်းများကို ပြန်လည်ရေးရန် သတိရပါ။
...
[အဖွဲ့အစည်းတစ်ခုဖန်တီးရန် ဤနေရာကို နှိပ်ပါ github](https://github.com/account/organizations/new?plan=free) အောက်ပါအဖွဲ့အစည်းအမည်သည် `i18n-demo` ဖြစ်သည်။
...
ယခင်ဆောင်းပါးတွင် အကြောင်းအရာကို ထုတ်ဝေသည့်အခါ `out/ol/htm` ထုတ်ပေးပြီး ကျေးဇူးပြု၍ ဤလမ်းညွှန်ကို ထည့်သွင်းပြီး လုပ်ဆောင်ပါ :
...
အဖွဲ့အစည်း `i18n-demo` ကို ဝင်ရောက်ခွင့်ပေးရန် `Add Account` ကိုနှိပ်ပါ။
...
အထက်ဖော်ပြပါပုံပါ စည်းမျဉ်းများသည် အောက်ပါအတိုင်း ကျေးဇူးပြု၍ သင်ချည်နှောင်ထားသော ဒိုမိန်းအမည်ဖြင့် အောက်ပါပထမစာကြောင်းတွင် `i18n.site` အစားထိုးပါ။
...
ထို့နောက် တရုတ်ပြည်မကြီးရှိ cloud ရောင်းချသူများ၏ အရာဝတ္ထုသိုလှောင်မှုကို အသုံးပြုပါ `CDN` `out/ol/htm` အကြောင်းအရာကို အသုံးချပါ +
...
မှတ်တမ်း `MX` နှင့် record `CNAME` သည် အတူမတည်ရှိနိုင်သောကြောင့်၊ သင်သည် ဒိုမိန်းအမည်အီးမေးလ်များကို တစ်ချိန်တည်းလက်ခံလိုပါက၊ အဆင့် `CNAME` သို့ record `A` သို့ ပူးပေါင်းဆောင်ရွက်ရန် လိုအပ်ပါသည် [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten)

ထို့အပြင်၊ တရုတ်ပြည်မကြီးရှိ cloud ရောင်းချသူများ၏ပြည်ပအသွားအလာ ကောက်ခံမှုများသည် အတော်လေးစျေးကြီးသောကြောင့် ကုန်ကျစရိတ်များကို ပိုမိုကောင်းမွန်အောင်ပြုလုပ်လိုပါက၊ သင်ရရှိရန် [Huawei Cloud ၏ အခမဲ့ပထဝီဝင် DNS](https://support.huaweicloud.com/usermanual-dns/dns_usermanual_0041.html) နှင့် [Cloudflare for SaaS](https://developers.cloudflare.com/cloudflare-for-platforms/cloudflare-for-saas) ၏စိတ်ကြိုက်ဒိုမိန်းအမည် (အောက်တွင်ဖော်ပြထားသည့်အတိုင်း) ကိုအသုံးပြုနိုင်ပါသည်။ ယာဉ်အသွားအလာလွှဲခြင်း── တရုတ်ပြည်မကြီးရှိ Baidu Cloud `CDN` ၊ နိုင်ငံတကာအသွားအလာ cloudflare .
...
[Alibaba CDN](https://cdn.console.aliyun.com/domain/list) တွင် ဒိုမိန်းအမည်ကို ထည့်သွင်းပြီး Alibaba Cloud `CDN` တွင် ဒိုမိန်းအမည် `*.xxx.com` ကို `CNAME` သို့ ညွှန်ပါ။
...
`.i18n` directory အောက်တွင် `i18n.site` ၏ configuration files များ၊ translation cache စသည်တို့ဖြစ်သည်။ အသေးစိတ်အတွက် နောက်အခန်း ["Configuration" ကို](/i18n.site/conf) ကြည့်ပါ။

#### `en`

အရင်းအမြစ် ဘာသာစကား လမ်းညွှန်၊ `.i18n/conf.yml` တွင် `fromTo` ခုမှ `en` နှင့် သက်ဆိုင်သော ဖွဲ့စည်းမှုပုံစံဖိုင်
...
ဘာသာပြန်ခြင်းပုံစံကို ကျေးဇူးပြု၍ ကိုးကားပါ [i18](/i18/use)
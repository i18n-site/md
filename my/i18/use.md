...
ပုံတူပွားပြီးနောက်၊ လမ်းညွှန်ကိုထည့်သွင်းပြီး ဘာသာပြန်ခြင်းကို အပြီးသတ်ရန် `i18` ကိုဖွင့်ပါ။
...
၎င်းတို့တွင် `.i18n/cache/.gitignore` ထုတို၏ အကြောင်းအရာမှာ အောက်ပါအတိုင်းဖြစ်သည် :
...
ဆိုလိုသည်မှာ directory `.i18n/cache/` ( `.i18n/cache/.gitignore` မှလွဲ၍) အတွင်းရှိ ဖိုင်အားလုံးကို လျစ်လျူရှုထားသည်။

သင့်ဗားရှင်း ထိန်းချုပ်ဆော့ဖ်ဝဲသည် `git` မဟုတ်ပါက၊ ဤဖွဲ့စည်းပုံအရ ၎င်းကို လျစ်လျူရှုပါ။

## ဖွဲ့စည်းမှုဖိုင်

`.i18n/conf.yml` သည် `i18` command line ဘာသာပြန်ကိရိယာ၏ ဖွဲ့စည်းမှုဖိုင်ဖြစ်သည်။
...
`en` သည် မူရင်းဘာသာစကားဖြစ်ပြီး `zh ja ko de fr` သည် ဘာသာပြန်ခြင်း၏ ပစ်မှတ်ဘာသာစကားဖြစ်သည်။
...
မတူညီသော ဖိုင်များ အတွက် : `fromTo` configure လုပ်နိုင်ပါသည် /
...
ဤဖွဲ့စည်းပုံဇယားတွင်၊ ကက်တလောက် `blog` ဘာသာပြန်ဆိုခြင်း၏အရင်းအမြစ်ဘာသာစကားမှာ `zh` ဖြစ်ပြီး `blog/your_file_name.md` ဘာသာပြန်ဆိုမှု၏အရင်းအမြစ်ဘာသာစကားမှာ `ja` ဖြစ်သည်။
...
`ignore` `.gitignore` ဖိုင်ကဲ့သို့ တူညီသော syntax ကိုအသုံးပြုသည် [globset](https://docs.rs/globset/latest/globset/#syntax)
...
`.i18n/conf.yml` ဖန်တီးထားသရွေ့ (အချိန်တိုင်း ဒီမိုပရောဂျက် နမူနာပုံစံမှ စတင်ရန် မလိုအပ်ပါ) `i18` သည် ကောင်းမွန်စွာ အလုပ်လုပ်ပါမည်။
...
`/usr/local/bin` ရေးသားခွင့်မရှိပါက ၎င်းကို `~/.bin` သို့ ထည့်သွင်းမည်ဖြစ်သည်။

...
HTML `<pre>` ဘာသာပြန်ခြင်း `MarkDown` `<code>` Markdown HTML
...
အကွက် `title` ၊ `summary` နှင့် `description` တို့ကိုသာ ဘာသာပြန်ပေးသည့် ငြိမ်ဘလော့ဂ်၏ ခေါင်းစီးပုံစံကို ပံ့ပိုးပေးသည် [HOGO](https://github.com/gohugoio/hugo)
...
`i18` သည် `MarkDown` တွင် ခေါင်းစဉ်ကို မှတ်မိနိုင်ပြီး စာလုံးအကြီးအသေးအဖြစ် ဘာသာပြန်သောအခါတွင် ပထမစာလုံးကို အလိုအလျောက် စာလုံးအကြီးဖြင့် ရေးပါမည်။
...
`Falcon` `faucon` အဖြစ် ဘာသာပြန်ပြီး `Llama` ကို `lama` အဖြစ် ဘာသာပြန်ပါသည်။ သင့်လျော်သောနာမ်များအဖြစ် ၎င်းတို့ကို ဘာသာပြန်ရန် မသင့်ပါ။
...
DeepL အထက်ဖော်ပြပါများကို ပြင်သစ်ဘာသာသို့ ဘာသာပြန်ခြင်း (သင့်လျော်သောအမည်များကို ပြန်လည်ရေးသားခြင်းနှင့် ထူးဆန်းသော `... ` ကိုထည့်ခြင်း ):
...
client သည် လုံးဝ open source ဖြစ်ပြီး 90 ကုဒ်၏ % ၏ server side သည် open [source code ကိုကြည့်ရှုရန် ဤနေရာကိုနှိပ်ပါ](/i18n.site/src) ။

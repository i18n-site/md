...
ဤဆောင်းပါးသည် ၀င်ရောက်ကြည့်ရှု `i18n.site` [i18n.site](//i18n.site)

ကုဒ်ဖွင့ [်](//github.com/i18n-site/plugin/tree/main/qy) ထားသောအရင်းအမြစ် [ရှာဖွေရေး kernel](//github.com/i18n-site/ie/tree/main/qy) /

## serverless full-text ရှာဖွေမှုဖြေရှင်းချက်၏ ခြုံငုံသုံးသပ်ချက်

ရိုးရှင်းသောစာရွက်စာတမ်းများ/ကိုယ်ရေးကိုယ်တာဘလော့ဂ်များကဲ့သို့သော ဝဘ်ဆိုဒ်ငယ်များအတွက်၊ စာသားအပြည့်အစုံရှာဖွေမှုနောက်ကွယ်တွင် သင်ကိုယ်တိုင်တည်ဆောက်ရန်မှာ သံသယဖြစ်စရာကောင်းလောက်အောင် လေးလံနေပြီး ဝန်ဆောင်မှုများမပါဘဲ စာသားအပြည့်အစုံရှာဖွေခြင်းသည် ပိုမိုကောင်းမွန်သောအလေးချိန်ဖြစ်သည်မှာ သေချာပါသည်။

လက်ရှိ ဆာဗာမဲ့ စာသားအပြည့်အစုံ ရှာဖွေမှုဖြေရှင်းချက်သည် အမျိုးအစားနှစ်မျိုး ရှိသည်။

တစ်ခုသည် [algolia.com](//algolia.com) ရှေ့ဆုံးတွင် စာသားအပြည့်အစုံ ရှာဖွေမှုအပိုင်းများကို ပံ့ပိုးပေးသည်။

အဆိုပါဝန်ဆောင်မှုများသည် ငွေပေးချေမှုလိုအပ်ပြီး ဝဘ်ဆိုက်လိုက်နာမှုပြဿနာများကြောင့် တရုတ်ပြည်မကြီးရှိ သုံးစွဲသူများအတွက် မရနိုင်ပါ။

အော့ဖ်လိုင်းသုံး၍မရပါ၊ အင်ထရာနက်ပေါ်တွင် အသုံးမပြုနိုင်ပါ၊ အကန့်အသတ်များစွာရှိသည်။ ဒီဆောင်းပါးက အများကြီး မဆွေးနွေးပါဘူး။

ဒုတိယမှာ စာသားအပြည့်အစုံ ရှာဖွေမှုဖြစ်သည်။

ပိုမိုလူသိများသော သန့်စင်သော စာသားအပြည့်အစုံ ရှာဖွေမှုများတွင် [lunrjs](https://lunrjs.com) နှင့် [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) ပါဝင်သည်။

`lunrjs` အညွှန်းကိန်းများတည်ဆောက်ရန် နည်းလမ်းနှစ်မျိုးရှိသော်လည်း နှစ်ခုစလုံးတွင် ပြဿနာရှိကြသည်။
...
[fusejs](https://www.fusejs.io) ၊ ရှာဖွေရန် စာကြောင်းများကြား တူညီမှုကို တွက်ချက်ပါ။

ဤဖြေရှင်းချက်၏စွမ်းဆောင်ရည်သည် အလွန်ညံ့ဖျင်းပြီး စာသားအပြည့်အစုံရှာဖွေမှုတွင် အသုံးမပြုနိုင်ပါ ( [10 Fuse.js](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries)

[TinySearch](https://github.com/tinysearch/tinysearch) ၊ ရှာဖွေရန် Bloom စစ်ထုတ်မှုကို အသုံးပြုပါ၊ ရှေ့ဆက်ရှာဖွေမှုအတွက် အသုံးမပြုနိုင်ပါ (ဥပမာ၊ `goo` ၊ ရှာဖွေမှု `good` ၊ `google` ) နှင့် အလားတူ အလိုအလျောက် ပြီးဆုံးမှုအကျိုးသက်ရောက်မှုကို မရရှိနိုင်ပါ။

ရှိပြီးသားဖြေရှင်းချက်များ၏ ချို့ယွင်းချက်များအပေါ် မကျေနပ်မှုများကြောင့် `i18n.site` အောက်ပါအင်္ဂါရပ်များပါရှိသော သန့်ရှင်းသော front-end full-text ရှာဖွေမှုဖြေရှင်းချက်အသစ်ကို တီထွင်ခဲ့သည် :
...
1. အကြိုရှာဖွေမှုကို ပံ့ပိုးပေးပြီး အသုံးပြုသူ စာရိုက်နေချိန်တွင် ရှာဖွေမှုရလဒ်များကို အချိန်နှင့်တပြေးညီ ပြသနိုင်သည်။
...
`IndexedDB` တွင် object storage table 5 ခုကို ဖန်တီးခဲ့သည် :
...
ရှေ့ဆုံးမှအပြန်အလှန်ဆက်သွယ်မှုတွင်၊ ပထမအကြိမ်စတင်သောအခါတွင် နောက်ကျခြင်းကိုရှောင်ရှားရန် အညွှန်းကိန်းစတင်ခြင်းတိုးတက်မှုဘားကိုပြသနိုင်သည် "Progress Bar with Animation, Single on a Based progress + Pure css " [English](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [Chinese](https://juejin.cn/post/7413586285954154522) .

### IndexedDB မြင့်မားသော တစ်ပြိုင်တည်းရေးသားမှု

ပရောဂျက်သည် ချိန်ညှိထားသော ကာဗာကို အခြေခံ၍ [idb](https://www.npmjs.com/package/idb) IndexedDB
...
ပြောင်းပြန်လှန်ထားသော စာသားအပြည့်အစုံရှာဖွေမှုကို မြန်ဆန်သောတုံ့ပြန်မှုဖြင့် ဆာဗာမလိုအပ်ဘဲ ရှေ့ဆုံးတွင်သာ အကောင်အထည်ဖော်ခဲ့သည်။

စာရွက်စာတမ်းများနှင့် ကိုယ်ပိုင်ဘလော့ဂ်များကဲ့သို့သော အသေးစားနှင့် အလတ်စားဝဘ်ဆိုဒ်များအတွက် အလွန်သင့်လျော်ပါသည်။
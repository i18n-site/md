...
ဘာပဲဖြစ်ဖြစ် cloudflare ကိုသုံးပြီးနောက်၊ ဆာဗာများကြားတွင် ကွာခြားမှုသိပ်မရှိပါ။
...
ပြသမှု CPU မော်ဒယ် `AMD EPYC 9224 24-Core Processor` single-core စွမ်းဆောင်ရည်ရမှတ် 1285
...
ဝယ်ယူသည့်အခါတွင် သုံးစွဲသူအသစ်များသည် ၎င်းတို့၏ ID ကတ်များကို အမည်ရင်း စစ်မှန်ကြောင်းအထောက်အထားပြရန်အတွက် တင်သွင်းရန်လိုအပ်ပါသည်။

## စကားဝှက်မပါဘဲ အကောင့်ဝင်ခြင်းကို စီစဉ်သတ်မှတ်ပါ။

မိနစ်အနည်းငယ်ကြာပြီးနောက်၊ ဆာဗာများအားလုံးကို စတင်အသုံးပြုနိုင်ပါပြီ။

ပထမအချက်မှာ စက်၏ `~/.ssh/config` အတွက် နံပတ်တစ်ခု သတ်မှတ်ရန် IP ထို့နောက် စကားဝှက်မပါဘဲ အကောင့်ဝင်ရန် `ssh-copy-id root@c2` အသုံးပြုပါ။
...
ဥရောပမှ `ssh` ကွန်ရက်မတည်ငြိမ်ပါက အသုံးပြုရန် အကြံပြုထားသည် [mosh](//mosh.org)
...
ဖန်တီးပြီးနောက်၊ လုပ်ဆောင်နိုင်သော ခွင့်ပြုချက်များနှင့် Soft-link `c2` ပေးပါ `c1`
...
အနာဂတ်တွင် သင်သည် တိုက်ရိုက်ဝင်ရောက်နိုင်သည် `c0` `c1` နှင့် သင်သည် `mosh` မြန်နှုန်းမြင့် တိုက်ရိုက်ချိတ်ဆက်မှုကို အသုံးပြုပြီး [tmux](https://www.ruanyifeng.com/blog/2019/10/tmux.html)
...
လက်ဗွေ `ssh-keygen -R ip` ပြောင်းလဲမှုများ ဖြစ်ပေါ်မည် ssh
...
သင်သည် perfectionist တစ်ယောက်ဖြစ်ပါက၊ သင်သည် full disk compression ကို ကိုယ်တိုင်လုပ်ဆောင်နိုင်သည်။
...
[snapper](https://manual.siduction.org/sys-admin-btrfs-snapper_en.html) သည် Btrfs အရန်ကူးခြင်းအတွက် အကောင်းဆုံးပါတနာဖြစ်သည်။

အစပြုခြင်း script သည် `~/ubuntu`
...
လျှပ်တစ်ပြက်ရိုက်ချက်များကို သတ်မှတ်ရန်အတွက် အတွဲခွဲများကို ကြည့်ရန် `snapper list-configs`

<img alt="" src="https://i-01.eu.org/1718302689.avif">

အတွဲခွဲတစ်ခု၏ လျှပ်တစ်ပြက်ရိုက်ချက်အား ကြည့်ရှုရန် `snapper -c mnt list`

ဤအတွဲခွဲ၏ သီးခြားအရန်ဆက်တင်များကို သင်ကြည့်ရှုနိုင်ပါသည် `/etc/snapper/configs/mnt`
...
ဤနည်းအားဖြင့်၊ systemd-journald သည် အသစ်ဖွဲ့စည်းမှုပုံစံဖြင့် စတင်မည်ဖြစ်ပြီး hard disk တွင် မှတ်တမ်းများကို အမြဲမပြတ်သိမ်းဆည်းနေမည်ဖြစ်သည်။

အထက်ပါ လုပ်ဆောင်ချက်များကို ကယ်ဆယ်ရေးစနစ်တွင် လုပ်ဆောင်ကြောင်း မှတ်သားထားပါ၊ ထို့ကြောင့် အဆိုပါပြောင်းလဲမှုများသည် စနစ်ပြန်လည်စတင်ပြီး ကယ်ဆယ်ရေးမုဒ်တွင် မရှိတော့သည်နှင့်သာ အကျိုးသက်ရောက်မည်ဖြစ်ကြောင်း မှတ်သားထားပါ။

ဆိုလိုသည်မှာ ရှိပြီးသားမှတ်တမ်းများတွင် အပြောင်းအလဲများ ဆက်တိုက်ဖြစ်ပေါ်နေခြင်းကို သင်ချက်ချင်းမြင်နိုင်မည်မဟုတ်သော်လည်း ၎င်းပြီးနောက် ထုတ်လုပ်လိုက်သော မှတ်တမ်းများအားလုံး ဆက်လက်တည်ရှိနေမည်ဖြစ်သည်။
...
ထပ်ခါတလဲလဲ စုံစမ်းပြီးနောက်၊ tar အပ်လုဒ်လုပ်သော အသုံးပြုသူ `uid` `1001` ဖြစ်သောကြောင့်ဖြစ်သည် github action

tar ထုပ်ပိုးခြင်းကို `1001` `--no-same-owner` ် `uid` ချက်များမပါဘဲ လုပ်ဆောင်ရပါမည်

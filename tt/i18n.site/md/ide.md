...
Без `MarkDown` язу өчен [vscode](https://code.visualstudio.com/) , һәм язганда реаль вакытта алдан карау өчен [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) урнаштырабыз.

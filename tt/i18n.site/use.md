...
Әгәр дә сез бастыру өчен өзлексез интеграция мохитен куллансагыз, `nodejs` урнаштырырга кирәкми, теркәлгәнне күчереп алыгыз һәм `~/.npmrc` рөхсәтне әйләнә-тирә мохиткә бастырыгыз.

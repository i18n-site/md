...
`md/.i18n/htm/ol.yml` үзгәртегез һәм [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) үзегезнең `npm` пакет исеме итеп үзгәртегез.

Аннары `md/.i18n/htm/ol.package.json` үзгәртегез

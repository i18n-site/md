...
Демо файл түбәндәгечә конфигурацияләнгән:
...
Әгәр дә сез мәкаләне өскә бәйләргә тиеш булсагыз, зинһар, `i18n.site` эшләгез һәм `.i18n/data/blog` файл астындагы `xxx.yml` файлны редакцияләгез, һәм вакыт маркасын тискәре санга үзгәртегез (берничә тискәре сан зурдан кечегә төрләнәчәк).
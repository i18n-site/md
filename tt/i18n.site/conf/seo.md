...
Конфигурациядә `i18n.site` `.i18n/htm/ol.yml` -дән `host:` гә үзгәртегез, берничә объект кибете `s3` кадәр конфигурацияләнергә мөмкин, һәм `region` кыр факультатив (күп объект кибетләренә бу кырны куярга кирәк түгел).

Аннары проектны бастыру өчен `i18n.site -n` йөгерегез.

Әгәр дә сез `~/.config/i18n.site.yml` үзгәртсәгез һәм яңадан йөкләргә телисез икән, зинһар, проект тамыр каталогында йөкләү кэшын чистарту өчен түбәндәге боерыкны кулланыгыз :
...
`cloudflare` конфигурациясендә бик күп тозаклар бар :
...
`R2` махсуслаштырылган домен исеме белән кереп `cloudflare` , статик файллар урнаштыру өчен өченче як объект саклауны кулланырга кирәк.
...
`backblaze.com` чиләк ясагыз, теләсә нинди файлны йөкләгез, файлны карау өчен `f003.backblazeb2.com` `Friendly URL` исемен алыгыз.
...
`Rewrite to` динамиканы сайлагыз һәм `concat("/file/your_bucketname",http.request.uri.path)` дән `your_bucketname` чиләк исеменә үзгәртегез.

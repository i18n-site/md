...
`i18n.site` сайтның эчтәлеген килешү буенча `npmjs.com` бастырачак, [unpkg.com](//unpkg.com) һәм # `npm` белән йөкләнгән бүтән `CDN` эчтәлек [jsdelivr.com](//jsdelivr.com)
...
`404` биттә бик матур йөзә торган арбалар бар, аларның күзләре тычкан белән хәрәкәтләнәчәк, [view Монда карау өчен басыгыз](/404) ,

...
Шәхси ачык чыганак проекты булса да, киң аудиториягә тәэсир итәргә тели, ул баштан ук халыкара технология сайларга тиеш.

## <a rel=id href="#project" id="project"></a> Проект тасвирламасы
...
Тәрҗемә `Markdown` һәм `YAML` командалар коралына ( [чыганак коды](https://github.com/i18n-site/rust/tree/main/i18) ) берничә телдә.

Форматын бик яхшы саклый ала `Markdown` Файл үзгәртүләрен ачыклый һәм үзгәртелгән файлларны гына тәрҗемә итә ала.
...
Без барысы да " `UNIX` " уртаклашабыз һәм катлаулы һәм авыр предприятияле чишелешләр кертмичә йөзләгән телләрдә тәрҗемә белән идарә итә алабыз.

Сез тәрҗемәне `Markdown` өчен иң таныш коралларны куллана аласыз (ләкин сез абзацларны өсти алмыйсыз) һәм версия белән идарә итүнең иң таныш ысулын куллана аласыз.

Код базасы тел файллары өчен ачык чыганак итеп ясалырга мөмкин, һәм `Pull Request` ярдәмендә глобаль кулланучылар тәрҗемәләрне өзлексез оптимизациядә катнаша ала. Чиксез тоташу [github](//github.com)

[User Кулланучының кулланмасы өчен проект документларын укыгыз](/i18) .
...
Чиста статик, уку тәҗрибәсе өчен оптимальләштерелгән һәм тәрҗемә белән интеграцияләнгән [i18](#i18) Бу проект документ сайты төзү өчен иң яхшы сайлау.

Төп фронтовик нигез тулы плагин архитектурасын кабул итә, бу икенчел үсеш өчен җиңел.

Бу вебсайт бу база нигезендә эшләнгән һәм кулланучы, түләү һәм башка функцияләрне үз эченә ала ( [чыганак коды](/i18n.site/src) ).

[User Кулланучының кулланмасы өчен проект документларын укыгыз](/i18n.site) .
...
<p style="text-align:right">Библия · Яратылыш</p>
...
Социаль медиага эчтәлек урнаштыруны синхронлаштыру;
...
Без киң кешеләр диңгезендә шундый ук кешеләр белән очрашуны түземсезлек белән көтәбез.

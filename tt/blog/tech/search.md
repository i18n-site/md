...
Мөмкин булган чишелешләрнең җитешсезлекләре аркасында, `i18n.site` яңа саф фронтның тулы текстлы эзләү чишелешен эшләде, аның түбәндәге үзенчәлекләре бар :
...
1. Префикс эзләүне хуплый, кулланучы язган вакытта эзләү нәтиҗәләрен күрсәтә ала.
1. Оффлайнда Бар
...
Игътибар итегез, `yield` соң кабат эзләгәндә, `IndexedDB` сорау транзакциясен ачарга кирәк.

...
Тәрҗемә редакцияләнә, оригиналь текстны үзгәртә, һәм ул яңадан тәрҗемә ителгәч, тәрҗемәгә кул белән үзгәртүләр язылмаячак (әгәр төп текстның бу абзацы үзгәртелмәгән булса).
...
Хәзерге тәрҗемә белән идарә итү кораллары артык `git` .
...
Мәсәлән, статистик документ сайтын социаль медиа һәм электрон почтага язылу белән тоташтырып, кулланучыларга яңартулар чыккан вакытта барып була.

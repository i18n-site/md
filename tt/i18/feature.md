...
Markdown HTML хуплый, `MarkDown` эчендә урнаштырылган HTML `<pre>` һәм `<code>` тэглардагы эчтәлек тәрҗемә ителми
...
Тәрҗемә аңлатмалары телне ` ``` ` дан соң күрсәтергә тиеш, ` ```rust ` :
...
`title` , `summary` һәм `description` кырларын тәрҗемә иткән статик блогның баш конфигурациясен хуплый [HOGO](https://github.com/gohugoio/hugo)

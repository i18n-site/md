...
windows , зинһар, [монда `git bash` йөкләү һәм урнаштыру өчен монда басыгыз](https://git-scm.com/download/win) .
...
Алар арасында `.i18n/cache/.gitignore` эчтәлеге түбәндәгечә :
...
Димәк, `.i18n/cache/` каталогындагы барлык файллар ( `.i18n/cache/.gitignore` кала) санга сукмыйлар.

Әгәр дә сезнең версия белән идарә итү программасы `git` булмаса, зинһар, бу конфигурация буенча аны санга сукмагыз.
...
Әгәр дә сез барлык телләргә дә тәрҗемә итәсегез килсә, зинһар, `:` соң буш калдырыгыз. мәсәлән
...
Төрле суб-каталоглар өчен сез төрле `fromTo` конфигурацияли аласыз, демонстрация : язылган /
...
Бу конфигурация таблицасында `blog` тәрҗемә каталогының чыганак теле `zh` , `blog/your_file_name.md` тәрҗемәсенең чыганак теле `ja` .

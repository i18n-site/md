...
Mayk'aq `User-Agent` yaykuy mañakuymanta maskana motor maskaqwan llamk'achkan, mañakuyqa `302` kaqnintakama mana kuyukuq p'anqaman kutichisqa kanqa.
...
### `cloudflare R2` Nisqataqa Manam Sapanchasqa Kamachiy Sutiwan Yaykuyta Atikunmanchu

Imaraykuchus `R2` `cloudflare` huk ruwasqa kamachiy sutiwan yaykuyta atikunmanchu, huk kimsa kaq objeto waqaychay llamk'achinan tiyan mana kuyusqa willañiqikunata churanapaq.

`cloudflare` [backblaze.com](https://www.backblaze.com)

`backblaze.com` kaqpi huk kutilla ruway, mayqin willañiqitapas yapay, willañiqita qhawanaykipaq ñit'iy, `Friendly URL` kaqpa kamachiy sutinta hap'iy, kaypi `f003.backblazeb2.com` .

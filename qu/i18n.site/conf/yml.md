...
#### Huk Proyecto Achka Archivokuna
...
Hawa qillqana ñanqa `url: xxx` nisqawanmi tupan, tupaqnin willañiqitaq `en/xxx/TOC` nisqawanmi.
...
Ejemplopaq, sichus `/test` yaykusqa, chaymanta `nav:` mana kay ñanpa ñawpaqninwan ruwasqa, chaymanta kunan maskana simi inglés (código `en` ), `/en/test.md` ñawpaqmanta kargasqa kanqa chaymanta plantilla `Md` llamk'achispa ruwasqa kanqa.

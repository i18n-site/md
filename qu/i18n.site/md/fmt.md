...
`i18n.site` kaqwan rimanakusqa ancla punto allichayqa `<a rel=id href="#xxx" id="xxx"></a>` kaqman rikch'akuq qillqata `MarkDown` kaqpi churaymi, makiwan ruwanapaq ancla punto posición kaqmanta.
...
[github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) codigoqa kayhinam :

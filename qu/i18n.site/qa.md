...
`npm` paquete nisqap lluqsichisqan historial nisqa layaqa `.i18n/v/ol/v.hash` nisqapi waqaychasqam.

Mana yuyaypi `.i18n/v/ol` qulluptiykiqa, `npm` paqueteqa manam kacharisqachu kanqa.

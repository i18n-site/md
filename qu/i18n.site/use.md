...
Sichus `i18n.site` llamk'achkanki huk web kitita ruwanapaq hatun web kitiyki hina, aswanta pan-dominio kutichiyta wakichinayki tiyan, chaytaq, yaykuyta `*.xxx.com` kaqman ( `www.xxx.com` kaqpi) `xxx.com` kaqman kutichiyman kutichinayki tiyan.

...
Mixed HTML Markdown tikrayta yanapan, HTML `MarkDown` kaqpi churasqa `<pre>` chaymanta `<code>` etiquetakunapi kaq contenidoqa mana tikrasqachu
...
Wakin kamachiy chiru tikray yanapakuykunapas kanmi, ahinataq [translate-shell](https://github.com/soimort/translate-shell)
...
[Kaypi ñit'iy autorizanaykipaq chaymanta kikillanmanta qatinaykipaq github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) chaymanta **$50 bono chaskinaykipaq** !
...
## Yanapakuy Tikray `HOGO` Umalliq Wakichiy
...
`i18` `MarkDown` nisqapi tituluta riqsiyta atin, hatun qillqawantaq kikinmanta hatun qillqawan qillqanqa, mayúsculas nisqa simiman tikraspa.
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` simiman t'ikrasqa :

![](//p.3ti.site/1720199391.avif)

Francés simiman `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

`Falcon` `faucon` nisqaman t'ikrakun, `Llama` `lama` nisqaman t'ikrakun. Propio sutikuna hinaqa manan t’ikranachu.

![](//p.3ti.site/1720199451.avif)

### DeepL Tikray

`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` simiman t'ikrasqa :
...
Inglés simiwan chino, japonés, coreano qillqawan huk espacio kaptinlla utaq inglés simipi 1manta aswan hatun kaptinqa, chay simiqa huk término hina qawasqa kanqa.
...
Clienteqa tukuyninpi kichasqa qullqiyuqmi, chaymanta sirwiqpa 90 % kichasqa qullqiyuqmi [Kaypi ñit'iy pukyuta qhawanaykipaq](/i18n.site/src) .

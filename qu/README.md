<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Soluciones internacionales nisqa<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Willakuy phatariywan, pachantinpi qhatuwan ima, pisi qhawaypaq atipanakuypaq, **achka simikunata yanapayqa huk yachaymi** .
...
## <a rel=id href="#project" id="project"></a> Proyectomanta Willakuy
...
`Markdown` `YAML` ima kamachiy chiru yanapakuyman ( [pukyuta](https://github.com/i18n-site/rust/tree/main/i18) ) achka simikunapi tikray.

Pueden perfectamente mantener el formato de `Markdown` Willañiqi tikraykunata riqsiyta atin, tikrasqa willañiqikunallata tikrayta atin.
...
Tukuy imapas huk Archivo " `UNIX` " kaqmanta qunakuyku chaymanta pachak simikunapi tikraykunata kamachiyta atiyku mana sasachakuyniyuq chaymanta empresa-nivel solucionkunata riqsichispa.

Aswan riqsisqa yanapakuykunata llamk'achiy atikunki tikrayta `Markdown` (ichaqa mana parrafokunata yapayta utaq qulluyta atikunkichu), chaymanta aswan riqsisqa ñanta llamk'achiyta llamk'achiy laya kamachiyta ruwanapaq.

Huk codigo base nisqa simi willañiqikunapaq kichasqa qullqisapa hinam rurasqa kanman, chaymanta `Pull Request` Mana llamk'ayniyuq tinkiynin [github](//github.com) Hinallataq huk kichasqa qullqiyuq ayllukuna.

[→ Ruwaqpa pusaqninpaqqa, ama hina kaspa, proyecto qillqakunata ñawiriy](/i18) .

## Xindaya’s Alto Calidad T’ikray
...
Kikin calidadta `2.67` , `3.15` Translate kaqwan `ChatGPT`

#### <a rel=id href="#price" id="price"></a> Ancha atipanakuy chaninkuna churay
...
Puramente estático, ñawiriy experienciapaq allinchasqa, chaymanta [i18](#i18) aswan allin akllana huk proyecto qillqa sitio ruwanapaq.

Ukhupi kaq ñawpaq-tukuy marco huk hunt'asqa plug-in arquitecturata hap'in, mayqinchus iskay kaq wiñachiypaq sasan, Necesario kaqtinqa, qhipa-tukuy ruwanakuna tinkisqa kanman.

Kay web kitiqa kay marco kaqpi ruwasqa kachkan chaymanta ruwaq, qullqi quy chaymanta wak ruwanakunayuq ( [pukyuta código](/i18n.site/src) ).

[→ Ruwaqpa pusaqninpaqqa, ama hina kaspa, proyecto qillqakunata ñawiriy](/i18n.site) .
...
/ allin hamusqaykichikta qatipanaykichikpaq cuenta [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) [X.COM: @i18nSite](https://x.com/i18nSite)
...
Aswan achkaraqmi ruway munasqanchik.

Runakunapa hatun lamar-qochanpi kaqlla yuyayniyuq runakunawan tupayta suyayku.

...
brief: |
  ...
  Kunan kaq allichaykunawan tupachisqa, i18n.site ch'uya ñawpaq-tukuy hunt'asqa qillqa maskana huch'uy sayayniyuq chaymanta utqaylla, huch'uy chaymanta chawpi hatun web kitikuna qillqakuna chaymanta blogkuna hina allin, chaymanta mana tinkisqa kaqpi tarikun.
...
1. Ñawpaqmanta ruwasqa indis willañiqikuna
   ...
   Chayqa ruwaqpa suyaynin pachata yapanqa chaymanta achka ancho de banda nisqatapas tukunqa.
...
Kunan kaq allichaykunap pisiyayninrayku, `i18n.site` musuq ch'uya ñawpaq-tukuy hunt'asqa qillqa maskana allichayta ruwasqa, kay qatiq ruwanakunayuq :
...
Uraypiqa `i18n.site` técnico implementacionmanta detalles nisqakunam detallewan riqsichisqa kanqa.
...
* `/\p{P}/` nisqaqa sapa kuti rimaymi, chaymi tupan chikukunawan tupaq chikukuna: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` { | } ~. `.</p><ul><li> `split('.')` nisqaqa `Firefox` maskaq simi rakiy mana `. ` rakisqanraykum.</li>
...
IndexedDB ñawiriy chaymanta qillqay mana sincrono kanku. Indice nisqa paqarichispaqa, qillqakunam kuskalla kargasqa kanqa, indis nisqa ruranapaq.
...
Maskana ruwasqakunata qawachiptinchikqa, capitulopa sutinmi qawakunqa, ñitiykuptinñataqmi capitulota purinqa.

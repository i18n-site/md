...
windows , mangga [klik ing kene kanggo ngundhuh lan nginstal `git bash`](https://git-scm.com/download/win) dhisik.
...
Mangga deleng proyek demo kanggo sinau konfigurasi `i18` terjemahan [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18)
...
Sampeyan bisa ngatur macem-macem `fromTo` kanggo macem-macem subdirektori : /
...
Ing tabel konfigurasi iki, basa sumber terjemahan katalog `blog` yaiku `zh` , lan basa sumber terjemahan `blog/your_file_name.md` yaiku `ja` .
...
`ignore` nggunakake [globset](https://docs.rs/globset/latest/globset/#syntax) sing padha karo file `.gitignore` .
...
Nanging elinga yen baris terjemahan lan teks asli kudu cocog siji-siji. Yaiku, aja nambah utawa mbusak baris nalika nyusun terjemahan. Yen ora, bakal nyebabake kebingungan ing cache panyuntingan terjemahan.

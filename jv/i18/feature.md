...
Terjemahan kudu ditindakake kanthi ngetik perintah lan ngrampungake kanthi siji klik Ora ana dependensi lingkungan sing rumit.
...
## Optimalisasi Terjemahan Kanggo China, Jepang Lan Korea
...
Terjemahake ing ndhuwur menyang basa DeepL (uga nulis maneh jeneng sing bener lan nambah `... ` ganjil):
...
Klien punika open source, lan sisih 90 % saka kode punika open source [Klik kene kanggo ndeleng kode sumber](/i18n.site/src) .

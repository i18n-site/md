...
Ndhukung konfigurasi header saka blog statis jinis [HOGO](https://github.com/gohugoio/hugo) , sing mung nerjemahake kolom `title` , `summary` lan `description` .
...
Diterjemahake menyang basa `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

...
Saiki, telusuran teks lengkap ngarep sing umum kalebu [lunrjs](//lunrjs.com) lan [ElasticLunr.js](//github.com/weixsong/elasticlunr.js) (adhedhasar `lunrjs` pangembangan sekunder).
...
Amarga kekurangan saka solusi sing wis ana, `i18n.site` wis ngembangake solusi telusuran teks lengkap ngarep murni anyar, sing nduweni ciri ing ngisor iki :
...
1. Ndhukung telusuran awalan, sing bisa nampilake asil panelusuran ing wektu nyata nalika pangguna lagi ngetik.
1. Kasedhiya Offline
...
Kanggo nampilake asil panelusuran nalika pangguna lagi ngetik, contone, nalika `wor` diketik, tembung sing diawali karo `wor` kayata `words` lan `work` ditampilake.
...
Panelusuran teks lengkap terbalik sing diimplementasikake mung ing ngarep, ora ana server sing dibutuhake. Cocog banget kanggo situs web ukuran cilik lan medium kayata dokumen lan blog pribadi.

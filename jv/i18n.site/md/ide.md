...
Kita nggunakake [vscode](https://code.visualstudio.com/) kanggo nulis `MarkDown` , lan uga nginstal plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) kanggo pratinjau ing wektu nyata nalika nulis.
...
Ing wektu sing padha, sampeyan bisa ngrujuk menyang konfigurasi ing ngisor iki, ngowahi file, lan ngatur file sing diunggah kanthi otomatis dikompres dadi `avif` kanggo nyuda ukuran gambar.

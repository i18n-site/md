...
Yen sampeyan nggunakake lingkungan integrasi terus-terusan kanggo nerbitake, ora perlu nginstal `nodejs` , mung nyalin ijin mlebu lan nerbitake `~/.npmrc` menyang lingkungan.

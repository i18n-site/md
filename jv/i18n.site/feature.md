...
Program wis built- `i18` terjemahan, mangga deleng [➔ `i18`](/i18) kanggo panggunaan tartamtu.
...
`i18n.site` Kanthi gawan, isi situs bakal diterbitake kanggo `npmjs.com` , kanthi bantuan saka [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) lan sawetara `CDN` isi dimuat ing `npm` .
...
Prinsip kasebut yaiku: nyegat panjalukan kasebut kanthi bantuan [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , yen panjalukan gagal, coba maneh ing `CDN` liyane, lan kanthi adaptif ngaktifake stasiun asal sing paling cepet respon minangka sumber muatan standar.
...
Ana hantu cilik sing ngambang ing `404` , mripate bakal obah nganggo mouse, [➔ Klik ing kene kanggo ndeleng](/404) ,

...
* `import.css` : 1Gaya `i18n.site` kanggo kabeh situs
* `conf.css` : Ikon footer lan font

### Font Lambang

Ikon footer digawe kanthi nggawe font kanthi `F` iconfont.cn [versi Inggris](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

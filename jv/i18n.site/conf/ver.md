...
Kosong `v` ora bakal ditampilake ing outline sidebar, nanging anggere ana `v` file, indeks independen bakal digawe kanggo file ing direktori lan subdirektori.

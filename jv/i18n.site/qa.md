...
## Ora Sengaja Dibusak `.i18n/V` , Nyebabake `Npm` Paket Gagal Diterbitake

Versi historis saka `npm` rilis paket disimpen ing `.i18n/v/ol/v.hash`

Yen sampeyan ora sengaja mbusak `.i18n/v/ol` paket `npm` ora bakal diterbitake.

Ing wektu iki, goleki nomer versi versi rilis pungkasan proyek sampeyan ing [npmjs.com](//npmjs.com) contone `0.1.9`

Banjur deleng `bash` Gawe file ing ngisor iki.

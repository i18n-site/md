...
Sararri ajaja Markdown Yaml , marsariitii sanadoota idil-addunyaa ijaaruuf si gargaara, [afaanota dhibbaan lakkaa'aman](/i18/LANG_CODE) deeggaru ...
...
Miidiyaa hawaasaa fi emailiin namoonni madda odeeffannoo afaan dhalootaa isaaniitiin xiyyeeffachuu amaleeffataniiru.
...
#### <a rel=id href="#price" id="price"></a> Gatii baayyee dorgomaa ta'e
...
Maaloo <button onclick="mailsub()">email kana cuqaasuun fooyya'iinsa oomishaa irratti galmaa'uu</button> fi <button onclick="webpush()">dhiibbaa biraawzari dandeessisuuf</button> yeroo oomishni haaromfamu isin beeksifna.
...
Intarneetii afaan adda baafamuu malee ijaaruu barbaanna.
Ilmi namaa hundi abjuu waloo qabatanii akka walitti dhufan abdii qabna.

Marsariitiin hiikkaa fi galmee Markdown jalqaba qofa.

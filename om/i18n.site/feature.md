...
## Hiikaa Walitti Makame `I18`

Sagantaan kun hiikkaa ijaarame `i18` , itti fayyadama addaa argachuuf [➔ `i18`](/i18) ilaalaa.
...
Akka `i18n.site` , qabiyyeen saayitii gara `npmjs.com` , gargaarsa [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) fi qabiyyee `CDN` dachaa `npm` .
...
Prinsippiin `CDN` : gaaffii gargaarsa [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
Akka durtiitti, [Alimama dual-axis variable rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) fi qubeewwan toora interneetii biroo fuula marsariitii irratti dandeessifamanii muuxannoo dubbisuu fayyadamtoota waltajjiiwwan adda addaa irratti tokkoomsuuf.
...
Fuula irratti hafuurri xiqqoo bareedduu lola'aa jira, iji isaa hantuutee waliin ni socho'a, [➔ ilaaluuf as tuqi](/404) , `404`

...
`MarkDown` barreessuudhaaf [vscode](https://code.visualstudio.com/) fayyadamna, akkasumas yeroo barreessinu yeroo qabatamaa keessatti dursanii ilaaluuf plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) fe'a.
...
Faayilii `Markdown` banuuf `vscode` waamuuf sarara ajajaa keessatti `code xxx.md` galchi.

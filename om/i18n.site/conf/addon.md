...
* `lang_li` : afaanii, afaan jalqabaa afaan madda
* `changed` : Faayilota fooyya'an
* `root` : hundee pirojektii

Gatiin deebi'aa galmee jechootaa, kan akka
...
Yeroon gaggeeffama `js` ijaarame guddina sadarkaa lammaffaa : [boa](https://github.com/boa-dev/boa)

...
Faayilli demoo akka armaan gadiitti qindaa'a:
...
Qindaa'inni muka galmee gama mirgaa biloogichaa irrattis faayilii `TOC` dha (boqonnaa darbe ilaali barruulee `TOC` keessatti tarreeffaman qofatu indeksii fuula jalqabaa biloogii keessatti mul'ata).
...
Odeeffannoon barreessaa meetaa-odeeffannoo barreeffamichaa keessatti barreeffamuu danda’a, kanneen akka:

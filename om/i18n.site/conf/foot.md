...
[`pug`](https://pugjs.org) afaan unkaa kan `HTML` 's maddisiisudha.
...
Qaamolee weeb uumuun salphaadha, kan akka `<x-img>` amala0 .
...
Link irratti `class="a"` dabaluun linkiin gara `MarkDown` akka hin jijjiiramneef.Ilaali :

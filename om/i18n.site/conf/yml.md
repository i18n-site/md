...
Isaan keessaa `i18n: home` `en/i18n.yml` keessaa `home: Home` wajjin walsima (bakka `en` afaan madda hiikkaa pirojektichaati).
...
Malli barreeffamaa armaan olii `url: xxx` waliin walqixa , faayilii isaa walgitu `en/xxx/TOC` dha .

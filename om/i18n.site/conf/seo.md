...
Kuusaan `cloudflare` ijaarame `R2` maqaa domeenii dhuunfameen dhaqqabamuu waan hin dandeenyeef, kuusaan wanta qaama sadaffaa faayilii istaatiksii kaa'uuf fayyadamuu qaba.
...
Dabalataan, seera jijjiirraa `cloudflare` armaan olii keessatti, `index.html` gara `file/your_bucketname/index.html` tti jijjiirama, fi qindeessootni biroo akkuma jirutti hafu.

...
It allows you to quickly build international documents and blogs that support [hundreds of languages](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

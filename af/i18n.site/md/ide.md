...
Ons gebruik [vscode](https://code.visualstudio.com/) om `MarkDown` te skryf, en installeer ook die inprop [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) om intyds te kyk terwyl ons skryf.
...
Terselfdertyd kan jy na die volgende konfigurasie verwys, die lêer wysig en die opgelaaide lêer opstel om outomaties saamgepers te word na `avif` om die beeldgrootte te verminder.

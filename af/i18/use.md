...
[i18n.site/payBill](//i18n.site/payBill) moet jy 'n kredietkaart bind vir betaling (geen herlaai word vereis nie, die webwerf sal outomaties fooie aftrek volgens gebruik, [sien die tuisblad vir pryse](/#price) ).
...
As jy sekere lêers wil ignoreer en nie vertaal nie (soos onvoltooide konsepte), kan jy die `ignore` veldkonfigurasie gebruik.

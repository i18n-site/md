...
Verwys asseblief na die demo- [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) om die konfigurasie van `i18` vertaling te leer.
...
Jy kan verskillende `fromTo` vir verskillende subgidse opstel / 'n Demonstrasie word soos volg geskryf :
...
In hierdie konfigurasietabel is die brontaal van katalogus `blog` -vertaling `zh` , en die brontaal van `blog/your_file_name.md` -vertaling `ja` .
...
`ignore` gebruik dieselfde [globset](https://docs.rs/globset/latest/globset/#syntax) as die `.gitignore` lêer.

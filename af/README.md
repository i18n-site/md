...
#### <a rel=id href="#price" id="price"></a> Baie mededingende pryse
...
<button onclick="mailsub()">Klik asseblief hierdie e-pos om in te teken op produkopdaterings</button> en <button onclick="webpush()">aktiveer blaaierstoot</button> . Ons sal jou in kennis stel wanneer produkte opgedateer word.
...
Ons wil 'n internet bou sonder taalisolasie.
Ons hoop dat die hele mensdom saam sal kom met 'n gemeenskaplike droom.

Markdown vertaling en dokumentasie webwerf is net die begin.

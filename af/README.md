<h1 style="display:flex;justify-content:space-between">i18n.site Internasionale oplossings<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Projek Beskrywing
...
Vertaal `Markdown` en `YAML` in 'n opdragreëlinstrument ( [bronkode](https://github.com/i18n-site/rust/tree/main/i18) ) in verskeie tale.

Kan die formaat van perfek handhaaf `Markdown` Kan lêerwysigings identifiseer en slegs veranderde lêers vertaal.
...
Ons deel " filosofie `UNIX` Everything is a File " en kan vertalings in honderde tale bestuur sonder om komplekse en omslagtige oplossings op ondernemingsvlak bekend te stel.

Jy kan die bekendste gereedskap gebruik om die vertaling `Markdown` (maar jy kan nie paragrawe byvoeg of uitvee nie), en die mees bekende manier gebruik om weergawebeheer te doen.

'n Kodebasis kan geskep word as 'n oopbron vir taallêers, en met behulp van `Pull Request` se proses kan globale gebruikers deelneem aan die voortdurende optimalisering van vertalings. Naatlose [github](//github.com) en ander oopbrongemeenskappe.
...
Suiwer staties, geoptimaliseer vir leeservaring, en geïntegreer met die vertaling van [i18](#i18) is dit die beste keuse vir die bou van 'n projekdokumentwebwerf.
...
Hierdie webwerf is ontwikkel op grond van hierdie raamwerk en sluit gebruiker-, betaling- en ander funksies in ( [bronkode](/i18n.site/src) ) 'n Gedetailleerde tutoriaal sal later geskryf word.

[→ Vir gebruikersgids, lees asseblief die projekdokumentasie](/i18n.site) .

...
Jappoġġja t-traduzzjoni ta' HTML Markdown , il-kontenut fit-tags `<pre>` u `<code>` ta' HTML inkorporati `MarkDown` mhux tradott
...
It-traduzzjoni għandha ssir billi ddaħħal kmandi u timla bi klikk waħda. M'għandu jkun hemm l-ebda dipendenzi ambjentali kumplessi.
...
## <a rel=id href="#price" id="price"></a> Prezzijiet kompetittivi ħafna
...
### Termini Ingliżi Fiċ-Ċiniż, Il-Ġappuniż, Il-Korean U Ċ-Ċiniż Mhumiex Tradotti
...
DeepL dan ta’ hawn fuq għall-Franċiż (kitba mill-ġdid ukoll l-ismijiet proprji u żżid il-fard `... ` ):

...
Jappoġġja t-traduzzjoni ta HTML mħallta Markdown , il-kontenut fit-tags `<pre>` u `<code>` ta HTML inkorporati `MarkDown` mhux tradott
...
Il-kummenti tat-traduzzjoni jeħtieġ li jindikaw il-lingwa wara ` ``` ` , : ` ```rust ` .
...
Jappoġġja l-konfigurazzjoni tal-header ta [HOGO](https://github.com/gohugoio/hugo) blog statiku tat-tip, li jittraduċi biss l-oqsma `title` , `summary` u `description` .

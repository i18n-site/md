...
`Markdown` jintuża bħala mudell ta 'email, `YAML` jintuża bħala konfigurazzjoni tal-fajl tal-lingwa, u se jkun hemm parametri varjabbli (per eżempju: recharge `${amount}` ġie riċevut).

...
tarf ta' wara [axum](https://github.com/tokio-rs/axum) [tower-http](https://github.com/tower-rs/tower-http/releases) .

Linja tal-kmand [inkorporata js boa_engine](https://docs.rs/boa_engine) , [database inkorporata fjall](https://github.com/fjall-rs/fjall) .

[contabo](https://my.contabo.com) VPS

database [kvrocks](https://kvrocks.apache.org) , [mariadb](https://mariadb.org) .

Ibgħat posta lil self-built SMTP [chasquid](https://github.com/albertito/chasquid)

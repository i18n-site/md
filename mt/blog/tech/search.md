...
It-tieni hija pura tfittxija full-test front-end.
...
`lunrjs` Hemm żewġ modi kif jinbnew l-indiċi, u t-tnejn għandhom il-problemi tagħhom.
...
Minħabba n-nuqqasijiet tas-soluzzjonijiet eżistenti, `i18n.site` żviluppat soluzzjoni ġdida ta 'tfittxija ta' test sħiħ ta 'quddiem pur, li għandha l-karatteristiċi li ġejjin :
...
1. Jappoġġja t-tfittxija tal-prefiss, li tista 'turi r-riżultati tat-tfittxija f'ħin reali waqt li l-utent ikun qed ittajpja.
1. Disponibbli Offline

Hawn taħt, `i18n.site` dettalji ta' implimentazzjoni teknika se jiġu introdotti fid-dettall.

## Segmentazzjoni Multilingwi Tal-Kliem
...
IndexedDB jaqra u jikteb huma asinkroniċi. Meta jinħoloq indiċi, id-dokumenti jitgħabbew fl-istess ħin biex jinħoloq l-indiċi.

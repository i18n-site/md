...
It-tfittxija l-ewwel sejra l-kliem kjavi mdaħħla mill-utent.
...
It-tabella ta 'l-indiċi ma taħżinx it-test oriġinali, il-kliem biss, li jnaqqas l-ammont ta' ħażna.
...
Is-soluzzjoni pura ta' tfittxija front-end ta' `i18n.site` hija ottimizzata għal dokumenti `MarkDown` .

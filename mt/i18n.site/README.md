...
`i18n.site` huwa li naħseb mill-ġdid tal-mudell tal-iżvilupp tal-websajt.

Dan huwa ġeneratur ta' sit ta' dokumenti u qafas ta' żvilupp ta' websajt.

Paradigma ġdida ta 'żvilupp ta' websajt li tieħu `MarkDown` bħala ċ-ċentru u tuża komponenti ta 'quddiem biex tinjetta l-interattività.

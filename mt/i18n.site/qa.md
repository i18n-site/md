...
Il-verżjoni storika maħruġa mill-pakkett `npm` hija salvata `.i18n/v/ol/v.hash` .

Jekk aċċidentalment tħassar `.i18n/v/ol` il-pakkett `npm` mhux se jiġi rilaxxat.

F'dan iż-żmien, l-ewwel sib in-numru tal-verżjoni tal-aħħar verżjoni tal-ħruġ tal-proġett tiegħek f' [npmjs.com](//npmjs.com) bħal `0.1.9` .

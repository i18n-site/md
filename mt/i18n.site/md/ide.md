...
Aħna [vscode](https://code.visualstudio.com/) biex niktbu `MarkDown` , u ninstallaw ukoll il-plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) biex nipprevedi f'ħin reali waqt il-kitba.
...
Jappoġġja l-ikkuppjar awtomatikament tal-isem tal-fajl għal format `Markdown` wara t-tlugħ, li jtejjeb ħafna l-effiċjenza.

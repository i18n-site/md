...
Il-programm għandu traduzzjoni `i18` , jekk jogħġbok ara [➔ `i18`](/i18) għal użu speċifiku.
...
`i18n.site` B'mod awtomatiku, il-kontenut tas-sit se jiġi ppubblikat fuq `npmjs.com` , bl-għajnuna ta [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) u kontenut `CDN` mgħobbi fuq `npm` .
...
Il-prinċipju huwa: interċetta t-talba bl-għajnuna ta [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , jekk it-talba tfalli, erġa' ipprova fuq `CDN` oħra, u abilita b'mod adattiv l-istazzjon tal-oriġini li jwieġeb b'mod mgħaġġel bħala s-sors tat-tagħbija default.
...
Il-websajt jadotta arkitettura ta' applikazzjoni ta' paġna waħda, mingħajr ebda aġġornament meta taqleb il-paġni u tagħbija estremament veloċi.
...
### Tagħbija Fonts Onlajn, Appoġġ Ċiniż

B'mod awtomatiku, [fonts rettangolari varjabbli b'assi doppju Alimama](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) u fonts oħra onlajn huma attivati ​​fuq il-paġna web biex jgħaqqdu l-esperjenza tal-qari tal-utenti fuq pjattaformi differenti.

Fl-istess ħin, sabiex tittejjeb il-veloċità tat-tagħbija, il-fonts jitqattgħu skont l-istatistika tal-frekwenza tal-kliem.
...
Hemm fantat żgħir ħelu f'wiċċ l-ilma fuq il `404` paġna, għajnejha se jimxu bil-maws, [➔ Ikklikkja hawn biex tara](/404) ,

...
## <a rel=id href="#project" id="project"></a> Deskrizzjoni tal-Proġett
...
Ittraduċi `Markdown` u `YAML` f'għodda tal-linja tal-kmand ( [kodiċi tas-sors](https://github.com/i18n-site/rust/tree/main/i18) ) f'diversi lingwi.
...
Aħna naqsmu " filosofija `UNIX` Kollox huwa File " u nistgħu niġġestixxu traduzzjonijiet f'mijiet ta' lingwi mingħajr ma nintroduċu soluzzjonijiet kumplessi u ingombranti fil-livell tal-intrapriża.

Tista' tuża l-aktar għodod familjari biex `Markdown` t-traduzzjoni (imma ma tistax iżżid jew tħassar paragrafi), u tuża l-aktar mod familjari biex tagħmel il-kontroll tal-verżjoni.

Bażi ta 'kodiċi tista' tinħoloq bħala sors miftuħ għall-fajls tal-lingwa, u bl-għajnuna tal-proċess ta `Pull Request` , utenti globali jistgħu jipparteċipaw fl-ottimizzazzjoni kontinwa tat-traduzzjonijiet. Konnessjoni bla xkiel [github](//github.com) komunitajiet oħra ta 'sors miftuħ.
...
Purament statiku, ottimizzat għall-esperjenza tal-qari, u integrat mat-traduzzjoni ta ' [i18](#i18) hija l-aħjar għażla għall-bini ta' sit ta 'dokument ta' proġett.

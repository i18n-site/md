# Rekomendasion Ti Editor

Tunggal maysa ket addaan iti bukodna a paborito nga editor Ditoy nga ibinglaymi `Markdown` a kasayaatan nga aramidmi.

Usarenmi ti [vscode](https://code.visualstudio.com/) tapno agsurat `MarkDown` ken mangikabil ti plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) tapno preview iti aktual nga oras bayat ti panagsurat.
...
Usaren ti [PicList](https://github.com/Kuingsmile/PicList)

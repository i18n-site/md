...
Dagiti tradisional a `MarkDown` a puntos ti angkla ket napataud a naibatay iti linaon ti teksto Iti kaso ti adu a pagsasao, daytoy a solusion ket saan a maaramid.
...
`<a rel=id href="#xxx" id="xxx"></a>` , ditoy `rel=id` ket mangikeddeng ti estilo ti panid ti puntos ti angkla, pangngaasi a sukatam `xxx` iti aktual nga ababa nga Ingles ti angklamo.

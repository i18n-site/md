...
Dagiti plug-in ket amin `npm` a pakete.
...
No kayatmo nga ilinteg ti bersion, mabalinmo nga isurat `i18n.addon/toc@0.1.3` .
...
Ti naibangon a `js` oras ti panagtaray ket naibatay iti sekondario a panagrang-ay ti [boa](https://github.com/boa-dev/boa) , ken dagiti naibangon a panagandar ket kas ti sumaganad :

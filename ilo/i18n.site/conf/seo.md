...
Umuna nga agsilpo ti arbitrario a nagan ti dominio iti `cloudflare` , ken kalpasanna usaren ti `SSL/TLS` → kostumbre a nagan ti dominio tapno mainaig ti kangrunaan a nagan ti dominio iti daytoy a nagan ti dominio.

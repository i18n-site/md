...
Kaskasdi nga alaen ti proyekto ti demo a kas pagarigan, `.i18n/htm/foot.pug` iti `md` a direktorio ket mangikeddeng ti footer ti website.

![](https://p.3ti.site/1721286077.avif)

[`pug`](https://pugjs.org) ket maysa a pagsasao ti plantilia a mangpataud `HTML` 's.
...
Ti pananginayon `class="a"` iti silpo ket tapno malapdan ti silpo a mabaliwan iti `MarkDown` Kitaen ti :
 [➔ `YAML` Kasano a malapdan ti pannakabaliw : link `HTML` iti `Markdown`](/i18/qa#H2) .
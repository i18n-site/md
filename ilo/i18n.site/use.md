...
No agus-usar ka ti agtultuloy nga aglawlaw ti panagtipon tapno mangipablaak, saan a kasapulan ti mangikabil `nodejs` , kopiaem laeng ti nakalog-in ken pammalubos ti panagipablaak `~/.npmrc` iti aglawlaw.
...
Gapu ta ti website ket agus-usar ti [maymaysa a panid nga arkitektura ti aplikasion](https://developer.mozilla.org/docs/Glossary/SPA) , laglagipen nga isurat manen dagiti dalan ti URL nga awan ti linaon ti `. ` aginggana ti `index.html` .
...
Kalpasanna, usaren ti pagipempenan ti banag dagiti aglaklako iti ulep iti mainland China + I-deploy ti sumaganad a linaon `CDN` `out/ol/htm`
...
Pangngaasi nga inayon ti panagisaad a kapada ti `out/ol/htm` iti `server` a parapo ti nginx `/root/i18n/md/out/ol/htm`

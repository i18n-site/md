...
Iti front-end a panagtitinnulong, ti index loading progress bar ket mabalin a maiparang tapno maliklikan ti lag no agkarga iti umuna a gundaway Kitaen ti "Progress Bar nga addaan Animation, Naibatay iti Maymaysa progress + Puro css Implementation" [Ingles](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [Chinese](//juejin.cn/post/7413586285954154522) .

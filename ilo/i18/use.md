...
## windows Umuna Nga I-Install Ti git bash
...
[i18n.site/payBill](//i18n.site/payBill) , kasapulam ti mangigalut iti credit card para iti panagbayad (awan ti kasapulan a recharge, automatiko nga ibaba ti website dagiti bayad sigun iti pannakausar, [kitaen ti homepage para iti panagpresyo](/#price) ).
...
No kayatmo a di ikankano dagiti sumagmamano a papeles ken saan nga ipatarus dagitoy (kas dagiti saan a nalpas a draft), mabalinmo nga usaren ti `ignore` a panagisaad ti tay-ak.

...
Adda met sumagmamano nga alikamen ti panagipatarus iti linia ti bilin, kas iti [translate-shell](https://github.com/soimort/translate-shell)
...
## <a rel=id href="#price" id="price"></a> Nasalisal unay ti panagpresyo
...
`Markdown` ket maus-usar a kas ti plantilia ti email, `YAML` ket naus-usar a kas ti panagisaad ti papeles ti pagsasao, ken addanto dagiti variable a parametro (kas pagarigan: naawat ti panagkarga manen `${amount}` ).
...
Awan ti dadakkel wenno babassit a letra ti China, Japan, ken Korea, ngem dagiti paulo nga Ingles ket sapasap a dakkel ti umuna a letra.
...
### Saan a Naipatarus Dagiti Termino Nga Ingles Iti Insik, Hapon, Koreano Ken Insik
...
`Falcon` ket maipatarus a `faucon` ken `Llama` ket naipatarus a kas `lama` . Kas proper noun, saan koma a maipatarus dagitoy.

![](//p.3ti.site/1720199451.avif)

### DeepL Nga Patarus

Naipatarus `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` Hapones :
...
Ti kliyente ket naan-anay a silulukat a taudan, ken ti sikigan ti 90 % ti kodigo ket silulukat a taudan [I-klik ditoy tapno makita ti taudan a kodigo](/i18n.site/src) .

...
No dadduma ti panagbalbaliw manipud iti `HTML` → `MarkDown` ket saan a kas iti kayattayo, kas iti pannakakomberte ti `<a href="/">Home</a>` iti `[Home](/)` .

Ti pananginayon ti ania man a kababalin malaksid `href` iti etiketa ti `a` , a kas ti `<a class="A" href="/">Home</a>` , ket mabalin a mangliklik iti daytoy a panagbalbaliw.

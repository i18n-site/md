<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Internasional a solusion<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Linya ti bilin Markdown Yaml ti panagipatarus, tulongannaka a mangbangon ti internasional a site ti dokumento, a mangsuporta [kadagiti ginasut a pagsasao](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> Panangdeskribir ti Proyekto
...
Ipatarus ti `Markdown` ken `YAML` iti ramit ti linia ti bilin ( [taudan a kodigo](https://github.com/i18n-site/rust/tree/main/i18) ) iti adu a pagsasao.
...
Ibinglaymi " pilosopia `UNIX` Everything is a File " ken mabalinmi nga imanehar dagiti panagipatarus iti ginasut a pagsasao a di mangiyam-ammo kadagiti komplikado ken narikut a solusion iti lebel ti empresa.

Mabalinmo nga usaren dagiti kaaduan a pamiliar nga alikamen a `Markdown` ti panagipatarus (ngem saanmo a mabalin ti manginayon wenno mangikkat kadagiti parapo), ken agusar ti kaaduan a pamiliar a wagas a mangaramid ti panagtengngel ti bersion.

Ti maysa a batayan ti kodigo ket mabalin a maparsua a kas ti silulukat a taudan para kadagiti papeles ti pagsasao, ken babaen ti tulong ti proseso ti `Pull Request` , dagiti sangalubongan nga agar-aramat ket mabalinda ti makipaset iti agtultuloy a panagoptimisar kadagiti panagipatarus. Seamless connection [github](//github.com) Ken dadduma pay nga open source a komunidad.

[→ Para iti giya ti agar-aramat, pangngaasi a basaen ti dokumentasion ti proyekto](/i18) .

## De Kalidad a Patarus Ni Xindaya
...
Tapno maragpat ti isu met laeng a kalidad, ti kaadu ti manual a panag-edit a kasapulan ti Google Translate ken `ChatGPT` ket `2.67` daras ken `3.15` a daras ti panagsasarunotayo.

#### <a rel=id href="#price" id="price"></a> Nalabes ti kompetisionna a panagpresyo

|                                                                                   | USD/milion a balikas |
| --------------------------------------------------------------------------------- | ------------- |
...
Puro nga estatiko, nasayaat para iti padas ti panagbasa, ken naikaykaysa iti panagipatarus ti [i18](#i18) daytoy ti kasayaatan a pili para iti panagbangon ti maysa a site ti dokumento ti proyekto.
...
Daytoy a website ket naaramid a naibatay iti daytoy a balangkas ken mairaman ti agar-aramat, panagbayad ken dagiti dadduma pay a panagandar ( ti [taudan a kodigo](/i18n.site/src) ket maisuratto inton agangay.

[→ Para iti giya ti agar-aramat, pangngaasi a basaen ti dokumentasion ti proyekto](/i18n.site) .

## Agtultuloy a Makikomunikar

Pangngaasi nga <button onclick="mailsub()">i-klik daytoy nga email tapno agsuskribir kadagiti panagpabaro ti produkto</button> ken <button onclick="webpush()">mapalubosan ti panangiduron ti browser</button> .

Kasta met / maawat nga suroten dagiti social [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) tayo [X.COM: @i18nSite](https://x.com/i18nSite)
...
>
> Nakita ni Yahweh daytoy ket kinunana, "Amin a tattao ket agpapada ti pagsasao ken puli. Ita ta naaramiden daytoy, maaramidto ti amin."
>

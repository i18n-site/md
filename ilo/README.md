...
Maysa a ramit ti linia ti bilin ( [taudan a kodigo](https://github.com/i18n-site/rust/tree/main/i18) ) a mangipatarus `Markdown` ken `YAML` kadagiti adu a pagsasao.
...
Mabalinmo nga usaren dagiti kaaduan a pamiliar nga alikamen a mang-edit ti `Markdown` (ngem saanmo a mabalin ti manginayon wenno mangikkat kadagiti parapo), ken agusar ti kaaduan a pamiliar a wagas a mangaramid ti panagtengngel ti bersion.
...
[I-klik ditoy tapno autorisaran ken automatiko i18n.site suroten ti github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ken **umawat iti bonus $50** .
...
Daytoy a website ket naaramid a naibatay iti daytoy a balangkas ken mairaman ti agar-aramat, panagbayad ken dagiti dadduma pay a panagandar ( [taudan a kodigo](/i18n.site/src) ket maisuratto inton agangay.

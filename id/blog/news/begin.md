...
Terjemahan dapat diedit; memodifikasi teks asli, dan ketika diterjemahkan lagi dengan mesin, modifikasi manual pada terjemahan tidak akan ditimpa (jika paragraf teks asli ini belum diubah).
...
Alat manajemen terjemahan yang ada terlalu berat. Bagi pemrogram yang mengandalkan manajemen versi `git` , mereka masih lebih memilih baris perintah.

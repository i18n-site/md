...
1. Mendukung pencarian awalan, yang dapat menampilkan hasil pencarian secara real time saat pengguna mengetik.
1. Tersedia offline
...
Fungsi anti-guncangan `debounce` juga digunakan dalam interaksi front-end (diimplementasikan sebagai berikut) untuk mengurangi frekuensi input pengguna yang memicu pencarian dan mengurangi jumlah perhitungan.

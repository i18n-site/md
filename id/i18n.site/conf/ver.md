...
Angka `v` yang kosong tidak akan ditampilkan di garis besar sidebar, tetapi selama ada file `v` , indeks independen akan dibuat untuk file di direktori dan subdirektori.

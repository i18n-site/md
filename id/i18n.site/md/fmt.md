...
Solusi titik jangkar yang disetujui dengan `i18n.site` adalah memasukkan teks yang mirip dengan `<a rel=id href="#xxx" id="xxx"></a>` in `MarkDown` untuk membuat titik jangkar posisi secara manual.

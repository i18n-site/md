...
Kami menggunakan [vscode](https://code.visualstudio.com/) untuk menulis `MarkDown` , dan juga menginstal plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) untuk melihat pratinjau secara real time saat menulis.

<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Solusi internasional<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Deskripsi Proyek
...
Terjemahkan `Markdown` dan `YAML` ke dalam alat baris perintah ( [kode sumber](https://github.com/i18n-site/rust/tree/main/i18) ) dalam berbagai bahasa.
...
Kami berbagi " `UNIX` adalah File " dan dapat mengelola terjemahan dalam ratusan bahasa tanpa memperkenalkan solusi tingkat perusahaan yang rumit dan rumit.

Anda dapat menggunakan alat yang paling familiar untuk `Markdown` terjemahan (tetapi Anda tidak dapat menambah atau menghapus paragraf), dan menggunakan cara yang paling familiar untuk melakukan kontrol versi.

Basis kode dapat dibuat sebagai sumber terbuka untuk file bahasa, dan dengan bantuan proses `Pull Request` , pengguna global dapat berpartisipasi dalam optimalisasi terjemahan yang berkelanjutan. Koneksi mulus [github](//github.com) Dan komunitas sumber terbuka lainnya.
...
Murni statis, dioptimalkan untuk pengalaman membaca, dan terintegrasi dengan terjemahan [i18](#i18) ini adalah pilihan terbaik untuk membangun situs dokumen proyek.
...
Situs web ini dikembangkan berdasarkan kerangka kerja ini dan mencakup fungsi pengguna, pembayaran, dan lainnya ( [kode sumber](/i18n.site/src) ). Tutorial terperinci akan ditulis nanti.

[→ Untuk panduan pengguna, silakan baca dokumentasi proyek](/i18n.site) .

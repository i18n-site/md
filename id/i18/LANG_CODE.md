...
| 1 | `zh` | Cina disederhanakan | `简体中文` |
| 2 | `de` | Jerman | `Deutsch` |
| 3 | `fr` | Perancis | `Français` |
| 4 | `es` | Orang Spanyol | `Español` |
...
| 11 | `tr` | Turki | `Türkçe` |
| 12 | `sv` | Orang Swedia | `Svenska` |
| 13 | `cs` | Ceko | `Čeština` |
| 14 | `uk` | Orang Ukraina | `Українська` |
| 15 | `hu` | Hongaria | `Magyar` |
| 16 | `id` | bahasa Indonesia | `Indonesia` |
| 17 | `ko` | Korea | `한국어` |
| 18 | `ro` | Rumania | `Română` |
| 19 | `no` | Norwegia | `Norsk` |
| 20 | `sk` | Orang Slovakia | `Slovenčina` |
| 21 | `fi` | Finlandia | `Suomi` |
| 22 | `ar` | Arab | `العربية` |
| 23 | `ca` | Katalan | `Català` |
| 24 | `da` | Orang Denmark | `Dansk` |
| 25 | `fa` | Orang Persia | `فارسی` |
| 26 | `vi` | Orang Vietnam | `Tiếng Việt` |
| 27 | `lt` | Lithuania | `Lietuvių` |
| 28 | `hr` | Kroasia | `Hrvatski` |
| 29 | `he` | Ibrani | `עברית` |
| 30 | `sl` | bahasa Slovenia | `Slovenščina` |
| 31 | `sr` | Orang Serbia | `српски језик` |

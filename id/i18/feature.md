...
## Dapat Dikombinasikan Dengan Lebih Dari `i18n.site` Bahasa Untuk Membangun Sebuah Website
...
Klien sepenuhnya open source, dan sisi server 90 % [kodenya](/i18n.site/src) adalah open source.

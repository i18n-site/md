...
windows Sistem, silakan [klik di sini untuk mengunduh dan menginstal `git bash`](https://git-scm.com/download/win) terlebih dahulu.
...
Silakan merujuk ke proyek [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) untuk mempelajari konfigurasi `i18` terjemahan.
...
Diantaranya, isi `.i18n/cache/.gitignore` adalah sebagai berikut :
...
Artinya semua file di direktori `.i18n/cache/` (kecuali `.i18n/cache/.gitignore` ) diabaikan.

Jika perangkat lunak kontrol versi Anda bukan `git` , abaikan saja sesuai dengan konfigurasi ini.
...
Dalam tabel konfigurasi ini, bahasa sumber terjemahan katalog `blog` adalah `zh` , dan bahasa sumber terjemahan `blog/your_file_name.md` adalah `ja` .

...
នៅក្នុងការកំណត់រចនាសម្ព័ន្ធ សូមប្តូរ `i18n.site` ទៅតម្លៃនៃ `host:` ក្នុង `.i18n/htm/ol.yml` ហាងលក់វត្ថុជាច្រើនអាចត្រូវបានកំណត់រចនាសម្ព័ន្ធក្រោម `s3` ហើយវាល `region` គឺស្រេចចិត្ត (ហាងលក់វត្ថុជាច្រើនមិនចាំបាច់កំណត់វាលនេះទេ)។
...
ដោយសារតែ `R2` `cloudflare` ចូលប្រើបានដោយឈ្មោះដែនដែលបានប្ដូរតាមបំណងនោះ កន្លែងផ្ទុកវត្ថុភាគីទីបីចាំបាច់ត្រូវប្រើដើម្បីដាក់ឯកសារឋិតិវន្ត។

នេះជាឧទាហរណ៍ [backblaze.com](https://www.backblaze.com) ដើម្បីបង្ហាញពីរបៀបចងវត្ថុភាគីទីបីដើម្បីរក្សាទុកនៅ `cloudflare` ។

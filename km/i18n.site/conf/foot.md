...
សូមយោងទៅខាងក្រោម រចនាប័ទ្មត្រូវបានសរសេរក្នុង `.css` ដែលត្រូវគ្នា ហើយអន្តរកម្មត្រូវបានសម្រេចដោយការបង្កើតសមាសធាតុគេហទំព័រ។
...
* `foot.css` :
* `import.css` : 1 រចនាប័ទ្ម `i18n.site` សម្រាប់គេហទំព័រទាំងមូល
...
ការបន្ថែម `class="a"` ទៅក្នុងតំណគឺដើម្បីការពារតំណពីការបំប្លែងទៅជា `MarkDown` សូមមើល :
 [➔ `YAML` : វិធីការពារតំណ `HTML` ពីការបំប្លែងទៅជា `Markdown`](/i18/qa#H2) ។
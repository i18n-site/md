...
កែសម្រួល `md/.i18n/htm/ol.yml` និងប្តូរតម្លៃពី [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` ជាឈ្មោះកញ្ចប់ `npm` ផ្ទាល់ខ្លួនរបស់អ្នកនឹង [npmjs.com](//npmjs.com) ។

បន្ទាប់មកកែប្រែ `md/.i18n/htm/ol.package.json`

...
នៅពេលបោះពុម្ពមាតិកានៅក្នុងអត្ថបទមុន `out/ol/htm` ត្រូវបានបង្កើត សូមបញ្ចូលថតនេះ ហើយដំណើរការ :
...
សូមបន្ថែមការកំណត់រចនាសម្ព័ន្ធដូច `/root/i18n/md/out/ol/htm` ក្នុង `out/ol/htm` `server` នៃ nginx

...
គាំទ្រការកំណត់រចនាសម្ព័ន្ធបឋមកថា [HOGO](https://github.com/gohugoio/hugo) វាយប្លុកឋិតិវន្ត ដែលបកប្រែតែវាល `title` `summary` និង `description`
...
ការបកប្រែខាងលើទៅជាភាសាបារាំង (ក៏សរសេរឈ្មោះត្រឹមត្រូវ និងបន្ថែមលេខសេស `... ` ) DeepL
...
`i18` ត្រូវបានបញ្ចូលទៅក្នុងឧបករណ៍បន្ទាត់ពាក្យបញ្ជាបង្កើតគេហទំព័រ [`i18n.site`](/i18n.site) ភាសា។

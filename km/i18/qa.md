...
សូមចាំថា **ចំនួនបន្ទាត់នៅក្នុងការបកប្រែត្រូវតែត្រូវគ្នានឹងបន្ទាត់នៅក្នុងអត្ថបទដើម** ។
...
ប្រសិនបើអ្នកបន្ថែម ឬលុបបន្ទាត់ដោយចៃដន្យ ដែលបណ្តាលឱ្យមានការភ័ន្តច្រឡំ សូមស្ដារការបកប្រែទៅជាកំណែមុននឹងការកែប្រែ ដំណើរការការបកប្រែ `i18` ម្តងទៀត ហើយដាក់ឃ្លាំងសម្ងាត់ឡើងវិញនូវផែនទីត្រឹមត្រូវ។
...
ពេលខ្លះការបម្លែងពី `HTML` → `MarkDown` មិនមែនជាអ្វីដែលយើងចង់បានដូចជា `<a href="/">Home</a>` ត្រូវបានបំប្លែងទៅ `[Home](/)` ។

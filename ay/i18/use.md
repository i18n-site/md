...
Kunayman `fromTo` / subdirectorios ukanakatakix wakicht’asispawa Mä uñacht’äwix akham qillqt’atawa :
...
Aka configuración tabla ukanx `blog` directorio jaqukipañatakix phuqhat arupax `zh` ukhamawa, ukatx `blog/your_file_name.md` directorio jaqukipañatakix phuqhat arupax `ja` ukhamawa.

### Archiwu Jan Yäqaña

Ukhamarusa, taqi qillqatanakaxa `.md` ukatxa `.yml` ukampi qalltatawa, ukaxa phuqhawi aru qillqantayañatakixa jaqukipatawa.

Yaqhip qillqatanakar jan yäqañ munsta ukat jan jaqukipañ munsta ukhaxa (jan tukuyat borradoranakjama), `ignore` yapu configuración ukampiw apnaqasispa.
...
Kamachi chimpu lurawixa taqi qillqatanaka `.yml` ukampi tukuyata jikxatañatakixa, phuqhata aru qillqañ utanxa, ukatxa jaqukipatarakiniwa.

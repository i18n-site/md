...
Jaqukipäwix kamachinak qillqt’asaw lurasiñapa ukatx mä clic ukampiw tukuyañapa.
...
Mä machaq generación de tecnología de traducción ukaw lurasiwayi, ukax ventajas técnicas de modelos tradicionales de traducción de máquinas ukat jach’a modelos de lenguas ukanakamp mayachthapitawa, ukhamat jaqukipäwinak chiqaparu, suma ukat suma uñt’ayañataki.
...
[Aka tuqir ch'iqt'am autorizacion ukat github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ukat **bono $50 katuqañataki** !
...
## Yanapt’awi Jaqukipaña `HOGO` P’iqinchawi Wakicht’awi
...
China, Japón ukat Corea markanakax janiw jachʼa qillqanakanïpkiti, jiskʼa qillqanakas janiw utjkiti, ukampis inglés arut sutinak uñtʼayañatakix jachʼa jachʼa tukuñampiw nayrïr letranak qillqtʼasiñapa.
...
Japonés arut `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Francés arut `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Japonés arut `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Amuyt’añataki: `C罗` `Cristiano Ronaldo` ukham jaqukipatawa.

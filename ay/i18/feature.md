# Producto Ukan Uñacht’äwinakapa
...
Markdown in mixed HTML `<pre>` `<code>` HTML `MarkDown`
...
Jaqukipañ amuyunakax uka qhipat aru uñacht'ayañawa ` ``` ` ` ```rust ` :

Jichhax `toml` , `yaml` , `json5` , `go` , `rust` , `c` , `cpp` `java` `js` `coffee` `python` , `bash` , `php` [ukat yaqha arunakan](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) aruskipäwinak jaqukipañ yanapt’i.
...
Jaqukipañ qillqatanaka apnaqañatakix walja [jach’a herramientas](https://www.capterra.com/translation-management-software) ukanakaw utji.

Programadores `vscode` `vim` `git`
...
Ukhamaraki yaqhipa kamachi jaqukipaña yänakaxa utjarakiwa, sañäni [translate-shell](https://github.com/soimort/translate-shell)
...
Nayra qillqata mayjt’ayaña ukatxa mayampi maquina-jaqukipaña, jaqukipaña amparampi mayjt’ayañaxa janiwa qillqantatäkaniti (nayriri qillqatan aka t’aqapaxa jani mayjt’ayatäkchi ukhaxa).

## Xindaya Ukax Wali Suma Jaqukipatawa
...
`3.15` suma `2.67` , Google Translate ukatxa `ChatGPT`
...
Qhanacht’awi: Jakhuwi facturable chimpunaka = [unicode](https://en.wikipedia.org/wiki/Unicode) phuqhata qillqatanxa × jakhuwi arunaka jaqukipata

## ¡Jaqukipañ Yanapt'aña `YAML`

Herramienta ukax `YAML`

`YAML`

## Jaqukipaña Yanapt’aña `HOGO`
...
China, Japón ukat Corea markanakax janiw jachʼa qillqanakanïpkiti, janirakiw jiskʼa qillqanakanïpkiti, ukampis inglés arun sutinakapax nayrïr letraruw jachʼa qillqat qillqtʼapxi.
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` arut jaqukipata :
...
Inglés arumpi chino, japonés ukat coreano qillqatanakampi jan ukax inglés arun largopax 1 ukjat juk’ampïki ukhakiw uka arux mä arurjam uñjatäni.

Amuyt’añataki `Cristiano Ronaldo` `C罗`

## `i18n.site` Walja Arunakan Sitio Web Ukan Lurawipa

`i18` [`i18n.site`](/i18n.site)

Uñakipt’añatakix documentación de [`i18n.site`](/i18n.site)

## Codigo Jist’arat Qullqi

Clientex taqpach jist’aratawa, ukatx servidor lado 90 ukax [codigo](/i18n.site/src) jist’aratawa.
...
Jumatix munassta ukhax [→ Aka tuqir ch’iqt’am perfil phuqhantañataki](https://ggl.link/i18n) ukatx [lista de correo](https://groups.google.com/u/2/g/i18n-site) ukar mantañamawa aruskipt’añataki.
...
Ukhamarakiw jiwasan cuentas sociales ukar arktañax / [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) [X.COM: @i18nSite](https://x.com/i18nSite)

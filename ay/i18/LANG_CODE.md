...
| 30 | `sl` | esloveno sat jaqi | `Slovenščina` |
| 31 | `sr` | Serbio aru | `српски језик` |
| 32 | `eo` | Esperanto aru | `Esperanto` |
| 33 | `el` | Griego arunjja | `Ελληνικά` |
| 34 | `et` | Estonia markankir jaqe | `Eesti` |
...
| 42 | `gl` | Galicia aru uñt’ayaña | `Galego` |
...
| 50 | `ka` | Georgia markankir jaqewa | `ქართული` |
...
| 90 | `hmn` | Hmong | `Hmong` |
| 91 | `ig` | Igbo markankir jaqinakawa | `Ásụ̀sụ́ Ìgbò` |
| 92 | `ilo` | llocano | `Iloko` |
| 93 | `kk` | Kazaj arunxa | `Қазақ Тілі` |
| 94 | `km` | Camboya markankir jaqi | `ខ្មែរ` |
...
| 103 | `mt` | maltesa ukat juk’ampinaka | `Malti` |
| 104 | `mn` | Mongol markankir jaqinakawa | `монгол` |
| 105 | `my` | Birmania markankir jaqinaka | `မြန်မာ` |
| 106 | `ny` | Nyanza (Chichewa) ukat juk’ampinaka. | `ChiCheŵa` |

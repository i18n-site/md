...
Mä `YAML` chimpuxa `MarkDown` ukhamawa jaqukipañataki.

Awisax `HTML` → `MarkDown` uksat jaqukipañax janiw kunjamtix munktan ukhamäkiti, sañäni, `<a href="/">Home</a>` `[Home](/)` ukjaruw jaqukipata.

`href` ukat sipan yaqha atributo `a` ukar yapxatañaxa, kunjamatix `<a class="A" href="/">Home</a>` , ukax uka jaqukipäwit jark’aqasispawa.

...
Uka versión histórica ukax `npm` paquete ukan apsutawa `.i18n/v/ol/v.hash` ukan imatäxiwa.

Ukax jan amuyt’asisaw `.i18n/v/ol` chhaqtayatäni, paquete `npm` ukax janiw mistkaniti.

`0.1.9` pachanxa, nayraqatax [npmjs.com](//npmjs.com)

...
Amuyt’añataki, `.i18n/htm/ol.yml` ukax `out/ol` directorio uñstayañapawa.
...
Uñt’ayañatakix mä sarantañ mayacht’asiñ pacha apnaqañamawa, janiw `nodejs` ukar uñstayañax wakiskiti, jan ukasti, mantat ukat uñt’ayañ permiso `~/.npmrc` ukax pachamamaruw copiaña.

Ukax `v:` ukan `ol.yml` ukan paquete sutip mayjt’ayatäni ukhaxa, **nayraqat `.i18n/v/ol` chhaqtayañaw wakisi** , ukatx uñt’ayañaw wakisi.
...
Uka contenido ukar auto-host lurañ munsta ukhax nayraqatax `md/.i18n/htm/ol.yml` ukar editar ukat `v: //unpkg.com/i18n.site` ukar URL prefijo ukar mayjt’ayaña, kunjamatix `v: //i18n-v.xxx.com` .
...
Nayra qillqatan qillqatanakap uñt’ayasaxa, `out/ol/htm` ukaw utji Aka directorio ukar mantam ukat :
...
Yaqha tama almacén ukarux lint’sta ukhaxa, `Add Account` pä kutiw ch’iqt’añama, pä kuti autorizañatakix janïr machaq tama uñacht’ayañkama.
...
Mä configuración ukar uñtasit `server` `out/ol/htm` nginx `/root/i18n/md/out/ol/htm`

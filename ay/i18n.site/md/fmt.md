...
`<a rel=id href="#xxx" id="xxx"></a>` , aka `rel=id` ukax ancla punto ukan panka estilo ukar qhanañchi, `xxx` chiqpach ancla inglés abreviatura ukamp lantintañamawa.
...
`HTML` ukax `pug` codigo ukan uñt’ayatarakispawa.
...
¡Uka phuqhawi uñakipt’apxasmawa [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) uka chimpuxa akhamawa :

...
Wali proyecto demostración ukax mä uñacht’äwiwa, `.i18n/htm/foot.pug` directorio `md` ukanx sitio web ukan ch’iqap uñt’ayi.
...
**Janiw `css` ukat `js` ukanak `foot.pug` ukan qillqt’añati** , jan ukhamäkanixa, pantjasiwiw utjani.

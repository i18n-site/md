...
Mä demostración qillqatax akham wakicht’atawa:
...
Qillqirin yatiyawipax qillqatan meta-información ukan qillqt’asispawa, sañäni:

```yml
author: marlowe
```

Ukatx `author.yml` ukx phuqhat arunak uñt’ayañ utarux chiqañchañamawa ukatx qillqirin yatiyawinakap yapxatañamawa, sañäni :

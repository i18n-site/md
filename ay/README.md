...
Mä kamachi chimpu ( [código fuente](https://github.com/i18n-site/rust/tree/main/i18) ) ukax `Markdown` ukat `YAML` walja arunakar jaqukipi.
...
Mä base de código ukax mä abierto código ukhamaw arut arsuwinakatak lurasispa, ukatx `Pull Request` procesos ukan yanapt’apampiw uraqpachan apnaqirinakax jaqukipäwinak sarantañ optimización ukan chikancht’asipxaspa. ¡Jan ch’axwañamp chikt’atäña [github](//github.com)
...
Puramente estático, experiencia de lectura ukarjam suma wakicht’ata [i18](#i18) jaqukipäwimp mayachata, ukax mä proyecto documento ukan sitio lurañatakix wali askiwa.
...
> Jupanakax sapxänwa: Jutapxam, mä torre lurapxam, ukax alaxpachar puriñkamaw purini ukat jaqir uñt’ayapxam.
>
...
Pä arut aruskipäwinak ukhamarak salas de chat ukanakar yanapt’i;

...
La traducció és editable. Modifiqueu el text original i torneu a traduir-lo automàticament, les modificacions manuals a la traducció no se sobreescriuran (si aquest paràgraf del text original no s'ha modificat).

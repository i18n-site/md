...
windows Sistema, [feu clic aquí per descarregar i instal·lar `git bash`](https://git-scm.com/download/win) primer.
...
Consulteu el projecte de demostració per conèixer la configuració de la traducció `i18` [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18)
...
En aquesta taula de configuració, l'idioma font de la traducció del catàleg `blog` és `zh` i l'idioma font de la traducció `blog/your_file_name.md` és `ja` .
...
`ignore` utilitza la mateixa [globset](https://docs.rs/globset/latest/globset/#syntax) que el fitxer `.gitignore` .

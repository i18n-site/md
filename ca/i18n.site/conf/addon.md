...
* `lang_li` : Llista d'idiomes, el primer idioma és l'idioma d'origen
...
* `rTxt(path)` : Llegir fitxer de text
* `rBin(path)` : Llegir el fitxer binari
* `rDir(dirpath)` Llegiu el directori, el valor de retorn és una llista : , llista : fitxers

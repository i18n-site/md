...
Creeu un cub a `backblaze.com` , carregueu qualsevol fitxer, feu clic per navegar pel fitxer i obteniu el nom de domini `Friendly URL` , que és `f003.backblazeb2.com` aquí.

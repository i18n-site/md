...
A continuació, creeu l'script al [EdgeJS Edge](//console.bce.baidu.com/cdn/#/cdn/ejs/list) de la manera següent
...
Feu clic `Debug` i, a continuació, feu clic a Publica a tota la xarxa.
...
En primer lloc, enllaça un nom de domini arbitrari a `cloudflare` i després utilitza `SSL/TLS` → nom de domini personalitzat per associar el nom de domini principal a aquest nom de domini.

![](https://p.3ti.site/1725438658.avif)

### No Es Pot Accedir `cloudflare R2` Mitjançant Un Nom De Domini Personalitzat

Com que `cloudflare` es pot accedir `R2` mitjançant un nom de domini personalitzat, cal utilitzar un emmagatzematge d'objectes de tercers per col·locar fitxers estàtics.

Aquí [backblaze.com](https://www.backblaze.com) com a exemple per demostrar com vincular objectes de tercers per emmagatzemar-los a `cloudflare` .

...
Si necessiteu fixar l'article a la part superior, executeu `i18n.site` i editeu els `xxx.yml` fitxers per sota d' `.i18n/data/blog` i canvieu la marca de temps a un nombre negatiu (s'ordenaran diversos números negatius de petit a gran en valor absolut).
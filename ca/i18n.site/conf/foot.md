...
La icona de peu de pàgina es genera creant un tipus `F` iconfont.cn [versió en anglès](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

Creeu el vostre propi tipus de lletra d'icona segons sigui necessari i substituïu la configuració següent per `conf.css` :

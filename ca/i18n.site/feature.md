...
El programa té `i18` traducció integrada, consulteu [➔ `i18` document](/i18) per a un ús específic.
...
La imatge de dalt mostra la [inoreader.com](//inoreader.com) `i18n.site` en diversos `RSS` .
...
Hi ha molts requisits petits que són importants però no urgents. L'equip de desenvolupament assignarà tasques pràctiques en funció de les tecnologies en les quals us conegueu i millorarà els documents de desenvolupament mentre assigna els requisits.
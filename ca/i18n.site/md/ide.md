...
Utilitzem [vscode](https://code.visualstudio.com/) per escriure `MarkDown` , i també instal·lem el connector [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) per previsualitzar en temps real mentre escrivim.

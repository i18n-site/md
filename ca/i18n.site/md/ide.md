...
Utilitzeu [PicList](https://github.com/Kuingsmile/PicList) per pujar imatges, recordeu configurar la tecla de drecera de pujada i carregar la captura de pantalla amb un sol clic.

...
`<a rel=id href="#xxx" id="xxx"></a>` , aquí `rel=id` defineix l'estil de pàgina del punt d'ancoratge, substituïu `xxx` per la vostra abreviatura anglesa d'ancoratge real.

...
La traducció és editable; modifiqueu el text original, i quan es torni a traduir automàticament, les modificacions manuals a la traducció no es sobreescriuran (si aquest paràgraf del text original no s'ha modificat).
...
Els [codis de front-end, back-end i línia d'ordres són tots de codi obert](https://i18n.site/i18n.site/c/src) (el model de traducció encara no és de codi obert).

<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Solucions internacionals<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Descripció del Projecte

Aquest lloc ofereix actualment dues eines de línia d'ordres de codi obert:

* [i18 : MarkDown de traducció de la línia d'ordres](/i18/feature)
* [Generador de llocs web estàtics i18n.site : diversos idiomes](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: eina de traducció de línia d'ordres MarkDown

Tradueix `Markdown` i `YAML` a una eina de línia d'ordres ( [codi font](https://github.com/i18n-site/rust/tree/main/i18) ) en diversos idiomes.
...
Compartim " filosofia `UNIX` Everything is a File " i podem gestionar traduccions en centenars d'idiomes sense introduir solucions complexes i feixugues a nivell empresarial.

Podeu utilitzar les eines més familiars per `Markdown` la traducció (però no podeu afegir ni suprimir paràgrafs) i utilitzar la manera més familiar de fer el control de versions.

Es pot crear una base de codi com a codi obert per a fitxers d'idiomes i, amb l'ajuda del procés de `Pull Request` , els usuaris globals poden participar en l'optimització contínua de les traduccions. Connexió [github](//github.com) i altres comunitats de codi obert.
...
Purament estàtic, optimitzat per a l'experiència de lectura i integrat amb la traducció de [i18](#i18) és la millor opció per crear un lloc de document de projecte.
...
Aquest lloc web es desenvolupa a partir d'aquest marc i inclou funcions d'usuari, pagament i altres ( [codi font](/i18n.site/src) ).

[→ Per a la guia de l'usuari, llegiu la documentació del projecte](/i18n.site) .
...
>
> El Senyor va veure això i va dir: "Tots els éssers humans tenen la mateixa llengua i la mateixa raça. Ara que això s'ha fet, tot es farà".
>
...
Un mercat de vendes de components front-end internacionals;

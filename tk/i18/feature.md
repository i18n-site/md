...
Garyşyk Markdown terjimesini goldaýar, HTML `MarkDown` -da ýerleşdirilen `<pre>` we `<code>` belliklerdäki mazmun terjime edilmeýär HTML
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` diline terjime edildi :

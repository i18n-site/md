...
`i18n.site` taslamany boş bukjadan başlasaňyz, demo taslamasyny `.i18n` bukjanyňyza göçürmegi ýatdan çykarmaň.
...
Belli bir ýol üçin girmek üçin, ýol prefiksi `nav:` -da düzülmedik bolsa, ýol bilen baglanyşykly `MarkDown` faýl deslapky görnüşde ýüklener we `Md` şablon arkaly görkeziler.

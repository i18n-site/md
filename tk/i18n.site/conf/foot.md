...
Aşakdaky ýazgy belgisi iconfont.cn atly şrift döretmek arkaly döredilýär ( [Iňlis wersiýasy](https://www.iconfont.cn/?lang=en-us) /[中文](https://www.iconfont.cn/?lang=zh)`F` ).
...
Bu ýerde `${I18N.C}` `en/i18n.yml` gabat gelýär :
...
Baglanyşyga `class="a"` goşmak, baglanyşygyň `MarkDown` e öwrülmeginiň öňüni almakdyr! Serediň :
 [➔ `YAML` : `HTML` baglanyşygyň `Markdown` öwrülmeginiň öňüni nädip almaly](/i18/qa#H2) ?
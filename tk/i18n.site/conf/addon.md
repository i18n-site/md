...
* : täsiri `i18n.addon/mouse`

## Faýlyň Ady Konwensiýasy

Plug-insleriň hemmesi `npm` paket.

Aboveokardaky `i18n.addon/toc` gabat gelýän paket [https://www.npmjs.com/package/@i18n.addon/toc](https://www.npmjs.com/package/@i18n.addon/toc)
...
* `lang_li` : sanawy, ilkinji dil çeşme dili
...
Gurlan `js` iş wagty ikinji derejeli ösüşe esaslanýar we gurlan funksiýalar aşakdaky ýaly : [boa](https://github.com/boa-dev/boa)

* `wPath(path, txt)` Faýl ýazyň :
* `rTxt(path)` okaň Tekst faýlyny okaň :
* `rBin(path)` ikilik faýly okaň :
* `rDir(dirpath)` okaň : katalogy okaň, gaýtarma bahasy : sanawy, faýl sanawy

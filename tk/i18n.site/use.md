...
Neşir etmek üçin üznüksiz integrasiýa gurşawyny ulanýan bolsaňyz, `nodejs` gurmagyň zerurlygy ýok, diňe sessiýa açyň we `~/.npmrc` rugsady daşky gurşawa göçüriň.
...
Domenörite domen adyny baglanyşdyranyňyzdan soň, aşakda görkezilişi ýaly bir sahypalyk programmanyň ýol täzeden ýazylmagyny düzmek üçin domen adyna giriň:
...
Soň bolsa, `out/ol/htm` materiginde bulut satyjylarynyň obýekt saklanyşyny ulanyň `CDN` Aşakdaky mazmuny ýerleşdiriň +
...
Aşakdakylara meňzeş konfigurasiýa goşuň! `server` abzasda nginx `/root/i18n/md/out/ol/htm` öz `out/ol/htm` ýoluna üýtgediň:

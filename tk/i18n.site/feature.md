...
Web sahypasynyň deslapky dili brauzeriň diline awtomatiki gabat gelýär.
...
Principleörelge: haýyşlary [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) bilen saklamak, beýleki `CDN` lerde şowsuz haýyşlary gaýtadan synap görmek we iň çalt seslenýän sahypany deslapky ýükleme çeşmesi hökmünde uýgunlaşdyrmak.
...
Düzgüne görä [, Alimama goşa okly üýtgeýän gönüburçly](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) şriftler [MiSans](https://hyperos.mi.com/font/zh/download/) we beýleki onlaýn şriftler web sahypasynda ulanyjylaryň dürli platformalarda okamak tejribesini birleşdirmek üçin açykdyr.

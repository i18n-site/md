...
Terjime redaktirläp bolýar, asyl teksti üýtgedýär we maşyn täzeden terjime edilende, terjime bilen elde üýtgetmeler ýazylmaz (asyl tekstiň bu abzasy üýtgedilmedik bolsa).
...
Şeýlelik bilen, `i18` terjime guralyny taýýarladym we terjime guralyna esaslanýan köp dilli statiki saýt `i18n.site` gurdum.
...
Öň [svelte](https://svelte.dev) , [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
Buýruk setiri [js boa_engine](https://docs.rs/boa_engine) , [içerki maglumat bazasy fjall](https://github.com/fjall-rs/fjall) .

serwer [contabo](https://my.contabo.com) VPS

maglumat [kvrocks](https://kvrocks.apache.org) , [mariadb](https://mariadb.org) .

Özbaşdak gurlan poçta iberiň SMTP [chasquid](https://github.com/albertito/chasquid)

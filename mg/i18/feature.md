...
Manohana ny fandikana ny mixed HTML , ny atiny ao amin'ny marika `<pre>` sy `<code>` amin'ny HTML tafiditra ao amin'ny `MarkDown` dia tsy Markdown

## Mahay Mahafantatra Raikipohy Matematika Sy Mandingana Ny Fandikana
...
Ny fanamarihana fandikan-teny dia mila manondro ny fiteny aorian'ny ` ``` ` , toy ` ```rust ` :
...
## Tsy Misy Fanovana, Tsy Misy Fandikan-Teny
...
Ny sandan'ny rakibolana amin'ny `YAML` ihany no mandika ny fitaovana fa tsy ny fanalahidin'ny rakibolana.
...
## Tohano Ny Dikanteny `HOGO` Tefi-Dohateny

Manohana ny fandrindrana lohapejy amin'ny blôgy static karazana [HOGO](https://github.com/gohugoio/hugo) , izay tsy mandika afa-tsy saha `title` , `summary` ary `description` .

## Aza Mandika Anarana Miovaova

`Markdown` dia ampiasaina ho môdely mailaka, `YAML` dia ampiasaina ho fichier fichier fiteny, ary hisy masontsivana miovaova (ohatra: recharge `${amount}` no voaray).
...
Raha mampiasa Google na DeepL ianao, dia samy mandika teny anglisy tsy araka ny tokony ho izy izy ireo fa tokony hijanona ho tany am-boalohany (alaivo ohatra ny Japoney sy Frantsay).

### Dikanteny Google

Nadika tamin'ny teny `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Nadika tamin'ny teny `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Nadika tamin'ny teny `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Loharano misokatra tanteraka ny mpanjifa, ary loharano misokatra ny lafiny [mpizara](/i18n.site/src) 90

...
`<a rel=id href="#xxx" id="xxx"></a>` , eto `rel=id` dia mamaritra ny endriky ny pejin'ny teboka vatofantsika, azafady soloy `xxx` amin'ny fanafohezanao tena amin'ny teny anglisy.
...
Mariho fa ny `<style>` dia voafaritra ao amin'ny `<pre>` etsy ambony.
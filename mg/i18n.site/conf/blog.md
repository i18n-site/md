...
Ny fampahalalam-baovao meta dia tsy maintsy eo am-piandohan'ny rakitra, manomboka amin'ny `---` ary mifarana amin'ny `---` Ny endriky ny fampahalalam-baovao eo afovoany dia `YAML` .

Ny rakitra demo dia namboarina toy izao manaraka izao:
...
Ny lahatsoratra tsy misy fampahafantarana meta dia tsy hiseho ao amin'ny pejin'ny bilaogy, fa mety hiseho amin'ny hazo lahatahiry eo ankavanana.

## Fampahafantarana Ny Mpanoratra

Ny fampahalalana momba ny mpanoratra dia azo soratana ao amin'ny meta-information ny lahatsoratra, toy ny:
...
`name` , `url` ary `title` dia azo atao avokoa. Raha toa ka tsy napetraka `name` dia ny anarana fanalahidy (eto `marlowe` ) dia ampiasaina ho `name` .

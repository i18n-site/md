...
Ohatra, [ny Huawei Cloud DNS](https://www.huaweicloud.com) dia manome famakafakana isam-paritra maimaim-poana, izay ahafahan'ny fifamoivoizana Shinoa mandeha amin'ny Baidu Smart Cloud, ary ny fifamoivoizana iraisam-pirenena dia afaka mandalo `cloudflare` .
...
Ovao `cloudflare` amin'ny `SSL` → fomba fanafenana, atao `Full`

![](//p.3ti.site/1725438572.avif)

Ampio ny fitsipika fiovam-po araka ny aseho eto ambany, ataovy aloha (ny voalohany dia manana laharam-pahamehana ambany indrindra):

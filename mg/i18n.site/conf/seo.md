...
Toy izao ny kaody fitsipika, ovao azafady ny kaody "i18n.site" amin'ny anaran'ny sehatra misy anao:
...
Avy eo mamorona ny script ao amin'ny [EdgeJS edge](//console.bce.baidu.com/cdn/#/cdn/ejs/list) toy izao manaraka izao
...
Satria `cloudflare` idirana amin'ny anaran'ny sehatra `R2` , dia mila ampiasaina ny fitahirizana zavatra hafa mba hametrahana rakitra static.

Raisintsika ho ohatra ny fomba famatorana ireo zavatra hafa hotehirizina ao amin'ny `cloudflare` [backblaze.com](https://www.backblaze.com)
...
Amboary ny `cloudflare` amin'ny `SSL` → fomba fanafenana, atao `Full`

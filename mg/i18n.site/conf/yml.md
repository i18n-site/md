...
### `use: Toc` , Môdely Rakitra Tokana Misy Drafitra
...
### `use: Doc` , Môdely Antontan-Taratasy Maromaro
...
Ny fomba fanoratana etsy ambony dia mitovy amin'ny `url: xxx` , ary ny rakitra mifanaraka aminy dia `en/xxx/TOC` .

#### TOC Lisitry Ny Atiny Index

`i18n.site` dia hanatanteraka `js` plug-in `.i18n/hook/after.tran/TOC.js` ao amin'ny trano fanatobiana demo mba hamakiana ny fisie index directory `TOC` mifanaraka amin'ny configuration template `doc` mba hamoronana ny drafitra `json` directory.
...
Ho an'ny lalana iray idirana, raha tsy voarindra ao amin'ny `nav:` ny tovan'ny lalana, ny rakitra `MarkDown` mifanandrify amin'ilay lalana dia hapetraka amin'ny alàlan'ny default ary adika amin'ny alàlan'ny môdely `Md` .

Ohatra, raha `/test` no idirana, ary `nav:` no amboarina tsy misy prefix amin'ity lalana ity, ary ny fiteny fitetezana amin'izao fotoana izao dia anglisy (code `en` ), `/en/test.md` dia hapetraka amin'ny alàlan'ny default ary adika amin'ny alàlan'ny môdely `Md` .

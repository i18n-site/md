...
Azafady, jereo ity manaraka ity, nosoratana ao amin'ny `.css` mifanaraka amin'izany ny fomba, ary vita amin'ny famoronana singa web ny fifandraisana.

## Style Footer

Misy rakitra `css` telo ambanin'ny `md/.i18n/htm` ao amin'ny tetikasa demo.

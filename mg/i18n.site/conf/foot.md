...
Mbola maka ny tetikasa demo ho ohatra, `.i18n/htm/foot.pug` amin'ny lahatahiry `md` dia mamaritra ny tongotry ny tranokala.
...
* `foot.css` :
* `import.css` : `i18n.site` ho an'ny tranokala manontolo
* `conf.css` :

### Endri-Tsoratra Kisary

Ny kisary footer dia noforonina tamin'ny famoronana endri-tsoratra antsoina hoe iconfont.cn ( dikan- `F` [anglisy](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

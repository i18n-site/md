...
Raha mampiasa tontolon'ny fampidirana mitohy ianao mba hamoahana, dia tsy ilaina ny mametraka `nodejs` , kopia fotsiny ny fahazoan-dàlana miditra sy mamoaka `~/.npmrc` amin'ny tontolo iainana.

Raha ovainao ny anaran'ny fonosan'ny `v:` amin'ny `ol.yml` , **azafady mba hofafanao aloha `.i18n/v/ol`** ary avoaka avy eo.
...
Raha te hampiantrano tena ny atiny ianao dia ovay aloha `md/.i18n/htm/ol.yml` ary ovay `v: //unpkg.com/i18n.site` amin'ny tovan'ny URL-nao, toy ny `v: //i18n-v.xxx.com` .
...
Aza hadino ny manitsy `CDN` ka ny fotoana cache amin'ny lalana mifarana amin'ny `/.v` dia `1s` , raha tsy izany dia tsy azo idirana avy hatrany ny atiny vao navoaka.
...
[Kitiho aloha eto github raha te hamorona fikambanana](https://github.com/account/organizations/new?plan=free) Ny anaran'ny fikambanana dia `i18n-demo` ho ohatra.
...
Rehefa namoaka ny votoaty tao amin'ny lahatsoratra teo aloha dia `out/ol/htm` no natsangana azafady, ampidiro ity lahatahiry ity ary mandehana :
...
Mamorona tetikasa ary fehezo ny trano fanatobiana entana `i18n-demo.github.io` etsy ambony.
...
Avy eo, safidio ny trano fanatobiana entana `i18n-demo.github.io` , avy eo tsindrio `Begin setup` , ary ampiasao ny sanda default ho an'ny dingana manaraka.
...
Raha te-hahazo fampandehanana fidirana tsara kokoa amin'ny tontolon'ny tambajotran'ny tanibe Shina ianao, azafady [misoratra anarana anarana sehatra](//beian.aliyun.com) aloha.
...
Azonao atao ny mampiasa informatika edge hanoratana ny lalana hifanaraka amin'ny rindranasa pejy tokana, ohatra, [ny Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) dia azo amboarina toy izao:
...
Raha mampiasa `i18n.site` ianao mba hamoronana tranokala ho tranokalanao lehibe, dia matetika ianao no mila manitsy ny fanodikodinam-pan-domain, izany hoe ny fidirana amin'ny `*.xxx.com` (anisan'izany ny `www.xxx.com` ) mankany `xxx.com` .
...
Ampio ny anaran-tsehatra ao amin'ny [Alibaba CDN](https://cdn.console.aliyun.com/domain/list) ary tondroy ny anaran-tsehatra `*.xxx.com` `CNAME` ao amin'ny Alibaba Cloud `CDN` .
...
Azafady, ampio fika mitovy amin'ity manaraka `out/ol/htm` ao amin'ny `/root/i18n/md/out/ol/htm` `server` amin'ny nginx

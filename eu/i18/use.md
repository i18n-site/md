...
## Windows-Ek Lehenik Instalatu git bash
...
[i18n.site/payBill](//i18n.site/payBill) , kreditu-txartel bat lotu behar duzu ordainketa egiteko (ez da kargatu behar, webguneak automatikoki kenduko ditu kuotak erabileraren arabera, [ikusi hasierako orrialdea prezioak ikusteko](/#price) ).
...
Fitxategi batzuk alde batera utzi eta ez itzuli nahi badituzu (adibidez, amaitu gabeko zirriborroak), `ignore` eremuaren konfigurazioa erabil dezakezu.

`ignore` `.gitignore` fitxategiaren sintaxi [globset](https://docs.rs/globset/latest/globset/#syntax) erabiltzen du.

Adibidez, goiko konfigurazio-fitxategian `_* ` esan nahi du `_` hasten diren fitxategiak ez direla itzuliko.

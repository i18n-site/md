...
[rclone](https://rclone.org) Erabili dezakezu `S3` zerbitzarian saioa hasteko, eta, ondoren, hurrengo script-a jo eta alda dezakezu, eta bertsio inkrementalak `S3` bakarrik kopiatu.
...
Goiko irudiko arauak hauek dira, mesedez, ordezkatu beheko lehen lerroko `i18n.site` a lotu duzun domeinu-izenarekin.

...
`i18n.site` rekin adostutako aingura-puntuaren irtenbidea `MarkDown` `<a rel=id href="#xxx" id="xxx"></a>` en antzeko testua txertatzea da kokapen-aingura-puntua eskuz sortzeko.

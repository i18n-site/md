...
[Egin klik hemen orrialde honen iturburu-fitxategia arakatzeko,](//raw.githubusercontent.com/i18n-site/md/refs/heads/main/$LANG/i18n.site/md/styl.md) hurrengo estiloetan `MarkDown` nola idatzi ikusteko.
...
`i18n.site` webgunea eraikitzeko tresnaren `MarkDown` analizatzaileak azpimarra, marradura eta sintaxia lodia optimizatu ditu. Markaren aurretik eta ondoren zuriunerik gabe eragin dezake, Txinan, Japonian eta Korea bezalako hizkuntzatan dokumentuak idaztea erraztuz. bereizle gisa espazioak erabiltzen ez dituztenak.
...
> Eta zientzia-fikziozko eleberriek Asimov-en "Azken erantzuna" bezalako eleberriek unibertso osoaren, gizakiak barne, milaka milioi urteko historia bizi-bizi deskribatzen dute milaka hitz gutxitan.
...
> [!WARN]
> Abentura basati batera joatean, garrantzitsua da seguru egotea.
> Joan den astean, eskalatzaile talde batek ekaitz batekin topo egin zuen mendiaren erdian eta ebakuatu behar izan zuten eguraldi iragarpena egiaztatu ez zutelako.
> Gogoratu, kanpoko edozein jarduerak behar bezala prestatzea eta eguraldiarekiko arreta behar duela.
...
* ekitaldi sozialak
  - Industria truke-bileretan parte hartu
    ...
    + Ekintzailetza trukatzeko topaketa

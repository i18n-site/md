...
[vscode](https://code.visualstudio.com/) idazteko erabiltzen dugu, eta [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) plugina instalatzen `MarkDown` idazten ari zaren bitartean denbora errealean aurreikusteko.
...
Aldi berean, honako konfiguraziora jo dezakezu, fitxategia alda dezakezu eta kargatutako fitxategia automatikoki `avif` konprimitzeko konfigura dezakezu irudiaren tamaina murrizteko.

...
Adibidez, [Huawei Cloud DNS -k](https://www.huaweicloud.com) doako analisia eskaintzen du, Txinako kontinenteko trafikoa Baidu Smart Cloud-etik pasa daiteke eta nazioarteko trafikoa `cloudflare` bidez.
...
Gehitu bihurketa-araua behean agertzen den moduan, jarri lehen (lehenak lehentasun txikiena du):

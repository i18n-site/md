<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Nazioarteko irtenbideak<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Sare sozialen eta posta elektronikoaren bidez, jendea ohituta dago bere ama hizkuntzako informazio iturrietara bideratzen.
...
## <a rel=id href="#project" id="project"></a> Proiektuaren Deskribapena
...
Itzuli `Markdown` eta `YAML` komando lerroko tresna batera ( [iturburu-kodea](https://github.com/i18n-site/rust/tree/main/i18) ) hainbat hizkuntzatan.

-ren formatua ezin hobeto mantendu dezake `Markdown` Fitxategien aldaketak identifikatu ditzake eta aldatutako fitxategiak soilik itzul ditzake.
...
Everything is a File " `UNIX` " partekatzen dugu eta ehunka hizkuntzatan itzulpenak kudea ditzakegu enpresa-mailako irtenbide konplexu eta astunak sartu gabe.

Tresna ezagunenak erabil ditzakezu itzulpena `Markdown` (baina ezin dituzu paragrafoak gehitu edo ezabatu), eta bertsio-kontrola egiteko modurik ezagunena erabil dezakezu.

Kode-oinarri bat hizkuntza-fitxategietarako kode ireki gisa sor daiteke, eta `Pull Request` -ren prozesuaren laguntzaz, erabiltzaile globalak itzulpenen etengabeko optimizazioan parte har dezakete. Konexiorik [github](//github.com) beste kode irekiko komunitateak.
...
Estatiko hutsa, irakurketa-esperientziarako optimizatua eta [i18](#i18) proiektuaren dokumentu-gune bat eraikitzeko aukerarik onena da.
...
Webgune hau esparru honetan oinarrituta garatu da eta erabiltzaileak, ordainketak eta beste funtzio batzuk ( [iturburu kodea](/i18n.site/src) ) biltzen ditu tutoretza zehatza geroago.

[→ Erabiltzailearen gidarako, irakurri proiektuaren dokumentazioa](/i18n.site) .

...
`md/.i18n/htm/ol.yml` ایډیټ کړئ او د خپل `npm` بستې نوم په [npmjs.com](//npmjs.com) د [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` بدل کړئ.

بیا `md/.i18n/htm/ol.package.json` تعدیل کړئ

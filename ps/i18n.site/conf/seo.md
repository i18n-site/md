...
جامد فایلونه په ځایی توګه تولید کیدی شي، مګر یو ډیر عام طریقه دا ده چې دوی د اعتراض ذخیره کې پورته کړئ.
...
په ترتیب کې، مهرباني وکړئ `i18n.site` په `.i18n/htm/ol.yml` کې `host:` ارزښت ته بدل کړئ، ډیری اعتراض پلورنځي `s3` لاندې ترتیب کیدی شي، او `region` ساحه اختیاري ده (ډیری اعتراض پلورنځي د دې ساحې تنظیم کولو ته اړتیا نلري).

بیا د پروژې بیا خپرولو لپاره `i18n.site -n` چل کړئ.

که تاسو `~/.config/i18n.site.yml` تعدیل کړی وي او غواړئ چې بیا اپلوډ وکړئ، مهرباني وکړئ د پروژی روټ ډایرکټر کې لاندې کمانډ وکاروئ ترڅو د اپلوډ کیچ پاک کړئ :
...
`URL redirect` متحرک ریډیریکشن غوره کړئ، مهرباني وکړئ `/en` په ریډائریکشن لار `concat("/en",http.request.uri.path,".htm")` کې هغه ډیفالټ ژبه ته بدل کړئ چې تاسو غواړئ د لټون انجنونه پکې شامل کړئ.

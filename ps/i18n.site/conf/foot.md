...
دلته `${I18N.C}` `en/i18n.yml` سره مطابقت لري :
...
لینک ته `class="a"` اضافه کول د لینک `MarkDown` ته د بدلیدو مخه نیسي. وګورئ :
 [➔ `YAML` څنګه د لینک `HTML` : `Markdown` بدلیدو څخه مخنیوی وشي](/i18/qa#H2) .
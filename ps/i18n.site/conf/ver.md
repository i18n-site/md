...
خالي `v` به د سائډبار په خاکه کې نه ښودل کیږي، مګر تر هغه چې `v` فایل شتون ولري، یو خپلواک شاخص به په ډایرکټر او فرعي لارښود کې د فایلونو لپاره تولید شي.
...
د مثال په توګه، د ډیمو پروژه کې `blog` سره مطابقت لري [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) :
...
`TOC` فایلونه په نښه شوي ترڅو د خاکې درجه بندي اړیکه په ګوته کړي، د څو سطحې نښه کولو مالتړ وکړي، او `# ` سره پیل شوي لاین تبصرې.
...
د مثال په توګه، که چیرې `/test` ته لاسرسی ومومي، او `nav:` د دې لارې له مخکینۍ پرته ترتیب شوی وي، او د لټون کولو اوسنۍ ژبه انګلیسي ده (کوډ `en` )، `/en/test.md` به د ډیفالټ لخوا پورته شي او د ټیمپلیټ `Md` په کارولو سره وړاندې شي.

...
د اینکر پوائنټ حل چې د `i18n.site` سره موافقه شوی د `<a rel=id href="#xxx" id="xxx"></a>` په `MarkDown` کې ورته متن دننه کول دي ترڅو په لاسي ډول د موقعیت لنگر نقطه رامینځته کړي.

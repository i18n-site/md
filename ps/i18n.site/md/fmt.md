...
دودیز `MarkDown` لنگر ټکي د متن مینځپانګې پراساس رامینځته کیږي ، د څو ژبو په حالت کې ، دا حل ممکن ندي.
...
## په څو ژبو کې انځورونه / ویډیوګانې / لینکونه

وروسته له دې چې `MarkDown` په `HTML` بدل شي، `$LANG` په ځانګړتیاوو کې `src` او `href` به د اوسني [ژبې کوډ](/i18/LANG_CODE) سره بدل شي.

د دې متغیر سره، تاسو کولی شئ د عکسونو / ویډیوګانو / لینکونو څو ژبني کولو ترلاسه کړئ.
...
موږ [vscode](https://code.visualstudio.com/) `MarkDown` لیکلو لپاره کاروو، او د لیکلو پرمهال په ریښتیني وخت کې د لیدو لپاره پلگ ان [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) نصب کوو.
...
د فایل `Markdown` خلاصولو لپاره `vscode` زنګ وهلو لپاره د کمانډ لاین کې `code xxx.md` دننه کړئ.

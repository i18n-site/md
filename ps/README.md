...
## <a rel=id href="#project" id="project"></a> د پروژې تفصیل
...
کولی شي په بشپړ ډول د فارمیټ ساتنه وکړي `Markdown` کولی شي د فایل بدلونونه وپیژني او یوازې بدل شوي فایلونه وژباړي.
...
موږ `UNIX` هر څه یوه فایل " " شریکوو او کولی شو په سلګونو ژبو کې ژباړې اداره کړو پرته لدې چې پیچلي او پیچلي تصدۍ کچې حلونه معرفي کړي.

تاسو کولی شئ د ژباړې `Markdown` لپاره خورا پیژندل شوي وسیلې وکاروئ (مګر تاسو نشئ کولی پراګرافونه اضافه یا حذف کړئ) ، او د نسخې کنټرول کولو لپاره خورا پیژندل شوې لار وکاروئ.

د کوډ اساس د ژبې فایلونو لپاره د خلاصې سرچینې په توګه رامینځته کیدی شي ، او `Pull Request` پروسې په مرسته ، نړیوال کارونکي کولی شي د ژباړې په دوامداره اصلاح کې برخه واخلي. بې سیمه [github](//github.com) او نورې خلاصې سرچینې ټولنې.

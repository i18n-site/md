...
ژباړه د تدوین وړ ده؛ اصلي متن بدل کړئ، او کله چې دا په ماشین کې بیا ژباړل شي، د ژباړې لاسي بدلونونه به له سره نه لیکل کیږي (که د اصلي متن دا پراګراف نه وي بدل شوی).
...
د ژباړې د مدیریت موجوده وسایل د هغو پروګرامرانو لپاره چې په `git` مدیریت تکیه کوي، ډیر وزن لري، دوی لاهم د کمانډ لاین غوره کوي.

نو، ما د ژباړې وسیله `i18` رامینځته کړه او د ژباړې وسیلې پراساس د څو ژبو جامد سایټ جنریټر `i18n.site` جوړ کړ.

![](https://p.3ti.site/1723777556.avif)

دا یوازې پیل دی، نور ډیر څه شته.

...
د نیم کال څخه ډیر پرمختګ وروسته، آنلاین دی [https://i18n.site](//i18n.site)

اوس مهال، دوه خلاصې سرچینې کمانډ لاین وسیلې پلي کیږي:

* `i18` : MarkDown کمانډ لاین ژباړې وسیله
* `i18n.site` : څو ژبو جامد سند سایټ جنریټر، **د لوستلو تجربې لپاره مطلوب**
...
مخکینۍ برخه [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
ډیټابیس [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

په خپله جوړ شوی ته بریښنالیک واستوئ SMTP [chasquid](https://github.com/albertito/chasquid)

## موږ سره اړیکه ونیسئ

کله چې نوي محصولات په لاره واچول شي، ستونزې حتمي دي.

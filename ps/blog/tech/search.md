...
دا مقاله به د `i18n.site` خالص مخکینۍ بشپړ متن لټون ټیکنالوژي پلي کړي چې تاسو د لټون اغیز تجربه کولی شئ [i18n.site](//i18n.site)

کوډ د خلاصې سرچینې [لټون کارنل](//github.com/i18n-site/ie/tree/main/qy) [متقابل انٹرفیس](//github.com/i18n-site/plugin/tree/main/qy) /

## د سرور پرته د بشپړ متن لټون حلونو یوه عمومي کتنه

د کوچنیو ویب پاڼو لپاره لکه د اسنادو/شخصي بلاګونو لپاره چې خالص جامد دي، بې له شکه د خپل ځان لخوا د بشپړ متن لټون پس منظر جوړولو لپاره خورا دروند دی، او د خدماتو پرته د بشپړ متن لټون بې له شکه یو ښه وزن دی.

د سرور پرته د بشپړ متن لټون حلونه په دوه پراخه کټګوریو کې راځي.

یو د دریمې ډلې لټون خدماتو چمتو کونکی دی چې ورته ورته دی [algolia.com](//algolia.com) کوم چې د مخکینۍ پای بشپړ متن لټون برخې چمتو کوي.

دا ډول خدمتونه تادیاتو ته اړتیا لري او د ویب پاڼې د موافقت مسلو له امله په چین کې د کاروونکو لپاره شتون نلري.
...
ډیر ښه پیژندل شوي خالص مخکینۍ بشپړ متن لټونونه شامل دي [lunrjs](https://lunrjs.com) [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) .

`lunrjs` د شاخصونو د جوړولو لپاره دوه لارې شتون لري، مګر دواړه خپلې ستونزې لري.
...
د [fusejs](https://www.fusejs.io) لپاره د تارونو ترمنځ ورته والی محاسبه کړئ.

د دې حل فعالیت خورا خراب دی او د بشپړ متن لټون لپاره نشي کارول کیدی (وګورئ [Fuse.js اوږده پوښتنه له 10 ثانیو څخه ډیر وخت نیسي، دا څنګه اصلاح کول؟](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

د لټون لپاره بلوم فلټر وکاروئ [TinySearch](https://github.com/tinysearch/tinysearch) د مخکینۍ لټون لپاره نشي کارول کیدی (د مثال په توګه، `goo` داخل کړئ، لټون `good` ، `google` )، او د ورته اتوماتیک بشپړولو اغیز نشي ترلاسه کولی.

د موجوده حلونو نیمګړتیاو څخه د نا رضایتۍ له امله، `i18n.site` یو نوی خالص مخکینۍ پای بشپړ متن لټون حل رامینځته کړی، کوم چې لاندې ځانګړتیاوې لري :
...
1. د مخکیني لټون ملاتړ کوي ، کوم چې کولی شي د لټون پایلې په ریښتیني وخت کې ښکاره کړي پداسې حال کې چې کارونکي ټایپ کوي.
...
* `/\p{P}/` یو منظم بیان دی چې د ټکي نښه نښانو سره سمون خوري، په دې کې شامل دي: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _ ` { | } `.</p><ul style=";text-align:right;direction:rtl"><li style=";text-align:right;direction:rtl"> `split('.')` ځکه چې `Firefox` براوزر کلمې قطع کول `.` برخه نه کوي.</li>
...
په مخکینۍ متقابل عمل کې، د شاخص د بار کولو پرمختګ بار ښودل کیدی شي کله چې د لومړي ځل لپاره د بار کولو څخه مخنیوی وشي "د انیمیشن سره د پرمختګ بار، د واحد پر بنسټ progress + خالص css تطبیق" [انګلیسي](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [چینایي](https://juejin.cn/post/7413586285954154522) .

### IndexedDB لوړ همغږي لیکنه

پروژه د اسینکرونس انکاپسولیشن پراساس [idb](https://www.npmjs.com/package/idb) IndexedDB
...
د لټون کرنل به د `prefix` جدول د وروستي کلمې لپاره د کلمو د قطع کولو وروسته وکاروي ترڅو ټول هغه کلمې ومومي چې د هغې سره مخکینۍ وي، او په ترتیب کې لټون وکړي.
...
د لټون پایلې ښودل شوي لومړی د پوښتنې دقیقیت یقیني کوي، او پایلې وروسته پورته کیږي (د لاډ ډیر تڼۍ کلیک وکړئ) د یادولو نرخ ډاډمن کوي.
...
د بشپړ متن پلټنه په بشپړ ډول په مخکني پای کې پلي کیږي، د چټک غبرګون سره او سرور ته اړتیا نلري.

دا د کوچنیو او منځنیو سایټونو لکه اسنادو او شخصي بلاګونو لپاره خورا مناسب دی.
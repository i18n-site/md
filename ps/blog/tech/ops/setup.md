...
په هرصورت، هره میاشت یو څو ورځې شتون لري چیرې چې د نصب کولو فیس وړیا دی یوازې راجستر کړئ او پروموشنل بریښنالیکونو ته پاملرنه وکړئ.
...
ماډل `AMD EPYC 9224 24-Core Processor` ښودل CPU ، د واحد کور فعالیت سکور 1285
...
لومړی شی IP چې د محلي ماشین `~/.ssh/config` د عرف ټاکلو لپاره ایډیټ کړئ، او بیا د پټنوم څخه پاک ننوت تنظیم کولو لپاره `ssh-copy-id root@c2` وکاروئ.
...
له اروپا څخه چین ته `ssh` د سرعت لپاره د [mosh](//mosh.org) سپارښتنه کیږي.

په سیمه ایز لارښود `~/.bin` کې `c0` سکریپټونه جوړ کړئ (په عمده ډول د چاپیریال متغیر `PATH` کې اضافه شوي) په لاندې ډول:
...
د جوړولو وروسته، د اجرا وړ اجازې او نرم لینک `c1` او `c2` ورکړئ.
...
په راتلونکي کې، تاسو کولی شئ په مستقیم ډول `c0` او `c1` داخل کړئ ترڅو د `mosh` تیز رفتار مستقیم ارتباط وکاروئ او داخل شئ [tmux](https://www.ruanyifeng.com/blog/2019/10/tmux.html)
...
د ګوتو نښې به ssh ، د پاکولو لپاره `ssh-keygen -R ip` وکاروئ
...
که تاسو د بشپړتیا وړ یاست، تاسو کولی شئ په لاسي ډول د بشپړ ډیسک کمپریشن ترسره کړئ کمانډ په لاندې ډول دی:
...
د پیل کولو سکریپټ به `~/ubuntu` ډایرکټر رامینځته کړي ، یوازې لاندې کمانډ پرمخ وړئ:
...
د فرعي حجمونو لیدو لپاره `snapper list-configs` وکاروئ د کوم لپاره چې سنیپ شاټونه ترتیب شوي.

![](https://i-01.eu.org/1718302689.avif)

د فرعي حجم د عکس شاټ لیدو لپاره `snapper -c mnt list` وکاروئ

`/etc/snapper/configs/mnt` کولی شي د دې فرعي حجم ځانګړي بیک اپ تنظیمات وګوري
...
په هرصورت، د دې سنیپ شاټ ګرانولیت ډیر لوی دی یوځل چې بیرته راګرځول شي، نوي اضافه شوي ډاټا به په بشپړه توګه له لاسه ورکړي، نو مهرباني وکړئ دا په احتیاط سره وکاروئ.
...
د ریسکیو سیسټم لاندې د لاګ دوام فعالول تاسو ته اړتیا لري چې په لاسي ډول اړونده ډایرکټر جوړ کړئ او ځینې اضافي مرحلې ترسره کړئ ، ځکه چې تاسو ممکن د چلولو سیسټم خدمت نلرئ. دلته هغه ګامونه دي چې تاسو یې هڅه کولی شئ:
...
په یاد ولرئ چې پورتني عملیات د ریسکیو سیسټم کې ترسره کیږي، نو دا بدلونونه به تر هغه وخته اغیزه ونلري چې سیسټم ریبوټ شوی وي او نور د ژغورنې حالت کې نه وي.

دا پدې مانا ده چې تاسو به سمدلاسه په موجوده لاګونو کې کوم بدلون ونه ګورئ کوم چې دوامدار کیږي ، مګر له هغې وروسته رامینځته شوي ټول لاګونه به دوام ومومي.
...
د بار بار تحقیقاتو وروسته، دا ځکه github action د tar کارن `uid` `1001`

پیک کول باید وي که چیرې هیڅ پیرامیټر `--no-same-owner` نه وي، دا به `1001` کاروونکو لپاره `uid` ته کم شي tar

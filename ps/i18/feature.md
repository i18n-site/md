...
د مخلوط ژباړې ملاتړ کوي Markdown HTML په `MarkDown` کې د HTML `<pre>` او `<code>` ټګونو مینځپانګه ژباړل شوې نه ده
...
د هغو پروګرامرانو لپاره چې د `git` ، `vim` ، او `vscode` سره اشنا دي، د اسنادو سمولو او نسخو اداره کولو لپاره د دې وسیلو کارول به بې له شکه د زده کړې لګښت زیات کړي.
...
[HOGO](https://github.com/gohugoio/hugo) سټیټ بلاګ د سرلیک ترتیب ملاتړ کوي، کوم چې یوازې `title` ، `summary` او `description` ساحې ژباړي.
...
`Falcon` د `faucon` په توګه ژباړل شوی او `Llama` `lama` په توګه ژباړل شوی. د مناسبو اسمونو په توګه، دوی باید ژباړل نشي.
...
په DeepL کې د پورتنۍ ژباړه (د مناسبو نومونو بیا لیکل او د عجیب `... ` اضافه کول):
...
یوازې هغه وخت چې د انګلیسي کلمې او چینایي، جاپاني او کوریايي متن تر مینځ فاصله شتون ولري یا د انګلیسي اوږدوالی له 1 څخه ډیر وي، کلمه به د اصطلاح په توګه وګڼل شي.

د مثال په توګه: `C罗` به `Cristiano Ronaldo` په توګه ژباړل شي.
...
مراجع په بشپړه توګه خلاص سرچینه ده، او 90 کوډ % خلاص سرچینه ده [د سرچینې کوډ لیدلو لپاره](/i18n.site/src) .

...
[i18n.site/payBill](//i18n.site/payBill) ، تاسو اړتیا لرئ د تادیې لپاره کریډیټ کارت وتړئ (د ریچارج ته اړتیا نشته ، ویب پا به په اوتومات ډول د کارونې سره سم فیسونه کموي ، [د نرخ لپاره کورپاڼه وګورئ](/#price) ).
...
که تاسو غواړئ ځینې فایلونه له پامه غورځوئ او نه یې ژباړئ (لکه نامکمل مسودې)، تاسو کولی شئ د `ignore` ساحې ترتیب وکاروئ.

...
Кээде `HTML` → `MarkDown` өзгөртүү биз каалагандай эмес, мисалы `<a href="/">Home</a>` `[Home](/)` айландырылат.

`a` тегине `href` башка кандайдыр бир атрибутту кошуу, мисалы, `<a class="A" href="/">Home</a>` , бул конверсиядан качышы мүмкүн.

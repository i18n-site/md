...
windows Система, биринчи [`git bash` жүктөп алуу жана орнотуу үчүн бул жерди басыңыз](https://git-scm.com/download/win) .
...
Мындан тышкары, сиз төлөм үчүн кредиттик картаны байлашыңыз [i18n.site/payBill](//i18n.site/payBill) (толуктоо талап кылынбайт, веб-сайт колдонууга жараша төлөмдөрдү автоматтык түрдө чыгарып салат, [баасын билүү үчүн башкы баракчаны караңыз](/#price) ).
...
Алардын арасында `.i18n/cache/.gitignore` мазмуну төмөнкүдөй :
...
Бул `.i18n/cache/` каталогундагы бардык файлдар ( `.i18n/cache/.gitignore` башкасы) этибарга алынбайт дегенди билдирет.

Эгерде сиздин версияңызды башкаруу программалык камсыздооңуз `git` эмес болсо, бул конфигурацияга ылайык ага көңүл бурбай коюңуз.
...
Мисалы, эгер сиз кытайчаны англис тилине которгуңуз келсе, бул сапты `zh: en` деп кайра жазыңыз.

Эгер сиз бардык колдоого алынган тилдерге которууну кааласаңыз, `:` кийин бош калтырыңыз. мисалы
...
Бул конфигурация таблицасында каталог `blog` котормонун баштапкы тили `zh` , ал эми `blog/your_file_name.md` котормонун баштапкы тили `ja` .

...
Мындан [i18n.site/payBill](//i18n.site/payBill) , сиз төлөм үчүн кредиттик картаны байлашыңыз керек (толуктоо талап кылынбайт, веб-сайт колдонууга жараша төлөмдөрдү автоматтык түрдө кармап турат, [бааны башкы беттен караңыз](/#price) ).
...
Ар кандай субкаталогдор үчүн ар кандай `fromTo` конфигурацияланса болот Демонстрация төмөнкүдөй : /
...
Бул конфигурация таблицасында `blog` каталогунун котормонун баштапкы тили `zh` , ал эми `blog/your_file_name.md` каталогунун котормонун баштапкы тили `ja` .

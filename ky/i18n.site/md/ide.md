...
`MarkDown` жазуу үчүн [vscode](https://code.visualstudio.com/) , ошондой эле жазуу учурунда реалдуу убакытта алдын ала көрүү үчүн [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) плагинди орнотобуз.

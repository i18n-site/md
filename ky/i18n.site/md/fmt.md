...
`i18n.site` менен макулдашылган якорь чекитинин чечими `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` текстти жайгаштыруу анкердик чекитин кол менен түзүү.
...
Эскерте кетсек, `<style>` да жогоруда `<pre>` менен аныкталган.
...
`md/.i18n/htm/ol.yml` түзөтүңүз [npmjs.com](//npmjs.com) [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` маанини өзүңүздүн `npm` пакетиңиздин аталышы катары өзгөртүңүз.

Андан кийин `md/.i18n/htm/ol.package.json` өзгөртүңүз

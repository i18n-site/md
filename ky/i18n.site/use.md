...
Иштегенден кийин котормо жана кэш файлдары түзүлөт, `git add . ` `md` каталогундагы репозиторийге кошууну унутпаңыз.
...
`i18n.site` [бир беттик колдонмо](https://developer.mozilla.org/docs/Glossary/SPA) архитектурасын кабыл алат, ал эми веб-сайтка кирүү бети жана веб-сайттын мазмуну өз алдынча жайгаштырылат.
...
`ol` - бул `online` `-n` дин кыскартылышы, `npm` расмий релиз үчүн колдонулган онлайн чөйрөнү көрсөтүүдө.
...
Сиз `S3` серверине кирүү үчүн [rclone](https://rclone.org) болот, андан кийин төмөнкү скриптке кайрылыңыз жана өзгөртө аласыз жана ар бир чыгарылыш үчүн кошумча өзгөртүүлөрдү `S3` гана көчүрсөңүз болот.
...
[Уюмду түзүү үчүн биринчи бул github басыңыз](https://github.com/account/organizations/new?plan=free) `i18n-demo`

Андан кийин бул уюмдун алдында кампа `i18n-demo.github.io` түзүңүз ( `i18n-demo` дегенди сиз түзгөн уюмдун аталышы менен алмаштырыңыз):
...
`github page` менен [cloudflare page](//pages.cloudflare.com) , ал жолду кайра жазууну камсыз кылат жана материктик Кытайга ыңгайлуу жана аны колдонуу сунушталат.
...
Жогорудагы сүрөттөгү эрежелер төмөнкүдөй: төмөнкү биринчи саптагы `i18n.site` сиз байлаган домендик ат менен алмаштырыңыз.
...
Андан кийин, материктик Кытайдагы булут сатуучулардын объект сактагычын `out/ol/htm` + Төмөнкү мазмунду жайгаштырыңыз `CDN` .
...
Рекорд `MX` жана рекорд `CNAME` бирге жашай албагандыктан, эгер сиз бир эле учурда домендик аталыштагы электрондук каттарды алууну кааласаңыз, [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) менен `CNAME` деңгээлге `A` рекордуна чейин иштешиңиз керек.
...
`out/ol/htm` `/root/i18n/md/out/ol/htm` `server` абзацына төмөнкүгө окшош конфигурацияны кошуңуз nginx
...
Бул жерде сүрөтчө файлдары менен түзүлүшү мүмкүн [realfavicongenerator.net](https://realfavicongenerator.net)

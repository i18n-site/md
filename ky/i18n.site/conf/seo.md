...
Конфигурацияда `i18n.site` `host:` `.i18n/htm/ol.yml` маанисине өзгөртүңүз, бир нече объект дүкөндөрү `s3` астында конфигурацияланса болот, ал эми `region` талаасы милдеттүү эмес (көп объект дүкөндөрүндө бул талааны коюунун кереги жок).
...
Төмөндө көрсөтүлгөндөй өзгөртүү эрежелерин кошуңуз:
...
Төмөндө көрсөтүлгөндөй конвертациялоо эрежесин кошуңуз, аны биринчи коюңуз (биринчи эң төмөнкү артыкчылыкка ээ):

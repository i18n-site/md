...
Плагиндердин бардыгы `npm` пакеттен турат.
...
Камтылган `js` иштөө убактысы [boa](https://github.com/boa-dev/boa) иштеп чыгууга негизделген жана орнотулган функциялар төмөнкүдөй :

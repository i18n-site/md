...
### `use: Toc` , Контур Менен Бир Файл Шаблону
...
Мисалы, эгер `/test` кирсе жана `nav:` бул жолдун префикси жок конфигурацияланса жана учурдагы серептөө тили англисче (код `en` ) болсо, `/en/test.md` демейки боюнча жүктөлөт жана `Md` үлгүсү менен көрсөтүлөт.

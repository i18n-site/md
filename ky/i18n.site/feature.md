...
Программада камтылган котормо `i18` , атайын колдонуу үчүн [➔ `i18`](/i18) караңыз.
...
Демейки боюнча, сайттын мазмуну [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) жана бир нече `CDN` мазмунунун жардамы менен `npmjs.com` `npm` `i18n.site`
...
Принцип: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) жардамы менен өтүнүчтү токтотуңуз, эгер өтүнүч ишке ашпай калса, аны башка `CDN` менен кайталап көрүңүз жана демейки жүктөө булагы катары эң тез жооп берүүчү баштапкы станцияны ыңгайлаштырыңыз.
...
`404` Баракта сүйкүмдүү кичинекей калкып турган арбак бар, анын көздөрү чычкан менен кыймылдайт, [➔ Көрүү үчүн бул жерди басыңыз](/404) ,

...
## <a rel=id href="#project" id="project"></a> Долбоордун киришүүсү
...
`Markdown` жана `YAML` сандарын бир нече тилге которгон буйрук сабынын куралы ( [булак коду](https://github.com/i18n-site/rust/tree/main/i18) ).
...
Биз `UNIX` философиясына жазылабыз " Баары бир " болуп саналат жана ишкана деңгээлиндеги татаал жана түйшүктүү чечимдерди киргизбестен жүздөгөн тилдерге котормолорду башкара алабыз.
...
## Мыкты Сапаттагы Машина Которуу
...
[github авторизациялоо жана автоматтык түрдө i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) жана **$50 алуу үчүн** бул жерди басыңыз!
...
<button onclick="mailsub()">Өнүмдүн жаңыртууларына жазылуу</button> жана <button onclick="webpush()">браузерди иштетүү үчүн</button> бул электрондук катты басыңыз.

...
## <a rel=id href="#project" id="project"></a> Долбоордун сүрөттөлүшү

Бул сайт учурда эки ачык булак буйрук сабы куралдарын камсыз кылат:

* [i18 : MarkDown line которуу куралы](/i18/feature)
...
`Markdown` жана `YAML` дегенди бир нече тилде буйрук сабына ( [булак коду](https://github.com/i18n-site/rust/tree/main/i18) ) которуңуз.

форматын мыкты сактай алат `Markdown` Файлдын өзгөртүүлөрүн аныктап, өзгөртүлгөн файлдарды гана которо алат.
...
Биз баары бир " " `UNIX` бөлүшөбүз жана ишкана деңгээлиндеги татаал жана түйшүктүү чечимдерди киргизбестен жүздөгөн тилдердеги котормолорду башкара алабыз.

Котормону `Markdown` үчүн сиз эң тааныш куралдарды колдоно аласыз (бирок абзацтарды кошуп же жок кыла албайсыз) жана версияны башкаруунун эң тааныш ыкмасын колдонсоңуз болот.

Код базасы тил файлдары үчүн ачык булак катары түзүлүшү мүмкүн жана `Pull Request` процессинин жардамы менен глобалдык колдонуучулар котормолорду үзгүлтүксүз оптималдаштырууга катыша алышат. Үзгүлтүксүз [github](//github.com) жана башка ачык булак коомдоштуктары.

[→ Колдонуучунун колдонмосу үчүн долбоордун документтерин окуп чыгыңыз](/i18) .
...
Таза статикалык, окуу тажрыйбасы үчүн оптималдаштырылган жана [i18](#i18) бул долбоор документинин сайтын куруу үчүн эң мыкты тандоо.

Негизги алдыңкы алкак толук плагин архитектурасын кабыл алат, ал экинчи даражадагы иштеп чыгуу үчүн жеңил болот.

Бул веб-сайт ушул негиздин негизинде иштелип чыккан жана колдонуучу, төлөм жана башка функцияларды камтыйт ( [булак коду](/i18n.site/src) ) Толук окуу куралы кийинчерээк жазылат.

[→ Колдонуучунун колдонмосу үчүн долбоордун документтерин окуп чыгыңыз](/i18n.site) .

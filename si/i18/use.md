...
## windows මුලින්ම git bash ස්ථාපනය කරන්න
...
ටෝකනය පිටපත් කිරීමට [i18n.site/token](//i18n.site/token)
...
ඊට [i18n.site/payBill](//i18n.site/payBill) , ඔබට ගෙවීම සඳහා ක්රෙඩිට් කාඩ්පතක් බැඳීමට අවශ්ය වේ (නැවත ආරෝපණය කිරීම අවශ්ය නොවේ, වෙබ් අඩවිය භාවිතය අනුව ස්වයංක්රීයව ගාස්තු අඩු කරයි, [මිල නියම කිරීම සඳහා මුල් පිටුව බලන්න](/#price) ).
...
`en` ඩිරෙක්ටරියේ පරිවර්තිත ආදර්ශන ගොනු උදාහරණයක් පමණක් වන අතර ඒවා මකා දැමිය හැක.
...
විවිධ උප බහලුම් සඳහා විවිධ `fromTo` වින්යාසගත කළ : /
...
මෙම වින්යාස වගුවේ, බහලුම `blog` පරිවර්තනය සඳහා මූලාශ්ර භාෂාව `zh` වන අතර නාමාවලිය `blog/your_file_name.md` පරිවර්තනය සඳහා මූලාශ්ර භාෂාව `ja` වේ.

### ගොනුව නොසලකා හරින්න

පෙරනිමියෙන්, මූලාශ්ර භාෂා නාමාවලියෙහි `.md` සහ `.yml` න් ආරම්භ වන සියලුම ගොනු පරිවර්තනය කරනු ලැබේ.

ඔබට ඇතැම් ගොනු නොසලකා හැරීමට සහ ඒවා පරිවර්තනය නොකිරීමට අවශ්ය නම් (නිම නොකළ කෙටුම්පත් වැනි), ඔබට `ignore` ක්ෂේත්ර වින්යාසය භාවිතා කළ හැක.
...
නමුත් පරිවර්තනයේ රේඛා සහ මුල් පිටපත එකකට අනුරූප විය යුතු බව කරුණාවෙන් සලකන්න. එනම්, පරිවර්තනය සම්පාදනය කිරීමේදී රේඛා එකතු කිරීම හෝ මකා දැමීම නොකළ යුතුය. එසේ නොමැති නම්, එය පරිවර්තන සංස්කරණ හැඹිලියේ ව්යාකූලත්වය ඇති කරයි.

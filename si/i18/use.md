...
ඒවා අතර, `.i18n/cache/.gitignore` හි අන්තර්ගතය පහත පරිදි වේ :
...
මෙයින් අදහස් කරන්නේ `.i18n/cache/` නාමාවලියේ ( `.i18n/cache/.gitignore` හැර) සියලුම ගොනු නොසලකා හරින බවයි.

ඔබගේ අනුවාද පාලන මෘදුකාංගය `git` නොවේ නම්, කරුණාකර මෙම වින්යාසය අනුව එය නොසලකා හරින්න.

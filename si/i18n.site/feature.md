...
`i18n.site` විසින් [jsdelivr.com](//jsdelivr.com) හි පූරණය කරන ලද , [unpkg.com](//unpkg.com) සහ අනෙකුත් `CDN` අන්තර්ගතයන් සමඟින් `npm` පෙරනිමියෙන් `npmjs.com` වෙත වෙබ් අඩවියේ අන්තර්ගතය ප්රකාශ කරයි.

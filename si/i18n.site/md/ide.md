...
සෑම කෙනෙකුටම ඔවුන්ගේම `Markdown` සංස්කාරකයක් ඇත.

අපි `MarkDown` ලිවීමට සහ ප්ලග්-ඉන් [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ස්ථාපනය කිරීම සඳහා තථ්ය කාලීනව පෙරදසුන් කිරීමට භාවිතා [vscode](https://code.visualstudio.com/) .

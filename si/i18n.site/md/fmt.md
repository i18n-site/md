...
නැංගුරම් සාමාන්යයෙන් මාතෘකාවට එකතු කරනු ලැබේ, වැනි:
...
ඔබට ක්රියාත්මක කිරීම වෙත යොමු විය හැක [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) කේතය පහත පරිදි වේ :
...
## බහු භාෂාවලින් පින්තූර/වීඩියෝ/සබැඳි

`MarkDown` `HTML` බවට පරිවර්තනය වූ පසු, `src` සහ `href` යන ගුණාංගවල `$LANG` වත්මන් [භාෂා කේතය](/i18/LANG_CODE) සමඟ ප්රතිස්ථාපනය වේ.

මෙම විචල්යය සමඟ, ඔබට පින්තූර/වීඩියෝ/සබැඳි බහුභාෂාකරණය ලබා ගත හැක.
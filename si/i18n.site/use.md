...
[ප්රවේශ ටෝකනය වින්යාස කිරීම සඳහා `i18` ලේඛනය වෙත යොමු කිරීමට කරුණාකර මෙහි](/i18/use) `i18n.site` `i18` මෙවලමක් ඇත.
...
ධාවනය කිරීමෙන් පසු, පරිවර්තන සහ හැඹිලි ගොනු උත්පාදනය වනු ඇත, කරුණාකර `git add . ` `md` නාමාවලියට එක් කිරීමට මතක තබා ගන්න.

### දේශීය පෙරදසුන

`docker` ස්ථාපනය කර ආරම්භ කරන්න ( `MAC` පරිශීලකයෙක් නිර්දේශ කරන්නේ [orbstack](https://orbstack.dev) `docker` සඳහා ධාවන කාලය ලෙස ).
...
`htm` නාමාවලිය වෙබ් අඩවියට ඇතුල් වන පිටුවයි.
...
#### වින්යාස ගොනුව නියම කිරීමට -c භාවිතා කරන්න

විවිධ වින්යාස ගොනු `out` නාමාවලියෙහි අනුරූප නාමාවලි සාදනු ඇත.

උදාහරණයක් ලෙස, `.i18n/htm/ol.yml` විසින් `out/ol` නාමාවලිය සාදනු ඇත.

`dev.yml` සහ `ol.yml` යනු පෙරනිමි සැකසුම් වේ.
...
මෙහි `--save` යනු යාවත්කාලීන නිකුත් කිරීමේ අනුවාද අංකය නියෝජනය කරයි.

#### <a rel=id href="#npm" id="npm"></a> අන්තර්ගතය npmjs.com වෙත ප්රකාශ කරන්න

[npmjs.com](//npmjs.com) අන්තර්ගතය ප්රකාශ කිරීම නිර්දේශිත පෙරනිමි විසඳුමයි ( [ඉදිරිපස ඉහළ ලබා ගත හැකි බව](/i18n.site/feature#ha) බලන්න).

##### npm login &

`nodejs` ස්ථාපනය කරන්න, `npm login` සමඟ ලොග් වන්න.

`md/.i18n/htm/ol.yml` සංස්කරණය කර `i18n.site` න් `v: //unpkg.com/i18n.site` ඔබේම `npm` පැකේජ නාමයට වෙනස් කරන්න.

[npmjs.com](//npmjs.com)

පැකේජය `npm` මත පදනම්ව ප්රකාශනය කරන විට, `v:` අගයේ උපසර්ගය **සඳහා `//unpkg.com/` භාවිතා කිරීමට වග බලා ගන්න** `i18n.site` නව නිකුතු කාලානුරූපව බැලීම සඳහා මෙම උපසර්ග මාර්ගය යටතේ `/.v` හි හැඹිලි කාලය විශේෂයෙන් ප්රශස්ත කර ඇත.
...
ඔබ `v:` හි `ol.yml` හි පැකේජ නාමය වෙනස් කරන්නේ නම්, කරුණාකර **පළමුව `.i18n/v/ol` මකා පසුව එය ප්රකාශ කිරීමට වග බලා ගන්න** .

##### ප්රොක්සි සේවාදායකය npm විසින් ප්රකාශනය කරන ලදී

චීනයේ ප්රධාන භූමි ප්රදේශයේ පරිශීලකයින්ට ජාල ගැටළු වලට මුහුණ දීමට සිදුවුවහොත් සහ පැකේජ `npm` ප්රකාශයට පත් කිරීමට නොහැකි නම්, ඔවුන්ට ප්රොක්සි සේවාදායකය වින්යාස කිරීමට පරිසර විචල්යය `https_proxy` සැකසිය හැක.
...
ඔබට අන්තර්ගතය ස්වයං-සත්කාරක කිරීමට අවශ්ය නම්, පළමුව `md/.i18n/htm/ol.yml` සංස්කරණය කර `v: //i18n-v.xxx.com` වැනි ඔබේ URL උපසර්ගයට `v: //unpkg.com/i18n.site` වෙනස් කරන්න.
...
ඉන්පසුව, `md/out/ol/v` නාමාවලියෙහි අන්තර්ගතය `v:` හි සකසා ඇති URL උපසර්ග මාර්ගයට වින්යාස කරන්න.
...
ස්වයං-සත්කාරක අන්තර්ගතය සඳහා, ඔබේම සේවාදායකය භාවිතා කිරීමට `CDN` , තවත් පොදු විකල්පයක් වන්නේ `S3` +

`S3` සේවාදායකයට `S3` වීමට ඔබට [rclone](https://rclone.org)
...
පෙර ලිපියේ අන්තර්ගතය ප්රකාශයට පත් කරන විට, `out/ol/htm` ජනනය වී ඇත, කරුණාකර මෙම නාමාවලිය ඇතුළත් කර ධාවනය කරන්න :
...
ඉන්පසුව + චීනයේ ප්රධාන භූමියේ ක්ලවුඩ් වෙළෙන්දන්ගේ වස්තු ගබඩාව භාවිතා කරන්න `CDN` පහත අන්තර්ගතය යොදවන්න `out/ol/htm` .
...
රෙකෝඩ් `MX` සහ රෙකෝඩ් `CNAME` එකට පැවතිය නොහැකි නිසා, ඔබට එකවර ඩොමේන් නාම ඊමේල් ලබා ගැනීමට අවශ්ය නම්, ඔබ `CNAME` `A` මට්ටමට වාර්තාගත කිරීමට [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) සමඟ සහයෝගයෙන් කටයුතු කළ යුතුය.

මීට අමතරව, චීනයේ ප්රධාන භූමියේ ක්ලවුඩ් වෙළෙන්දන්ගේ විදේශ ගමනාගමන ගාස්තු සාපේක්ෂව මිල අධික බැවින්, ඔබට පිරිවැය ප්රශස්ත කිරීමට අවශ්ය නම්, ඔබට ලබා ගැනීමට [Huawei DNS හි නොමිලේ භූගෝලීය විභේදනය](https://support.huaweicloud.com/usermanual-dns/dns_usermanual_0041.html) සහ [Cloudflare for SaaS](https://developers.cloudflare.com/cloudflare-for-platforms/cloudflare-for-saas) හි අභිරුචි ඩොමේන් නාමය (පහත පෙන්වා ඇති පරිදි) භාවිතා කළ හැකිය රථවාහන හැරවීම──චයිනා බයිඩු ක්ලවුඩ් `CDN` ප්රධාන භූමියේ ගමනාගමනය, ජාත්යන්තර ගමනාගමනය cloudflare .
...
[Alibaba CDN](https://cdn.console.aliyun.com/domain/list) හි වසම් නාමය එකතු කර Alibaba Cloud `CDN` හි වසම් නාමය `*.xxx.com` සිට `CNAME` දක්වා යොමු කරන්න.
...
කරුණාකර `server` ඡේදයේ පහත දැක්වෙන වින්යාසයක් එක් කරන්න nginx කරුණාකර `/root/i18n/md/out/ol/htm` ඔබේම ව්යාපෘතියේ මාර්ගයට `out/ol/htm` වෙනස් කරන්න:

...
`md/.i18n/htm/ol.yml` සංස්කරණය කර [npmjs.com](//npmjs.com) `npm` පැකේජ නාමය ලෙස [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` වෙනස් කරන්න.

ඉන්පසු `md/.i18n/htm/ol.package.json` වෙනස් කරන්න

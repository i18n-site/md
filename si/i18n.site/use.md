...
උදාහරණයක් ලෙස, `.i18n/htm/ol.yml` `out/ol` නාමාවලිය සාදනු ඇත.
...
`md` නාමාවලිය ඇතුල් කර ධාවනය කරන්න
...
වෙබ් අඩවිය [තනි පිටු යෙදුම්](https://developer.mozilla.org/docs/Glossary/SPA) ගෘහ නිර්මාණ ශිල්පයක් භාවිතා කරන බැවින්, `. ` සිට `index.html` දක්වා අඩංගු නොවන URL මාර්ග නැවත ලිවීමට මතක තබා ගන්න.
...
අභිරුචි වසම් නාමය බැඳීමෙන් පසු, පහත දැක්වෙන පරිදි, තනි පිටු යෙදුමේ නැවත ලිවීමේ මාර්ගය වින්යාස කිරීමට කරුණාකර වසම් නාමය වෙත යන්න:

![](https://p.3ti.site/1721119320.avif)

ඉහත පින්තූරයේ ඇති නීති පහත පරිදි වේ, කරුණාකර පහත පළමු පේළියේ `i18n.site` වෙනුවට ඔබ බැඳී ඇති වසම් නාමය.
...
ඉන්පසුව, + ප්රධාන භූමියේ ක්ලවුඩ් වෙළෙන්දන්ගේ වස්තු ගබඩාව භාවිතා කරන්න `CDN` පහත අන්තර්ගතය යොදවන්න `out/ol/htm` .
...
[CDN Cloud](https://cdn.console.aliyun.com/domain/list) හි වසම් නාමය එකතු කර Alibaba Cloud `CDN` හි වසම් නාමය `*.xxx.com` `CNAME` යොමු කරන්න.

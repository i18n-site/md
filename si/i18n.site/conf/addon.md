...
ප්ලග්-ඉන් `.i18n/conf.yml` හි වින්යාස කළ හැක, වැනි:
...
* `i18n.addon/toc` නාමාවලි :
  පෙරනිමියෙන් සක්රීය කර ඇති `TOC` මත පදනම් වූ නාමාවලි දර්ශකය `json` ජනනය කරන්න
...
ඉහත `i18n.addon/toc` ට අනුරූප පැකේජය [https://www.npmjs.com/package/@i18n.addon/toc](https://www.npmjs.com/package/@i18n.addon/toc) .

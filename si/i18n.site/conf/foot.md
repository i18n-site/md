...
* `conf.css` : අයිකන සහ අකුරු

### අයිකන අකුරු

පාදක නිරූපකය `F` iconfont.cn ( [ඉංග්රීසි අනුවාදය](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)) ලෙසින් නිර්මාණය කර ඇත
...
ඔබට `js` `foot.pug` නොහැක. අන්තර්ක්රියා අවශ්ය නම්, කරුණාකර වෙබ් සංරචකය අභිරුචිකරණය කරන්න.

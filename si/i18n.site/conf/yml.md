...
`url` ලියා නොමැති නම්, `url` `i18n` හි අගයට පෙරනිමි වේ. මෙම නියමය අනෙකුත් සැකිලි සඳහා ද බලාත්මක වේ.

ඉහත ලිවීමේ ක්රමය `url: xxx` තිබීමට සමාන වන අතර එහි අනුරූප ගොනුව `en/xxx/TOC` වේ.
...
### මානකරන මාර්ගය නොමැතිව පෙරනිමි පැටවීම

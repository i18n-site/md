...
සෙවුම් සුචිගත කිරීම පහසු කිරීම සඳහා `i18n.site` විසින් නැවුම් නොවන තනි පිටු ගෘහ නිර්මාණ ශිල්පයක් අනුගමනය කරයි, බඩගා යන්නන්ට බඩගා යාමට වෙනම ස්ථිතික පිටුවක් සහ `sitemap.xml` ජනනය කෙරේ.
...
වින්යාසය තුළ, කරුණාකර `i18n.site` `.i18n/htm/ol.yml` හි `host:` අගයට වෙනස් කරන්න, බහු වස්තු ගබඩා `s3` යටතේ වින්යාස කළ හැකි අතර `region` ක්ෂේත්රය විකල්ප වේ (බොහෝ වස්තු ගබඩාවලට මෙම ක්ෂේත්රය සැකසීමට අවශ්ය නොවේ).
...
ප්රතියොමු කිරීමේ රීති පහත පරිදි සකසන්න, කරුණාකර "i18n.site" කේතය ඔබගේ වසම් නාමයට වෙනස් කරන්න
...
උදාහරණයක් `cloudflare` , [Huawei Cloud DNS](https://www.huaweicloud.com)
...
`R2` අභිරුචිකරණය කළ වසම් නාමයකින් ප්රවේශ විය `cloudflare` නිසා, ස්ථිතික ගොනු තැබීමට තුන්වන පාර්ශ්ව වස්තු ගබඩාවක් භාවිතා කිරීමට අවශ්ය වේ.

`cloudflare` හි ගබඩා කළ යුතු තෙවන පාර්ශවීය වස්තු බැඳිය යුතු ආකාරය නිරූපණය කිරීමට අපි උදාහරණයක් ලෙස [backblaze.com](https://www.backblaze.com) .

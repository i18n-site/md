...
## <a rel=id href="#project" id="project"></a> መግለጺ ፕሮጀክት
...
`Markdown` ን `YAML` ን ናብ መሳርሒ መስመር ትእዛዝ ( [ምንጪ ኮድ](https://github.com/i18n-site/rust/tree/main/i18) ) ብብዙሕ ቋንቋታት ተርጉም።

ፍጹም ቅርጺ ናይ `Markdown` ናይ ፋይል ምምሕያሻት ከለልን ዝተቐየሩ ፋይላት ጥራይ ክትርጉምን ይኽእል።
...
ኩሉ ፋይል " እዩ `UNIX` " ንካፈልን ብደረጃ ትካል ዝተሓላለኹን ጽንኩራትን መፍትሒታት ከየተኣታተና ብኣማኢት ቋንቋታት ትርጉማት ከነመሓድር ንኽእል ኢና።

ነቲ ትርጉም `Markdown` እቶም ኣዝዮም ፍሉጣት መሳርሒታት ክትጥቀም ትኽእል ኢኻ (ግን ሕጡበ-ጽሑፋት ክትውስኽ ወይ ክትድምስሶ ኣይትኽእልን ኢኻ)፣ ከምኡ’ውን ነቲ ዝያዳ ፍሉጥ መገዲ ንመቆጻጸሪ ስሪት ክትጥቀመሉ ትኽእል።

ናይ ኮድ መሰረት ከም ክፉት ምንጪ ናይ ቋንቋ ፋይላት ክፍጠር ይኽእል እዩ፣ ብሓገዝ ናይ `Pull Request` 's መስርሕ ድማ ዓለማውያን ተጠቀምቲ ኣብ ቀጻሊ ምምሕያሽ ትርጉማት ክሳተፉ ይኽእሉ። ስሉጥ ምትእስሳር [github](//github.com) ከምኡ ውን ካልኦት ክፉት ምንጪ ማሕበረሰባት።

[→ ንመምርሒ ተጠቃሚ፡ በጃኹም ነቲ ናይ ፕሮጀክት ሰነድ ኣንብቡ](/i18) ።

## Xindaya’s ልዑል ጽሬት ዘለዎ ትርጉም
...
ተመሳሳሊ ፅሬት ንምርካብ ድማ ብጉግል ትራንስሌትን `ChatGPT` ን ዝጠልቦ መጠን ማንዋል ኤዲቲንግ ብቕደም ተኸተል `2.67` ዕጽፊን `3.15` ዕጽፊ ናትና እዩ።
...
ማርክዳውን ትርጉምን ሰነዳትን ሳይታት መጀመርታ ጥራይ እዩ።

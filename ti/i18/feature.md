...
ትርጉም ናይ mixed HTML Markdown ይድግፍ፣ ኣብ `<pre>` ን `<code>` ን tags ናይ HTML ኣብ `MarkDown` ዝተሰረተ ትሕዝቶ ኣይተተርጎመን
...
ኣብ መስመር ዝርከብ ኮድን ቁንጣሮ ኮድን ኣይትርጎሙን እዮም፣ ኣብቲ ኮድ ዘለዉ ርእይቶታት ግን ክትርጎሙ ይኽእሉ እዮም።

ናይ ትርጉም ርእይቶታት ድሕሪ ` ``` ` ዘሎ ቋንቋ ከመልክት ኣለዎ ፣ ` ```rust ` :
...
ይኹን እምበር ምምሕያሽ ፋይል ምልላይ ኣይድግፉን እዮም፣ ዝተመሓየሹ ፋይላት ድማ ወፃኢታት ንምንካይን ብቕዓት ንምዕባይን ጥራሕ ይትርጉሙ።
...
`title` `summary` `description` [HOGO](https://github.com/gohugoio/hugo)
...
`i18` ነቲ ኣብ `MarkDown` ዘሎ ኣርእስቲ ከለልዮ ይኽእል እዩ፣ ናብ ፊደል-ዓበይቲ ቋንቋታት ክትትርጉሞ ከለኻ ድማ ነታ ቀዳመይቲ ፊደል ብኣውቶማቲክ ብዓቢ ፊደል ክጽሕፋ እዩ።
...
ናብ : ተተርጒሙ `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす`

![](//p.3ti.site/1720199391.avif)

ናብ ፈረንሳ `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
ናብ : ተተርጒሙ `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す`
...
ኣብ መንጎ እቲ ናይ እንግሊዝኛ ቃልን ጽሑፍ ቻይናዊ፡ ጃፓናውን ኮርያውን ቦታ ምስ ዝህሉ ወይ ድማ ንውሓት እንግሊዝኛ ካብ 1 ምስ ዝዓቢ ጥራይ እዩ እቲ ቃል ከም ቃል ዝቑጸር።
...
እቲ ዓሚል ምሉእ ብምሉእ ክፉት ምንጪ እዩ 90 እቲ ብወገን ኣገልጋሊ % ናይቲ ኮድ ድማ [ምንጪ ኮድ ንምርኣይ ኣብዚ ጠውቑ](/i18n.site/src) ።

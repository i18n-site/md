...
ይኹን እምበር ኣብ ነፍሲ ወከፍ ወርሒ ናይ ምትካል ክፍሊት ብነጻ ዝኾነሉ ውሑዳት መዓልታት ኣለዉ Just register and pay attention to the promotional emails.
...
ሞዴል ምርኢት CPU `AMD EPYC 9224 24-Core Processor` ንጽል-ኮር ኣፈጻጽማ ነጥቢ 1285
...
IP ቀዳማይ ነገር `ssh-copy-id root@c2` ሎካል ማሽን `~/.ssh/config`
...
እዚ ስጉምቲ ነዊሕ ​​ግዜ ዝወስድ ንፍርቂ ሰዓት ድሕሪ ምጽባይ፡ ምዕባይን ምትካልን ልሙድ ዝኾነ ሶፍትዌር ዕዉት ክኸውን እዩ። በዚ ዝስዕብ ትእዛዝ ከተረጋግጾ ትኽእል ኢኻ፤
...
ካብ ኤውሮጳ ክሳብ ቻይና `ssh` ኔትወርክ ርጉእ ኣይኮነን ክትጥቀመሉ ይምከር ንዑ ክትቅልጥፍ [mosh](//mosh.org)

ኣብቲ ናይ ውሽጢ ዓዲ `~/.bin` (ብቐንዱ ኣብቲ ናይ ከባቢ ተለዋዋጢ `PATH` ዝተወሰኸ) ማህደር `c0` ስክሪፕት ከምዚ ዝስዕብ ፍጠር፤

```bash
#!/usr/bin/env ባሽ ዝብል ጽሑፍ ኣሎ።
...
ድሕሪ ምፍጣር፡ ተግባራዊ ፍቓድን ሶፍት-ሊንክን `c1` `c2` .
...
ኣብ መጻኢ ብቐጥታ `c0` , `c1` ክትኣቱ ትኽእል ኢኻ ከምኡ ውን `mosh` ፍጥነት ዘለዎ ቀጥታዊ ምትእስሳር ተጠቒምካ [tmux](https://www.ruanyifeng.com/blog/2019/10/tmux.html)
...
`ssh-keygen -R ip` ኣሰር ኣጻብዕቲ ክመጽእ ከሎ ssh
...
ቅጽበታዊ ስእልታት ዝተቐመጡሎም ንኡሳን ጥራዛት ንምርኣይ `snapper list-configs`

<img alt="" src="https://i-01.eu.org/1718302689.avif">

ቅጽበታዊ ስእሊ ናይ ሓደ ንኡስ ጥራዝ ንምርኣይ `snapper -c mnt list`

`/etc/snapper/configs/mnt` ፍሉይ ናይ መጠባበቒ ቅጥዕታት ናይዚ ንኡስ ጥራዝ ክትዕዘብ ትኽእል ኢኻ።
...
ናብ ስርዓት ኡቡንቱ ዳግማይ ምጅማር፦ እዚ ኣብ ላዕሊ ዝተጠቕሰ ለውጢ ድሕሪ ምግባርና፡ ኣብ ክንዲ ስርዓተ ምድሓን ማሽንና ብንቡርን ናብ ስርዓተ ምድሓንና ናብ ስርዓት ኡቡንቱ ዳግማይ ምጅማር የድልየና።

በዚ መንገዲ እዚ systemd-journald በቲ ሓድሽ ውቅር ክጅምርን ምዝገባታት ብቐጻልነት ኣብ ሃርድ ዲስክ ክዕቅብ ክጅምርን እዩ።

እዞም ኣብ ላዕሊ ዝተጠቕሱ ስርሒታት ኣብ ስርዓተ ምድሓን ህይወት ዝፍጸሙ ምዃኖም ኣብ ግምት ኣእትዉ፣ ስለዚ እቶም ለውጥታት እቲ ስርዓት ዳግማይ ምስ ተጀመረን ድሕሪ ደጊም ኣብ ሞድ ምድሓን ምስ ዘይህሉን ጥራይ እዮም ተግባራዊ ዝኾኑ።

እዚ ማለት ኣብ ዝጸንሑ ምዝገባታት ዝኾነ ለውጢ ቀጻሊ ክኸውን ብኡንብኡ ኣይትርእዮን ኢኻ፣ እንተኾነ ግን ኩሎም ድሕሪ እዚ ዝፍጠሩ ምዝገባታት ክጸንሑ እዮም።
...
ድሕሪ ተደጋጋሚ መርመራታት `1001` tar ዝሰቐለ ተጠቃሚ `uid` ስለ ዝኾነ github action

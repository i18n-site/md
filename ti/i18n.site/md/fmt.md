...
ነቲ ኣተገባብራ ኣብ [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) ክትውከሱ ትኽእሉ ኢኹም፣ እቲ ኮድ ከምዚ ዝስዕብ እዩ :
...
## ስእልታት/ቪድዮታት/ሊንክ ብብዙሕ ቋንቋታት

`MarkDown` ናብ `HTML` ምስ ተቐየረ ኣብ ባህርያት `src` ን `href` ን ዘሎ `$LANG` በቲ ሕጂ ዘሎ [ናይ ቋንቋ ኮድ](/i18/LANG_CODE) ይትካእ ።

በዚ ተለዋዋጢ ቁጽሪ እዚ፡ ብዙሕ ቋንቋታት ናይ ስእልታት/ቪድዮታት/ሊንክታት ክትበጽሕ ትኽእል።
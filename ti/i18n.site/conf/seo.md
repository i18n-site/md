...
ኣብቲ ናይ ዲሞ ፕሮጀክት ዘሎ `.i18n/htm/ol.yml` ናይ ውቅር ፋይል ከም ኣብነት ንውሰድ
...
በጃኻ መጀመርታ ነቲ ኣብ ላዕሊ ዘሎ ዋጋ `host:` ናብ ስም ዓውዲኻ ኣዐርዮ፣ ከም `i18n.site` ።
...
ኣብቲ ውቅር፡ በጃኻ `i18n.site` ናብ ዋጋ `host:` ኣብ `.i18n/htm/ol.yml` ቀይሮ፡ ብዙሓት መኽዘናት ነገራት ኣብ ትሕቲ `s3` ክውነኑ ይኽእሉ፡ እቲ `region` ዓውዲ ድማ ኣማራጺ እዩ (ብዙሓት መኽዘናት ነገራት ነዚ ዓውዲ ምቕማጥ ኣየድልዮምን)።
...
## ምዕቡል ኣጠቓቕማ፦ ኣብ ዞባዊ ውሳነ መሰረት ትራፊክ ምክፍፋል
...
`R2` ብዝተፈላለየ ስም ዓውዲ `cloudflare` ስለዘይክእል፡ ስታትቲካዊ ፋይላት ንምቕማጥ ሳልሳይ ወገን መኽዘን ነገራት ምጥቃም የድሊ።

...
* `i18n.addon/toc` : ናይ ማውጫ ኢንዴክስ
  ኣብ `TOC` ዝተመርኮሰ `json` ናይ ማህደር መወከሲ ምፍጣር፣ ብነባሪ ዝንቀሳቐስ

* `i18n.addon/mouse` : ማውስ ጽልዋታት
...
እቲ ፕላግ-ኢን ብነባሪ መልክዑ ነቲ ዝሓሸ ስሪት ይጥቀምን ሰሙናዊ ምዕባለታት እንተሃልዩ ይምርምርን።
...
* `lang_li` ዝርዝር ቋንቋ፡ ቀዳማይ ቋንቋ ምንጪ ቋንቋ እዩ :
* `changed` ዝተመሓየሹ :
* `root` ሱር ማህደር :

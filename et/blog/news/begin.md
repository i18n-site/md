...
Tõlge on redigeeritav ja selle uuesti masintõlgimisel ei kirjutata tõlke käsitsi tehtud muudatusi üle (kui seda originaalteksti lõiku pole muudetud).
...
Näiteks ühendades staatilise dokumendi saidi sotsiaalmeedia ja e-posti tellimustega, saab värskenduste avaldamisel õigeaegselt kasutajateni jõuda.
...
Esiosa, tagaosa ja käsurea [koodid on kõik avatud lähtekoodiga](https://i18n.site/i18n.site/c/src) (tõlkemudel pole veel avatud lähtekoodiga).

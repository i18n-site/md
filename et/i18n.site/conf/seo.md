...
Kuna `R2` `cloudflare` pääse kohandatud domeeninimega juurde, tuleb staatiliste failide paigutamiseks kasutada kolmanda osapoole objektimälu.

Siin [backblaze.com](https://www.backblaze.com) näide, et näidata, kuidas siduda kolmanda osapoole objekte, mis salvestatakse `cloudflare` .
...
Muuda `cloudflare` → `SSL` , määra `Full`

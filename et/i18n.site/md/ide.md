...
[vscode](https://code.visualstudio.com/) `MarkDown` kirjutamiseks ja installime reaalajas eelvaate tegemiseks ka pistikprogrammi [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) .

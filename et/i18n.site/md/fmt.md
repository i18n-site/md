...
Ankurpunkti lahendus, mis on kokku lepitud `i18n.site` ga, on sisestada teksti, mis sarnaneb `<a rel=id href="#xxx" id="xxx"></a>` in `MarkDown` , et luua positsioneerimisankurpunkt käsitsi.
...
Pange tähele, et `<style>` on defineeritud ka ülaltoodud `<pre>` .
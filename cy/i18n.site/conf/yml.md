...
### `use: Md` , Templed Ffeil Sengl Heb Amlinelliad
...
### `use: Doc` , Templed Dogfen Aml-Ffeil
...
Mae'r dull ysgrifennu uchod yn cyfateb i gael `url: xxx` , a'r ffeil gyfatebol yw `en/xxx/TOC` .

#### Mynegai Tabl Cynnwys TOC

Bydd `i18n.site` yn gweithredu `js` plug-in `.i18n/hook/after.tran/TOC.js` yn y warws demo i ddarllen y ffeil mynegai `TOC` cyfeiriadur sy'n cyfateb i'r ffurfweddiad `doc` templed i gynhyrchu'r amlinelliad cyfeiriadur `json` .

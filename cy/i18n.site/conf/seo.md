...
Er enghraifft, `cloudflare` [Huawei Cloud DNS](https://www.huaweicloud.com)
...
Oherwydd `cloudflare` cyrchu'r `R2` trwy ddefnyddio enw parth wedi'i addasu, mae angen defnyddio storfa gwrthrychau trydydd parti i osod ffeiliau statig.

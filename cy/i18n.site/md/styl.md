...
[Cliciwch yma i bori trwy ffeil ffynhonnell y dudalen hon](//raw.githubusercontent.com/i18n-site/md/refs/heads/main/$LANG/i18n.site/md/styl.md) i weld sut i ysgrifennu `MarkDown` yn yr arddulliau canlynol.
...
Mae parser `MarkDown` yr offeryn adeiladu gwefan `i18n.site` wedi optimeiddio'r tanlinelliad, y streic, a'r gystrawen feiddgar Gall ddod i rym heb fylchau cyn ac ar ôl y marc, gan ei gwneud hi'n haws ysgrifennu dogfennau mewn ieithoedd fel Tsieina, Japan, a Korea. nad ydynt yn defnyddio gofodau fel gwahanyddion.
...
> [!WARN]
> Wrth fynd ar antur wyllt, mae’n bwysig cadw’n ddiogel.
> Yr wythnos diwethaf, daeth criw o ddringwyr ar draws storm hanner ffordd i fyny'r mynydd a bu'n rhaid iddynt adael oherwydd iddynt fethu â gwirio rhagolygon y tywydd.
> Cofiwch, mae angen paratoi a rhoi sylw digonol i'r tywydd ar gyfer unrhyw weithgaredd awyr agored.

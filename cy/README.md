...
Yn y ffrwydrad gwybodaeth a'r farchnad fyd-eang, er mwyn cystadlu am sylw prin, **mae cefnogi ieithoedd lluosog yn sgil sylfaenol** .
...
## <a rel=id href="#project" id="project"></a> Disgrifiad o'r Prosiect

Ar hyn o bryd mae'r wefan hon yn darparu dau offeryn llinell gorchymyn ffynhonnell agored:

* [i18 : MarkDown cyfieithu llinell orchymyn](/i18/feature)
* [i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Offeryn cyfieithu llinell orchymyn MarkDown

Cyfieithwch `Markdown` a `YAML` i offeryn llinell orchymyn ( [cod ffynhonnell](https://github.com/i18n-site/rust/tree/main/i18) ) mewn sawl iaith.

Yn gallu cynnal fformat `Markdown` Yn gallu adnabod addasiadau ffeil a chyfieithu ffeiliau sydd wedi newid yn unig.
...
Rydym yn rhannu `UNIX` " is a File " a gallwn reoli cyfieithiadau mewn cannoedd o ieithoedd heb gyflwyno atebion cymhleth a beichus ar lefel menter.

Gallwch ddefnyddio'r offer mwyaf cyfarwydd i `Markdown` cyfieithiad (ond ni allwch ychwanegu neu ddileu paragraffau), a defnyddio'r ffordd fwyaf cyfarwydd i reoli fersiwn.

Gellir creu sylfaen cod fel ffynhonnell agored ar gyfer ffeiliau iaith, a gyda chymorth proses `Pull Request` , gall defnyddwyr byd-eang gymryd rhan yn y broses barhaus o optimeiddio cyfieithiadau. Cysylltiad di-dor [github](//github.com) A chymunedau ffynhonnell agored eraill.

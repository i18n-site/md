...
Weithiau nid y trosiad o `HTML` → `MarkDown` yw'r hyn yr ydym ei eisiau, megis trosi `<a href="/">Home</a>` i `[Home](/)` .

Gall ychwanegu unrhyw briodwedd heblaw `href` at y tag `a` , megis `<a class="A" href="/">Home</a>` , osgoi'r trosi hwn.

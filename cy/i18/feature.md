...
Ar gyfer rhaglenwyr sy'n gyfarwydd â `git` , `vim` , a `vscode` , bydd defnyddio'r offer hyn i olygu dogfennau a rheoli fersiynau yn ddi-os yn cynyddu'r gost dysgu.
...
Mae yna hefyd rai offer cyfieithu llinell orchymyn, megis [translate-shell](https://github.com/soimort/translate-shell)
...
Gall `i18` adnabod y teitl yn `MarkDown` , a bydd yn priflythrennu'r llythyren gyntaf yn awtomatig wrth ei chyfieithu i iaith sy'n sensitif i achos.
...
DeepL yr uchod i'r Ffrangeg (gan ailysgrifennu'r enwau priodol hefyd ac ychwanegu'r od `... ` ):
...
Mae'r cleient yn ffynhonnell gwbl agored, ac mae ochr y 90 % o'r cod yn ffynhonnell agored [Cliciwch yma i weld y cod ffynhonnell](/i18n.site/src) .

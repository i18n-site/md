...
Yn cefnogi cyfieithu cymysg HTML Markdown nid yw'r cynnwys yn y tagiau `<pre>` a `<code>` o HTML wedi'i fewnosod yn `MarkDown` wedi'i gyfieithu
...
Yn cefnogi cyfluniad pennawd blog statig math [HOGO](https://github.com/gohugoio/hugo) , sydd ond yn cyfieithu meysydd `title` , `summary` a `description` .

...
HTML Markdown च्या भाषांतरास समर्थन देते, `MarkDown` मध्ये एम्बेड केलेल्या HTML च्या `<pre>` आणि `<code>` टॅगमधील सामग्री भाषांतरित केलेली नाही
...
स्टॅटिक ब्लॉगच्या हेडर कॉन्फिगरेशनला सपोर्ट करते [HOGO](https://github.com/gohugoio/hugo) जे फक्त `title` , `summary` आणि `description` फील्डचे भाषांतर करते.
...
जपानी `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` अनुवादित :

![](//p.3ti.site/1720199391.avif)

फ्रेंच `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` अनुवादित :

`Falcon` चे भाषांतर `faucon` आणि `Llama` चे भाषांतर `lama` असे केले आहे. योग्य संज्ञा म्हणून, त्यांचे भाषांतर केले जाऊ नये.

![](//p.3ti.site/1720199451.avif)

### डीपएल अनुवाद

जपानी `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` अनुवादित :

![](//p.3ti.site/1720199550.avif)

वरीलचे DeepL भाषांतर (योग्य नावे पुन्हा लिहा आणि विषम `... ` जोडणे):

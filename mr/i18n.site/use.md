...
`dev.yml` आणि `ol.yml` ही डीफॉल्ट कॉन्फिगरेशन आहेत.
...
`ol` हे `online` चे संक्षेप आहे, जे ऑनलाइन वातावरण दर्शवते, जे अधिकृत प्रकाशनासाठी वापरले जाते तेव्हा कमांड लाइन पॅरामीटर्स `-n` ते `npm` वापरताना ती डीफॉल्ट कॉन्फिगरेशन फाइल असते.
...
फक्त [npmjs.com](//npmjs.com) पॅकेजचे नाव वापरा.

पॅकेज `npm` वर आधारित प्रकाशित करताना, `v:` मूल्याच्या उपसर्गासाठी **`//unpkg.com/` वापरण्याचे सुनिश्चित** करा `i18n.site` नवीन प्रकाशनांचे वेळेवर पाहण्यासाठी या उपसर्ग मार्ग अंतर्गत `/.v` चा कॅशे वेळ विशेषत: अनुकूल केला आहे.

भाषांतर आणि प्रकाशित करण्यासाठी `md` निर्देशिकेत `i18n.site --npm` किंवा `i18n.site -n` चालवा.

तुम्ही प्रकाशित करण्यासाठी सतत एकीकरण वातावरण वापरत असल्यास, `nodejs` स्थापित करण्याची आवश्यकता नाही, फक्त लॉग इन आणि प्रकाशन परवानगी `~/.npmrc` पर्यावरणात कॉपी करा.
...
त्यानंतर, मुख्य भूभागातील क्लाउड विक्रेत्यांचे ऑब्जेक्ट स्टोरेज वापरा + खालील सामग्री तैनात करा `CDN` `out/ol/htm`
...
कृपया `server` nginx खालीलप्रमाणे कॉन्फिगरेशन जोडा कृपया तुमच्या स्वतःच्या प्रकल्प `out/ol/htm` च्या मार्गावर `/root/i18n/md/out/ol/htm` बदला:

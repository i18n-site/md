...
चालवल्यानंतर, भाषांतर आणि कॅशे `git add . ` तयार केल्या `md` .
...
उदाहरणार्थ, `.i18n/htm/ol.yml` `out/ol` निर्देशिका तयार करेल.

`dev.yml` आणि `ol.yml` डीफॉल्ट कॉन्फिगरेशन आहेत.

`dev` हे `development` चे संक्षेप आहे, जे विकासाचे वातावरण दर्शवते, स्थानिक पूर्वावलोकनासाठी वापरले जाते, आणि डीफॉल्ट कॉन्फिगरेशन फाइल देखील आहे.
...
वापरण्यासाठी कॉन्फिगरेशन फाइलचे नाव निर्दिष्ट करण्यासाठी तुम्ही कमांड लाइनवर `--htm_conf` वापरा इतर कॉन्फिगरेशन फाइल्स देखील तयार करू शकता:
...
`md/.i18n/htm/ol.yml` संपादित करा आणि `v: //unpkg.com/i18n.site` मध्ये `i18n.site` ला तुमच्या स्वतःच्या `npm` पॅकेज नावात बदला.

फक्त अनक्युपीड पॅकेजचे नाव वापरा [npmjs.com](//npmjs.com)

पॅकेज `npm` वर आधारित प्रकाशित करताना, `v:` मूल्याच्या उपसर्गासाठी **`//unpkg.com/` वापरण्याचे सुनिश्चित करा** `i18n.site` ने नवीन प्रकाशनांचे वेळेवर पाहण्यासाठी या उपसर्ग मार्ग अंतर्गत `/.v` चा कॅशे वेळ विशेषत: अनुकूल केला आहे.
...
तुम्ही `ol.yml` मधील `v:` चे पॅकेज नाव बदलल्यास, कृपया **प्रथम `.i18n/v/ol` हटवण्याचे सुनिश्चित करा** आणि नंतर ते प्रकाशित करा.
...
तुम्हाला सामग्री स्व-होस्ट करायची असल्यास, प्रथम `md/.i18n/htm/ol.yml` संपादित करा आणि `v: //unpkg.com/i18n.site` ला तुमच्या URL उपसर्गात बदला, जसे की `v: //i18n-v.xxx.com` .
...
त्यानंतर, `md/out/ol/v` निर्देशिकेतील सामग्री `v:` मध्ये सेट केलेल्या URL उपसर्ग मार्गावर कॉन्फिगर करा.

शेवटी, **`/.v` ते `1s` मध्ये समाप्त होणाऱ्या मार्गाचा कॅशे वेळ कॉन्फिगर करा** , अन्यथा नवीन रिलीज झालेल्या सामग्रीमध्ये त्वरित प्रवेश केला जाऊ शकत नाही.
...
स्वयं-होस्ट सामग्रीसाठी, आपला स्वतःचा सर्व्हर वापरण्याव्यतिरिक्त, `S3` + वापरणे `CDN` दुसरा सामान्य पर्याय आहे.

तुम्ही `S3` सर्व्हरवर लॉग इन करण्यासाठी [rclone](https://rclone.org) शकता, नंतर खालील स्क्रिप्ट पहा आणि सुधारित करा आणि प्रत्येक प्रकाशनासाठी फक्त `S3` मध्ये वाढीव बदल कॉपी करा.
...
मागील लेखातील सामग्री प्रकाशित करताना, `out/ol/htm` तयार केले गेले आहे कृपया ही निर्देशिका प्रविष्ट करा आणि चालवा :
...
नंतर `htm` निर्देशिकेत खालील कमांड चालवा ( `i18n-demo/i18n-demo.github.io.git` ला तुमच्या स्वतःच्या वेअरहाऊस पत्त्याने बदलण्याचे लक्षात ठेवा) :
...
`github page` [cloudflare page](//pages.cloudflare.com) तुलनेत, हे मार्ग पुनर्लेखन प्रदान करते आणि मुख्य भूभाग चीनसाठी अधिक अनुकूल आहे आणि ते वापरण्याची शिफारस केली जाते.
...
तुम्ही दुसऱ्या संस्थेचे वेअरहाऊस बांधले असल्यास, नवीन संस्था प्रदर्शित होण्यापूर्वी दोनदा अधिकृत करण्यासाठी तुम्हाला `Add Account` दोनदा क्लिक करावे लागेल.
...
वरील चित्रातील `i18n.site` खालीलप्रमाणे आहेत.
...
त्यानंतर, मुख्य भूभागातील क्लाउड विक्रेत्यांचे ऑब्जेक्ट स्टोरेज वापरा + खालील सामग्री तैनात `out/ol/htm` `CDN`
...
[अलीबाबा CDN](https://cdn.console.aliyun.com/domain/list) डोमेन नाव जोडा आणि अलीबाबा क्लाउड `CDN` मध्ये डोमेन नाव `*.xxx.com` ते `CNAME` दर्शवा.
...
nginx `server` परिच्छेदातील खालीलप्रमाणे कॉन्फिगरेशन जोडा कृपया तुमच्या स्वतःच्या प्रकल्प `out/ol/htm` च्या मार्गावर `/root/i18n/md/out/ol/htm` बदला:

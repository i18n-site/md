...
`i18n.site` नॉन-रिफ्रेश सिंगल `sitemap.xml` आर्किटेक्चरचा अवलंब करते.
...
उदाहरण म्हणून डेमो प्रोजेक्टमधील `.i18n/htm/ol.yml` कॉन्फिगरेशन फाइल घ्या
...
कृपया प्रथम वरील `host:` चे मूल्य तुमच्या डोमेन नावात बदला, जसे की `i18n.site` .
...
कॉन्फिगरेशनमध्ये, कृपया `i18n.site` चे मूल्य `host:` मधील `.i18n/htm/ol.yml` मध्ये बदला, एकाधिक ऑब्जेक्ट स्टोअर `s3` अंतर्गत कॉन्फिगर केले जाऊ शकतात आणि `region` फील्ड पर्यायी आहे (अनेक ऑब्जेक्ट स्टोअरला हे फील्ड सेट करण्याची आवश्यकता नाही).
...
`URL redirect` डायनॅमिक रीडायरेक्शन निवडा, कृपया रीडायरेक्शन पथ `concat("/en",http.request.uri.path,".htm")` मध्ये `/en` मध्ये बदल करा ज्यात तुम्हाला शोध इंजिन समाविष्ट करायचे आहे.
...
सानुकूलित डोमेन नावाने `R2` मध्ये प्रवेश करता `cloudflare` , स्टॅटिक फाइल्स ठेवण्यासाठी थर्ड-पार्टी ऑब्जेक्ट स्टोरेज वापरणे आवश्यक आहे.

`cloudflare` वर संग्रहित करण्यासाठी थर्ड-पार्टी ऑब्जेक्ट्स कसे बांधायचे हे दाखवण्यासाठी आम्ही येथे एक उदाहरण [backblaze.com](https://www.backblaze.com) .

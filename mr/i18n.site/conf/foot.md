...
* `conf.css` : चिन्ह आणि फॉन्ट

### आयकॉन फॉन्ट

तळटीप चिन्ह iconfont.cn `F` फॉन्ट तयार करून तयार केला जातो ( [इंग्रजी आवृत्ती](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
दुव्यावर `class="a"` जोडणे म्हणजे दुव्याचे `MarkDown` मध्ये रूपांतर होण्यापासून रोखणे. पहा :
 [➔ `YAML` : लिंक `HTML` ला `Markdown` मध्ये रूपांतरित होण्यापासून कसे रोखायचे](/i18/qa#H2) .
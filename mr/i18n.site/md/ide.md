...
आम्ही `MarkDown` [vscode](https://code.visualstudio.com/) वापरतो आणि लिहिताना रिअल टाइममध्ये पूर्वावलोकन करण्यासाठी प्लग-इन [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) स्थापित करतो.

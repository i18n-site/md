...
पोझिशनिंग अँकर पॉइंट मॅन्युअली तयार करण्यासाठी `i18n.site` सह सहमत असलेला अँकर पॉइंट सोल्यूशन म्हणजे `<a rel=id href="#xxx" id="xxx"></a>` मध्ये `MarkDown` सारखा मजकूर घालणे.

`<a rel=id href="#xxx" id="xxx"></a>` , येथे `rel=id` अँकर पॉइंटची पृष्ठ शैली परिभाषित करते, कृपया `xxx` ला तुमच्या वास्तविक अँकर इंग्रजी संक्षेपाने बदला.

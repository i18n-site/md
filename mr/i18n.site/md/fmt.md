...
## अनेक भाषांमधील चित्रे/व्हिडिओ/लिंक

`MarkDown` रूपांतर `HTML` मध्ये केल्यानंतर, `src` आणि `href` मधील `$LANG` वर्तमान [भाषा कोडने](/i18/LANG_CODE) बदलले जातील.

या व्हेरिएबलसह, तुम्ही चित्रे/व्हिडिओ/लिंकचे बहुभाषिकीकरण साध्य करू शकता.
...
ఫార్మాట్కు హాని కలిగించకుండా మార్క్డౌన్ పట్టికల అనువాదానికి మద్దతు ఇస్తుంది; గణిత సూత్రాలు లేదా లింక్లలో పదాలను అనువదించదు.

Markdown `MarkDown` పొందుపరిచిన HTML `<pre>` మరియు `<code>` ట్యాగ్లలోని కంటెంట్ HTML
...
అనువాద వ్యాఖ్యలు ` ```rust ` వంటి ` ``` ` తర్వాత భాషను సూచించాలి :
...
`KISS` ( `Keep It Simple, Stupid` ) సూత్రాలను నమ్మేవారిలో, ఎంటర్ప్రైజ్-స్థాయి పరిష్కారాలు గజిబిజిగా, అసమర్థంగా మరియు ఉపయోగించడం కష్టంగా ఉంటాయి.
...
`title` , `summary` మరియు `description` ఫీల్డ్లను మాత్రమే అనువదించే స్టాటిక్ బ్లాగ్ రకం యొక్క హెడర్ కాన్ఫిగరేషన్కు మద్దతు ఇస్తుంది [HOGO](https://github.com/gohugoio/hugo)
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` అనువదించబడింది :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` అనువదించబడింది :

`Falcon` ని `faucon` గా మరియు `Llama` ని `lama` గా అనువదించారు. సరైన నామవాచకాలుగా, వాటిని అనువదించకూడదు.

![](//p.3ti.site/1720199451.avif)

### లోతైన అనువాదం

`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` అనువదించబడింది :

![](//p.3ti.site/1720199550.avif)

DeepL పైన పేర్కొన్న వాటిని ఫ్రెంచ్లోకి అనువదించడం (సరైన పేర్లను తిరిగి వ్రాయడం మరియు బేసి `... ` జోడించడం):
...
ఆంగ్ల పదం మరియు చైనీస్, జపనీస్ మరియు కొరియన్ టెక్స్ట్ల మధ్య ఖాళీ లేదా ఆంగ్ల పొడవు 1 కంటే ఎక్కువగా ఉన్నప్పుడు మాత్రమే, పదం పదంగా పరిగణించబడుతుంది.

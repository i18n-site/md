...
### రిపోజిటరీకి ఫైల్లను జోడించండి

అనువాదంతో పాటు, ప్రోగ్రామ్ కింది ఫైల్లను కూడా రూపొందిస్తుంది, దయచేసి వాటిని రిపోజిటరీకి జోడించండి.
...
వాటిలో, `.i18n/cache/.gitignore` యొక్క కంటెంట్ క్రింది విధంగా ఉంది :
...
డైరెక్టరీ `.i18n/cache/` ( `.i18n/cache/.gitignore` మినహా)లోని అన్ని ఫైల్లు విస్మరించబడతాయని దీని అర్థం.

మీ సంస్కరణ నియంత్రణ సాఫ్ట్వేర్ `git` కాకపోతే, దయచేసి ఈ కాన్ఫిగరేషన్ ప్రకారం దాన్ని విస్మరించండి.

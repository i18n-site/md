...
భాషా కోడ్‌ల సంఖ్య స్థిరంగా ఉంది మరియు కొత్త భాషలు తర్వాత జోడించబడతాయి.

| క్రమ సంఖ్య | కోడ్ | భాష | ప్రదర్శన పేరు |
| - | - | - | - |
| 0 | `en` | ఆంగ్ల | `English` |
| 1 | `zh` | సరళీకృత చైనీస్ | `简体中文` |
| 2 | `de` | జర్మన్ | `Deutsch` |
...
| 80 | `bho` | భోజ్‌పురి | `Bhojpuri` |
| 81 | `zh-TW` | సాంప్రదాయ చైనీస్ | `正體中文` |

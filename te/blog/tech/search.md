...
ఈ కథనం `i18n.site` స్వచ్ఛమైన ఫ్రంట్-ఎండ్ పూర్తి-వచన శోధన సాంకేతికత యొక్క అమలును భాగస్వామ్యం చేస్తుంది, [i18n.site](//i18n.site) శోధన ప్రభావాన్ని అనుభవించవచ్చు.

కోడ్ ఓపెన్ సోర్స్ [శోధన](//github.com/i18n-site/ie/tree/main/qy) [కెర్నల్](//github.com/i18n-site/plugin/tree/main/qy) /

## సర్వర్లెస్ పూర్తి-వచన శోధన పరిష్కారాల యొక్క అవలోకనం

పూర్తిగా స్థిరంగా ఉండే డాక్యుమెంట్లు/వ్యక్తిగత బ్లాగుల వంటి చిన్న వెబ్సైట్ల కోసం, నిస్సందేహంగా పూర్తి-టెక్స్ట్ సెర్చ్ బ్యాకెండ్ను మీరే నిర్మించడం చాలా భారంగా ఉంటుంది మరియు సేవలు లేకుండా పూర్తి-టెక్స్ట్ శోధన నిస్సందేహంగా మెరుగైన బరువు.

ఇప్పటికే ఉన్న సర్వర్లెస్ ఫుల్-టెక్స్ట్ సెర్చ్ సొల్యూషన్లు రెండు విస్తృత వర్గాలలోకి వస్తాయి.

ఒకటి [algolia.com](//algolia.com) ఇది ఫ్రంట్-ఎండ్ ఫుల్-టెక్స్ట్ సెర్చ్ కాంపోనెంట్లను అందిస్తుంది.

ఇటువంటి సేవలకు చెల్లింపు అవసరం మరియు వెబ్సైట్ సమ్మతి సమస్యల కారణంగా చైనా ప్రధాన భూభాగంలోని వినియోగదారులకు అందుబాటులో ఉండదు.
...
మరింత ప్రసిద్ధి చెందిన స్వచ్ఛమైన ఫ్రంట్-ఎండ్ పూర్తి-వచన శోధనలు మరియు [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) [lunrjs](https://lunrjs.com)

`lunrjs` సూచికలను రూపొందించడానికి రెండు మార్గాలు ఉన్నాయి, కానీ రెండింటికీ వాటి స్వంత సమస్యలు ఉన్నాయి.
...
2. పత్రాలను లోడ్ చేయండి మరియు ఫ్లైలో సూచికలను రూపొందించండి
   ...
   ఇండెక్స్ను రూపొందించడం అనేది మీరు దాన్ని యాక్సెస్ చేసిన ప్రతిసారీ ఇండెక్స్ను పునర్నిర్మించడం అనేది స్పష్టమైన లాగ్స్ మరియు పేలవమైన వినియోగదారు అనుభవాన్ని కలిగిస్తుంది.

`lunrjs` తో పాటు, : వంటి కొన్ని పూర్తి-వచన శోధన పరిష్కారాలు కూడా ఉన్నాయి.

[fusejs](https://www.fusejs.io) , శోధించడానికి తీగల మధ్య సారూప్యతను లెక్కించండి.

ఈ పరిష్కారం యొక్క పనితీరు చాలా తక్కువగా ఉంది మరియు పూర్తి-వచన శోధన కోసం ఉపయోగించబడదు (చూడండి [Fuse.js సుదీర్ఘ ప్రశ్నకు 10 సెకన్ల కంటే ఎక్కువ సమయం పడుతుంది, దీన్ని ఎలా ఆప్టిమైజ్ చేయాలి?](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

[TinySearch](https://github.com/tinysearch/tinysearch) , శోధించడానికి బ్లూమ్ ఫిల్టర్ని ఉపయోగించండి, ఉపసర్గ శోధన కోసం ఉపయోగించబడదు (ఉదాహరణకు, `goo` , శోధన `good` , `google` ) మరియు అదే విధమైన స్వయంచాలక పూర్తి ప్రభావాన్ని సాధించలేరు.

ఇప్పటికే ఉన్న పరిష్కారాల లోపాలతో అసంతృప్తితో, `i18n.site` కొత్త స్వచ్ఛమైన ఫ్రంట్-ఎండ్ ఫుల్-టెక్స్ట్ సెర్చ్ సొల్యూషన్ను అభివృద్ధి చేసింది, ఇది క్రింది లక్షణాలను కలిగి ఉంది :
...
1. ఉపసర్గ శోధనకు మద్దతు ఇస్తుంది, ఇది వినియోగదారు టైప్ చేస్తున్నప్పుడు శోధన ఫలితాలను నిజ సమయంలో ప్రదర్శించగలదు.
...
వర్డ్ సెగ్మెంటేషన్ బ్రౌజర్ యొక్క స్థానిక పద విభజనను ఉపయోగిస్తుంది `Intl.Segmenter` , మరియు అన్ని ప్రధాన స్రవంతి బ్రౌజర్లు ఈ ఇంటర్ఫేస్కు మద్దతు ఇస్తాయి.
...
ఫ్రంట్-ఎండ్ ఇంటరాక్షన్లో, మొదటి సారి లోడ్ అవుతున్నప్పుడు లాగ్ను నివారించడానికి ఇండెక్స్ యొక్క లోడ్ ప్రోగ్రెస్ బార్ ప్రదర్శించబడుతుంది "ఒకే ఆధారంగా progress + ప్యూర్ css ఇంప్లిమెంటేషన్" [ఇంగ్లీష్](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [చైనీస్](https://juejin.cn/post/7413586285954154522) .

### IndexedDB అధిక ఏకకాలిక రచన

యొక్క అసమకాలిక ఎన్క్యాప్సులేషన్ ఆధారంగా ప్రాజెక్ట్ [idb](https://www.npmjs.com/package/idb) IndexedDB
...
వినియోగదారు ఇన్పుట్ ట్రిగ్గర్ చేసే శోధనల ఫ్రీక్వెన్సీని తగ్గించడానికి మరియు గణన మొత్తాన్ని తగ్గించడానికి ఫ్రంట్-ఎండ్ ఇంటరాక్షన్లో యాంటీ-షేక్ ఫంక్షన్ `debounce` కూడా ఉపయోగించబడుతుంది (ఈ క్రింది విధంగా అమలు చేయబడింది).
...
మొదట ప్రదర్శించబడిన శోధన ఫలితాలు ప్రశ్న యొక్క ఖచ్చితత్వాన్ని నిర్ధారిస్తాయి మరియు తర్వాత లోడ్ చేయబడిన ఫలితాలు (లోడ్ మోర్ బటన్ను క్లిక్ చేయండి) రీకాల్ రేట్ను నిర్ధారిస్తాయి.
...
విలోమ పూర్తి-వచన శోధన పూర్తిగా ఫ్రంట్ ఎండ్లో అమలు చేయబడుతుంది, వేగవంతమైన ప్రతిస్పందనతో మరియు సర్వర్ అవసరం లేదు.

పత్రాలు మరియు వ్యక్తిగత బ్లాగులు వంటి చిన్న మరియు మధ్య తరహా వెబ్సైట్లకు ఇది చాలా అనుకూలంగా ఉంటుంది.
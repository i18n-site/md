...
`npm` లో లోడ్ చేయబడిన , [unpkg.com](//unpkg.com) మరియు ఇతర బహుళ `CDN` కంటెంట్ [jsdelivr.com](//jsdelivr.com) `i18n.site` డిఫాల్ట్గా సైట్ కంటెంట్ను `npmjs.com` కి ప్రచురిస్తుంది.
...
సూత్రం: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) తో అభ్యర్థనలను అడ్డగించండి, ఇతర `CDN` లలో విఫలమైన అభ్యర్థనలను మళ్లీ ప్రయత్నించండి మరియు డిఫాల్ట్ లోడ్ సోర్స్గా వేగంగా స్పందించే మూలం సైట్ను అనుకూలీకరించండి.
...
> ఇది అనవసరమైన అలంకరణను వదిలివేస్తుంది మరియు దాని స్వచ్ఛమైన రూపంలో కంటెంట్ను అందిస్తుంది.
...
పైన ఉన్న చిత్రం సబ్స్క్రిప్షన్ `i18n.site` `RSS` బహుళ-భాషను చూపుతుంది [inoreader.com](//inoreader.com)

### ఆన్లైన్ ఫాంట్లను లోడ్ చేయండి, చైనీస్కు మద్దతు ఇవ్వండి

డిఫాల్ట్గా, వివిధ ప్లాట్ఫారమ్లలో వినియోగదారుల పఠన అనుభవాన్ని ఏకీకృతం చేయడానికి [అలిమామా డ్యూయల్-యాక్సిస్ వేరియబుల్ దీర్ఘచతురస్రాకార ఫాంట్లు](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) ఇతర ఆన్లైన్ ఫాంట్లు వెబ్పేజీలో ప్రారంభించబడ్డాయి.
...
కూల్ స్పెషల్ ఎఫెక్ట్లను చూడటానికి ఎగువ నావిగేషన్కు కుడి వైపున ఉన్న బటన్పై మీ మౌస్ని ఉంచండి.

### `404` చిన్న దెయ్యం

`404` పేజీలో అందమైన చిన్న తేలియాడే దెయ్యం ఉంది, దాని కళ్ళు మౌస్తో కదులుతాయి, [➔ వీక్షించడానికి ఇక్కడ క్లిక్ చేయండి](/404) ,

## కోడ్ ఓపెన్ సోర్స్

[కోడ్ ఓపెన్ సోర్స్](/i18n.site/src) , మీరు డెవలప్మెంట్లో పాల్గొనడానికి ఆసక్తి కలిగి ఉంటే, దయచేసి మిమ్మల్ని [మెయిలింగ్ జాబితాకు](//groups.google.com/u/2/g/i18n-site) పరిచయం చేసుకోండి.

ముఖ్యమైనవి కానీ అత్యవసరం కాని అనేక చిన్న అవసరాలు ఉన్నాయి, అభివృద్ధి బృందం మీకు బాగా ఉన్న సాంకేతికతకు అనుగుణంగా ప్రాక్టీస్ టాస్క్లను కేటాయిస్తుంది మరియు అవసరాలను కేటాయించేటప్పుడు అభివృద్ధి పత్రాలను మెరుగుపరుస్తుంది.
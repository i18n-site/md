...
## బహుళ భాషలలో చిత్రాలు/వీడియోలు/లింకులు

`MarkDown` `HTML` కి మార్చబడిన తర్వాత, `src` మరియు `href` లక్షణాలలో `$LANG` ప్రస్తుత [భాషా కోడ్తో](/i18/LANG_CODE) భర్తీ చేయబడుతుంది.

ఈ వేరియబుల్తో, మీరు చిత్రాలు/వీడియోలు/లింక్ల బహుభాషాీకరణను సాధించవచ్చు.
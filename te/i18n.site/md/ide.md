...
మేము `MarkDown` వ్రాయడానికి మరియు వ్రాస్తున్నప్పుడు నిజ సమయంలో ప్రివ్యూ చేయడానికి ప్లగ్-ఇన్ [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ఇన్స్టాల్ చేయడానికి [vscode](https://code.visualstudio.com/) .
...
ఫైల్ `Markdown` ని తెరవడానికి `vscode` కాల్ చేయడానికి కమాండ్ లైన్లో `code xxx.md` నమోదు చేయండి.

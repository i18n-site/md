...
ప్యాకేజీ `npm` ఆధారంగా ప్రచురించేటప్పుడు, `v:` విలువ యొక్క ఉపసర్గ కోసం **`//unpkg.com/` ఉపయోగించాలని నిర్ధారించుకోండి** `i18n.site` కొత్త విడుదలలను సకాలంలో వీక్షించడానికి ఈ ఉపసర్గ మార్గంలో `/.v` యొక్క కాష్ సమయాన్ని ప్రత్యేకంగా ఆప్టిమైజ్ చేసింది.
...
దయచేసి `server` nginx కిందివాటికి సారూప్యమైన కాన్ఫిగరేషన్ను జోడించండి `/root/i18n/md/out/ol/htm` మీ స్వంత ప్రాజెక్ట్ `out/ol/htm` కి మార్చండి:

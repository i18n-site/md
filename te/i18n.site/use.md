...
#### <a rel=id href="#npm" id="npm"></a> కంటెంట్ను npmjs.comకు ప్రచురించండి
...
`md/.i18n/htm/ol.yml` సవరించండి మరియు `v: //unpkg.com/i18n.site` లో `i18n.site` మీ స్వంత `npm` ప్యాకేజీ పేరుకు మార్చండి.
...
మీరు ప్రచురించడానికి నిరంతర ఏకీకరణ వాతావరణాన్ని ఉపయోగిస్తే, `nodejs` ఇన్స్టాల్ చేయాల్సిన అవసరం లేదు, లాగిన్ చేసి, పబ్లిషింగ్ అనుమతి `~/.npmrc` పర్యావరణానికి కాపీ చేయండి.
...
మునుపటి కథనంలోని కంటెంట్ను : , దయచేసి ఈ డైరెక్టరీని నమోదు చేసి రన్ చేయండి `out/ol/htm`
...
మొదటిసారి బైండింగ్ చేసిన తర్వాత, మీరు దీన్ని యాక్సెస్ చేయడానికి ముందు కొన్ని నిమిషాలు వేచి ఉండాలి.

...
సమాచార విస్ఫోటనం మరియు ప్రపంచ మార్కెట్తో, అరుదైన శ్రద్ధ కోసం పోటీ పడేందుకు, **బహుళ భాషలకు మద్దతు ఇవ్వడం ప్రాథమిక నైపుణ్యం** .
...
## <a rel=id href="#project" id="project"></a> ప్రాజెక్ట్ వివరణ

ఈ సైట్ ప్రస్తుతం రెండు ఓపెన్ సోర్స్ కమాండ్ లైన్ సాధనాలను అందిస్తుంది:

* [కమాండ్ లైన్ అనువాద i18 : MarkDown](/i18/feature)
* [i18n.site : బహుళ భాషా స్టాటిక్ వెబ్సైట్ జనరేటర్](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: MarkDown కమాండ్ లైన్ అనువాద సాధనం

`Markdown` మరియు `YAML` బహుళ భాషలలో కమాండ్ లైన్ సాధనం ( [సోర్స్ కోడ్](https://github.com/i18n-site/rust/tree/main/i18) )లోకి అనువదించండి.

యొక్క ఆకృతిని సంపూర్ణంగా నిర్వహించగలదు `Markdown` ఫైల్ సవరణలను గుర్తించగలదు మరియు మార్చబడిన ఫైల్లను మాత్రమే అనువదించగలదు.
...
మేము ప్రతిదీ ఒక ఫైల్ " `UNIX` " పంచుకుంటాము మరియు సంక్లిష్టమైన మరియు గజిబిజిగా ఉండే ఎంటర్ప్రైజ్-స్థాయి పరిష్కారాలను పరిచయం చేయకుండా వందలాది భాషల్లో అనువాదాలను నిర్వహించగలము.

మీరు అనువాదాన్ని `Markdown` అత్యంత సుపరిచితమైన సాధనాలను ఉపయోగించవచ్చు (కానీ మీరు పేరాగ్రాఫ్లను జోడించలేరు లేదా తొలగించలేరు), మరియు సంస్కరణ నియంత్రణ చేయడానికి అత్యంత సుపరిచితమైన మార్గాన్ని ఉపయోగించవచ్చు.

భాషా ఫైల్ల కోసం ఒక కోడ్ బేస్ను ఓపెన్ సోర్స్గా సృష్టించవచ్చు మరియు `Pull Request` యొక్క ప్రక్రియ సహాయంతో గ్లోబల్ యూజర్లు అనువాదాల నిరంతర ఆప్టిమైజేషన్లో పాల్గొనవచ్చు. అతుకులు లేని కనెక్షన్ [github](//github.com) ఇతర ఓపెన్ సోర్స్ కమ్యూనిటీలు.

[→ వినియోగదారు గైడ్ కోసం, దయచేసి ప్రాజెక్ట్ డాక్యుమెంటేషన్ చదవండి](/i18) .
...
పూర్తిగా స్టాటిక్, పఠన అనుభవం కోసం ఆప్టిమైజ్ చేయబడింది మరియు [i18](#i18) ప్రాజెక్ట్ డాక్యుమెంట్ సైట్ను రూపొందించడానికి ఇది ఉత్తమ ఎంపిక.
...
ఈ వెబ్సైట్ ఈ ఫ్రేమ్వర్క్ ఆధారంగా అభివృద్ధి చేయబడింది మరియు వినియోగదారు, చెల్లింపు మరియు ఇతర ఫంక్షన్లను కలిగి ఉంటుంది ( [సోర్స్ కోడ్](/i18n.site/src) ) వివరణాత్మక ట్యుటోరియల్ తర్వాత వ్రాయబడుతుంది.

[→ వినియోగదారు గైడ్ కోసం, దయచేసి ప్రాజెక్ట్ డాక్యుమెంటేషన్ చదవండి](/i18n.site) .
...
విస్తారమైన ప్రజల సముద్రంలో ఇలాంటి ఆలోచనాపరులను కలవాలని మేము ఎదురుచూస్తున్నాము.

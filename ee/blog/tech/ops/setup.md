...
Gake ŋkeke ʋɛ aɖewo li ɣleti sia ɣleti siwo me woxea fe si woxena ɖe eɖoɖo ɖe teƒea ta la ɖeko nàŋlɔ ŋkɔ eye nàlé ŋku ɖe e-mail siwo wotsɔ doa bobloe ŋu.
...
CPU Model `AMD EPYC 9224 24-Core Processor` ɖeka-nu vevi dɔwɔwɔ ƒe dzesi 1285
...
Nu gbãtɔ enye be nàtrɔ asi le `ssh-copy-id root@c2` si le mia gbɔ IP `~/.ssh/config`
...
Afɔɖeɖe sia xɔa ɣeyiɣi didi Ne èlala gaƒoƒo afã vɔ la, kɔmpiutadziɖoɖo siwo wozãna zi geɖe la ɖɔɖɔɖo kple wo dede eme akpɔ dzidzedze. Àte ŋu aɖo kpe edzi kple sedede si gbɔna:
...
## mosh Na ssh Ƒe Duƒuƒu

Network tso Europa yi China meli ke o `ssh` Wokafui be woazãe [mosh](//mosh.org)

Wɔ `c0` script le local machine `~/.bin` (vevietɔ wotsɔe kpe ɖe environment variable `PATH` ) directory me abe alesi gbɔna ene:
...
Le ewɔwɔ vɔ megbe la, na mɔɖeɖe siwo woate ŋu awɔ kple soft-link `c1` `c2` .
...
Le etsɔme la, àte ŋu age ɖe `c0` , `c1` tẽ eye àte ŋu azã `mosh` kadodo tẽ si zɔna kabakaba eye nàŋlɔ [tmux](https://www.ruanyifeng.com/blog/2019/10/tmux.html)
...
Asibidɛ ƒe dzesi ƒe tɔtrɔ ava ne ssh , zã `ssh-keygen -R ip`
...
Ne ènye blibodededila la, àte ŋu awɔ disk ƒe nutete blibo hã kple asi Sededea le ale
...
Gɔmedzedze ƒe ŋɔŋlɔdzesi la awɔ `~/ubuntu`
...
`/etc/snapper/configs/mnt` Àte ŋu akpɔ subvolume sia ƒe backup ƒe ɖoɖo tɔxɛwo
...
Nenɔ susu me na wò be xɔnameɖoɖo aɖe dzie wowɔa dɔ siwo le etame la, eyata ne wogadze ɖoɖoa gɔme eye megale xɔname ƒe nɔnɔme me ko hafi tɔtrɔ mawo adze dɔwɔwɔ gɔme.

Esia fia be màkpɔ tɔtrɔ aɖeke enumake le nuŋlɔɖi siwo li fifia ŋu wòazu nusi anɔ anyi ɖaa o, gake nuŋlɔɖi siwo katã wowɔ le esia megbe la anɔ anyi.
...
## Nyatakaka Siwo Ku Ɖe Dɔléle Sesẽwo Kple Esiwo Sesẽ Ŋu

### Kpɔ Kuxi Wɔnukua Gbɔ: Dɔdzikpɔla Mate Ŋu Awɔ ssh O

Me zã github action tsɔ wɔ automatic nuƒoƒoƒu kple deployment script do ŋgɔ, gake mekpɔe be deployment service mateŋu anye ssh o.
...
Le numekukuwo wɔwɔ enuenu megbe `1001` , github action ezãla si tsɔ tar `uid`

tar Ele be woawɔ unpacking parameters manɔmee `--no-same-owner` woaɖee ɖa wòazu `uid` for `1001` user

...
Le egbɔkpɔnu siwo li fifia ƒe gbɔdzɔgbɔdzɔwo ta la, `i18n.site` to ŋgɔgbe-nuŋɔŋlɔ blibo didi ƒe egbɔkpɔnu yeye dzadzɛ aɖe vɛ, si ƒe nɔnɔmewo gbɔna :
...
* `/\p{P}/` nye nyagbɔgblɔ si wozãna edziedzi si sɔ kple nuŋɔŋlɔmedzesiwo Dzesi tɔxɛ siwo sɔ kple wo nɔewo dometɔ aɖewoe nye: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` { | } ~. `.</p><ul><li> `split('.')` nye elabena `Firefox` browser nyawo mama mema `. ` o.</li>
...
Didi ƒe emetsonu siwo woɖe fia gbã la kpɔa egbɔ be nyabiasea de pɛpɛpɛ, eye emetsonu siwo woda ɖe eme emegbe (zi load more ƒe dzesi dzi) kpɔa egbɔ be wogbugbɔ ŋku lé ɖe eŋu.

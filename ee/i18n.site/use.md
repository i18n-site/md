...
Gbã la, ge ɖe `md` nyatakakadzraɖoƒea eye nàwɔ `i18n.site` , si aɖe `en` gɔme wòazu `zh` .

<img src="https://p.3ti.site/1721114619.avif" style="width:350px">

Ne ewɔ dɔ vɔ la, woawɔ gbegɔmeɖeɖe kple cache faɛlwo Taflatse ɖo ŋku edzi nàtsɔ `git add . ` akpe ɖe nudzraɖoƒe si le `md` ƒe nuŋlɔɖiwo me.
...
Emegbe, ŋlɔ `docker` nyatakakadzraɖoƒe eye nàƒu du `./up.sh` , eye emegbe nàyi [https://127.0.0.1](https://127.0.0.1)
...
`htm` agbalẽdzraɖoƒea nye nyatakakadzraɖoƒea ƒe gege ɖe eme ƒe axa.

`v` nyatakakadzraɖoƒe la me nyatakakadzraɖoƒea me nyawo le kple woƒe tɔtrɔ ƒe xexlẽdzesiwo.
...
Ðeko nàzã agbalẽvi si me ame aɖeke mele o ƒe ŋkɔ le [npmjs.com](//npmjs.com)
...
De `md` ƒe agbalẽdzraɖoƒea eye nàƒu du
...
Emegbe, ɖo nya siwo le `md/out/ol/v` nyatakakadzraɖoƒea ɖe URL ƒe ŋgɔdonya mɔ si woɖo ɖe `v:` me la nu.
...
Be nàxɔ nyatakakawo le ɖokuiwò si la, tsɔ kpe ɖe wò ŋutɔ wò server zazã ŋu `CDN` , tiatia bubu si bɔ enye be nàzã `S3` +
...
Gbã la, zi afisia `i18n-demo` [github nàwɔ habɔbɔ aɖe](https://github.com/account/organizations/new?plan=free) .
...
Ne èbla domenyiŋkɔ tɔxɛa vɔ la, taflatse yi domenyiŋkɔa gbɔ be nàɖo mɔ si dzi woagbugbɔ aŋlɔ axa ɖeka ƒe dɔwɔɖoɖoa, abe alesi woɖee fia le ete ene:

![](https://p.3ti.site/1721119320.avif)

Se siwo le nɔnɔmetata si le etame la le ale: Taflatse tsɔ domenyiŋkɔ si nèbla la ɖɔ li `i18n.site` si le fli gbãtɔ si le ete.
...
Emegbe, zã nudzraɖoƒe si le alilikpo me nudzralawo le China + nyigba gã dzi `CDN` Deploy the following content `out/ol/htm` .
...
Esi wònye be nuŋlɔɖi `MX` kple nuŋlɔɖi `CNAME` mate ŋu anɔ anyi `A` o ta la, ne èdi be yeaxɔ domenyiŋkɔ ƒe e-mailwo le ɣeyiɣi `CNAME` me la, ele be nàwɔ nu aduadu kple [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten)
...
Tsɔ domenyiŋusẽfianu ŋkɔ kpe ɖe eŋu le [Alibaba Alilikpo CDN](https://cdn.console.aliyun.com/domain/list) eye nàfia asi domenyinyi ŋkɔ `*.xxx.com` va ɖo `CNAME` le Alibaba Alilikpo `CDN` me .
...
Taflatse tsɔ ɖoɖo si sɔ kple `/root/i18n/md/out/ol/htm` gbɔna le `server` memama `out/ol/htm` le nginx

...
Tsɔ `.i18n/htm/ol.yml` ɖoɖowɔɖi faɛl si le wɔwɔfia dɔa me abe kpɔɖeŋu ene
...
Le ɖoɖowɔwɔ me la, taflatse trɔ `i18n.site` ɖe asixɔxɔ si nye `host:` le `.i18n/htm/ol.yml` me, woateŋu aɖo nudzraɖoƒe geɖewo ɖe `s3` te, eye `region` ƒe akpaa nye tiatia (mehiã be nudzraɖoƒe geɖewo naɖo agble sia o).
...
Le kpɔɖeŋu `cloudflare` , [Huawei Cloud DNS](https://www.huaweicloud.com)
...
Esi wònye be `cloudflare` atsɔ `R2` o ta la, ehiã be woazã nudzraɖoƒe si nye ame etɔ̃lia atsɔ aɖo faɛl siwo meʋãna o.

`cloudflare` míetsɔ [backblaze.com](https://www.backblaze.com)
...
`Rewrite to` tia dynamic eye nàtrɔ asi le `your_bucketname` le `concat("/file/your_bucketname",http.request.uri.path)` ɖe wò bucket ŋkɔ ŋu.

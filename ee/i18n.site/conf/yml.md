...
### `use: Toc` , Faɛl Ɖeka Ƒe Nɔnɔmetata Si Me Nɔnɔmetata Le
...
### `use: Md` , Faɛl Ɖeka Ƒe Nɔnɔmetata Si Me Nɔnɔmetata Mele O
...
### `use: Doc` , Nuŋlɔɖi Ƒe Nɔnɔmetata Si Me Faɛl Geɖe Le
...
Nuŋɔŋlɔmɔnu si le etame la sɔ kple `url: xxx` , eye eƒe faɛl si sɔ kplii nye `en/xxx/TOC` .

#### TOC Ƒe Emenyawo Ƒe Xexlẽdzesifiaƒe

`i18n.site` awɔ `js` plug-in `.i18n/hook/after.tran/TOC.js` le demo nudzraɖoƒea be wòaxlẽ `TOC` directory index file si sɔ kple `doc` template configuration be wòawɔ `json` directory outline.
...
`Doc` ƒe nɔnɔmetata la awɔ emenyawo ƒe nɔnɔmetata si wotu ɖe `json` si wowɔ dzi.
...
Ne indentation ƒe dzidzenu geɖe li la, dzila ƒe dzidzenu koe ŋlɔa tanya la ke menye emenyawo o. Ne menye nenema o la, agbalẽtata ƒe nɔnɔme atɔtɔ.
...
Ne wotrɔ gbegbɔgblɔ si me wotso la, ele be nàtsɔ batch aʋu gbegbɔgblɔ aɖe ƒe faɛl `TOC` siwo le dɔa me ayi gbe bubu me.

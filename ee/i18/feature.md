...
Doa alɔ mixed HTML Markdown ƒe gɔmeɖeɖe, womeɖea nya siwo le HTML `<pre>` kple `<code>` tags siwo wotsɔ de `MarkDown` me la gɔme o
...
Ele be gbegɔmeɖeɖe ŋuti nyawo nafia gbe si le ` ``` ` megbe , ` ```rust ` :

Fifia la, edoa alɔ nuŋlɔɖiwo gɔmeɖeɖe le `toml` , `yaml` , `json5` , `go` , `rust` , `c` , `cpp` , `java` , `js` , `coffee` , `python` , `bash` , `php` [kple gbe bubuwo](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) me .
...
Sedede ƒe fli gɔmeɖeɖedɔwɔnu aɖewo hã li, abe [translate-shell](https://github.com/soimort/translate-shell)
...
## Do Alɔ Gbegɔmeɖeɖe `HOGO` Tanya Ƒe Ɖoɖowɔwɔ

Doa alɔ tanya ƒe ɖoɖowɔwɔ si nye [HOGO](https://github.com/gohugoio/hugo) type static blog, si ɖea agble `title` , `summary` kple `description` gɔme ko.

## Mègaɖe Ŋkɔ Siwo Trɔna Gɔme O

Wozãa `Markdown` abe email template ene, wozãa `YAML` abe gbegbɔgblɔ ƒe faɛl ƒe ɖoɖo ene, eye parameters siwo trɔna anɔ anyi (le kpɔɖeŋu me: woxɔ recharge `${amount}` ).
...
Woɖe egɔme ɖe Japangbe `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Woɖe egɔme ɖe `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` me :
...
Woɖe egɔme ɖe Japangbe `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Asitsaha la nye dzɔtsoƒe si woʋu keŋkeŋ, eye dɔwɔƒea ƒe 90 % nye dzɔtsoƒe [si](/i18n.site/src) woʋu ɖi.

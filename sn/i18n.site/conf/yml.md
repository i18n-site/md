...
Nzira yekunyora iri pamusoro yakaenzana `url: xxx` , uye faira yayo inoenderana `en/xxx/TOC` .
...
Semuenzaniso, kana `/test` yakasvikirwa, uye `nav:` yakagadziriswa pasina prefix yeiyi nzira, uye mutauro wekubhurawuza uripo chiRungu (code `en` ), `/en/test.md` ichatakurwa nekusarudzika uye ichishandurwa uchishandisa template `Md` .

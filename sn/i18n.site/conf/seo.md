...
Nekuti `R2` `cloudflare` kuwanikwa neyakajairwa zita rezita, chechitatu-bato chinhu chekuchengetedza chinoda kushandiswa kuisa static mafaera.

Pano [backblaze.com](https://www.backblaze.com) semuenzaniso kuratidza nzira yekusunga zvinhu zvechitatu kuti zvichengetwe `cloudflare` .
...
Shandura `cloudflare` `SSL` → encryption modhi, yakaiswa `Full`

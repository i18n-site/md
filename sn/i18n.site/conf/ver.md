...
Pano `en/` ndiyo kodhi yemutauro inoenderana neshanduro yemutauro yakagadziriswa `.i18n/conf.yml` .

Kana mutauro wako usiri Chirungu, saka `v` faira inofanirwa kuiswa mudhairekitori reprojekiti yemutauro wako waunobva.

Iko kugona kubhurawuza zvinyorwa zvenhoroondo zvemagwaro kuri kugadziridzwa.

Zvinokurudzirwa kungoshandura nhamba yevhezheni yegwaro kana zvigadziriso zvakakura zvaburitswa (senge `v1` , `v2` ) kudzivirira nhamba dzeshanduro dzakawanda dzinokonzera kusanganisa mumapeji akaiswa neinjini dzekutsvaga.

## Shandisa `v` Mafaira Asina Chinhu Kupatsanura Mafaera Indexes Emapurojekiti Akasiyana

Muchirongwa chedemo, mukuwedzera kune `en/demo2/v` , iwe unogona zvakare kuona kuti pane asina `v` mafaera mune `en/blog` uye `en/demo1` madhairekitori.

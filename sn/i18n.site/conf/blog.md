...
Iyo demo file inogadziriswa seinotevera:
...
Wobva wagadzirisa `author.yml` mudura remutauro dhairekitori uye wowedzera ruzivo rwemunyori, senge :
...
Ona demo chirongwa [`begin.md`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/blog/news/begin.md?plain=1) uye [`author.yml`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/author.yml)

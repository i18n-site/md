...
Kana iwe ukashandisa inoenderera yekubatanidza nharaunda kushambadza, hapana chikonzero chekuisa `nodejs` , ingoteedzera iyo yakapinda uye yekuburitsa mvumo `~/.npmrc` kune zvakatipoteredza.
...
Unogona kushandisa komputa komputa kunyorazve nzira kuti ienderane kune imwechete-peji maapplication Semuenzaniso, [Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) inogona kugadzirwa seizvi:

...
Tsinhiro dzeshanduro dzinoda kuratidza mutauro mushure ` ```rust ` ` ``` ` , sekuti : .
...
Kune vanogadzira mapurogiramu vanoziva `git` , `vim` , uye `vscode` , kushandisa maturusi aya kugadzirisa zvinyorwa uye kugadzirisa shanduro pasina mubvunzo kuchawedzera mari yekudzidza.
...
Kune zvakare mamwe maturusi ekuraira mutsara, senge [translate-shell](https://github.com/soimort/translate-shell)
...
## Shanduro Iyi Inogona Kupepetwa, Uye Shanduro Yemuchina Haizopedzi Gadziridzo Dziripo.

Shanduro yacho inogadzirika.

Shandura zvinyorwa zvekutanga wozvishandura zvakare, magadzirirwo eshandurudzo haasi kuzonyorwa pamusoro (kana ndima iyi yemavara ekutanga isina kugadziridzwa).

## Shanduro Yemhando Yepamusoro Yemuchina

Tagadzira chizvarwa chitsva chetekinoroji yeshanduro inobatanidza zvakanakira zvemichina yeshanduro yechinyakare nemamodheru emitauro mikuru kuita shanduro nemazvo, zvakapfava uye zvinoyevedza.
...
[Dzvanya apa kuti ubvumire uye i18n.site otomatiki 's github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) uye **ugamuchire bhonasi $50** .
...
Inotsigira kugadziridzwa kwemusoro we [HOGO](https://github.com/gohugoio/hugo) type static blog, iyo inongoshandura ndima `title` , `summary` uye `description` .

## Usashandure Mazita Akasiyana

`Markdown` inoshandiswa se template ye email, `YAML` inoshandiswa semutauro wefaira, uye pachava nemiganhu yakasiyana-siyana (somuenzaniso: recharge `${amount}` yakagamuchirwa).
...
Chete kana paine nzvimbo pakati peizwi rechirungu nechiChinese, chiJapan nechiKorea chinyorwa kana kureba kweChirungu kwakakura kupfuura 1, izwi rinozotorwa sezwi.
...
Mutengi akavhurika sosi, uye 90 % yekodhi yakavhurika [sosi](/i18n.site/src) .
...
Ndapota <button onclick="mailsub()">tinya iyi email kuti unyore kugadziridzo dzechigadzirwa</button> uye <button onclick="webpush()">kugonesa browser kusunda</button> Isu tichakuzivisa iwe kana zvigadzirwa zvagadziridzwa.

...
Ge o šomiša tikologo ya kopanyo ye e tšwelago pele go phatlalatša, ga go nyakege gore o tsenye `nodejs` , e no kopiša tumelelo ya go tsena le go phatlalatša `~/.npmrc` tikologong.

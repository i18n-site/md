# Phetolelo Ya Porojeke

Nka projeke ya demo e le mohlala:
...
Mo `en/` ke khoutu ya polelo yeo e sepelelanago le polelo ya mothopo wa phetolelo yeo e beakantšwego ke `.i18n/conf.yml` .
...
Ka projeke ya demo, go tlaleletša go `en/demo2/v` , o ka bona gape gore go na le difaele `v` tše di se nago selo ka go dipuku tša dipuku tša `en/blog` le `en/demo1` .

`v` ye e se nago selo e ka se bontšhwe ka go thulaganyo ya bara ya ka thoko, eupša ge fela go na le faele ya `v` , tšhupamabaka ye e ikemetšego e tla tšweletšwa bakeng sa difaele ka gare ga tšhupetšo le dipuku tša ka fasana.
...
Ka mohlala, faele ya tšhupamabaka yeo e sepelelanago le `blog` mo porojekeng [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) demo ke :
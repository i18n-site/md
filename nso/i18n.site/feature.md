# Tšobotsi Ya Sehlahiswa

## Phetolelo Ye E Kopantšwego `I18`

Lenaneo le na le phetolelo ye e agetšwego ka `i18` , hle bona [➔ `i18`](/i18) bakeng sa tšhomišo ye e itšego.
...
Ka go ikemela `i18n.site` diteng tša sebaka di tla phatlalatšwa go `npmjs.com` , ka thušo ya [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) le diteng tše dintši `CDN` tšeo di imetšwego go `npm` .
...
Molao `CDN` motheo ke: thibela kgopelo ka thušo ya [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)

Khoutu ye e amanago le [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) :
...
Ka default, [Alimama habeli-axis feto-fetogago khutlonne difonte](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/)
...
Khoutu ye e amanago le [github.com/i18n-site/font](https://github.com/i18n-site/font) :
...
### `404` Sepoko Se Sennyane

Go na le sepoko se senyenyane se se rategago se se phaphametšego letlakaleng, mahlo a sona a tla sepela ka toeba, [➔ Tobetsa mo go lebelela](/404) , `404`

<h1 style="justify-content:space-between">3Ti.Site · Go Nagana ka Ntle le Mellwane<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

3Ti.Site, Phetolelo ya Markdown + jenereithara ya sebaka sa go se fetoge sa maleme a mantši.

E go dumelela go aga ka pela ditokomane tša boditšhabatšhaba le di-blog tšeo di thekgago [maleme a makgolo](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

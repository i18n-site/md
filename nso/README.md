<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Ditharollo tša boditšhabatšhaba<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Mola wa taelo Markdown #sedirišwa sa Yaml , go go thuša go aga lefelo la ditokomane la boditšhabatšhaba, go thekga [maleme a makgolo](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> Tlhaloso ya Protšeke
...
* [i18n.site : ya weposaete ya go se fetoge ya maleme a mantši](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Sedirišwa sa phetolelo ya mola wa taelo wa MarkDown

Fetolela `Markdown` le `YAML` go sedirišwa sa mola wa taelo ( [khoutu ya mohlodi](https://github.com/i18n-site/rust/tree/main/i18) ) ka maleme a mantši.
...
Re abelana ka " `UNIX` Se sengwe le se sengwe ke Faele " gomme re ka laola diphetolelo ka maleme a makgolo ntle le go tsebagatša ditharollo tše di raraganego le tše di thata tša maemo a kgwebo.

O ka šomiša didirišwa tše di tlwaelegilego kudu go `Markdown` phetolelo (eupša o ka se kgone go oketša goba go phumola ditemana), gomme wa šomiša tsela ye e tlwaelegilego kudu go dira taolo ya phetolelo.

Motheo wa khoutu o ka hlolwa bjalo ka mohlodi wo o bulegilego wa difaele tša polelo, gomme ka thušo ya tshepedišo ya `Pull Request` Kgokagano ye e se nago selo [github](//github.com)

[→ Bakeng sa tlhahlo ya mosebedisi, hle bala ditokomane tsa projeke](/i18) .

## Phetolelo Ya Maemo a Godimo Ya Xindaya
...
Go fihlelela boleng bjo bo swanago, palo ya go rulaganya ka seatla yeo e nyakegago ke Google Translate le `ChatGPT` ke `2.67` makga le `3.15` makga a rena ka go latelelana.
...
Purely static, optimized bakeng sa ho bala boiphihlelo, le kopantswe le phetolelo ya [i18](#i18) ke kgetho molemo ka ho fetisisa bakeng sa ho haha porojeke e ne tokomane sebaka.
...
Webosaete ye e hlamilwe go ya ka tlhako ye gomme e akaretša mosediriši, tefo le mešomo ye mengwe ( [khoutu ya mohlodi](/i18n.site/src) Thuto ye e tletšego e tla ngwalwa ka morago.

[→ Bakeng sa tlhahlo ya mosebedisi, hle bala ditokomane tsa projeke](/i18n.site) .
...
Gape [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) amogetšwe go latela diakhaonto tša rena tša / [X.COM: @i18nSite](https://x.com/i18nSite)

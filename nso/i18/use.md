...
## Lifensetere Pele Kenya git bash
...
Ho [i18n.site/payBill](//i18n.site/payBill) , u lokela ho tlama karete ya mokitlane bakeng sa tefo (ha ho recharge e hlokahalang, websaeteng tla ka tsela e iketsang deduct ditefello ho ea ka tshebediso ya, [bona leqepheng la lapeng bakeng sa theko](/#price) ).
...
`fromTo` ye e fapanego e ka beakanywa bakeng sa difaele tše nnyane tše di / Pontšho e ngwalwa ka tsela ye e latelago :
...
Tafoleng ye ya peakanyo, polelo ya mothopo ya phetolelo ya tšhupetšo `blog` ke `zh` , gomme polelo ya mothopo ya phetolelo ya tšhupetšo `blog/your_file_name.md` ke `ja` .

### Hlokomologa Faele

Ka go ikemela, difaele ka moka tšeo di thomago ka `.md` le `.yml` ka go tšhupetšo ya polelo ya mothopo di tla fetolelwa.

Ge o nyaka go hlokomologa difaele tše itšego gomme o se di fetole (go swana le dithalwa tše di sa fetšwago), o ka šomiša peakanyo ya tšhemo `ignore` .

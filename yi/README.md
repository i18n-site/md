...
מיר אַבאָנירן צו די פילאָסאָפיע פון `UNIX` אַלץ איז אַ טעקע " און קענען פירן " אין הונדערטער פון שפראַכן אָן ינטראָודוסינג קאָמפּלעקס און קאַמבערסאַם סאַלושאַנז פֿאַר פאַרנעמונג.

איר קענט נוצן די מערסט באַקאַנטע מכשירים צו רעדאַגירן `Markdown` איבערזעצונג (אָבער איר קענט נישט לייגן אָדער ויסמעקן פּאַראַגראַפס), און נוצן די מערסט באַקאַנטע וועג צו טאָן ווערסיע קאָנטראָל.
...
#### <a rel=id href="#price" id="price"></a> זייער קאַמפּעטיטיוו פּרייסינג
...
[דריקט דאָ צו אָטערייז און אויטאָמאַטיש נאָכפאָלגן די i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) און **באַקומען באָנוס $50** .

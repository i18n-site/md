...
## אַקסאַדענאַלי אויסגעמעקט , וואָס געפֿירט די `npm` פּעקל צו זיין ארויס `.i18n/v`

די היסטארישע ווערסיע פון `npm` פּעקל מעלדונג איז געראטעוועט אין `.i18n/v/ol/v.hash`

אויב איר אַקסאַדענאַלי ויסמעקן `.i18n/v/ol` די `npm` פּעקל וועט נישט זיין ארויס.
...
דערנאָך אָפּשיקן צו `bash` שאַפֿן טעקע אונטן.

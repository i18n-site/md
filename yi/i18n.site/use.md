...
רעדאַגירן `md/.i18n/htm/ol.yml` און טוישן די ווערט פון [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` ווי דיין אייגן `npm` פּעקל נאָמען וועט [npmjs.com](//npmjs.com) .

דערנאָך מאָדיפיצירן `md/.i18n/htm/ol.package.json`

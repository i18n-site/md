...
אַלעמען האט זייער באַליבסטע רעדאַקטאָר דאָ מיר טיילן אונדזער `Markdown` בעסטער פּראַקטיסיז.

מיר [vscode](https://code.visualstudio.com/) צו שרייַבן `MarkDown` , און אויך ינסטאַלירן די פּלוג-אין [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) צו פאָרויסיקע ווייַזונג אין פאַקטיש צייט בשעת שרייבן.
...
אַרייַן `code xxx.md` אין די באַפֿעל שורה צו רופן `vscode` צו עפענען טעקע `Markdown` .

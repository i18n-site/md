...
## בילדער / ווידיאס / פֿאַרבינדונגען אין קייפל שפּראַכן

נאָך `MarkDown` איז קאָנווערטעד צו `HTML` , `$LANG` אין אַטריביוץ `src` און `href` וועט זיין ריפּלייסט מיט די קראַנט [שפּראַך קאָד](/i18/LANG_CODE) .

מיט דעם בייַטעוודיק, איר קענען דערגרייכן מאַלטיילינגוואַליזיישאַן פון בילדער / ווידיאס / לינקס.
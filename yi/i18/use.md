...
windows סיסטעם, ביטע [גיט דאָ צו אָפּלאָדירן און ינסטאַלירן `git bash`](https://git-scm.com/download/win) ערשטער.
...
צווישן זיי, דער אינהאַלט פון `.i18n/cache/.gitignore` איז ווי גייט :
...
דעם מיטל אַז אַלע טעקעס אין וועגווייַזער `.i18n/cache/` (חוץ `.i18n/cache/.gitignore` ) זענען איגנאָרירט.

אויב דיין ווערסיע קאָנטראָל ווייכווארג איז נישט `git` , ביטע איגנאָרירן עס לויט די קאַנפיגיעריישאַן.
...
איר קענען קאַנפיגיער פאַרשידענע `fromTo` פֿאַר פאַרשידענע / א דעמאַנסטריישאַן איז געשריבן ווי גייט :
...
אין דעם קאַנפיגיעריישאַן טיש, די מקור שפּראַך פון קאַטאַלאָג `blog` איבערזעצונג איז `zh` , און די מקור שפּראַך פון `blog/your_file_name.md` איבערזעצונג איז `ja` .
...
`ignore` ניצט די זעלבע [globset](https://docs.rs/globset/latest/globset/#syntax) ווי די `.gitignore` טעקע.

...
שטיצט איבערזעצונג פון HTML Markdown , די אינהאַלט אין די `<pre>` און `<code>` טאַגס פון HTML עמבעדיד אין `MarkDown` איז נישט איבערגעזעצט
...
שטיצט די [HOGO](https://github.com/gohugoio/hugo) קאַנפיגיעריישאַן פון טיפּ סטאַטיק בלאָג, וואָס בלויז טראַנזלייץ פעלדער `title` , `summary` און `description` .
...
טשיינאַ, יאַפּאַן און קארעע טאָן ניט האָבן גרעסטן און נידעריקער אותיות, אָבער די קאַנווענשאַן פֿאַר ענגליש טיטלען איז צו קאַפּיטאַלייז דער ערשטער בריוו.
...
`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` אין פראנצויזיש :

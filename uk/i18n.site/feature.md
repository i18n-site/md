...
Програма має вбудований переклад `i18` , дивіться [➔ `i18`](/i18) для конкретного використання.
...
`i18n.site` За замовчуванням вміст сайту буде `npmjs.com` за допомогою [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) і кількох завантажених `CDN` вмісту `npm` .
...
Принцип такий: перехопіть запит за допомогою [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , якщо запит не вдасться, повторіть його на іншій `CDN` та адаптивно ввімкніть станцію, що відповідає найшвидше, як джерело завантаження за замовчуванням.

[github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) код :

## Односторінкова Програма, Надзвичайно Швидке Завантаження
...
За замовчуванням на веб-сторінці ввімкнено [двовісні змінні прямокутні шрифти](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) та інші онлайн-шрифти для уніфікації досвіду читання для користувачів на різних платформах.
...
`404` На сторінці є милий маленький привид, його очі рухатимуться мишкою, [➔ Натисніть тут, щоб переглянути](/404) ,

## Код З Відкритим Кодом

[Код із відкритим вихідним кодом](/i18n.site/src) Якщо ви зацікавлені в участі в розробці, укажіть себе в [списку розсилки](//groups.google.com/u/2/g/i18n-site) .

Є багато дрібних вимог, які є важливими, але не терміновими, призначаючи практичні завдання відповідно до технології, якою ви володієте, і призначаючи вимоги, вдосконалюватиме документи розробки.

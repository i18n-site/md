...
* / базова [atomgit](https://atomgit.com/i18n/lib) [github](https://github.com/i18n-site/lib)
* Базова бібліотека браузера [github](https://github.com/i18n-site/ie) / [atomgit](https://atomgit.com/i18n/ie)
* Немає необхідності пакувати інтерфейсні бібліотеки [atomgit](https://atomgit.com/i18n/x) / посиланнями [github](https://github.com/i18n-site/x)

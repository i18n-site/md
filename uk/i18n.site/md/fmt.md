...
Схема аanker, узгоджена з `i18n.site`, полягає у вставленні в `MarkDown` тексту, подібного до `<a rel=id href="#xxx" id="xxx"></a>`, для ручного створення аankerів позиціонування.
...
Вміст елементів `<pre>` не буде перекладено.

Комбінуючи ці два моменти, можна легко写入 `HTML` у `MarkDown`, щоб досягти різних ефектів відображення.

Можна звернутися до реалізації в [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md), код такий:

...
Ми використовуємо [vscode](https://code.visualstudio.com/) для написання `Markdown` та встановлюємо плагін [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) для перегляду в режимі реального часу під час письма.
...
Також ви можете скористатися наступною конфігурацією, щоб змінити файл і налаштувати автоматичне стиснення завантажених файлів до формату `avif`, що дозволяє зменшити розмір зображень.

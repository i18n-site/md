...
3Ti.Site, генератор статичних сайтів, може автоматично перекладати Markdown [більш ніж сотнею різних мов](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

...
Програма, крім перекладу, згенерує наступні файли, які потрібно додати до репозиторію.
...
Серед них вміст `.i18n/cache/.gitignore` виглядає так:
...
Це означає, що всі файли в каталозі `.i18n/cache/` (крім `.i18n/cache/.gitignore`) будуть проігноровані.

Якщо ваше програмне забезпечення для контролю версій не є `git`, налаштуйте проігнорування відповідно до цієї конфігурації.

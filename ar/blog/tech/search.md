...
تشتمل عمليات البحث عن النص الكامل المستخدمة بشكل شائع على [lunrjs](/0) و [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) .
...
[fusejs](https://www.fusejs.io)، حساب التشابه بين السلاسل للبحث.

أداء هذا الحل ضعيف للغاية ولا يمكن استخدامه للبحث عن النص الكامل (انظر [Fuse.js يستغرق الاستعلام الطويل أكثر من 10 ثانية، وكيفية تحسينه؟](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

[TinySearch](https://github.com/tinysearch/tinysearch)، يستخدم مرشح Bloom للبحث، ولا يمكن استخدامه للبحث عن البادئة (على سبيل المثال، أدخل `goo`، ابحث `good`، `google`)، ولا يمكن تحقيق تأثير إكمال تلقائي مماثل.
...
في التفاعل الأمامي، يمكن عرض شريط تقدم تحميل الفهرس لتجنب التأخير عند التحميل لأول مرة، راجع "شريط التقدم مع الرسوم المتحركة، بناءً على تطبيق واحد progress + Pure css " [الإنجليزية](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [الصينية](https://juejin.cn/post/7413586285954154522).

### IndexedDB الكتابة المتزامنة عالية

تم [idb](https://www.npmjs.com/package/idb) المشروع بناءً على التغليف غير المتزامن لـ IndexedDB

...
ستشارك هذه المقالة في تنفيذ تقنية البحث عن النص الكامل للواجهة الأمامية `i18n.site` [i18n.site](//i18n.site) ويمكنك تجربة تأثير البحث.

كود [نواة البحث](//github.com/i18n-site/ie/tree/main/qy) مفتوحة المصدر [واجهة تفاعلية](//github.com/i18n-site/plugin/tree/main/qy) /

## مراجعة لحلول البحث عن النص الكامل بدون خادم

بالنسبة لمواقع الويب الصغيرة مثل المستندات/المدونات الشخصية الثابتة تمامًا، فمن المؤكد أنه من الصعب جدًا إنشاء واجهة خلفية للبحث عن النص الكامل بنفسك، كما أن البحث عن النص الكامل بدون خدمات هو بلا شك وزن أفضل.

تنقسم حلول البحث عن النص الكامل بدون خادم الحالية إلى فئتين عريضتين.

أحدهما هو مزود خدمة بحث تابع لجهة خارجية يشبه [algolia.com](//algolia.com) والذي يوفر مكونات البحث عن النص الكامل للواجهة الأمامية.

تتطلب مثل هذه الخدمات الدفع وهي غير متاحة للمستخدمين في الصين القارية بسبب مشكلات الامتثال لموقع الويب.
...
تتضمن عمليات البحث عن النص الكامل الأكثر شهرة في الواجهة الأمامية [lunrjs](/0) و [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) .

`lunrjs` هناك طريقتان لبناء الفهارس، ولكن لكل منهما مشاكله الخاصة.
...
بسبب عدم الرضا عن أوجه القصور في الحلول الحالية، قامت `i18n.site` بتطوير حل جديد للبحث عن النص الكامل للواجهة الأمامية، والذي يحتوي على الميزات التالية:
...
يتم تنفيذ البحث المقلوب عن النص الكامل على الواجهة الأمامية فقط، مع استجابة سريعة وعدم الحاجة إلى خادم.

إنه مناسب جدًا للمواقع الصغيرة والمتوسطة الحجم مثل المستندات والمدونات الشخصية.
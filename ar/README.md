...
## <a rel=id href="#project" id="project"></a> وصف المشروع

يوفر هذا الموقع حاليًا أداتين لسطر الأوامر مفتوحة المصدر:

* [i18 : MarkDown ترجمة سطر الأوامر](/i18/feature)
* [مولد موقع ثابت متعدد اللغات i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: أداة ترجمة سطر الأوامر MarkDown

ترجمة `Markdown` و `YAML` إلى أداة سطر الأوامر ( [الكود المصدر](https://github.com/i18n-site/rust/tree/main/i18) ) بلغات متعددة.

يمكن الحفاظ تماما على شكل `Markdown` يمكن تحديد تعديلات الملف وترجمة الملفات التي تم تغييرها فقط.
...
نحن نتشارك " `UNIX` كل شيء عبارة عن ملف " ويمكننا إدارة الترجمات بمئات اللغات دون تقديم حلول معقدة ومرهقة على مستوى المؤسسة.

يمكنك استخدام الأدوات الأكثر شيوعًا `Markdown` الترجمة (لكن لا يمكنك إضافة فقرات أو حذفها)، واستخدام الطريقة الأكثر شيوعًا للتحكم في الإصدار.

يمكن إنشاء قاعدة التعليمات البرمجية كمصدر مفتوح لملفات اللغة، وبمساعدة عملية `Pull Request` ، يمكن للمستخدمين العالميين المشاركة في التحسين المستمر للترجمات. اتصال سلس [github](//github.com) من المجتمعات مفتوحة المصدر.

[→ للحصول على دليل المستخدم، يرجى قراءة وثائق المشروع](/i18) .
...
تم تطوير هذا الموقع بناءً على هذا الإطار ويتضمن وظائف المستخدم والدفع ووظائف أخرى ( [كود المصدر](/i18n.site/src) ) وسيتم كتابة برنامج تعليمي مفصل لاحقًا.

[→ للحصول على دليل المستخدم، يرجى قراءة وثائق المشروع](/i18n.site) .

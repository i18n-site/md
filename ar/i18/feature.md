...
`i18` هو أداة سطر الأوامر لترجمة Markdown و YAML.

## يحافظ بشكل مثالي على تنسيق Markdown

يدعم ترجمة جداول Markdown دون الإضرار بالتنسيق؛ لا يترجم الكلمات في الصيغ الرياضية أو الروابط.
...
يدعم تكوين الرأس للمدونة الثابتة من النوع [HOGO](https://github.com/gohugoio/hugo)، ويترجم الحقول `title`، `summary`، `brief`، `description` فقط.
...
`i18` يمكنه التعرف على العناوين في `Markdown`، وسيقوم تلقائيًا برفع الحرف الأول عند الترجمة إلى لغات تفرق بين الحرف الكبير والصغير.
...
العميل مفتوح المصدر بالكامل، و 90% من الكود الخاص بالخادم مفتوح المصدر. [انقر هنا لعرض الكود المصدري](/i18n.site/src).

...
| 116 | `sd` | السيندي | `سنڌي` |
| 117 | `si` | السيريلانكية | `සිංහල` |
| 118 | `so` | الصومالية | `Soomaali` |
| 119 | `tt` | الطاجيكية | `Татар` |
| 120 | `ti` | التتار | `ትግር` |
| 121 | `ts` | التيغرينيا | `Xitsonga` |
| 122 | `tk` | الكونغو | `Türkmen Dili` |
| 123 | `ak` | ال契维 (الأكان) | `Akan` |
| 124 | `xh` | ال班图 | `isiXhosa` |
| 125 | `yi` | اليديッシュ | `ייִדיש` |

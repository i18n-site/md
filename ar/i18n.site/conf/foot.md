...
ămālًا بمثال المشروع العرضي، ملف `.i18n/htm/foot.pug` في الدليل `md` يحدد تذييل الموقع.
...
يرجى الرجوع إلى ما يلي: يُكتب النمط في الملفات الم对应ة ب`.css`، والتفاعل يتم من خلال إنشاء مكونات الويب.
...
* `import.css`: النمط الافتراضي للموقع الكامل `i18n.site`
...
يرجى إنشاء خط الأيقون الخاص بك حسب الحاجة واستبدال التكوينات التالية في `conf.css`:
...
لا يمكن كتابة `js` في `foot.pug`، إذا كنت بحاجة إلى تفاعل، يرجى تخصيص مكونات الويب.

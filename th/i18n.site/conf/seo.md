...
หากคุณต้องการให้บริการในจีนแผ่นดินใหญ่และต้องการการเข้าชมระหว่างประเทศฟรี `cloudflare` รายการ คุณสามารถใช้ `DNS` กับความละเอียดระดับภูมิภาคได้
...
เนื่องจาก `R2` `cloudflare` เข้าถึงได้ด้วยชื่อโดเมนที่กำหนดเอง จึงจำเป็นต้องใช้ที่เก็บข้อมูลอ็อบเจ็กต์ของบริษัทอื่นเพื่อวางไฟล์แบบคงที่

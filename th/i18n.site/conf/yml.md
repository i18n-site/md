...
คุณสามารถแก้ไข `use: Toc` ในการกำหนดค่าข้างต้นเป็น `use: Md` เรียกใช้ `i18n.site` ในไดเรกทอรี `md` อีกครั้ง จากนั้นไปที่ URL ตัวอย่างการพัฒนาเพื่อดูการเปลี่ยนแปลงในหน้าแรก
...
มีการเยื้องไฟล์ `TOC` เพื่อระบุความสัมพันธ์แบบลำดับชั้นของโครงร่างและรองรับการเยื้องหลายระดับ

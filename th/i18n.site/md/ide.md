...
ทุกคนมีโปรแกรมแก้ไขที่ชื่นชอบเป็นของตัวเอง ที่นี่เราแบ่งปันแนวทางปฏิบัติที่ดีที่สุด `Markdown` ของเรา
...
ใช้ [PicList](https://github.com/Kuingsmile/PicList) เพื่ออัปโหลดรูปภาพ อย่าลืมตั้งค่าปุ่มลัดสำหรับการอัปโหลด และอัปโหลดภาพหน้าจอได้ในคลิกเดียว

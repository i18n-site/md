...
แก้ไข `md/.i18n/htm/ol.yml` และเปลี่ยนค่า [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` เป็นชื่อแพ็คเกจ `npm` ของคุณเอง [npmjs.com](//npmjs.com)

แล้วแก้ไข `md/.i18n/htm/ol.package.json`

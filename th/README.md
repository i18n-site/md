# I18N.SITE · เอกสารไร้พรมแดน<img Src="//ok0.pw/5l" Style="float:right;width:42px;margin-Top:6px">

I18N.SITE เครื่องมือสร้างเว็บไซต์แบบคงที่ที่รองรับการแปลอัตโนมัติเป็น [133 ภาษา](https://github.com/i18n-site/node/blob/main/lang/src/index.js)

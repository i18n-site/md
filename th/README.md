<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ โซลูชั่นระดับสากล<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> รายละเอียดโครงการ

ขณะนี้ไซต์นี้มีเครื่องมือบรรทัดคำสั่งโอเพ่นซอร์สสองรายการ:
...
แปล `Markdown` และ `YAML` เป็นเครื่องมือบรรทัดคำสั่ง ( [ซอร์สโค้ด](https://github.com/i18n-site/rust/tree/main/i18) ) ในหลายภาษา

สามารถรักษารูปแบบของ `Markdown` สามารถระบุการแก้ไขไฟล์และแปลเฉพาะไฟล์ที่เปลี่ยนแปลงเท่านั้น
...
เราแบ่งปัน " `UNIX` Everything is a File " และสามารถจัดการการแปลในหลายร้อยภาษาโดยไม่ต้องแนะนำโซลูชันระดับองค์กรที่ซับซ้อนและยุ่งยาก

คุณสามารถใช้เครื่องมือที่คุ้นเคยที่สุดเพื่อ `Markdown` การแปล (แต่คุณไม่สามารถเพิ่มหรือลบย่อหน้าได้) และใช้วิธีที่คุ้นเคยที่สุดในการควบคุมเวอร์ชัน

ฐานโค้ดสามารถสร้างเป็นโอเพ่นซอร์สสำหรับไฟล์ภาษาได้ และด้วยความช่วยเหลือของกระบวนการของ `Pull Request` ผู้ใช้ทั่วโลกสามารถมีส่วนร่วมในการเพิ่มประสิทธิภาพการแปลอย่างต่อเนื่อง การเชื่อมต่อที่ไร้รอยต่อ [github](//github.com) และชุมชนโอเพ่นซอร์สอื่น ๆ

[→ สำหรับคู่มือผู้ใช้ โปรดอ่านเอกสารประกอบโครงการ](/i18)
...
เป็นแบบคงที่ล้วนๆ ปรับให้เหมาะสมสำหรับประสบการณ์การอ่าน และผสานรวมกับการแปล [i18](#i18) จึงเป็นตัวเลือกที่ดีที่สุดสำหรับการสร้างไซต์เอกสารโครงการ
...
เว็บไซต์นี้ได้รับการพัฒนาตามกรอบการทำงานนี้ และรวมถึงผู้ใช้ การชำระเงิน และฟังก์ชันอื่นๆ ( [ซอร์สโค้ด](/i18n.site/src) ) บทช่วยสอนโดยละเอียดจะเขียนในภายหลัง

[→ สำหรับคู่มือผู้ใช้ โปรดอ่านเอกสารประกอบโครงการ](/i18n.site)
...
เราหวังว่าจะได้พบผู้คนที่มีใจเดียวกันในทะเลอันกว้างใหญ่ของผู้คน

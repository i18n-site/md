...
ประการแรก ผู้ให้บริการการค้นหาบุคคลที่สามที่คล้าย [algolia.com](//algolia.com) จัดเตรียมส่วนประกอบส่วนหน้าสำหรับการค้นหาข้อความแบบเต็ม
...
การค้นหาข้อความแบบเต็มส่วนหน้าที่ใช้กันทั่วไป ได้แก่ [lunrjs](https://lunrjs.com) และ [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91)
...
เนื่องจากข้อบกพร่องของโซลูชันที่มีอยู่ `i18n.site` จึงได้พัฒนาโซลูชันการค้นหาข้อความแบบเต็มส่วนหน้าแบบใหม่ซึ่งมีลักษณะดังต่อไปนี้ :
...
`i18n.site` การค้นหาส่วนหน้าแบบโอเพ่นซอร์สที่พัฒนาตนเองล้วนๆ ขนาดเล็กและการตอบสนองที่รวดเร็ว แก้ไขข้อบกพร่องของการค้นหาข้อความแบบเต็มส่วนหน้าแบบบริสุทธิ์ในปัจจุบัน และมอบประสบการณ์ผู้ใช้ที่ดีขึ้น
...
บทความนี้จะแบ่งปันการใช้งานเทคโนโลยีการค้นหาข้อความแบบเต็มส่วนหน้า `i18n.site` เยี่ยมชม [i18n.site](//i18n.site)

รหัสเคอร์เนล [ค้นหา](//github.com/i18n-site/ie/tree/main/qy) [โอเพ่นซอร์ส](//github.com/i18n-site/plugin/tree/main/qy) /

## ภาพรวมของโซลูชันการค้นหาข้อความแบบเต็มแบบไร้เซิร์ฟเวอร์

สำหรับเว็บไซต์ขนาดเล็ก เช่น เอกสาร/บล็อกส่วนตัว ที่เป็นแบบคงที่ล้วนๆ ไม่ต้องสงสัยเลยว่าการสร้างแบ็กเอนด์การค้นหาข้อความแบบเต็มด้วยตัวเองนั้นหนักเกินไปอย่างไม่ต้องสงสัย และการค้นหาข้อความแบบเต็มโดยไม่มีบริการก็มีน้ำหนักที่ดีกว่าอย่างไม่ต้องสงสัย

โซลูชันการค้นหาข้อความแบบเต็มแบบไร้เซิร์ฟเวอร์ที่มีอยู่แบ่งออกเป็นสองประเภทกว้าง ๆ

หนึ่งคือผู้ให้บริการการค้นหาบุคคลที่สามที่คล้ายกับ [algolia.com](//algolia.com) ซึ่งมีส่วนประกอบการค้นหาข้อความแบบเต็มส่วนหน้า

บริการดังกล่าวจำเป็นต้องชำระเงินและไม่สามารถใช้งานได้สำหรับผู้ใช้ในจีนแผ่นดินใหญ่เนื่องจากปัญหาการปฏิบัติตามข้อกำหนดของเว็บไซต์
...
การค้นหาข้อความแบบเต็มส่วนหน้าที่รู้จักกันดี ได้แก่ [lunrjs](https://lunrjs.com) และ [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91)

`lunrjs` มีสองวิธีในการสร้างดัชนี แต่ทั้งสองวิธีมีปัญหาของตัวเอง
...
[fusejs](https://www.fusejs.io) คำนวณความคล้ายคลึงกันระหว่างสตริงที่จะค้นหา

ประสิทธิภาพของโซลูชันนี้แย่มาก และไม่สามารถใช้สำหรับการค้นหาข้อความแบบเต็มได้ (ดู [Fuse.js การสืบค้นแบบยาวใช้เวลานานกว่า 10 วินาที จะปรับให้เหมาะสมได้อย่างไร](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) )

[TinySearch](https://github.com/tinysearch/tinysearch) ให้ใช้ตัวกรอง Bloom เพื่อค้นหา ไม่สามารถใช้สำหรับการค้นหาคำนำหน้าได้ (เช่น ป้อน `goo` ค้นหา `good` , `google` ) และไม่สามารถใช้เอฟเฟกต์การเติมคำอัตโนมัติที่คล้ายกันได้

ด้วยความไม่พอใจกับข้อบกพร่องของโซลูชันที่มีอยู่ `i18n.site` ได้พัฒนาโซลูชันการค้นหาข้อความแบบเต็มส่วนหน้าแบบใหม่ซึ่งมีคุณสมบัติดังต่อไปนี้ :
...
โครงการนี้ได้ [idb](https://www.npmjs.com/package/idb) บนพื้นฐานของการห่อหุ้มแบบอะซิงโครนัสของ IndexedDB
...
โปรดทราบว่าแต่ละครั้งที่คุณค้นหาอีกครั้งหลังจาก `yield` คุณจะต้องเปิดธุรกรรมการค้นหา `IndexedDB` ครั้ง
...
การเน้นผลลัพธ์การค้นหาจำเป็นต้องโหลดข้อความต้นฉบับซ้ำ และการจับคู่ `service worker` สามารถหลีกเลี่ยงการร้องขอเครือข่ายซ้ำได้
...
การค้นหาข้อความแบบเต็มแบบกลับด้านใช้งานเฉพาะที่ส่วนหน้า พร้อมการตอบสนองที่รวดเร็วและไม่ต้องใช้เซิร์ฟเวอร์

เหมาะมากสำหรับเว็บไซต์ขนาดเล็กและขนาดกลาง เช่น เอกสาร และบล็อกส่วนตัว
...
ดังนั้นฉันจึงพัฒนาเครื่องมือแปล `i18` และสร้างตัวสร้างไซต์คงที่หลายภาษา `i18n.site` โดยใช้เครื่องมือแปล
...
รหัสส่วนหน้า ส่วนหลัง และบรรทัดคำสั่ง [ล้วนเป็นโอเพ่นซอร์ส](https://i18n.site/i18n.site/c/src) (โมเดลการแปลยังไม่เป็นโอเพ่นซอร์ส)
...
บรรทัดคำสั่ง [ที่ฝังตัว js Engine boa_engine](https://docs.rs/boa_engine) [ฐานข้อมูลแบบฝังตัว fjall](https://github.com/fjall-rs/fjall)

เซิร์ฟเวอร์ VPS [contabo](https://my.contabo.com)

ฐานข้อมูล [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

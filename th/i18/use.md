...
windows ระบบ กรุณา [คลิกที่นี่เพื่อดาวน์โหลดและติดตั้ง `git bash`](https://git-scm.com/download/win) ก่อน
...
ในหมู่พวกเขามีเนื้อหาของ `.i18n/cache/.gitignore` มีดังนี้ :
...
ซึ่งหมายความว่าไฟล์ทั้งหมดในไดเร็กทอรี `.i18n/cache/` (ยกเว้น `.i18n/cache/.gitignore` ) จะถูกละเว้น
...
คุณสามารถกำหนดค่า `fromTo` ที่แตกต่างกันสำหรับไดเร็กทอรีย่อย : แตกต่างกัน /
...
ในตารางคอนฟิกูเรชันนี้ ภาษาต้นฉบับของการแปลแค็ตตาล็อก `blog` คือ `zh` และภาษาต้นฉบับของการแปล `blog/your_file_name.md` คือ `ja`

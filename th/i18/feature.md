...
ความ ` ```rust ` การแปลต้องระบุภาษาหลัง ` ``` ` เช่น :
...
รองรับการกำหนดค่าส่วนหัวของบล็อกแบบคงที่ประเภท [HOGO](https://github.com/gohugoio/hugo) ซึ่งแปลเฉพาะฟิลด์ `title` , `summary` และ `description`

...
Kod öppen : [Sök kärna](//github.com/i18n-site/ie/tree/main/qy) / [Interaktivt gränssnitt](//github.com/i18n-site/plugin/tree/main/qy)
...
1. Stöder prefixsökning, som kan visa sökresultat i realtid medan användaren skriver.
...
* `/\p{P}/` är ett reguljärt uttryck som matchar skiljetecken. Specifika matchande symboler inkluderar: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _ ` { | } ~. `.</p><ul><li> `split('.')` beror på att `Firefox` webbläsarordsegmentering inte segmenterar `.` .</li>

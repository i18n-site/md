...
Översättningen är redigerbar; modifiera originaltexten, och när den maskinöversätts igen, kommer de manuella ändringarna av översättningen inte att skrivas över (om detta stycke i originaltexten inte har ändrats).
...
Flerspråkiga forum och arbetsordersystem kan till exempel bäddas in på vilken webbsida som helst, vilket gör att användare kan kommunicera utan hinder.
...
bakänden [axum](https://github.com/tokio-rs/axum) [tower-http](https://github.com/tower-rs/tower-http/releases) .

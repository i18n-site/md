...
Vi använder [vscode](https://code.visualstudio.com/) för att skriva `MarkDown` , och installerar även plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) för att förhandsgranska i realtid medan vi skriver.
...
Ange `code xxx.md` på kommandoraden för att anropa `vscode` för att öppna fil `Markdown` .

...
अनुवाद `.i18h/hash` मूल पाठ के बीच के मैपिंग टोकन स॑ बान्हलऽ छै [i18n.site/token](//i18n.site/token)

## `YAML` : लिंक `HTML` के `Markdown` में बदलय स कोना बचल जाय

`YAML` के मान के अनुवाद के लेल `MarkDown` के रूप में मानल जाइत अछि.

कखनो काल `HTML` → `MarkDown` सँ रूपांतरण हम सभ जे चाहैत छी से नहि होइत अछि, जेना `<a href="/">Home</a>` `[Home](/)` मे परिवर्तित कयल जा रहल अछि ।

`a` टैग मे `href` अलावा कोनो विशेषता कए जोड़ब, जेना `<a class="A" href="/">Home</a>` , एहि रूपांतरण स बचल जा सकैत अछि.

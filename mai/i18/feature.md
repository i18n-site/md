...
मिश्रित HTML Markdown क अनुवाद क समर्थन करैत अछि , `MarkDown` मे एम्बेडेड HTML क `<pre>` आ `<code>` टैग मे सामग्री अनुवाद नहि कएल गेल अछि

## गणितीय सूत्र कें पहचान सकय छै आ अनुवाद छोड़ सकय छै

गणितीय सूत्रकेँ मान्यता देल जाइत अछि आ अनुवाद छोड़ि देल जाइत अछि ।
...
अनुवाद टिप्पणी मे ` ``` ` के बाद के भाषा के संकेत देबय के जरूरत अछि , ` ```rust ` :
...
### अंग्रेजी मे अनुवाद भेला पर शीर्षकक पहिल अक्षर स्वतः कैपिटल भ' जाइत अछि ।
...
जँ अहाँ गूगल वा डीपल केर प्रयोग करैत छी तँ ई दुनू अंग्रेजी शब्दक गलत अनुवाद करैत अछि जे मूल रहबाक चाही (जापानी आ फ्रेंच उदाहरणक रूपमे लिअ) ।

### गूगल अनुवाद

`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` मे अनुवादित :

![](//p.3ti.site/1720199391.avif)

फ्रेंच `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` अनुवादित :

`Falcon` अनुवाद `faucon` आ `Llama` अनुवाद `lama` होइत अछि | विशेषणक रूपमे एकर अनुवाद नहि हेबाक चाही।

![](//p.3ti.site/1720199451.avif)

### DeepL अनुवाद

`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` मे अनुवादित :

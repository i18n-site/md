...
ओहि मे `.i18n/cache/.gitignore` के सामग्री निम्नलिखित अछि :
...
एकर मतलब अछि जे डाइरेक्टरी `.i18n/cache/` मे सभ फाइल ( `.i18n/cache/.gitignore` छोड़ि कए) अनदेखी कएल गेल अछि.

जँ अहाँक संस्करण नियंत्रण सॉफ्टवेयर `git` नहि अछि, तँ कृपया एहि विन्यासक अनुसार एकरा अनदेखी करू.
...
एहि विन्यास तालिका मे, कैटलॉग `blog` अनुवाद क स्रोत भाषा `zh` अछि, आओर `blog/your_file_name.md` अनुवाद क स्रोत भाषा `ja` अछि.
...
`ignore` `.gitignore` फाइल के समान वाक्य रचना [globset](https://docs.rs/globset/latest/globset/#syntax) प्रयोग करैत अछि.
...
मुदा ध्यान राखब जे अनुवादक पाँति आ मूल पाठ एकसँ एक संग मेल खाए पड़त। अर्थात अनुवाद संकलित करबा काल पाँति नहि जोड़ब वा मेटाब । नै तँ अनुवाद संपादन कैशमे भ्रम उत्पन्न करत।

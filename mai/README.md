...
सूचना विस्फोट आ वैश्विक बाजार कें साथ, दुर्लभ ध्यान कें लेल प्रतिस्पर्धा करय कें लेल, **कई भाषाक कें समर्थन करनाय एकटा बुनियादी कौशल छै** .
...
अनेक भाषा मे एकटा कमांड लाइन टूल ( [स्रोत कोड](https://github.com/i18n-site/rust/tree/main/i18) ) `YAML` `Markdown`

के प्रारूप के एकदम सही बना क राखि सकैत छी `Markdown` फाइल संशोधनक कें पहचान कयर सकय छै आ केवल बदलल गेल फाइल कें अनुवाद कयर सकय छै.
...
हम Everything is a File " `UNIX` " साझा करैत छी आ जटिल आ बोझिल उद्यम स्तरीय समाधान के शुरूआत केने बिना सैकड़ों भाषा में अनुवाद के प्रबंधन क सकैत छी |

अनुवाद क॑ `Markdown` लेली आपने सबसें परिचित उपकरणऽ के उपयोग करी सकै छियै (लेकिन आपने पैराग्राफ नै जोड़ै या हटाय सकै छियै), आरू संस्करण नियंत्रण करै लेली सबसें परिचित तरीका के उपयोग करी सकै छियै ।

भाषा फाइल के लेलऽ एक कोड बेस बनैलऽ जाब॑ सकै छै, आरू `Pull Request` 's प्रक्रिया के मदद स॑ वैश्विक उपयोगकर्ता अनुवाद के निरंतर अनुकूलन म॑ भाग ल॑ सकै छै । निर्बाध कनेक्शन आ अन्य ओपन सोर्स समुदाय [github](//github.com)

[→ उपयोगकर्ता गाइड क लेल, कृपया परियोजना दस्तावेजीकरण पढ़ू](/i18) .
...
विशुद्ध रूप स॑ स्थिर, पढ़ै के अनुभव लेली अनुकूलित, आरू [i18](#i18) ई परियोजना दस्तावेज साइट के निर्माण लेली सबसे अच्छा विकल्प छै.

अंतर्निहित फ्रंट-एंड फ्रेमवर्क एकटा पूर्ण प्लग-इन आर्किटेक्चर अपनायत छै, जे माध्यमिक विकास कें लेल आसान छै अगर आवश्यक होय त बैक-एंड फंक्शन कें एकीकृत कैल जा सकय छै.

इ वेबसाइट अइ ढाँचा कें आधार पर विकसित कैल गेल छै आ अइ मे उपयोगकर्ता, भुगतान आ अन्य कार्यक ( [स्रोत कोड](/i18n.site/src) ) शामिल छै.

[→ उपयोगकर्ता गाइड क लेल, कृपया परियोजना दस्तावेजीकरण पढ़ू](/i18n.site) .
...
>
> प्रभु ई देखि बजलाह, "सब मनुक्खक भाषा आ जाति एके अछि। आब जखन ई काज पूरा भ' गेल त' सब किछु भ' जेतै।"
>
> तखन आबि गेल, मनुष्य एक दोसराक भाषा बुझबा मे असमर्थ भ' गेल आ विभिन्न ठाम तितर-बितर भ' गेल।
...
बहुभाषी टिकट प्रणाली जे इनाम द सकैत अछि;

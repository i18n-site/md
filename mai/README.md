...
इंटरनेट भौतिक स्थान में दूरी के समाप्त क देलक अछि, मुदा भाषा के अंतर एखनो मानवीय एकता में बाधा उत्पन्न करैत अछि |
...
हम `UNIX` के दर्शन के सदस्यता लैत छी सब किछु एकटा फाइल " अछि आ बिना जटिल आ बोझिल उद्यम स्तरीय समाधान के परिचय केने सैकड़ों भाषा में अनुवाद के प्रबंधन क सकैत छी "

`Markdown` संपादित करै लेली आपने सबसें परिचित उपकरणऽ के उपयोग करी सकै छियै (लेकिन आपने पैराग्राफ नै जोड़ै या हटाय सकै छियै), आरू संस्करण नियंत्रण करै लेली सबसें परिचित तरीका के उपयोग करी सकै छियै ।

भाषा फाइल कें लेल एकटा ओपन सोर्स कें रूप मे कोड बेस बनायल जा सकय छै, आ `Pull Request` प्रक्रियाक कें मदद सं वैश्विक उपयोगकर्ता अनुवादक कें निरंतर अनुकूलन मे भाग ल सकय छै. निर्बाध कनेक्शन आ अन्य ओपन सोर्स समुदाय [github](//github.com)

[→ उपयोगकर्ता गाइड क लेल, कृपया परियोजना दस्तावेजीकरण पढ़ू](/i18) .

## उत्तम गुणवत्ता मशीन अनुवाद

हम अनुवाद प्रौद्योगिकी केरऽ एगो नया पीढ़ी विकसित करल॑ छै जे पारंपरिक मशीन अनुवाद मॉडल आरू बड़ऽ भाषा मॉडल केरऽ तकनीकी फायदा क॑ एकीकृत करी क॑ अनुवाद क॑ सटीक, सुचारू आरू सुरुचिपूर्ण बनाबै छै ।
...
[अधिकृत करबाक लेल एतय क्लिक करू आ स्वचालित रूप सँ github पालन i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) आ **बोनस $50 प्राप्त करू** !
...
द्विभाषी टिप्पणी आ चैट रूम के समर्थन करैत अछि;

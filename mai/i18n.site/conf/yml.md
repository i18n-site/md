...
उदाहरण के लेल, यदि `/test` तक पहुंचल गेल अछि, आओर `nav:` बिना एहि पथ के कॉन्फ़िगर कएल गेल अछि, आओर पृष्ठ भाषा अंग्रेजी अछि (कोड `en` ), त `/en/test.md` डिफ़ॉल्ट रूप सं लोड कएल जाएत आओर टेम्पलेट `Md` के उपयोग सं रेंडर कएल जाएत.

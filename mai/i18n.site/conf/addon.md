...
प्लग-इन कें `.i18n/conf.yml` मे कॉन्फ़िगर कैल जा सकय छै, जेना:
...
जहाँ `__CONF__` क॑ वर्तमान विन्यास (जैना `dev` या `ol` ) केरऽ नाम स॑ बदललऽ जैतै ।

### afterTran.js

अनुवाद पूरा भेलाक बाद एकरा बजाओल जायत, आ पास कएल गेल पैरामीटर निम्नलिखित अछि ।

* `lang_li` : भाषा सूची, पहिल भाषा स्रोत भाषा अछि
* `changed` संशोधित :
* `root` : जड़ निर्देशिका

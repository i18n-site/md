...
विन्यास मे, कृपया `i18n.site` `.i18n/htm/ol.yml` मे `host:` कें मान मे बदलू, कईटा वस्तु भंडार कें `s3` कें तहत विन्यस्त कैल जा सकय छै, आ `region` फील्ड वैकल्पिक छै (बहुत वस्तु भंडार कें इ फील्ड कें सेट करय कें जरूरत नहि छै).
...
पहिने एकटा मनमाना डोमेन नाम कें `cloudflare` सं बाइंड करू, आओर फेर मुख्य डोमेन नाम कें एहि डोमेन नाम सं जोड़य कें लेल `SSL/TLS` → कस्टम डोमेन नाम कें उपयोग करूं.
...
रूपांतरण नियम जोड़ू जेना कि नीचाँ देखाओल गेल अछि, एकरा पहिने राखू (पहिल केर प्राथमिकता सबसँ कम अछि):
...
एकरऽ अलावा, उपरोक्त `cloudflare` रूपांतरण नियम म॑, `index.html` `file/your_bucketname/index.html` म॑ बदललऽ गेलऽ छै, आरू अन्य विन्यास वू ही रह॑ छै.

...
विन्यास मे, कृपया `i18n.site` `.i18n/htm/ol.yml` मे `host:` कें मान मे बदलू, कईटा वस्तु भंडार कें `s3` तहत विन्यस्त कैल जा सकय छै, आ `region` फील्ड वैकल्पिक छै (बहुत वस्तु भंडार कें इ फील्ड कें सेट करय कें जरूरत नहि छै).
...
डाटा बैडू ऑब्जेक्ट स्टोरेज मे अपलोड कैल जायत छै आ बैडू कंटेंट डिस्ट्रीब्यूशन नेटवर्क सं बाइंड कैल जायत छै.
...
`Debug` क्लिक करू, फेर पूरा नेटवर्क पर प्रकाशित करू पर क्लिक करू.
...
चूँकि `R2` अनुकूलित डोमेन नाम सं एक्सेस `cloudflare` कैल जा सकय छै, स्थिर फाइल कें रखय कें लेल तृतीय-पक्ष वस्तु भंडारण कें उपयोग करय कें जरूरत छै.

`cloudflare` हम [backblaze.com](https://www.backblaze.com)
...
`SSL` मे सँ `cloudflare` केँ संशोधित करू → एन्क्रिप्शन मोड, `Full` पर सेट करू
...
`Rewrite to` डायनामिक चुनू आओर `concat("/file/your_bucketname",http.request.uri.path)` मे `your_bucketname` केँ अपन बाल्टी नाम मे संशोधित करू.

एकरऽ अलावा, उपरोक्त `cloudflare` रूपांतरण नियम म॑, `index.html` क॑ `file/your_bucketname/index.html` म॑ बदललऽ गेलऽ छै, आरू अन्य विन्यास वू ही रह॑ छै.

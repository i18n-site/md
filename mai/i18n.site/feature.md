...
कार्यक्रम `i18` अनुवाद अंतर्निहित अछि, कृपया विशिष्ट उपयोग के लेल [➔ `i18`](/i18) देखू।
...
`i18n.site` रूप स, साइट सामग्री `npmjs.com` पर प्रकाशित कएल जाएत, [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) आओर कईटा `CDN` सामग्री `npm` .
...
सिद्धांत `CDN` : [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
> अनावश्यक सजावट छोड़ि सामग्री केँ अपन शुद्धतम रूप मे प्रस्तुत करैत अछि ।
...
डिफ़ॉल्ट रूप स॑, [अलीमामा ड्यूल-अक्ष चर आयताकार फॉन्ट](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) आरू अन्य ऑनलाइन फॉन्ट क॑ वेबपेज प॑ सक्षम करलऽ जाय छै ताकि विभिन्न प्लेटफॉर्म प॑ उपयोगकर्ता केरऽ पढ़ै के अनुभव क॑ एकीकृत करलऽ जाय सक॑ ।
...
पेज पर एकटा प्यारा सा तैरैत भूत अछि, ओकर आँखि माउस के संग हिलत, [➔ देखबाक लेल एतय क्लिक करू](/404) , `404`

## कोड ओपन सोर्स

[कोड ओपन सोर्स अछि](/i18n.site/src) [.](//groups.google.com/u/2/g/i18n-site)

बहुत रास छोट-छोट आवश्यकता छै जे महत्वपूर्ण छै मुदा जरूरी नै छै विकास टीम अहां कें जे तकनीक मे नीक छी ओकर अनुसार अभ्यास कार्य सौंपतय, आ आवश्यकताक कें नियुक्ति करयत समय विकास दस्तावेजक मे सुधार करतय.

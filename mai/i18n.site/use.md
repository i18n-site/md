...
`md/.i18n/htm/ol.yml` संपादित करू आओर [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` बदलू जेना अपन `npm` पैकेज नाम पर कोनो खाली पैकेज नाम काज [npmjs.com](//npmjs.com) .

तखन `md/.i18n/htm/ol.package.json` संशोधित करू

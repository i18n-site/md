...
`ol` `online` कें संक्षिप्त रूप छै, जे ऑनलाइन `npm` कें `-n` करयत छै, जेकर उपयोग आधिकारिक रिलीज कें लेल कैल जायत छै.
...
`md/.i18n/htm/ol.yml` संपादित करू आओर `v: //unpkg.com/i18n.site` मे `i18n.site` अपन `npm` पैकेज नाम मे बदलू.
...
यदि अहां प्रकाशन कें लेल एकटा निरंतर एकीकरण वातावरण कें उपयोग करय छी, त `nodejs` इंस्टॉल करय कें जरूरत नहि छै, बस लॉग इन आ प्रकाशन अनुमति `~/.npmrc` वातावरण मे कॉपी करूं.
...
पहिल बेर बाइंडिंग के बाद अहां के किछ मिनट इंतजार करय पड़त तखनहि अहां एकरा एक्सेस क सकय छी.

...
चललाक बाद अनुवाद आओर कैश फाइल उत्पन्न कएल जाएत कृपया `git add . ` `md` निर्देशिका मे भंडार मे जोड़ब मोन राखू.
...
जेना, `.i18n/htm/ol.yml` `out/ol` निर्देशिका बनाओत.

`dev.yml` आओर `ol.yml` पूर्वनिर्धारित विन्यास अछि.
...
`ol` `online` कें संक्षिप्त रूप छै, `-n` ऑनलाइन वातावरण कें इंगित करयत छै, जेकर उपयोग आधिकारिक रिलीज कें लेल कैल `npm` छै.

अहां अन्य विन्यास फाइल सेहो `--htm_conf` सकय छी.
...
`md/.i18n/htm/ol.yml` संपादित करू आओर `v: //unpkg.com/i18n.site` मे `i18n.site` केँ अपन `npm` पैकेज नाम मे बदलू.
...
पैकेज `npm` कें आधार पर प्रकाशन करय कें समय, `v:` मान कें उपसर्ग **कें लेल `//unpkg.com/` उपयोग करनाय सुनिश्चित करूं** `i18n.site` नब रिलीज कें समय पर देखनाय प्राप्त करय कें लेल अइ उपसर्ग पथ कें तहत `/.v` कें कैश समय कें विशेष रूप सं अनुकूलित करलक छै.
...
जँ अहाँ `ol.yml` मे `v:` क' पैकेज नाम संशोधित करैत छी , त' कृपया **पहिने `.i18n/v/ol` मेटाब' सुनिश्चित करू** आओर फेर ओकरा प्रकाशित करू.

##### npm द्वारा प्रकाशित प्रॉक्सी सर्वर

यदि मुख्य भूमि चीन मे उपयोगकर्ताक कें नेटवर्क समस्याक कें सामना करय पड़य छै आ `npm` पैकेज प्रकाशित करय मे असमर्थ छै, त ओ प्रॉक्सी सर्वर कें कॉन्फ़िगर करय कें लेल वातावरण चर `https_proxy` कें सेट कयर सकय छै.
...
जँ अहाँ सामग्री केँ स्व-होस्ट करय चाहैत छी, पहिने `md/.i18n/htm/ol.yml` संपादित करू आओर `v: //unpkg.com/i18n.site` अपन यूआरएल उपसर्ग मे बदलू, जेना `v: //i18n-v.xxx.com` .
...
तखन, `md/out/ol/v` निर्देशिका मे सामग्री कें `v:` मे सेट यूआरएल उपसर्ग पथ पर कॉन्फ़िगर करू.
...
सामग्री के स्व-होस्ट `CDN` लेल, अपन सर्वर के उपयोग करय के अलावा, एकटा आओर आम विकल्प अछि `S3` +

अहाँ `S3` सर्वर पर `S3` इन करबाक लेल [rclone](https://rclone.org)
...
पिछला लेख मे सामग्री प्रकाशित करबा काल `out/ol/htm` उत्पन्न भेल अछि कृपया एहि निर्देशिका केँ दर्ज करू आ चलाउ :
...
चूँकि `github page` यूआरएल पथ पुनर्लेखन क समर्थन नहि करैत अछि, एकर बदला मे `404.html` क उपयोग कएल जाइत अछि.
...
`github page` के तुलना में [cloudflare page](//pages.cloudflare.com) ई पथ पुनर्लेखन प्रदान करै छै आरू मुख्य भूमि चीन के लेलऽ अधिक अनुकूल छै आरू एकरऽ उपयोग करै के अनुशंसा अधिक छै.
...
यदि अहां कोनों अन्य संगठन कें गोदाम कें बाउंड कयरने छी, त अहां कें दू बेर अधिकृत करय कें लेल `Add Account` दू बेर क्लिक करय कें जरूरत भ सकय छै, तखन नव संगठन कें प्रदर्शित करय सं पहिले.

![](https://p.3ti.site/1721118306.avif)

अगिला, गोदाम `i18n-demo.github.io` चुनू, फेर `Begin setup` क्लिक करू, आओर बादक चरणक लेल डिफ़ॉल्ट मान क उपयोग करू.
...
तखन, मुख्य भूमि + मे क्लाउड विक्रेता के वस्तु भंडारण के उपयोग करू `CDN` निम्नलिखित सामग्री के तैनात करू `out/ol/htm` .

अहां एकल-पृष्ठ अनुप्रयोगक कें अनुकूल बनय कें लेल पथ कें पुनर्लेखन कें लेल एज कंप्यूटिंग कें उपयोग कयर सकय छी उदाहरण कें लेल, [बैडू स्मार्ट क्लाउड `CDN` कें](//cloud.baidu.com/product/cdn.html) अइ तरह सं कॉन्फ़िगर कैल जा सकय छै:
...
चूँकि रिकॉर्ड `MX` आ रिकॉर्ड `CNAME` सह-अस्तित्व मे नहि भ सकैत अछि, जँ अहाँ एकहि संग डोमेन नाम ईमेल प्राप्त करय चाहैत छी, त' अहाँ केँ रिकॉर्ड `A` मे लेवल `CNAME` धरि स्क्रिप्ट [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) संग सहयोग करबाक आवश्यकता अछि.

एकरऽ अलावा, मुख्य भूमि चीन म॑ क्लाउड विक्रेता केरऽ विदेशी ट्रैफिक शुल्क अपेक्षाकृत महंगा होय के कारण, अगर आपने लागत क॑ अनुकूलित करना चाहै छियै त॑ आपने हासिल करै लेली [हुवावे DNS केरऽ मुफ्त भौगोलिक रिजोल्यूशन](https://support.huaweicloud.com/usermanual-dns/dns_usermanual_0041.html) आरू [Cloudflare for SaaS](https://developers.cloudflare.com/cloudflare-for-platforms/cloudflare-for-saas) केरऽ कस्टम डोमेन नाम (जैना कि नीचें दिखालऽ गेलऽ छै) के उपयोग करी सकै छियै यातायात डायवर्सन──मुख्य भूमि चीन में यातायात बैडू बादल `CDN` , अंतर्राष्ट्रीय यातायात cloudflare जाइत अछि |
...
[अलीबाबा CDN](https://cdn.console.aliyun.com/domain/list) मे डोमेन नाम जोड़ू आ अलीबाबा क्लाउड `CDN` मे डोमेन नाम `*.xxx.com` सँ `CNAME` दिस इशारा करू !
...
कृपया nginx के `server` पैराग्राफ मे निम्नलिखित के समान विन्यास जोड़ू कृपया `/root/i18n/md/out/ol/htm` अपन प्रोजेक्ट `out/ol/htm` के पथ पर बदलू :

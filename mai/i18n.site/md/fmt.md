...
पारंपरिक `MarkDown` एंकर बिन्दु पाठ सामग्री कें आधार पर उत्पन्न कैल जायत छै बहु-भाषा कें मामला मे, इ समाधान संभव नहि छै.

`i18n.site` स॑ सहमत एंकर बिंदु समाधान `MarkDown` म॑ `<a rel=id href="#xxx" id="xxx"></a>` के समान पाठ डालना छै ताकि मैन्युअल रूप स॑ पोजीशनिंग एंकर बिंदु बनाबै के काम करलऽ जाय सक॑ ।
...
## अनेक भाषा मे चित्र/वीडियो/लिंक

`MarkDown` `HTML` मे बदललाक बाद विशेषता `src` आओर `href` मे `$LANG` वर्तमान [भाषा कोड](/i18/LANG_CODE) स बदलल जाएत .

एहि चर के संग अहां चित्र/वीडियो/लिंक के बहुभाषीीकरण हासिल क सकय छी.
...
[i18n.site/payBill](//i18n.site/payBill) musíte pri platbe viazať kreditnú kartu (nie je potrebné dobíjanie, web si automaticky strháva poplatky podľa použitia, [ceny nájdete na domovskej stránke](/#price) ).

## Použitie

### Demo Projekt

Pozrite si demo projekt [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) kde sa dozviete o konfigurácii prekladu `i18` .

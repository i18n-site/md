...
V komentároch k prekladu je potrebné uviesť jazyk po ` ``` ` , : ` ```rust ` .
...
Podporuje konfiguráciu hlavičky statického blogu typu [HOGO](https://github.com/gohugoio/hugo) , ktorý prekladá iba polia `title` , `summary` a `description` .

...
Odporúča sa upravovať číslo verzie dokumentu až po vydaní veľkých aktualizácií (napríklad `v1` , `v2` ), aby ste sa vyhli príliš veľkému počtu čísel verzií, ktoré by spôsobovali neporiadok na stránkach indexovaných vyhľadávačmi.

...
Umožňuje vám rýchlo vytvárať medzinárodné dokumenty a blogy, ktoré podporujú [stovky jazykov](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

...
* `i18` : MarkDown
* `i18n.site` Viacjazyčný generátor statickej stránky dokumentov : **optimalizovaný pre zážitok z čítania**
...
Pošlite poštu na svojpomocne zostavené SMTP [chasquid](https://github.com/albertito/chasquid)

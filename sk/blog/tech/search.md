...
[TinySearch](//github.com/tinysearch/tinysearch) na vyhľadávanie použite filter Bloom, nemožno ho použiť na vyhľadávanie prefixov (napríklad zadajte `goo` , hľadajte `good` , `google` ) a nemôžete dosiahnuť podobný efekt automatického dokončenia.
...
V interakcii s front-endom sa môže / indikátor [priebehu](//juejin.cn/post/7413586285954154522) načítania indexu [,](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) aby sa css oneskoreniu pri prvom progress + .
...
Zároveň, pretože `service worker` ukladá všetky články do vyrovnávacej pamäte, akonáhle používateľ vykoná vyhľadávanie, celý web vrátane vyhľadávania je dostupný offline.

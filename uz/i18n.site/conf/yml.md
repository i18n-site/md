...
Bir nechta chekinish darajasi mavjud bo'lsa, ota-ona darajasi kontentni emas, balki faqat sarlavhani yozadi. Aks holda, tipografiya buziladi.
...
Misol uchun, agar `/test` ga kirsa va `nav:` ushbu yo'lning prefiksisiz sozlangan bo'lsa va joriy ko'rish tili ingliz (kod `en` ) bo'lsa, `/en/test.md` sukut bo'yicha yuklanadi va shablon `Md` yordamida ko'rsatiladi.

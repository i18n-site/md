...
**`foot.pug` ga `css` va `js` yozmang** , aks holda xatolik yuz beradi.
...
Ushbu yozish usuliga o'xshash `${I18N.xxx}` foydalanib, `i18n.yml` bilan birlashtirilib, siz kolontiterni ko'p tilli xalqarolashtirishga erishishingiz mumkin.

Havolaga `class="a"` qo'shish havolani `MarkDown` ga o'tkazishning oldini olishdir. Qarang :
 [➔ `YAML` : `HTML` havolasini `Markdown` ga aylantirishni qanday oldini olish mumkin](/i18/qa#H2) .
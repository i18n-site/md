...
Namoyish loyihasida `en/demo2/v` ga qo'shimcha ravishda `en/blog` va `en/demo1` kataloglarida bo'sh `v` fayl mavjudligini ham ko'rishingiz mumkin.

Yon panel konturida bo'sh `v` ko'rsatilmaydi, lekin `v` fayl mavjud ekan, katalog va pastki katalogdagi fayllar uchun mustaqil indeks hosil bo'ladi.

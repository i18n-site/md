...
Printsip quyidagilardan iborat: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) bilan soʻrovlarni toʻxtatib turish, boshqa `CDN` larda muvaffaqiyatsiz soʻrovlarni qaytadan urinib koʻrish va eng tez javob beruvchi manba saytini standart yuklash manbai sifatida moslashtirish.
...
`404` sahifasida yoqimli suzuvchi sharpa bor, uning ko'zlari sichqoncha bilan harakatlanadi, [➔ Ko'rish uchun shu yerni bosing](/404) ,

...
Nashr qilish uchun uzluksiz integratsiya muhitidan foydalansangiz, `nodejs` o'rnatishning hojati yo'q, shunchaki tizimga kirgan va nashr qilish ruxsatnomasini `~/.npmrc` muhitga nusxalang.
...
Iltimos, ! ning `server` paragrafiga o'xshash `/root/i18n/md/out/ol/htm` `out/ol/htm` nginx

...
Markdown HTML tarjimasini qo'llab-quvvatlaydi, `MarkDown` ga o'rnatilgan HTML ning `<pre>` va `<code>` teglaridagi kontent tarjima qilinmaydi
...
[github ni avtorizatsiya qilish va avtomatik ravishda kuzatib i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) va **$50 olish uchun** shu yerni bosing.
...
[HOGO](https://github.com/gohugoio/hugo) `title` , `summary` va `description` maydonlarini tarjima qiladigan statik blogning sarlavha konfiguratsiyasini qo'llab-quvvatlaydi.
...
Fransuz tiliga tarjima `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Yuqoridagilarning frantsuz tiliga tarjimasi (shuningdek DeepL tegishli nomlarni qayta yozish va toq `... ` qo'shish):

...
Xitoy, yapon va koreys tillarining mashina tarjimasi ingliz tilidan tashqari tilga aylandi va atamalar ko'pincha birgalikda tarjima qilinadi, masalan, quyidagi xitoycha jumla:
...
Yuqoridagilarni DeepL tiliga tarjima qiling (shuningdek, tegishli nomlarni qayta yozing va toq `... ` qo'shing):
...
Faqat inglizcha so'z bilan xitoycha, yaponcha va koreyscha matn o'rtasida bo'sh joy bo'lsa yoki inglizcha uzunligi 1 dan katta bo'lsa, so'z atama sifatida qabul qilinadi.
...
Mijoz butunlay ochiq manba va kodning % server 90 [manba kodini ko'rish uchun shu yerni bosing](/i18n.site/src) .

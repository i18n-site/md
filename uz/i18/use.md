...
windows Tizim, avval [`git bash` yuklab olish va o'rnatish uchun shu yerni bosing](https://git-scm.com/download/win) .
...
`i18` tarjimasi konfiguratsiyasini o'rganish uchun demo loyihasiga murojaat qiling [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18)
...
Ushbu konfiguratsiya jadvalida katalog `blog` tarjimasining manba tili `zh` ga, `blog/your_file_name.md` tarjimasining manba tili esa `ja` ga teng.
...
`ignore` `.gitignore` fayl bilan bir xil [globset](https://docs.rs/globset/latest/globset/#syntax) foydalanadi.

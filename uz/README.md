<h1 style="display:flex;justify-content:space-between">i18n.site Xalqaro yechimlar<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Brauzerda o'rnatilgan tarjima mavjud bo'lsa-da, qidiruv tizimlari hali ham tillar bo'ylab so'rov qila olmaydi.
...
## <a rel=id href="#project" id="project"></a> Loyiha tavsifi

Ushbu sayt hozirda ikkita ochiq kodli buyruq qatori vositalarini taqdim etadi:

* [i18 : MarkDown qatorini tarjima qilish vositasi](/i18/feature)
...
`Markdown` va `YAML` bir nechta tillarda buyruq qatori vositasiga ( [manba kodi](https://github.com/i18n-site/rust/tree/main/i18) ) tarjima qiling.

ning formatini mukammal darajada ushlab turishi mumkin `Markdown` Fayl o'zgarishlarini aniqlay oladi va faqat o'zgartirilgan fayllarni tarjima qiladi.
...
Biz hamma narsa fayl " `UNIX` baham ko'ramiz va korporativ darajadagi murakkab va noqulay echimlarni kiritmasdan " yuzlab tillardagi tarjimalarni boshqarishimiz mumkin.

Tarjimani `Markdown` uchun siz eng tanish vositalardan foydalanishingiz mumkin (lekin siz paragraflarni qo'sha olmaysiz yoki o'chira olmaysiz) va versiyani boshqarishning eng tanish usulidan foydalanishingiz mumkin.

Kod bazasi til fayllari uchun ochiq manba sifatida yaratilishi mumkin va `Pull Request` ning yordami bilan global foydalanuvchilar tarjimalarni uzluksiz optimallashtirishda ishtirok etishlari mumkin. Uzluksiz [github](//github.com) va boshqa ochiq manbali jamoalar.
...
Sof statik, o‘qish tajribasi uchun optimallashtirilgan va [i18](#i18) bu loyiha hujjatlari saytini yaratish uchun eng yaxshi tanlovdir.
...
Ushbu veb-sayt ushbu tizim asosida ishlab chiqilgan va foydalanuvchi, to'lov va boshqa funktsiyalarni o'z ichiga oladi ( [manba kodi](/i18n.site/src) ) Batafsil o'quv qo'llanma keyinroq yoziladi.

[→ Foydalanuvchi qoʻllanmasi uchun loyiha hujjatlarini oʻqing](/i18n.site) .
...
> Ular: “Kel, osmonga yetadigan minora qur va inson zotini mashhur qil”, dedilar.
>

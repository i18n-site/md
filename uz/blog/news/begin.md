...
Tarjima asl matnni o'zgartirish mumkin va u qayta tarjima qilinganda, tarjimaga qo'lda kiritilgan o'zgartirishlar yozilmaydi (agar asl matnning ushbu bandi o'zgartirilmagan bo'lsa).
...
Mavjud tarjimalarni boshqarish vositalari juda `git` .
...
O'z-o'zidan qurilgan [chasquid](https://github.com/albertito/chasquid) ga xat yuboring SMTP

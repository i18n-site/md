...
* `i18` : MarkDown qatorini tarjima qilish vositasi
...
Mavjud tarjimani boshqarish vositalari juda og'ir, `git` versiya boshqaruviga tayanadigan dasturchilar uchun ular hali ham buyruq qatorini afzal ko'rishadi.
...
Front-end, backend va buyruq qatori [kodlari hammasi ochiq manbadir](https://i18n.site/i18n.site/c/src) (tarjima modeli hali ochiq manba emas).

Qo'llaniladigan texnologiya to'plami quyidagicha:
...
Buyruqlar qatori [o'rnatilgan js boa_engine](https://docs.rs/boa_engine) , [o'rnatilgan ma'lumotlar bazasi fjall](https://github.com/fjall-rs/fjall) .

server [contabo](https://my.contabo.com) VPS

ma'lumotlar bazasi [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

O'z-o'zidan qurilgan SMTP ga xat yuboring [chasquid](https://github.com/albertito/chasquid)

## Biz Bilan Bog'lanish

Yangi mahsulotlar ishlab chiqarilsa, muammolar muqarrar.

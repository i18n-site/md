...
क्योंकि दस्तावेज़ लिखते समय, मार्कडाउन फ़ाइल नामों को अक्सर समायोजित किया जाता है, जिसके परिणामस्वरूप अनुवाद निर्देशिका में कई पुरानी और परित्यक्त फ़ाइलें आ जाती हैं।

अन्य भाषा निर्देशिकाओं में हटाई जाने वाली फ़ाइलों को साफ़ करने के लिए इस पैरामीटर का उपयोग करें।

## `-d` अनुवाद निर्देशिका निर्दिष्ट करें

अनुवादित निर्देशिका उस निर्देशिका पर डिफ़ॉल्ट होती है जहां वर्तमान फ़ाइल स्थित है।

`-d` या `--workdir` अनुवाद निर्देशिका निर्दिष्ट कर सकते हैं, जैसे:
...
`-h` या `--help` कमांड लाइन सहायता देख सकते हैं।
...
अनुवाद टिप्पणियों ` ```rust ` ` ``` ` के बाद की भाषा को इंगित करना आवश्यक है, जैसे कि :
...
प्रोग्रामर जो `git` , `vim` , और `vscode` से परिचित हैं, उनके लिए दस्तावेज़ों को संपादित करने और संस्करणों को प्रबंधित करने के लिए इन उपकरणों का उपयोग करने से निस्संदेह सीखने की लागत में वृद्धि होगी।
...
[HOGO](https://github.com/gohugoio/hugo) प्रकार के स्थिर ब्लॉग के हेडर कॉन्फ़िगरेशन का समर्थन करता है, जो केवल फ़ील्ड `title` , `summary` और `description` का अनुवाद करता है।
...
`Falcon` का अनुवाद `faucon` और `Llama` का अनुवाद `lama` है। व्यक्तिवाचक संज्ञा के रूप में उनका अनुवाद नहीं किया जाना चाहिए।

...
`Markdown` और `YAML` एक कमांड लाइन टूल ( [स्रोत कोड](https://github.com/i18n-site/rust/tree/main/i18) ) में कई भाषाओं में अनुवाद करें।

के प्रारूप को पूरी तरह से बनाए रख सकते हैं `Markdown` फ़ाइल संशोधनों की पहचान कर सकता है और केवल परिवर्तित फ़ाइलों का अनुवाद कर सकता है।
...
हम सब कुछ एक फ़ाइल है " `UNIX` " को साझा करते हैं और जटिल और बोझिल उद्यम-स्तरीय समाधान पेश किए बिना सैकड़ों भाषाओं में अनुवाद का प्रबंधन कर सकते हैं।

आप अनुवाद को `Markdown` के लिए सबसे परिचित टूल का उपयोग कर सकते हैं (लेकिन आप पैराग्राफ जोड़ या हटा नहीं सकते हैं), और संस्करण नियंत्रण करने के लिए सबसे परिचित तरीके का उपयोग कर सकते हैं।

भाषा फ़ाइलों के लिए एक खुले स्रोत के रूप में एक कोड आधार बनाया जा सकता है, और `Pull Request` की प्रक्रिया की मदद से, वैश्विक उपयोगकर्ता अनुवाद के निरंतर अनुकूलन में भाग ले सकते हैं। निर्बाध कनेक्शन [github](//github.com) और अन्य खुले स्रोत समुदाय।

[→ उपयोगकर्ता गाइड के लिए, कृपया प्रोजेक्ट दस्तावेज़ पढ़ें](/i18) ।
...
पूरी तरह से स्थिर, पढ़ने के अनुभव के लिए अनुकूलित, और [i18](#i18) यह एक प्रोजेक्ट दस्तावेज़ साइट बनाने के लिए सबसे अच्छा विकल्प है।
...
यह वेबसाइट इस ढांचे के आधार पर विकसित की गई है और इसमें उपयोगकर्ता, भुगतान और अन्य कार्य ( [स्रोत कोड](/i18n.site/src) ) शामिल हैं। एक विस्तृत ट्यूटोरियल बाद में लिखा जाएगा।

[→ उपयोगकर्ता गाइड के लिए, कृपया प्रोजेक्ट दस्तावेज़ पढ़ें](/i18n.site) ।

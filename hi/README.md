...
हम `UNIX` के दर्शन की सदस्यता लेते हैं " सब कुछ एक फ़ाइल है " और जटिल और बोझिल उद्यम-स्तरीय समाधान पेश किए बिना सैकड़ों भाषाओं में अनुवाद का प्रबंधन कर सकते हैं।

आप `Markdown` को संपादित करने के लिए सबसे परिचित टूल का उपयोग कर सकते हैं (लेकिन आप पैराग्राफ जोड़ या हटा नहीं सकते हैं), और संस्करण नियंत्रण करने के लिए सबसे परिचित तरीके का उपयोग कर सकते हैं।
...
हमने अनुवाद तकनीक की एक नई पीढ़ी विकसित की है जो अनुवाद को सटीक, सहज और सुरुचिपूर्ण बनाने के लिए पारंपरिक मशीन अनुवाद मॉडल और बड़े भाषा मॉडल के तकनीकी लाभों को एकीकृत करती है।
...
[अधिकृत करने और स्वचालित रूप से github का अनुसरण i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) और **बोनस $50 प्राप्त करने** के लिए यहां क्लिक करें।
...
### i18n.site: बहु-भाषा स्थैतिक साइट जनरेटर
...
हम आशा करते हैं कि समस्त मानव जाति एक साझा सपने के साथ एक साथ आयेगी।

मार्कडाउन अनुवाद और दस्तावेज़ीकरण साइटें तो बस शुरुआत हैं।
सामग्री पोस्टिंग को सोशल मीडिया पर सिंक्रोनाइज़ करें;
द्विभाषी टिप्पणियों और चैट रूम का समर्थन करता है;

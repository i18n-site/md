...
## अनेक भाषाओं में चित्र/वीडियो/लिंक

`MarkDown` को `HTML` में परिवर्तित करने के बाद, गुण `src` और `href` में `$LANG` वर्तमान [भाषा कोड](/i18/LANG_CODE) से बदल दिया जाएगा।

इस वेरिएबल के साथ, आप चित्रों/वीडियो/लिंक का बहुभाषीकरण प्राप्त कर सकते हैं।
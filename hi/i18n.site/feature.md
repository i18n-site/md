...
कार्यक्रम में अंतर्निहित अनुवाद `i18` , कृपया विशिष्ट उपयोग के लिए [➔ `i18`](/i18) देखें।
...
`i18n.site` डिफ़ॉल्ट रूप से, साइट सामग्री को [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) और एकाधिक `CDN` सामग्री की सहायता से `npmjs.com` किया जाएगा `npm`
...
सिद्धांत यह है: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) मदद से अनुरोध को रोकें, यदि अनुरोध विफल हो जाता है, तो इसे अन्य `CDN` पर पुनः प्रयास करें, और डिफ़ॉल्ट लोडिंग स्रोत के रूप में सबसे तेज़ प्रतिक्रिया देने वाले मूल स्टेशन को सक्षम करें।
...
डिफ़ॉल्ट रूप से, विभिन्न प्लेटफार्मों पर उपयोगकर्ताओं के पढ़ने के अनुभव को एकीकृत करने के लिए [अलीमामा डुअल-एक्सिस वेरिएबल आयताकार फ़ॉन्ट](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) और अन्य ऑनलाइन फ़ॉन्ट वेबपेज पर सक्षम हैं।
...
`404` पेज पर एक प्यारा सा तैरता हुआ भूत है, उसकी आंखें माउस से हिलेंगी, [➔ देखने के लिए यहां क्लिक करें](/404) ,

## कोड खुला स्रोत

[कोड खुला स्रोत है](/i18n.site/src) । यदि आप विकास में भाग लेने में रुचि रखते हैं, तो कृपया [मेलिंग सूची](//groups.google.com/u/2/g/i18n-site) में अपना परिचय दें।

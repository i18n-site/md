...
* `i18n.addon/toc` :
  `TOC` आधार पर `json` की निर्देशिका अनुक्रमणिका उत्पन्न करें, जो डिफ़ॉल्ट रूप से सक्षम है
...
जहां `__CONF__` वर्तमान कॉन्फ़िगरेशन के नाम से बदल दिया जाएगा (जैसे कि `dev` या `ol` )।
...
अंतर्निहित `js` रनटाइम द्वितीयक [boa](https://github.com/boa-dev/boa) पर आधारित है, और अंतर्निहित फ़ंक्शन इस प्रकार हैं :

...
### `use: Toc` , रूपरेखा के साथ एकल फ़ाइल टेम्पलेट
...
### `use: Md` , रूपरेखा के बिना एकल फ़ाइल टेम्पलेट
...
### `use: Doc` , बहु-फ़ाइल दस्तावेज़ टेम्पलेट
...
उपरोक्त लेखन विधि `url: xxx` के बराबर है, और इसकी संबंधित फ़ाइल `en/xxx/TOC` है।

#### सामग्री सूचकांक की टीओसी तालिका

`i18n.site` `json` निर्देशिका रूपरेखा उत्पन्न करने के लिए `doc` टेम्पलेट कॉन्फ़िगरेशन के अनुरूप `TOC` निर्देशिका इंडेक्स फ़ाइल को पढ़ने के लिए डेमो वेयरहाउस में `js` प्लग-इन `.i18n/hook/after.tran/TOC.js` निष्पादित करेगा।

यदि आप `doc` टेम्पलेट का उपयोग करते हैं, तो आपके पास यह प्लग-इन होना चाहिए।

यदि आप किसी खाली फ़ोल्डर से प्रोजेक्ट `i18n.site` प्रारंभ करते हैं, तो डेमो प्रोजेक्ट `.i18n` अपनी निर्देशिका में कॉपी करना याद रखें।
...
आप देख सकते हैं कि `Deme Two` की प्रोजेक्ट टैगलाइन ड्रॉप-डाउन मेनू और कैटलॉग आउटलाइन प्रोजेक्ट नाम `Your Project slogan` के नीचे है :

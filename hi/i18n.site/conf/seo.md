...
स्थिर पृष्ठों पर, इस पृष्ठ के विभिन्न भाषा संस्करणों के लिंक को इंगित करने के लिए `link` का उपयोग करें, जैसे :
...
कॉन्फ़िगरेशन में, कृपया `i18n.site` `host:` `.i18n/htm/ol.yml` मान में बदलें, एकाधिक ऑब्जेक्ट स्टोर्स को `s3` अंतर्गत कॉन्फ़िगर किया जा सकता है, और `region` फ़ील्ड वैकल्पिक है (कई ऑब्जेक्ट स्टोर्स को इस फ़ील्ड को सेट करने की आवश्यकता नहीं है)।
...
### डोमेन नाम अन्य `DNS` में होस्ट किया गया है, `cloudflare` का उपयोग कैसे करें
...
क्योंकि `R2` अनुकूलित डोमेन नाम द्वारा एक्सेस `cloudflare` , स्थिर फ़ाइलों को रखने के लिए एक तृतीय-पक्ष ऑब्जेक्ट स्टोरेज का उपयोग करने की आवश्यकता होती है।
...
`SSL` में से `cloudflare` को संशोधित करें → एन्क्रिप्शन मोड, `Full` पर सेट करें
...
`Rewrite to` डायनामिक का चयन करें और अपने बकेट नाम में `your_bucketname` इन `concat("/file/your_bucketname",http.request.uri.path)` को संशोधित करें।

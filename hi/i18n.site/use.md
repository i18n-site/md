...
`md/.i18n/htm/ol.yml` संपादित करें और [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` के मान को अपने `npm` पैकेज नाम के रूप में बदलें [npmjs.com](//npmjs.com)

फिर संशोधित करें `md/.i18n/htm/ol.package.json`

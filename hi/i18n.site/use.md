...
पैकेज `npm` के आधार पर प्रकाशित करते समय, `v:` मान के उपसर्ग के लिए **`//unpkg.com/` उपयोग करना सुनिश्चित** करें। नई रिलीज़ को समय पर देखने के लिए `i18n.site` इस उपसर्ग पथ के तहत `/.v` के कैश समय को विशेष रूप से अनुकूलित किया है।

अनुवाद और प्रकाशन के लिए `md` निर्देशिका में `i18n.site --npm` या `i18n.site -n` चलाएँ।

यदि आप प्रकाशित करने के लिए निरंतर एकीकरण वातावरण का उपयोग करते हैं, तो `nodejs` स्थापित करने की कोई आवश्यकता नहीं है, बस लॉग इन और प्रकाशन अनुमति `~/.npmrc` पर्यावरण में कॉपी करें।

यदि आप `v:` में `ol.yml` के पैकेज नाम को संशोधित करते हैं, तो कृपया **पहले `.i18n/v/ol` हटाना सुनिश्चित करें** और फिर इसे प्रकाशित करें।
...
फिर, मुख्य भूमि + में क्लाउड विक्रेताओं के ऑब्जेक्ट स्टोरेज का उपयोग करें `CDN` निम्नलिखित सामग्री तैनात करें `out/ol/htm` ।

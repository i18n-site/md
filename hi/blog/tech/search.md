...
यह आलेख `i18n.site` शुद्ध फ्रंट-एंड पूर्ण-पाठ खोज तकनीक के कार्यान्वयन को साझा करेगा [i18n.site](//i18n.site) आप खोज प्रभाव का अनुभव कर सकते हैं।

कोड ओपन सोर्स [सर्च](//github.com/i18n-site/ie/tree/main/qy) [कर्नेल](//github.com/i18n-site/plugin/tree/main/qy) /

## सर्वर रहित पूर्ण-पाठ खोज समाधानों का अवलोकन

दस्तावेज़/व्यक्तिगत ब्लॉग जैसी छोटी वेबसाइटों के लिए जो पूरी तरह से स्थिर हैं, अपने आप से एक पूर्ण-पाठ खोज बैकएंड बनाना निस्संदेह बहुत भारी है, और सेवाओं के बिना पूर्ण-पाठ खोज निस्संदेह एक बेहतर वजन है।

मौजूदा सर्वर रहित पूर्ण-पाठ खोज समाधान दो व्यापक श्रेणियों में आते हैं।

एक [algolia.com](//algolia.com) जो फ्रंट-एंड पूर्ण-पाठ खोज घटक प्रदान करता है।

ऐसी सेवाओं के लिए भुगतान की आवश्यकता होती है और वेबसाइट अनुपालन मुद्दों के कारण ये मुख्य भूमि चीन में उपयोगकर्ताओं के लिए उपलब्ध नहीं हैं।
...
अधिक प्रसिद्ध शुद्ध फ्रंट-एंड पूर्ण-पाठ खोजों में [lunrjs](https://lunrjs.com) और [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) शामिल हैं।

`lunrjs` इंडेक्स बनाने के दो तरीके हैं, लेकिन दोनों की अपनी-अपनी समस्याएं हैं।
...
[fusejs](https://www.fusejs.io) , खोजने के लिए स्ट्रिंग्स के बीच समानता की गणना करें।

इस समाधान का प्रदर्शन बेहद खराब है और इसका उपयोग पूर्ण-पाठ खोज के लिए नहीं किया जा सकता है (देखें [Fuse.js लंबी क्वेरी में 10 सेकंड से अधिक समय लगता है, इसे कैसे अनुकूलित करें?](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) )।

[TinySearch](https://github.com/tinysearch/tinysearch) , खोजने के लिए ब्लूम फ़िल्टर का उपयोग करें, उपसर्ग खोज के लिए उपयोग नहीं किया जा सकता है (उदाहरण के लिए, `goo` दर्ज करें, `good` खोजें, `google` ), और समान स्वचालित पूर्णता प्रभाव प्राप्त नहीं कर सकता है।

मौजूदा समाधानों की कमियों से असंतुष्ट होकर, `i18n.site` एक नया शुद्ध फ्रंट-एंड पूर्ण-पाठ खोज समाधान विकसित किया, जिसमें निम्नलिखित विशेषताएं हैं :
...
* `prefix` : उपसर्ग की सारणी - शब्द id
...
फ्रंट-एंड इंटरैक्शन में, पहली बार लोड करते समय अंतराल से बचने के लिए इंडेक्स लोडिंग प्रगति बार प्रदर्शित किया जा सकता है। "एनीमेशन के साथ प्रगति बार, एकल पर आधारित progress + शुद्ध css कार्यान्वयन" [अंग्रेजी](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [चीनी](https://juejin.cn/post/7413586285954154522) देखें।

### IndexedDB उच्च समवर्ती लेखन

प्रोजेक्ट को अतुल्यकालिक एनकैप्सुलेशन के आधार पर [idb](https://www.npmjs.com/package/idb) है IndexedDB

IndexedDB पढ़ना और लिखना अतुल्यकालिक है। इंडेक्स बनाते समय, इंडेक्स बनाने के लिए दस्तावेजों को एक साथ लोड किया जाएगा।
...
उपयोगकर्ता द्वारा टाइप करते समय खोज परिणाम प्रदर्शित करने के लिए, उदाहरण के लिए, जब `wor` दर्ज किया जाता है, तो `wor` के पहले लगे शब्द जैसे `words` और `work` प्रदर्शित होते हैं।
...
तेजी से प्रतिक्रिया और सर्वर की कोई आवश्यकता नहीं होने के साथ, उलटा पूर्ण-पाठ खोज पूरी तरह से फ्रंट एंड पर लागू की गई है।

दस्तावेज़ और व्यक्तिगत ब्लॉग जैसी छोटी और मध्यम आकार की वेबसाइटों के लिए बहुत उपयुक्त है।
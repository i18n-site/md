...
Ang mga full-text na solusyon sa paghahanap na walang server ay nahahati sa dalawang malawak na kategorya:
...
Ginagamit ng Word segmentation ang native word segmentation ng browser `Intl.Segmenter` , at sinusuportahan ng lahat ng pangunahing browser ang interface na ito.
...
Ipasa ang hanay ng dokumento `url` at bersyon numero `ver` , at hanapin kung ang dokumento ay umiiral sa talahanayan `doc` Kung wala ito, lumikha ng isang baligtad na index. Kasabay nito, alisin ang baligtad na index para sa mga dokumentong hindi naipasa.

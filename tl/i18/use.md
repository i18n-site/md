...
Hahanapin ng command line tool ang lahat ng file na nagtatapos sa `.yml` sa source language file directory at isalin ang mga ito.
...
Maaaring hatiin ng mga proyektong gumagamit ng [monorepo](//monorepo.tools) arkitektura ang mga file ng wika sa mga subdirectory.

...
Ang bilang ng mga code ng wika ay naayos at ang mga bagong wika ay idaragdag sa ibang pagkakataon.

| serial number | code | wika | display name |
| - | - | - | - |
| 0 | `en` | Ingles | `English` |
| 1 | `zh` | Pinasimpleng Chinese | `简体中文` |
| 2 | `de` | Aleman | `Deutsch` |
...
| 81 | `zh-TW` | Tradisyunal na Intsik | `正體中文` |

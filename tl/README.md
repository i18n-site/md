...
" -subscribe kami sa pilosopiya ng `UNIX` "

Maaari mong gamitin ang pinakapamilyar na mga tool upang i-edit ang `Markdown` (ngunit hindi ka maaaring magdagdag o magtanggal ng mga talata), at gamitin ang pinakapamilyar na paraan upang gawin ang kontrol sa bersyon.
...
Nakagawa kami ng bagong henerasyon ng teknolohiya sa pagsasalin na isinasama ang mga teknikal na bentahe ng tradisyonal na mga modelo ng pagsasalin ng makina at mga modelo ng malalaking wika upang gawing tumpak, maayos at elegante ang mga pagsasalin.
...
[Mag-click dito upang pahintulutan at awtomatikong sundin i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) at **makatanggap ng bonus na $50** .

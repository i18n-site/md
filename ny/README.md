<h1 style="display:flex;justify-content:space-between">i18n.site Njira zapadziko lonse lapansi<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Ndi kuphulika kwa chidziwitso komanso msika wapadziko lonse lapansi, kuti mupikisane ndi chidwi chosowa, **kuthandizira zilankhulo zingapo ndi luso lofunikira** .
...
## <a rel=id href="#project" id="project"></a> Kufotokozera Ntchito
...
`YAML` `Markdown`[](https://github.com/i18n-site/rust/tree/main/i18)

Itha kusunga mawonekedwe a `Markdown` Itha kuzindikira zosinthidwa zamafayilo ndikumasulira mafayilo osinthidwa okha.
...
Timagawana " `UNIX` Chilichonse ndi Fayilo " ndipo timatha kuyang'anira zomasulira m'zilankhulo mazanamazana popanda kubweretsa zovuta komanso zovuta zamabizinesi.

Mutha kugwiritsa ntchito zida zodziwika bwino kuti `Markdown` zomasulira (koma simungawonjezere kapena kufufuta ndime), ndikugwiritsa ntchito njira yodziwika bwino yowongolera zomasulira.

Ma code maziko atha kupangidwa ngati gwero lotseguka la mafayilo azilankhulo, ndipo mothandizidwa ndi ndondomeko ya `Pull Request` Kulumikizana kopanda msoko [github](//github.com) madera ena otseguka.

[→ Kuti muwongolere ogwiritsa ntchito, chonde werengani zolemba za polojekitiyi](/i18) .

## Kutanthauzira Kwapamwamba Kwambiri Kwa Xindaya
...
Kuti mukwaniritse mtundu womwewo, kuchuluka kwa zosintha `3.15` `2.67` Google Translate imafunikira ndipo `ChatGPT`
...
Zindikirani: Chiwerengero cha zilembo zolipiridwa = [kuchuluka kwa unicode](https://en.wikipedia.org/wiki/Unicode) zomwe zili mufayilo yoyambira × kuchuluka kwa zilankhulo zomwe zimamasuliridwa
...
Zosasunthika, zokometsedwa pakuwerenga, komanso kuphatikizidwa ndi kumasulira kwa [i18](#i18) ndiye chisankho chabwino kwambiri pomanga tsamba lachikalata cha polojekiti.
...
Webusaitiyi imapangidwa potengera dongosololi ndipo imaphatikizapo wogwiritsa ntchito, malipiro ndi ntchito zina ( [gwero lachidziwitso](/i18n.site/src) ).

[→ Kuti muwongolere ogwiritsa ntchito, chonde werengani zolemba za polojekitiyi](/i18n.site) .
...
Takulandilaninso kutsata maakaunti / [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) [X.COM: @i18nSite](https://x.com/i18nSite)

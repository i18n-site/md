...
Pulogalamuyi `i18` , chonde onani [➔ `i18`](/i18) kuti mugwiritse ntchito mwapadera.
...
`i18n.site` Mwachisawawa, zomwe zili patsamba zidzasindikizidwa ku `npmjs.com` , mothandizidwa ndi [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) ndi zambiri `CDN` zomwe zayikidwa pa `npm` .
...
Mfundo yake ndi: vomerezani `CDN` mothandizidwa ndi [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
`404` Patsambapo pali mzimu wokongola woyandama, maso ake amayenda ndi mbewa, [➔ Dinani apa kuti muwone](/404) ,

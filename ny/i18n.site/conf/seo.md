...
Chifukwa `R2` `cloudflare` ndi dzina lachidziwitso chokhazikika, kusungirako chinthu chachitatu chiyenera kugwiritsidwa ntchito kuyika mafayilo osasunthika.

Apa [backblaze.com](https://www.backblaze.com) mwachitsanzo kusonyeza momwe tingamangirire zinthu za chipani chachitatu kuti zisungidwe pa `cloudflare` .

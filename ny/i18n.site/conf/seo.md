...
Dzina lachidziwitso lakhazikitsidwa ku [cloudflare](//www.cloudflare.com)
...
Chifukwa `cloudflare` chinthu `R2` sichingapezeke ndi dzina lachidziwitso chokhazikika, kusungirako kwa chinthu chachitatu kuyenera kugwiritsidwa ntchito kuyika mafayilo osasunthika.
...
Onjezani lamulo lotembenuka monga momwe likusonyezera pansipa, ikani poyamba (loyamba limakhala lotsika kwambiri):

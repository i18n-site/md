...
Maina afayilo omwe adagwirizana ndi awa
...
Idzatchedwa kumasulira kumalizidwa, ndipo magawo omwe adadutsamo ndi awa.
...
Nthawi yothamangitsira `js` idakhazikitsidwa pakukula kwachiwiri kwa [boa](https://github.com/boa-dev/boa) ndipo ntchito zomangidwa ndi izi :

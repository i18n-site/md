# Mndandanda Wamawonekedwe

[Dinani apa kuti musakatule fayilo yoyambira patsamba lino](//raw.githubusercontent.com/i18n-site/md/refs/heads/main/$LANG/i18n.site/md/styl.md) kuti muwone momwe mungalembe `MarkDown` mumasitayelo otsatirawa.
...
Wolemba `MarkDown` wa chida chomangira webusayiti `i18n.site` wakonza mawu oyambira, opitilira muyeso, komanso mawu olimba mtima. Itha kugwira ntchito popanda mipata isanachitike komanso itatha chizindikiro, kupangitsa kuti zikhale zosavuta kulemba zilankhulo m'zilankhulo monga China, Japan, ndi Korea. amene sagwiritsa ntchito mipata ngati olekanitsa.
...
> [!WARN]
> Pamene mukuyenda ulendo wamtchire, ndikofunikira kukhala otetezeka.
> Sabata yatha, gulu la anthu okwera phirili lidakumana ndi chimphepo chamkuntho pakati pa phirilo ndipo adayenera kusamuka chifukwa adalephera kuyang'ana momwe nyengo ikuyendera.
> Kumbukirani, ntchito iliyonse yapanja imafuna kukonzekera kokwanira ndi chisamaliro chanyengo.
...
* zochitika zamagulu
  ...
  - Konzani kusonkhana kwa mabwenzi
    + Panja BBQ
    + filimu usiku
...
M'dziko lalikulu la zilankhulo zamapulogalamu, `Rust` , `Python` , `JavaScript` ndi `Go` aliyense ali ndi udindo wapadera.

### Mizere Ingapo Yama Code

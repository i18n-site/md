...
Mwachitsanzo, `.i18n/htm/ol.yml` ipanga chikwatu `out/ol` .
...
Ngati musintha dzina la phukusi la `v:` mu `ol.yml` , chonde **onetsetsani kuti mwachotsa `.i18n/v/ol`** kaye ndikusindikiza.

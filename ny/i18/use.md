...
M'ndandanda iyi yomasulira, chinenero chomasuliridwa mu katatalogu `blog` ndi `zh` , ndipo chinenero chomasuliridwa cha khathalogi `blog/your_file_name.md` ndi `ja` .

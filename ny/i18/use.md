...
[i18n.site/payBill](//i18n.site/payBill) , muyenera kumangirira kirediti kadi kuti mulipire (palibe kubwezanso komwe kumafunikira, tsamba lawebusayiti lizichotsa zokha zolipirira malinga ndi momwe zimagwiritsidwira ntchito, [onani tsamba loyamba lamitengo](/#price) ).
...
Zosiyana `fromTo` zitha kukhazikitsidwa pamafayilo osiyanasiyana Mafayilo amalembedwa : /
...
Pazochunira izi, chilankhulo chomasulira `blog` ndi `zh` , ndipo chilankhulo chomasulira chikwatu `blog/your_file_name.md` ndi `ja` .

### Nyalanyazani Fayilo

Mwachisawawa, mafayilo onse kuyambira `.md` ndi `.yml` mu bukhu lachiyankhulo choyambira adzamasuliridwa.

Ngati mukufuna kunyalanyaza mafayilo ena ndikusawamasulira (monga zolemba zosamalizidwa), mutha kugwiritsa ntchito kasinthidwe ka `ignore` .

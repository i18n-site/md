...
## ஒருங்கிணைக்கப்பட்ட `i18`

நிரலில் உள்ளமைக்கப்பட்ட மொழிபெயர்ப்பு `i18` , குறிப்பிட்ட பயன்பாட்டிற்கு [➔ `i18`](/i18) பார்க்கவும்.
...
கொள்கை `CDN` : கோரிக்கையை இடைமறித்து [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)

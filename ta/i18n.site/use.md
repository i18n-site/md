...
இயங்கிய பிறகு, மொழிபெயர்ப்பு மற்றும் கேச் கோப்புகள் உருவாக்கப்படும், `git add . ` `md` கோப்பகத்தில் சேர்க்க நினைவில் கொள்க.
...
`md/.i18n/htm/ol.yml` திருத்தி, `v: //unpkg.com/i18n.site` இல் `i18n.site` உங்கள் சொந்த `npm` தொகுப்புப் பெயருக்கு மாற்றவும்.

இல் பயன்படுத்தப்படாத தொகுப்பு பெயரைப் பயன்படுத்தவும் [npmjs.com](//npmjs.com)

தொகுப்பு `npm` அடிப்படையாகக் கொண்டு வெளியிடும் போது, `v:` மதிப்பின் முன்னொட்டுக்கு **`//unpkg.com/` பயன்படுத்துவதை உறுதிப்படுத்திக் கொள்ளுங்கள்** , புதிய வெளியீடுகளை சரியான நேரத்தில் பார்க்க இந்த முன்னொட்டு பாதையின் கீழ் `i18n.site` `/.v` கேச் நேரத்தை சிறப்பாக மேம்படுத்தியுள்ளது.
...
சீனாவின் மெயின்லேண்டில் உள்ள பயனர்கள் நெட்வொர்க் சிக்கல்களை எதிர்கொண்டு `npm` தொகுப்புகளை வெளியிட முடியாவிட்டால், அவர்கள் ப்ராக்ஸி சேவையகத்தை உள்ளமைக்க சூழல் மாறி `https_proxy` அமைக்கலாம்.
...
நீங்கள் உள்ளடக்கத்தை சுயமாக ஹோஸ்ட் செய்ய விரும்பினால், முதலில் `md/.i18n/htm/ol.yml` திருத்தி, `v: //i18n-v.xxx.com` போன்ற உங்கள் URL முன்னொட்டுக்கு `v: //unpkg.com/i18n.site` மாற்றவும்.
...
அடுத்து, கிடங்கு `i18n-demo.github.io` ஐத் தேர்ந்தெடுத்து, `Begin setup` கிளிக் செய்து, அடுத்த படிகளுக்கு இயல்புநிலை மதிப்புகளைப் பயன்படுத்தவும்.
...
ஒற்றை-பக்க பயன்பாடுகளுக்கு ஏற்ப பாதையை மாற்றியமைக்க நீங்கள் எட்ஜ் கம்ப்யூட்டிங்கைப் பயன்படுத்தலாம் எடுத்துக்காட்டாக, [Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) இவ்வாறு கட்டமைக்க முடியும்:
...
ரெக்கார்ட் `MX` மற்றும் ரெக்கார்ட் `CNAME` `A` செயல்பட முடியாது என்பதால், நீங்கள் ஒரே நேரத்தில் டொமைன் பெயர் மின்னஞ்சல்களைப் பெற விரும்பினால், [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) ஸ்கிரிப்ட் `CNAME` க்கு ஒத்துழைக்க வேண்டும்.
...
[அலிபாபா கிளவுட்டில் டொமைன் பெயரைச் சேர்த்து CDN](https://cdn.console.aliyun.com/domain/list) அலிபாபா கிளவுட் `CDN` இல் டொமைன் பெயரை `*.xxx.com` முதல் `CNAME` வரை குறிப்பிடவும்.
...
`.i18n` கோப்பகத்தின் கீழ் `i18n.site` இன் உள்ளமைவு கோப்புகள், மொழிபெயர்ப்பு தற்காலிக சேமிப்பு போன்றவை உள்ளன. விவரங்களுக்கு அடுத்த அத்தியாயமான ["உள்ளமைவு"](/i18n.site/conf) ஐப் பார்க்கவும்.

...
உள்ளூர் முன்னோட்டம் பதிப்பு எண்ணைப் பற்றி கவலைப்படாது, மேலும் எல்லா கோப்புகளையும் `out/dev/v/0.1.0` கோப்பகத்திற்கு நகலெடுக்கும்.
...
தொகுப்பு `npm` அடிப்படையாகக் கொண்டு வெளியிடும் போது, `v:` மதிப்பின் முன்னொட்டுக்கு **`//unpkg.com/` பயன்படுத்துவதை உறுதிசெய்யவும்,** புதிய வெளியீடுகளை சரியான நேரத்தில் பார்க்க இந்த முன்னொட்டு பாதையின் கீழ் `/.v` இன் கேச் நேரத்தை சிறப்பாக `i18n.site` .
...
இணையதளம் எங்கும் பயன்படுத்தப்படலாம் [github page](https://pages.github.com) மேலும் [cloudflare page](https://pages.cloudflare.com) நல்ல தேர்வுகள்.
...
குறியீட்டை அழுத்திய பிறகு, அதை அணுகுவதற்கு முன், `github page` இன் வரிசைப்படுத்தல் வெற்றிகரமாக இயங்கும் வரை (கீழே காட்டப்பட்டுள்ளபடி) காத்திருக்கவும்.
...
! இன் `server` `out/ol/htm` `/root/i18n/md/out/ol/htm` உள்ளமைவைச் சேர்க்கவும் nginx
...
மூல மொழி அடைவு, `en` இல் `fromTo` இல் `.i18n/conf.yml` உள்ளமைவு கோப்புடன் தொடர்புடையது

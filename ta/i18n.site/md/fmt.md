...
`i18n.site` உடன் ஒப்புக்கொள்ளப்பட்ட நங்கூரப் புள்ளி தீர்வு, பொசிஷனிங் ஆங்கர் புள்ளியை கைமுறையாக உருவாக்க `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` உரையைச் செருகுவதாகும்.

`<a rel=id href="#xxx" id="xxx"></a>` , இங்கே `rel=id` ஆங்கர் புள்ளியின் பக்க நடையை வரையறுக்கிறது, `xxx` உங்கள் உண்மையான ஆங்கர் ஆங்கில சுருக்கத்துடன் மாற்றவும்.
...
இந்த இரண்டு புள்ளிகளையும் இணைத்து, பல்வேறு காட்சி விளைவுகளை அடைய 0 இல் `MarkDown` `HTML` எளிதாக எழுதலாம்.

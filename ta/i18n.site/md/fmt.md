...
## பல மொழிகளில் படங்கள்/வீடியோக்கள்/இணைப்புகள்

`MarkDown` `HTML` ஆக மாற்றப்பட்ட பிறகு, பண்புக்கூறுகள் `src` மற்றும் `href` இல் உள்ள `$LANG` தற்போதைய [மொழிக் குறியீட்டுடன்](/i18/LANG_CODE) மாற்றப்படும்.

இந்த மாறி மூலம், நீங்கள் படங்கள்/வீடியோக்கள்/இணைப்புகளின் பன்மொழிமயமாக்கலை அடையலாம்.
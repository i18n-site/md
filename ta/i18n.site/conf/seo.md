...
`i18n.site` ஆனது புதுப்பித்தலற்ற `sitemap.xml` பக்க கட்டமைப்பை ஏற்றுக்கொள்கிறது.

தேடுபொறி கிராலர் அணுகல் கோரிக்கையின் `User-Agent` ஐப் பயன்படுத்தும் போது, கோரிக்கை `302` வழியாக நிலையான பக்கத்திற்கு திருப்பி விடப்படும்.
...
உள்ளமைவில், `i18n.site` `.i18n/htm/ol.yml` இன் `host:` இன் மதிப்புக்கு மாற்றவும், பல பொருள் கடைகளை `s3` கீழ் உள்ளமைக்க முடியும், மேலும் `region` புலம் விருப்பமானது (பல பொருள் கடைகளுக்கு இந்த புலத்தை அமைக்க தேவையில்லை).
...
தனிப்பயனாக்கப்பட்ட டொமைன் பெயர் மூலம் `R2` அணுக `cloudflare` என்பதால், நிலையான கோப்புகளை வைக்க மூன்றாம் தரப்பு பொருள் சேமிப்பகம் பயன்படுத்தப்பட வேண்டும்.

`cloudflare` இல் சேமிக்கப்படும் மூன்றாம் தரப்பு பொருட்களை எவ்வாறு பிணைப்பது என்பதை விளக்குவதற்கு இங்கே நாம் ஒரு உதாரணம் எடுத்துக்கொள்கிறோம் [backblaze.com](https://www.backblaze.com)

`backblaze.com` இல் ஒரு வாளியை உருவாக்கவும், எந்த கோப்பையும் பதிவேற்றவும், கோப்பை உலாவ கிளிக் செய்யவும் மற்றும் `Friendly URL` இன் டொமைன் பெயரைப் பெறவும், இது `f003.backblazeb2.com` இங்கே.
...
`SSL` இல் `cloudflare` → குறியாக்க பயன்முறையை மாற்றவும், `Full` ஆக அமைக்கவும்

...
சில சமயங்களில் `HTML` → `MarkDown` இலிருந்து மாற்றம் நாம் விரும்புவது இல்லை, `<a href="/">Home</a>` `[Home](/)` ஆக மாற்றுவது போன்றவை.

`<a class="A" href="/">Home</a>` போன்ற `a` குறிச்சொல்லில் `href` ஐத் தவிர வேறு எந்தப் பண்புக்கூறையும் சேர்த்தால், இந்த மாற்றத்தைத் தவிர்க்கலாம்.

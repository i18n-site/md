...
மொழிபெயர்ப்புக் கருத்துகள் ` ``` ` : பிறகு ` ```rust ` போன்ற மொழியைக் குறிக்க வேண்டும்.
...
[# github அங்கீகரித்து தானாகவே i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) மற்றும் **போனஸ் $50 ஐப் பெற** இங்கே கிளிக் செய்யவும்.
...
`title` , `summary` மற்றும் `description` புலங்களை மட்டுமே மொழிபெயர்க்கும் [HOGO](https://github.com/gohugoio/hugo) வகை நிலையான வலைப்பதிவின் தலைப்பு உள்ளமைவை ஆதரிக்கிறது.
...
எடுத்துக்காட்டாக, `为阅读体验而优化` என்பது `Optimized for Reading Experience` ஆக மொழிபெயர்க்கப்படும்.

### சீன, ஜப்பானிய, கொரியன் மற்றும் சீன மொழிகளில் உள்ள ஆங்கிலச் சொற்கள் மொழிபெயர்க்கப்படவில்லை

சீனா, ஜப்பான் மற்றும் கொரியாவின் ஆவணங்களில் பெரும்பாலும் பல ஆங்கிலச் சொற்கள் உள்ளன.
...
மேலே உள்ளவற்றை DeepL மொழியில் மொழிபெயர்த்தல் (சரியான பெயர்களை மீண்டும் எழுதுதல் மற்றும் ஒற்றைப்படை `... ` சேர்ப்பது):
...
எடுத்துக்காட்டாக: `C罗` என்பது `Cristiano Ronaldo` என மொழிபெயர்க்கப்படும்.
...
க்ளையன்ட் முற்றிலும் ஓப்பன் சோர்ஸ், மற்றும் சர்வர் பக்கம் % [ஓப்பன்](/i18n.site/src) சோர்ஸாக உள்ளது 90

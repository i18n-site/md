...
Çeviri düzenlenebilir; orijinal metni değiştirin ve makineyle tekrar çevrildiğinde, çeviride yapılan manuel değişikliklerin üzerine yazılmaz (orijinal metnin bu paragrafı değiştirilmemişse).
...
Örneğin, çok dilli forumlar ve iş emri sistemleri herhangi bir web sayfasına yerleştirilebilir ve kullanıcıların engelsiz iletişim kurmasına olanak tanır.

...
Kod açık kaynak : [Çekirdekte arama yapın](//github.com/i18n-site/ie/tree/main/qy) / [Etkileşimli arayüz](//github.com/i18n-site/plugin/tree/main/qy)
...
1. Kullanıcı yazarken arama sonuçlarını gerçek zamanlı olarak görüntüleyebilen önek aramayı destekler.
...
Kelime bölümleme, tarayıcının yerel sözcük bölümlendirmesini `Intl.Segmenter` kullanır ve tüm genel tarayıcılar bu arayüzü destekler.
...
Arama öncelikle kullanıcı tarafından girilen anahtar kelimeleri segmentlere ayıracaktır.

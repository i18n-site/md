...
* Doğrudan başvurulan ön uç kitaplıklarını paketlemeye [atomgit](https://atomgit.com/i18n/x) / [github](https://github.com/i18n-site/x)
...
* Çevrimiçi dağıtım komut [atomgit](https://atomgit.com/i18n-ops/ops) [github](https://github.com/i18n-ops/ops) /
* Sistem Yapılandırması [github](https://github.com/i18n-ops/ubuntu) / [atomgit](https://atomgit.com/i18n-ops/ubuntu) ubuntu
* Zamanlanmış [atomgit](https://atomgit.com/i18n/cron) / [github](https://github.com/i18n-cron/cron)

...
Arama motorları tarafından indekslenen sayfalarda çok fazla sürüm numarasının karışıklığa neden olmasını önlemek için, belgenin sürüm numarasını yalnızca büyük güncellemeler yayınlandığında ( `v1` , `v2` gibi) değiştirmeniz önerilir.

...
İçeriği kendiniz barındırmak istiyorsanız önce `md/.i18n/htm/ol.yml` düzenleyin ve `v: //unpkg.com/i18n.site` URL ön ekinizle ( `v: //i18n-v.xxx.com` gibi) değiştirin.

...
މިކްސްޑް HTML Markdown ގެ ތަރުޖަމާއަށް ސަޕޯޓް ކުރާއިރު، `MarkDown` ގައި އެންބެޑްކޮށްފައިވާ HTML ގެ `<pre>` އަދި `<code>` ޓެގްގައިވާ ކޮންޓެންޓް ތަރުޖަމާ ނުކުރެވެއެވެ
...
ތަރުޖަމާ ކޮމެންޓްތަކުގައި ` ``` ` ފަހުން ބަސް ދައްކަން ޖެހެއެވެ , ` ```rust ` :
...
`i18` އަށް `MarkDown` ގައިވާ ސުރުޚީ ދެނެގަނެވޭއިރު، ކޭސް ސެންސިޓިވް ބަހަކަށް ތަރުޖަމާ ކުރާއިރު ފުރަތަމަ އަކުރު އޮޓޮމެޓިކުން ބޮޑު އަކުރު ކުރާނެއެވެ.
...
މަތީގައިވާ ކަންތައްތައް ފްރެންޗް ބަހަށް ތަރުޖަމާކުރުން (އެހެންމެ ރަނގަޅު ނަންތައް އަލުން ލިޔެ DeepL އޯޑް `... ` އިތުރުކުރުން):

`Un faucon marque un point sur un lama... Le classement des visages étreints suscite la controverse. `

![](//p.3ti.site/1720199603.avif)

### i18n.site ތަރުޖަމާ ކުރުން
...
މިސާލަކަށް: `C罗` ތަރުޖަމާ ކުރެވޭނީ `Cristiano Ronaldo` ގޮތުގައެވެ.

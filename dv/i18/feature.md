...
## ހިސާބުގެ ފޯމިއުލާތައް ދެނެގަނެ ތަރުޖަމާ ދޫކޮށްލުން
...
`Markdown` އީމެއިލް ޓެމްޕްލޭޓެއްގެ ގޮތުގައި ބޭނުންކުރާއިރު، `YAML` ބޭނުންކުރަނީ ބަހުގެ ފައިލް ކޮންފިގްރޭޝަނެއްގެ ގޮތުގައި، އަދި ވެރިއޭބަލް ޕެރެމިޓަރސް ހުންނާނެ (މިސާލަކަށް: ރީޗާޖް `${amount}` ލިބިއްޖެއެވެ).

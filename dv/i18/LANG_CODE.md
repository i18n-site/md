...
| 27 | `lt` | ލިތުއޭނިއާ ބައެކެވެ | `Lietuvių` |
| 28 | `hr` | ކްރޮއޭޝިއާ އެވެ | `Hrvatski` |
| 29 | `he` | އިބްރާހީމީ ބަހެވެ | `עברית` |
...
| 51 | `sq` | އަލްބޭނިއަން ބައެކެވެ | `Shqip` |
...
| 57 | `bn` | ބަންގާޅު ބަހުންނެވެ | `বাংলা` |
| 58 | `ta` | ތަމަޅަ ބަހުންނެވެ | `தமிழ்` |

...
[i18n.site/token](//i18n.site/token) އަސްލު ލިޔުމާ ދެމެދުގައިވާ މެޕިންގ `.i18h/hash` އާއި ގުޅިފައިވެއެވެ.

## `YAML` : ލިންކް `HTML` `Markdown` އަށް ބަދަލު ނުކުރެވޭނެ ގޮތް

ތަރުޖަމާއަށް `YAML` ގެ އަގެއް `MarkDown` ގޮތުގައި ބަލައެވެ.

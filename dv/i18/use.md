...
## ވިންޑޯސް ފުރަތަމަ އިންސްޓޯލް ކުރަނީ ގިޓް ބެޝް އެވެ
...
މީގެ [i18n.site/payBill](//i18n.site/payBill) , ފައިސާ ދެއްކުމަށް ކްރެޑިޓް ކާޑެއް ބައިންޑް ކުރަން ޖެހޭނެ (ރީޗާޖް ކުރަން ނުޖެހޭނެ، ވެބްސައިޓުން ބޭނުން ކުރާ ގޮތަށް އޮޓޮމެޓިކުން ފީ އުނިކުރާނެ، [އަގު ކަނޑައެޅުމަށް ހޯމްޕޭޖް ބައްލަވާ](/#price) ).
...
ވަކި ފައިލްތަކަށް އަޅާނުލާ ތަރުޖަމާ ނުކުރަން ބޭނުންނަމަ (ނުނިމި ހުރި ޑްރާފްޓްތައް ފަދަ) `ignore` ފީލްޑް ކޮންފިގްރޭޝަން ބޭނުންކުރެވިދާނެއެވެ.

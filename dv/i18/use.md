...
windows ސިސްޓަމް، ފުރަތަމަ [`git bash` ޑައުންލޯޑްކޮށް އިންސްޓޯލް ކުރުމަށް މިތަނަށް ފިތާލާށެވެ](https://git-scm.com/download/win) .
...
އޭގެ ތެރެއިން `.i18n/cache/.gitignore` ގެ ކޮންޓެންޓް ތިރީގައި މިވަނީ :
...
މާނައަކީ ޑައިރެކްޓަރީ `.i18n/cache/` ގައިވާ ހުރިހާ ފައިލްތަކެއް ( `.i18n/cache/.gitignore` ފިޔަވައި) އަޅާނުލާ ދޫކޮށްލެވޭނެއެވެ.

ތިބާގެ ވަރޝަން ކޮންޓްރޯލް ސޮފްޓްވެއަރ އަކީ `git` ނޫންނަމަ، މި ކޮންފިގްރޭޝަން އާއި އެއްގޮތަށް އަޅާނުލާށެވެ.
...
މި ކޮންފިގްރޭޝަން ޓޭބަލްގައި ކެޓަލަގް `blog` ތަރުޖަމާގެ ސޯސް ލޭންގުއޭޖް އަކީ `zh` ކަމަށާއި، `blog/your_file_name.md` ތަރުޖަމާގެ ސޯސް ލޭންގުއޭޖް އަކީ `ja` ކަމަށް ވެސް ވިދާޅުވި އެވެ.
...
ތަރުޖަމާ ކުރެވޭނީ `i18n/zh/i18n.yml` ގޮތުގައެވެ

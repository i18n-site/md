...
ކުޑަކުއްޖެއްނަމަ، ތިބާގެ ބެލެނިވެރިޔާގެ އިރުޝާދުގެ ދަށުން މި އެއްބަސްވުން ކިޔައި، މި އެއްބަސްވުމަށް ތިބާގެ ބެލެނިވެރިޔާގެ ރުހުން ހޯދުމަށްފަހު މި ވެބްސައިޓް ބޭނުންކުރަންވާނެއެވެ. ތިބާއާއި ތިބާގެ ބެލެނިވެރިޔާ ޒިންމާ އުފުލަންވާނީ ގާނޫނާއި މި އެއްބަސްވުމާ އެއްގޮތަށެވެ.
...
1. ތިޔަބޭފުޅާގެ ޓްރާންސްމިޝަންތަކަށް ނުވަތަ ޑޭޓާއަށް ހުއްދަ ނެތި އެކްސެސް ނުވަތަ ބަދަލު ގެނެވިފައިވެއެވެ
...
މި ވެބްސައިޓަށް ކޮންމެ ވަގުތެއްގައިވެސް ތިބާއަށް ފޯރުކޮށްދޭ ހިދުމަތް މެދުކަނޑާލުމުގެ ނުވަތަ ނިމުމަކަށް ގެނައުމުގެ ހައްގު ލިބިގެންވެއެވެ.

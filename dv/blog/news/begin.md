...
މިހާރު ތަންފީޒު ކުރެވެނީ ދެ އޮޕަން ސޯސް ކޮމާންޑް ލައިން ޓޫލް އެވެ.
...
ތަރުޖަމާއަކީ އެޑިޓް ކުރެވޭ އެއްޗެއް ކަމުގައި ވާއިރު، އަލުން މެޝިނުން ތަރުޖަމާ ކުރެވޭއިރު، ތަރުޖަމާއަށް ގެންނަ މެނުއަލް ބަދަލުތައް އޯވަރރައިޓް ނުކުރެވޭނެ (އަސްލު ލިޔުމުގެ މި ޕެރެގްރާފް ބަދަލުކޮށްފައި ނުވާނަމަ) އެވެ.
...
މިއީ ހަމައެކަނި ފެށުމެއް، އިތުރު އެތައް ކަމެއް އެބަހުރި.

މިސާލަކަށް ސްޓޭޓިކް ޑޮކިއުމެންޓް ސައިޓް ސޯޝަލް މީޑިއާ އާއި އީމެއިލް ސަބްސްކްރިޕްޝަންތަކާ ގުޅުވައިގެން އަޕްޑޭޓްތައް ރިލީޒް ކުރާއިރު ވަގުތުން ޔޫޒަރުންނާ ގުޅޭނެ އެވެ.

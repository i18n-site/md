...
ކޮމާންޑް ލައިން Markdown Yaml ތަރުޖަމާ ޓޫލް، ބައިނަލްއަޤްވާމީ ޑޮކިއުމަންޓް ސައިޓެއް ބިނާކުރުމުގައި އެހީތެރިވެދޭ، [އެތައް ސަތޭކަ ބަހަކަށް](/i18/LANG_CODE) ސަޕޯޓްކުރާ ...
...
މައުލޫމާތު ގޮވުމާއި ދުނިޔޭގެ ބާޒާރާއެކު، މަދު ސަމާލުކަމެއް ހޯދުމަށް ވާދަކުރުމަށްޓަކައި، **އެތައް ބަހަކަށް ސަޕޯޓް ކުރުމަކީ އަސާސީ ހުނަރެކެވެ** .
...
## <a rel=id href="#project" id="project"></a> ޕްރޮޖެކްޓް ޑިސްކްރިޕްޝަން
...
* [i18n.site : ލެންގުއޭޖް ސްޓޭޓިކް ވެބްސައިޓް ޖަނަރޭޓަރ](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: މާކްޑައުން ކޮމާންޑް ލައިން ތަރުޖަމާ ކުރުމުގެ ވަސީލަތް

ގިނަ ބަސްބަހުން ކޮމާންޑް ލައިން ޓޫލް ( [ސޯސް ކޯޑް](https://github.com/i18n-site/rust/tree/main/i18) ) އަކަށް `Markdown` އަދި `YAML` ތަރުޖަމާކުރުން.

ގެ ފޯމެޓް ފުރިހަމައަށް ބެލެހެއްޓޭނެ `Markdown` ފައިލް ބަދަލުތައް ދެނެގަނެ، ހަމައެކަނި ބަދަލުކޮށްފައިވާ ފައިލްތައް ތަރުޖަމާކުރެވޭނެއެވެ.
...
އަޅުގަނޑުމެން ހިއްސާކުރަނީ އެވަރިތިންގ އިޒް އަ ފައިލް " `UNIX` " ، ކޮމްޕްލެކްސް އަދި އުނދަގޫ އެންޓަޕްރައިސް ލެވެލް ސޮލިއުޝަންތައް ތަޢާރަފް ނުކޮށް އެތައް ސަތޭކަ ބަހަކުން ތަރުޖަމާތައް މެނޭޖްކުރެވޭނެއެވެ.

ތަރުޖަމާ `Markdown` ކުރުމަށް އެންމެ ފަރިތަ ވަސީލަތްތައް ބޭނުން ކުރެވިދާނެ (އެކަމަކު ޕެރެގްރާފް އިތުރު ނުވަތަ ޑިލީޓް ނުކުރެވޭނެ)، އަދި ވަރޝަން ކޮންޓްރޯލް ކުރުމަށް އެންމެ ފަރިތަ ގޮތް ބޭނުން ކުރެވިދާނެ އެވެ.

ބަހުގެ ފައިލްތަކަށް އޮޕަން ސޯސްއެއްގެ ގޮތުގައި ކޯޑް ބޭސްއެއް އުފެއްދިދާނެ ކަމަށާއި، `Pull Request` ގެ ޕްރޮސެސްގެ އެހީގައި ގްލޯބަލް ޔޫޒަރުންނަށް ތަރުޖަމާތައް މެދުނުކެނޑި އޮޕްޓިމައިޒް ކުރުމުގައި ބައިވެރިވެވޭނެ ކަމަށެވެ. އަދި ސީމްލޭސް ކަނެކްޝަން [github](//github.com)

[→ ޔޫޒަރ ގައިޑް އަށް ޕްރޮޖެކްޓް ޑޮކިއުމަންޓޭޝަން ކިޔައިލައްވާށެވެ](/i18) .
...
ޚުދު ސްޓޭޓިކް، ކިޔެވުމުގެ ތަޖުރިބާއަށް އޮޕްޓިމައިޒް ކުރެވިފައިވާ، އަދި [i18](#i18)
...
މި ވެބްސައިޓަކީ މި އޮނިގަނޑުގެ މައްޗަށް ބިނާކޮށް ތައްޔާރުކޮށްފައިވާ ވެބްސައިޓެއް ކަމަށާއި، މި ވެބްސައިޓުގައި ޔޫޒަރ، ޕޭމަންޓް އަދި އެހެނިހެން ކަންތައްތައް ހިމެނޭ ( [ސޯސް ކޯޑް](/i18n.site/src) ) ތަފްސީލީ ޓިއުޓޯރިއަލްއެއް ފަހުން ލިޔެވޭނެއެވެ.

[→ ޔޫޒަރ ގައިޑް އަށް ޕްރޮޖެކްޓް ޑޮކިއުމަންޓޭޝަން ކިޔައިލައްވާށެވެ](/i18n.site) .
...
> އެމީހުން ބުނީ: އައިސް އުޑުމައްޗަށް ފޯރާ ޓަވަރެއް ހަދައި، އިންސާނީ ނަސްލު މަޝްހޫރު ކޮށްލާށެވެ.
>
> މާތްރަސްކަލާނގެ މިކަން ފެނިވަޑައިގެން ވިދާޅުވީ، "ހުރިހާ އިންސާނުންގެ ބަހަކާއި ނަސްލެއް އެއްގޮތެވެ. މިހާރު މިކަން ފުރިހަމަ ކުރެވިއްޖެއެވެ."
>

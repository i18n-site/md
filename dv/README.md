...
> ޤަދީމީން އުޑުމައްޗަށް ވާޞިލްވެ، މާތްރަސްކަލާނގެ ދޮރާ ހަމައަށް ވާޞިލްވެ، އިންސާނީ ނަސްލުގެ ޝަރަފު ކުރިއެރުވުމަށްޓަކައި ޓަވަރުތައް ބިނާކުރިއެވެ.
>
> މާތްރަސްކަލާނގެ ވިދާޅުވީ، މީހުން އަމިއްލަ ދަރިއެއް އުފައްދައި، އެއް ބަހަކުން ވާހަކަ ދައްކާ ކަމަށެވެ. ޓަވަރެއް ހެދުމަކީ ހަމައެކަނި މުޤައްދަސް ކަމެކެވެ. މިހާރު އެކަން ނިމުނީމަ ކުރިއަށް އޮތްތަނުގައި ހުރިހާ ކަމެއްވެސް ކުރާނެ.
>
> ދެން، މާތްރަސްކަލާނގެ އައިސް އެކި ތަންތަނުގައި މީސްތަކުން އެތުރިގެން ދިޔައީ، އެކަކު އަނެކަކަށް ވިސްނޭގޮތް ނުވެފައެވެ.
>
> އޭގެ ފަހުން އިންސާނުންގެ ދެބަސްވުންތައް ކުރިއަށް ދިޔައިރު، މިހާރު ދުނިޔޭގައި ބާބެލްގެ ޓަވަރެއް ނެތެވެ.

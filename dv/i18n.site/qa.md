...
ގޯސްކޮށް `.i18n/v/ol` ޑިލީޓް ކޮށްފިނަމަ ޕެކޭޖް `npm` ރިލީޒް ނުވާނެއެވެ.

މިވަގުތު ފުރަތަމަ ތިބާގެ ޕްރޮޖެކްޓްގެ އެންމެ ފަހުން ރިލީޒްކުރި ވަރޝަންގެ ވަރޝަން ނަންބަރު [npmjs.com](//npmjs.com) މިސާލަކަށް `0.1.9` ހޯދާށެވެ.

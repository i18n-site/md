...
މިތަނުގައި `en/` އަކީ `.i18n/conf.yml` އިން ކޮންފިގްރޭޓްކޮށްފައިވާ ތަރުޖަމާ ސޯސް ލޭންގުއޭޖް އާއި ގުޅޭ ބަހުގެ ކޯޑެވެ.
...
ސަރޗް އިންޖީނުތަކުން އިންޑެކްސްކުރާ ޞަފްޙާތަކުގައި މާގިނައިން ވަރޝަން ނަންބަރުތައް އުފެދި ތަރުތީބު ނުކުރުމަށްޓަކައި ބޮޑެތި އަޕްޑޭޓްތައް ނެރޭއިރު ( `v1` , `v2` ފަދަ) ޑޮކިއުމަންޓްގެ ވަރޝަން ނަންބަރު ބަދަލުކުރުމަށް ލަފާދެއެވެ.
...
ސައިޑްބާ އައުޓްލައިންގައި ހުސް `v` ނުފެންނާނެ ނަމަވެސް `v` ފައިލް ހުރިހާ ހިނދަކު ޑައިރެކްޓަރީއާއި ސަބްޑައިރެކްޓަރީތަކުގައި ހުންނަ ފައިލްތަކަށް މިނިވަން އިންޑެކްސްއެއް އުފެދިގެންދާނެއެވެ.
...
މިސާލަކަށް ޑެމޯ ޕްރޮޖެކްޓްގައި `blog` އަށް ދިމާވާ އިންޑެކްސް [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) :
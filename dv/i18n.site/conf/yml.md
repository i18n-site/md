...
### `use: Toc` , އައުޓްލައިން އާއި އެކު އެއް ފައިލް ޓެމްޕްލޭޓް
...
### `use: Md` , އައުޓްލައިން ނެތި އެއް ފައިލް ޓެމްޕްލޭޓް
...
### `use: Doc` , މަލްޓި ފައިލް ޑޮކިއުމަންޓް ޓެމްޕްލޭޓް
...
މަތީގައިވާ ލިޔުމުގެ އުސޫލަކީ `url: xxx` އާ އެއްވަރުގެ އުސޫލެއް ކަމަށާއި، އޭގެ ގުޅޭ ފައިލަކީ `en/xxx/TOC` ކަމަށް ވެސް ވިދާޅުވިއެވެ .

#### ޓީއޯސީ ޓޭބަލް އޮފް ކޮންޓެންޓްސް އިންޑެކްސް

`i18n.site` އިން `json` ޑައިރެކްޓަރީ އައުޓްލައިން އުފެއްދުމަށްޓަކައި `doc` ޓެމްޕްލޭޓް ކޮންފިގްރޭޝަން އާއި ގުޅޭ `TOC` ޑައިރެކްޓަރީ އިންޑެކްސް ފައިލް ކިޔުމަށް ޑެމޯ ވެއަރހައުސްގައި `js` ޕްލަގް-އިން `.i18n/hook/after.tran/TOC.js` އެގްޒެކެޓް ކުރާނެއެވެ.
...
މިސާލަކަށް `/test` އެކްސެސް ވެއްޖެނަމަ، އަދި `nav:` މި މަގުގެ ޕްރިފިކްސް ނެތި ކޮންފިގްރޭޓް ކުރެވިއްޖެނަމަ، އަދި މިހާރު ބްރައުޒިންގ ލޭންގުއޭޖް އަކީ އިނގިރޭސި ބަހެއްނަމަ (ކޯޑް `en` )، `/en/test.md` ޑިފޯލްޓްކޮށް ލޯޑްކޮށް ޓެމްޕްލޭޓް `Md` ބޭނުންކޮށްގެން ރެންޑަރ ކުރެވޭނެއެވެ.

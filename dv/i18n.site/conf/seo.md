...
`i18n.site` އިން ނޮން ރިފްރެޝް ސިންގަލް ޕޭޖް އަރކިޓެކްޗަރ އެއް އެޑޮޕްޓް ކުރަނީ ސަރޗް އިންޑެކްސް ކުރުމަށް ފަސޭހަ ކުރުމަށްޓަކައި ކްރޯލަރސް ކްރޯލް ކުރުމަށް ވަކި ސްޓޭޓިކް ޕޭޖެއް އަދި `sitemap.xml` އުފެދިގެންދާނެއެވެ.
...
ކޮންފިގްރޭޝަންގައި `i18n.site` އިން `.i18n/htm/ol.yml` ގެ އަގަށް ބަދަލުކޮށް، `s3` ދަށުން ގިނަ އޮބްޖެކްޓް ސްޓޯރ ކޮންފިގްރޭޓް ކުރެވޭނެ، އަދި `region` ފީލްޑަކީ އިޚްތިޔާރީ `host:` (ގިނަ އޮބްޖެކްޓް ސްޓޯރ ތަކުން މި ފީލްޑް ސެޓް ކުރަން ނުޖެހެއެވެ).

ދެން ޕްރޮޖެކްޓް އަލުން ޝާއިއު ކުރުމަށް `i18n.site -n` ދުއްވާލާށެވެ.

`~/.config/i18n.site.yml` ބަދަލު ގެނެސް އަލުން އަޕްލޯޑް ކުރަން ބޭނުންނަމަ، އަޕްލޯޑް ކެޝް ސާފުކުރުމަށް ޕްރޮޖެކްޓް ރޫޓް ޑައިރެކްޓަރީގައިވާ ތިރީގައިވާ ކޮމާންޑް ބޭނުން ކުރައްވާ :
...
`URL redirect` ޑައިނަމިކް ރީޑައިރެކްޝަން ހޮވާ، ރީޑައިރެކްޝަން ޕަތް `concat("/en",http.request.uri.path,".htm")` ގައިވާ `/en` ސަރޗް އިންޖީނުތަކުގައި ހިމަނަން ބޭނުންވާ ޑިފޯލްޓް ބަހަށް ބަދަލުކުރައްވާށެވެ.
...
`Debug` ފިތާލުމަށްފަހު މުޅި ނެޓްވޯކަށް ޕަބްލިޝް އަށް ކްލިކް ކުރާށެވެ.
...
`cloudflare` [ވާވޭ ކްލައުޑް DNS](https://www.huaweicloud.com)
...
`R2` ކަސްޓަމައިޒް ކުރެވިފައިވާ ޑޮމެއިން ނަމަކުން އެކްސެސް `cloudflare` ، ސްޓޭޓިކް ފައިލްތައް ބެހެއްޓުމަށް ތިންވަނަ ފަރާތެއްގެ އޮބްޖެކްޓް ސްޓޯރޭޖެއް ބޭނުން ކުރަން ޖެހެއެވެ.

މިތަނުގައި އަޅުގަނޑުމެން މިސާލެއްގެ ގޮތުން [backblaze.com](https://www.backblaze.com) `cloudflare` ގައި ރައްކާކުރަންޖެހޭ ތިންވަނަ ފަރާތެއްގެ ތަކެތި ބައިންޑް ކުރާނެ ގޮތް ދައްކާލުމަށެވެ.

`backblaze.com` ގައި ބާލިދީއެއް އުފައްދައި، ކޮންމެ ފައިލެއް އަޕްލޯޑްކޮށް، ފައިލް ބްރައުޒް ކުރުމަށް ކްލިކްކޮށް، `Friendly URL` ގެ ޑޮމެއިން ނަން ހޯދާ، މިއީ މިތަނުގައި `f003.backblazeb2.com` އެވެ.

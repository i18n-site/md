...
ކޮންފިގްރޭޝަންގައި `i18n.site` އިން `.i18n/htm/ol.yml` `host:` އަގަށް ބަދަލުކޮށް، `s3` ދަށުން ގިނަ އޮބްޖެކްޓް ސްޓޯރ ކޮންފިގްރޭޓް ކުރެވޭނެ، އަދި `region` ފީލްޑަކީ އިޚްތިޔާރީ ފީލްޑެއް (ގިނަ އޮބްޖެކްޓް ސްޓޯރ ތަކުން މި ފީލްޑް ސެޓް ކުރަން ނުޖެހެއެވެ).

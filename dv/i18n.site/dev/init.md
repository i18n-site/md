# މާހައުލު ތައްޔާރުކުރުން

* އިންސްޓޯލްކޮށް ފެށުން `docker` ( Mac ޔޫޒަރުން ލަފާދެނީ `docker` ގެ ރަންޓައިމްގެ ގޮތުގައި [orbstack](https://orbstack.dev) ބޭނުންކުރުމަށެވެ !

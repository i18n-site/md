...
މި ޕްރޮގްރާމްގައި ބިލްޓް- `i18` ތަރުޖަމާއެއް ހުރެއެވެ، ​​ވަކި ބޭނުންތަކަށް [➔ `i18`](/i18) ބައްލަވާށެވެ.
...
`i18n.site` ޑިފޯލްޓްކޮށް، `CDN` ކޮންޓެންޓް [unpkg.com](//unpkg.com) ކުރެވޭނީ `npmjs.com` `npm` ، [jsdelivr.com](//jsdelivr.com)
...
އުސޫލަކީ `CDN` [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
ޕޭޖުގައި ކުޑަކުޑަ ފްލޯޓިން ޖިންނިއެއް ހުރިއިރު، އޭގެ ލޯ މައުސް އާއި އެކު ހަރަކާތްތެރިވާނެ، [➔ ބަލާލުމަށް މިތަނަށް ފިތާލާށެވެ](/404) , `404`

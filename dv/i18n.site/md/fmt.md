...
އިން އިމްޕްލިމެންޓޭޝަން އަށް ރިފަރ ކުރެވޭނީ [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) ކޯޑް ތިރީގައި މިވަނީ :
...
## އެތައް ބަހަކުން ތަސްވީރު/ވީޑިއޯ/ލިންކް

`MarkDown` `HTML` އަށް ބަދަލުކުރުމަށްފަހު އެޓްރިބިއުޓް `src` އަދި `href` ގައިވާ `$LANG` ބަދަލުގައި މިހާރު ބޭނުންކުރާ [ބަހުގެ ކޯޑް](/i18/LANG_CODE) ހުންނާނެއެވެ .

މި ވެރިއޭބަލް މެދުވެރިކޮށް ތަސްވީރު/ވީޑިއޯ/ލިންކްތަކުގެ މަލްޓިލިންގުއަލައިޒޭޝަން ހާސިލް ކުރެވޭނެއެވެ.
# މާކްޑައުން ފޯމެޓް ކޮންވެންޝަން

## އެންކަރ ޕޮއިންޓެވެ

ސަގާފީ `MarkDown` އެންކަރ ޕޮއިންޓް އުފައްދަނީ ޓެކްސްޓް ކޮންޓެންޓަށް ބަލައިގެންނެވެ.

`i18n.site` އާ އެއްބަސްވެފައިވާ އެންކަރ ޕޮއިންޓް ސޮލިއުޝަނަކީ ޕޮޒިޝަނިންގ އެންކަރ ޕޮއިންޓް އަމިއްލައަށް އުފެއްދުމަށްޓަކައި `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` އެއްގޮތް ޓެކްސްޓެއް ޖައްސައިގެންނެވެ.

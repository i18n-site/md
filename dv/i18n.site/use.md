...
ހިންގުމަށްފަހު ތަރުޖަމާ އަދި ކެޝް `git add . ` `md` ޑައިރެކްޓަރީގައިވާ ރިޕޮޒިޓަރީއަށް އިތުރުކުރުން ހަނދާން ކުރާށެވެ.
...
މިސާލަކަށް `.i18n/htm/ol.yml` `out/ol` ޑައިރެކްޓަރީ އުފައްދާނެއެވެ.
...
`ol` އަކީ `online` ގެ ކުރުކުރުން `-n` ، މިއީ ރަސްމީކޮށް ރިލީޒް ކުރުމަށް ބޭނުންކުރާ އޮންލައިން މާހައުލު ދައްކުވައިދޭ `npm` .

އަދި އެހެން ކޮންފިގްރޭޝަން ފައިލްތައް ވެސް `--htm_conf` .
...
ޕެކޭޖް `npm` އަށް ބިނާކޮށް ޕަބްލިޝް ކުރާއިރު، އާ ރިލީޒްތައް ވަގުތުން ބަލާލުމަށްޓަކައި މި ޕްރިފިކްސް މަގުގެ ދަށުން `v:` `/.v` ޕްރިފިކްސް އަށް `i18n.site` **`//unpkg.com/` ޔަގީން ކުރައްވާށެވެ** .

ތަރުޖަމާކޮށް ޝާއިޢުކުރުމަށްޓަކައި `md` ޑައިރެކްޓަރީގައި `i18n.site --npm` ނުވަތަ `i18n.site -n` ދުއްވާށެވެ.

ޕަބްލިޝް ކުރުމަށް ކޮންޓިނިއުއަސް އިންޓަގްރޭޝަން އެންވަޔަރަންމަންޓެއް ބޭނުންކުރާނަމަ `nodejs` އިންސްޓޯލް ކުރަން ނުޖެހޭނެއެވެ `~/.npmrc`
...
`CDN` ކޮންޓެންޓް ހޯސްޓް ކުރުމަށްޓަކައި، އަމިއްލަ ސަރވަރ ބޭނުން ކުރުމުގެ އިތުރުން، އާންމު އެހެން ގޮތަކީ `S3` +

`S3` ސަރވަރ އަށް `S3` ވުމަށް [rclone](https://rclone.org)
...
ވެބްސައިޓް އެންޓްރީ ޕޭޖް ޑިޕްލޮއި ކުރަން ޖެހެނީ އެންމެ ފަހަރަކު ކަމަށާއި، އޭގެ ފަހުން ކޮންޓެންޓް އަޕްޑޭޓް ކުރުމަށްޓަކައި ވެބްސައިޓް އެންޓްރީ ޕޭޖް އަލުން ޑިޕްލޮއި ކުރަން ނުޖެހޭ ކަމަށެވެ.
...
`github page` ޔޫއާރްއެލް މަގު އަލުން ލިޔުމަށް ސަޕޯޓް ނުކުރާތީ، އޭގެ ބަދަލުގައި ބޭނުންކުރަނީ `404.html` އެވެ.
...
ދެން `out/ol/htm` ޗައިނާގެ ބިންގަނޑުގައި ކްލައުޑް ވެންޑަރުންގެ އޮބްޖެކްޓް ސްޓޯރޭޖް ބޭނުންކުރުން + ތިރީގައިވާ ކޮންޓެންޓް ޑިޕްލޮއިކުރުން `CDN` .

އެއް ޞަފްޙާގެ އެޕްލިކޭޝަންތަކަށް އެޑެޕްޓްވުމަށްޓަކައި މަގު އަލުން ލިޔުމަށް އެޖް [`CDN`](//cloud.baidu.com/product/cdn.html) ބޭނުންކުރެވިދާނެއެވެ.
...
ރެކޯޑް `MX` އާއި ރެކޯޑް `CNAME` އެއްތަނެއްގައި ނުތިބެވޭނެތީ، އެއްފަހަރާ ޑޮމެއިން ނަން އީމެއިލް ލިބެން ބޭނުންނަމަ، ރެކޯޑް `A` އަށް ލެވެލް `CNAME` އަށް ސްކްރިޕްޓް [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) އެއްބާރުލުން ދޭން ޖެހެއެވެ.
...
[އަލީބާބާ CDN](https://cdn.console.aliyun.com/domain/list) ޑޮމެއިން ނަން އިތުރުކޮށް އަލީބާބާ ކްލައުޑް `CDN` ގައި ޑޮމެއިން ނަން `*.xxx.com` އިން `CNAME` އަށް އިޝާރާތް ކުރާށެވެ !

...
ޕަބްލިޝް ކުރުމަށް ކޮންޓިނިއުއަސް އިންޓަގްރޭޝަން އެންވަޔަރަންމަންޓެއް ބޭނުންކުރާނަމަ، `nodejs` އިންސްޓޯލް ކުރަން ނުޖެހޭނެ، ހަމައެކަނި ލޮގްއިން ކޮށްފައިވާ އަދި ޕަބްލިޝް ކުރުމުގެ ހުއްދަ `~/.npmrc` އެންވަޔަރަންމަންޓަށް ކޮޕީ ކުރާށެވެ.
...
ވެބްސައިޓުގައި ބޭނުންކުރަނީ [އެއް ޞަފްޙާގެ އެޕްލިކޭޝަން](https://developer.mozilla.org/docs/Glossary/SPA) އަރކިޓެކްޗަރ ކަމުން، `. ` އިން `index.html` އަށް ނުހިމެނޭ ޔޫ.އާރ.އެލް މަގުތައް އަލުން ލިޔަން ހަނދާން ކުރާށެވެ.
...
ސޯސް ލޭންގުއޭޖް ޑައިރެކްޓަރީ، `.i18n/conf.yml` އިން `fromTo` ގެ `en` އަށް ދިމާވާ ކޮންފިގްރޭޝަން ފައިލް

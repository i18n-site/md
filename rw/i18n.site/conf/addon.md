...
Gucomeka ikoresha verisiyo yanyuma kubisanzwe kandi igenzura ibishya buri cyumweru.

Niba ushaka gukosora verisiyo, urashobora kwandika `i18n.addon/toc@0.1.3` .

Ubusobanuro bwumurongo wumurongo `i18n.site` uzashyiraho dosiye yamasezerano ya plug-in pack hanyuma uyikorere.
...
* `rDir(dirpath)` : Soma ububiko, agaciro kagarutse ni urutonde : , urutonde rwa dosiye

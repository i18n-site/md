...
`fromTo` zitandukanye zirashobora gushyirwaho kububiko butandukanye bwa : /
...
Muri iyi mbonerahamwe iboneza, ururimi rwinkomoko yububiko `blog` ni `zh` , naho ururimi rwinkomoko yububiko `blog/your_file_name.md` ni `ja` .

### Kwirengagiza Dosiye

Mburabuzi, dosiye zose zitangirana na `.md` na `.yml` mubisobanuro byururimi rwinkomoko bizahindurwa.

Niba ushaka kwirengagiza amadosiye amwe kandi ntuyahindure (nkimishinga itarangiye), urashobora gukoresha iboneza rya `ignore` .
...
Igikoresho cyumurongo uzasanga dosiye zose zirangirana na `.yml` mubisobanuro byururimi rwamadosiye kandi ubihindure.

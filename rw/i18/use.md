...
windows , nyamuneka [kanda hano kugirango ukuremo hanyuma ushyire `git bash`](https://git-scm.com/download/win) mbere.
...
Urashobora gushiraho `fromTo` zitandukanye kubisobanuro bitandukanye : Fayili /
...
Muri iyi mbonerahamwe iboneza, ururimi rwinkomoko ya catalog `blog` ibisobanuro ni `zh` , naho ururimi rwinkomoko ya `blog/your_file_name.md` ibisobanuro ni `ja` .
...
Ubusobanuro bwa `YAML` burashobora kandi guhindurwa nintoki (ariko ntukongereho cyangwa gusiba urufunguzo cyangwa imirongo mubisobanuro).

...
Ongeraho ikiranga icyo aricyo cyose kitari `href` kuri `a` tag, nka `<a class="A" href="/">Home</a>` , birashobora kwirinda iri hinduka.

## `./i18n/hash` Dosiye Zivuguruzanya Hepfo

Siba dosiye zivuguruzanya hanyuma usubiremo `i18` ibisobanuro.
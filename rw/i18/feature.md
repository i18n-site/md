...
Shyigikira ubusobanuro buvanze HTML , ibikubiye Markdown tagi `<pre>` na `<code>` ya HTML yashyizwe muri `MarkDown` ntabwo yahinduwe
...
Kugeza ubu, ishyigikira ibisobanuro byanditse muri `toml` , `yaml` , `json5` , `go` , `rust` , `c` , `cpp` , `java` , `js` , `coffee` , `python` , `bash` , `php` [nizindi ndimi](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) .
...
Shyigikira umutwe [HOGO](https://github.com/gohugoio/hugo) yubwoko bwa static blog, kandi uhindura imirima `title` , `summary` , `brief` , na `description` !
...
Ubushinwa, Ubuyapani, na Koreya ntabwo bifite inyuguti nkuru cyangwa inyuguti nto, ariko inyito yicyongereza muri rusange inyuguti nkuru.
...
Byahinduwe mu Kiyapani `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

DeepL ibyavuzwe haruguru mu gifaransa (nanone wandike amazina akwiye kandi wongereho `... ` ):
...
Kurugero, ibisubizo byubuyapani ibisubizo hejuru ni:
...
Umukiriya arafunguye rwose, kandi kuruhande rwa seriveri ni isoko ifunguye 90 [Kanda hano urebe inkomoko](/i18n.site/src) .
...
Nyamuneka <button onclick="mailsub()">kanda iyi imeri kugirango wiyandikishe kubicuruzwa</button> kandi <button onclick="webpush()">ushoboze gusunika amashakiro</button> Tuzakumenyesha mugihe ibicuruzwa bigezweho.

...
Shyigikira umutwe [HOGO](https://github.com/gohugoio/hugo) yubwoko bwa static blog, kandi uhindura gusa imirima `title` , `summary` , `brief` , na `description` !
...
Guhindura ibyavuzwe DeepL mu gifaransa (nanone kwandika amazina akwiye no kongeramo `... ` ):
...
Nyamuneka <button onclick="mailsub()">kanda iyi imeri kugirango wiyandikishe kubicuruzwa</button> kandi <button onclick="webpush()">ushoboze gushakisha gusunika</button> . Turakumenyesha mugihe ibicuruzwa bigezweho.

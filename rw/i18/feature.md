...
Shyigikira ubusobanuro HTML Markdown , ibikubiye muri tagi ya `<pre>` na `<code>` ya HTML yashyizwe muri `MarkDown` ntabwo yahinduwe
...
Imirongo ya kode hamwe nibisobanuro bya kode ntibisobanuwe, ariko ibisobanuro biri muri kode birashobora guhindurwa.
...
Ariko, ntibashyigikira kumenya guhindura dosiye kandi bahindura gusa dosiye zahinduwe kugirango bagabanye ibiciro no kongera imikorere.
...
## Shyigikira Ubusobanuro `YAML`

Igikoresho gihindura gusa inkoranyamagambo indangagaciro muri `YAML` , ntabwo urufunguzo rwamagambo.
...
Shyigikira imitwe yimiterere yubwoko [HOGO](https://github.com/gohugoio/hugo) static blog, isobanura gusa imirima `title` , `summary` na `description` .
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` mu Kiyapani :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` mu gifaransa :
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` mu Kiyapani :

![](//p.3ti.site/1720199550.avif)

DeepL ibyavuzwe haruguru mu gifaransa (nanone kwandika amazina akwiye no kongeramo `... ` ):
...
`i18` yinjijwe mururimi rwindimi nyinshi kubaka amabwiriza yumurongo wigikoresho [`i18n.site`](/i18n.site) .

Reba inyandiko ya [`i18n.site`](/i18n.site) kugirango ubone ibisobanuro.

## Kode Ifungura Isoko

Umukiriya arafunguye rwose, kandi seriveri kuruhande rwa code ni isoko ifunguye 90 [Kanda hano urebe inkomoko](/i18n.site/src) .

...
## <a rel=id href="#project" id="project"></a> Ibisobanuro byumushinga
...
`Markdown` na `YAML` mubikoresho byumurongo ( [code code](https://github.com/i18n-site/rust/tree/main/i18) ) mundimi nyinshi.
...
Twasangiye " `UNIX` Byose ni File " kandi irashobora kuyobora ibisobanuro mundimi amagana tutabanje gutangiza ibibazo bigoye kandi bigoye kurwego rwibikorwa.

Urashobora gukoresha ibikoresho bizwi cyane kugirango `Markdown` ibisobanuro (ariko ntushobora kongeramo cyangwa gusiba paragarafu), kandi ukoreshe inzira izwi cyane yo kugenzura verisiyo.

Kode shingiro irashobora gushirwaho nkisoko ifunguye amadosiye yindimi, kandi hamwe nubufasha `Pull Request` , abakoresha isi yose barashobora kugira uruhare mugukomeza guhindura ibisobanuro. Ihuza ridahwitse N'andi masoko afunguye [github](//github.com)

[→ Kubakoresha bayobora, nyamuneka soma ibyangombwa byumushinga](/i18) .

## Ubusobanuro Bwiza Bwa Xindaya
...
Kugirango ugere ku bwiza bumwe, ingano yo guhindura `3.15` `2.67` na Google Translate kandi `ChatGPT`
...
Birahagaze neza, byashyizwe mubikorwa byo gusoma, kandi byahujwe no guhindura [i18](#i18) Ni amahitamo meza yo kubaka urubuga rwinyandiko.
...
Uru rubuga rwakozwe rushingiye kuriyi mikorere kandi rurimo umukoresha, ubwishyu nibindi bikorwa ( [code code](/i18n.site/src) ) Inyigisho irambuye izandikwa nyuma.

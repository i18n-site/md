...
Այս հոդվածը [i18n.site](//i18n.site) `i18n.site` մաքուր ամբողջական տեքստային որոնման տեխնոլոգիայի իրականացումը:

Կոդ բաց կոդով [որոնման միջուկը](//github.com/i18n-site/ie/tree/main/qy) / [ինտերֆեյս](//github.com/i18n-site/plugin/tree/main/qy)

## Առանց Սերվերի Ամբողջական Տեքստի Որոնման Լուծումների Ակնարկ

Փոքր վեբկայքերի համար, ինչպիսիք են փաստաթղթերը/անձնական բլոգները, որոնք զուտ ստատիկ են, անկասկած, չափազանց ծանր է ինքնուրույն ամբողջական տեքստի որոնման հետին պլան ստեղծելը, և ամբողջական տեքստի որոնումն առանց ծառայությունների, անկասկած, ավելի լավ է:

Առանց սերվերի ամբողջական տեքստի որոնման գոյություն ունեցող լուծումները բաժանվում են երկու լայն կատեգորիաների.

One-ը երրորդ կողմի որոնման ծառայություններ մատուցող է [algolia.com](//algolia.com) որն ապահովում է ամբողջական տեքստային որոնման բաղադրիչներ:

Նման ծառայությունները պահանջում են վճարում և հասանելի չեն մայրցամաքային Չինաստանի օգտատերերին՝ կայքի համապատասխանության հետ կապված խնդիրների պատճառով:
...
Ավելի հայտնի մաքուր ճակատային ամբողջական տեքստային որոնումները ներառում [lunrjs](https://lunrjs.com) և [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) :

`lunrjs` Ինդեքսներ ստեղծելու երկու եղանակ կա, բայց երկուսն էլ ունեն իրենց խնդիրները:

1. Նախապես կառուցված ինդեքսային ֆայլեր

   Քանի որ ինդեքսը պարունակում է բառեր բոլոր փաստաթղթերից, այն մեծ է չափերով:
   Ամեն անգամ, երբ փաստաթուղթը ավելացվում կամ փոփոխվում է, պետք է բեռնվի նոր ինդեքսային ֆայլ:
   Դա կավելացնի օգտատիրոջ սպասման ժամանակը և կսպառի մեծ թողունակություն:
...
[fusejs](https://www.fusejs.io) հաշվարկեք որոնման տողերի նմանությունը:

Այս լուծման արդյունավետությունը չափազանց վատ է և չի կարող օգտագործվել ամբողջական տեքստի որոնման համար (տես [Fuse.js Երկար հարցումը տևում է ավելի քան 10 վայրկյան, ինչպե՞ս այն օպտիմալացնել:](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ):

[TinySearch](https://github.com/tinysearch/tinysearch) օգտագործեք Bloom ֆիլտրը որոնման համար, չի կարող օգտագործվել նախածանցի որոնման համար (օրինակ, մուտքագրեք `goo` , որոնեք `good` , `google` ) և չի կարող հասնել նմանատիպ ավտոմատ ավարտման էֆեկտի:

Գոյություն ունեցող լուծումների թերություններից դժգոհությունից ելնելով, `i18n.site` մշակեց նոր մաքուր ճակատային ամբողջական տեքստի որոնման լուծում, որն ունի հետևյալ հատկանիշները :
...
1. Աջակցում է նախածանցների որոնմանը, որը կարող է իրական ժամանակում ցուցադրել որոնման արդյունքները, երբ օգտագործողը մուտքագրում է:
1. Հասանելի է անցանց
...
Առջևի փոխազդեցության դեպքում ինդեքսի բեռնման առաջընթացի գիծը կարող է ցուցադրվել՝ առաջին անգամ բեռնելիս ուշացումից խուսափելու համար տե՛ս «Առաջընթացի գիծը անիմացիայով, հիմնված է միայնակ progress + Մաքուր css իրականացման վրա» [անգլերեն](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [չինարեն](https://juejin.cn/post/7413586285954154522) :

### IndexedDB Բարձր Միաժամանակյա Գրություն

Նախագիծը [idb](https://www.npmjs.com/package/idb) է IndexedDB -ի ասինխրոն ինկապսուլյացիայի հիման վրա:
...
Շրջված ամբողջական տեքստի որոնումն իրականացվել է զուտ առջևի մասում, արագ արձագանքով և սերվերի կարիք չկա:

Այն շատ հարմար է փոքր և միջին կայքերի համար, ինչպիսիք են փաստաթղթերը և անձնական բլոգները:
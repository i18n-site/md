...
Մենք բաժանորդագրվում ենք `UNIX` " ի փիլիսոփայությանը "
...
Կոդերի բազան կարող է ստեղծվել որպես լեզվական ֆայլերի բաց աղբյուր, և `Pull Request` պրոցեսների օգնությամբ համաշխարհային օգտատերերը կարող են մասնակցել թարգմանությունների շարունակական օպտիմալացմանը։ Անխափան կապ [github](//github.com) բաց կոդով այլ համայնքներ:
...
[Սեղմեք այստեղ՝ թույլատրելու և ավտոմատ կերպով հետևելու github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) և **ստանալու $50 բոնուս** :
...
Աջակցում է երկլեզու մեկնաբանություններին և զրուցարաններին;

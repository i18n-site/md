...
" բաժանորդագրվում ենք `UNIX` -ի փիլիսոփայությանը "
...
#### <a rel=id href="#price" id="price"></a> Շատ մրցունակ գներ
...
Խնդրում ենք <button onclick="mailsub()">սեղմել այս էլ.փոստը` ապրանքի թարմացումներին բաժանորդագրվելու</button> և <button onclick="webpush()">զննարկիչի push-ն ակտիվացնելու</button> համար, երբ ապրանքները թարմացվեն:
...
Մենք ցանկանում ենք կառուցել ինտերնետ առանց լեզվական մեկուսացման:
Հուսով ենք, որ ողջ մարդկությունը համախմբվելու է ընդհանուր երազանքով։

Markdown թարգմանության և փաստաթղթերի կայքը միայն սկիզբն է:

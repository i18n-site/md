...
«Երեք մարմին» գիտաֆանտաստիկ վեպը (չինական արտասանություն՝ `3Ti` ) հորինում է այլմոլորակային քաղաքակրթություն, որն օգտագործում է էլեկտրամագնիսական ալիքները հաղորդակցվելու համար՝ թափանցիկ մտածողությամբ և բարգավաճ գիտությամբ ու տեխնիկայով:

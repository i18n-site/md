...
| սերիական համար | ծածկագիրը | լեզու | ցուցադրվող անունը |
| - | - | - | - |
...
| 33 | `el` | հունարեն | `Ελληνικά` |
| 34 | `et` | էստոնական | `Eesti` |
...
| 113 | `nso` | Սեպեթին | `Sesotho sa Leboa` |

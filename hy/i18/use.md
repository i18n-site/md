...
[i18n.site/payBill](//i18n.site/payBill) , դուք պետք է կապեք կրեդիտ քարտ վճարման համար (վերալիցքավորում չի պահանջվում, վեբկայքը ավտոմատ կերպով կհանի վճարները՝ ըստ օգտագործման, [տե՛ս հիմնական էջը գնագոյացման համար](/#price) ):
...
Տարբեր `fromTo` կարող է կազմաձևվել տարբեր ֆայլերի : /
...
Այս կազմաձևման աղյուսակում գրացուցակ `blog` թարգմանության սկզբնաղբյուր լեզուն `zh` է, իսկ տեղեկատու `blog/your_file_name.md` թարգմանության սկզբնաղբյուր լեզուն `ja` է:

### Անտեսել Ֆայլը

Լռելյայնորեն, սկզբնաղբյուր լեզվի գրացուցակում `.md` -ով և `.yml` սկսվող բոլոր ֆայլերը կթարգմանվեն:

Եթե ցանկանում եք անտեսել որոշ ֆայլեր և չթարգմանել դրանք (օրինակ՝ անավարտ սևագրեր), կարող եք օգտագործել `ignore` դաշտի կազմաձևումը:

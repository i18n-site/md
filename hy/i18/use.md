...
Դրանցից `.i18n/cache/.gitignore` ի բովանդակությունը հետևյալն է :
...
Սա նշանակում է, որ `.i18n/cache/` գրացուցակի բոլոր ֆայլերը (բացի `.i18n/cache/.gitignore` ից) անտեսված են:

Եթե ձեր տարբերակի վերահսկման ծրագիրը `git` չէ, խնդրում ենք անտեսել այն այս կազմաձևման համաձայն:
...
Այս կազմաձևման աղյուսակում կատալոգ `blog` ի թարգմանության սկզբնաղբյուր լեզուն `zh` է, իսկ `blog/your_file_name.md` ի թարգմանության սկզբնական լեզուն `ja` է:

### Անտեսել Ֆայլը

Լռելյայնորեն, սկզբնաղբյուր լեզվի գրացուցակում `.md` և `.yml` ով սկսվող բոլոր ֆայլերը կթարգմանվեն:
...
Այն կտեղադրվի լռելյայն `/usr/local/bin` ի վրա:

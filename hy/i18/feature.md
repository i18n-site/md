...
Աջակցում է Markdown HTML թարգմանությանը, `MarkDown` ում ներկառուցված HTML `<pre>` և `<code>` պիտակներում բովանդակությունը թարգմանված չէ
...
Աջակցում է ստատիկ [HOGO](https://github.com/gohugoio/hugo) վերնագրի կազմաձևմանը, որը թարգմանում է միայն `title` , `summary` և `description` դաշտերը:
...
Վերոհիշյալի թարգմանությունը DeepL (նաև վերագրանցելով համապատասխան անունները և ավելացնելով կենտ `... ` ):
...
`i18` ինտեգրված է բազմալեզու վեբ կայքի կառուցման հրամանի տող գործիք [`i18n.site`](/i18n.site) ում:

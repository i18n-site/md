...
Հրամանատարի գործիք `i18` թարգմանելու համար Markdown & Yaml
...
Աջակցում է Markdown HTML `<pre>` HTML թարգմանությանը `MarkDown` իսկ `<code>` պիտակները չեն թարգմանվում
...
Թարգմանության մեկնաբանությունները պետք է նշեն լեզուն հետո ` ``` ` օրինակ : ` ```rust ` :

Ներկայումս աջակցում է մեկնաբանությունների թարգմանությունը `toml` `yaml` , `json5` , `go` , `rust` , `c` , `cpp` , `java` `js` , `coffee` `python` , `bash` , `php` [եւ այլ լեզուներով](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) :
...
Ծրագրավորողների համար `vscode` ովքեր ծանոթ `vim` `git`

( `Keep It Simple, Stupid` `KISS` Սկզբունքին հավատացողների շրջանում ձեռնարկության մակարդակի լուծումները հոմանիշ են ծանր, անարդյունավետ և դժվար օգտագործելի:
...
## Xindaya-Ի Բարձրորակ Թարգմանությունը
...
Նույն որակին հասնելու համար Google Translate-ի և `ChatGPT` ի կողմից պահանջվող ձեռքով խմբագրման քանակը համապատասխանաբար `2.67` անգամ և `3.15` անգամ է:
...
Գործիքը թարգմանում է միայն բառարանի արժեքները `YAML` այլ ոչ թե բառարանի ստեղները:

`YAML` հիման վրա դուք կարող եք հեշտությամբ ստեղծել միջազգային լուծումներ տարբեր ծրագրավորման լեզուների համար:

## Աջակցեք `HOGO` Կազմաձևմանը

Աջակցում է ստատիկ բլոգի վերնագրի կազմաձևմանը [HOGO](https://github.com/gohugoio/hugo) թարգմանվում `summary` `description` `title`

## Մի Թարգմանեք Փոփոխականների Անունները

Օգտագործվում `${amount}` որպես `YAML` `Markdown`

Այս տեսակի փոփոխականի անունը `${varname}` դիտարկվի որպես անգլերեն թարգմանություն:
...
Չինաստանը, Ճապոնիան և Կորեան չունեն մեծատառ կամ փոքրատառ տառեր, սակայն անգլերեն վերնագրերը հիմնականում մեծատառ են գրում առաջին տառը:

`i18` կարող է ճանաչել վերնագրերը `MarkDown` ով և առաջին տառը ինքնաբերաբար մեծատառով գրելու է մեծատառով մեծատառով թարգմանելիս:

Օրինակ `为阅读体验而优化` կթարգմանվի որպես `Optimized for Reading Experience` :
...
Թարգմանված է `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

<img alt="" src="//p.3ti.site/1720199391.avif">

Թարգմանված է `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Թարգմանված է `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

<img alt="" src="//p.3ti.site/1720199550.avif">

DeepL թարգմանությունը ֆրանսերեն (նաև վերագրանցելով համապատասխան անունները և ավելացնելով տարօրինակը `... ` :
...
`i18` -ի թարգմանությունը կճանաչի չինարեն, ճապոներեն և կորեերեն տերմինները և կթողնի տերմինները անփոփոխ:
...
## Կարող Է `i18n.site` Բազմալեզու Վեբկայքի Կառուցում

Ինտեգրված `i18` բազմալեզու վեբկայքի կառուցման հրամանի տողում [`i18n.site`](/i18n.site) .

Մանրամասների համար տես [`i18n.site`](/i18n.site) -ի փաստաթղթերը:

## Կոդ Բաց Կոդով

Հաճախորդը ամբողջովին բաց կոդով է, իսկ սերվերի կողմը բաց [կոդ](/i18n.site/src) է 90

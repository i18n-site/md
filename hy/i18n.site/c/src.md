...
* / [atomgit](https://atomgit.com/i18n/x) ուղղակիորեն հղված ճակատային [github](https://github.com/i18n-site/x) փաթեթավորել
  Հարմար է ուղղակիորեն մեջբերում անել markdown սկզբնավորման սկրիպտում և միաժամանակ օգտագործել այն փաթեթավորված վեբկայքում, որպեսզի խուսափենք կոդի կրկնությունից:
...
* [atomgit](https://atomgit.com/i18n-api/srv.docker) կոնտեյներ / [github](https://github.com/i18n-api/srv.docker)

## Շահագործում ԵՒ Սպասարկում

* Առցանց տեղակայման [atomgit](https://atomgit.com/i18n-ops/ops) [github](https://github.com/i18n-ops/ops) /

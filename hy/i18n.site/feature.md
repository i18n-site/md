...
`i18n.site` [unpkg.com](//unpkg.com) կհրապարակի կայքի բովանդակությունը `npmjs.com` `CDN` `npm` ՝ [jsdelivr.com](//jsdelivr.com)
...
Մկնիկը դրեք վերևի նավիգացիայի աջ կողմում գտնվող կոճակի վրա՝ հիանալի հատուկ էֆեկտներ տեսնելու համար:
...
Կան շատ փոքր պահանջներ, որոնք կարևոր են, բայց ոչ հրատապ: Զարգացման թիմը կնշանակի գործնական առաջադրանքներ՝ համաձայն այն տեխնոլոգիայի, որը դուք լավ եք տիրապետում, և կբարելավի մշակման փաստաթղթերը՝ պահանջները հանձնարարելիս:
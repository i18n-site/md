...
`i18n.site` լռելյայնորեն կհրապարակի կայքի բովանդակությունը `npmjs.com` ի , [unpkg.com](//unpkg.com) և `npm` վրա բեռնված այլ `CDN` բովանդակության [jsdelivr.com](//jsdelivr.com) :
...
Վերևի նկարը ցույց է տալիս բազմալեզու `RSS` , օգտագործելով `i18n.site` բաժանորդագրությունը [inoreader.com](//inoreader.com)
...
`404` էջն ունի գեղեցիկ փոքրիկ լողացող ուրվական, նրա աչքերը կշարժվեն մկնիկի օգնությամբ, [➔ Սեղմեք այստեղ՝ դիտելու համար](/404) ,

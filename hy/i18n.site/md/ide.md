...
Մենք օգտագործում ենք `MarkDown` [vscode](https://code.visualstudio.com/) գրելու համար, ինչպես նաև տեղադրում ենք [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) plug-in-ը՝ գրելիս իրական ժամանակում նախադիտելու համար:

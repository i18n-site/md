...
## Նկարներ/Տեսանյութեր/Հղումներ Բազմաթիվ Լեզուներով

`MarkDown` `HTML` -ի վերածվելուց հետո `src` և `href` ատրիբուտներում `$LANG` կփոխարինվի ներկայիս [լեզվի կոդով](/i18/LANG_CODE) :

Այս փոփոխականով դուք կարող եք հասնել նկարների/տեսանյութերի/հղումների բազմալեզուացման:
...
`i18n.site` հետ համաձայնեցված խարիսխի կետի լուծումը `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` -ում նման տեքստի տեղադրումն է՝ ձեռքով ստեղծելու դիրքավորման խարիսխի կետը:

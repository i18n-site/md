...
Դուք կարող եք վերը նշված կոնֆիգուրացիայից `use: Toc` փոխել `use: Md` ի, նորից գործարկել `i18n.site` `md` գրացուցակում, այնուհետև այցելել զարգացման նախադիտման URL-ը՝ հիմնական էջի փոփոխությունները դիտելու համար:
...
`TOC` ֆայլը մատնանշված է ուրվագծի հիերարխիկ հարաբերությունները ցույց տալու, բազմամակարդակ նահանջը աջակցելու և `#` ով սկսվող տողերի մեկնաբանությունները:

...
Վերոնշյալ գրելու եղանակը համարժեք է `url: xxx` ի, իսկ դրա համապատասխան ֆայլը `en/xxx/TOC` է։
...
Օրինակ, եթե `/test` հասանելի է, և `nav:` կազմաձևված է առանց այս ճանապարհի նախածանցի, իսկ զննարկման ներկայիս լեզուն անգլերենն է (կոդ `en` ), `/en/test.md` կբեռնվի լռելյայն և կարտացոլվի՝ օգտագործելով ձևանմուշ `Md` :

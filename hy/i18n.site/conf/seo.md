...
Երբ մուտքի հայտի `User-Agent` օգտագործվում է որոնման համակարգի սողունի կողմից, հարցումը կվերահղվի ստատիկ էջ `302` ի միջոցով:
...
Խնդրում ենք նախ փոփոխեք վերը նշված `host:` արժեքը ձեր տիրույթի անվան համար, օրինակ՝ `i18n.site` :
...
Կազմաձևում, խնդրում ենք փոխել `i18n.site` `host:` -ը `.i18n/htm/ol.yml` -ում, մի քանի օբյեկտների պահեստներ կարող են կազմաձևվել `s3` տակ, իսկ `region` դաշտը կամընտիր է (օբյեկտների շատ պահեստարանների կարիք չկա այս դաշտը դնել):
...
Սահմանեք վերահղման կանոնները հետևյալ կերպ, խնդրում ենք փոփոխել «i18n.site» կոդը ձեր տիրույթի անվան մեջ
...
Օրինակ, [Huawei DNS ը](https://www.huaweicloud.com) տրամադրում է անվճար տարածաշրջանային վերլուծություն, որի միջոցով մայրցամաքային չինական երթևեկությունը կարող է անցնել Baidu Smart Cloud-ով, իսկ միջազգային տրաֆիկը կարող է անցնել `cloudflare` :
...
Քանի որ `R2` `cloudflare` մուտք գործել հարմարեցված տիրույթի անունով, անհրաժեշտ է օգտագործել երրորդ կողմի օբյեկտների պահեստավորում՝ ստատիկ ֆայլեր տեղադրելու համար:

`cloudflare` մենք վերցնում ենք [backblaze.com](https://www.backblaze.com)

Ստեղծեք դույլ `backblaze.com` -ում, վերբեռնեք ցանկացած ֆայլ, սեղմեք՝ ֆայլը թերթելու համար և ստացեք `Friendly URL` -ի տիրույթի անունը, որն այստեղ `f003.backblazeb2.com` ն է:

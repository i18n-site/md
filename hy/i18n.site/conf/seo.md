...
`i18n.site` ընդունում է ոչ թարմացվող մեկ էջի ճարտարապետություն, որպեսզի հեշտացվի որոնման ինդեքսավորումը, կստեղծվի առանձին ստատիկ էջ և `sitemap.xml` սողացողների համար:

...
Այստեղ `en/` `.i18n/conf.yml` ի կողմից կազմաձևված թարգմանության սկզբնաղբյուր լեզվին համապատասխան լեզվի կոդը է:
...
Դատարկ `v` չի ցուցադրվի կողագոտու ուրվագծում, բայց քանի դեռ կա `v` ֆայլ, անկախ ինդեքս կստեղծվի գրացուցակի և ենթագրքերում գտնվող ֆայլերի համար:
...
Օրինակ, ցուցադրական նախագծում `blog` ին համապատասխանող ինդեքսային ֆայլը [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) է :
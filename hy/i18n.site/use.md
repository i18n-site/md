...
Գործարկումից հետո `md` և քեշի `git add . ` կստեղծվեն:
...
Այնուհետև մուտքագրեք `docker` գրացուցակը և գործարկեք `./up.sh` , այնուհետև այցելեք [https://127.0.0.1](https://127.0.0.1) նախադիտելու համար:
...
`ol` `-n` `online` `npm` հապավումն է, որը ցույց է տալիս առցանց միջավայրը, որն օգտագործվում է պաշտոնական թողարկման համար:
...
Եթե դուք փոփոխում եք փաթեթի անվանումը `v:` `ol.yml` ում, խնդրում ենք **համոզվեք, որ նախ ջնջեք `.i18n/v/ol`** , ապա հրապարակեք այն:
...
Ինքնահոսթինգի բովանդակությունը, `CDN` ձեր սեփական սերվերից օգտվելուց, մեկ այլ ընդհանուր տարբերակ է օգտագործել `S3` +

Դուք կարող եք օգտագործել [rclone](https://rclone.org) -ն՝ `S3` սերվեր մուտք գործելու համար, այնուհետև հղում կատարել և փոփոխել հետևյալ սկրիպտը և պատճենել միայն ավելացող փոփոխությունները `S3` ի յուրաքանչյուր թողարկման համար:
...
Համեմատած `github page` [cloudflare page](//pages.cloudflare.com) , այն ապահովում է ուղու վերաշարադրում և ավելի բարեկամական է մայրցամաքային Չինաստանի համար և խորհուրդ է տրվում օգտագործել:
...
Վերոնշյալ նկարի `i18n.site` հետևյալն են.
...
Այնուհետև օգտագործեք ամպային վաճառողների օբյեկտների պահեստը մայրցամաքային Չինաստանում + Տեղադրեք հետևյալ բովանդակությունը `CDN` `out/ol/htm`
...
Քանի որ ձայնագրությունը `MX` և `CNAME` չեն կարող գոյակցել, եթե դուք ցանկանում եք միաժամանակ ստանալ տիրույթի անուններով նամակներ, դուք պետք է համագործակցեք `CNAME` մակարդակի `A` [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) հետ:
...
Ավելացրեք տիրույթի անունը [Alibaba CDN](https://cdn.console.aliyun.com/domain/list) ում և նշեք տիրույթի անունը `*.xxx.com` ից `CNAME` Alibaba Cloud `CDN` -ում:
...
Խնդրում ենք ավելացնել հետևյալ կազմաձևը `server` ի պարբերությունում nginx Խնդրում ենք փոխել `/root/i18n/md/out/ol/htm` ձեր սեփական նախագծի `out/ol/htm` ի ուղու վրա:

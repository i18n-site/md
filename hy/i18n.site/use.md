...
Եթե դուք օգտագործում եք շարունակական ինտեգրման միջավայր հրապարակելու համար, կարիք չկա տեղադրել `nodejs` , պարզապես մուտք գործած և հրապարակման թույլտվությունը `~/.npmrc` պատճենեք միջավայրում:
...
Կոդը սեղմելուց հետո սպասեք, որ `github page` -ի տեղակայումը հաջողությամբ գործարկվի (ինչպես ցույց է տրված ստորև), նախքան դրան մուտք գործեք:

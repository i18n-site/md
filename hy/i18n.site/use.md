...
Խմբագրեք `md/.i18n/htm/ol.yml` [npmjs.com](//npmjs.com) փոխեք [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` ի արժեքը որպես ձեր սեփական `npm` փաթեթի անուն:

Այնուհետև փոփոխեք `md/.i18n/htm/ol.package.json`

...
Wobetumi akyerɛkyerɛ [wɛb fã bi mu](https://www.freecodecamp.org/news/build-your-first-web-component/) wɔ `md/.i18n/htm/index.js` mu na afei wɔde adi dwuma wɔ `foot.pug` mu .
...
Sɛ wode `class="a"` ka link no ho a, ɛyɛ sɛ wobɛsiw link no kwan sɛ wɔbɛdan akɔ `MarkDown` Hwɛ :
 [➔ `YAML` Sɛnea wobɛsiw link `HTML` kwan sɛ wɔbɛdan `Markdown` :](/i18/qa#H2) !
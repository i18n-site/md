...
## Nkyerɛase a Wɔaka Abom `I18`

Dwumadi no wɔ nkyerɛase a wɔde ahyɛ mu `i18` yɛsrɛ wo hwɛ [➔ `i18`](/i18) a wɔde bedi dwuma pɔtee.
...
Sɛnea wɔahyɛ `i18n.site` , wɔbɛtintim sait no mu nsɛm akɔ `npmjs.com` , denam [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) ne `CDN` nsɛm pii a wɔde ahyɛ `npm` .
...
Nnyinasosɛm `CDN` ne sɛ: fa [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
Sɛnea wɔahyɛ no, wɔama [Alimama dual-axis variable rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) ne intanɛt so nkyerɛwde afoforo ayɛ adwuma wɔ wɛbsaet krataafa no so de aka akenkan osuahu a ɛwɔ wɔn a wɔde di dwuma wɔ nhyiam ahorow so no abom.

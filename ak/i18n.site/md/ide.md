...
Yɛde [vscode](https://code.visualstudio.com/) di dwuma de kyerɛw `MarkDown` , na yɛde plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) nso hyɛ mu de hwɛ wɔ bere ankasa mu bere a yɛrekyerɛw.

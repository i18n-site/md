...
`<a rel=id href="#xxx" id="xxx"></a>` , ha `rel=id` kyerɛkyerɛ kratafa kwan a ɛwɔ anchor point no mu, yɛsrɛ wo fa wo anchor Engiresi kasa tiawa ankasa si `xxx` ananmu.
...
Wubetumi akyerɛ implementation no wɔ [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) code no te sɛ nea edidi so yi :

...
* Asetra mu dwumadi ahorow
  - Fa wo ho hyɛ nnwuma mu nsakrae nhyiam ahorow mu
    + Mfiridwuma ho kyɛfa nhyiam
    + Adwumayɛfoɔ Nsesa Nhyiamu
...
| marx       | komunism a wɔde di dwuma |

## Koodu

### Inline Koodu a Ɛwɔ Mu

Wɔ nhyehyɛe kasa ahorow wiase kɛse no mu no, `Rust` , `Python` , `JavaScript` ne `Go` biara gye beae soronko.

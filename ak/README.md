<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Amanaman ntam ano aduru<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Command line Markdown Yaml , boa wo ma wokyekye amanaman ntam nkrataa site, a ɛboa [kasa ɔhaha pii](/i18/LANG_CODE) ...
...
Intanɛt ayi akyirikyiri a ɛwɔ ahunmu a ɛwɔ honam fam no afi hɔ, nanso kasa mu nsonsonoe da so ara siw nnipa biakoyɛ kwan.
...
Ɛnam sohyial media ne email so no, nkurɔfoɔ ayɛ wɔn su sɛ wɔde wɔn adwene besi nsɛm a wonya fibea wɔ wɔn ankasa kurom kasa mu so.
...
## <a rel=id href="#project" id="project"></a> Dwumadie no Nkyerɛkyerɛmu
...
Kyerɛkyerɛ `Markdown` ne `YAML` ase kɔ ahyɛde kwan so adwinnade ( [source code](https://github.com/i18n-site/rust/tree/main/i18) ) mu wɔ kasa ahorow pii mu.

Ebetumi akura ɔkwan a wɔfa so yɛ no mu pɛpɛɛpɛ `Markdown` Ebetumi ahu fael nsakrae na akyerɛ fael a wɔasesa nkutoo ase.
...
Yɛkyɛ " `UNIX` Biribiara yɛ Fael " na yebetumi ahwɛ nkyerɛase ahorow so wɔ kasa ɔhaha pii mu a yɛmfa ano aduru a ɛyɛ den na ɛyɛ den a ɛwɔ adwumayɛbea gyinabea mmra.

Wubetumi de nnwinnade a wunim no yiye adi dwuma de `Markdown` nkyerɛase no (nanso wuntumi mfa nkyekyem ahorow nka ho anaasɛ wompopa), na wode ɔkwan a wunim no yiye no adi dwuma de ayɛ version control.

Wobetumi ayɛ koodu nnyinaso sɛ ɔkwan a wɔabue ano ama kasa fael ahorow, na ɛdenam `Pull Request` Seamless connection [github](//github.com) Na afoforo a wɔabue ano.

[→ Sɛ wopɛ akwankyerɛ a, yɛsrɛ wo kenkan adwuma no ho nkrataa](/i18) .

## Xindaya’s Nkyerɛase a Ɛkorɔn
...
Sɛnea ɛbɛyɛ a yebenya su koro no ara a, nsaano nkyerɛwee dodow a Google Translate ne `ChatGPT` hwehwɛ no yɛ `2.67` mpɛn ne `3.15` mmɔho yɛn de.
...
Ɛyɛ static kɛkɛ, wɔayɛ no yie ama akenkan mu osuahu, na wɔde afrafra [i18](#i18)
...
Wɔde saa nhyehyɛe yi na ɛyɛɛ wɛbsaet yi na ɛka nea ɔde di dwuma, sikatua ne dwumadi afoforo ho ( [source code](/i18n.site/src) ).

[→ Sɛ wopɛ akwankyerɛ a, yɛsrɛ wo kenkan adwuma no ho nkrataa](/i18n.site) .

## Kɔ So Nni Nkitaho

Yɛsrɛ wo <button onclick="mailsub()">, klik saa email yi so na kyerɛw wo din wɔ nneɛma foforo ho</button> na <button onclick="webpush()">ma browser push nyɛ adwuma</button> Yɛbɛbɔ wo amanneɛ bere a wɔayɛ nneɛma foforo no.

Afei nso / wo [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) sɛ di yɛn social accounts akyi [X.COM: @i18nSite](https://x.com/i18nSite)

...
Ebetumi akura format a ɛyɛ `Markdown` mu pɛpɛɛpɛ. Ebetumi ahu fael nsakrae na akyerɛ fael a wɔasesa nkutoo ase.
...
Wubetumi de nnwinnade a wunim no yiye adi dwuma de asiesie `Markdown` no (nanso wuntumi mfa nkyekyem ahorow nka ho anaasɛ wompopa), na wode ɔkwan a wunim no yiye no adi dwuma de ayɛ version control.

Wobetumi ayɛ code base sɛ open source ama kasa fael ahorow, na ɛnam `Pull Request` nhyehyɛe mmoa so no, wiase nyinaa dwumadiefoɔ bɛtumi de wɔn ho ahyɛ nkyerɛaseɛ a ɛkɔ so yie no mu. Seamless connection [github](//github.com) ne mpɔtam afoforo a wɔabue ano.
...
[Klik ha na ma tumi na wo ara i18n.site github no akyi](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) na **woanya bonus $50** .
...
Anim-awieɛ nhyehyeɛ a ɛwɔ aseɛ no fa plug-in nhyehyeɛ a ɛdi mũ, a ɛnyɛ den ma nkɔsoɔ a ɛtɔ so mmienu Sɛ ɛho hia a, wɔbɛtumi de akyi-awieɛ dwumadie abom.
...
Sɛ wuhyia ɔhaw [→ yɛsrɛ wo fa to user forum no so](https://groups.google.com/u/1/g/i18n) .
...
Ɛboa kasa abien mu nsɛm ne nkɔmmɔbɔ dan ahorow;

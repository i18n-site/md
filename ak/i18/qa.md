...
Mapping a ɛda nkyerɛaseɛ ne mfitiaseɛ nkyerɛwee no ntam no, wɔakyekyere token no ho Yɛ token foforɔ wɔ [i18n.site/token](//i18n.site/token) popa `.i18h/hash` , na kyerɛ aseɛ bio na ama map a ɛyɛ basaa no afiri hɔ (nanso yei bɛma nsaano nsakraeɛ nyinaa ayera).

## `YAML` : Sɛnea Wobɛkwati Sɛ Wɔbɛdan Link `HTML` No Akɔ `Markdown` Mu

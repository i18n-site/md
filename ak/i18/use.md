...
windows System, yɛsrɛ wo [klik ha na twe na install `git bash`](https://git-scm.com/download/win) kan.
...
Bio nso, ɛsɛ sɛ [i18n.site/payBill](//i18n.site/payBill) credit card de tua ka (ɛho nhia sɛ wosan gye sika bio, wɛbsaet no bɛtwe sika a wɔbɔ no ankasa sɛnea wɔde di dwuma, [hwɛ homepage no so na woahu ne bo](/#price) ).

## Fa Di Dwuma

### Demo Adwuma No

Yɛsrɛ wo hwɛ demo [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) no so na sua nhyehyeɛ a ɛwɔ `i18` nkyerɛaseɛ mu.
...
Wɔ nhyehyeɛ pon yi mu no, kasa a ɛfiri katalog `blog` nkyerɛaseɛ mu ne `zh` , na kasa a ɛfiri `blog/your_file_name.md` nkyerɛaseɛ mu ne `ja` .

...
Ɛboa nkyerɛaseɛ a ɛfa mixed HTML Markdown , nsɛm a ɛwɔ tag `<pre>` ne `<code>` a wɔde ahyɛ HTML `MarkDown` mu no, wɔankyerɛ aseɛ

## Otumi Hu Akontaabu Nhyehyɛe Ahorow Na Ohuruw Nkyerɛase

Wohu akontaabu nhyehyɛe ahorow na wohuruw nkyerɛase.
...
China, Japan, ne Korea nni nkyerɛwde akɛse anaa nketewa, nanso mpɛn pii no, Engiresi abodin ahorow no de nkyerɛwde akɛse kyerɛw nkyerɛwde a edi kan no.
...
Wɔakyerɛ `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` akɔ Japan kasa mu :
...
Client no yɛ open source koraa, na server fã % no yɛ open 90 [Klik ha na hwɛ source code no](/i18n.site/src) .

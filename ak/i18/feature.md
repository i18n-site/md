...
Ɛboa nkyerɛaseɛ a ɛfa mixed HTML Markdown , nsɛm a ɛwɔ `<pre>` ne `<code>` tags a ɛwɔ HTML a wɔde ahyɛ `MarkDown` mu no, wɔankyerɛ aseɛ
...
Ɛsɛ sɛ nkyerɛase mu nsɛm kyerɛ kasa a ɛwɔ ` ``` ` akyi , te ` ```rust ` :
...
Ahyɛde kwan so nkyerɛase nnwinnade bi nso wɔ hɔ, te sɛ [translate-shell](https://github.com/soimort/translate-shell)
...
## Boa Nkyerɛase `HOGO` Atiri Nhyehyɛe

Boa ti nhyehyɛe a ɛwɔ [HOGO](https://github.com/gohugoio/hugo) type static blog, a ɛkyerɛ afuw `title` , `summary` ne `description` nkutoo ase.
...
Wɔakyerɛ ase akɔ Japan kasa : `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす`

![](//p.3ti.site/1720199391.avif)

Wɔakyerɛ ase akɔ Franse kasa : `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique`
...
Wɔakyerɛ ase akɔ Japan kasa : `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す`
...
Hwɛ nkrataa a ɛwɔ [`i18n.site`](/i18n.site) mu ma nsɛm no mu nsɛm.

## Kood a Wɔabue Ano

Client no yɛ open source koraa, na server 90 % no yɛ open source [Klik ha na hwɛ source code no](/i18n.site/src) .

<h1 style="display:flex;justify-content:space-between">i18n.site Suluhu za kimataifa<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Mstari wa amri Markdown Yaml ya kutafsiri, hukusaidia kuunda tovuti ya hati ya kimataifa, inayosaidia [mamia ya lugha](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> Maelezo ya Mradi
...
* [Jenereta ya tovuti i18n.site : lugha nyingi isiyobadilika](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Chombo cha kutafsiri mstari wa amri cha MarkDown

Tafsiri `Markdown` na `YAML` kuwa zana ya mstari wa amri ( [msimbo wa chanzo](https://github.com/i18n-site/rust/tree/main/i18) ) katika lugha nyingi.

Inaweza kudumisha umbizo la `Markdown` Inaweza kutambua marekebisho ya faili na kutafsiri faili zilizobadilishwa pekee.
...
Tunashiriki " `UNIX` Kila kitu ni Faili " na tunaweza kudhibiti tafsiri katika mamia ya lugha bila kuwasilisha masuluhisho changamano na magumu ya kiwango cha biashara.

Unaweza kutumia zana zinazojulikana zaidi `Markdown` tafsiri (lakini huwezi kuongeza au kufuta aya), na kutumia njia inayojulikana zaidi kufanya udhibiti wa toleo.

Msingi wa msimbo unaweza kuundwa kama chanzo wazi cha faili za lugha, na kwa usaidizi wa mchakato wa `Pull Request` watumiaji wa kimataifa wanaweza kushiriki katika uboreshaji unaoendelea wa tafsiri. Muunganisho usio na mshono [github](//github.com) Na jamii zingine za chanzo wazi.

[→ Kwa mwongozo wa mtumiaji, tafadhali soma hati za mradi](/i18) .

## Tafsiri Ya Hali Ya Juu Ya Xindaya
...
Majaribio yasiyo sahihi yanaonyesha kuwa ubora wetu wa tafsiri ni bora zaidi ikilinganishwa na huduma zinazofanana.

Ili kufikia ubora sawa, kiasi cha kuhariri mwenyewe kinachohitajika na Google `ChatGPT` ni mara `2.67` na `3.15` mara zetu mtawalia.
...
Iliyotulia kabisa, iliyoboreshwa kwa uzoefu wa kusoma, na kuunganishwa na tafsiri ya [i18](#i18) ni chaguo bora kwa kujenga tovuti ya hati ya mradi.
...
Tovuti hii imeundwa kulingana na mfumo huu na inajumuisha mtumiaji, malipo na vipengele vingine ( [msimbo wa chanzo](/i18n.site/src) ) Mafunzo ya kina yataandikwa baadaye.

[→ Kwa mwongozo wa mtumiaji, tafadhali soma hati za mradi](/i18n.site) .
...
[i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) / kufuata akaunti zetu za kijamii [X.COM: @i18nSite](https://x.com/i18nSite)

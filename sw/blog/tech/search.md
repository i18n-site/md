...
* `prefix` : wa kiambishi awali - neno id
...
Kiini cha utafutaji kitatumia jedwali `prefix` kwa neno la mwisho baada ya mgawanyo wa neno ili kupata maneno yote yaliyowekwa awali nalo, na kutafuta kwa mfuatano.

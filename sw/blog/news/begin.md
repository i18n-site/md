...
Baada ya zaidi ya nusu mwaka wa maendeleo [https://i18n.site](//i18n.site) ni online.

Hivi sasa, zana mbili za mstari wa amri ya chanzo wazi zinatekelezwa:

* `i18` : MarkDown Zana ya kutafsiri mstari wa amri
...
Mbele [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
hifadhidata [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

Tuma barua kwa SMTP [chasquid](https://github.com/albertito/chasquid) .

## Wasiliana Nasi

Bidhaa mpya zinapozinduliwa, matatizo hayaepukiki.

Jisikie huru kuwasiliana nasi kupitia Google [groups.google.com/u/2/g/i18n-site](https://groups.google.com/u/2/g/i18n-site) :
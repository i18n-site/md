...
Kwa [i18n.site/payBill](//i18n.site/payBill) , unahitaji kumfunga kadi ya mkopo kwa malipo (hakuna recharge inahitajika, tovuti itaondoa ada moja kwa moja kulingana na matumizi, [angalia ukurasa wa nyumbani kwa bei](/#price) ).
...
`fromTo` tofauti inaweza kusanidiwa kwa saraka ndogo / Maonyesho yameandikwa kama ifuatavyo :
...
Ikiwa ungependa kupuuza faili fulani na usizitafsiri (kama vile rasimu ambazo hazijakamilika), unaweza kutumia usanidi wa sehemu `ignore` .

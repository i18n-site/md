...
Hiyo ni kusema, unaporekebisha tafsiri mwenyewe, **usiongeze au kufuta mistari ya tafsiri** , vinginevyo uhusiano wa ramani kati ya tafsiri na maandishi asili hautaharibika.
...
Wakati mwingine ubadilishaji kutoka `HTML` → `MarkDown` sio tunachotaka, kama vile `<a href="/">Home</a>` kubadilishwa hadi `[Home](/)` .

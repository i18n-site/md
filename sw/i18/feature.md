...
Maoni ya tafsiri yanahitaji kuashiria lugha baada ya ` ``` ` , kama : ` ```rust ` .
...
Inaauni usanidi wa kichwa cha [HOGO](https://github.com/gohugoio/hugo) chapa blogu tuli, ambayo hutafsiri sehemu `title` , `summary` na `description` pekee.
...
Imetafsiriwa kwa `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

...
Suluhisho la sehemu ya nanga iliyokubaliwa na `i18n.site` ni kuingiza maandishi sawa na `<a rel=id href="#xxx" id="xxx"></a>` kwa `MarkDown` ili kuunda mwenyewe mahali pa kuweka nanga.
...
Unaweza kurejelea utekelezaji katika [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) nambari ni kama ifuatavyo :

...
Katika usanidi, tafadhali badilisha `i18n.site` hadi thamani ya `host:` katika `.i18n/htm/ol.yml` , hifadhi nyingi za vitu zinaweza kusanidiwa chini ya `s3` , na sehemu ya `region` ni ya hiari (duka nyingi za vitu hazihitaji kuweka uga huu).
...
Ongeza sheria za cache kama ifuatavyo:

...
* `foot.css` :
* `import.css` : 1Mtindo `i18n.site` kwa tovuti nzima
* `conf.css` : ikoni na fonti za chini

### Fonti Ya Ikoni

/ [ya](https://www.iconfont.cn/?lang=en-us) [kijachini](https://www.iconfont.cn/?lang=zh) inatolewa kwa kuunda fonti iitwayo `F` iconfont.cn

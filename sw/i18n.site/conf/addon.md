...
`file` ni orodha ya faili za pato, `path` ni njia ya faili, na `txt` ni maudhui ya faili.

## Kazi Zilizojengwa Ndani

Muda wa kukimbia `js` uliojengwa ni msingi wa ukuzaji wa pili wa [boa](https://github.com/boa-dev/boa) na vitendaji vilivyojumuishwa ni kama ifuatavyo :

...
Ikiwa unatumia mazingira ya ujumuishaji unaoendelea kuchapisha, hakuna haja ya kusakinisha `nodejs` , nakili tu kilichoingia na kuchapisha ruhusa `~/.npmrc` kwa mazingira.
...
Muda wa akiba wa njia zingine unaweza kuwekwa hadi mwaka mmoja au zaidi ili kupunguza maombi yasiyo ya lazima.
...
Tafadhali ongeza usanidi sawa na ufuatao katika aya ya `server` ya nginx Tafadhali badilisha `/root/i18n/md/out/ol/htm` hadi njia ya mradi wako mwenyewe `out/ol/htm` :

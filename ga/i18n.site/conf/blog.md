...
Más gá duit an t-alt a phionnáil go dtí an barr, rith `i18n.site` le do thoil agus cuir an `xxx.yml` chomhad in eagar faoi `.i18n/data/blog` , agus athraigh an stampa ama go uimhir dhiúltach (sórtálfar uimhreacha diúltacha iolracha ó bheag go mór i ndearbhluach).
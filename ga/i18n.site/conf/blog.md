...
Tá comhad taispeána cumraithe mar seo a leanas:
...
Is féidir faisnéis údair a scríobh i meitifhaisnéis an ailt, mar shampla:

```yml
author: marlowe
```

Ansin cuir `author.yml` in eagar san eolaire teanga foinse agus cuir faisnéis údair, mar shampla :

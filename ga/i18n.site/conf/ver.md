...
Seo é `en/` an cód teanga a fhreagraíonn don teanga fhoinseach aistriúcháin atá cumraithe ag `.i18n/conf.yml` .
...
Sa tionscadal taispeána, chomh maith le `en/demo2/v` , is féidir leat a fheiceáil freisin go bhfuil `v` chomhad folamh sna `en/blog` agus `en/demo1` chomhad.

...
Toisc `cloudflare` `R2` a rochtain le hainm fearainn saincheaptha, ní mór stóras réad tríú páirtí a úsáid chun comhaid statacha a chur.

[backblaze.com](https://www.backblaze.com) anseo mar shampla chun a léiriú conas rudaí tríú páirtí a cheangal le stóráil ag `cloudflare` .

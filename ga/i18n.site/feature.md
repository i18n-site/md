...
Is é an prionsabal ná: iarratais idirghabhála le [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , bain triail eile as iarratais theip ar `CDN` eile , agus cumasaigh go hoiriúnaitheach an suíomh tionscnaimh is tapúla a fhreagraíonn mar an fhoinse lódála réamhshocraithe.
...
> Tréigeann sé maisiú gan ghá agus cuireann sé ábhar i láthair ina fhoirm ghlan.
...
Hover do luch thar an gcnaipe ar an taobh deas den nascleanúint barr a fheiceáil éifeachtaí speisialta fionnuar.

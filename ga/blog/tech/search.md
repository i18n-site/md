...
1. Tacaíonn sé le cuardach iltheanga agus tá sé beag i méid Is é méid an eithne cuardaigh tar éis `gzip` a phacáistiú ná `6.9KB` (le haghaidh comparáide, is é `lunrjs` méid `25KB` ).

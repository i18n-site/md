...
brief: |
  ...
  I gcomparáid leis na réitigh atá ann cheana féin, tá cuardach téacs iomlán tosaigh tosaigh i18n.site beag i méid agus go tapa, oiriúnach do láithreáin ghréasáin bheaga agus mheánmhéide cosúil le doiciméid agus blaganna, agus tá sé ar fáil as líne.
...
Bainfidh an t-eithne cuardaigh úsáid as an tábla `prefix` don fhocal deiridh tar éis deighilt focal chun gach focal a bhfuil réimír leis a aimsiú, agus cuardach a dhéanamh in ord.

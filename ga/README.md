<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Réitigh idirnáisiúnta<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Cur síos ar an Tionscadal

Soláthraíonn an suíomh seo dhá uirlis líne ordaithe foinse oscailte faoi láthair:

* [i18 : MarkDown aistriúcháin líne ordaithe](/i18/feature)
* [i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Uirlis aistriúcháin líne ordaithe MarkDown

Aistrigh `Markdown` agus `YAML` go huirlis líne ordaithe ( [cód foinse](https://github.com/i18n-site/rust/tree/main/i18) ) i dteangacha éagsúla.

Is féidir a choimeád ar bun breá an fhormáid `Markdown` Is féidir leis mionathruithe comhaid a aithint agus gan ach comhaid athraithe a aistriú.
...
Roinnimid " fhealsúnacht `UNIX` is a File " agus is féidir linn aistriúcháin a bhainistiú sna céadta teanga gan réitigh casta agus an-deacair ar leibhéal an fhiontair a thabhairt isteach.

Is féidir leat na huirlisí is mó aithne a úsáid chun an t-aistriúchán `Markdown` (ach ní féidir leat ailt a chur leis nó a scriosadh), agus úsáid a bhaint as an mbealach is coitianta chun leagan a rialú.

Is féidir bonn cód a chruthú mar fhoinse oscailte do chomhaid teanga, agus le cabhair ó phróiseas `Pull Request` , is féidir le húsáideoirí domhanda a bheith rannpháirteach in optamú leanúnach na n-aistriúchán. Ceangal gan uaim [github](//github.com) agus pobail foinse oscailte eile.

[→ Le haghaidh treoir úsáideora, léigh na doiciméid tionscadail](/i18) .

## Aistriúchán Ar Ardchaighdeán Xindaya
...
Chun an cháilíocht chéanna a bhaint `2.67` , is `3.15` an méid eagarthóireachta láimhe a theastaíonn ó Google Translate agus `ChatGPT`
...
Go hiomlán statach, optamaithe le haghaidh taithí léitheoireachta, agus comhtháite leis an aistriúchán ar [i18](#i18) is é an rogha is fearr chun suíomh doiciméad tionscadail a thógáil.
...
Forbraítear an suíomh Gréasáin seo bunaithe ar an gcreat seo agus cuimsíonn sé feidhmeanna úsáideora, íocaíochta agus eile ( [cód foinse](/i18n.site/src) ).

[→ Le haghaidh treoir úsáideora, léigh na doiciméid tionscadail](/i18n.site) .
...
Chomh maith leis / [X.COM: @i18nSite](https://x.com/i18nSite) [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social)
...
Má tá suim agat, le do thoil [→ Cliceáil anseo chun do phróifíl a chomhlánú](https://ggl.link/i18n) agus ansin bheith ar [an liosta seoltaí](https://groups.google.com/u/2/g/i18n-site) le haghaidh cumarsáide.

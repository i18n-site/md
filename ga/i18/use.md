...
## Suiteáil Fuinneoga Ar Dtús git bash
...
Ina [i18n.site/payBill](//i18n.site/payBill) , ní mór duit cárta creidmheasa a cheangal le haghaidh íocaíochta (ní gá athmhuirearú a dhéanamh, déanfaidh an láithreán gréasáin táillí a asbhaint go huathoibríoch de réir úsáide, [féach ar an leathanach baile le haghaidh praghsála](/#price) ).
...
Más mian leat neamhaird a dhéanamh ar chomhaid áirithe agus gan iad a aistriú (cosúil le dréachtaí neamhchríochnaithe), is féidir leat an chumraíocht réimse `ignore` a úsáid.

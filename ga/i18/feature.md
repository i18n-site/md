...
Tacaíonn sé le haistriúchán measctha HTML Markdown , ní aistrítear an t-inneachar sa chlib `<pre>` agus `<code>` de HTML leabaithe i `MarkDown`
...
Ní aistríonn an uirlis ach na luachanna foclóir i `YAML` , ní na heochracha foclóir.
...
Níl litreacha móra nó litreacha beaga ag an tSín, ag an tSeapáin agus ag an gCóiré, ach is gnách gurb iad teidil Bhéarla an chéad litir.
...
Aistrigh an méid thuas go Fraincis (athscríobh freisin na hainmneacha cearta agus cuir an corr `... ` ): DeepL
...
Tá an cliant foinse oscailte go hiomlán, agus 90 taobh an fhreastalaí % den chód foinse oscailte. [Cliceáil anseo chun an cód foinse a fheiceáil](/i18n.site/src) .

...
Eipurúramo peteĩ tekoha integración continuo emoherakuã hag̃ua, natekotevẽi emoĩ `nodejs` , ekopia mante pe permiso ojeike ha oñemoherakuã hag̃ua `~/.npmrc` tekohápe.
...
Upéi, emohenda mbaꞌe oĩva `md/out/ol/v` ryru’ípe URL ñepyrũrã rape oñemohendavaꞌekue `v:` -pe.
...
Emoĩ peteĩ ñemboheko ojoguáva `/root/i18n/md/out/ol/htm` `server` párrafo nginx `out/ol/htm`
...
Ñe’ẽ ypykue ryru, okorrespondéva `en` de `fromTo` en `.i18n/conf.yml` vore ñembohekorã

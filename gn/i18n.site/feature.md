# Característica Producto Rehegua

## Ñe’ẽasa Integrado `I18`

Ko programa oguereko ñembohasa `i18` , ehecha [➔ `i18`](/i18) ojepuru hag̃ua específico.
...
`CDN` principio haꞌehína: emboty pe mbaꞌejerure [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
> Oheja decoración innecesaria ha opresenta contenido iforma ipotĩvévape.
...
Oñedesvanecéta pe mouse nomýiri jave.

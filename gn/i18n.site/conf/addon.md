...
Remyatyrõséramo pe versión, ikatu rehai `i18n.addon/toc@0.1.3` .
...
Pe `js` ejecución tiempo incorporado oñemopyenda desarrollo secundario de [boa](https://github.com/boa-dev/boa) , ha umi función incorporada haꞌehína koꞌãva :

...
`.i18h/hash` mapeo oĩva ñembohasa ha jehaipyre ypykue apytépe ojejokua pe token rehe Ejapo peteĩ token pyahu [i18n.site/token](//i18n.site/token)

## `YAML` : Mba'éichapa Ikatu Ani Oñekonverti Enlace `HTML` `Markdown` -Pe
...
Oñemoĩramo oimeraẽ atributo ndaha’éiva `href` pe etiqueta `a` pe, ha’eháicha `<a class="A" href="/">Home</a>` , ikatu ojehekýi ko ñemoambue.

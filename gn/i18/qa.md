...
## `YAML` : Mba'éichapa Ikatu Ani Oñekonverti Enlace `HTML` `Markdown`
...
Oñemoĩramo oimeraẽ atributo ndahaꞌeiva `href` pe etiqueta `a` pe, haꞌeháicha `<a class="A" href="/">Home</a>` , ikatu ojehekýi ko ñemoambue.

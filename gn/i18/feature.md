...
Oipytyvõ ñembohasa mixed HTML Markdown , pe contenido oĩva umi etiqueta `<pre>` ha `<code>` -pe HTML oñemboguapýva `MarkDown` pe noñembohasái
...
Umi ñe'ẽasa ñe'ẽasa tekotevẽ ohechauka ñe'ẽ ` ``` ` rire, ` ```rust ` :
...
Ñembohasaha ojejapovaꞌerã oñembohasávo tembiapoukapy ha oñembotývo peteĩ clic-pe Ndaipórivaꞌerã dependencia entorno compleja.

Ani remoĩ entidad-kuéra tekotevẽramo.

## Ndaipóri Modificación, Ndaipóri Traducción
...
Rojapo peteĩ generación pyahu tecnología ñembohasa rehegua ombojoajúva umi ventaja técnica umi modelo tradicional ñembohasa máquina rehegua ha umi modelo ñe’ẽ tuicháva rehegua ojapo hag̃ua ñembohasa hekopete, isãso ha iporãva.
...
## <a rel=id href="#price" id="price"></a> Precio competitivoiterei
...
[Emboguejy ko'ápe eautorisa ha esegui github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ha **ehupyty bono $50** !
...
Oñemopyendáva `YAML` ñembohasa rehe, ikatu remopuꞌa pyaꞌe solución internacional opaichagua ñeꞌepykuaa programación rehegua.
...
China, Japón ha Corea ndorekói tai tuicháva térã tai michĩva, péro umi título ingléspe jepivegua ohai mayúscula pe primera létra.
...
Ombohasa japonés- `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Pe cliente haꞌehína código abierto completo, ha pe servidor 90 % kódigo haꞌehína código abierto [Emboguejy koꞌape ehecha hag̃ua código fuente](/i18n.site/src) .
...
<button onclick="mailsub()">Emboguejy ko kuatiañe’ẽ eñembohasávo mba’erepy ñembopyahu</button> ha <button onclick="webpush()">emboguata navegador push</button> .

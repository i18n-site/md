...
windows Sistema, [eity ko'ápe emboguejy ha emoĩ hag̃ua `git bash`](https://git-scm.com/download/win) raẽ.
...
Avei, tekotevẽ [i18n.site/payBill](//i18n.site/payBill) peteĩ tarjeta de crédito repaga hag̃ua (noñeikotevẽi recarga, pe página web odeduci ijeheguiete umi honorario según jeporu, [ehecha página web-pe precio rehegua](/#price) ).
...
Ikatu emohenda `fromTo` iñambuéva opaichagua subdirectorio-pe g̃uarã : /
...
Ko cuadro configuración-pe, ñeꞌe ypykue catálogo `blog` ñembohasa rehegua haꞌehína `zh` , ha ñeꞌe ypykue `blog/your_file_name.md` ñembohasa rehegua haꞌehína `ja` .

### Omboyke Archivo

Por defecto, opaite vore oñepyrũva `.md` ha `.yml` gui oĩva ñe’ẽ ypy ryru’ípe oñembohasáta.
...
Pe tembipuru ombohasa ñe’ẽryru repykue `.yml` añoite, ndaha’éi ñe’ẽryru ñemohendaha.

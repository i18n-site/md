...
## <a rel=id href="#project" id="project"></a> Proyecto rehegua Ñemombe’u
...
Embohasa `Markdown` ha `YAML` peteĩ tembipuru’i ñe’ẽmondo rehegua ( [código fuente](https://github.com/i18n-site/rust/tree/main/i18) ) heta ñe’ẽme.

Ikatu omantene perfectamente pe formato de `Markdown` Ikatu ohechakuaa vore ñemoambue ha ombohasa vore oñemoambuéva añoite.

Pe traduksión ningo ikatu oñemboheko.
...
Rokomparti " `UNIX` mba’e ha’e peteĩ Archivo " ha ikatu oisambyhy ñembohasa hetaiterei ñe’ẽme romoinge’ỹre solución compleja ha engorrosa nivel empresarial-pe.

Ikatu reipuru umi tembipuru ojekuaavéva `Markdown` hag̃ua ñembohasa (ha katu ndaikatúi remoĩ térã rembogue umi párrafo), ha reipuru pe tape ojekuaavéva rejapo hag̃ua control de versión.

Peteĩ base código rehegua ikatu ojejapo peteĩ código abierto ramo umi archivo ñe’ẽ rehegua, ha `Pull Request` Conexión sin costuras [github](//github.com) Ha ambue komunida código abierto rehegua.

[→ Pojoapy puruhárape g̃uarã, emoñe’ẽmi proyecto kuatiañe’ẽ](/i18) .

## Xindaya Ñembohasa Iporãitereíva
...
Ojehupyty hag̃ua peteĩchagua calidad, pe cantidad de edición manual oikotevẽva Google Translate ha `ChatGPT` ha’e `2.67` veces ha `3.15` veces ñande mba’éva respectivamente.
...
Puramente estático, oñemboheko porãva moñe’ẽrã jeikoverã, ha oñembojoajúva [i18](#i18) ha’e pe jeporavo iporãvéva oñemopu’ã hag̃ua peteĩ proyecto kuatia tenda.
...
Ko página web oñembosako’i ko marco-pe ha oike puruhára, jehepyme’ẽ ha ambue tembiaporã ( [código fuente](/i18n.site/src) ).

[→ Pojoapy puruhárape g̃uarã, emoñe’ẽmi proyecto kuatiañe’ẽ](/i18n.site) .
...
/ peju porãite pesegui haguã ore [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) social [X.COM: @i18nSite](https://x.com/i18nSite)

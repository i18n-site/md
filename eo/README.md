...
#### <a rel=id href="#price" id="price"></a> Tre konkurenciva prezo
...
Nure statika, optimumigita por legado, kaj integrita kun la traduko de [i18](#i18) ĝi estas la plej bona elekto por konstrui projektdokumentejon.
...
Bonvolu <button onclick="mailsub()">klaki ĉi tiun retpoŝton por aboni produktajn ĝisdatigojn</button> kaj <button onclick="webpush()">ebligi retumilon push</button> Ni sciigos vin kiam produktoj estos ĝisdatigitaj.

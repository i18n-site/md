...
Malsama `fromTo` povas esti agordita por malsamaj subdosierujoj / Demonstro estas skribita jene :
...
En ĉi tiu agorda tabelo, la fontlingvo por tradukado de dosierujo `blog` estas `zh` , kaj la fontlingvo por tradukado de dosierujo `blog/your_file_name.md` estas `ja` .

### Ignori Dosieron

Defaŭlte, ĉiuj dosieroj komencantaj per `.md` kaj `.yml` en la fontlingva dosierujo estos tradukitaj.

Se vi volas ignori iujn dosierojn kaj ne traduki ilin (kiel nefinitajn skizojn), vi povas uzi la `ignore` kampan agordon.

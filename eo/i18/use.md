...
windows Sistemo, bonvolu [klaki ĉi tie por elŝuti kaj instali `git bash`](https://git-scm.com/download/win) unue.
...
Bonvolu raporti al la demo- [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) por lerni la agordon de `i18` traduko.
...
En ĉi tiu agorda tabelo, la fontlingvo de katalogo `blog` traduko estas `zh` , kaj la fontlingvo de `blog/your_file_name.md` traduko estas `ja` .

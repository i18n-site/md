# Rekomendo De La Redaktoro

Ĉiu havas sian plej ŝatatan redaktilon Ĉi tie ni dividas niajn `Markdown` plej bonajn praktikojn.

Ni uzas [vscode](https://code.visualstudio.com/) por skribi `MarkDown` , kaj ankaŭ instali la kromprogramon [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) por antaŭrigardi en reala tempo dum skribado.

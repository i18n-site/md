...
Aŭtorinformoj povas esti skribitaj en la meta-informo de la artikolo, kiel ekzemple:
...
Vidu demo-projekton [`begin.md`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/blog/news/begin.md?plain=1) kaj [`author.yml`](https://github.com/i18n-site/demo.i18n.site/blob/main/en/author.yml)

...
En la agordo, bonvolu ŝanĝi `i18n.site` al la valoro de `host:` en `.i18n/htm/ol.yml` , pluraj objektobutikoj povas esti agorditaj sub `s3` , kaj la `region` kampo estas laŭvola (multaj objektobutikoj ne bezonas agordi ĉi tiun kampon).
...
Aldonu kaŝmemorajn regulojn jene:
...
Ĉar `R2` `cloudflare` estas alirebla per personecigita domajna nomo, triaparta objektostokado devas esti uzata por meti senmovajn dosierojn.

Ĉi tie ni [backblaze.com](https://www.backblaze.com) kiel ekzemplon por montri kiel ligi triajn objektojn por esti stokitaj ĉe `cloudflare` .

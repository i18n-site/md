...
windows , প্রথমে [`git bash` ডাউনলোড এবং ইনস্টল করতে এখানে ক্লিক করুন](https://git-scm.com/download/win) ।
...
তার মধ্যে `.i18n/cache/.gitignore` এর বিষয়বস্তু নিম্নরূপ :
...
এর মানে হল যে `.i18n/cache/` ডিরেক্টরির সমস্ত ফাইল ( `.i18n/cache/.gitignore` বাদে) উপেক্ষা করা হয়েছে।

আপনার সংস্করণ নিয়ন্ত্রণ সফ্টওয়্যার `git` না হলে, এই কনফিগারেশন অনুযায়ী এটি উপেক্ষা করুন।
...
আপনি বিভিন্ন সাবডিরেক্টরিগুলির জন্য বিভিন্ন `fromTo` কনফিগার করতে পারেন একটি প্রদর্শন : লেখা হয় /
...
এই কনফিগারেশন টেবিলে, ক্যাটালগ `blog` অনুবাদের উৎস ভাষা হল `zh` , এবং `blog/your_file_name.md` অনুবাদের উৎস ভাষা হল `ja` ।
...
উদাহরণস্বরূপ, উপরের কনফিগারেশন ফাইলে `_* ` অর্থ হল `_` দিয়ে শুরু হওয়া ফাইলগুলি অনুবাদ করা হবে না।

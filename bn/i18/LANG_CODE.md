...
| ক্রমিক সংখ্যা | কোড | ভাষা | প্রদর্শনের নাম |
| - | - | - | - |
| 0 | `en` | ইংরেজি | `English` |
| 1 | `zh` | সরলীকৃত চীনা | `简体中文` |
| 2 | `de` | জার্মান | `Deutsch` |
| 3 | `fr` | ফরাসি | `Français` |
| 4 | `es` | স্পেনীয় | `Español` |
| 5 | `it` | ইতালীয় | `Italiano` |
| 6 | `ja` | জাপানিজ | `日本語` |
| 7 | `pl` | পোলিশ | `Polski` |
| 8 | `pt` | পর্তুগীজ | `Português(Brasil)` |
...
| 81 | `zh-TW` | ঐতিহ্যবাহী চাইনিজ | `正體中文` |

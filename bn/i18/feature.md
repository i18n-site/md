...
মিক্সড HTML এর অনুবাদ সমর্থন করে Markdown `MarkDown` এ এমবেড করা HTML এর `<pre>` এবং `<code>` ট্যাগের বিষয়বস্তু অনুবাদ করা হয়নি

## গাণিতিক সূত্র চিনতে পারে এবং অনুবাদ এড়িয়ে যেতে পারে

গাণিতিক সূত্র স্বীকৃত হয় এবং অনুবাদ এড়িয়ে যায়।

কিভাবে গাণিতিক সূত্র লিখতে হয়, অনুগ্রহ করে পড়ুন [" Github গাণিতিক অভিব্যক্তি লেখার বিষয়ে"।](https://docs.github.com/get-started/writing-on-github/working-with-advanced-formatting/writing-mathematical-expressions#about-writing-mathematical-expressions)
...
একই গুণমান অর্জনের জন্য, Google অনুবাদ এবং `ChatGPT` এর দ্বারা প্রয়োজনীয় ম্যানুয়াল সম্পাদনার পরিমাণ যথাক্রমে `2.67` গুণ এবং `3.15` গুণ।
...
[অনুমোদন করতে এখানে ক্লিক করুন এবং স্বয়ংক্রিয়ভাবে এর github অনুসরণ i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) এবং **$50 বোনাস পাবেন** ।
...
স্ট্যাটিক ব্লগের হেডার কনফিগারেশন সমর্থন করে [HOGO](https://github.com/gohugoio/hugo) যা শুধুমাত্র `title` , `summary` এবং `description` ক্ষেত্রগুলিকে অনুবাদ করে।

## পরিবর্তনশীল নাম অনুবাদ করবেন না

`Markdown` একটি ইমেল টেমপ্লেট হিসাবে ব্যবহার করা হয়, `YAML` একটি ভাষা ফাইল কনফিগারেশন হিসাবে ব্যবহৃত হয়, এবং পরিবর্তনশীল প্যারামিটার থাকবে (উদাহরণস্বরূপ: রিচার্জ `${amount}` গৃহীত হয়েছে)।

`${varname}` এর মত পরিবর্তনশীল নামগুলিকে ইংরেজি অনুবাদ হিসাবে গণ্য করা হবে না।
...
জাপানি ভাষায় অনুবাদ করা `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

ফরাসি `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

`Falcon` `faucon` হিসাবে অনুবাদ করা হয়েছে এবং `Llama` কে `lama` হিসাবে অনুবাদ করা হয়েছে। যথাযথ বিশেষ্য হিসাবে, তাদের অনুবাদ করা উচিত নয়।

![](//p.3ti.site/1720199451.avif)

### ডিপএল অনুবাদ

জাপানি ভাষায় অনুবাদ করা `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

DeepL ভাষায় উপরোক্ত অনুবাদ (এছাড়াও সঠিক নামগুলি পুনরায় লিখুন এবং বিজোড় `... ` যোগ করুন):

...
আমরা `MarkDown` লিখতে ব্যবহার [vscode](https://code.visualstudio.com/) এবং প্ল্যাগ-ইন ইনস্টল করি [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) লেখার সময় রিয়েল টাইমে প্রিভিউ করতে।
...
একই সময়ে, আপনি নিম্নলিখিত কনফিগারেশনটি উল্লেখ করতে পারেন, ফাইলটি সংশোধন করতে পারেন এবং আপলোড করা ফাইলটিকে স্বয়ংক্রিয়ভাবে `avif` এ সংকুচিত করার জন্য কনফিগার করতে পারেন ছবির আকার কমাতে।

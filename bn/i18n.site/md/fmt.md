...
`<a rel=id href="#xxx" id="xxx"></a>` , এখানে `rel=id` অ্যাঙ্কর পয়েন্টের পৃষ্ঠা শৈলী সংজ্ঞায়িত করে, অনুগ্রহ করে আপনার প্রকৃত অ্যাঙ্কর ইংরেজি সংক্ষিপ্ত নাম দিয়ে `xxx` প্রতিস্থাপন করুন।
...
## একাধিক ভাষায় ছবি/ভিডিও/লিঙ্ক

`MarkDown` `HTML` এ রূপান্তরিত করার পর, `$LANG` এর বৈশিষ্ট্য `src` এবং `href` বর্তমান [ভাষার কোড](/i18/LANG_CODE) দিয়ে প্রতিস্থাপিত হবে।

এই ভেরিয়েবলের সাহায্যে আপনি ছবি/ভিডিও/লিঙ্কের বহুভাষীকরণ অর্জন করতে পারেন।
...
`i18n.site` এর সাথে সম্মত অ্যাঙ্কর পয়েন্ট সমাধান হল ম্যানুয়ালি পজিশনিং অ্যাঙ্কর পয়েন্ট তৈরি করতে `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` মতো টেক্সট সন্নিবেশ করা।

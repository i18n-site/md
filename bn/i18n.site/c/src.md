...
* / বেস [atomgit](https://atomgit.com/i18n/lib) [github](https://github.com/i18n-site/lib)
* / বেস [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* সরাসরি / ফ্রন্ট-এন্ড [atomgit](https://atomgit.com/i18n/x) প্যাকেজ করার দরকার নেই [github](https://github.com/i18n-site/x)
  মার্কডাউন ইনিশিয়ালাইজেশন স্ক্রিপ্টে সরাসরি উদ্ধৃত করা এবং একই সময়ে প্যাকেজ করা ওয়েবসাইটে এটি ব্যবহার করা সুবিধাজনক, যাতে কোডের নকল এড়ানো যায়।
...
* অনলাইন স্থাপনার [atomgit](https://atomgit.com/i18n-ops/ops) / [github](https://github.com/i18n-ops/ops)

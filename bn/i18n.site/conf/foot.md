...
`F` ( [ইংরেজি সংস্করণ](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)) নামের একটি ফন্ট তৈরি করে ফুটার আইকন তৈরি করা হয় iconfont.cn
...
আপনি `foot.pug` মধ্যে `js` লিখতে পারবেন না। ইন্টারঅ্যাকশনের প্রয়োজন হলে, অনুগ্রহ করে ওয়েব কম্পোনেন্ট কাস্টমাইজ করুন।
...
ওয়েব কম্পোনেন্ট তৈরি করা সহজ, যেমন কাস্টম `<x-img>` ।
...
এখানে `${I18N.C}` সাথে `en/i18n.yml` মিল রয়েছে :

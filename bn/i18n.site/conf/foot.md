...
অনুগ্রহ করে নিম্নলিখিতগুলি পড়ুন, শৈলীটি সংশ্লিষ্ট `.css` এ লেখা হয়েছে, এবং ইন্টারঅ্যাকশনটি ওয়েব উপাদান তৈরি করে অর্জন করা হয়।
...
লিঙ্কে `class="a"` যোগ করা হল লিঙ্কটিকে `MarkDown` এ রূপান্তরিত হওয়া থেকে রক্ষা করা। দেখুন :
 [➔ `YAML` কিভাবে লিঙ্ক `HTML` `Markdown` তে রূপান্তর করা থেকে বিরত রাখা :](/i18/qa#H2) ।
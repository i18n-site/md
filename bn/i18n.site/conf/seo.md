...
যেহেতু `R2` একটি কাস্টমাইজড ডোমেন নাম দ্বারা অ্যাক্সেস করা `cloudflare` , স্ট্যাটিক ফাইলগুলি রাখার জন্য একটি তৃতীয় পক্ষের অবজেক্ট স্টোরেজ ব্যবহার করা প্রয়োজন।

এখানে আমরা `cloudflare` এ সংরক্ষণ করার জন্য তৃতীয় পক্ষের বস্তুগুলিকে কীভাবে আবদ্ধ করতে হয় তা প্রদর্শনের জন্য একটি উদাহরণ হিসাবে গ্রহণ করি [backblaze.com](https://www.backblaze.com)

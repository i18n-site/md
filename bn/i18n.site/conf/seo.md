...
`URL redirect` গতিশীল পুনঃনির্দেশ নির্বাচন করুন, অনুগ্রহ করে পুনঃনির্দেশ পাথ `concat("/en",http.request.uri.path,".htm")` -এ `/en` পরিবর্তন করুন যে ডিফল্ট ভাষা আপনি সার্চ ইঞ্জিন অন্তর্ভুক্ত করতে চান।

...
### `use: Toc` , রূপরেখা সহ একক ফাইল টেমপ্লেট
...
### `use: Md` , রূপরেখা ছাড়া একক ফাইল টেমপ্লেট
...
### `use: Doc` , মাল্টি-ফাইল ডকুমেন্ট টেমপ্লেট
...
উপরের লেখার পদ্ধতিটি `url: xxx` এর সমতুল্য, এবং এর সংশ্লিষ্ট ফাইলটি `en/xxx/TOC` ।

#### TOC বিষয়বস্তুর সূচি

`json` ডিরেক্টরী আউটলাইন তৈরি করতে `doc` টেমপ্লেট কনফিগারেশনের সাথে সম্পর্কিত `TOC` ডিরেক্টরি সূচক ফাইলটি পড়ার জন্য `i18n.site` ডেমো গুদামে `js` প্লাগ-ইন `.i18n/hook/after.tran/TOC.js` চালাবে।
...
`Doc` টেমপ্লেট উত্পন্ন `json` উপর ভিত্তি করে বিষয়বস্তুর সারণী রেন্ডার করবে।

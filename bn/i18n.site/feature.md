...
`i18n.site` ডিফল্টভাবে `npmjs.com` -এ সাইটের বিষয়বস্তু প্রকাশ করবে [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) এবং অন্যান্য একাধিক `CDN` কন্টেন্ট `npm` এ লোড হবে।
...
`404` পৃষ্ঠায় একটি সুন্দর ছোট ভাসমান ভূত আছে, এর চোখ মাউস দিয়ে নড়বে, [➔ দেখতে এখানে ক্লিক করুন](/404) ,

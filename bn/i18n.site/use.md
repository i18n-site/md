...
`md/.i18n/htm/ol.yml` সম্পাদনা করুন এবং আপনার নিজের `npm` প্যাকেজের নাম হিসাবে [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` এর মান পরিবর্তন করুন [npmjs.com](//npmjs.com)

তারপর `md/.i18n/htm/ol.package.json` পরিবর্তন করুন

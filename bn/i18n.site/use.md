...
চালানোর পরে, অনুবাদ এবং ক্যাশে ফাইল তৈরি করা হবে `md` `git add . ` সংগ্রহস্থলে যোগ করতে মনে রাখবেন।
...
উপরের অনুবাদটি চালানোর পরে, `md/out/dev` ডিরেক্টরির অধীনে ডিরেক্টরি `htm` এবং `v` তৈরি হবে।
...
প্যাকেজ নাম হিসাবে [npmjs.com](//npmjs.com) ডোমেইন নাম ব্যবহার করা একটি ভাল পছন্দ!
...
আপনি যদি প্রকাশ করার জন্য একটি অবিচ্ছিন্ন একীকরণ পরিবেশ ব্যবহার করেন, তাহলে `nodejs` ইনস্টল করার দরকার নেই, শুধু লগ ইন করা এবং প্রকাশ করার অনুমতি `~/.npmrc` পরিবেশে অনুলিপি করুন।
...
তারপর, `md/out/ol/v` ডিরেক্টরীতে থাকা বিষয়বস্তুটিকে `v:` এ সেট করা URL প্রিফিক্স পাথে কনফিগার করুন।
...
তারপর, মূল ভূখণ্ড + ক্লাউড বিক্রেতাদের অবজেক্ট স্টোরেজ ব্যবহার করুন `CDN` নিম্নলিখিত সামগ্রী স্থাপন করুন `out/ol/htm` !
...
অনুগ্রহ করে `server` nginx অনুরূপ একটি কনফিগারেশন যোগ করুন আপনার নিজের প্রকল্প `out/ol/htm` এর পাথে `/root/i18n/md/out/ol/htm` পরিবর্তন করুন:

...
## <a rel=id href="#project" id="project"></a> প্রকল্প বর্ণনা

এই সাইটটি বর্তমানে দুটি ওপেন সোর্স কমান্ড লাইন টুল সরবরাহ করে:

* [i18 : MarkDown লাইন অনুবাদ টুল](/i18/feature)
* [বহু-ভাষা স্ট্যাটিক ওয়েবসাইট i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: মার্কডাউন কমান্ড লাইন অনুবাদ টুল

একাধিক ভাষায় অনুবাদ করুন এবং `YAML` একটি কমান্ড লাইন টুলে ( [সোর্স কোড](https://github.com/i18n-site/rust/tree/main/i18) ) `Markdown`

পুরোপুরি ফরম্যাট বজায় রাখতে পারে `Markdown` ফাইল পরিবর্তন সনাক্ত করতে পারে এবং শুধুমাত্র পরিবর্তিত ফাইল অনুবাদ করতে পারে।
...
আমরা এভরিথিং ইজ একটি ফাইল " `UNIX` " শেয়ার করি এবং জটিল এবং কষ্টকর এন্টারপ্রাইজ-স্তরের সমাধান প্রবর্তন না করে শত শত ভাষায় অনুবাদ পরিচালনা করতে পারি।

আপনি অনুবাদ `Markdown` করতে সবচেয়ে পরিচিত সরঞ্জাম ব্যবহার করতে পারেন (কিন্তু আপনি অনুচ্ছেদ যোগ বা মুছে ফেলতে পারবেন না), এবং সংস্করণ নিয়ন্ত্রণ করতে সবচেয়ে পরিচিত উপায় ব্যবহার করতে পারেন।

ভাষা ফাইলের জন্য একটি ওপেন সোর্স হিসাবে একটি কোড বেস তৈরি করা যেতে পারে, এবং `Pull Request` সাহায্যে বিশ্বব্যাপী ব্যবহারকারীরা অনুবাদের ক্রমাগত অপ্টিমাইজেশানে অংশগ্রহণ করতে পারে। বিরামহীন সংযোগ এবং অন্যান্য ওপেন সোর্স সম্প্রদায় [github](//github.com)

[→ ব্যবহারকারী গাইডের জন্য, অনুগ্রহ করে প্রজেক্ট ডকুমেন্টেশন পড়ুন](/i18) ।
...
সম্পূর্ণরূপে স্থির, পড়ার অভিজ্ঞতার জন্য অপ্টিমাইজ করা, এবং [i18](#i18) এটি একটি প্রকল্প নথি সাইট তৈরির জন্য সেরা পছন্দ।
...
এই ওয়েবসাইটটি এই কাঠামোর উপর ভিত্তি করে তৈরি করা হয়েছে এবং এতে ব্যবহারকারী, অর্থপ্রদান এবং অন্যান্য ফাংশন রয়েছে ( [উৎস কোড](/i18n.site/src) ) পরে বিস্তারিত টিউটোরিয়াল লেখা হবে।

[→ ব্যবহারকারী গাইডের জন্য, অনুগ্রহ করে প্রজেক্ট ডকুমেন্টেশন পড়ুন](/i18n.site) ।

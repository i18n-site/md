...
#### <a rel=id href="#price" id="price"></a> খুব প্রতিযোগিতামূলক মূল্য
...
<button onclick="mailsub()">পণ্য আপডেটে সদস্যতা নিতে</button> এবং <button onclick="webpush()">ব্রাউজার পুশ সক্ষম করতে</button> দয়া করে এই ইমেলটিতে ক্লিক করুন যখন পণ্যগুলি আপডেট করা হয় তখন আমরা আপনাকে অবহিত করব৷

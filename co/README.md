...
## <a rel=id href="#project" id="project"></a> Introduzione di prughjettu
...
Abbunemu à a filusufìa " `UNIX` Tuttu hè un schedariu " è ponu gestisce traduzioni in centinaie di lingue senza introduzione di soluzioni cumplesse è ingombranti à livellu di l'impresa.

Pudete utilizà l'arnesi più familiari per edità a `Markdown` (ma ùn pudete micca aghjunghje o sguassate paragrafi), è utilizate a manera più familiare per fà u cuntrollu di versione.

Una basa di codice pò esse creatu cum'è una fonte aperta per i schedarii di lingua, è cù l'aiutu di i prucessi `Pull Request` , l'utilizatori glubale ponu participà à l'ottimisazione cuntinuu di traduzzioni. Cunnessione perfetta [github](//github.com) altre cumunità open source.
...
[Cliccate quì per auturizà è seguità i18n.site a github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) è **riceve bonus $50** .
...
>
> Tandu hè vinutu, facendu l'omu incapace di capiscenu a lingua di l'altru è spargugliatu in parechji lochi.
...
Supporta cumenti bilingui è chat room;
Un sistema di bigliettu multilingue chì pò pagà ricompense;
Un mercatu di vendita per cumpunenti front-end internaziunali;

...
Usemu [vscode](https://code.visualstudio.com/) per scrive `MarkDown` , è ancu installà u plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) per previsualizà in tempu reale mentre scrive.

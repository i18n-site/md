...
> E rumanzi di fantascienza cum'è "A Risposta Finale" di Asimov descrizanu vivamente i miliardi d'anni di storia di l'universu sanu, cumpresi l'esseri umani, in solu uni pochi di millaie di parolle.
> Tali inclusività è audacia sò impussibili di ottene in a literatura tradiziunale.
<p style="text-align:right">── Liu Cixin</p>

## Lista Da Fà

- [x] Disegnu prototipu di produttu è lista di funzioni
...
* avvenimenti suciali
  - Participà à riunioni di scambiu di l'industria
    ...
    + Reunione di scambiu di imprenditorialità

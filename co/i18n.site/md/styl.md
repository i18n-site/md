...
|--------------|------------------------------------|
| Confucius         | Fundatore di u Confucianismu |
...
In u vastu mondu di i linguaggi di prugrammazione, `Rust` , `Python` , `JavaScript` è `Go` ognunu occupanu un locu unicu.

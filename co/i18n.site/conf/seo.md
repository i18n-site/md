...
`URL redirect` Selezziunate a redirezzione dinamica, per piacè mudificà `/en` in u percorsu di redirezzione `concat("/en",http.request.uri.path,".htm")` à a lingua predeterminata chì vulete chì i mutori di ricerca includinu.

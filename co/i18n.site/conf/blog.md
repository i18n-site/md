...
L'infurmazione meta deve esse à u principiu di u schedariu, cuminciendu cù `---` è finiscinu cù `---` U furmatu di l'infurmazioni di cunfigurazione in u mità hè `YAML` .

Un schedariu demo hè cunfiguratu cusì:
...
L'infurmazione di l'autore pò esse scritta in a meta-informazione di l'articulu, cum'è:

...
L'articuli chì ùn cuntenenu micca meta infurmazione ùn apparisceranu micca nantu à a pagina di u blog, ma ponu appare in l'arbulu di l'annuariu à a diritta.

Sè avete bisognu di pinà l'articulu à a cima, per piacè eseguite `i18n.site` è edità i schedarii `xxx.yml` sottu `.i18n/data/blog` , è cambiate u timestamp à un numeru negativu (multipli numeri negativi seranu ordinati da chjuche à grande in valore assolutu).
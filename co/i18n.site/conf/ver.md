...
Empty `v` ùn serà micca mostratu in a barra laterale, ma finu à chì ci hè un schedariu `v` , un indice indipendente serà generatu per i schedari in u cartulare è i subdirectorii.

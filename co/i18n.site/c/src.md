...
* Ùn ci hè bisognu di [atomgit](https://atomgit.com/i18n/x) librerie front-end direttamente riferite / [github](https://github.com/i18n-site/x)
  Hè cunvenutu di cita direttamente in u script d'inizializazione di markdown è l'utilizanu in u situ web imballatu à u stessu tempu, per evità a duplicazione di codice.

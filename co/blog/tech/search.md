...
A causa di i difetti di suluzioni esistenti, `i18n.site` hà sviluppatu una nova suluzione pura di ricerca di testu in front-end, chì hà e seguenti caratteristiche :
...
1. Custruisce un indice invertitu basatu annantu à `indexedb` , chì occupa menu memoria è hè veloce.

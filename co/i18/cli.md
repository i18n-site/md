...
`-p` o `--purge` sguassate i fugliali chì esistenu in ogni repertoriu di traduzzione ma ùn esistenu micca in u cartulare di a lingua fonte.
...
U repertoriu traduttu predeterminatu in u cartulare induve u schedariu attuale hè situatu.

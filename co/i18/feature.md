...
`Markdown` hè utilizatu cum'è un mudellu di email, `YAML` hè utilizatu cum'è una cunfigurazione di file di lingua, è ci saranu parametri variabili (per esempiu: recharge `${amount}` hè statu ricevutu).
...
Solu quandu ci hè un spaziu trà a parolla inglesa è u testu cinese, giapponese è coreanu o a lunghezza inglese hè più grande di 1, a parolla serà cunsiderata cum'è un terminu.
...
U cliente hè completamente apertu, è u latu di u servitore hè un codice 90 [Clicca quì per vede u codice fonte](/i18n.site/src) .

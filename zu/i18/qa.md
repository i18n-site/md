...
Uma wengeza noma ususa umugqa ngephutha, okubangela ukudideka, sicela ubuyisele okuhunyushiwe enguqulweni ngaphambi kokulungisa, sebenzisa ukuhumusha okungu `i18` futhi, bese uphinda ulondoloze ukumepha okulungile.
...
## `YAML` : Kanjani Ukuthi Isixhumanisi `HTML` Siguqulwe Sibe Ngu- `Markdown`
...
Ukwengeza noma yisiphi isibaluli ngaphandle kuka `href` kumaka angu `a` , njengokuthi `<a class="A" href="/">Home</a>` , kungagwema lokhu kuguqulwa.

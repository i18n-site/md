...
## Sekela Ukuhumusha Oku `HOGO` Ukucushwa Kwesihloko

Isekela ukucushwa kweheda ye- [HOGO](https://github.com/gohugoio/hugo) thayipha ibhulogi emile, ehumusha kuphela izinkambu `title` , `summary` kanye no `description` .
...
Kuhunyushelwe kusi `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` Japanese :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` kusiFulentshi :
...
Kuhunyushelwe kusi `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` Japanese :
...
Iklayenti ingumthombo ovulekile ngokuphelele, futhi uhlangothi 90 % lwekhodi luwumthombo ovulekile [Chofoza lapha ukuze ubuke ikhodi yomthombo](/i18n.site/src) .

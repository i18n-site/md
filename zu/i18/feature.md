...
Isekela ukuhunyushwa kwamathebula e-Markdown ngaphandle kokulimaza ifomethi; ayihumushi amagama ngendlela yezibalo noma izixhumanisi.
...
Kukhona futhi amathuluzi wokuhumusha umugqa womyalo, njengokuthi [translate-shell](https://github.com/soimort/translate-shell)
...
## Sekela Ukuhumusha `HOGO` Ukucushwa Kwesihloko
...
`Markdown` isetshenziswa njengesifanekiso se-imeyili, `YAML` isetshenziswa njengokucushwa kwefayela lolimi, futhi kuzoba nemingcele eguquguqukayo (isibonelo: ukushajwa kabusha `${amount}` kutholiwe).
...
I-China, i-Japan, ne-Korea ayinawo osonhlamvukazi noma abancane, kodwa izihloko zesiNgisi ngokuvamile zibhala ngosonhlamvukazi uhlamvu lokuqala.
...
Kuhunyushelwe kusi- `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :
...
Iklayenti ingumthombo ovulekile ngokuphelele 90 futhi uhlangothi lweseva % lwekhodi luwumthombo ovulekile [Chofoza lapha ukuze ubuke ikhodi yomthombo](/i18n.site/src) .

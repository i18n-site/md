...
Nansi u `en/` ikhodi yolimi ehambisana nolimi lomthombo wokuhumusha olulungiselelwe ngu `.i18n/conf.yml` .
...
## Sebenzisa Amafayela Angu `v` Angenalutho Ukuze Uhlukanise Izinkomba Zefayela Zamaphrojekthi Ahlukene
...
U `v` ongenalutho ngeke uboniswe kuhlaka lwebha eseceleni, kodwa inqobo nje uma kunefayela elingu `v` , kuzokwenziwa inkomba ezimele yamafayela kuhla lwemibhalo nasezindaweni ezingaphansi.

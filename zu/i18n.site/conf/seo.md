...
Ekucupheni, sicela ushintshe `i18n.site` enani lika `host:` koku `.i18n/htm/ol.yml` , izitolo eziningi zezinto zingalungiselelwa ngaphansi kuka `s3` , futhi inkambu `region` ingokuzithandela (izitolo eziningi zezinto azidingi ukusetha le nkambu).

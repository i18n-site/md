...
> Kuyimvelo yami ukuthi amakhono ami azoba wusizo, futhi ngizobuya sekuphele yonke imali yami.
...
|--------------|------------------------------------|
| I-Confucius         | Umsunguli weConfucianism |
...
Emhlabeni omkhulu wezilimi zokuhlela, `Rust` `Python` , `JavaScript` futhi `Go` ngayinye ithatha indawo ehlukile.

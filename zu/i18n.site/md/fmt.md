...
`<a rel=id href="#xxx" id="xxx"></a>` , lapha `rel=id` uchaza isitayela sekhasi lephoyinti lehange, sicela ufake u `xxx` esikhundleni sakho ngesifinyezo sakho sangempela se-anchor English.
...
Okuqukethwe kuma-elementi `<pre>` ngeke kuhunyushwe.
...
Ungabhekisa ekusetshenzisweni ku- [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) ikhodi imi kanje :

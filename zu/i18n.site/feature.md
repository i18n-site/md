...
`i18n.site` izoshicilela okuqukethwe kwesayithi ku `npmjs.com` ngokuzenzakalelayo, ngosizo [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) nokunye okuqukethwe okungu `CDN` okulayishwe ku `npm` .
...
Kukhona isipoki esincane esihle esintantayo ekhasini `404` , amehlo aso azohamba negundane, [➔ Chofoza lapha ukuze ubuke](/404) ,

...
[vscode](https://code.visualstudio.com/)を使用して`Markdown`を書き、同時にプラグイン[Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced)をインストールして、書きながらリアルタイムでプレビューします。
...
また、以下の設定を参考にして、ファイルを変更し、アップロードされたファイルを自動的に`avif`形式に圧縮して画像サイズを減らすように設定することができます。

...
> 古代人は天に届く、神の門に届く塔を建て、人類の威信を高めました。
>
> 主は、「人は自分たちの部族を形成し、同じ言語を話す。塔を建てるのは序章にすぎない。それが完了したら、将来はすべてのことを行うだろう」と語られました。
>
> そこに主が来られ、人々は互いに分かり合えないまま各地に散らされてしまいました。
>
> 以来、人類の争いは続き、世界にはバベルの塔は存在しなくなった。

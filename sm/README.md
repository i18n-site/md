<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ fofo faavaomalo<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Faatasi ai ma ala o faasalalauga lautele ma imeli, ua masani tagata i le taulai atu i punaoa o faamatalaga i la latou lava gagana.
...
## <a rel=id href="#project" id="project"></a> Fa'amatalaga o Poloketi
...
Fa'aliliu `Markdown` ma `YAML` i se meafaigaluega laina fa'atonu ( [source code](https://github.com/i18n-site/rust/tree/main/i18) ) i le tele o gagana.

E mafai ona tausia lelei le faatulagaga o `Markdown` E mafai ona iloa suiga o faila ma na'o le faaliliu o faila ua suia.
...
Matou te fefaʻasoaaʻi " filosofia `UNIX` Mea uma o se File " ma e mafai ona faʻatautaia faʻaliliuga i le faitau selau o gagana e aunoa ma le faʻalauiloaina o faʻafitauli faigata ma faʻalavelave faʻapitoa.

E mafai ona e fa'aogaina meafaigaluega e sili ona masani ai e `Markdown` le fa'aliliuga (ae le mafai ona e fa'aopoopo pe tape palakalafa), ma fa'aoga le auala sili ona masani e fai ai le fa'atonutonuina o fa'aliliuga.

E mafai ona fausia se fa'avae fa'ailoga e avea o se puna tatala mo faila o gagana, ma fa'atasi ai ma le fesoasoani a `Pull Request` Feso'ota'iga leai se fa'aoga [github](//github.com)

[→ Mo taʻiala faʻaoga, faʻamolemole faitau le faʻamaumauga o le poloketi](/i18) .

## Fa'aliliuga Maualuga a Xindaya
...
Ina ia ausia le tulaga tutusa, o le aofaʻi o `3.15` tusi e manaʻomia e Google `2.67` ma `ChatGPT`
...
Fa'atotonuga, fa'amalieina mo le faitau tusi, ma tu'ufa'atasia ma le fa'aliliuga o le [i18](#i18) o le filifiliga sili lea mo le fausiaina o se nofoaga o pepa o galuega.
...
O lenei 'upega tafaʻilagi e faʻavae i luga o lenei faʻavae ma e aofia ai le tagata faʻaoga, totogi ma isi galuega ( [code source](/i18n.site/src) .

[→ Mo taʻiala faʻaoga, faʻamolemole faitau le faʻamaumauga o le poloketi](/i18n.site) .
...
Fa'afeiloa'i fo'i e mulimuli / matou tala [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) [X.COM: @i18nSite](https://x.com/i18nSite)
...
>
> Na silafia e le ALI‘I lenei mea, ‘ona fetalai atu ai lea o ia, “E tasi le gagana ma le fa‘apotopotoga o tagata uma, o lenei ‘ua fa‘ataunu‘uina lenei mea, o le a faia fo‘i mea uma.
>
> Ona oo mai ai lea, ua le mafai ai e tagata ona malamalama le tasi i le gagana a le isi ma taapeape i nofoaga eseese.

<p style="text-align:right">── Tusi Paia·Kenese</p>

Matou te mananaʻo e fausia se Initaneti e aunoa ma le faʻaesea o gagana.
Matou te faamoemoe o le a o mai faatasi tagata uma ma se miti masani.

Fa'aliliuga ma fa'amaumauga a le Markdown ua na'o le amataga.
Fa'amaopoopo fa'asalalauga fa'asalalauga i fa'asalalauga lautele;
Lagolago fa'amatalaga e lua gagana ma potu talatalanoaga;
O se faiga tiketi gagana e mafai ona totogi tupe;

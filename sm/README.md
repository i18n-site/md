...
Faatasi ai ma ala o faasalalauga faaleagafesootai ma imeli, ua masani tagata i le taulai atu i punaoa o faamatalaga i la latou lava gagana.
...
O le fa'avae pito i luma o lo'o fa'aaogaina se fausaga fa'apipi'i atoatoa, lea e faigofie mo le atina'e lona lua pe a mana'omia, e mafai ona tu'ufa'atasia galuega fa'amuli.
...
Fa'amolemole <button onclick="mailsub()">kiliki lenei imeli e lesitala i fa'afouga oloa</button> ma <button onclick="webpush()">fa'agaoioi le browser push</button> .

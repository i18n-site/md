...
`i18` o le meafaigaluega laina laina mo le faaliliuga Markdown & Yaml
...
`<code>` `<pre>` HTML `MarkDown` Markdown HTML
...
I le taimi nei, e lagolagoina fa'aliliuga fa'amatalaga i le `toml` , `yaml` , `json5` , `go` , `rust` , `c` , `cpp` , `java` , `js` , `coffee` , `python` , `bash` , `php` [ma isi gagana](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) .
...
## Lagolago Le Fa'aliliuga `HOGO` Fa'aulutala Fa'atonuga

E lagolagoina le fa'auluuluga o le [HOGO](https://github.com/gohugoio/hugo) type static blog, lea e na'o le fa'aliliuina o fanua `title` , `summary` ma `description` .
...
Fa'aliliu i `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` gagana Iapani :

![](//p.3ti.site/1720199391.avif)

Fa'aliliu i `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Fa'aliliu i `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` gagana Iapani :

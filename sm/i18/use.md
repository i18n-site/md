...
I le faila faila, o le pito i lalo o `fromTo` :
...
E mafai ona e fetuutuuna'i `fromTo` eseese mo subdirectories : /
...
I lenei laulau fa'aopoopo, o le gagana fa'apogai o le fa'aliliuga `blog` o le `zh` , ma le gagana fa'apogai o `blog/your_file_name.md` o le `ja` .
...
Mo se faʻataʻitaʻiga, `_* ` i le faila faʻatulagaina o loʻo i luga o lona uiga o faila e amata i `_` o le a le faʻaliliuina.
...
O le meafaigaluega laina laina o le a su'e faila uma e fa'ai'u i `.yml` i le fa'atonuga o faila gagana ma fa'aliliu.
...
o le a faaliliuina i `i18n/zh/i18n.yml`
...
O le a faʻapipiʻi i `/usr/local/bin` e ala i le faaletonu.

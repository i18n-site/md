...
Afai e te fa'afuase'i ona fa'aopoopo pe tape se laina, fa'atupu le fenumiai, fa'amolemole toe fa'afo'i le fa'aliliuga i le fa'aliliuga a'o le'i suia, toe fa'agasolo `i18` fa'aliliuga, ma toe fa'asao le faafanua sa'o.
...
Ole tau ole `YAML` e fa'atatauina ole `MarkDown` mo fa'aliliuga.

O nisi taimi o le liua mai `HTML` → `MarkDown` e le o le mea tatou te mananaʻo ai, e pei o `<a href="/">Home</a>` ua liua i `[Home](/)` .

Faʻaopoopoina soʻo se uiga e ese mai `href` i le `a` tag, pei ole `<a class="A" href="/">Home</a>` , e mafai ona aloese mai lenei liua.

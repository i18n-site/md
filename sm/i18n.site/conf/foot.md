...
* `foot.css` :
* `import.css` : 1 Sitaili `i18n.site` mo le saite atoa
* `conf.css` :

### Fa'ailoga Fa'ailoga

O le fa'ailoga vae e fa'atupuina [e](https://www.iconfont.cn/?lang=en-us) ala i le fa'atupuina o se vai papatisoga [e](https://www.iconfont.cn/?lang=zh) ta'ua / `F` iconfont.cn
...
O `${I18N.C}` e fetaui ma `en/i18n.yml` :

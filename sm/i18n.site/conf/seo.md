...
Afai ua e suia `~/.config/i18n.site.yml` ma e te manaʻo e toe faʻapipiʻi, faʻamolemole faʻaaoga le poloaiga lenei i le lisi autu o le poloketi e faʻamalo ai le faʻapipiʻiina o le cache :
...
## Fa'aoga Fa'apitoa: Fa'asoa Fefa'ataua'iga E Fa'atatau I Fa'ai'uga Fa'aitulagi
...
E le gata i lea, i le tulafono `cloudflare` liliu mai luga, ua suia `index.html` i `file/your_bucketname/index.html` , ma o isi faʻasalalauga e tumau pea.

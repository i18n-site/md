...
I le faʻatulagaga, faʻamolemole sui `i18n.site` i le tau o `host:` i `.i18n/htm/ol.yml` , tele faleoloa mea faitino e mafai ona faʻapipiʻiina i lalo ole `s3` , ma le `region` fanua e filifili (tele faleoloa mea faitino e le manaʻomia le setiina o lenei fanua).
...
Le igoa ole igoa e talimalo ai [cloudflare](//www.cloudflare.com)
...
Ole tulafono ole tulafono e fa'apea, fa'amolemole sui le code "i18n.site" i lou igoa ole igoa:
...
Fa'aopoopo tulafono fa'aoga e pei ona ta'ua i lalo:
...
Seti tulafono toe fa'atonu e pei ona taua i lalo, fa'amolemole sui le code "i18n.site" i lou igoa ole igoa
...
`URL redirect` Filifili le suiga malosi, fa'amolemole suia `/en` ile toe fa'asinoala ala `concat("/en",http.request.uri.path,".htm")` ile gagana fa'aletonu e te mana'o e fa'aaofia i masini su'esu'e.
...
O faʻamatalaga e tuʻuina atu i le Baidu Object Storage ma fusia i le Baidu Content Distribution Network.
...
Kiliki `Debug` , ona kiliki lea Fa'asalalau i le feso'otaiga atoa.
...
E le gata i lea, i le tulafono o le liua o `cloudflare` i luga, ua suia `index.html` i `file/your_bucketname/index.html` , ma o isi faatulagaga e tumau pea.

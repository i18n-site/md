...
Fa'amolemole suia muamua le tau o `host:` i luga i lou igoa ole igoa, pei ole `i18n.site` .
...
I le faʻatulagaga, faʻamolemole sui `i18n.site` i le tau o `host:` i le `.i18n/htm/ol.yml` , tele faleoloa mea faitino e mafai ona faʻapipiʻiina i lalo ole `s3` , ma le `region` fanua e filifili (tele faleoloa mea faitino e le manaʻomia le setiina o lenei fanua).
...
Ona fai lea o le tusitusiga i totonu [EdgeJS le auaunaga pito i lalo](//console.bce.baidu.com/cdn/#/cdn/ejs/list)
...
## Fa'aoga Maualuga: Tufa Atu Felauaiga E Fa'atatau I Iugafono Fa'aitulagi
...
### `cloudflare R2` E Le Mafai Ona Maua E Ala Ile Igoa Fa'ale-Aganu'u

Talu ai ona `R2` `cloudflare` ona faʻaogaina e se igoa faʻapitoa faʻapitoa, e manaʻomia le faʻaogaina o se mea faʻapipiʻi lona tolu e tuʻu ai faila faʻamau.
...
Suia `cloudflare` o `SSL` → faiga fa'ailoga, seti i le `Full`

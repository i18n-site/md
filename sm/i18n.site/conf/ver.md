...
O `en/` lea o le fa'ailoga gagana e fetaui ma le gagana fa'aliliuga na fa'atulagaina e le `.i18n/conf.yml` .
...
I le poloketi faʻataʻitaʻiga, faʻaopoopo i `en/demo2/v` , e mafai foi ona e vaʻai o loʻo i ai `v` faila gaogao i le `en/blog` ma `en/demo1` directories.

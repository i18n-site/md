...
E mafai ona faʻapipiʻi faʻapipiʻi i le `.i18n/conf.yml` , e pei o:
...
* `i18n.addon/toc` :
  Fa'atupu fa'asino igoa o le `json` fa'atatau i `TOC` , fa'aaga e ala i le fa'aletonu
...
O igoa faila ua malilie i ai e faapea
...
O le taimi faʻatulagaina `js` e faʻavae i luga ole atinaʻe lona lua o : [boa](https://github.com/boa-dev/boa)
...
O le atinaʻeina o le plug-in e mafai ona avea ma faʻamatalaga [https://github.com/i18n-site/addon](https://github.com/i18n-site/addon)
...
`NB` , o le faapuupuuga o `Name Breif` , o lona uiga e mafai e le lisi pa'ū i lalo ona faʻaalia le igoa ma le faʻaupuga o le poloketi.
...
O le auala tusitusi o loʻo i luga e tutusa ma `url: xxx` , ma o lona faila tutusa o `en/xxx/TOC` .
...
Mo se faʻataʻitaʻiga, afai e maua `/test` , ma faʻapipiʻi `nav:` e aunoa ma le prefix o lenei ala, ma o le gagana suʻesuʻe o loʻo i ai nei o le Igilisi (code `en` ), `/en/test.md` o le a utaina e ala i le faaletonu ma faʻaaogaina le faʻataʻitaʻiga `Md` .

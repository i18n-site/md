...
Sei o tatou amata i se poloketi faʻataʻitaʻiga e aʻoaʻo ai le faʻaogaina o `i18n.site` .
...
A mae'a fa'agasolo, fa'aliliuga ma faila faila fa'amolemole manatua e `git add . ` i le faleteuoloa i le `md` directory.
...
`dev` o le faʻapuupuuga o le `development` , e faʻaalia ai le siosiomaga atinaʻe, faʻaaogaina mo le vaʻaiga faʻapitonuʻu, ma o le faila faʻapipiʻi le lelei.
`ol` o le faʻapuupuuga o le `online` , e faʻaalia ai le siosiomaga i luga ole laiga, lea e faʻaaogaina mo le faʻatagaina aloaia O le faila faʻapipiʻi le faʻaogaina pe a faʻaogaina laina laina `-n` i le `npm` e faʻasaʻo.

E mafai foi ona e fatuina isi faila faila Fa'aaoga le `--htm_conf` i luga o le laina faʻatonu e faʻamaonia ai le igoa faila faila e faʻaoga:
...
O `--save` o lo'o fa'atusalia ai le fa'afouga fa'asa'olotoga numera.
...
A lolomi e fa'atatau i le afifi `npm` , **ia mautinoa e fa'aoga `//unpkg.com/` mo** le fa'aulu o `v:` `i18n.site` ua fa'amanino fa'apitoa le taimi fa'apolopolo o `/.v` i lalo o lenei ala muamua e maua ai le va'aiga talafeagai o fa'asalalauga fou.

Fa'agasolo `i18n.site --npm` po'o le `i18n.site -n` ile `md` fa'atonu e fa'aliliu ma fa'asalalau.
...
Fa'apea o lau port server sui o `7890` , e mafai ona e tusia:
...
Afai e te manaʻo e faʻafeiloaʻi e oe lava ia mea, faʻasaʻo muamua `md/.i18n/htm/ol.yml` ma sui `v: //unpkg.com/i18n.site` i lau prefix URL, pei ole `v: //i18n-v.xxx.com` .
...
Ona, fetuutuunai le anotusi i le `md/out/ol/v` directory i le URL prefix ala seti i le `v:` .

Mulimuli ane, **fetuutuunai le taimi o le cache o le ala e fa'ai'u i `/.v` i le `1s`** , a le o lea e le mafai ona vave maua le mea fou na tu'uina atu.
...
I mea e faʻafeiloaʻi e le tagata lava ia, faʻaopoopo i le faʻaaogaina o lau lava 'auʻaunaga, `CDN` le isi filifiliga masani o le faʻaaogaina `S3` +
...
Manatua e faʻapipiʻi `CDN` ina ia oʻo i le taimi faʻapipiʻi o le ala e faʻaiʻu i le `/.v` o le `1s` , a le o lea e le mafai ona vave maua le mea fou na tuʻuina atu.
...
O le itulau e ulufale ai i luga o le upega tafaʻilagi e naʻo le tasi e manaʻomia ona faʻapipiʻi, ma e leai se manaʻoga e toe faʻapipiʻi le itulau o le upega tafaʻilagi mo faʻafouga o mea e sosoo ai.
...
A maeʻa ona tuleia le code, faʻatali mo le faʻapipiʻiina o `github page` e tamoe manuia (e pei ona faʻaalia i lalo) ae e te leʻi mauaina.
...
Pe a faatusatusa i `github page` , e maua ai le toe tusiina o le ala ma e sili atu ona faauo i le atunuu tele o Saina ma e sili atu [cloudflare page](//pages.cloudflare.com) faigofie.

O le faʻaogaina o le `cloudflare page` e masani lava ona faʻavae i luga o le faʻaogaina o le `github page` i luga.
...
Ona, fa'aoga le mea e teu ai fa'atau oloa i le atunu'u tele + Saina `CDN` Fa'atino mea nei `out/ol/htm` .
...
Fa'aopoopo le `CNAME` `*.xxx.com` igoa ile Alibaba `CDN` [CDN](https://cdn.console.aliyun.com/domain/list)

![](https://p.3ti.site/1721122000.avif)

Mo se faʻataʻitaʻiga, o le faʻasologa o le redirection igoa o le pan-domain o `*.i18n.site` i le ata o loʻo i luga e faʻapea:
...
Fa'amolemole fa'aopoopo se fa'asologa e pei o `/root/i18n/md/out/ol/htm` `out/ol/htm` i le `server` parakalafa o nginx
...
I lalo o le `.i18n` directory o loʻo i ai faila faʻapipiʻi, faʻaliliuga cache, ma isi o `i18n.site` Vaʻai le isi mataupu ["Configuration"](/i18n.site/conf) mo faʻamatalaga.

#### `en`

Fa'atonuga gagana fa'apogai, e fetaui ma `en` o le `fromTo` i `.i18n/conf.yml` faila fa'atulagaina

...
##### Fa'asalalauina Le Server Na Lomia E npm
...
`CDN` fa'aaoga lea o le mea e teu ai le au fa'atau ao i `out/ol/htm` atunu'u tele o Saina +
...
Fa'amolemole fa'aopoopo se `/root/i18n/md/out/ol/htm` e pei o mea nei i le `server` parakalafa o nginx `out/ol/htm`

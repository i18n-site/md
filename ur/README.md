...
یہاں تک کہ اگر یہ ایک ذاتی اوپن سورس پروجیکٹ ہے جو وسیع تر سامعین کو متاثر کرنا چاہتا ہے، تو اسے شروع سے ہی بین الاقوامی ٹیکنالوجی کا انتخاب کرنا چاہیے۔
...
ہم `UNIX` کے فلسفے کو سبسکرائب کرتے " ہر چیز ایک " ہے اور سیکڑوں زبانوں میں پیچیدہ اور بوجھل انٹرپرائز سطح کے حل پیش کیے بغیر ترجمہ کر سکتے ہیں۔

آپ `Markdown` میں ترمیم کرنے کے لیے سب سے زیادہ مانوس ٹولز استعمال کر سکتے ہیں (لیکن آپ پیراگراف کو شامل یا حذف نہیں کر سکتے ہیں)، اور ورژن کنٹرول کرنے کے لیے سب سے زیادہ مانوس طریقہ استعمال کر سکتے ہیں۔

زبان کی فائلوں کے لیے ایک کوڈ بیس کو اوپن سورس کے طور پر بنایا جا سکتا ہے، اور `Pull Request` پروسیس کی مدد سے، عالمی صارفین ترجمے کی مسلسل اصلاح میں حصہ لے سکتے ہیں۔ ہموار کنکشن [github](//github.com) دیگر اوپن سورس کمیونٹیز۔
...
[اجازت دینے کے لیے یہاں کلک کریں اور خود بخود github کی پیروی i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) اور **بونس $50 وصول کریں** ۔
...
مکمل طور پر جامد، پڑھنے کے تجربے کے لیے موزوں،! کے ترجمے کے ساتھ مربوط [i18](#i18) یہ پروجیکٹ دستاویز کی سائٹ بنانے کے لیے بہترین انتخاب ہے۔
...
دو لسانی تبصروں اور چیٹ رومز کی حمایت کرتا ہے۔

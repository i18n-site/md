...
سائنس فکشن ناول &quot;تھری باڈی&quot; (چینی تلفظ: `3Ti` ) ایک اجنبی تہذیب کا افسانہ بناتا ہے جو شفاف سوچ اور خوشحال سائنس اور ٹیکنالوجی کے ساتھ بات چیت کے لیے برقی مقناطیسی لہروں کا استعمال کرتی ہے۔

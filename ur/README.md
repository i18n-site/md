...
## <a rel=id href="#project" id="project"></a> پروجیکٹ کی تفصیل

یہ سائٹ فی الحال دو اوپن سورس کمانڈ لائن ٹولز فراہم کرتی ہے:

* [i18 : MarkDown لائن ترجمہ کا آلہ](/i18/feature)
* [کثیر زبان کا جامد ویب سائٹ i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: مارک ڈاون کمانڈ لائن ٹرانسلیشن ٹول

اور `YAML` ایک کمانڈ لائن ٹول ( [سورس کوڈ](https://github.com/i18n-site/rust/tree/main/i18) ) میں متعدد زبانوں میں ترجمہ کریں `Markdown`

بالکل کی شکل برقرار رکھ سکتے ہیں `Markdown` فائل میں ترمیم کی شناخت کرسکتا ہے اور صرف تبدیل شدہ فائلوں کا ترجمہ کرسکتا ہے۔
...
ہم ہر چیز `UNIX` " ایک فائل " کا اشتراک کرتے ہیں اور پیچیدہ اور بوجھل انٹرپرائز سطح کے حل متعارف کرائے بغیر سینکڑوں زبانوں میں ترجمہ کا انتظام کر سکتے ہیں۔

آپ ترجمہ میں `Markdown` کے لیے سب سے زیادہ مانوس ٹولز استعمال کر سکتے ہیں (لیکن آپ پیراگراف کو شامل یا حذف نہیں کر سکتے ہیں)، اور ورژن کنٹرول کرنے کے لیے سب سے زیادہ مانوس طریقہ استعمال کر سکتے ہیں۔

ایک کوڈ بیس کو زبان کی فائلوں کے لیے ایک اوپن سورس کے طور پر بنایا جا سکتا ہے، اور `Pull Request` کے عمل کی مدد سے، عالمی صارفین ترجمے کی مسلسل اصلاح میں حصہ لے سکتے ہیں۔ ہموار کنکشن [github](//github.com) دیگر اوپن سورس کمیونٹیز۔

[→ صارف کی رہنمائی کے لیے، براہ کرم پروجیکٹ کی دستاویزات پڑھیں](/i18) ۔
...
مکمل طور پر جامد، پڑھنے کے تجربے کے لیے موزوں، اور [i18](#i18) یہ پروجیکٹ دستاویز کی سائٹ بنانے کے لیے بہترین انتخاب ہے۔
...
یہ ویب سائٹ اس فریم ورک کی بنیاد پر تیار کی گئی ہے اور اس میں صارف، ادائیگی اور دیگر افعال شامل ہیں ( [سورس کوڈ](/i18n.site/src) ) ایک تفصیلی ٹیوٹوریل بعد میں لکھا جائے گا۔

[→ صارف کی رہنمائی کے لیے، براہ کرم پروجیکٹ کی دستاویزات پڑھیں](/i18n.site) ۔

...
لہذا، میں نے ترجمے کا ٹول `i18` تیار کیا اور ترجمے کے آلے کی بنیاد پر ایک کثیر زبان کا جامد سائٹ جنریٹر `i18n.site` بنایا۔
...
فرنٹ اینڈ [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)

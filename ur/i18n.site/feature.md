...
`i18n.site` سائٹ کے مواد کو بطور [jsdelivr.com](//jsdelivr.com) `npmjs.com` پر شائع کرے گا، [unpkg.com](//unpkg.com) اور `npm` پر لوڈ کردہ دیگر `CDN` مواد۔
...
## سنگل پیج ایپلی کیشن، انتہائی تیز لوڈنگ

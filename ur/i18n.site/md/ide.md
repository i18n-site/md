...
[vscode](https://code.visualstudio.com/) `MarkDown` لکھنے کے لیے استعمال کرتے ہیں اور پلگ ان [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) انسٹال کرتے ہیں تاکہ لکھتے وقت ریئل ٹائم میں پیش نظارہ کریں۔
...
تصویریں اپ لوڈ کرنے کے لیے استعمال [PicList](https://github.com/Kuingsmile/PicList) ، اپ لوڈ شارٹ کٹ کی سیٹ کرنا یاد رکھیں، اور ایک کلک کے ساتھ اسکرین شاٹ اپ لوڈ کریں۔

...
ہم `MarkDown` لکھنے اور پلگ [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) انسٹال کرنے کے لیے استعمال کرتے [vscode](https://code.visualstudio.com/) تاکہ لکھتے وقت ریئل ٹائم میں پیش نظارہ کیا جا سکے۔
...
فائل `Markdown` کو کھولنے کے لیے `vscode` کال کرنے کے لیے کمانڈ لائن میں `code xxx.md` درج کریں۔

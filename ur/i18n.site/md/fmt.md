...
## متعدد زبانوں میں تصاویر/ویڈیوز/لنک

`MarkDown` `HTML` میں تبدیل ہونے کے بعد، `$LANG` میں انتساب `src` اور `href` موجودہ [زبان کے کوڈ](/i18/LANG_CODE) سے بدل دیا جائے گا۔

اس متغیر کے ساتھ، آپ تصاویر/ویڈیوز/لنک کی کثیر لسانی کاری حاصل کر سکتے ہیں۔
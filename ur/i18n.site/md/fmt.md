...
`i18n.site` کے ساتھ متفق اینکر پوائنٹ حل دستی طور پر پوزیشننگ اینکر پوائنٹ بنانے کے لیے `MarkDown` میں `<a rel=id href="#xxx" id="xxx"></a>` کی طرح کا متن داخل کرنا ہے۔
...
نوٹ کریں کہ `<style>` کی وضاحت اوپر `<pre>` میں بھی کی گئی ہے۔
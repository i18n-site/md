...
### اپنی مرضی کے مطابق ڈومین نام کے ذریعے `cloudflare R2` تک رسائی حاصل نہیں کی جا سکتی
...
تبادلوں کا اصول شامل کریں جیسا کہ ذیل میں دکھایا گیا ہے، اسے پہلے رکھیں (پہلے کی ترجیح سب سے کم ہے):

...
* `rTxt(path)` : فائل پڑھیں
* `rBin(path)` بائنری : پڑھیں
* `rDir(dirpath)` : پڑھیں، ریٹرن ویلیو ایک صف ہے : فہرست، فائل کی فہرست

## ڈویلپمنٹ گائیڈ

پلگ ان ترقی ایک حوالہ ہو سکتا ہے [https://github.com/i18n-site/addon](https://github.com/i18n-site/addon)
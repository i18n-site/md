...
آپ مندرجہ بالا کنفیگریشن میں `use: Toc` کو `use: Md` میں تبدیل کر سکتے ہیں، `md` ڈائرکٹری میں `i18n.site` دوبارہ چلا سکتے ہیں، اور پھر ہوم پیج پر تبدیلیوں کا مشاہدہ کرنے کے لیے ڈویلپمنٹ کا پیش نظارہ URL ملاحظہ کر سکتے ہیں۔

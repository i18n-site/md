...
`md/.i18n/htm/ol.yml` میں ترمیم کریں اور [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` اپنے `npm` پیکیج کے نام کے طور پر تبدیل کریں [npmjs.com](//npmjs.com)

پھر `md/.i18n/htm/ol.package.json` ترمیم کریں۔

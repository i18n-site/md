...
اسی معیار کو حاصل کرنے کے لیے، Google Translate اور `ChatGPT` کے لیے ضروری دستی ترمیم کی مقدار بالترتیب ہمارے مقابلے میں `2.67` گنا اور `3.15` گنا ہے۔
...
یہ ٹول صرف لغت کی قدروں کا ترجمہ `YAML` میں کرتا ہے، ڈکشنری کیز کا نہیں۔
...
کلائنٹ مکمل طور پر اوپن سورس ہے 90 اور کوڈ کا % اوپن سورس ہے [سورس کوڈ دیکھنے کے لیے یہاں کلک کریں](/i18n.site/src) ۔

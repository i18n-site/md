...
> [!WARN]
> ترجمہ اور اصل متن کی سطریں ایک سے ایک ہونی چاہئیں۔ یعنی ترجمہ مرتب کرتے وقت سطریں شامل یا حذف نہ کریں۔ بصورت دیگر، یہ ترجمے کی تدوین کیش میں الجھن پیدا کرے گا۔

...
Лутфан ба лоиҳаи намоишӣ муроҷиат кунед, то конфигуратсияи тарҷумаи `i18` омӯзед [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18)
...
Дар байни онхо мазмуни `.i18n/cache/.gitignore` чунин аст :
...
Ин маънои онро дорад, ки ҳамаи файлҳо дар директорияи `.i18n/cache/` (ба истиснои `.i18n/cache/.gitignore` ) сарфи назар карда мешаванд.

Агар нармафзори идоракунии версияи шумо `git` набошад, лутфан онро мувофиқи ин конфигуратсия сарфи назар кунед.
...
Масалан, агар шумо хоҳед, ки хитоиро ба англисӣ тарҷума кунед, ин сатри `zh: en` аз нав нависед.
...
Дар ин ҷадвали конфигуратсия забони аслии тарҷумаи каталоги `blog` `zh` ва забони аслии тарҷумаи `blog/your_file_name.md` `ja` аст.
...
`ignore` синтаксиси `.gitignore` [globset](https://docs.rs/globset/latest/globset/#syntax) истифода мебарад.

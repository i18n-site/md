...
Тарҷумаи омехта Markdown HTML дастгирӣ мекунад, мундариҷаи дар `<pre>` ва `<code>` тегҳои HTML дар `MarkDown` ҷойгиршуда тарҷума нашудааст
...
Шарҳҳои тарҷума бояд забонро пас аз ` ``` ` нишон диҳанд, масалан ` ```rust ` :
...
Конфигуратсияи [HOGO](https://github.com/gohugoio/hugo) блоги статикиро дастгирӣ мекунад, ки танҳо майдонҳои `title` , `summary` ва `description` ро тарҷума мекунад.
...
Ба забони японӣ тарҷума `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :
...
Ба забони японӣ тарҷума `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

Тарҷумаи боло ба фаронсавӣ (инчунин аз нав навиштани номҳои мувофиқ DeepL илова кардани тоқ `... ` ):

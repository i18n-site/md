...
Агар шумо тасодуфан як сатр илова кунед ё нест кунед, ки боиси нофаҳмиҳо гардад, лутфан тарҷумаро ба версияи пеш аз тағир додан барқарор кунед, тарҷумаи `i18` дубора иҷро кунед ва харитасозии дурустро аз нав кэш кунед.
...
## `YAML` Чӣ Тавр Аз Табдил Додани Пайванди `HTML` Ба `Markdown` Пешгирӣ Кардан Мумкин :

Барои тарҷума арзиши `YAML` ҳамчун `MarkDown` ҳисоб карда мешавад.

Баъзан табдили `HTML` → `MarkDown` он чизе нест, ки мо мехоҳем, масалан `<a href="/">Home</a>` ба `[Home](/)` табдил дода мешавад.
...
Файлҳои ихтилофро нест кунед ва тарҷумаи `i18` дубора иҷро кунед.
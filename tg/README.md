<h1 style="justify-content:space-between">3Ti.Site · Тафаккури бидуни марз<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

3Ti.Site, Тарҷумаи Markdown + генератори сайти статикии бисёрзабон.

Он ба шумо имкон медиҳад, ки ҳуҷҷатҳо ва блогҳои байналмилалиро зуд созед, ки [садҳо забонро](https://github.com/i18n-site/node/blob/main/lang/src/index.js) дастгирӣ мекунанд.
...
Баъзеҳо метавонанд бипурсанд, зеро ҳама браузерҳо функсияҳои тарҷума доранд, оё интернационализатсия кардани вебсайт нолозим аст?
...
> Дар он замон овозу гуфтори ҳама зери осмон як буд.
>
> Онҳо манорае сохтанд, ки ба осмон мерасад ва ба дарвозаҳои Худо мерасад, дилҳоро муттаҳид мекунад ва аз ҷалоли онҳо фахр мекунад.
>
> Худованд эълон кард: Вақте ки одамон забон ва наслро муштарак доранд, онҳо як қабила мешаванд. Манора танҳо ибтидо аст; дар рузхои оянда чизе нест, ки онхо ба даст наоваранд.
>
> Хамин тавр, У фуруд омад ва мардумро ба дуру дароз парешон кард, ки забонашон акнун барои якдигар нофахмост.
>
> Аз он вақт инҷониб низоъ беохир буд ва ҷаҳон дигар манораҳоеро намедид, ки ба осмон мерасид.
...
Тарҷумаи Markdown метавонад мустақилона ё бо генератори статикии бисёрзабонӣ барои зуд сохтани вебсайт истифода шавад.

Форматгузории Markdown, ғафс, рӯйхатҳо, унвонҳо, иқтибосҳо, истинодҳо, тасвирҳо ва ғайраро ба таври комил нигоҳ доред.

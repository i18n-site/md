...
Бо шабакаҳои иҷтимоӣ ва почтаи электронӣ, одамон одат кардаанд, ки ба манбаъҳои иттилоотӣ бо забони модарии худ таваҷҷӯҳ кунанд.
...
## Беҳтарин Сифати Тарҷумаи Мошин
...
Лутфан <button onclick="mailsub()">ин почтаи электрониро клик кунед, то ба навсозиҳои маҳсулот обуна шавед</button> ва <button onclick="webpush()">браузерро фаъол созед</button> , вақте ки маҳсулот навсозӣ мешавад, шуморо огоҳ мекунад.
...
>
> Худованд инро дид ва гуфт: Ҳама одамон забон ва нажод доранд.
>
> Пас аз он омад, ки одамон забони якдигарро нафахмида, ба чойхои гуногун пароканда шуданд.

<p style="text-align:right">──Библия·Ибтидо</p>

Мо мехоҳем интернетро бидуни ҷудоии забон созем.
Умедворем, ки тамоми инсоният бо як орзуи умумй гирд меояд.

Тарҷумаи Markdown ва сайти ҳуҷҷатгузорӣ танҳо ибтидо аст.

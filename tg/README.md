...
Гарчанде ки браузер тарҷумаи дарунсохт дорад, муҳаррикҳои ҷустуҷӯ то ҳол наметавонанд дар байни забонҳо дархост кунанд.
...
Бо таркиши иттилоот ва бозори ҷаҳонӣ, барои рақобат барои таваҷҷӯҳи кам, **дастгирии забонҳои гуногун як маҳорати асосӣ аст** .
...
## <a rel=id href="#project" id="project"></a> Тавсифи лоиҳа
...
`Markdown` ва `YAML` ба асбоби сатри фармон ( [коди сарчашма](https://github.com/i18n-site/rust/tree/main/i18) ) бо забонҳои гуногун тарҷума кунед.

Метавонад формати `Markdown` Метавонад тағироти файлро муайян кунад ва танҳо файлҳои тағирёфтаро тарҷума кунад.
...
Мо `UNIX` " Ҳар чиз як файл аст " -ро мубодила мекунем ва бидуни ҷорӣ кардани ҳалли мураккаб ва вазнини сатҳи корхона тарҷумаҳоро бо садҳо забон идора карда метавонем.

Шумо метавонед абзорҳои маъмултаринро барои `Markdown` тарҷума истифода баред (аммо шумо параграфҳоро илова кардан ё нест карда наметавонед) ва роҳи маъмултарини идоракунии версияро истифода баред.

Пойгоҳи кодро метавон ҳамчун манбаи кушодаи файлҳои забонӣ эҷод кард ва бо ёрии раванди `Pull Request` Пайвасти бефосила ва дигар ҷамоатҳои кушодаасос [github](//github.com)

[→ Барои дастури корбар, лутфан ҳуҷҷатҳои лоиҳаро хонед](/i18) .
...
Соф статикӣ, барои таҷрибаи хониш оптимизатсияшуда ва бо тарҷумаи [i18](#i18) он беҳтарин интихоб барои сохтани сайти ҳуҷҷати лоиҳавӣ мебошад.
...
Ин вебсайт дар асоси ин чаҳорчӯба таҳия шудааст ва корбар, пардохт ва дигар вазифаҳоро дар бар мегирад ( [коди сарчашма](/i18n.site/src) ). Дарси муфассал дертар навишта мешавад.

[→ Барои дастури корбар, лутфан ҳуҷҷатҳои лоиҳаро хонед](/i18n.site) .

...
`NB` пас аз параметри `demo1,demo2` ба он дода мешавад.
...
Файлҳои `TOC` барои нишон додани робитаи иерархивии контур ва пуштибонии сатҳҳои бисёрсатҳа ворид карда шудаанд.

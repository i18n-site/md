...
`URL redirect` Бозгашти динамикӣ интихоб кунед, лутфан `/en` дар роҳи масир `concat("/en",http.request.uri.path,".htm")` ба забони пешфарз, ки мехоҳед системаҳои ҷустуҷӯ дохил кунанд, тағир диҳед.

...
`i18n.site` меъмории як `sitemap.xml` навнашавандаро қабул мекунад.
...
Файли конфигуратсияи `.i18n/htm/ol.yml` дар лоиҳаи намоишӣ ҳамчун мисол гиред
...
Лутфан аввал арзиши `host:` дар боло ба номи домени худ тағир диҳед, масалан `i18n.site` .

Пас, `~/.config/i18n.site.yml` таҳрир кунед ва конфигуратсияи зеринро илова кунед :
...
Дар конфигуратсия, лутфан `i18n.site` ба арзиши `host:` дар `.i18n/htm/ol.yml` иваз кунед, якчанд мағозаҳои объектро дар зери `s3` танзим кардан мумкин аст ва майдони `region` ихтиёрӣ аст (бисёр мағозаҳои объектҳо лозим нест, ки ин майдонро танзим кунанд).

Сипас `i18n.site -n` иҷро кунед, то лоиҳаро дубора нашр кунед.
...
Азбаски `R2` бо номи домени фармоишӣ дастрас шуда `cloudflare` , барои ҷойгиркунии файлҳои статикӣ захираи объекти тарафи сеюм бояд истифода шавад.

Дар ин ҷо мо ҳамчун мисол мегирем [backblaze.com](https://www.backblaze.com) то нишон диҳем, ки чӣ гуна объектҳои тарафи сеюмро дар `cloudflare` нигоҳ доштан мумкин аст.

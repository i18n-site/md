...
Васлкунак бо нобаёнӣ версияи охиринро истифода мебарад ва ҳар ҳафта навсозиро тафтиш мекунад.
...
`file` рӯйхати файли баромад, `path` роҳи файл ва `txt` мундариҷаи файл аст.

## Функсияҳои Дарунсохт

Вақти : `js` ба рушди дуюмдараҷаи [boa](https://github.com/boa-dev/boa)

* `wPath(path, txt)` Ба файл :
* `rTxt(path)` : Файли матниро хонед
* `rBin(path)` : Файли бинариро хонед

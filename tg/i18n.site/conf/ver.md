...
`v` холӣ дар контури панели паҳлӯӣ намоиш дода намешавад, аммо то он даме, ки файли `v` мавҷуд аст, барои файлҳои директория ва зеркаталогҳо индекси мустақил тавлид мешавад.

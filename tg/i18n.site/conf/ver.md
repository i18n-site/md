...
`v` и холӣ дар контури панели паҳлӯӣ намоиш дода намешавад, аммо то он даме, ки файл `v` мавҷуд аст, барои файлҳои директория ва зеркаталогҳо индекси мустақил тавлид мешавад.

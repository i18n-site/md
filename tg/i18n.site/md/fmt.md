...
## Тасвирҳо/Видеоҳо/Пайвандҳо Бо Забонҳои Гуногун

Пас аз табдил додани `MarkDown` ба `HTML` , `$LANG` дар атрибутҳои `src` ва `href` бо [рамзи забони](/i18/LANG_CODE) ҷории иваз карда мешавад.

Бо ин тағирёбанда, шумо метавонед ба бисёрзабонии тасвирҳо/видеоҳо/пайвандҳо ноил шавед.
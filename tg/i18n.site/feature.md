...
`i18n.site` мундариҷаи сайтро ба таври `npmjs.com` бо [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) ва `CDN` мундариҷаи дар `npm` боршуда нашр мекунад.
...
Бисёр талаботҳои хурд вуҷуд доранд, ки муҳиманд, аммо таъхирнопазиранд, Гурӯҳи таҳиякунанда мувофиқи технологияе, ки шумо хуб доред, вазифаҳои амалияро таъин мекунад ва ҳангоми таъини талабот ҳуҷҷатҳои таҳияро такмил медиҳад.
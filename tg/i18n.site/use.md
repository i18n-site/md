...
Аввалан, директорияи `md` ворид кунед ва `i18n.site` иҷро кунед, ки `en` ба `zh` тарҷума мешавад.

<img src="https://p.3ti.site/1721114619.avif" style="width:350px">

Пас аз иҷро, файлҳои тарҷума ва кэш тавлид мешаванд, Лутфан `git add . ` ба репозиторий дар феҳристи `md` илова кунед.
...
Сипас, феҳристи `docker` ворид кунед ва `./up.sh` иҷро кунед ва сипас ба таври маҳаллӣ дидан [https://127.0.0.1](https://127.0.0.1) .
...
`ol` ихтисораи `online` мебошад, ки муҳити онлайнро нишон медиҳад, ки он барои нашри расмӣ истифода мешавад, инчунин файли конфигуратсияи пешфарз ҳангоми истифодаи параметрҳои сатри фармон аз `-n` то `npm` барои озод кардан.

Шумо инчунин метавонед файлҳои дигари конфигуратсияро эҷод кунед, то номи файли `--htm_conf` барои истифода муайян кунед.
...
Таҳрири `md/.i18n/htm/ol.yml` ва тағир додани `i18n.site` дар `v: //unpkg.com/i18n.site` ба номи бастаи `npm` -и худ.

Танҳо номи бастаи бебандро истифода баред [npmjs.com](//npmjs.com) ки номи домени вебсайтро интихоб кунед.

Ҳангоми нашр дар асоси бастаи `npm` , **боварӣ ҳосил кунед, ки `//unpkg.com/` барои** префикси `v:` қиммат истифода баред `i18n.site` вақти кэши `/.v` -ро дар зери ин роҳи префикс барои ноил шудан ба тамошои саривақтии релизҳои нав беҳтар кардааст.

Барои тарҷума ва нашр кардан дар феҳристи `md` `i18n.site --npm` ё `i18n.site -n` иҷро кунед.
...
Агар корбарон дар қитъаи Чин ба мушкилоти шабака дучор шаванд ва наметавонанд `npm` бастаро нашр кунанд, онҳо метавонанд тағирёбандаи муҳити `https_proxy` барои танзим кардани сервери прокси танзим кунанд.
...
Феҳристи `md` ворид кунед ва иҷро кунед
...
Сипас, мундариҷаро дар директорияи `md/out/ol/v` ба роҳи префикси URL, ки дар `v:` муқаррар шудааст, танзим кунед.
...
Шумо метавонед [rclone](https://rclone.org) барои ворид шудан ба сервери `S3` истифода баред, пас ба скрипти зерин муроҷиат кунед ва онро тағир диҳед ва танҳо тағиротҳои афзояндаро барои ҳар `S3` нашр нусхабардорӣ кунед.
...
Сипас анбори `i18n-demo.github.io` дар зери ин созмон эҷод кунед (лутфан `i18n-demo` бо номи созмоне, ки шумо сохтаед, иваз кунед):
...
[cloudflare page](//pages.cloudflare.com) муқоиса бо `github page` , он азнавнависии роҳро таъмин мекунад ва ба материкии Чин бештар мувофиқ аст ва истифодаи он дастрастар аст.
...
Лутфан `Add Account` пахш кунед, то дастрасӣ ба созмони `i18n-demo` диҳад.

Агар шумо анбори ташкилоти дигарро баста бошед, ба шумо лозим меояд, ки пеш аз намоиши ташкилоти нав ду маротиба `Add Account` клик кунед, то ду маротиба иҷозат диҳед.
...
Шумо метавонед роёниши канориро барои аз нав сабт кардани роҳ барои мутобиқ шудан ба барномаҳои яксаҳифа истифода баред, масалан, [Baidu Smart Cloud `CDN`](//cloud.baidu.com/product/cdn.html) метавон чунин танзим кард:
...
Номи доменро дар [Alibaba CDN](https://cdn.console.aliyun.com/domain/list) илова кунед ва номи доменро `*.xxx.com` то `CNAME` дар Alibaba Cloud `CDN` нишон диҳед.
...
Лутфан конфигуратсияи `/root/i18n/md/out/ol/htm` дар сархати `server` `out/ol/htm` nginx

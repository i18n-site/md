...
* `i18` : MarkDown тарҷумаи сатри фармон
* `i18n.site` :****

Тарҷума метавонад формати `Markdown` ро ба таври комил нигоҳ дорад. Метавонад тағироти файлро муайян кунад ва танҳо файлҳоро бо тағирот тарҷума кунад.
...
Воситаҳои мавҷудаи идоракунии тарҷума барои барномасозоне, ки ба идоракунии версияи `git` такя мекунанд, онҳо то ҳол хати фармонро бартарӣ медиҳанд.

Ҳамин тавр, ман асбоби тарҷумаи `i18` таҳия кардам ва дар асоси абзори тарҷума як генератори сайти статикии бисёрзабонӣ `i18n.site` сохтам.

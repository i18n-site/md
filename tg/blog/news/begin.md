...
Тарҷума матни аслиро таҳрир кардан мумкин аст ва вақте ки он дубора ба мошин тарҷума мешавад, тағироти дастӣ ба тарҷума дубора навишта намешавад (агар ин параграфи матни аслӣ тағир дода нашуда бошад).
...
Сатри фармон [js Engine boa_engine](https://docs.rs/boa_engine) , [базаи дохилии fjall](https://github.com/fjall-rs/fjall) .

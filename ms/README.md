...
Dengan media sosial dan e-mel, orang ramai terbiasa memberi tumpuan kepada sumber maklumat dalam bahasa ibunda mereka sendiri.
...
[Klik github sini untuk memberi kebenaran dan secara automatik mengikuti i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) dan **menerima bonus $50** .
...
Sila <button onclick="mailsub()">klik e-mel ini untuk melanggan kemas kini produk</button> dan <button onclick="webpush()">mendayakan tolak penyemak imbas</button> Kami akan memberitahu anda apabila produk dikemas kini.
...
>
> TUHAN melihat ini dan berkata: Semua manusia mempunyai bahasa dan bangsa yang sama Sekarang ini telah dicapai, segala-galanya akan dilakukan.
>
...
Kami mahu membina Internet tanpa pengasingan bahasa.

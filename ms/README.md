<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Penyelesaian antarabangsa<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Huraian Projek
...
* [i18n.site : laman web statik berbilang bahasa](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Alat terjemahan baris arahan MarkDown

Terjemah `Markdown` dan `YAML` ke dalam alat baris arahan ( [kod sumber](https://github.com/i18n-site/rust/tree/main/i18) ) dalam pelbagai bahasa.

Boleh mengekalkan format `Markdown` Boleh mengenal pasti pengubahsuaian fail dan hanya menterjemah fail yang diubah.
...
Kami berkongsi " `UNIX` ialah Fail " dan boleh mengurus terjemahan dalam ratusan bahasa tanpa memperkenalkan penyelesaian peringkat perusahaan yang rumit dan menyusahkan.

Anda boleh menggunakan alat yang paling biasa untuk `Markdown` terjemahan (tetapi anda tidak boleh menambah atau memadam perenggan), dan menggunakan cara yang paling biasa untuk melakukan kawalan versi.

Pangkalan kod boleh dibuat sebagai sumber terbuka untuk fail bahasa, dan dengan bantuan proses `Pull Request` , pengguna global boleh mengambil bahagian dalam pengoptimuman berterusan terjemahan. Sambungan lancar [github](//github.com) Dan komuniti sumber terbuka yang lain.
...
Statik semata-mata, dioptimumkan untuk pengalaman membaca, dan disepadukan dengan terjemahan [i18](#i18) ia adalah pilihan terbaik untuk membina tapak dokumen projek.
...
Laman web ini dibangunkan berdasarkan rangka kerja ini dan termasuk pengguna, pembayaran dan fungsi lain ( [kod sumber](/i18n.site/src) Tutorial terperinci akan ditulis kemudian).

[→ Untuk panduan pengguna, sila baca dokumentasi projek](/i18n.site) .
...
<p style="text-align:right">──Bible·Kejadian</p>

...
Kemudian buat skrip dalam [EdgeJS tepi](//console.bce.baidu.com/cdn/#/cdn/ejs/list) seperti berikut
...
Oleh kerana `R2` `cloudflare` diakses oleh nama domain tersuai, storan objek pihak ketiga perlu digunakan untuk meletakkan fail statik.

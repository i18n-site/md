...
## Terjemahan Bersepadu `I18`

Program ini mempunyai terjemahan terbina `i18` , sila lihat [➔ `i18`](/i18) untuk kegunaan tertentu.
...
Kod berkaitan : [github.com/i18n-site/18x/src/lang.coffee](https://github.com/i18n-site/18x/blob/main/src/lang.coffee)
...
`i18n.site` Secara lalai, kandungan `npm` akan diterbitkan [unpkg.com](//unpkg.com) `npmjs.com` , dengan `CDN` [jsdelivr.com](//jsdelivr.com)
...
Prinsipnya ialah: memintas permintaan dengan bantuan [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , jika permintaan gagal, cuba semula pada `CDN` yang lain, dan secara adaptif membolehkan stesen asal bertindak balas terpantas sebagai sumber pemuatan lalai.

Kod berkaitan : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)
...
> Ia meninggalkan hiasan yang tidak perlu dan membentangkan kandungan dalam bentuk yang paling tulen.
...
Secara lalai, [Alimama dwi-paksi pembolehubah fon segi empat tepat](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) dan fon dalam talian lain didayakan pada halaman web untuk menyatukan pengalaman membaca pengguna pada platform yang berbeza.

Pada masa yang sama, untuk meningkatkan kelajuan pemuatan, fon dihiris mengikut statistik kekerapan perkataan.

Kod berkaitan : [github.com/i18n-site/font](https://github.com/i18n-site/font)
...
`404` Terdapat hantu terapung kecil yang comel pada halaman, matanya akan bergerak dengan tetikus, [➔ Klik di sini untuk melihat](/404) ,

## Kod Sumber Terbuka

[Kod adalah sumber terbuka](/i18n.site/src) . Jika anda berminat untuk menyertai pembangunan, sila perkenalkan diri anda kepada [senarai mel](//groups.google.com/u/2/g/i18n-site) .

Terdapat banyak keperluan kecil yang penting tetapi tidak mendesak Pasukan pembangunan akan memberikan tugasan secara langsung berdasarkan teknologi yang anda kuasai, dan menambah baik dokumen pembangunan semasa menetapkan keperluan.

...
Kami menggunakan [vscode](https://code.visualstudio.com/) untuk menulis `MarkDown` , dan juga memasang pemalam [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) untuk pratonton dalam masa nyata semasa menulis.
...
Ia menyokong penyalinan nama fail secara automatik ke format `Markdown` selepas memuat naik, yang sangat meningkatkan kecekapan.

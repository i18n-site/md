...
Apabila menerbitkan berdasarkan pakej `npm` , **pastikan anda menggunakan `//unpkg.com/`** untuk awalan `v:` nilai `i18n.site` telah mengoptimumkan masa cache `/.v` di bawah laluan awalan ini untuk mencapai paparan keluaran baharu yang tepat pada masanya.

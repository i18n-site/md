# i18n.site: Marco De Sitio Web Multilingüe Estático Puro

`i18n.site` Generador de sitios de documentos puramente estáticos en varios idiomas.

Actualmente está disponible inicialmente, pero aún hay características importantes en desarrollo. Consulte [el plan de desarrollo](/i18n.site/c/roadmap) para obtener más detalles.
...
`i18n.site` es mi replanteamiento del modelo de desarrollo de sitios web.

Este es un generador de sitios de documentos y un marco de desarrollo de sitios web.

Un nuevo paradigma de desarrollo de sitios web que se centra en `MarkDown` y utiliza componentes de interfaz para inyectar interactividad.

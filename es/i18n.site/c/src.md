...
* / No es [atomgit](https://atomgit.com/i18n/x) empaquetar bibliotecas de interfaz de usuario a las que se hace referencia directamente [github](https://github.com/i18n-site/x)
...
La construcción del sitio del documento solo requiere la parte frontal, no la parte posterior.

Este backend es para el sitio web i18n.site mismo, que incluye sistemas de usuarios, pagos, notificaciones push, etc.

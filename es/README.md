...
Le permite crear rápidamente documentos y blogs internacionales compatibles con [cientos de idiomas](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

# I18N.SITE · Documentos Sin Fronteras<img Src="//ok0.pw/5l" Style="float:right;width:42px;margin-Top:6px">

I18N.SITE, un generador de sitios estáticos que admite traducción automática a [133 idiomas diferentes](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

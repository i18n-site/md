...
## <a rel=id href="#project" id="project"></a> Descripción del Proyecto
...
Traducir `Markdown` y `YAML` a una herramienta de línea de comandos ( [código fuente](https://github.com/i18n-site/rust/tree/main/i18) ) en varios idiomas.
...
Compartimos " filosofía `UNIX` Todo es un Archivo " y podemos gestionar traducciones en cientos de idiomas sin introducir soluciones complejas y engorrosas a nivel empresarial.

Puede utilizar las herramientas más familiares para `Markdown` la traducción (pero no puede agregar ni eliminar párrafos) y utilizar la forma más familiar para realizar el control de versiones.

Se puede crear una base de código como fuente abierta para archivos de idioma y, con la ayuda del proceso de `Pull Request` , los usuarios globales pueden participar en la optimización continua de las traducciones. ¡Conexión perfecta [github](//github.com) Y otras comunidades de código abierto.

[→ Para obtener la guía del usuario, lea la documentación del proyecto](/i18) .
...
Puramente estático, optimizado para la experiencia de lectura e integrado con la traducción de [i18](#i18) es la mejor opción para crear un sitio de documentos de proyecto.
...
Este sitio web se desarrolla en base a este marco e incluye funciones de usuario, pago y otras ( [código fuente](/i18n.site/src) ). Se escribirá un tutorial detallado más adelante.

[→ Para obtener la guía del usuario, lea la documentación del proyecto](/i18n.site) .
...
>
> El Señor vio esto y dijo: "Todos los seres humanos tenemos el mismo idioma y la misma raza. Ahora que esto se ha cumplido, todo se hará".
>

...
`-p` o `--purge` eliminarán archivos que están presentes en cada directorio de traducción pero no en el directorio del idioma original.
...
Usando este parámetro, se pueden limpiar archivos que deberían ser eliminados en los directorios de otros idiomas.

...
La cantidad de códigos de idioma es fija, y se agregarán nuevos idiomas posteriormente.

| Número | Código | Idioma | Nombre de visualización |
| - | - | - | - |
| 0 | `en` | Inglés | `English` |

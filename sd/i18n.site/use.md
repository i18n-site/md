...
ھلڻ کان پوء، ترجمو ۽ ڪيش فائلون ٺاھيو ويندو مھرباني ڪري `git add . ` `md` ڊاريڪٽري ۾ شامل ڪرڻ لاء.
...
تبديل ڪريو `md/.i18n/htm/ol.yml` ۽ تبديل ڪريو `i18n.site` `v: //unpkg.com/i18n.site` `npm` پيڪيج جو نالو.
...
جڏهن پيڪيج `npm` جي بنياد تي شايع ڪيو وڃي، `v:` قدر جي اڳياڙي **لاءِ `//unpkg.com/` کي استعمال ڪرڻ جي پڪ ڪريو** `i18n.site` خاص طور تي `/.v` جي ڪيش وقت کي هن اڳياڙي واري رستي جي بروقت ڏسڻ حاصل ڪرڻ لاءِ.

ترجمو ڪرڻ ۽ شايع ڪرڻ لاءِ `md` ڊاريڪٽري ۾ `i18n.site --npm` يا `i18n.site -n` هلايو.

جيڪڏهن توهان شايع ڪرڻ لاءِ مسلسل انٽيگريشن ماحول استعمال ڪريو ٿا، `nodejs` انسٽال ڪرڻ جي ڪا ضرورت ناهي، صرف لاگ ان ٿيل ۽ اشاعت جي اجازت `~/.npmrc` کي ماحول ڏانهن نقل ڪريو.
...
جيڪڏهن توهان مواد کي خود ميزباني ڪرڻ چاهيو ٿا، پهرين `md/.i18n/htm/ol.yml` ۾ ترميم ڪريو ۽ `v: //unpkg.com/i18n.site` پنهنجي URL جي اڳياڙي ۾ تبديل ڪريو، جهڙوڪ `v: //i18n-v.xxx.com` .
...
توھان استعمال ڪري [rclone](https://rclone.org) `S3` سرور ۾ لاگ ان ٿيڻ لاءِ، پوءِ ھيٺ ڏنل اسڪرپٽ جو حوالو ڏيو ۽ تبديل ڪريو، ۽ صرف ھر رليز لاءِ `S3` ۾ وڌندڙ تبديلين کي نقل ڪريو.
...
ان کان پوء هن تنظيم جي تحت گودام `i18n-demo.github.io` ٺاهيو (مهرباني ڪري `i18n-demo` تبديل ڪريو ان تنظيم جي نالي سان جيڪو توهان ٺاهيو آهي):
...
[cloudflare page](//pages.cloudflare.com) `github page` مقابلي ۾، اهو رستو ٻيهر لکندو آهي ۽ سرزمين چين لاء وڌيڪ دوستانه آهي ۽ استعمال ڪرڻ جي سفارش ڪئي وئي آهي.
...
مھرباني ڪري `Add Account` ڪلڪ ڪريو تنظيم `i18n-demo` تائين پھچائڻ لاءِ.
...
پهريون ڀيرو پابند ٿيڻ کان پوء، توهان کي ان تائين رسائي ڪرڻ کان پهريان توهان کي ڪجهه منٽ انتظار ڪرڻو پوندو.
...
ان کان علاوه، ڇاڪاڻ ته مکيه لينڊ چين ۾ ڪلائوڊ وينڊرز جا اوورسيز ٽريفڪ چارجز نسبتاً مهانگو آهن، جيڪڏهن توهان قيمتن کي بهتر ڪرڻ چاهيو ٿا، ته توهان حاصل ڪرڻ لاءِ [Huawei Cloud جي مفت جاگرافيائي DNS](https://support.huaweicloud.com/usermanual-dns/dns_usermanual_0041.html) ۽ [Cloudflare for SaaS](https://developers.cloudflare.com/cloudflare-for-platforms/cloudflare-for-saas) جي ڪسٽم ڊومين جو نالو استعمال ڪري سگهو ٿا (جيئن هيٺ ڏيکاريل آهي). ٽريفڪ جو رخ──ٽريفڪ سرزمين چين ۾ Baidu Cloud `CDN` , بين الاقوامي ٽرئفڪ cloudflare .
...
[Alibaba CDN](https://cdn.console.aliyun.com/domain/list) ۾ ڊومين جو نالو شامل ڪريو ۽ علي بابا ڪلائوڊ `CDN` ۾ ڊومين جو نالو `*.xxx.com` کان `CNAME` ڏانھن اشارو ڪريو.
...
مھرباني ڪري `server` پيراگراف ۾ ھيٺ ڏنل ھڪڙي ترتيب شامل ڪريو nginx مھرباني ڪري پنھنجي منصوبي `out/ol/htm` جي رستي ۾ `/root/i18n/md/out/ol/htm` کي تبديل ڪريو

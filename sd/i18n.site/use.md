...
`md/.i18n/htm/ol.yml` [npmjs.com](//npmjs.com) ڪريو ۽ [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` کي پنھنجي `npm` پيڪيج جي نالي سان تبديل ڪريو.

پوء تبديل ڪريو `md/.i18n/htm/ol.package.json`

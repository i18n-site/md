...
### `use: Toc` ، واحد فائل ٽيمپليٽ آئوٽ لائن سان
...
### `use: Md` ، ھڪڙي فائل ٽيمپليٽ بغير بغير
...
### `use: Doc` ، ملٽي فائل دستاويز ٽيمپليٽ
...
`Doc` ٽيمپليٽ ھڪڙي يا گھڻن پروجيڪٽن لاءِ دستاويز جي خاڪي پيدا ڪرڻ لاءِ گھڻن `MarkDown` ضم ڪرڻ جي حمايت ڪري ٿو.
...
مٿين لکڻ جو طريقو `url: xxx` جي برابر آهي، ۽ ان جي لاڳاپيل فائل `en/xxx/TOC` آهي.

#### TOC مواد جي انڊيڪس جي جدول

`i18n.site` ڊيمو گودام ۾ `js` پلگ ان `.i18n/hook/after.tran/TOC.js` تي عمل ڪندو `TOC` ڊاريڪٽري انڊيڪس فائل پڙهڻ لاءِ `doc` ٽيمپليٽ جي ترتيب سان لاڳاپيل `json` ڊاريڪٽري جو خاڪو تيار ڪرڻ لاءِ.

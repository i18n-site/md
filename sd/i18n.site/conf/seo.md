...
ترتيب ۾، مھرباني ڪري `i18n.site` `host:` جي قيمت ۾ `.i18n/htm/ol.yml` ۾ تبديل ڪريو، گھڻن آبجیکٹ اسٽورن کي `s3` ھيٺان ترتيب ڏئي سگھجي ٿو، ۽ `region` فيلڊ اختياري آھي (ڪيترائي اعتراض اسٽورن کي ھن فيلڊ کي سيٽ ڪرڻ جي ضرورت نه آھي).

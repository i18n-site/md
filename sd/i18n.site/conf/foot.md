...
اڃا تائين ڊيمو پروجيڪٽ کي مثال طور وٺي رهيو آهي، `md` ڊاريڪٽري ۾ `.i18n/htm/foot.pug` ويب سائيٽ جي فوٽر کي بيان ڪري ٿو.
...
توھان `js` ۾ `foot.pug` لکي نٿا سگھو. جيڪڏھن رابطي جي ضرورت آھي، مھرباني ڪري ويب جزو کي ترتيب ڏيو.

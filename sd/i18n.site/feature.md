...
پروگرام ۾ بلٽ `i18` ترجمو آهي، مهرباني ڪري ڏسو [➔ `i18`](/i18) مخصوص استعمال لاءِ.
...
اصول آهي: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) مدد سان درخواست کي روڪيو، جيڪڏهن درخواست ناڪام ٿئي ٿي، ان کي ٻيهر ڪوشش ڪريو `CDN` ، ۽ تيز ترين جواب ڏيڻ واري اصلي اسٽيشن کي ڊفالٽ لوڊ ڪرڻ جو ذريعو طور تي فعال ڪريو.
...
ويب سائيٽ هڪ واحد صفحي جي ايپليڪيشن آرڪيٽيڪچر کي اختيار ڪري ٿي، بغير ڪنهن ريفريش جي جڏهن صفحا مٽائيندي ۽ انتهائي تيز لوڊشيڊنگ.
...
> اهو غير ضروري سجاڳي کي ڇڏي ٿو ۽ مواد کي پنهنجي خالص شڪل ۾ پيش ڪري ٿو.
...
ڊفالٽ طور، [Alimama dual-axis variable مستطيل فونٽس](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) ۽ ٻيا آن لائن فونٽس ويب پيج تي فعال ڪيا ويا آھن مختلف پليٽ فارمن تي استعمال ڪندڙن جي پڙھڻ جي تجربي کي متحد ڪرڻ لاءِ.

ساڳئي وقت، لوڊشيڊنگ جي رفتار کي بهتر ڪرڻ لاء، فونٽ لفظ جي تعدد جي انگن اکرن جي مطابق سلائي رهيا آهن.
...
پنھنجي ماؤس کي ھور ڪريو بٽڻ تي مٿي نيويگيشن جي ساڄي پاسي کان ٿڌو خاص اثر ڏسڻ لاءِ.

### ننڍڙو `404`

صفحي تي ھڪڙو پيارو ننڍڙو سچل بھوت `404` ، ان جون اکيون مائوس سان ھلنديون، [➔ ڏسڻ لاءِ ھتي ڪلڪ ڪريو](/404) ،

## ڪوڊ اوپن سورس

[ڪوڊ کليل ذريعو آهي](/i18n.site/src) جيڪڏهن توهان ترقي ۾ حصو وٺڻ ۾ دلچسپي رکو ٿا، مهرباني ڪري پنهنجو پاڻ کي [ميلنگ لسٽ](//groups.google.com/u/2/g/i18n-site) ۾ متعارف ڪرايو.

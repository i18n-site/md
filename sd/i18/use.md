...
انهن مان، `.i18n/cache/.gitignore` جو مواد هن ريت آهي :
...
هن جو مطلب آهي ته ڊاريڪٽري `.i18n/cache/` ۾ سڀ فائلون (سواء `.i18n/cache/.gitignore` ) نظر انداز ڪيا ويا آهن.

جيڪڏھن توھان جو ورجن ڪنٽرول سافٽ ويئر `git` نه آھي، مھرباني ڪري ھن ترتيب جي مطابق ان کي نظرانداز ڪريو.

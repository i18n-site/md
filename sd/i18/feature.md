...
`i18` عنوان کي سڃاڻي سگھي ٿو `MarkDown` ۾، ۽ خود بخود پھرين اکر کي ڪيپيٽلائيز ڪندو جڏھن ڪنھن ڪيس جي حساس ٻوليءَ ۾ ترجمو ڪيو ويندو.
...
مٿين جو DeepL فرانسيسي ۾ (پڻ صحيح نالن کي ٻيهر لکڻ ۽ odd `... ` شامل ڪرڻ):
...
ڪلائنٽ مڪمل طور تي اوپن سورس آهي، ۽ سرور 90 جو ٪ اوپن سورس آهي [سرچ ڪوڊ ڏسڻ لاءِ هتي ڪلڪ ڪريو](/i18n.site/src) .

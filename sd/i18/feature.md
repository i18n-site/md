...
mixed HTML Markdown جي ترجمي کي سپورٽ ڪري ٿو، `MarkDown` ۾ شامل ڪيل `<pre>` ۽ `<code>` HTML ۾ مواد ترجمو نه ڪيو ويو آهي
...
ترجمي جي تبصرن جي ضرورت آهي ` ``` ` کان پوءِ جي ٻولي، جيئن ته ` ```rust ` :
...
`KISS` ( `Keep It Simple, Stupid` ) اصولي مڃيندڙن جي وچ ۾، ڪاروباري سطح جا حل پيچيده، غير موثر، ۽ استعمال ڪرڻ ڏکيو هجڻ جي مترادف آهن.
...
اسان ترجمي جي ٽيڪنالاجي جي هڪ نئين نسل کي ترقي ڪئي آهي جيڪا روايتي مشين ترجمي جي ماڊلز جي فني فائدن کي ضم ڪري ٿي ۽ ترجمي کي درست، هموار ۽ خوبصورت بنائڻ لاءِ وڏي ٻولي جا ماڊل.

بلائنڊ ٽيسٽ ڏيکاري ٿو ته اسان جي ترجمي جو معيار ساڳيون خدمتن جي مقابلي ۾ تمام گهڻو بهتر آهي.

ساڳئي معيار کي حاصل ڪرڻ لاءِ، گوگل ٽرانسليٽ ۽ `ChatGPT` کي گهربل دستي ترميم جو مقدار `2.67` ڀيرا ۽ `3.15` ڀيرا اسان جي ڀيٽ ۾ آهي.
...
[جي github اختيار ڪرڻ ۽ پاڻمرادو فالو i18n.site لاءِ ھتي ڪلڪ ڪريو](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ۽ **بونس $50 وصول ڪريو** .
...
[HOGO](https://github.com/gohugoio/hugo) هيڊر جي ترتيب کي سپورٽ ڪري ٿو جامد بلاگ، جيڪو صرف ترجمو ڪري ٿو `title` ، `summary` ۽ `description` .
...
متغير نالن جهڙوڪ `${varname}` کي انگريزي ترجمي جي طور تي نه سمجهيو ويندو.
...
فرانسيسي ۾ ترجمو `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` ويو :

`Falcon` ترجمو ڪيو ويو آهي `faucon` ۽ `Llama` جو ترجمو `lama` طور ڪيو ويو آهي. مناسب اسم جي طور تي، انهن جو ترجمو نه ڪيو وڃي.
...
مٿين جو ترجمو DeepL ۾ (پڻ صحيح نالا لکڻ ۽ odd `... ` شامل ڪرڻ):
...
صرف ان صورت ۾ جڏهن انگريزي لفظ ۽ چيني، جاپاني ۽ ڪورين متن جي وچ ۾ فاصلو هجي يا انگريزي جي ڊيگهه 1 کان وڌيڪ هجي، لفظ کي اصطلاح طور سمجهيو ويندو.
...
ڪلائنٽ مڪمل طور تي اوپن سورس آهي 90 ۽ سرور جو % آهي اوپن سورس [ڪوڊ ڏسڻ لاءِ هتي ڪلڪ ڪريو](/i18n.site/src) .

...
## <a rel=id href="#project" id="project"></a> منصوبي جي وضاحت
...
ترجمو `Markdown` ۽ `YAML` هڪ ڪمان لائن ٽول ۾ ( [ذريعو ڪوڊ](https://github.com/i18n-site/rust/tree/main/i18) ) ڪيترن ئي ٻولين ۾.

مڪمل طور تي فارميٽ کي برقرار رکي سگھي ٿو `Markdown` فائل جي تبديلين کي سڃاڻي سگھي ٿو ۽ صرف تبديل ٿيل فائلن کي ترجمو ڪري سگھي ٿو.
...
اسان شيئر ڪريون ٿا هر شي `UNIX` " هڪ " آهي ۽ سوين ٻولين ۾ ترجمي کي منظم ڪري سگھون ٿا بغير پيچيده ۽ منجهيل انٽرپرائز-سطح حل متعارف ڪرائڻ جي.

توھان ترجمي کي `Markdown` لاءِ سڀ کان وڌيڪ واقف اوزار استعمال ڪري سگھو ٿا (پر توھان پيراگراف شامل يا ختم نٿا ڪري سگھو)، ۽ ورجن ڪنٽرول ڪرڻ لاءِ سڀ کان واقف طريقو استعمال ڪريو.

هڪ ڪوڊ بيس ٻولي فائلن لاءِ اوپن سورس طور ٺاهي سگهجي ٿو، ۽ `Pull Request` عمل جي مدد سان، عالمي استعمال ڪندڙ ترجمي جي مسلسل اصلاح ۾ حصو وٺي سگهن ٿا. بيحد ڪنيڪشن ۽ [github](//github.com) اوپن سورس ڪميونٽيز.

...
سوشل ميڊيا ۽ اي ميل سان، ماڻهو پنهنجي مادري زبان ۾ معلومات جي ذريعن تي ڌيان ڏيڻ جا عادي آهن.
...
اسان رڪنيت حاصل ڪريون ٿا `UNIX` جي " هر شي هڪ " آهي ۽ سوين ٻولين ۾ ترجمي کي منظم ڪري سگھون ٿا بغير پيچيده ۽ منجهيل انٽرپرائز-سطح حلن کي متعارف ڪرائڻ.
...
اسان ترجمي جي ٽيڪنالاجي جي هڪ نئين نسل کي ترقي ڪئي آهي جيڪا روايتي مشين ترجمي جي ماڊلز ۽ وڏي ٻوليءَ جي ماڊلز جي فني فائدن کي ضم ڪري ٿي ترجمي کي درست، هموار ۽ خوبصورت بنائڻ لاءِ.
...
#### <a rel=id href="#price" id="price"></a> تمام مقابلي واري قيمت
...
[جي github اختيار ڪرڻ ۽ i18n.site فالو ڪرڻ لاءِ ھتي ڪلڪ ڪريو](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ۽ **بونس $50 وصول ڪريو** .
...
هي ويب سائيٽ هن فريم ورڪ جي بنياد تي ٺاهي وئي آهي ۽ صارف، ادائگي ۽ ٻيا ڪم شامل آهن ( [ذريعو ڪوڊ](/i18n.site/src) ).

[→ يوزر گائيڊ لاءِ، مھرباني ڪري پڙھو پروجيڪٽ جا دستاويز](/i18n.site) .

## رابطي ۾ رهجو

مھرباني ڪري <button onclick="mailsub()">ھن اي ميل تي ڪلڪ ڪريو پراڊڪٽ اپڊيٽ جي رڪنيت حاصل ڪرڻ</button> ۽ <button onclick="webpush()">برائوزر پش کي فعال ڪرڻ لاءِ</button> اسان توھان کي مطلع ڪنداسين جڏھن پراڊڪٽس کي اپڊيٽ ڪيو ويندو.
...
اسان ٻولي جي اڪيلائي کان سواءِ انٽرنيٽ ٺاهڻ چاهيون ٿا.

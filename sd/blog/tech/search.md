...
هي آرٽيڪل `i18n.site` خالص فرنٽ-اينڊ مڪمل-ٽيڪسٽ سرچ ٽيڪنالاجي جو دورو ڪندو [i18n.site](//i18n.site) توهان ڳولي سگهو ٿا.

ڪوڊ اوپن سورس [سرچ](//github.com/i18n-site/ie/tree/main/qy) [ڪنيل](//github.com/i18n-site/plugin/tree/main/qy) /

## سرور جي بغير مڪمل ٽيڪسٽ ڳولا حل جو هڪ جائزو

ننڍين ويب سائيٽن لاءِ جيئن ته دستاويز/ذاتي بلاگ جيڪي خالص جامد آهن، اهو بلاشڪ تمام ڳرو آهي ته پنهنجي طرفان مڪمل ٽيڪسٽ سرچ پسمنظر ٺاهي، ۽ مڪمل متن جي ڳولا بغير خدمتن جي بلاشڪ هڪ بهتر وزن آهي.

موجوده سرور کان سواءِ مڪمل متن جي ڳولا جا حل ٻن وسيع ڀاڱن ۾ اچي وڃن ٿا.

ھڪڙي ھڪڙي ٽئين پارٽي جي ڳولا جي خدمت مهيا ڪندڙ آھي جھڙوڪ [algolia.com](//algolia.com) جيڪو مهيا ڪري ٿو فرنٽ-اينڊ مڪمل-ٽيڪسٽ ڳولا اجزاء.

اهڙيون خدمتون ادائگي جي ضرورت هونديون آهن ۽ ويب سائيٽ جي تعميل جي مسئلن جي ڪري سرزمين چين ۾ صارفين لاء دستياب ناهي.

اهو آف لائن استعمال نٿو ڪري سگھجي، انٽرنيٽ تي استعمال نٿو ڪري سگھجي، ۽ وڏيون حدون آھن. هي مضمون گهڻو بحث نٿو ڪري.

ٻيو خالص سامهون-آخر مڪمل متن جي ڳولا آهي.

وڌيڪ مشهور خالص فرنٽ-اينڊ مڪمل-ٽيڪسٽ ڳولها شامل آهن [lunrjs](https://lunrjs.com) [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) .

`lunrjs` انڊيڪس ٺاهڻ جا ٻه طريقا آهن، پر ٻنهي جا پنهنجا مسئلا آهن.

1. اڳ ۾ ٺهيل انڊيڪس فائلون

   ڇاڪاڻ ته انڊيڪس سڀني دستاويزن مان لفظن تي مشتمل آهي، اهو سائيز ۾ وڏو آهي.
   جڏهن به هڪ دستاويز شامل ڪيو وڃي يا تبديل ڪيو وڃي، هڪ نئين انڊيڪس فائل کي لوڊ ڪيو وڃي.
   اهو صارف جي انتظار جو وقت وڌائيندو ۽ تمام گهڻو بينڊوڊٿ استعمال ڪندو.

2. دستاويز لوڊ ڪريو ۽ اڏام تي انڊيڪس ٺاهيو

   انڊيڪس ٺاھڻ ھڪ ڪمپيوٽيشنل گھڻائي وارو ڪم آھي انڊيڪس کي ٻيهر ٺاھڻ ھر وقت توھان ان کي پھچائڻ ۾ واضح دير ۽ خراب استعمال ڪندڙ تجربو جو سبب بڻجندو.

`lunrjs` کان علاوه، ڪجھ ٻيا مڪمل-ٽيڪسٽ سرچ حل آھن، جھڙوڪ :

[fusejs](https://www.fusejs.io) ، ڳولهڻ لاءِ تارن جي وچ ۾ هڪجهڙائي جو اندازو لڳايو.

هن حل جي ڪارڪردگي انتهائي خراب آهي ۽ مڪمل متن جي ڳولا لاءِ استعمال نه ٿي ڪري سگھجي (ڏسو [Fuse.js ڊگهو سوال 10 سيڪنڊن کان وڌيڪ وٺندو آهي، ان کي ڪيئن بهتر ڪجي؟](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

[TinySearch](https://github.com/tinysearch/tinysearch) ، استعمال ڪريو بلوم فلٽر ڳولا لاءِ، استعمال نه ٿو ڪري سگھجي اڳياڙي ڳولھا لاءِ (مثال طور، داخل ڪريو `goo` ، ڳولا `good` ، `google` )، ۽ ساڳيو خودڪار مڪمل اثر حاصل نٿو ڪري سگھي.

موجوده حلن جي گهٽتائي سان عدم اطمينان جي ڪري، `i18n.site` هڪ نئون خالص فرنٽ-اينڊ مڪمل ٽيڪسٽ سرچ حل تيار ڪيو، جنهن ۾ هيٺيون خاصيتون آهن :
...
1. اڳوڻي ڳولا کي سپورٽ ڪري ٿو، جيڪو حقيقي وقت ۾ ڳولا جا نتيجا ڏيکاري ٿو جڏهن صارف ٽائپ ڪري رهيو آهي.
1. آف لائن دستياب

هيٺ، `i18n.site` ٽيڪنيڪل عمل درآمد تفصيل سان متعارف ڪرايو ويندو.

## گھڻ لساني لفظن جي ورهاست
...
* `docWord` : دستاويز جو صفحو id - لفظ id
* `prefix` : اڳڪٿي جو سلسلو - لفظ id
* `rindex` : لفظ id - دستاويز id : لائن نمبرن جو صفحو
...
هن طريقي سان، وڌندڙ انڊيڪسنگ حاصل ڪري سگھجي ٿو ۽ حساب جي رقم گھٽجي ويندي آهي.

فرنٽ-اينڊ رابطي ۾، انڊيڪس لوڊنگ پروگریس بار کي ڏيکاري سگھجي ٿو دير کان بچڻ لاءِ جڏهن پهريون ڀيرو لوڊ ٿي رهيو آهي ته ڏسو "پراگريس بار سان اينيميشن، بيسڊ آن اي سنگل progress + خالص css نفاذ" [انگريزي](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [چيني](https://juejin.cn/post/7413586285954154522) .

### IndexedDB اعلي سمورو لکڻ

پروجيڪٽ جي بنياد تي [idb](https://www.npmjs.com/package/idb) آهي asynchronous encapsulation of IndexedDB
...
ڳولا جا نتيجا ڏيکاريا ويا پهريان سوال جي درستگي کي يقيني بڻائيندا آهن، ۽ نتيجن کي بعد ۾ لوڊ ڪيو ويندو آهي (لوڊ وڌيڪ بٽڻ تي ڪلڪ ڪريو) ياداشت جي شرح کي يقيني بڻائي.
...
انڊيڪس ٽيبل اصل متن کي ذخيرو نٿو ڪري، صرف لفظن، جيڪو ذخيرو جي مقدار کي گھٽائي ٿو.
...
مڪمل متن جي ڳولها مڪمل طور تي اڳئين آخر تي لاڳو ڪئي وئي آهي، تيز جواب سان ۽ سرور جي ضرورت ناهي.

اهو ننڍڙو ۽ وچولي سائيز جي ويب سائيٽن جهڙوڪ دستاويزن ۽ ذاتي بلاگن لاء تمام مناسب آهي.
...
ოფიციალური გამოშვებისთვის, შეცვლილი ფაილები დაკოპირდება ახალი ვერსიის ნომრის დირექტორიაში.
...
შეცვალეთ `md/.i18n/htm/ol.yml` და შეცვალეთ მნიშვნელობა [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) როგორც თქვენი საკუთარი `npm` პაკეტის სახელი.

შემდეგ შეცვალეთ `md/.i18n/htm/ol.package.json`

გაუშვით `i18n.site --npm` ან `i18n.site -n` `md` დირექტორიაში თარგმნისა და გამოსაქვეყნებლად.

თუ თქვენ იყენებთ უწყვეტი ინტეგრაციის გარემოს გამოქვეყნებისთვის, არ არის საჭირო `nodejs` ინსტალაცია, უბრალოდ დააკოპირეთ სისტემაში შესული და გამოქვეყნების ნებართვა `~/.npmrc` გარემოში.

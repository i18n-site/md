...
პროგრამას აქვს `i18` თარგმანი, იხილეთ [➔ `i18`](/i18) კონკრეტული გამოყენებისთვის.

## Ბრაუზერის Ენის Ავტომატური Შედარება

ვებსაიტის ნაგულისხმევი ენა ავტომატურად ემთხვევა ბრაუზერის ენას.

მას შემდეგ რაც მომხმარებელი ხელით გადართავს ენებს, მომხმარებლის არჩევანი დაიმახსოვრდება.
...
## <a rel=id href="#ha" id="ha"></a> წინა ნაწილის მაღალი ხელმისაწვდომობა

`i18n.site` , საიტის შიგთავსი გამოქვეყნდება `npmjs.com` , [unpkg.com](//unpkg.com) და მრავალჯერადი `CDN` ში ჩატვირთული `npm` [jsdelivr.com](//jsdelivr.com)
...
პრინციპი ასეთია: მოთხოვნის ჩაჭრა [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) -ის დახმარებით, თუ მოთხოვნა ვერ მოხერხდა, ხელახლა სცადეთ იგი სხვა `CDN` -ზე და ადაპტირებულად ჩართეთ ყველაზე სწრაფად რეაგირებადი საწყისი სადგური, როგორც ნაგულისხმევი ჩატვირთვის წყარო.
...
## Ოპტიმიზებულია Კითხვის Გამოცდილებისთვის

### Კარგად Შემუშავებული Სტილი

> სიმარტივის სილამაზე შესანიშნავად არის ინტერპრეტირებული ამ ვებ-გვერდის დიზაინში.
> ის უარს ამბობს არასაჭირო დეკორაციებზე და ასახავს შინაარსს სუფთა სახით.
...
ნაგულისხმევად, [Alimama ორღერძიანი ცვლადი მართკუთხა შრიფტები](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/)
...
`404` არის საყვარელი პატარა მცურავი მოჩვენება, მისი თვალები მაუსის საშუალებით მოძრაობს, [➔ დააწკაპუნეთ აქ სანახავად](/404) ,

## Კოდი Ღია Წყარო

[კოდი არის ღია კოდის წყარო](/i18n.site/src) [.](//groups.google.com/u/2/g/i18n-site)

არსებობს ბევრი მცირე მოთხოვნა, რომელიც მნიშვნელოვანია, მაგრამ არა გადაუდებელი, დეველოპერული გუნდი დანიშნავს პრაქტიკულ დავალებებს იმ ტექნოლოგიის მიხედვით, რომლითაც კარგად ხართ და გააუმჯობესებს განვითარების დოკუმენტებს მოთხოვნების მინიჭებისას.

...
`i18n.site` გამოაქვეყნებს საიტის შინაარსს `npmjs.com` , , [unpkg.com](//unpkg.com) და `npm` -ზე ჩატვირთული სხვა `CDN` კონტენტის [jsdelivr.com](//jsdelivr.com) .
...
პრინციპი ასეთია: მოთხოვნის ჩარევა [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) ით, ხელახლა სცადეთ წარუმატებელი მოთხოვნები სხვა `CDN` და ადაპტაციურად ჩართეთ ყველაზე სწრაფად რეაგირებადი საწყისი საიტი, როგორც ნაგულისხმევი ჩატვირთვის წყარო.

...
### `use: Toc` , Ერთი Ფაილის Შაბლონი Მონახაზით
...
### `use: Md` , Ერთი Ფაილის Შაბლონი Მონახაზის Გარეშე
...
### `use: Doc` , Მრავალფაილიანი Დოკუმენტის Შაბლონი
...
ზემოაღნიშნული ჩაწერის მეთოდი უდრის `url: xxx` ს, ხოლო მისი შესაბამისი ფაილი არის `en/xxx/TOC` .

#### TOC Სარჩევის Ინდექსი

`i18n.site` შეასრულებს `js` დანამატს `.i18n/hook/after.tran/TOC.js` დემო საწყობში, რათა წაიკითხოს `TOC` დირექტორიის ინდექსის ფაილი, რომელიც შეესაბამება `doc` შაბლონის კონფიგურაციას, რათა გამოიმუშაოს `json` კატალოგის მონახაზი.
...
##### Გამოიყენეთ Ჩაღრმავება Დონეების Მითითებისთვის

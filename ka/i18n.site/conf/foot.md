...
ქვედა კოლონტიტულის ხატულა იქმნება შრიფტის შექმნით `F` iconfont.cn [ინგლისური ვერსია](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
ბმულზე `class="a"` დამატება არის ბმულის `MarkDown` ად გადაქცევის თავიდან აცილება. იხილეთ :
 [➔ `YAML` როგორ ავიცილოთ : ბმული `HTML` `Markdown` -ზე გადაქცევა](/i18/qa#H2) .
...
### `cloudflare R2` Წვდომა Შეუძლებელია Მორგებული Დომენის Სახელით

იმის გამო, რომ `R2` `cloudflare` არის წვდომა მორგებული დომენის სახელით, მესამე მხარის ობიექტების საცავი უნდა იქნას გამოყენებული სტატიკური ფაილების განსათავსებლად.

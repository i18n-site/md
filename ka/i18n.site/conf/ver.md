...
დემო პროექტში, `en/demo2/v` გარდა, ასევე შეგიძლიათ ნახოთ, რომ `en/blog` და `en/demo1` დირექტორიაში არის `v` ცარიელი ფაილი.
...
მაგალითად, ინდექსის ფაილი, რომელიც შეესაბამება `blog` დემო პროექტში არის [https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) :
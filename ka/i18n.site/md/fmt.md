...
## Სურათები/Ვიდეოები/Ბმულები Მრავალ Ენაზე

მას შემდეგ, რაც `MarkDown` გარდაიქმნება `HTML` -ზე, `$LANG` ატრიბუტებში `src` და `href` შეიცვლება მიმდინარე [ენის კოდით](/i18/LANG_CODE) .

ამ ცვლადით შეგიძლიათ მიაღწიოთ სურათების/ვიდეოების/ბმულების მრავალენოვნებას.
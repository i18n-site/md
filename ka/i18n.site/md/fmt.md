...
`i18n.site` -ზე შეთანხმებული ანკერის წერტილის გადაწყვეტა არის `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` ში მსგავსი ტექსტის ჩასმა, რათა ხელით შექმნათ პოზიციონირების წამყვანი წერტილი.

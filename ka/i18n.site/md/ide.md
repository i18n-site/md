...
ჩვენ [vscode](https://code.visualstudio.com/) `MarkDown` დასაწერად და ასევე დააინსტალირეთ დანამატი [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) რეალურ დროში გადახედვისთვის.

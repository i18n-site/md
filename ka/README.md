...
## <a rel=id href="#project" id="project"></a> პროექტის აღწერა
...
თარგმნეთ `Markdown` და `YAML` ბრძანების სტრიქონში ( [წყაროს კოდი](https://github.com/i18n-site/rust/tree/main/i18) ) მრავალ ენაზე.
...
ჩვენ ვიზიარებთ ყველაფერი არის ფაილი " `UNIX` " და შეგვიძლია ვმართოთ თარგმანები ასობით ენაზე რთული და შრომატევადი საწარმოს დონის გადაწყვეტილებების დანერგვის გარეშე.

თქვენ შეგიძლიათ გამოიყენოთ ყველაზე ნაცნობი ხელსაწყოები თარგმანის `Markdown` (მაგრამ თქვენ არ შეგიძლიათ აბზაცების დამატება ან წაშლა) და გამოიყენოთ ყველაზე ნაცნობი გზა ვერსიის კონტროლისთვის.

კოდის ბაზა შეიძლება შეიქმნას, როგორც ენობრივი ფაილების ღია წყარო და `Pull Request` -ის პროცესის დახმარებით, გლობალურ მომხმარებლებს შეუძლიათ მონაწილეობა მიიღონ თარგმანის უწყვეტ ოპტიმიზაციაში. უწყვეტი კავშირი [github](//github.com) სხვა ღია წყაროების თემები.

[→ მომხმარებლის სახელმძღვანელოსთვის, გთხოვთ, წაიკითხოთ პროექტის დოკუმენტაცია](/i18) .
...
წმინდა სტატიკური, ოპტიმიზირებულია კითხვის გამოცდილებისთვის და ინტეგრირებული [i18](#i18) ეს საუკეთესო არჩევანია პროექტის დოკუმენტის საიტის შესაქმნელად.
...
ეს ვებსაიტი შემუშავებულია ამ ჩარჩოს საფუძველზე და მოიცავს მომხმარებლის, გადახდის და სხვა ფუნქციებს ( [საწყისი კოდი](/i18n.site/src) ) მოგვიანებით დაიწერება.

[→ მომხმარებლის სახელმძღვანელოსთვის, გთხოვთ, წაიკითხოთ პროექტის დოკუმენტაცია](/i18n.site) .

...
სამეცნიერო ფანტასტიკური რომანი &quot;სამი სხეული&quot; (ჩინური გამოთქმა: `3Ti` ) ასახავს უცხო ცივილიზაციას, რომელიც იყენებს ელექტრომაგნიტურ ტალღებს კომუნიკაციისთვის, გამჭვირვალე აზროვნებითა და წარმატებული მეცნიერებითა და ტექნოლოგიებით.

ბიბლია · დაბადება :

> იმ ეპოქაში ცის ქვეშ მყოფთა ხმები და სიტყვები ერთი იყო.
>
> მათ ააშენეს კოშკი, რომელიც მაღლა სწვდებოდა, ეხებოდა ღვთის კარიბჭეს, აერთიანებდა გულებს და ამაყობდა მათი დიდებით.
>
> უფალმა გამოაცხადა: როდესაც ხალხი იზიარებს ენას და საგვარეულოს, ისინი იქცევიან ცალკეულ ტომად. კოშკი მხოლოდ დასაწყისია; უახლოეს დღეებში ისინი ვერაფერს მიაღწევენ.
>
> ამრიგად, ის ჩამოვიდა, რამაც გამოიწვია ხალხის გაფანტვა შორს და ფართოდ, მათი ენები ახლა გაუგებარია ერთმანეთისთვის.
>
> მას შემდეგ ჩხუბი დაუსრულებელი იყო და სამყაროს აღარ უნახავს კოშკები, რომლებიც ცას ეხებოდა.

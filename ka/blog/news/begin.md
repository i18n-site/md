...
თარგმანის რედაქტირება შესაძლებელია ორიგინალური ტექსტის შეცვლა, და როდესაც ის ხელახლა ითარგმნება, თარგმანის მექანიკური ცვლილებები არ გადაიწერება (თუ ორიგინალური ტექსტის ეს პუნქტი არ არის შეცვლილი).

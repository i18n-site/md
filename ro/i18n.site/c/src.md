...
* Nu este nevoie să împachetați biblioteci front- / referite direct [github](https://github.com/i18n-site/x) [atomgit](https://atomgit.com/i18n/x)
  Este convenabil să citați direct în scriptul de inițializare markdown și să îl utilizați în site-ul web ambalat în același timp, pentru a evita duplicarea codului.

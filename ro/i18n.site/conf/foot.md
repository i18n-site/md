...
Pictograma subsol este generată prin crearea unui font numit iconfont.cn ( [versiunea în engleză](https://www.iconfont.cn/?lang=en-us) `F` /[版](https://www.iconfont.cn/?lang=zh)!).
...
Adăugarea `class="a"` la link înseamnă a preveni convertirea linkului la `MarkDown` Vezi :

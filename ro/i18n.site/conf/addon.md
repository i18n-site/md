...
* `i18n.addon/toc` : Indexul directorului
  Generați index de director de `json` pe baza `TOC` , activat în mod implicit
...
Linia de comandă de traducere `i18n.site` va instala fișierul convențional al pachetului de plug-in și apoi îl va executa.

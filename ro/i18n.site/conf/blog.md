...
Un fișier demonstrativ este configurat după cum urmează:
...
Dacă trebuie să fixați articolul în partea de sus, rulați `i18n.site` și editați cele `xxx.yml` fișiere de sub `.i18n/data/blog` și schimbați marcajul temporal la un număr negativ (mai multe numere negative vor fi sortate de la mic la mare în valoare absolută).
...
Folosim [vscode](https://code.visualstudio.com/) pentru a scrie `MarkDown` și, de asemenea, instalăm plug-in-ul [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) pentru a previzualiza în timp real în timp ce scriem.

...
Cod : deschisă [Căutare nucleu](//github.com/i18n-site/ie/tree/main/qy) / [Interfață interactivă](//github.com/i18n-site/plugin/tree/main/qy)

## O Prezentare Generală a Soluțiilor De Căutare Full-Text Fără Server
...
În interacțiunea front-end, bara de progres de încărcare a indexului poate fi afișată pentru a evita întârzierea la încărcare pentru prima dată. Consultați „Bara de progres cu animație, bazată pe o progress + implementare css pură” [Engleză](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [Chineză](//juejin.cn/post/7413586285954154522) .

...
| număr de serie | cod | limba | Numele de afișare |
| - | - | - | - |
| 0 | `en` | Engleză | `English` |
| 1 | `zh` | Chineză simplificată | `简体中文` |
| 2 | `de` | limba germana | `Deutsch` |
| 3 | `fr` | limba franceza | `Français` |
| 4 | `es` | Spaniolă | `Español` |
| 5 | `it` | Italiană | `Italiano` |
| 6 | `ja` | japonez | `日本語` |
| 7 | `pl` | Lustrui | `Polski` |
...
| 33 | `el` | greacă | `Ελληνικά` |
| 34 | `et` | estonă | `Eesti` |
| 35 | `bg` | bulgară | `Български` |

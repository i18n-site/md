...
## <a rel=id href="#project" id="project"></a> descrierea proiectului

Acest site oferă în prezent două instrumente de linie de comandă open source:

* [Instrument de traducere i18 : MarkDown linia de comandă](/i18/feature)
...
Traduceți `Markdown` și `YAML` într-un instrument de linie de comandă ( [codul sursă](https://github.com/i18n-site/rust/tree/main/i18) ) în mai multe limbi.

Poate menține perfect formatul de `Markdown` Poate identifica modificările fișierelor și poate traduce numai fișierele modificate.
...
Împărtășim `UNIX` " is a File " și putem gestiona traduceri în sute de limbi fără a introduce soluții complexe și greoaie la nivel de întreprindere.

Puteți folosi cele mai familiare instrumente pentru `Markdown` traducerea (dar nu puteți adăuga sau șterge paragrafe) și utilizați cel mai familiar mod de a controla versiunile.

O bază de cod poate fi creată ca sursă deschisă pentru fișierele de limbă și, cu ajutorul procesului `Pull Request` , utilizatorii globali pot participa la optimizarea continuă a traducerilor. Conexiune fără [github](//github.com) și alte comunități open source.
...
Pur static, optimizat pentru experiența de citire și integrat cu traducerea lui [i18](#i18) este cea mai bună alegere pentru construirea unui site de documente de proiect.
...
Acest site web este dezvoltat pe baza acestui cadru și include funcții de utilizator, de plată și alte funcții ( [codul sursă](/i18n.site/src) ). Un tutorial detaliat va fi scris ulterior.

[→ Pentru ghidul utilizatorului, vă rugăm să citiți documentația proiectului](/i18n.site) .
...
>
> Apoi a venit, făcându-i pe ființele umane incapabile să-și înțeleagă limba altora și dispersate în diferite locuri.

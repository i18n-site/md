...
La traduction est modifiable ; modifiez le texte original, et lorsqu'elle sera à nouveau traduite automatiquement, les modifications manuelles de la traduction ne seront pas écrasées (si ce paragraphe du texte original n'a pas été modifié).

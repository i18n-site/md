...
Il vous permet de créer rapidement des documents et des blogs internationaux prenant en charge [des centaines de langues](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

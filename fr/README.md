...
Une base de code peut être créée en open source pour les fichiers de langue, et avec l'aide de `Pull Request` processus, les utilisateurs mondiaux peuvent participer à l'optimisation continue des traductions. Connexion transparente [github](//github.com) Et d'autres communautés open source.

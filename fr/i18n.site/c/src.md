...
* Bibliothèque [atomgit](https://atomgit.com/i18n/lib) base universelle [github](https://github.com/i18n-site/lib) /
* Bibliothèque de base du navigateur [github](https://github.com/i18n-site/ie) / [atomgit](https://atomgit.com/i18n/ie)
* [atomgit](https://atomgit.com/i18n/x) besoin de packager / bibliothèques frontales directement référencées [github](https://github.com/i18n-site/x)

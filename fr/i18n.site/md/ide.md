...
Nous utilisons [vscode](https://code.visualstudio.com/) pour écrire `MarkDown` , et installons également le plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) pour prévisualiser en temps réel lors de l'écriture.
...
Il prend en charge la copie automatique du nom de fichier au format `Markdown` après le téléchargement, ce qui améliore considérablement l'efficacité.

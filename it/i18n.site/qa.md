...
Poi segui il seguente `bash` per creare il file.
...
Nota che riparare in questo modo comporterà la perdita della cronologia dei file, rendendo impossibile un aggiornamento incrementale nella prossima release e facendo sì che tutto il contenuto venga ricompresso e caricato di nuovo.
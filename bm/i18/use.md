...
Nin labɛncogo-tabali in kɔnɔ, katalogu `blog` bamanankan bamanankan bɔyɔrɔkan ye `zh` ye, `blog/your_file_name.md` bamanankan bamanankan bɔyɔrɔkan ye `ja` ye.

### Ignorer Filen

O cogo la, dosiye minnu bɛ daminɛ ni `.md` ni `.yml` minnu bɛ sɔrɔyɔrɔkan ɲɛbilasɛbɛn kɔnɔ, olu bɛɛ bɛna baara kɛ.

N’i b’a fɛ ka dosiye dɔw jate Minɛ k’u t’u baara (i n’a fɔ sɛbɛnfura dafabaliw), i bɛ Se k’a Labɛn ni `ignore` foro ye.

`ignore` bɛ baara kɛ [globset](https://docs.rs/globset/latest/globset/#syntax) `.gitignore`

Misali la, `_* ` min bɛ sanfɛ-labɛn-dosiyɛri kɔnɔ, o kɔrɔ ye ko dosiye minnu bɛ daminɛ ni `_` , olu tɛna baara kɛ.
...
* A kɔlɔsi ko filen tɔgɔ kɔfɛta ka kan ka kɛ `.yml` (a tɛ kɛ `.yaml` ).
...
bɛna baara kɛ ni `i18n/zh/i18n.yml`

...
Karta min bɛ bamanankan baarakɛcogo ni sɛbɛnni fɔlɔ cɛ, o sirilen bɛ token `.i18h/hash` , Token kura dabɔ [i18n.site/token](//i18n.site/token)

## `YAML` : `HTML` `Markdown`

Nafa min ye `YAML` ye, o bɛ jate `MarkDown` ye bamanankan baarakɛcogo la.

Tuma dɔw la, jiginni ka Bɔ `HTML` → `MarkDown` la, o tɛ an sago ye, i n’a fɔ `<a href="/">Home</a>` bɛ Yɛlɛma ka Kɛ `[Home](/)` ye.

Ni i ye fɛn o fɛn Fàra `a` taamaʃyɛn kan n’o tɛ `href` ye, i n’a fɔ `<a class="A" href="/">Home</a>` , o bɛ Se k’i yɛrɛ Kɔrɔbɔ o 'kɔnɔnafili in na.

## `./i18n/hash` File Bɛ Ɲɔgɔn Sɔsɔ Jukɔrɔ

Filenw minnu bɛ ɲɔgɔn sɔsɔ, olu bɔ yen ka `i18` bamanankan baara kɛ kokura.
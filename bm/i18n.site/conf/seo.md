...
### Domani Tɔgɔ Bɛ Jate `DNS` Wɛrɛw La, Baara Kɛcogo `cloudflare`
...
Domɛni tɔgɔ Changer ka bɔ `CNAME` ka kɛ `f003.backblazeb2.com` `cloudflare` la ani ka proxy (proxy) daminɛ.

![](//p.3ti.site/1725440896.avif)

Yɛlɛma `cloudflare` la `SSL` la → kodɔncogo, min bɛ bila `Full` la

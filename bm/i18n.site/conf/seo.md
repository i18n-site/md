...
Ɲɛ jɔlenw kan, baara kɛ ni `link` ye walasa ka jɛgɛnsira jira minnu bɛ nin ɲɛ in kan suguya wɛrɛw la, i n’a fɔ :
...
Labɛnni na, aw bɛ `i18n.site` Changer ka kɛ `host:` nafa ye `.i18n/htm/ol.yml` kɔnɔ, fɛn caman marayɔrɔw bɛ se ka labɛn `s3` jukɔrɔ, wa `region` foro ye ŋaniyata ye (fɛn marayɔrɔ caman mago tɛ ka nin foro in sigi).
...
Aw ye sira tigɛcogo sariyaw sigi nin cogo la, aw bɛ kode "i18n.site" sɛmɛntiya ka kɛɲɛ ni aw ka domani tɔgɔ ye
...
Ni aw mago bɛ ka baara kɛ Sinuwa jamanaba ye, aw bɛ se ka baara kɛ ni [Baidu Smart Cloud ye](//cloud.baidu.com) .
...
Misali `cloudflare` , [Huawei Cloud DNS](https://www.huaweicloud.com)
...
Ikomi `R2` `cloudflare` ka sɔrɔ ni domani tɔgɔ ye min bɛ kɛ ka kɛɲɛ ni mɔgɔw sago ye, fɛn marayɔrɔ sabanan ka kan ka kɛ ka dosiye jɔlenw bila.

`cloudflare` an bɛ [backblaze.com](https://www.backblaze.com)
...
Domɛni tɔgɔ Changer ka Bɔ `CNAME` ka Kɛ `f003.backblazeb2.com` ye `cloudflare` la ani ka proxy (proxy) Dabɔ.
...
Aw bɛ fɛn caman tigɛli sariya fara a kan i n’a fɔ a jiralen bɛ cogo min na jukɔrɔ, aw k’a bila fɔlɔ (fɔlɔ de fɔlɔ ka dɔgɔ):
...
Ka fara o kan, `cloudflare` jiginni sariya min bɛ sanfɛ, `index.html` bɛ Changé ka kɛ `file/your_bucketname/index.html` , wa sigicogo wɛrɛw bɛ to o cogo kelen na.

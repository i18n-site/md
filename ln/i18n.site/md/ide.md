...
Tosalelaka [vscode](https://code.visualstudio.com/) pona kokoma `MarkDown` , pe lisusu ko installer plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) pona ko aperçu na temps réel tango ya kokoma.

...
Na configuration, svp changer `i18n.site` na valeur ya `host:` na `.i18n/htm/ol.yml` , ba magasins ya objet ebele ekoki ko configurer na se `s3` , pe champ `region` ezali optionnel (ba magasins ya objet mingi esengeli te ko setting champ oyo).
...
Na sima sala script na [EdgeJS ya bord](//console.bce.baidu.com/cdn/#/cdn/ejs/list) ndenge elandi
...
Lokola `R2` ekoki kozwama `cloudflare` na nkombo ya domaine oyo ebongisami, esengeli kosalela ebombelo ya biloko ya bato mosusu mpo na kotya ba fichiers statiques.

`cloudflare` tozui [backblaze.com](https://www.backblaze.com)

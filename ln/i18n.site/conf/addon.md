...
* `i18n.addon/mouse` : effets ya soso

## Boyokani Ya Nkombo Ya Fisyé

Plug-ins ezali nionso `npm` paquets.
...
Tango ya kosala `js` oyo etongami na kati esalemi na développement secondaire : [boa](https://github.com/boa-dev/boa)

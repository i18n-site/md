...
### <a rel=id href="#i18" id="i18"></a> i18: Esaleli ya bobongoli ya molongo ya komande MarkDown
...
Base ya code ekoki kosalama lokola source ouverte pona ba fichiers ya langue, pe na aide ya `Pull Request` processus, ba usagers mondiaux bakoki ko participer na optimisation continue ya ba traductions. Connexion sans soudure [github](//github.com) ba communautés misusu ya source ouverte.

[→ Mpo na buku ya mosaleli, tosengi otanga mikanda ya mosala](/i18) .

## Bobongoli Ya Masini Ya Lolenge Malamu Koleka

Tosali génération ya sika ya technologie ya traduction oyo esangisaka ba avantages techniques ya ba modèles traditionnels ya traduction en machine mpe ba modèles ya minoko ya minene mpo na kosala que ba traductions ezala ya sikisiki, ya malamu mpe ya elegan.
...
[Bo finga awa pona ko autoriser pe i18n.site automatiquement github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) pe **kozua bonus $50** .
...
> Balobaki: Yaka, botonga linɔ́ngi oyo ekokóma na likoló mpe bókómisa libota ya bato lokumu.
>
> Yawe amonaki yango mpe alobaki: "Bato nyonso bazali na monoko mpe loposo moko. Sikawa lokola likambo oyo ekokisami, nyonso ekosalema."
>
...
Ezali kopesa maboko na ba commentaires ya minoko mibale mpe ba salles ya kosolola;
Système ya billets multilingue oyo ekoki kofuta ba bounties;

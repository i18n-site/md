<h1 style="display:flex;justify-content:space-between">i18n.site Ba solutions ya mokili mobimba<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Line ya commande Markdown #esaleli ya Yaml , esalisaka yo otonga site ya mikanda ya mokili mobimba, oyo ekosunga [bankama ya minoko](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> Bolimbisi ya mosala
...
Bobongola `Markdown` mpe `YAML` na esaleli ya molongo ya komande ( [code source](https://github.com/i18n-site/rust/tree/main/i18) ) na minoko ebele.

Ekoki ko maintenir parfaitement format ya `Markdown` Ekoki koyeba mbongwana ya ba fichiers mpe kobongola kaka ba fichiers oyo ebongwani.
...
Tozali kokabola " `UNIX` Everything is a File " mpe tokoki ko gérer ba traductions na ba centaines ya minoko sans ko introduire ba solutions complexes mpe ya kilo na niveau ya entreprise.

Okoki kosalela bisaleli oyo oyebi mingi mpo na `Markdown` libongoli (kasi okoki te kobakisa to kolongola baparagrafe), mpe kosalela lolenge oyo oyebi mingi mpo na kosala contrôle ya version.

Base ya code ekoki kosalama lokola source ouverte pona ba fichiers ya langue, pe na aide ya processus ya `Pull Request` 's, ba usagers mondiaux bakoki ko participer na optimisation continue ya ba traductions. Connexion sans soudure [github](//github.com) Na ba communautés misusu ya source ouverte.

[→ Mpo na buku ya mosaleli, tosengi otanga mikanda ya projet](/i18) .

## Libongoli Ya Malamu Mpenza Ya Xindaya
...
Pona kozua qualité `2.67` , quantité ya édition manuelle oyo Google Translate `3.15` `ChatGPT`
...
Purement statique, optimisé pona expérience ya kotanga, pe intégré na traduction ya [i18](#i18) ezali choix ya malamu pona kotonga site ya document ya projet.
...
Site oyo esalemi na nzela ya cadre oyo mpe ezali na mosaleli, kofuta mpe misala misusu ( [code source](/i18n.site/src) ).

[→ Mpo na buku ya mosaleli, tosengi otanga mikanda ya mosala](/i18n.site) .
...
/ [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) malamu pona kolanda ba comptes socials na biso [X.COM: @i18nSite](https://x.com/i18nSite)

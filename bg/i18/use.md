...
## windows Първо Инсталирайте git bash
...
[i18n.site/payBill](//i18n.site/payBill) трябва да обвържете кредитна карта за плащане (не се изисква презареждане, уебсайтът автоматично ще удържи таксите според използването, [вижте началната страница за ценообразуване](/#price) ).
...
Ако искате да игнорирате определени файлове и да не ги превеждате (като недовършени чернови), можете да използвате конфигурацията на полето `ignore` .

...
Редактирайте `md/.i18n/htm/ol.yml` и променете стойността от [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) собствено име на пакет `npm` .

След това променете `md/.i18n/htm/ol.package.json`

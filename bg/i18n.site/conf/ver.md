...
Препоръчва се да се променя само номерът на версията на документа, когато се пускат основни актуализации (като `v1` , `v2` ), за да се избегне твърде много номера на версиите, причиняващи бъркотия в страниците, индексирани от търсачките.

...
Можете да се обърнете към изпълнението в [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) кодът е както следва :
...
## Снимки/Видеоклипове/Линкове На Няколко Езика

След като `MarkDown` се преобразува в `HTML` , `$LANG` в атрибути `src` и `href` ще бъдат заменени с текущия [езиков код](/i18/LANG_CODE) .

С тази променлива можете да постигнете многоезичност на снимки/видеоклипове/връзки.
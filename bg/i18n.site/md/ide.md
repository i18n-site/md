...
Ние използваме [vscode](https://code.visualstudio.com/) write `MarkDown` и също така инсталираме приставката [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) за визуализация в реално време по време на писане.

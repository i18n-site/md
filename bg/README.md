...
Кодова база може да бъде създадена като отворен код за езикови файлове и с помощта на `Pull Request` процеси глобалните потребители могат да участват в непрекъснатото оптимизиране на преводите. Безпроблемна връзка и други общности с отворен [github](//github.com) .

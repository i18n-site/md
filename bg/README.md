...
С информационна експлозия и глобален пазар, за да се конкурирате за оскъдно внимание, **поддържането на множество езици е основно умение** .
...
## <a rel=id href="#project" id="project"></a> Описание на проекта
...
* [Генератор i18n.site : многоезичен статичен уебсайт](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Инструмент за превод на команден ред MarkDown

Преведете `Markdown` и `YAML` в инструмент за команден ред ( [изходен код](https://github.com/i18n-site/rust/tree/main/i18) ) на множество езици.
...
Ние споделяме " `UNIX` е файл " и можем да управляваме преводи на стотици езици, без да въвеждаме сложни и тромави решения на корпоративно ниво.

Можете да използвате най-познатите инструменти, за да `Markdown` превода (но не можете да добавяте или изтривате абзаци) и да използвате най-познатия начин за контрол на версиите.

Кодова база може да бъде създадена като отворен код за езикови файлове и с помощта на процеса на `Pull Request` потребителите могат да участват в непрекъснатото оптимизиране на преводите. Безпроблемна връзка [github](//github.com) И други общности с отворен код.

[→ За ръководство за потребителя, моля, прочетете документацията на проекта](/i18) .
...
Чисто статичен, оптимизиран за изживяване при четене и интегриран с превода на [i18](#i18) той е най-добрият избор за изграждане на сайт с документи за проекти.
...
Този уебсайт е разработен въз основа на тази рамка и включва потребителски, платежни и други функции ( [подробен](/i18n.site/src) урок ще бъде написан по-късно).

[→ За ръководство за потребителя, моля, прочетете документацията на проекта](/i18n.site) .
...
>
> ГОСПОД видя това и каза: „Всички човешки същества имат един и същ език и раса. Сега, когато това е изпълнено, всичко ще бъде направено.“
>

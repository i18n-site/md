...
Понастоящем обичайните чисти търсения в предния край [lunrjs](//lunrjs.com) [ElasticLunr.js](//github.com/weixsong/elasticlunr.js) (на базата на `lunrjs` вторична разработка).

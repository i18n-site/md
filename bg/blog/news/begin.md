...
* `i18` : MarkDown Инструмент за превод на командния ред
...
Преводът може да се редактира; модифицирайте оригиналния текст и когато той бъде преведен отново машинно, ръчните модификации на превода няма да бъдат презаписани (ако този параграф от оригиналния текст не е бил променен).

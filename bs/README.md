...
Čak i ako je riječ o osobnom open source projektu koji želi utjecati na širu publiku, on bi trebao napraviti međunarodnu tehnološku selekciju od početka.

## <a rel=id href="#project" id="project"></a> Opis projekta

Ova stranica trenutno nudi dva open source alata komandne linije:

* [i18 : MarkDown za prevođenje komandne linije](/i18/feature)
...
Prevedi `Markdown` i `YAML` u alat za komandnu liniju ( [izvorni kod](https://github.com/i18n-site/rust/tree/main/i18) ) na više jezika.
...
Dijelimo " `UNIX` je datoteka " i možemo upravljati prijevodima na stotine jezika bez uvođenja složenih i glomaznih rješenja na nivou preduzeća.

Možete koristiti najpoznatije alate za `Markdown` prijevoda (ali ne možete dodavati ili brisati pasuse) i koristiti najpoznatiji način kontrole verzija.

Baza koda može biti kreirana kao otvoreni izvor za jezičke datoteke, a uz pomoć procesa `Pull Request` , globalni korisnici mogu učestvovati u kontinuiranoj optimizaciji prijevoda. Besprekorna [github](//github.com) i druge zajednice otvorenog koda.
...
Čisto statičan, optimiziran za iskustvo čitanja i integriran s prijevodom [i18](#i18) najbolji je izbor za izgradnju web stranice projektnog dokumenta.
...
Ova web stranica je razvijena na osnovu ovog okvira i uključuje korisničke, platne i druge funkcije ( [izvorni kod](/i18n.site/src) ).

[→ Za uputstvo za upotrebu, pročitajte projektnu dokumentaciju](/i18n.site) .

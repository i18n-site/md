...
Molimo <button onclick="mailsub()">kliknite na ovu e-poštu da se pretplatite na ažuriranja proizvoda</button> i <button onclick="webpush()">omogućite push preglednika</button> . Obavijestit ćemo vas kada se proizvodi ažuriraju.

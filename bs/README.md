...
Pretplatili smo se na filozofiju `UNIX` Sve " datoteka " i možemo upravljati prijevodima na stotine jezika bez uvođenja složenih i glomaznih rješenja na nivou preduzeća!
...
Baza koda se može kreirati kao open source za jezičke datoteke, a uz pomoć `Pull Request` procesa globalni korisnici mogu učestvovati u kontinuiranoj optimizaciji prijevoda. Besprekorna [github](//github.com) i druge zajednice otvorenog koda.
...
[Kliknite ovdje da autorizujete i automatski github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) i **dobijete bonus $50** !
...
Osnovni front-end okvir usvaja potpunu plug-in arhitekturu, koja je laka za sekundarni razvoj, ako je potrebno, pozadinske funkcije se mogu integrirati.

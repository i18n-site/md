...
Program ima ugrađen `i18` prijevod, molimo pogledajte [➔ `i18` dokument](/i18) za konkretnu upotrebu.
...
[Kod je otvorenog koda](/i18n.site/src) . Ako ste zainteresovani za učešće u razvoju, predstavite se [mailing listi](//groups.google.com/u/2/g/i18n-site) .

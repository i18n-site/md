...
Kombinirajući ove dvije točke, lako možete napisati `HTML` u `MarkDown` kako biste postigli različite efekte prikaza.

Možete se obratiti na implementaciju u [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) kod je sljedeći :
...
## Slike/Video Zapisi/Linkovi Na Više Jezika

Nakon što se `MarkDown` konvertuje u `HTML` , `$LANG` u atributima `src` i `href` će biti zamijenjeno trenutnim [kodom jezika](/i18/LANG_CODE) .

Pomoću ove varijable možete postići višejezičnost slika/videozapisa/linkova.
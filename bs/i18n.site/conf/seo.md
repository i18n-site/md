...
Ovdje `cloudflare` uzeti [backblaze.com](https://www.backblaze.com)

Kreirajte kantu na `backblaze.com` , otpremite bilo koju datoteku, kliknite da pregledate datoteku i dobijete ime domene `Friendly URL` , što je ovdje `f003.backblazeb2.com` .

...
U front-end interakciji, traka [napretka](//juejin.cn/post/7413586285954154522) učitavanja indeksa [može](//dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) biti prikazana / bi se izbjeglo kašnjenje pri progress + po css put.
...
Prvo prikazani rezultati pretraživanja osiguravaju tačnost upita, a rezultati koji se naknadno učitavaju (kliknite na dugme Učitaj više) osiguravaju stopu prisjećanja.

...
[Ugrađena komandna linija js boa_engine](https://docs.rs/boa_engine) , [ugrađena baza podataka fjall](https://github.com/fjall-rs/fjall) .

[contabo](https://my.contabo.com) VPS

baza [kvrocks](https://kvrocks.apache.org) , [mariadb](https://mariadb.org) .

Pošaljite mail na self- [chasquid](https://github.com/albertito/chasquid) SMTP

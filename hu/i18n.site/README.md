...
A front-end és a back-end szétválasztása alapján a statikus tartalom és a dinamikus adatok elkülönítése is megtörténik.

Amit meglátogat [i18n.site](/) az erre a keretrendszerre épül (beleértve a felhasználói rendszert, a számlázási rendszert, az e-mail-előfizetést stb.).

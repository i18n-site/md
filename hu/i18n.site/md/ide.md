...
[vscode](https://code.visualstudio.com/) használjuk `MarkDown` írásához, és telepítjük a [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) beépülő modult is, hogy valós időben megtekinthessük írás közben.

...
A `i18n.site` val megegyezett horgonypont-megoldás a `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` -ben szöveghez hasonló szöveg beszúrása a pozicionálási rögzítési pont manuális létrehozásához.

...
A `i18n.site` val megegyezett rögzítési pont megoldása `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` -ben szöveghez hasonló szöveg beszúrása a pozicionálási horgonypont manuális létrehozásához.
...
A megvalósításra hivatkozhat a [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) a kód a következő :

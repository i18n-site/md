...
Az `en/i18n.yml` több nyelvre is le lesz fordítva, például `zh/i18n.yml`.
...
A fenti paraméterekhez tartozó könyvtár index fájl:
...
A `TOC` fájl a behúzásokkal jelzi az összefoglaló hierarchikus struktúráját, támogatja a több szintű behúzást, és a `#` karakterrel kezdődő sorok megjegyzések.

...
Parancssor Markdown Yaml fordítóeszköz, segít létrehozni egy nemzetközi dokumentumoldalt, [amely több száz nyelvet](/i18/LANG_CODE) támogat...
...
A közösségi médiával és az e-mailekkel az emberek hozzászoktak ahhoz, hogy saját anyanyelvükön az információforrásokra összpontosítsanak.
...
Még ha egy személyes nyílt forráskódú projektről van szó, amely szélesebb közönségre akar hatni, kezdettől fogva nemzetközi technológiai válogatást kell végeznie.
...
#### <a rel=id href="#price" id="price"></a> Nagyon versenyképes árak
...
[Kattintson ide, hogy engedélyezze és automatikusan kövesse github -t i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) és **bónusz $50 kapjon** .
...
Kérjük <button onclick="mailsub()">, kattintson erre az e-mailre a termékfrissítésekre való feliratkozáshoz</button> és <button onclick="webpush()">a böngésző leküldésének engedélyezéséhez</button> . Értesítést küldünk a termékek frissítéséről.
...
Nyelvi elszigeteltség nélküli internetet akarunk építeni.
Reméljük, hogy az egész emberiség összefog egy közös álommal.

A Markdown fordítási és dokumentációs oldala csak a kezdet.

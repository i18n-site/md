...
Például a fenti japán fordítás eredménye a következő:
...
`i18` be van építve a többnyelvű webhely-készítő parancssori eszközbe [`i18n.site`](/i18n.site) .

A részletekért lásd a [`i18n.site`](/i18n.site) dokumentációját.

## Nyílt Forráskódú Kód

A kliens teljesen nyílt forráskódú, 90 kód %-a pedig nyílt forráskódú. [Kattintson ide a forráskód megtekintéséhez](/i18n.site/src) .

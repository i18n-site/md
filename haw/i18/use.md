...
## windows E Hoʻokomo Mua I Ka git bash
...
Eia [i18n.site/payBill](//i18n.site/payBill) , pono ʻoe e hoʻopaʻa i kahi kāleka hōʻaiʻē no ka uku (ʻaʻole koi ʻia ka uku hou ʻana, e unuhi ʻokoʻa ka pūnaewele i nā uku e like me ka hoʻohana ʻana, [e ʻike i ka ʻaoʻao home no ke kumu kūʻai](/#price) ).
...
Inā makemake ʻoe e haʻalele i kekahi mau faila a ʻaʻole e unuhi iā lākou (e like me nā kikoʻī i hoʻopau ʻole ʻia), hiki iā ʻoe ke hoʻohana i ka hoʻonohonoho kahua `ignore` .
...
E hoʻokomo ʻia i ka `/usr/local/bin` ma ka paʻamau.

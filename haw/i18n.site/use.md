...
ʻO ka mua, e hoʻokomo i ka papa kuhikuhi `md` a holo i `i18n.site` , e unuhi i `en` i ka `zh` .

<img src="https://p.3ti.site/1721114619.avif" style="width:350px">

Ma hope o ka holo ʻana, e hana ʻia nā faila unuhi a me ka hūnā e hoʻomanaʻo e hoʻohui `git add . ` i ka waihona ma ka papa kuhikuhi `md` .

### Nāmua Kūloko

E hoʻouka a hoʻomaka i `docker` ( `MAC` ka mea hoʻohana e paipai [orbstack](https://orbstack.dev) ka hoʻohana ʻana i ka manawa holo no `docker` ).
...
No ka laʻana, `.i18n/htm/ol.yml` e hana i ka papa kuhikuhi `out/ol` .
...
I ka paʻi ʻana ma muli o ka pūʻolo `npm` , **e hoʻohana pono i `//unpkg.com/` no** ka prefix o `v:` waiwai `i18n.site` hoʻopaʻa pono ʻia ka manawa huna o `/.v` ma lalo o kēia ala prefix e hiki ai ke nānā pono i nā mea hou.
...
ʻO ka hope, **e hoʻonohonoho i ka manawa huna o ke ala e pau ana i `/.v` a i ka `1s`** , inā ʻaʻole hiki ke komo koke i nā mea hou i hoʻokuʻu ʻia.

Hiki ke hoʻonohonoho ʻia ka manawa hūnā no nā ala ʻē aʻe i hoʻokahi makahiki a ʻoi aku paha e hōʻemi i nā noi pono ʻole.

##### E Hoʻokipa Ma s3

No ka mea hoʻokipa ponoʻī, ma waho aʻe o ka hoʻohana ʻana i kāu kikowaena ponoʻī, kahi koho maʻamau e hoʻohana i `CDN` `S3` +

Hiki iā ʻoe ke hoʻohana i ka [rclone](https://rclone.org) no ke komo ʻana i ka server `S3` , a laila e nānā a hoʻololi i ka palapala ma lalo nei, a kope wale i nā hoʻololi hoʻonui i ka `S3` no kēlā me kēia hoʻokuʻu.
...
I ka hoʻopuka ʻana i ka ʻatikala ma mua, ua hana ʻia ʻo `out/ol/htm` e ʻoluʻolu e komo i kēia papa kuhikuhi a holo :
...
No ka mea ʻaʻole kākoʻo `github page` i ke kākau hou ʻana i ke ala URL, hoʻohana ʻia `404.html` ma kahi.
...
Hoʻohālikelike ʻia [cloudflare page](//pages.cloudflare.com) `github page` , hāʻawi ia i ke kākau hou ʻana i ke ala a ʻoi aku ka maikaʻi o ka ʻāina nui o Kina a ʻoi aku ka maʻalahi o ka hoʻohana.
...
A laila, e hoʻohana i ka waiho ʻana o nā mea kūʻai ao ma ka ʻāina nui o + `CDN` E hoʻohana i kēia ʻike `out/ol/htm` .
...
E hoʻohui i ka inoa kikowaena ma [Alibaba CDN](https://cdn.console.aliyun.com/domain/list) a kuhikuhi i ka inoa kikowaena `*.xxx.com` i ka `CNAME` ma Alibaba Cloud `CDN` .
...
E ʻoluʻolu e hoʻohui `/root/i18n/md/out/ol/htm` kahi hoʻonohonoho like me `out/ol/htm` ma ka paukū `server` o nginx

...
* `i18n.addon/toc` :
  E hana i ka papa kuhikuhi papa kuhikuhi o `json` ma muli o `TOC` , i hoʻohana ʻia ma ka paʻamau
...
ʻO ka pūʻolo e pili ana i `i18n.addon/toc` ma luna nei he [https://www.npmjs.com/package/@i18n.addon/toc](https://www.npmjs.com/package/@i18n.addon/toc)
...
ʻO nā inoa faila i ʻae ʻia penei
...
E kāhea ʻia ma hope o ka pau ʻana o ka unuhi ʻana, a penei nā ʻāpana i hoʻoholo ʻia.
...
Hoʻokumu ʻia ka `js` runtime i kūkulu ʻia ma ka hoʻomohala lua o [boa](https://github.com/boa-dev/boa) , a ʻo nā hana i kūkulu ʻia e like me kēia :

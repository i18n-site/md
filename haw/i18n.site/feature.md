...
E hoʻopuka ʻo `i18n.site` [unpkg.com](//unpkg.com) `npm` ʻike pūnaewele i ka `npmjs.com` ma ke ʻano maʻamau, me `CDN` kōkua o [jsdelivr.com](//jsdelivr.com)
...
Heluhelu [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) :
...
Hōʻike ke kiʻi ma luna i ka ʻōlelo `RSS` [inoreader.com](//inoreader.com) ka hoʻohana ʻana i ke kau inoa `i18n.site` .

### Hoʻouka I Nā Kikokikona Pūnaewele, Kākoʻo I Ka Pākē

[MiSans](https://hyperos.mi.com/font/zh/download/) [hiki](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) i ka ʻaoʻao pūnaewele ke hoʻohui i ka ʻike heluhelu o nā mea hoʻohana ma nā paepae like ʻole.
...
`404` ka ʻaoʻao he ʻuhane lana liʻiliʻi, e neʻe kona mau maka me ka ʻiole, [➔ Kaomi ma aneʻi e nānā](/404) ,

## Hoʻokaʻawale Kumu

[ʻO](//groups.google.com/u/2/g/i18n-site) [ka code open source](/i18n.site/src) .

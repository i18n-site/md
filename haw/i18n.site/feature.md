...
`i18n.site` e hoʻopuka [unpkg.com](//unpkg.com) ka ʻike pūnaewele i ka `npmjs.com` ma ke `npm` maʻamau, me ke kōkua `CDN` [jsdelivr.com](//jsdelivr.com)

Ma kēia kumu, ua hoʻohui ʻia nā kumu aniani mai ka ʻāina nui o Kina e ʻae i nā mea hoʻohana Kina e loaʻa i ke komo paʻa a loaʻa **ka loaʻa kiʻekiʻe ma mua** .

ʻO ke kumumanaʻo: e ʻae i nā noi me [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , e hoʻāʻo hou i nā noi i hāʻule ʻole ma `CDN` ʻē aʻe, a hiki ke hoʻololi i ka pūnaewele kumu pane wikiwiki loa e like me ke kumu hoʻouka paʻamau.
...
> Haʻalele ia i nā mea hoʻonani pono ʻole a hāʻawi i nā ʻike i kona ʻano maʻemaʻe.
...
Nui nā koi liʻiliʻi i koʻikoʻi akā ʻaʻole wikiwiki.
...
Eia nō naʻe, aia kekahi mau lā i kēlā me kēia mahina kahi manuahi e hoʻopaʻa inoa ai a hoʻolohe i nā leka uila.

Ma waho aʻe o ka uku wahi manuahi ma ʻEulopa, loaʻa i nā wahi ʻē aʻe nā pae like ʻole o ka piʻi ʻana o ke kumukūʻai.
...
Ma hope o kekahi mau minuke, ua hoʻohana ʻia nā kikowaena.

ʻO ka mea mua IP ʻo `ssh-copy-id root@c2` ka hoʻoponopono ʻana i ka mīkini kūloko o ka `~/.ssh/config`
...
Hoʻonohonoho ʻia ka polokalamu i hoʻonohonoho ʻia e like me kaʻu mau hana pilikino, e like me [mise](https://github.com/jdx/mise) , [direnv](https://direnv.net/) , etc. Inā pono, hiki iā ʻoe ke kope i ka hale kūʻai [i18n-ops/ubuntu](https://github.com/i18n-ops/ubuntu) a hoʻololi iā ia e like me ka mea e pono ai.

He manawa lōʻihi kēia ʻanuʻu Ma hope o ka kali ʻana no ka hapalua hola, e kūleʻa ana ka hoʻonui ʻana a me ka hoʻokomo ʻana i nā polokalamu maʻamau. Hiki iā ʻoe ke hōʻoia me kēia kauoha:
...
ʻAʻole paʻa ka pūnaewele mai ʻEulopa a hiki i `ssh` [mosh](//mosh.org)

E hana i `c0` script i loko o ka mīkini kūloko `PATH` ka `~/.bin`
...
Ma hope o ka hana ʻana, hāʻawi i nā ʻae hiki ke hoʻokō ʻia a me ka loulou palupalu `c1` `c2` .
...
I ka wā e hiki mai ana, hiki iā ʻoe ke hoʻokomo pololei i ka `c0` , `c1` a hiki iā ʻoe ke hoʻohana i `mosh` pilina pili kiʻekiʻe kiʻekiʻe a komo i [tmux](https://www.ruanyifeng.com/blog/2019/10/tmux.html)

## E Hoʻohuli I Ka ʻano ʻāpana Mai ext4 a I btrfs
...
E hoʻololi ʻia ka manamana lima i ka wā e hoʻohana `ssh-keygen -R ip` ssh
...
E hoʻomaka hou ka palapala i ka ʻōnaehana ma hope o ka holomua ʻana o ka hoʻololi ʻana.

### Nānā btrfs Lākiō Kōmi

E hoʻopaʻa ʻokoʻa ʻo ia ma ka paʻamau.
...
E like me ka mea i hōʻike ʻia ma ke kiʻi ma lalo nei, hiki iā ʻoe ke ʻike ma hope o ka hoʻopili lima ʻana i ka ʻōnaehana hou, kokoke i 100MB ʻoi aʻe i kaomi ʻia.
...
E hoʻohana i ka `snapper list-configs`

<img alt="" src="https://i-01.eu.org/1718302689.avif">

E hoʻohana i ka `snapper -c mnt list`
...
E nānā i nā hoʻololi ʻana i ka faila snapshot
...
### E ʻae I Ka Hoʻomau ʻana I Ka Log

ʻO ka ʻae ʻana i ka hoʻomau ʻana i ka log ma lalo o kahi ʻōnaehana hoʻopakele pono ʻoe e hana lima i ka papa kuhikuhi pili a hana i kekahi mau ʻanuʻu hou, no ka mea ʻaʻohe āu lawelawe systemd holo. Eia nā ʻanuʻu hiki iā ʻoe ke hoʻāʻo:
...
Ma kēia ala, hoʻomaka ʻo systemd-journald me ka hoʻonohonoho hou a hoʻomaka e mālama mau i nā lāʻau ma ka pā paʻa.

E hoʻomanaʻo i ka hana ʻana o nā hana i luna ma kahi ʻōnaehana hoʻopakele, no laila e hoʻololi wale ʻia kēlā mau hoʻololi ke hoʻomaka hou ʻia ka ʻōnaehana a ʻaʻole i ke ʻano hoʻopakele.

'O ia ho'i, 'a'ole 'oe e 'ike koke i nā ho'ololi o nā lā'au e noho nei e ho'omau, akā, e ho'omau 'ia nā lā'au a pau i hana 'ia ma hope o kēia.
...
Ua hoʻohana au i ka hana github e hana i kahi hōʻuluʻulu ʻokoʻa a me ka hoʻonohonoho ʻana ma mua, akā ʻike ʻia ʻaʻole hiki i ka lawelawe lawelawe ke ssh.
...
Ma hope o ka hoʻokolokolo pinepine ʻana, ʻo github action ka mea hoʻohana i hoʻouka i `1001` tar `uid`

Pono e `--no-same-owner` ʻia ka wehe ʻana me ka ʻole `1001` `uid` ʻāpana tar

ʻO ka hopena, e hoʻololi ʻo rsync i ka hui mea hoʻohana o ka papa kuhikuhi kumu, a laila ʻaʻole hiki iā ʻoe ke komo i ka ssh ma hope o ka hoʻomaka hou ʻana.

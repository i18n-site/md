...
[TinySearch](//github.com/tinysearch/tinysearch) , hoʻohana i ka kānana Bloom no ka huli ʻana, ʻaʻole hiki ke hoʻohana ʻia no ka ʻimi prefix (no ka laʻana, e hoʻokomo i `goo` , huli `good` , `google` ), a ʻaʻole hiki ke loaʻa ka hopena hoʻopau ʻakomi like.

Ma muli o nā hemahema o nā hāʻina i loaʻa, ua hoʻomohala ʻo `i18n.site` i kahi hoʻonā ʻimi huaʻōlelo piha mua maʻemaʻe, nona nā hiʻohiʻona :
...
* He ʻōlelo maʻamau `/\p{P}/` e pili ana i nā kaha `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` { | } ~. `.</p><ul><li> `split('.')` no ka mea ʻaʻole ʻo ka ʻāpana huaʻōlelo `Firefox` ka ʻāpana `. ` .</li>
...
E hoʻokomo i ka pūʻulu o ka palapala `url` a me ka helu helu `ver` , a e ʻimi inā aia ka palapala ma ka pākaukau `doc` Inā ʻaʻole i loaʻa, e hana i kahi kuhikuhi kuhikuhi. I ka manawa like, e wehe i ka papa kuhikuhi inverted no kēlā mau palapala i hoʻokomo ʻole ʻia.
...
E hoʻohana ka kernel huli i ka papa `prefix` no ka huaʻōlelo hope ma hope o ka ʻāpana huaʻōlelo e ʻimi ai i nā huaʻōlelo a pau i kau mua ʻia me ia, a huli ma ke kaʻina.

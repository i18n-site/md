# Ekifaananyi Ky’ekintu Ekikolebwa

## Okuvvuunula Okugatta `I18`

Programu erina enkyusa `i18` , nsaba olabe [➔ `i18`](/i18) for specific usage.
...
Nga bwekiba `i18n.site` ebirimu ku mukutu bijja kufulumizibwa ku `npmjs.com` , nga biyambibwako [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) n'ebirimu `CDN` ebingi ebitikkiddwa ku `npm` .
...
Omusingi `CDN` nti: okukwata okusaba ng'oyambibwako [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)

Koodi ekwatagana [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) :
...
Nga bwekiba, [Alimama dual-axis variable rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) n'empandiika endala ku mutimbagano zisobozeseddwa ku mukutu okugatta obumanyirivu bw'okusoma kw'abakozesa ku mikutu egy'enjawulo.
...
Koodi ekwatagana [github.com/i18n-site/font](https://github.com/i18n-site/font) :
...
Waliwo omuzimu omutono omulungi ogutengejja ku muko, amaaso gaago gajja kutambula ne mouse, [➔ Nyiga wano okulaba](/404) , `404`

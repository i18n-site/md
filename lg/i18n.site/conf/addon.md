...
* `lang_li` Olukalala : , olulimi olusooka lwe lulimi olusibuka
...
Ekiseera ky'okudduka ekizimbibwamu `js` kyesigamiziddwa ku nkulaakulana ey'okubiri : [boa](https://github.com/boa-dev/boa)

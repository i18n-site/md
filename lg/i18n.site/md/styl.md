...
|--------------|------------------------------------|
| Confucius         | Omutandisi w’enzikiriza ya Confucius |
...
Mu nsi ennene ey’ennimi za pulogulaamu, `Rust` , `Python` , `JavaScript` ne `Go` buli emu ekwata ekifo eky’enjawulo.

...
Buli muntu alina editor we gw'ayagala ennyo Wano tugabana enkola zaffe `Markdown` ezisinga obulungi.

Tukozesa [vscode](https://code.visualstudio.com/) okuwandiika `MarkDown` , era ne tuteeka ne plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) okulaba mu kiseera ekituufu nga tuwandiika.

...
`<a rel=id href="#xxx" id="xxx"></a>` , wano `rel=id` annyonnyola sitayiro y'olupapula lw'ensonga y'ennanga, nsaba okyuse `xxx` n'ekifupi kyo eky'Olungereza ky'ennanga kyennyini.
...
Osobola okujuliza okussa mu nkola mu [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) code eri bweti :

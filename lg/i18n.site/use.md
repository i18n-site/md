...
Bw'oba okozesa embeera y'okugatta okutambula obutasalako okufulumya, tekyetaagisa kuteeka `nodejs` , koppa olukusa oluyingidde n'okufulumya `~/.npmrc` mu mbeera.
...
Olwo, kozesa okutereka ebintu by'abatunzi b'ebire ku lukalu lwa China + Teeka ebirimu bino wammanga `CDN` `out/ol/htm`
...
Nsaba `/root/i18n/md/out/ol/htm` ensengeka efaananako ne zino wammanga mu katundu `server` aka nginx `out/ol/htm`

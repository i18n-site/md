...
windows System, nsaba [onyige wano okusooka okuwanula n'okussaako `git bash`](https://git-scm.com/download/win) .
...
Fayiro za demo ezivvuunuddwa mu dayirekita `en` kyakulabirako kyokka era zisobola okusazibwamu.
...
Osobola okutegeka `fromTo` ez'enjawulo ku / ez'enjawulo Okwolesebwa kuwandiikibwa bwekuti :
...
Mu kipande kino eky’okusengeka, olulimi ensibuko y’okuvvuunula katalogu `blog` luli `zh` , ate olulimi ensibuko y’okuvvuunula `blog/your_file_name.md` luli `ja` .

...
Waliwo n’ebikozesebwa ebimu eby’okuvvuunula layini y’ebiragiro, gamba nga [translate-shell](https://github.com/soimort/translate-shell)
...
Tukoze omulembe omupya ogwa tekinologiya w’okuvvuunula ng’agatta ebirungi eby’ekikugu ebiri mu nkola z’okuvvuunula ebyuma ez’ennono n’enkola z’ennimi ennene okufuula okuvvuunula okutuufu, okuweweevu era okulungi.
...
Awagira ensengeka y'omutwe gwa [HOGO](https://github.com/gohugoio/hugo) type static blog, evvuunula ennimiro `title` , `summary` ne `description` zokka.
...
### Bwe Kivvuunulwa Mu Lungereza, Ennukuta Esooka Ey’omutwe Ewandiikibwa Mu Ngeri Ennene Mu Ngeri Ey’otoma.
...
Ebiwandiiko okuva mu China, Japan ne Korea bitera okubaamu ebigambo by’Olungereza bingi.
...
`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` mu Lufalansa :
...
Kasitoma ye nsibuko enzigule ddala, era oludda lwa 90 % ya koodi nzigule [Nyiga wano okulaba ensibuko](/i18n.site/src) .
...
Nkusaba <button onclick="mailsub()">onyige email eno okuwandiika ku bipya by'ebintu</button> n'okusobozesa <button onclick="webpush()">browser push</button> .

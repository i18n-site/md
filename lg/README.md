<h1 style="display:flex;justify-content:space-between">i18n.site Ebigonjoola ebizibu by'ensi yonna<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Ennyonnyola ya Pulojekiti
...
Okuvvuunula `Markdown` ne `YAML` mu kikozesebwa mu layini y'ekiragiro ( [source code](https://github.com/i18n-site/rust/tree/main/i18) ) mu nnimi eziwera.
...
Tugabana " `UNIX` Everything is a File " era tusobola okuddukanya enkyusa mu bikumi n’ebikumi by’ennimi awatali kuleeta bigonjoola bizibu era ebizibu ku mutendera gw’ebitongole.

Osobola okukozesa ebikozesebwa ebisinga okumanyibwa `Markdown` enkyusa (naye tosobola kwongerako oba kusazaamu butundu), n’okozesa engeri esinga okumanyibwa ey’okukola okufuga enkyusa.

Omusingi gwa koodi gusobola okutondebwawo ng’ensibuko enzigule ya fayiro z’olulimi, era nga tuyambibwako enkola ya `Pull Request` , abakozesa mu nsi yonna basobola okwetaba mu kulongoosa okutambula obutasalako. Seamless connection [github](//github.com) N'ebitundu ebirala eby'enkozesa enzigule.

[→ Okusobola okulambika omukozesa, nsaba osome ebiwandiiko bya pulojekiti](/i18) .

## Enkyusa Ya Xindaya Ey’omutindo Ogwa Waggulu
...
Okutuuka ku mutindo gwe gumu, omuwendo gw’okulongoosa mu ngalo ogwetaagisa Google Translate ne `ChatGPT` guli `2.67` emirundi ne `3.15` emirundi gyaffe.
...
Purely static, optimized for reading experience, and integrated with the translation of [i18](#i18) ye nkola esinga obulungi ey’okuzimba omukutu gw’ebiwandiiko bya pulojekiti.

Enkola y’omu maaso ekwata ku nsengeka ya plug-in enzijuvu, nga eno nnyangu eri enkulaakulana ey’okubiri Bwe kiba kyetaagisa, emirimu egy’emabega giyinza okugattibwa.

Omukutu guno gukoleddwa nga gwesigamiziddwa ku nkola eno era gulimu emirimu gy’omukozesa, okusasula n’emirala ( [source code](/i18n.site/src) ).

[→ Okusobola okulambika omukozesa, nsaba osome ebiwandiiko bya pulojekiti](/i18n.site) .

## Sigala Ng'okwatagana

Nkusaba <button onclick="mailsub()">onyige email eno okwewandiisa ku bipya ku bikozesebwa</button> <button onclick="webpush()">n'okusobozesa browser push</button> .

...
O código de idioma é fixo, e novos idiomas serão adicionados posteriormente.

| Número | Código | Língua | Nome para Exibição |
| - | - | - | - |
| 0 | `en` | Inglês | `English` |
...
| 102 | `mg` | Madagascarense | `Malagasy` |
| 103 | `mt` | Maltês | `Malti` |
...
| 118 | `so` | Somália | `Soomaali` |
| 119 | `tt` | Tártaro | `Татар` |
| 120 | `ti` | Tigre | `ትግር` |
| 121 | `ts` | Congo | `Xitsonga` |

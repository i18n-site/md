...
Linha de comando Markdown, Yaml ferramenta de tradução, ajuda a construir sites de documentação internacional, com suporte a [centenas de idiomas](/i18/LANG_CODE)…
...
A Internet eliminou a distância física, mas as diferenças linguísticas ainda impedem a unidade humana.
...
Redes sociais, e-mails, o público está acostumado a focar em fontes de informação em sua língua materna.

Com a explosão de informações e o mercado global, para competir pela atenção escassa, **suportar múltiplos idiomas é fundamental**.

Mesmo projetos open-source pessoais que desejam alcançar um público mais amplo devem escolher uma tecnologia internacional desde o início.

## <a rel=id href="#project" id="project"></a> Introdução ao Projeto

Atualmente, este site oferece duas ferramentas de linha de comando open-source:
...
Aderimos à filosofia `UNIX` "Tudo é um arquivo" e podemos gerenciar traduções em centenas de idiomas sem a necessidade de soluções complexas e pesadas de nível empresarial.

Você pode usar as ferramentas mais familiares para editar o `Markdown` (mas não pode adicionar ou excluir parágrafos) e utilizar a maneira mais confortável para fazer o controle de versão.

Uma base de código pode ser criada como código aberto para arquivos de idioma, e, com a ajuda do processo de `Pull Request`, usuários de todo o mundo podem participar da otimização contínua das traduções. Conexão perfeita com [github](//github.com) e outras comunidades de código aberto.
...
Puro e estático, otimizado para experiência de leitura, integrado com a tradução de [i18](#i18), é a escolha ideal para construir sites de documentação de projetos.

Arquitetura de front-end flexível, baseada em plugins, fácil para desenvolvimento adicional e pode integrar funcionalidades de back-end se necessário.

Este site foi desenvolvido com base nesta estrutura, incluindo funções de usuário e pagamento ( [código-fonte](/i18n.site/src) ), e um tutorial detalhado será publicado em breve.
...
Se encontrar algum problema, [→ post no fórum de usuários](https://groups.google.com/u/1/g/i18n).

## Sobre Nós

> Eles disseram: "Vamos construir uma torre até o céu e dar fama à raça humana."
>
> O Senhor viu e disse: "A raça humana tem a mesma língua e origem, e agora que isso está completo, nada será impossível."
>
> Então Ele desceu e fez com que os seres humanos não pudessem se entender e os espalhou por todo o lugar.

<p style="text-align:right">— Bíblia, Gênesis</p>

Desejamos construir uma Internet sem barreiras de comunicação linguística.
Esperamos que a humanidade se una por um sonho comum.

O tradutor de Markdown e o site de documentação são apenas o começo.
...
Estamos ansiosos para encontrar pessoas que pensam como você no vasto oceano de almas.
...
Creemos no open-source e no amor pelo compartilhamento,
Bem-vindos para juntos criarmos um futuro sem fronteiras.
...
I18N.SITE, um gerador de sites estáticos que suporta tradução automática para [mais de cem idiomas diferentes](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

...
Os pontos de ancoragem tradicionais do `Markdown` são gerados com base no conteúdo do texto, mas essa abordagem não é viável em contextos multilíngues.
...
O resultado da exibição é o seguinte:
...
Combinando esses dois aspectos, é possível escrever `HTML` em `Markdown` de maneira simples, alcançando vários efeitos de visualização.

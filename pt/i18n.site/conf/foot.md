...
O ícone do rodapé é gerado por uma fonte chamada `F` criada em iconfont.cn ([versão em inglês](https://www.iconfont.cn/?lang=en-us) / [versão em chinês](https://www.iconfont.cn/?lang=zh)).

<h1 style="display:flex;justify-content:space-between">i18n.site ⋅ Solisyon entènasyonal yo<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Deskripsyon Pwojè
...
Tradui `Markdown` ak `YAML` nan yon zouti liy kòmand ( [kòd sous](https://github.com/i18n-site/rust/tree/main/i18) ) nan plizyè lang.
...
Nou pataje " `UNIX` bagay se yon dosye " epi nou ka jere tradiksyon nan plizyè santèn lang san nou pa entwodwi solisyon konplèks ak ankonbran nan nivo antrepriz.

Ou ka itilize zouti ki pi abitye pou `Markdown` tradiksyon an (men ou pa kapab ajoute oswa efase paragraf), epi sèvi ak fason ki pi abitye pou fè kontwòl vèsyon an.

Yon baz kòd ka kreye kòm yon sous louvri pou fichye lang, epi avèk èd nan pwosesis `Pull Request` , itilizatè mondyal yo ka patisipe nan optimize kontinyèl nan tradiksyon. Koneksyon san pwoblèm [github](//github.com) lòt kominote sous louvri.

[→ Pou gid itilizatè, tanpri li dokiman pwojè a](/i18) .

## Tradiksyon-Wo Kalite Xindaya A
...
Pou reyalize menm kalite a, kantite koreksyon manyèl `ChatGPT` Translate ak Google Translate egzije se `2.67` fwa ak `3.15` fwa nou respektivman.
...
Piman estatik, optimize pou eksperyans lekti, ak entegre ak tradiksyon an nan [i18](#i18) li se pi bon chwa pou bati yon sit dokiman pwojè.
...
Sit entènèt sa a devlope baze sou kad sa a epi li gen ladan itilizatè, peman ak lòt fonksyon ( [kòd sous](/i18n.site/src) ).

[→ Pou gid itilizatè, tanpri li dokiman pwojè a](/i18n.site) .
...
Byenvini swiv kont sosyal nou / [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) [X.COM: @i18nSite](https://x.com/i18nSite)

...
Pwogram nan gen tradiksyon `i18` , tanpri gade [➔ `i18`](/i18) pou itilizasyon espesifik.
...
`i18n.site` Pa default, yo pral pibliye kontni sit la nan `npmjs.com` , avèk èd nan [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) ak plizyè kontni `CDN` ki chaje sou `npm` .
...
Prensip la se: entèsepte demann lan avèk èd nan [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) si demann lan echwe, reesye li sou lòt `CDN` , epi adaptively pèmèt estasyon orijin ki pi rapid reponn kòm sous la chaje defo.
...
> Se bote nan senplisite parfe entèprete nan konsepsyon entènèt la nan sit entènèt sa a.
> Li abandone dekorasyon ki pa nesesè epi li prezante kontni nan fòm pi bon kalite li yo.
...
`404` yon bèl ti fantom k ap flote sou paj la, je l ap deplase ak sourit la, [➔ Klike la a pou w wè](/404) ,

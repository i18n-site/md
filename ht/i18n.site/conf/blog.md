...
Yon fichye Demo se konfigirasyon jan sa a:
...
Si ou bezwen mete atik la nan tèt la, tanpri kouri `i18n.site` epi edite `xxx.yml` fichye ki anba a `.i18n/data/blog` , epi chanje timestamp la nan yon nimewo negatif (plizyè nimewo negatif yo pral klase soti nan ti ak gwo nan valè absoli).
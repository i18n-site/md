...
Lè sa a, kreye script la nan [EdgeJS kwen](//console.bce.baidu.com/cdn/#/cdn/ejs/list) jan sa a
...
Klike sou `Debug` , Lè sa a, klike sou Pibliye nan tout rezo a.
...
Paske `R2` `cloudflare` jwenn aksè pa yon non domèn Customized, yon depo objè twazyèm-pati bezwen yo dwe itilize yo mete fichye estatik.

Isit la nou [backblaze.com](https://www.backblaze.com) kòm yon egzanp pou montre kouman yo mare objè twazyèm pati yo dwe estoke nan `cloudflare` .

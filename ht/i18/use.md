...
windows Sistèm, tanpri [klike isit la pou telechaje ak enstale `git bash`](https://git-scm.com/download/win) an premye.
...
Tanpri gade nan pwojè Demo [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) pou aprann konfigirasyon `i18` tradiksyon.
...
Ou kapab configure diferan `fromTo` pou diferan sous-dosye / yon demonstrasyon ekri jan sa a :
...
Nan tablo konfigirasyon sa a, lang sous tradiksyon katalòg `blog` a se `zh` , ak lang sous tradiksyon `blog/your_file_name.md` se `ja` .
...
`ignore` itilize menm [globset](https://docs.rs/globset/latest/globset/#syntax) ak `.gitignore` fichye a.

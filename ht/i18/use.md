...
[i18n.site/payBill](//i18n.site/payBill) , ou bezwen mare yon kat kredi pou peman (pa gen okenn rechaj obligatwa, sit entènèt la pral otomatikman dedwi frè dapre itilizasyon, [gade paj dakèy la pou pri](/#price) ).
...
Diferan `fromTo` ka konfigirasyon pou / sous-dosye : yo.
...
Nan tablo konfigirasyon sa a, lang sous tradiksyon anyè `blog` a se `zh` , ak lang sous tradiksyon anyè `blog/your_file_name.md` a se `ja` .

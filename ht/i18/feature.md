...
Sipòte tradiksyon HTML Markdown , kontni an nan tags `<pre>` ak `<code>` HTML entegre nan `MarkDown` pa tradui
...
Sipòte konfigirasyon nan header [HOGO](https://github.com/gohugoio/hugo) kalite blog estatik, ki sèlman tradui jaden `title` , `summary` ak `description` .
...
Kliyan an se yon sous konplètman louvri, epi bò sèvè a se [yon](/i18n.site/src) sous louvri 90

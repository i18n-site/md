...
Ko te uara o `YAML` ka kiia hei `MarkDown` mo te whakamaoritanga.

I etahi wa ko te hurihanga mai i `HTML` → `MarkDown` ehara i ta tatou e hiahia ana, penei i te `<a href="/">Home</a>` ka hurihia ki `[Home](/)` .

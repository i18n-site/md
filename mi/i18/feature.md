...
Mo te hunga hötaka e waia ana ki `git` , `vim` , me `vscode` , ko te whakamahi i enei taputapu ki te whakatika tuhinga me te whakahaere i nga putanga ka kore e kore ka piki ake te utu ako.
...
Hei whakatutuki i taua kounga, ko te nui o te whakatika a-ringa e hiahiatia ana e Google Whakamaori me `ChatGPT` he `2.67` nga wa me te `3.15` nga wa o to maatau.
...
Ka whakamahia `Markdown` hei tauira imeera, ka whakamahia `YAML` hei whirihoranga konae reo, ka puta nga tawhā taurangi (hei tauira: kua riro te utu `${amount}` ).
...
Karekau a Haina, Hapani me Korea he reta nui, he reta iti ranei, engari ko nga taitara Ingarihi te nuinga o te reta tuatahi.
...
He puna tuwhera te kiritaki, a ko te taha 90 % o te [waehere](/i18n.site/src) he puna tuwhera.

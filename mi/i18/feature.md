...
Ka tautokohia te whakamaoritanga o HTML ranunga Markdown , ko nga ihirangi kei roto i nga tohu `<pre>` me `<code>` o HTML kua mau ki `MarkDown` kaore i whakamaoritia
...
Karekau i te whakamaorihia nga tohu-a-roto me nga waahanga waehere, engari ka taea te whakamaori i nga korero i roto i te waehere.
...
## Kaore He Whakarereketanga, Kaore He Whakamaoritanga

He taputapu whakamaori rarangi whakahau, penei i te [translate-shell](https://github.com/soimort/translate-shell) .
...
Kua whakawhanakehia e matou he reanga hou o te hangarau whakamaori e whakauru ana i nga painga hangarau o nga tauira whakamaori miihini tuku iho me nga tauira reo nui kia tika, kia maeneene, kia huatau hoki nga whakamaoritanga.
...
[Pāwhiri ki konei hei whakamana me te whai aunoa i18n.site te github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ka **whiwhi bonus $50** .
...
Ko te taputapu anake ka whakamaori i nga uara papakupu i roto i `YAML` , kaua ko nga taviri papakupu.
...
Ka tautokohia `summary` whirihoranga `description` `title` [HOGO](https://github.com/gohugoio/hugo)
...
Kua whakamaoritia ki te reo : `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす`

![](//p.3ti.site/1720199391.avif)

Kua whakamaoritia ki `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` reo French :

Ko `Falcon` ka whakamaoritia hei `faucon` , ko `Llama` ka whakamaoritia hei `lama` . Hei ingoa tika, kaua e whakamaoritia.

![](//p.3ti.site/1720199451.avif)

### Whakamaoritanga DeepL

Kua whakamaoritia ki te reo : `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す`
...
He puna tuwhera te kiritaki, a 90 te taha tūmau % o te [waehere](/i18n.site/src) he puna tuwhera.
...
/ [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) koa ki te whai i a maatau kaute paapori [X.COM: @i18nSite](https://x.com/i18nSite)
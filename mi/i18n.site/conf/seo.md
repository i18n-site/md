...
Tena koa whakarereke i te uara o `host:` i runga ake nei ki to ingoa rohe, penei i `i18n.site` .
...
Na ka hanga i te tuhinga i roto i [EdgeJS ratonga taha](//console.bce.baidu.com/cdn/#/cdn/ejs/list) e whai ake nei
...
Hei tauira, ka tukuna e [Huawei Cloud DNS](https://www.huaweicloud.com) he tātari-a-rohe kore utu, ka taea e nga waka Hainamana te haere ma te Baidu Smart Cloud, ka taea e nga waka o te ao te haere ma `cloudflare` .

He maha nga mahanga i roto i te whirihoranga o `cloudflare` Anei etahi tohu hei tohu :

### Ko Te Ingoa Rohe Kei Roto I Etahi Atu `DNS` , Me Pehea Te Whakamahi `cloudflare`

Tuatahi herea te ingoa rohe ki `cloudflare` , ka whakamahi i te ingoa rohe ritenga `SSL/TLS` → hei hono i te ingoa rohe matua ki tenei ingoa rohe.

![](https://p.3ti.site/1725438658.avif)

### `cloudflare R2` Kaore E Taea Te Uru Atu Ma Te Ingoa Rohe Ritenga

Na te mea `cloudflare` e `R2` , me whakamahi he rokiroki ahanoa tuatoru hei tuu i nga konae pateko.

...
Ka whakaatu te tauira blog i te rarangi o nga tuhinga (taitara me nga waahanga) i runga i te raupapa o te waa whakaputa.

[→ Paatohia a konei ki te ako mo te whirihoranga motuhake](/i18n.site/conf/blog)

### `use: Doc` , Tauira Tuhinga Maha-Kōnae
...
Ko te tikanga tuhi i runga ake nei he rite ki `url: xxx` , a ko tana konae he `en/xxx/TOC` .

#### TOC Ripanga Ihirangi Taupū

`i18n.site` ka mahia `js` mono-i `.i18n/hook/after.tran/TOC.js` i roto i te whare putunga demo ki te panui i te konae taurangi whaiaronga `TOC` e rite ana ki te whirihoranga tauira `doc` hei whakaputa i te raarangi whaiaronga `json` .
...
Ka taea te tuhi ihirangi ki te nama `README.md` , penei i te `en/demo2/README.md` .
...
Mena kua whakarereketia te reo puna, me whakanekehia nga konae `TOC` o tetahi reo i roto i te kaupapa ki tetahi atu reo.

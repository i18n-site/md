...
Ka taea te whirihora i nga mono-mai ki `.i18n/conf.yml` , penei:
...
Ko te `__CONF__` ka whakakapia ki te ingoa o te whirihoranga o naianei (penei i `dev` , `ol` ranei).
...
Ko te wa whakahaere `js` : hangaia i runga i te whanaketanga tuarua o [boa](https://github.com/boa-dev/boa)

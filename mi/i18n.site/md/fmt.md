...
Ko nga tohu punga tuku iho `MarkDown` ka hangaia i runga i nga korero mo te reo-maha, kaore e taea tenei otinga.

Ko te otinga ira punga i whakaaehia ki `i18n.site` ko te whakauru kupu rite ki `<a rel=id href="#xxx" id="xxx"></a>` i roto i `MarkDown` hei hanga a ringa i te tohu punga tuunga.
...
Ko nga punga ka taapirihia ki te taitara, penei:

...
He whakamaoritanga kei roto `i18` te kaupapa, tirohia [➔ `i18`](/i18) mo te whakamahinga motuhake.
...
`i18n.site` Ma te taunoa, ka whakaputahia nga ihirangi pae ki `npmjs.com` , me te awhina o [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) me te maha o nga ihirangi `CDN` kua utaina ki runga `npm` .
...
Ko te kaupapa: haukotia te tono me te awhina a [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , ki te rahua te tono, ngana ano ki etahi atu `CDN` , ka urutau ki te teihana takenga urupare tere hei puna uta taunoa.

Waehere e pa ana : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)
...
Ma te taunoa, [ko nga momotuhi tapawha taurangi tuaka-rua Alimama](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) me etahi atu momotuhi ipurangi ka taea ki te wharangi tukutuku hei whakakotahi i te wheako panui a nga kaiwhakamahi i runga i nga papaaho rereke.

I te wa ano, hei whakapai ake i te tere o te uta, ka tapatapahia nga momotuhi e ai ki nga tatauranga auau kupu.

Waehere e pa ana : [github.com/i18n-site/font](https://github.com/i18n-site/font)
...
He kehua iti e rere ana i runga i te wharangi `404` ka korikori ona kanohi me te kiore, [➔ Paatohia ki konei kia kite](/404) ,

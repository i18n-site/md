...
Ko te whakaputa [i](/i18n.site/feature#ha) nga ihirangi ki te [npmjs.com](//npmjs.com)
...
`CNAME` te ingoa `*.xxx.com` `CDN` [Alibaba Cloud CDN](https://cdn.console.aliyun.com/domain/list)

...
Me `md` te ingoa whaiaronga o te `demo.i18n.site` toka turanga turanga kia pai ai te arokite o te rohe me `docker` .

### Whakamaori

Tuatahi, tomohia te whaiaronga `md` ka whakahaere i `i18n.site` , ka whakamaoritia `en` ki `zh` .

<img src="https://p.3ti.site/1721114619.avif" style="width:350px">

I muri i te whakahaerenga, ka hangaia nga konae whakamaori me te keteroki Me mahara ki te taapiri `git add . ` ki te putunga i te raarangi `md` .
...
Na, tomo i te whaiaronga `docker` ka whakahaere `./up.sh` , ka haere [https://127.0.0.1](https://127.0.0.1) te arokite i te rohe.
...
Whai muri i te whakahaere i te whakamaoritanga i runga ake nei, ka hangaia nga raarangi `htm` me te `v` i raro i te raarangi `md/out/dev` .
...
Ko `dev` te whakapoto o `development` , e tohu ana i te taiao whanaketanga, e whakamahia ana mo te arokite o te rohe, a ko te konae whirihoranga taunoa hoki.
Ko `ol` te whakapoto o te `online` , e tohu ana i te taiao ipurangi, e whakamahia ana mo te tuku mana ko te konae whirihoranga taunoa ka whakamahi i nga tawhā raina whakahau `-n` ki te `npm` ki te tuku.

Ka taea hoki e koe te hanga i etahi atu konae whirihoranga Whakamahia te `--htm_conf` i runga i te rarangi whakahau hei whakau i te ingoa konae whirihoranga hei whakamahi:
...
I te wa e whakaputa ana i runga i te kete `npm` , **me whakamahi i `//unpkg.com/` mo** te tohu tuatahi o `v:` uara kua tino arotautia e `i18n.site` te wa keteroki o `/.v` i raro i tenei ara prefix ki te tiro i nga putanga hou.
...
Mena ka whakarereketia e koe te ingoa o te kete `v:` i roto i `ol.yml` , **me whakakorea `.i18n/v/ol` i te tuatahi** ka whakaputa.
...
Mena kei te pirangi koe ki te manaaki whaiaro i nga ihirangi, tuatahi whakatika `md/.i18n/htm/ol.yml` ka huri i `v: //unpkg.com/i18n.site` ki to mua URL, penei i te `v: //i18n-v.xxx.com` .
...
Na, whirihora i te ihirangi i roto i te whaiaronga `md/out/ol/v` ki te ara prefix URL kua whakaritea ki te `v:` .

Hei whakamutunga, **whirihorahia te wa keteroki o te ara ka mutu i te `/.v` ki te `1s`** , ki te kore e taea te uru atu ki nga mea hou ka tukuna.
...
Ki te ihirangi manaaki-whaiaro, i tua `CDN` i te whakamahi i to ake kaimau, ko tetahi atu whiringa ko te whakamahi `S3` +

Ka taea e koe te whakamahi i te [rclone](https://rclone.org) ki te takiuru ki te tūmau `S3` , ka tirohia me te whakarereke i te tuhinga e whai ake nei, ka kape noa i nga huringa taapiri ki `S3` mo ia tukunga.
...
Kia mahara ki te whirihora i `CDN` kia ko te wa keteroki o te ara ka mutu ki te `/.v` ko te `1s` , mena kaore e taea te uru atu ki nga ihirangi hou.
...
Tuatahi [paohia ki github hei hanga whakahaere](https://github.com/account/organizations/new?plan=free) Ko te ingoa whakahaere e whai ake nei ko `i18n-demo` hei tauira.
...
Ka [cloudflare page](//pages.cloudflare.com) ki `github page` , he tuhi ano i te ara, he pai ake ki te tuawhenua o Haina me te waatea ake.

Ko te tukunga o `cloudflare page` i te nuinga o te waa i runga i te whakatakotoranga o `github page` i runga ake nei.
...
Na, whakamahia te rokiroki ahanoa o nga kaihoko kapua i te tuawhenua o + `CDN` Hoatuhia nga korero e whai ake nei `out/ol/htm` .
...
No te mea kaore e taea e te rekoata `MX` me te rekoata `CNAME` te noho tahi, ki te hiahia koe ki te whiwhi imeera ingoa rohe i te wa ano, me mahi tahi koe [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) te tuhi ki te taumata `CNAME` ki te rekoata `A` .
...
Mena ka whakamahi koe i `i18n.site` ki te whakaputa i tetahi paetukutuku hei paetukutuku matua, me whirihora e koe te hurihanga pan-domain, ara, te whakawhiti i te uru ki `*.xxx.com` (tae atu ki `www.xxx.com` ) ki te `xxx.com` .
...
Tāpirihia te ingoa rohe ki [Alibaba Cloud CDN](https://cdn.console.aliyun.com/domain/list) ka tohuhia te ingoa rohe `*.xxx.com` ki te `CNAME` ki Alibaba Cloud `CDN` .
...
Tāpirihia he whirihoranga rite ki enei e whai `out/ol/htm` `/root/i18n/md/out/ol/htm` i te `server` whiti o nginx
...
Whaiaronga reo puna, e rite ana ki `en` o te `fromTo` i roto i `.i18n/conf.yml` konae whirihoranga

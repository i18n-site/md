...
Na nga ngoikoretanga o nga otinga o naianei, kua whakawhanakehia `i18n.site` tetahi otinga rapu kupu-katoa o mua-mutunga hou, e whai ake nei nga ahuatanga :
...
* Ko `/\p{P}/` he korero auau e taurite ana ki nga tohu tohu ko: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _` { | } ~. `.</p><ul><li> Ko `split('.')` na te mea karekau te wehenga kupu tirotiro `Firefox` i te wahanga `. ` .</li>

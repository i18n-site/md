...
* `/\p{P}/` magana ce ta yau da kullun wacce ta dace da alamomin ƙayyadaddun alamomi sun haɗa da: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _ ` { | } `.</p><ul><li> `split('.')` saboda `Firefox` kalmar mashigai ba ta kashi `.` ba.</li>

<h1 style="display:flex;justify-content:space-between">i18n.site Magani na duniya<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

Layin umarni Markdown # kayan aikin Yaml , yana taimaka muku gina rukunin daftarin aiki na duniya, yana tallafawa [ɗaruruwan harsuna](/i18/LANG_CODE) ...
...
## <a rel=id href="#project" id="project"></a> Bayanin Aikin

A halin yanzu wannan rukunin yanar gizon yana ba da kayan aikin layin umarni na buɗewa guda biyu:

* [i18 : MarkDown aikin fassarar layin umarni](/i18/feature)
* [i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: MarkDown kayan aikin fassarar layin umarni

Fassara `Markdown` da `YAML` cikin kayan aikin layin umarni ( [lambar tushe](https://github.com/i18n-site/rust/tree/main/i18) ) a cikin yaruka da yawa.

Iya daidai kula da format na `Markdown` Zai iya gano gyare-gyaren fayil kuma kawai fassara fayilolin da aka canza.
...
Muna raba " `UNIX` Fayil " kuma muna iya sarrafa fassarori a cikin ɗaruruwan harsuna ba tare da gabatar da sarƙaƙƙiya da matsaloli na matakin kasuwanci ba.

Kuna iya amfani da mafi yawan kayan aikin da kuka saba don `Markdown` fassarar (amma ba za ku iya ƙara ko share sakin layi ba), kuma ku yi amfani da hanyar da ta fi dacewa don sarrafa sigar.

Za a iya ƙirƙirar tushe na lamba azaman buɗe tushen fayilolin harshe, kuma tare da taimakon tsarin `Pull Request` Haɗin kai mara kyau [github](//github.com)

[→ Don jagorar mai amfani, da fatan za a karanta takaddun aikin](/i18) .

## Babban Fassarar Xindaya
...
Don cimma inganci iri ɗaya, adadin gyaran `2.67` da Google Translate `3.15` buƙata kuma `ChatGPT`
...
A tsaye kawai, an inganta shi don ƙwarewar karatu, kuma haɗe tare da fassarar [i18](#i18) shine mafi kyawun zaɓi don gina wurin daftarin aiki.
...
An haɓaka wannan gidan yanar gizon akan wannan tsarin kuma ya haɗa da mai amfani, biyan kuɗi da sauran ayyuka ( [lambar tushe](/i18n.site/src) za a rubuta cikakken koyawa).

[→ Don jagorar mai amfani, da fatan za a karanta takaddun aikin](/i18n.site) .

...
Har yanzu ɗaukar aikin demo azaman misali, `.i18n/htm/foot.pug` a cikin kundin adireshi `md` yana ma'anar gindin gidan yanar gizon.
...
Da fatan za a ƙirƙiri rubutun gunkin ku kamar yadda ake buƙata kuma ku maye gurbin saitin mai zuwa a cikin `conf.css` :
...
Yin amfani da `${I18N.xxx}` mai kama da wannan hanyar rubutun, haɗe da `i18n.yml` , za ku iya cimma burin ƙasa da harsuna da yawa na ƙafa.

...
Sannan ƙirƙirar rubutun a cikin [EdgeJS na gefen](//console.bce.baidu.com/cdn/#/cdn/ejs/list) kamar haka
...
Saboda `R2` `cloudflare` a iya isa gare shi ta hanyar sunan yanki da aka keɓance ba, ana buƙatar amfani da ma'ajin abu na ɓangare na uku don sanya fayiloli na tsaye.

Anan mun [backblaze.com](https://www.backblaze.com) misali don nuna yadda ake ɗaure abubuwa na ɓangare na uku don adanawa a `cloudflare` .

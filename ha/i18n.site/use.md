...
Idan kun yi amfani da yanayin haɗin kai mai ci gaba don bugawa, babu buƙatar shigar da `nodejs` , kawai kwafi da shiga da buga izinin `~/.npmrc` zuwa yanayin.
...
Lokacin buga abun ciki a labarin da ya gabata, an ƙirƙira `out/ol/htm` Da fatan za a shigar da wannan kundin adireshi kuma ku gudanar da shi :
...
`CDN` nan, yi amfani da kayan ajiya `out/ol/htm` masu sayar da gajimare a cikin babban yankin Sin +

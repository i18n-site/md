...
## Kwatsam an Share `.i18n/v` , Yana Haifar Da Gazawar Bugu `npm`

An adana sigar tarihin da aka fitar ta kunshin `npm` a cikin `.i18n/v/ol/v.hash` .

Idan kun share `.i18n/v/ol` da gangan, ba za a saki kunshin `npm` ba.

...
Shirin yana da fassarorin `i18` , da fatan za a duba [➔ `i18`](/i18) don takamaiman amfani.
...
Ka'idar ita ce: kutsa cikin buƙatar tare da taimakon [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) idan buƙatar ta gaza, sake gwada ta a kan wasu `CDN` , kuma a daidaita ta da tashar mai amsawa mafi sauri azaman tushen lodawa.
...
> Yana watsar da kayan ado mara amfani kuma yana gabatar da abun ciki a cikin mafi kyawun tsari.
...
Ta hanyar tsoho, [Alimama dual-axis m rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) da sauran fonts na kan layi ana kunna su akan rukunin yanar gizon don haɗa ƙwarewar karatu na masu amfani akan dandamali daban-daban.
...
`404` wata kyakyawar fatalwa mai yawo a shafin, idanuwanta za su motsa da linzamin kwamfuta, [➔ Danna nan don kallo](/404) ,

## Lambar Bude Tushen

[Lambar buɗaɗɗen tushe ce](/i18n.site/src) Idan kuna sha'awar shiga ci gaba, da fatan za a gabatar da kanku ga [jerin aikawasiku](//groups.google.com/u/2/g/i18n-site) .

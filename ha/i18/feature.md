...
Yana goyan bayan fassarar gauraye HTML , abubuwan da ke cikin alamun `<pre>` da `<code>` na HTML da aka saka a cikin `MarkDown` ba a fassara Markdown ba
...
Hakanan akwai wasu kayan aikin fassarar layin umarni, kamar [translate-shell](https://github.com/soimort/translate-shell)
...
## Za a Iya Gyara Fassarar, Kuma Fassarar Inji Ba Za Ta Sake Rubuta Gyare-Gyaren Da Ke Akwai Ba.
...
## Taimakawa Daidaitawar Fassarar Kai `HOGO`

Yana goyan bayan daidaitawar rubutun kai na [HOGO](https://github.com/gohugoio/hugo) rubutu a tsaye, wanda ke fassara filayen `title` , `summary` da `description` kawai.
...
Fassarar na'ura na Sinanci, Jafananci da harsunan Koriya ta zama harshen da ba Ingilishi ba, kuma galibi ana fassara kalmomi tare, kamar jumlar Sinanci mai zuwa:
...
Fassara zuwa : `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす`

![](//p.3ti.site/1720199391.avif)

Fassara zuwa `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Fassara zuwa : `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す`

![](//p.3ti.site/1720199550.avif)

Fassarar abubuwan da ke sama zuwa DeepL (kuma sake rubuta sunayen da suka dace da ƙara `... ` mara kyau):
...
Abokin ciniki gabaɗaya buɗaɗɗen tushe ne, kuma gefen uwar 90 % na lambar buɗewa ce Danna [nan don duba lambar tushe](/i18n.site/src) .

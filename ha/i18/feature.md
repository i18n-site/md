...
## Za a Iya Kiyaye Tsarin Markdown Daidai

Yana goyan bayan fassarar tebur ɗin Markdown ba tare da lalata tsarin ba;

Yana goyan bayan fassarar gauraye HTML , abun ciki a cikin tags `<pre>` da `<code>` na HTML Markdown aka saka a cikin `MarkDown` ba a fassara su ba
...
[Danna nan don ba da izini kuma ku bi ta github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) da **karɓar kari $50** .
...
`Markdown` ana amfani da shi azaman samfuri na imel, ana amfani da `YAML` azaman tsarin fayil ɗin harshe, kuma za a sami sigogi masu canzawa (misali: an karɓi caji `${amount}` ).
...
China, Japan, da Koriya ba su da manyan haruffa ko ƙananan haruffa, amma taken Ingilishi gabaɗaya suna yin girman harafin farko.
...
Fassara ta `i18` za ta gane kalmomin Ingilishi cikin takaddun Sinanci, Jafananci da Koriya kuma su bar sharuɗɗan cikakke.
...
Muna neman masu sa kai don su shiga cikin haɓaka buɗaɗɗen lambar tushe da kuma gyara rubutun da aka fassara.

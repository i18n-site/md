...
Idan ka ƙara ko share layi ba da gangan ba, yana haifar da rudani, da fatan za a mayar da fassarar zuwa sigar kafin gyara, sake gudanar da fassarar `i18` , kuma sake cache taswirar daidai.
...
Wani lokaci juyawa daga `HTML` → `MarkDown` ba shine abin da muke so ba, kamar `<a href="/">Home</a>` ana canza shi zuwa `[Home](/)` .
...
Share fayilolin masu karo da juna kuma a sake aiwatar da fassarar `i18` .
...
Atbalsta jaukto HTML tulkojumu, `<pre>` un `<code>` HTML saturs, kas iegults `MarkDown` Markdown netiek tulkots
...
Atbalsta galvenes konfigurāciju [HOGO](https://github.com/gohugoio/hugo) statiskam emuāram, kas tulko tikai laukus `title` , `summary` un `description` .
...
Ķīnā, Japānā un Korejā nav lielo un mazo burtu, taču angļu valodas nosaukumos parasti ir jāraksta pirmais burts.
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` japāņu valodā :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` franču valodā :
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` japāņu valodā :

![](//p.3ti.site/1720199550.avif)

Iepriekš minētā tulkojums DeepL valodā (arī pārrakstot īpašvārdus un pievienojot nepāra `... ` ):

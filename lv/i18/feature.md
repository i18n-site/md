...
Atbalsta HTML Markdown tulkojumu, `<pre>` un `<code>` tagu saturs HTML kas iegults `MarkDown` , netiek tulkots
...
DeepL iepriekš minēto franču valodā (arī pārrakstot īpašvārdus un pievienojot nepāra `... ` ):

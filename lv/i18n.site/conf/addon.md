...
Spraudnis pēc noklusējuma izmanto jaunāko versiju un katru nedēļu pārbauda, vai nav atjauninājumu.
...
* `rBin(path)` : bināro failu
* `rDir(dirpath)` : direktoriju, atgriešanas vērtība ir masīvs : saraksts, failu saraksts

...
Mēs izmantojam [vscode](https://code.visualstudio.com/) lai ierakstītu `MarkDown` , kā arī instalējam spraudni [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) , lai priekšskatītu reāllaikā rakstīšanas laikā.

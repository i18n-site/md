...
Pēc vairāk nekā pusgada izstrādes [https://i18n.site](//i18n.site) tiešsaistē.

Pašlaik ir ieviesti divi atvērtā pirmkoda komandrindas rīki:

* `i18` : MarkDown tulkošanas rīks
* `i18n.site` Vairāku : statisko dokumentu vietņu ģenerators, **kas optimizēts lasīšanas pieredzei**
...
Piemēram, savienojot statisko dokumentu vietni ar sociālo mediju un e-pasta abonementiem, lietotājus var sasniegt savlaicīgi, kad tiek izdoti atjauninājumi.
...
Komandrinda [iegulta js boa_engine](https://docs.rs/boa_engine) , [iegulta datu bāze fjall](https://github.com/fjall-rs/fjall) .

serveris [contabo](https://my.contabo.com) VPS

datu bāze [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

<h1 style="display:flex;justify-content:space-between">i18n.site Starptautiski risinājumi<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Projekta apraksts
...
`Markdown` un `YAML` komandrindas rīkā ( [avota kodā](https://github.com/i18n-site/rust/tree/main/i18) ) vairākās valodās.

Var lieliski uzturēt formātu `Markdown` Var identificēt failu modifikācijas un tulkot tikai mainītos failus.
...
Mēs piekrītam `UNIX` ir fails " " un varam pārvaldīt tulkojumus simtiem valodu, neieviešot sarežģītus un apgrūtinošus uzņēmuma līmeņa risinājumus.

Tulkojuma `Markdown` varat izmantot pazīstamākos rīkus (bet nevarat pievienot vai dzēst rindkopas) un izmantot vispazīstamāko versiju kontroles veidu.

Koda bāzi var izveidot kā atvērto avotu valodu failiem, un ar `Pull Request` procesa palīdzību globālie lietotāji var piedalīties nepārtrauktā tulkojumu optimizācijā. Nevainojams savienojums un [github](//github.com) atvērtā pirmkoda kopienas.
...
Tīri statiska, optimizēta lasīšanas pieredzei un integrēta ar [i18](#i18) tā ir labākā izvēle projekta dokumentu vietnes izveidei.
...
Šī vietne ir izstrādāta, pamatojoties uz šo sistēmu, un tajā ir iekļautas lietotāja, maksājumu un citas funkcijas ( [avota kods](/i18n.site/src) ). Detalizēta apmācība tiks uzrakstīta vēlāk.

[→ Lai iegūtu lietotāja rokasgrāmatu, lūdzu, izlasiet projekta dokumentāciju](/i18n.site) .

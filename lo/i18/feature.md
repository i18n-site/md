...
ຄຳເຫັນການແປຕ້ອງລະບຸພາສາຫຼັງ ` ``` ` ` ```rust ` :
...
ກະລຸນາ <button onclick="mailsub()">ຄລິກໃສ່ອີເມລ໌ນີ້ເພື່ອສະຫມັກການປັບປຸງຜະລິດຕະພັນ</button> ແລະ <button onclick="webpush()">ເຮັດໃຫ້ການຊຸກຍູ້ຂອງຕົວທ່ອງເວັບ</button> ຂອງພວກເຮົາຈະແຈ້ງໃຫ້ທ່ານຮູ້ຈັກເມື່ອຜະລິດຕະພັນໄດ້ຮັບການປັບປຸງ.

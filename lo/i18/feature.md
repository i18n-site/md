...
Markdown `<code>` ການແປ HTML `MarkDown` `<pre>` HTML
...
`summary` ຮັບການກຳນົດຄ່າ `description` ຫົວ `title` [HOGO](https://github.com/gohugoio/hugo)
...
ແປເປັນພາສາ `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

...
brief: |
  i18n.site ຕອນນີ້ຮອງຮັບການຊອກຫາຂໍ້ຄວາມເຕັມແບບເຊີບເວີ.
...
ມັນບໍ່ສາມາດນໍາໃຊ້ອອຟໄລ, ບໍ່ສາມາດນໍາໃຊ້ໃນອິນทຣາເນັດ, ແລະມີຂໍ້ຈໍາກັດທີ່ຍິ່ງໃຫຍ່. ບົດຄວາມນີ້ບໍ່ໄດ້ສົນທະນາຫຼາຍ.
...
* `/\p{P}/` ເປັນເຄື່ອງໝາຍທີ່ກົງກັບເຄື່ອງໝາຍຈຸດທີ່ກົງກັນໂດຍສະເພາະລວມມີ: `! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \ ] ^ _ ` { | } ~. `.</p><ul><li> `split('.')` ແມ່ນຍ້ອນວ່າ `Firefox` ການແບ່ງສ່ວນຄໍາສັບຂອງຕົວທ່ອງເວັບບໍ່ໄດ້ segment `.` .</li>
...
ເພື່ອສະແດງຜົນການຄົ້ນຫາໃນຂະນະທີ່ຜູ້ໃຊ້ກໍາລັງພິມ, ຕົວຢ່າງ, ເມື່ອ `wor` ຖືກປ້ອນ, ຄໍາທີ່ນໍາຫນ້າດ້ວຍ `wor` ເຊັ່ນ `words` ແລະ `work` ຈະສະແດງ.

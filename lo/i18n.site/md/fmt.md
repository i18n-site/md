...
ການແກ້ໄຂຈຸດສະມໍທີ່ຕົກລົງກັບ `i18n.site` ແມ່ນການໃສ່ຂໍ້ຄວາມທີ່ຄ້າຍຄືກັນກັບ `<a rel=id href="#xxx" id="xxx"></a>` ໃນ `MarkDown` ເພື່ອສ້າງຈຸດສະມໍດ້ວຍຕົນເອງ.

`<a rel=id href="#xxx" id="xxx"></a>` , ທີ່ນີ້ `rel=id` ກໍານົດຮູບແບບຫນ້າຂອງຈຸດສະມໍ, ກະລຸນາປ່ຽນແທນ `xxx` ດ້ວຍຕົວຫຍໍ້ພາສາອັງກິດຂອງສະມໍ.
...
## ຮູບພາບ/ວິດີໂອ/ການເຊື່ອມຕໍ່ໃນຫຼາຍພາສາ

ຫຼັງຈາກ `MarkDown` ຖືກປ່ຽນເປັນ `HTML` , `$LANG` ໃນຄຸນລັກສະນະ `src` ແລະ `href` ຈະຖືກແທນທີ່ດ້ວຍ [ລະຫັດພາສາ](/i18/LANG_CODE) ປັດຈຸບັນ.

ດ້ວຍຕົວແປນີ້, ທ່ານສາມາດບັນລຸການເວົ້າຫຼາຍພາສາຂອງຮູບພາບ / ວິດີໂອ / ການເຊື່ອມຕໍ່.
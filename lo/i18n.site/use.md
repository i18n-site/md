...
ຊື່ໄດເຣັກທໍຣີຂອງໂຄນນຖານລະຫັດ `demo.i18n.site` ຈະຕ້ອງເປັນ `md` ເພື່ອອຳນວຍຄວາມສະດວກໃນການສະແດງຕົວຢ່າງທ້ອງຖິ່ນດ້ວຍ `docker` .
...
ເມື່ອເຜີຍແຜ່ໂດຍອີງໃສ່ແພັກເກັດ `npm` , ໃຫ້ **ແນ່ໃຈວ່າໃຊ້ `//unpkg.com/`** ສໍາລັບຄໍານໍາຫນ້າຂອງ `v:` ຄ່າ `i18n.site` ໄດ້ປັບແຕ່ງເວລາແຄດຂອງ `/.v` ພາຍໃຕ້ເສັ້ນທາງຄໍານໍາຫນ້ານີ້ເພື່ອບັນລຸເວລາການເບິ່ງສະບັບໃຫມ່.

ແລ່ນ `i18n.site --npm` ຫຼື `i18n.site -n` ໃນໄດເຣັກທໍຣີ `md` ເພື່ອແປ ແລະເຜີຍແຜ່.

ຖ້າທ່ານໃຊ້ສະພາບແວດລ້ອມການເຊື່ອມໂຍງຢ່າງຕໍ່ເນື່ອງເພື່ອເຜີຍແຜ່, ບໍ່ຈໍາເປັນຕ້ອງຕິດຕັ້ງ `nodejs` , ພຽງແຕ່ຄັດລອກການເຂົ້າສູ່ລະບົບແລະເຜີຍແຜ່ການອະນຸຍາດ `~/.npmrc` ກັບສະພາບແວດລ້ອມ.
...
#### ປັບປະຕິບັດການນໍາໃຊ້ເວັບໄຊທ໌ໃນຈີນແຜ່ນດິນໃຫຍ່
...
ຫຼັງຈາກ `CDN` , ການນໍາໃຊ້ການເກັບຮັກສາວັດຖຸ `out/ol/htm` ຜູ້ຂາຍຟັງໃນຈີນແຜ່ນດິນໃຫຍ່ +
...
ການແກ້ໄຂການເພີ່ມປະສິດທິພາບການໃຊ້ງານເຫຼົ່ານີ້ມີຄວາມຊັບຊ້ອນຫຼາຍຂຶ້ນ ແລະຈະຖືກນໍາສະເໜີໃນບົດທີ່ຕ່າງຫາກໃນອະນາຄົດ.
...
ກະລຸນາເພີ່ມການຕັ້ງຄ່າທີ່ຄ້າຍຄືກັບຕໍ່ໄປ `/root/i18n/md/out/ol/htm` ໃນ `server` ວັກຂອງ nginx `out/ol/htm`

...
ຫຼັງຈາກ `CDN` , ການນໍາໃຊ້ການເກັບຮັກສາວັດຖຸ `out/ol/htm` ຜູ້ຂາຍຟັງໃນແຜ່ນດິນໃຫຍ່ຂອງຈີນ +

...
`name` , `url` ແລະ `title` ແມ່ນທາງເລືອກທັງຫມົດ. ຖ້າ `name` ບໍ່ໄດ້ຕັ້ງ, ຊື່ທີ່ສໍາຄັນ (ທີ່ນີ້ `marlowe` ) ຈະຖືກໃຊ້ເປັນ `name` .
...
ຖ້າທ່ານຕ້ອງການປັກໝຸດບົດຄວາມໄວ້ເທິງສຸດ, ກະລຸນາແລ່ນ `i18n.site` ແລະແກ້ໄຂ `xxx.yml` ໄຟລ໌ຂ້າງລຸ່ມ `.i18n/data/blog` , ແລະປ່ຽນເວລາເປັນຕົວເລກລົບ (ຕົວເລກລົບຫຼາຍຕົວຈະຖືກຈັດຮຽງຈາກໃຫຍ່ຫານ້ອຍສຸດ).
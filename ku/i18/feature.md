...
Piştgiriya wergerandina mixed HTML Markdown , naveroka di `<pre>` û `<code>` tagên HTML yên ku di nav `MarkDown` de cih digirin nayê wergerandin
...
Çîn, Japon û Kore tîpên mezin an piçûk nînin, lê sernavên îngilîzî bi gelemperî tîpa yekem mezin dikin.
...
Ya jorîn DeepL Fransî (her weha navên xwerû ji nû ve binivîsin û `... ` jî lê zêde bikin):

...
Em bikar [vscode](https://code.visualstudio.com/) ku `MarkDown` binivîsin û pêveka [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) saz bikin da ku di dema nivîsandinê de pêşdîtin bikin.

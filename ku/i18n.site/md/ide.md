...
Em ji bo nivîsandina `MarkDown` [vscode](https://code.visualstudio.com/) ê bikar tînin, û di heman demê de pêveka [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) saz dikin ku di dema nivîsandinê de pêşdîtin bikin.
...
Ji bo barkirina wêneyan [PicList](https://github.com/Kuingsmile/PicList) bînin, ji bîr mekin ku mifteya barkirinê saz bikin, û dîmenê bi yek klîk barkirin.

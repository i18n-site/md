...
Ji kerema xwe pêşî nirxa `host:` jorîn li ser navê domaina xwe biguherînin, wek `i18n.site` .
...
Di veavakirinê de, ji kerema xwe `i18n.site` biguherînin nirxa `host:` di `.i18n/htm/ol.yml` de, gelek firotgehên tiştan dikarin di binê `s3` de werin mîheng kirin, û qada `region` vebijarkî ye (gelek dikanên tiştan ne hewce ne ku vê qadê saz bikin).
...
Rêbazên verastkirinê wekî jêrîn bicîh bikin, ji kerema xwe koda "i18n.site" li ser navê domaina xwe biguhezînin
...
Dûv re skrîptê di [EdgeJS devê](//console.bce.baidu.com/cdn/#/cdn/ejs/list) de wekî jêrîn biafirînin
...
Ji ber ku `R2` `cloudflare` bi navek domainek xwerû ve were gihandin, pêdivî ye ku hilanînek tişta sêyemîn were bikar anîn da ku pelên statîk bi cîh bike.

Li vir em mînakek [backblaze.com](https://www.backblaze.com) da ku destnîşan bikin ka meriv çawa tiştên sêyemîn ên ku li `cloudflare` têne hilanîn girêdide.

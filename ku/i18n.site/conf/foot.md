...
Bi karanîna `${I18N.xxx}` ya mîna vê rêbazê nivîsandinê, bi `i18n.yml` re hevgirtî, hûn dikarin navneteweyîbûna pirzimanî ya jêrîn bigihîjin.

Zêdekirina `class="a"` li ser lînkê ew e ku pêşî li veguhertina lînka `MarkDown` bigire. Binêre :
 [➔ `YAML` : çawa pêşî li guherandina girêdana `HTML` `Markdown` digire](/i18/qa#H2) .
...
* `i18n.addon/toc` :
  Indeksa pelrêça `json` li ser bingeha `TOC` biafirîne, ku ji hêla xwerû ve hatî çalak kirin
...
`htmIndex.js` dê heta dawiya `.i18n/htm/index.js` were derzî kirin.
...
* `lang_li` Lîsteya : , zimanê yekem zimanê çavkanî ye

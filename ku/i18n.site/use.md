...
Heke hûn ji bo weşandinê jîngehek întegrasyonê ya domdar bikar tînin, ne hewce ye ku `nodejs` saz bikin, tenê destûrnameya têketin û weşandinê `~/.npmrc` li hawîrdorê kopî bikin.
...
Ji kerema xwe veavakirinek mîna ya jêrîn di paragrafa `server` ya nginx de zêde bikin Ji kerema xwe `/root/i18n/md/out/ol/htm` biguherînin riya projeya xwe `out/ol/htm` :

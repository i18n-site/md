<h1 style="justify-content:space-between">3Ti.Malper · Fikirîna Bê Sînor<img src="//i-01.eu.org/3Ti/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>

3Ti.Site, wergera Markdown + jeneratorê malpera statîk a pirzimanî.

Ew dihêle hûn zû belge û blogên navneteweyî yên ku [bi sedan zimanan](https://github.com/i18n-site/node/blob/main/lang/src/index.js) piştgirî dikin ava bikin.

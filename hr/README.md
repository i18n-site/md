...
Prevedite `Markdown` i `YAML` u alat naredbenog retka ( [izvorni kod](https://github.com/i18n-site/rust/tree/main/i18) ) na više jezika.
...
Dijelimo " `UNIX` is a File " i možemo upravljati prijevodima na stotine jezika bez uvođenja složenih i glomaznih rješenja na razini poduzeća.

Možete koristiti najpoznatije alate za `Markdown` prijevoda (ali ne možete dodavati ili brisati odlomke) i koristiti najpoznatiji način za kontrolu verzija.

Baza koda može se stvoriti kao otvoreni kod za jezične datoteke, a uz pomoć procesa `Pull Request` , globalni korisnici mogu sudjelovati u kontinuiranoj optimizaciji prijevoda. Besprijekorna veza [github](//github.com) druge zajednice otvorenog koda.

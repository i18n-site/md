...
S društvenim medijima i e-poštom ljudi su navikli fokusirati se na izvore informacija na vlastitom materinjem jeziku.

S eksplozijom informacija i globalnim tržištem, kako bi se natjecali za oskudnu pozornost, **podržavanje više jezika osnovna je vještina** .
...
> [!TIP]
> Pretplaćujemo se na filozofiju `UNIX` " Sve je datoteka " i možemo upravljati prijevodima na stotine jezika bez uvođenja složenih i glomaznih rješenja na razini poduzeća.
...
[→ Za korisničke upute pročitajte projektnu dokumentaciju](/i18) .
...
#### <a rel=id href="#price" id="price"></a> Vrlo konkurentne cijene
...
[Kliknite ovdje za autorizaciju i automatsko i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) i **primajte bonus $50** .
...
Ova web stranica je razvijena na temelju ovog okvira i uključuje korisničke, plaćanja i druge funkcije ( [izvorni kod](/i18n.site/src) će biti napisan kasnije).

[→ Za korisničke upute pročitajte projektnu dokumentaciju](/i18n.site) .

## Ostati U Kontaktu

<button onclick="mailsub()">Kliknite ovu e-poštu da biste se pretplatili na ažuriranja proizvoda</button> i <button onclick="webpush()">omogućili push preglednik</button> . Obavijestit ćemo vas kada se proizvodi ažuriraju.
...
>
> GOSPODIN je to vidio i rekao: "Sva ljudska bića imaju isti jezik i rasu. Sada kada je ovo ostvareno, sve će biti učinjeno."
>
...
Želimo izgraditi internet bez jezične izolacije.
Nadamo se da će se cijelo čovječanstvo okupiti u zajedničkom snu.

Markdown stranica za prijevod i dokumentaciju samo je početak.

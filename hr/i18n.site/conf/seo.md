...
Budući da `R2` `cloudflare` pristupiti pomoću prilagođenog naziva domene, potrebno je koristiti pohranu objekata treće strane za postavljanje statičkih datoteka.

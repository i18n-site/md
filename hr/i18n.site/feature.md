...
`i18n.site` će prema zadanim `npmjs.com` objaviti sadržaj stranice uz pomoć [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) i drugih `CDN` sadržaja učitanih na `npm` .
...
Načelo je: presretanje zahtjeva s [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , ponovno pokušaj neuspješnih zahtjeva na drugim `CDN` i adaptivno omogućiti izvorno mjesto koje najbrže reagira kao zadani izvor učitavanja.

Povezani kod : [github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker)

## Aplikacija Na Jednoj Stranici, Iznimno Brzo Učitavanje

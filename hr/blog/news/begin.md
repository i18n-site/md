...
Prijevod se može uređivati; izmijenite izvorni tekst, a kada se ponovno strojno prevede, ručne izmjene prijevoda neće biti prebrisane (ako ovaj odlomak izvornog teksta nije izmijenjen).
...
Dakle, razvio sam alat za prevođenje `i18` i izgradio višejezični generator statične web stranice `i18n.site` na temelju alata za prevođenje.

![](https://p.3ti.site/1723777556.avif)

Ovo je tek početak, ima još mnogo toga za napraviti.

Na primjer, povezivanjem stranice sa statičnim dokumentima s društvenim medijima i pretplatama na e-poštu, korisnici se mogu dobiti na vrijeme kada se objave ažuriranja.

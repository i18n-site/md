<h1 style="display:flex;justify-content:space-between">i18n.site Ynternasjonale oplossingen<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Projekt Beskriuwing
...
`Markdown` en `YAML` yn in kommandorigelark ( [boarnekoade](https://github.com/i18n-site/rust/tree/main/i18) ) yn meardere talen.

Kin perfekt ûnderhâlde it formaat fan `Markdown` Kin bestânwizigingen identifisearje en allinich feroare bestannen oersette.
...
Wy diele " filosofy `UNIX` Everything is a File " en kinne oersettingen yn hûnderten talen beheare sûnder komplekse en omslachtige oplossingen op bedriuwsnivo yn te fieren.

Jo kinne de meast bekende ark brûke om de oersetting `Markdown` (mar jo kinne gjin paragrafen tafoegje of wiskje), en de meast bekende manier brûke om ferzjekontrôle te dwaan.

In koadebasis kin makke wurde as in iepen boarne foar taalbestannen, en mei help fan it proses fan `Pull Request` Naadleaze [github](//github.com) en oare iepen boarne mienskippen.

[→ Lês asjebleaft de projektdokumintaasje foar brûkershantlieding](/i18) .

## Xindaya's Oersetting Fan Hege Kwaliteit
...
Om deselde kwaliteit `2.67` berikken, is it bedrach fan hânmjittich bewurkjen `3.15` nedich is troch Google Translate en `ChatGPT`
...
Suver statysk, optimalisearre foar lêsûnderfining, en yntegreare mei de oersetting fan [i18](#i18) it is de bêste kar foar it bouwen fan in projektdokumintside.
...
Dizze webside is ûntwikkele op basis fan dit ramt en omfettet brûker, betelling en oare funksjes ( [boarnekoade](/i18n.site/src) ) In detaillearre tutorial sil letter skreaun wurde.

[→ Lês asjebleaft de projektdokumintaasje foar brûkershantlieding](/i18n.site) .

## Bliuw Yn Kontakt

<button onclick="mailsub()">Klikje asjebleaft op dizze e-post om te abonnearjen op produktupdates</button> en <button onclick="webpush()">ynskeakelje browserpush</button> .
...
As jo problemen tsjinkomme [→ post dan asjebleaft op it brûkersfoarum](https://groups.google.com/u/1/g/i18n) .

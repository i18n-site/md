...
It footer-ikoan wurdt oanmakke troch in lettertype te meitsjen mei `F` iconfont.cn [Ingelske ferzje](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
It tafoegjen fan `class="a"` oan de keppeling is om foar te kommen dat de keppeling wurdt omsetten nei `MarkDown` Sjoch :
 [➔ `YAML` Hoe kinne : foarkomme dat keppeling `HTML` wurdt omsetten nei `Markdown`](/i18/qa#H2) .
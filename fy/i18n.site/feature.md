# Eigenskip Fan Produkt

## Yntegreare `I18`

It programma hat `i18` oersetting, sjoch asjebleaft [➔ `i18`](/i18) foar spesifyk gebrûk.
...
It prinsipe is: ûnderskeppe it fersyk mei help fan [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) as it fersyk mislearret, probearje it opnij op oare `CDN` , en skeakelje it rapste reagearjende oarsprongstasjon oan as de standert laden boarne.
...
Standert binne [Alimama dual-axis fariabele rjochthoekige lettertypen](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) en oare online lettertypen ynskeakele op 'e webside om de lêsûnderfining fan brûkers op ferskate platfoarms te ferienigjen.
...
By it rôljen fan 'e ynhâld oan' e rjochterkant sil de omtrek oan 'e lofter tagelyk it haadstik dat op it stuit lêzen wurdt markearje.
...
`404` r is in leuk lyts driuwend spoek op 'e side, syn eagen sille mei de mûs bewege, [➔ Klik hjir om te sjen](/404) ,!

## Koade Iepen Boarne

[De koade is iepen boarne](/i18n.site/src) [.](//groups.google.com/u/2/g/i18n-site)

...
Besykje [i18n.site/token](//i18n.site/token) Klikje om token te kopiearjen
...
[i18n.site/payBill](//i18n.site/payBill) moatte jo in kredytkaart bine foar betelling (gjin opladen is nedich, de webside sil automatysk fergoedingen ôflûke neffens gebrûk, [sjoch de thússide foar prizen](/#price) ).
...
Ferskillende `fromTo` kinne wurde konfigureare : ferskate submappen /
...
As jo beskate bestannen negearje wolle en se net oersette (lykas ûnfoltôge ûntwerpen), kinne jo de `ignore` fjildkonfiguraasje brûke.

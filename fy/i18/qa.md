...
It tafoegjen fan in oare attribút dan `href` oan de `a` tag, lykas `<a class="A" href="/">Home</a>` , kin dizze konverzje foarkomme.

## `./i18n/hash` Triem Konflikten Hjirûnder

Wiskje de tsjinstridige bestannen en fier `i18` oersetting wer út.
...
# Pure Front-End Omkeard Folsleine Tekstsykjen
...
1. Pre-boud yndeks triemmen
   ...
   It sil de wachttiid fan 'e brûker fergrutsje en in protte bânbreedte ferbrûke.
...
Fanwegen de tekortkomingen fan 'e besteande oplossingen ûntwikkele `i18n.site` in nije suvere front-end folsleine-tekst sykaksje, dy't de folgjende skaaimerken hat :
...
1. Unterstützt sykjen nei foarheaksels, dy't sykresultaten yn realtime kinne werjaan wylst de brûker oan it typen is.
1. Offline Beskikber
...
* `rindex` : Word id - Dokumint id : Array fan linenûmers
...
Omkearde sykaksje mei folsleine tekst ymplementearre puur op 'e foarkant, gjin server nedich. It is tige geskikt foar lytse en middelgrutte websiden lykas dokuminten en persoanlike blogs.

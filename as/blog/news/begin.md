...
* `i18n.site` : স্থিতিশীল দস্তাবেজ চাইট জেনেৰেটৰ, **পঢ়া অভিজ্ঞতাৰ বাবে অনুকূলিত**
...
বৰ্ত্তমানৰ `git` ব্যৱস্থাপনা সঁজুলিসমূহ অতি গধুৰ।
...
[chasquid](https://github.com/albertito/chasquid) -নিৰ্মিতলৈ মেইল পঠাওক SMTP

## আমাৰ সৈতে যোগাযোগ কৰক

নতুন সামগ্ৰী মুকলি হ’লে সমস্যা অনিবাৰ্য হৈ পৰে।

গুগল ফ'ৰামৰ জৰিয়তে আমাৰ সৈতে যোগাযোগ কৰিব [groups.google.com/u/2/g/i18n-site](https://groups.google.com/u/2/g/i18n-site) :
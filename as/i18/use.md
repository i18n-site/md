...
windows , অনুগ্ৰহ কৰি [ইয়াত ক্লিক কৰি প্ৰথমে `git bash` ডাউনলোড আৰু ইনষ্টল কৰক](https://git-scm.com/download/win) ।
...
তাৰ ভিতৰত `.i18n/cache/.gitignore` ৰ বিষয়বস্তু তলত দিয়া ধৰণৰ :
...
ইয়াৰ অৰ্থ হ'ল `.i18n/cache/` পঞ্জিকাৰ সকলো নথিপত্ৰ ( `.i18n/cache/.gitignore` বাহিৰে) আওকাণ কৰা হয় ।

যদি আপোনাৰ সংস্কৰণ নিয়ন্ত্ৰণ চফ্টৱেৰ `git` নহয়, অনুগ্ৰহ কৰি এই বিন্যাস অনুসৰি ইয়াক আওকাণ কৰক ।
...
যদি আপুনি সকলো সমৰ্থিত ভাষালৈ অনুবাদ কৰিব বিচাৰে, অনুগ্ৰহ কৰি `:` পিছত খালী ৰাখক। উদাহৰণ স্বৰূপে
...
আপুনি বিভিন্ন উপডাইৰেকটৰ বাবে বিভিন্ন `fromTo` বিন্যাস কৰিব পাৰে : /
...
এই বিন্যাস টেবুলত, কেটেলগ `blog` অনুবাদৰ উৎস ভাষা `zh` , আৰু `blog/your_file_name.md` অনুবাদৰ উৎস ভাষা `ja` ।
...
`ignore` `.gitignore` ফাইলৰ দৰে একে [globset](https://docs.rs/globset/latest/globset/#syntax) ব্যৱহাৰ কৰে।

...
## একাধিক ভাষাত ছবি/ভিডিঅ'/লিংক

`MarkDown` `HTML` লৈ ৰূপান্তৰ কৰাৰ পিছত, বৈশিষ্ট্য `src` আৰু `href` ত `$LANG` বৰ্তমান [ভাষা ক'ডৰ](/i18/LANG_CODE) সৈতে সলনি কৰা হব।

এই চলকটোৰ সহায়ত আপুনি ছবি/ভিডিঅ'/লিংকসমূহৰ বহুভাষিককৰণ লাভ কৰিব পাৰিব।
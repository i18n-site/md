...
`i18n.site` ৰ সৈতে একমত হোৱা এংকৰ পইণ্ট সমাধান হ'ল `MarkDown` ত `<a rel=id href="#xxx" id="xxx"></a>` ৰ দৰে লিখনী সন্নিবিষ্ট কৰা যাতে পজিচনিং এংকৰ পইণ্টটো হস্তচালিতভাৱে সৃষ্টি কৰিব পাৰি।
...
মন কৰিব যে ওপৰত `<pre>` ত `<style>` সংজ্ঞাও দিয়া হৈছে।
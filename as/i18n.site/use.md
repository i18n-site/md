...
`md/.i18n/htm/ol.yml` সম্পাদনা কৰক আৰু [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` মান সলনি কৰক আপোনাৰ নিজৰ `npm` সৰঞ্জামৰ নাম [npmjs.com](//npmjs.com) ।

তাৰ পিছত `md/.i18n/htm/ol.package.json` পৰিবৰ্তন কৰক

...
চলোৱাৰ পিছত, অনুবাদ আৰু কেশ্ব নথিপত্ৰসমূহ সৃষ্টি কৰা হ'ব অনুগ্ৰহ কৰি `git add . ` `md` পঞ্জিকাত ভঁৰাললৈ যোগ কৰিবলৈ মনত ৰাখিব।
...
`i18n.site` এটা [একক-পৃষ্ঠা এপ্লিকেচন](https://developer.mozilla.org/docs/Glossary/SPA) স্থাপত্য গ্ৰহণ কৰে, আৰু ৱেবছাইট প্ৰৱেশ পৃষ্ঠা আৰু ৱেবছাইট বিষয়বস্তু স্বতন্ত্ৰভাৱে মোতায়েন কৰা হয়।
...
`htm` ডাইৰেক্টৰী হৈছে ৱেবছাইটৰ প্ৰৱেশ পৃষ্ঠা।
...
অফিচিয়েল মুক্তিৰ বাবে, পৰিবৰ্তন কৰা ফাইলসমূহক নতুন সংস্কৰণ নম্বৰ পঞ্জিকালৈ কপি কৰা হব।
...
`ol` হৈছে `online` ৰ সংক্ষিপ্তকৰণ, `-n` অনলাইন পৰিৱেশক সূচায়, যি অফিচিয়েল মুক্তিৰ বাবে ব্যৱহাৰ `npm` হয়।
...
পেকেইজ `npm` ৰ ওপৰত ভিত্তি কৰি প্ৰকাশ কৰাৰ সময়ত, `v:` ৰ উপসৰ্গৰ **বাবে `//unpkg.com/` ব্যৱহাৰ কৰাটো নিশ্চিত কৰক** `i18n.site` এ এই উপসৰ্গ পথৰ অন্তৰ্গত `/.v` ৰ কেশ্ব সময় বিশেষভাৱে অনুকূল কৰিছে নতুন উন্মোচনসমূহৰ সময়মতে দৰ্শন লাভ কৰিবলে।
...
শেষত, **`/.v` ৰ পৰা `1s` লৈ শেষ হোৱা পথৰ কেশ্ব সময় বিন্যাস কৰক** , অন্যথা নতুনকৈ মুকলি কৰা বিষয়বস্তু তৎক্ষণাত অভিগম কৰিব নোৱাৰি ।
...
বিষয়বস্তু স্ব-হ'ষ্ট `CDN` , আপোনাৰ নিজৰ চাৰ্ভাৰ ব্যৱহাৰ কৰাৰ উপৰিও, আন এটা সাধাৰণ বিকল্প হ'ল `S3` ব্যৱহাৰ কৰা +

আপুনি `S3` চাৰ্ভাৰত `S3` ইন কৰিবলে [rclone](https://rclone.org)
...
[এটা সংস্থা সৃষ্টি কৰিবলৈ প্ৰথমে ইয়াত ক্লিক github](https://github.com/account/organizations/new?plan=free) `i18n-demo`
...
`github page` [cloudflare page](//pages.cloudflare.com) সৈতে তুলনা কৰিলে, ই পথ পুনৰ লিখা প্ৰদান কৰে আৰু মূল চীনৰ বাবে অধিক বন্ধুত্বপূৰ্ণ আৰু ইয়াক ব্যৱহাৰ কৰাটো বাঞ্ছনীয়।

`cloudflare page` ৰ মোতায়েন সাধাৰণতে ওপৰৰ `github page` ৰ মোতায়েনৰ ওপৰত ভিত্তি কৰি কৰা হয়।

এটা প্ৰকল্প সৃষ্টি কৰক আৰু ওপৰৰ `i18n-demo.github.io` গুদামটো বান্ধি লওক।
...
তাৰ পিছত, মূল চীনত ক্লাউড বিক্ৰেতাসকলৰ বস্তু সংৰক্ষণ ব্যৱহাৰ কৰক `CDN` নিম্নলিখিত বিষয়বস্তু মোতায়েন কৰক `out/ol/htm` +

আপুনি এজ কম্পিউটিং ব্যৱহাৰ কৰিব পাৰে একক-পৃষ্ঠা এপ্লিকেচনসমূহৰ সৈতে খাপ খুৱাবলৈ পথ পুনৰায় লিখিবলৈ [`CDN`](//cloud.baidu.com/product/cdn.html)
...
যিহেতু ৰেকৰ্ড `MX` আৰু ৰেকৰ্ড `CNAME` সহাৱস্থান কৰিব নোৱাৰে, যদি আপুনি একে সময়তে ডমেইন নামৰ ইমেইলসমূহ গ্ৰহণ কৰিব বিচাৰে, আপুনি ৰেকৰ্ড `A` লৈ স্তৰ `CNAME` লৈ লিপিৰ সৈতে সহযোগ কৰিব লাগিব [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten)
...
[আলিবাবা CDN](https://cdn.console.aliyun.com/domain/list) ডমেইন নাম যোগ কৰক আৰু আলিবাবা ক্লাউড `CDN` ত ডমেইন নাম `*.xxx.com` ৰ পৰা `CNAME` লৈ আঙুলিয়াওক।
...
উৎস ভাষা পঞ্জিকা, `.i18n/conf.yml` বিন্যাস নথিপত্ৰত `fromTo` ৰ `en` ৰ সৈতে সংগতি ৰাখি

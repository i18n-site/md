...
প্ৰগ্ৰেমটোত অনুবাদ বিল্ট-ইন আছে `i18` নিৰ্দিষ্ট ব্যৱহাৰৰ বাবে অনুগ্ৰহ কৰি [➔ `i18`](/i18) চাওক।
...
`i18n.site` , চাইটৰ বিষয়বস্তু `npmjs.com` লৈ প্ৰকাশ কৰা হ'ব, [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) `CDN` সহায়ত আৰু `npm` .
...
নীতিটো `CDN` : অনুৰোধটো [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
পেজত এটা মৰমলগা সৰু ভাসমান ভূত আছে, তাৰ চকু দুটা মাউছৰ লগত লৰচৰ কৰিব, [➔ ইয়াত ক্লিক কৰি চাব](/404) , `404`

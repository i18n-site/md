...
### `use: Toc` , ৰূপৰেখাৰ সৈতে একক ফাইল সাঁচ
...
### `use: Md` , ৰূপৰেখা অবিহনে একক ফাইল সাঁচ
...
### `use: Doc` , বহু-ফাইল দস্তাবেজ সাঁচ
...
ওপৰৰ লিখা পদ্ধতিটো `url: xxx` ৰ সমতুল্য, আৰু ইয়াৰ সংশ্লিষ্ট ফাইলটো `en/xxx/TOC` ।

#### TOC বিষয়বস্তুৰ তালিকা সূচী

`i18n.site` ডেমো গুদামত `js` প্লাগ-ইন `.i18n/hook/after.tran/TOC.js` এক্সিকিউট কৰিব `TOC` পঞ্জিকা সূচী নথিপত্ৰ পঢ়িবলৈ `doc` সাঁচ বিন্যাসৰ সৈতে সংগতি ৰাখি `json` পঞ্জিকা ৰূপৰেখা সৃষ্টি কৰিবলে ।
...
`Doc` সাঁচটোৱে সৃষ্টি কৰা `json` ওপৰত ভিত্তি কৰি বিষয়বস্তুৰ ৰূপৰেখা ৰেণ্ডাৰ কৰিব।
...
মন কৰিব যে এই ফাইলৰ বিষয়বস্তুৱে বিষয়বস্তুৰ ৰূপৰেখা দেখুৱাব নোৱাৰে, গতিকে দৈৰ্ঘ্য সীমিত কৰা আৰু এটা চুটি পৰিচয় লিখাটো উপদেশিত।

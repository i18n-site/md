...
এই লিখা পদ্ধতিৰ সৈতে মিল থকা `${I18N.xxx}` ব্যৱহাৰ কৰি, `i18n.yml` ৰ সৈতে সংযুক্ত কৰি, আপুনি ফুটাৰৰ বহু-ভাষিক আন্তৰ্জাতিককৰণ লাভ কৰিব পাৰিব।

লিংকত `class="a"` যোগ কৰিলে লিংকটো `MarkDown` লৈ ৰূপান্তৰিত হোৱাত বাধা দিয়া হয়। চাওক :
 [➔ `YAML` লিংক `HTML` : `Markdown` ৰূপান্তৰিত হোৱাত কেনেকৈ বাধা দিব পাৰি](/i18/qa#H2) .
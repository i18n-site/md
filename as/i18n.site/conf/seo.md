...
`i18n.site` এটা নন-ৰিফ্ৰেছ একক পৃষ্ঠা স্থাপত্য গ্ৰহণ কৰে সন্ধান সূচীকৰণ সহজ কৰিবলে, এটা পৃথক স্থিতিশীল পৃষ্ঠা আৰু `sitemap.xml` ক্ৰ'লাৰসমূহৰ বাবে সৃষ্টি কৰা হ'ব।
...
বিন্যাসত, অনুগ্ৰহ কৰি `i18n.site` `.i18n/htm/ol.yml` ত `host:` ৰ মানলৈ সলনি কৰক, একাধিক বস্তু সংৰক্ষণক `s3` অন্তৰ্গত বিন্যাস কৰিব পাৰি, আৰু `region` ক্ষেত্ৰ বৈকল্পিক (বহু বস্তু সংৰক্ষণে এই ক্ষেত্ৰ সংহতি কৰাৰ প্ৰয়োজন নাই) ।
...
উদাহৰণস্বৰূপে, [হুৱেই DNS](https://www.huaweicloud.com) বিনামূলীয়া আঞ্চলিক বিশ্লেষণ প্ৰদান কৰে, যাৰ সৈতে মূল চীনৰ যাতায়ত বাইডু স্মাৰ্ট ক্লাউডৰ জৰিয়তে যাব পাৰে, আৰু আন্তঃৰাষ্ট্ৰীয় ট্ৰেফিক `cloudflare` ৰ মাজেৰে যাব পাৰে।
...
যিহেতু `R2` এটা স্বনিৰ্বাচিত ডমেইন নামৰ দ্বাৰা অভিগম `cloudflare` , এটা তৃতীয়-পক্ষ বস্তু সংৰক্ষণ ব্যৱহাৰ কৰিব লাগিব স্থিতিশীল নথিপত্ৰসমূহ স্থাপন কৰিবলে।

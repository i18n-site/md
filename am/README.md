...
`Markdown` እና `YAML` ን ወደ ብዙ ቋንቋዎች የሚተረጎም የትእዛዝ መስመር መሳሪያ ( [ምንጭ ኮድ](https://github.com/i18n-site/rust/tree/main/i18) )።

የ `Markdown` ቅርጸትን በትክክል ማቆየት ይችላል። የፋይል ማሻሻያዎችን መለየት እና የተቀየሩ ፋይሎችን ብቻ መተርጎም ይችላል።

ትርጉሙ ሊስተካከል የሚችል ነው።

ዋናውን ጽሑፍ አሻሽለው በማሽን-እንደገና ተርጉመው፣ በትርጉሙ ላይ የተደረጉ ማሻሻያዎች አይፃፉም (ይህ የዋናው ጽሑፍ አንቀጽ ካልተቀየረ)።

እኛ " `UNIX` ፍልስፍና ተመዝግበናል "

`Markdown` ለማርትዕ በጣም የታወቁ መሳሪያዎችን መጠቀም ይችላሉ (ነገር ግን አንቀጾችን ማከል ወይም መሰረዝ አይችሉም) እና የስሪት ቁጥጥር ለማድረግ በጣም የታወቀውን መንገድ ይጠቀሙ።

የኮድ መሰረት ለቋንቋ ፋይሎች ክፍት ምንጭ ሆኖ ሊፈጠር ይችላል፣ እና በ `Pull Request` ሂደቶች እገዛ አለምአቀፍ ተጠቃሚዎች ለትርጉሞች ቀጣይነት ባለው ማመቻቸት ላይ መሳተፍ ይችላሉ። እንከን የለሽ ግንኙነት እና ሌሎች ክፍት ምንጭ ማህበረሰቦች [github](//github.com)

[→ ለተጠቃሚ መመሪያ፣ እባክዎን የፕሮጀክት ሰነዶችን ያንብቡ](/i18) ።

## ምርጥ ጥራት ያለው ማሽን ትርጉም

ትርጉሞችን ትክክለኛ፣ ለስላሳ እና የሚያምር ለማድረግ የባህላዊ ማሽን የትርጉም ሞዴሎችን እና ትላልቅ የቋንቋ ሞዴሎችን ቴክኒካዊ ጥቅሞችን የሚያጣምር አዲስ የትርጉም ቴክኖሎጂ አዘጋጅተናል።
...
[ፍቃድ ለመስጠት እዚህ ጠቅ ያድርጉ እና የ github ን i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) እና **$50 ለመቀበል** ።

ማስታወሻ፡ የሚከፈሉ ቁምፊዎች ብዛት = በምንጭ ፋይል ውስጥ ያሉት [unicode ብዛት](https://en.wikipedia.org/wiki/Unicode) × በትርጉሙ ውስጥ ያሉ የቋንቋዎች ብዛት
...
የሁለት ቋንቋ አስተያየቶችን እና ቻት ሩም ይደግፋል;

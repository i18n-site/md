<h1 style="display:flex;justify-content:space-between">i18n.site አለም አቀፍ መፍትሄዎች<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
በመረጃ ፍንዳታ እና በአለምአቀፍ ገበያ ፣ለጎደለ ትኩረት ለመወዳደር ፣ **ብዙ ቋንቋዎችን መደገፍ መሰረታዊ ችሎታ ነው** ።

በሰፊው ተመልካቾች ላይ ተጽእኖ ለመፍጠር የሚፈልግ የግል ክፍት ምንጭ ፕሮጀክት ቢሆንም, ከመጀመሪያው ጀምሮ ዓለም አቀፍ የቴክኖሎጂ ምርጫ ማድረግ አለበት.

## <a rel=id href="#project" id="project"></a> የፕሮጀክት መግለጫ

ይህ ጣቢያ በአሁኑ ጊዜ ሁለት የክፍት ምንጭ የትእዛዝ መስመር መሳሪያዎችን ያቀርባል፡-

* [i18 : MarkDown መስመር የትርጉም መሣሪያ](/i18/feature)
* [i18n.site : ቋንቋ የማይንቀሳቀስ ድር ጣቢያ አመንጪ](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: MarkDown የትእዛዝ መስመር የትርጉም መሣሪያ

በበርካታ ቋንቋዎች `Markdown` እና `YAML` ወደ የትእዛዝ መስመር መሳሪያ ( [ምንጭ ኮድ](https://github.com/i18n-site/rust/tree/main/i18) ) ተርጉም።

ቅርጸቱን በትክክል ማቆየት ይችላል `Markdown` የፋይል ማሻሻያዎችን መለየት እና የተቀየሩ ፋይሎችን ብቻ መተርጎም ይችላል።

ትርጉሙ ሊስተካከል የሚችል ነው።

ዋናውን ጽሑፍ ይቀይሩ እና በማሽን ይተርጉሙት፣ በትርጉሙ ላይ የተደረጉ ማሻሻያዎች አይገለበጡም (ይህ የዋናው ጽሑፍ አንቀጽ ካልተቀየረ)።

የሁሉም ነገር " ነው `UNIX` " እንጋራለን እና ውስብስብ እና አስቸጋሪ የድርጅት ደረጃ መፍትሄዎችን ሳናመጣ በመቶዎች በሚቆጠሩ ቋንቋዎች ትርጉሞችን ማስተዳደር እንችላለን።

ትርጉሙን `Markdown` በጣም የታወቁ መሳሪያዎችን መጠቀም ይችላሉ (ነገር ግን አንቀጾችን ማከል ወይም መሰረዝ አይችሉም) እና የስሪት ቁጥጥር ለማድረግ በጣም የታወቀውን መንገድ ይጠቀሙ።

የኮድ መሰረት ለቋንቋ ፋይሎች እንደ ክፍት ምንጭ ሊፈጠር ይችላል፣ እና በ `Pull Request` 's ሂደት እገዛ አለምአቀፍ ተጠቃሚዎች ለትርጉሞች ቀጣይነት ባለው ማመቻቸት ላይ መሳተፍ ይችላሉ። እንከን የለሽ ግንኙነት እና ሌሎች ክፍት ምንጭ ማህበረሰቦች [github](//github.com)

[→ ለተጠቃሚ መመሪያ፣ እባክዎን የፕሮጀክት ሰነዶችን ያንብቡ](/i18) ።
...
የማይንቀሳቀስ፣ ለንባብ ልምድ የተመቻቸ እና ከ [i18](#i18) የፕሮጀክት ሰነድ ቦታን ለመገንባት ምርጡ ምርጫ ነው።

ከስር ያለው የፊት-መጨረሻ ማእቀፍ ሙሉ ተሰኪ አርክቴክቸርን ይቀበላል, ይህም ለሁለተኛ ደረጃ እድገት ቀላል ነው, አስፈላጊ ከሆነ, የኋላ-መጨረሻ ተግባራት ሊጣመሩ ይችላሉ.

ይህ ድረ-ገጽ የተዘጋጀው በዚህ ማዕቀፍ ሲሆን ተጠቃሚ፣ ክፍያ እና ሌሎች ተግባራትን ያካትታል ( [ምንጭ ኮድ](/i18n.site/src) ) ዝርዝር አጋዥ ስልጠና በኋላ ይፃፋል።

[→ ለተጠቃሚ መመሪያ፣ እባክዎን የፕሮጀክት ሰነዶችን ያንብቡ](/i18n.site) ።

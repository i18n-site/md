...
[i18n.site/payBill](//i18n.site/payBill) , ለክፍያ ክሬዲት ካርድ ማሰር ያስፈልግዎታል (ምንም መሙላት አያስፈልግም, ድህረ ገጹ በአጠቃቀም መሰረት ክፍያዎችን በራስ-ሰር ይቀንሳል, [ለዋጋ መነሻ ገጹን ይመልከቱ](/#price) ).
...
በዚህ የውቅር ሠንጠረዥ ውስጥ የካታሎግ `blog` ትርጉም ምንጭ ቋንቋ `zh` ነው, እና የካታሎግ `blog/your_file_name.md` ትርጉም ቋንቋ `ja` ነው.

### ፋይሉን ችላ በል

በነባሪ፣ የምንጭ ቋንቋ ማውጫ ውስጥ ከ `.md` እና `.yml` የሚጀምሩ ሁሉም ፋይሎች ይተረጎማሉ።

የተወሰኑ ፋይሎችን ችላ ለማለት እና ላለመተርጎም ከፈለጉ (እንደ ያልተጠናቀቁ ረቂቆች ያሉ) የ `ignore` የመስክ ውቅረትን መጠቀም ይችላሉ።

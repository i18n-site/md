...
ከነሱ መካከል የ `.i18n/cache/.gitignore` ይዘት እንደሚከተለው ነው :
...
ይህ ማለት በማውጫ `.i18n/cache/` ውስጥ ያሉ ሁሉም ፋይሎች ( `.i18n/cache/.gitignore` በስተቀር) ችላ ይባላሉ።

የእርስዎ ስሪት መቆጣጠሪያ ሶፍትዌር `git` ካልሆነ፣ እባክዎ በዚህ ውቅር መሰረት ችላ ይበሉት።

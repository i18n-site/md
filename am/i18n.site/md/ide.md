...
ስንጽፍ `MarkDown` ለመጻፍ እና ተሰኪውን [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ለመጫን [vscode](https://code.visualstudio.com/) ።

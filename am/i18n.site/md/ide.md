...
እኛ የምንጠቀመው `MarkDown` ለመጻፍ ነው [vscode](https://code.visualstudio.com/) እና ደግሞ ስንጽፍ በእውነተኛ ሰዓት ለማየት ተሰኪውን [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ይጫኑ።

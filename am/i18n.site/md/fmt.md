...
## ምስሎች/ቪዲዮዎች/አገናኞች በበርካታ ቋንቋዎች

`MarkDown` ወደ `HTML` ፣ `$LANG` በባህሪያት `src` እና `href` ከተለወጠ በኋላ አሁን ባለው [የቋንቋ ኮድ](/i18/LANG_CODE) ይተካል።

በዚህ ተለዋዋጭ፣ ሥዕሎች/ቪዲዮዎች/አገናኞች ብዙ ቋንቋዎችን ማሳካት ይችላሉ።
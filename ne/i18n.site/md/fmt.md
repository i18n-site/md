...
`i18n.site` सँग सहमत भएको एन्कर पोइन्ट समाधान भनेको म्यानुअल रूपमा पोजिशनिङ एन्कर पोइन्ट सिर्जना गर्न `<a rel=id href="#xxx" id="xxx"></a>` `MarkDown` पाठ घुसाउनु हो।

`<a rel=id href="#xxx" id="xxx"></a>` , यहाँ `rel=id` एन्कर पोइन्टको पृष्ठ शैली परिभाषित गर्दछ, कृपया `xxx` लाई आफ्नो वास्तविक एंकर अंग्रेजी संक्षिप्त नामले बदल्नुहोस्।

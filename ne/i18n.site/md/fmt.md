...
## धेरै भाषाहरूमा तस्बिर/भिडियो/लिङ्कहरू

`MarkDown` `HTML` मा रूपान्तरण गरिसकेपछि, `$LANG` विशेषताहरू `src` र `href` लाई हालको [भाषा कोडले](/i18/LANG_CODE) प्रतिस्थापन गरिनेछ।

यो चरको साथ, तपाईं तस्विर/भिडियो/लिङ्कहरूको बहुभाषिकीकरण प्राप्त गर्न सक्नुहुन्छ।
...
फुटर आइकन iconfont.cn `F` फन्ट सिर्जना गरेर उत्पन्न हुन्छ ( [अङ्ग्रेजी संस्करण](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh))।
...
यहाँ `${I18N.C}` ले `en/i18n.yml` सँग मेल खान्छ :
...
लिङ्कमा `class="a"` थप्नु भनेको लिङ्कलाई `MarkDown` मा रूपान्तरण हुनबाट रोक्नको लागि हो। हेर्नुहोस् :
 [➔ `YAML` कसरी लिंक `HTML` : `Markdown` रूपान्तरण हुनबाट रोक्ने](/i18/qa#H2) ।
...
### `use: Toc` , रूपरेखा सहितको एकल फाइल टेम्प्लेट
...
### `use: Md` , रूपरेखा बिना एकल फाइल टेम्प्लेट
...
### `use: Doc` , बहु-फाइल कागजात टेम्प्लेट
...
माथिको लेखन विधि `url: xxx` को बराबर छ, र यसको सम्बन्धित फाइल `en/xxx/TOC` हो।

#### TOC सामग्रीको तालिका

`i18n.site` `js` प्लग-इन `.i18n/hook/after.tran/TOC.js` डेमो वेयरहाउसमा `json` डाइरेक्टरी रूपरेखा उत्पन्न गर्न `doc` टेम्प्लेट कन्फिगरेसनसँग सम्बन्धित `TOC` डाइरेक्टरी अनुक्रमणिका फाइल पढ्नको लागि कार्यान्वयन गर्नेछ।
...
`Doc` टेम्प्लेटले उत्पन्न `json` आधारमा सामग्रीको रूपरेखाको तालिका प्रस्तुत गर्नेछ।
...
यदि स्रोत भाषा परिमार्जन गरिएको छ भने, तपाइँले परियोजनामा रहेको निश्चित भाषाको `TOC` फाइलहरूलाई अर्को भाषामा सार्नु पर्छ।
...
कुनै निश्चित मार्ग पहुँच गर्नको लागि, यदि पथ उपसर्ग `nav:` मा कन्फिगर गरिएको छैन भने, पथसँग सम्बन्धित `MarkDown` फाइल पूर्वनिर्धारित रूपमा लोड हुनेछ र `Md` टेम्प्लेट प्रयोग गरेर रेन्डर गरिनेछ।

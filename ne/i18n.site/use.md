...
`md/.i18n/htm/ol.yml` सम्पादन गर्नुहोस् र आफ्नो `npm` प्याकेज नामको रूपमा [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` को मान परिवर्तन गर्नुहोस् [npmjs.com](//npmjs.com)

त्यसपछि `md/.i18n/htm/ol.package.json` परिमार्जन गर्नुहोस्

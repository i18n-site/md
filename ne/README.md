...
## <a rel=id href="#project" id="project"></a> परियोजना विवरण
...
धेरै भाषाहरूमा कमाण्ड लाइन उपकरण ( [स्रोत कोड](https://github.com/i18n-site/rust/tree/main/i18) ) मा `YAML` गर्नुहोस् `Markdown`

को ढाँचा पूर्ण रूपमा कायम राख्न सक्छ `Markdown` फाइल परिमार्जनहरू पहिचान गर्न र परिवर्तन गरिएका फाइलहरू मात्र अनुवाद गर्न सक्छ।
...
हामी सबै `UNIX` " साझा गर्छौं एउटा फाइल " र सयौं भाषाहरूमा जटिल र जटिल उद्यम-स्तर समाधानहरू प्रस्तुत नगरी अनुवादहरू व्यवस्थापन गर्न सक्छौं।

तपाईंले अनुवाद `Markdown` गर्न सबैभन्दा परिचित उपकरणहरू प्रयोग गर्न सक्नुहुन्छ (तर तपाईंले अनुच्छेदहरू थप्न वा मेटाउन सक्नुहुन्न), र संस्करण नियन्त्रण गर्न सबैभन्दा परिचित तरिका प्रयोग गर्नुहोस्।

एक कोड आधार भाषा फाइलहरूको लागि खुला स्रोतको रूपमा सिर्जना गर्न सकिन्छ, र `Pull Request` प्रक्रियाको मद्दतले, विश्वव्यापी प्रयोगकर्ताहरूले अनुवादहरूको निरन्तर अनुकूलनमा भाग लिन सक्छन्। सिमलेस जडान [github](//github.com) अन्य खुला स्रोत समुदायहरू।

[→ प्रयोगकर्ता गाइडको लागि, कृपया परियोजना कागजात पढ्नुहोस्](/i18) ।
...
विशुद्ध रूपमा स्थिर, पढ्ने अनुभवको लागि अनुकूलित, र अनुवादको साथ एकीकृत [i18](#i18) यो परियोजना कागजात साइट निर्माणको लागि उत्तम विकल्प हो।

अन्तर्निहित फ्रन्ट-एन्ड ढाँचाले पूर्ण प्लग-इन वास्तुकला अपनाउछ, जुन माध्यमिक विकासको लागि सजिलो छ भने, ब्याक-एन्ड प्रकार्यहरू एकीकृत गर्न सकिन्छ।

यो वेबसाइट यस फ्रेमवर्कको आधारमा विकसित गरिएको हो र प्रयोगकर्ता, भुक्तानी र अन्य प्रकार्यहरू समावेश गर्दछ ( [स्रोत कोड](/i18n.site/src) ) पछि विस्तृत ट्यूटोरियल लेखिनेछ।

[→ प्रयोगकर्ता गाइडको लागि, कृपया परियोजना कागजात पढ्नुहोस्](/i18n.site) ।
...
हामी मानिसहरूको विशाल समुद्रमा समान विचारधारा भएका मानिसहरूलाई भेट्न तत्पर छौं।

...
windows , [डाउनलोड गर्न र स्थापना गर्न यहाँ क्लिक `git bash`](https://git-scm.com/download/win) ।
...
ती मध्ये, `.i18n/cache/.gitignore` को सामग्री निम्नानुसार छ :
...
यसको मतलब डाइरेक्टरी `.i18n/cache/` ( `.i18n/cache/.gitignore` बाहेक) मा रहेका सबै फाइलहरूलाई बेवास्ता गरिएको छ।

यदि तपाइँको संस्करण नियन्त्रण सफ्टवेयर `git` छैन भने, कृपया यो कन्फिगरेसन अनुसार बेवास्ता गर्नुहोस्।
...
तपाईंले विभिन्न उपनिर्देशिकाहरूका लागि फरक `fromTo` कन्फिगर गर्न सक्नुहुन्छ : एक प्रदर्शन लेखिएको छ /
...
यो कन्फिगरेसन तालिकामा, क्याटलग `blog` अनुवादको स्रोत भाषा `zh` हो, र `blog/your_file_name.md` अनुवादको स्रोत भाषा `ja` हो।

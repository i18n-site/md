...
मिश्रित को अनुवाद समर्थन गर्दछ Markdown HTML `MarkDown` मा सम्मिलित HTML को `<pre>` र `<code>` ट्यागमा सामग्री अनुवाद गरिएको छैन
...
स्ट्याटिक ब्लग प्रकारको हेडर कन्फिगरेसनलाई समर्थन गर्दछ [HOGO](https://github.com/gohugoio/hugo) जसले `title` , `summary` र `description` लाई मात्र अनुवाद गर्छ।

## चर नामहरू अनुवाद नगर्नुहोस्

`Markdown` लाई इमेल टेम्प्लेटको रूपमा प्रयोग गरिन्छ, `YAML` लाई भाषा फाइल कन्फिगरेसनको रूपमा प्रयोग गरिन्छ, र त्यहाँ चर प्यारामिटरहरू हुनेछन् (उदाहरणका लागि: रिचार्ज `${amount}` प्राप्त भएको छ)।
...
चीन, जापान र कोरियामा अपरकेस र लोअरकेस अक्षरहरू छैनन्, तर अङ्ग्रेजी शीर्षकहरूको लागि कन्भेन्सन पहिलो अक्षरलाई क्यापिटल गर्ने हो।
...
`Falcon` लाई `faucon` को रूपमा अनुवाद गरिएको छ र `Llama` लाई `lama` को रूपमा अनुवाद गरिएको छ। उचित संज्ञाहरूको रूपमा, तिनीहरू अनुवाद गर्नु हुँदैन।

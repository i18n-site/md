...
अनुवादको लागि कमाण्ड लाइन उपकरण Markdown & Yaml `i18`
...
Markdown HTML अनुवाद समर्थन गर्दछ `<pre>` HTML र `<code>` ट्यागहरूमा सामग्री अनुवाद गरिएको `MarkDown`

## गणितीय सूत्रहरू पहिचान गर्न र अनुवाद छोड्न सक्छ

गणितीय सूत्रहरू पहिचान गरिएका छन् र अनुवाद छोडिएको छ।
...
अनुवाद टिप्पणीहरू पछि भाषा संकेत गर्न आवश्यक छ ` ``` ` ` ```rust ` :

हाल , `yaml` , `json5` , `go` `rust` , `c` , `cpp` , `java` `js` `coffee` `python` , `bash` , `php` [र अन्य भाषाहरूमा](https://github.com/i18n-site/rust/blob/main/getc/src/style.rs#L14) टिप्पणीहरूको अनुवाद समर्थन गर्दछ `toml`
...
, `vim` , `vscode` `git` परिचित प्रोग्रामरहरूका लागि, कागजातहरू सम्पादन गर्न र संस्करणहरू प्रबन्ध गर्न यी उपकरणहरू प्रयोग गर्दा निस्सन्देह सिक्ने लागत बढ्छ।

( `Keep It Simple, Stupid` ) सिद्धान्तमा विश्वास गर्नेहरू मध्ये, उद्यम-स्तर समाधानहरू बोझिल, अकुशल र प्रयोग गर्न गाह्रो हुने `KISS` हुन्।
...
## Xindaya को उच्च गुणस्तर अनुवाद
...
ब्लाइन्ड परीक्षणहरूले हाम्रो अनुवादको गुणस्तर समान सेवाहरूको तुलनामा उल्लेखनीय रूपमा राम्रो भएको देखाउँछ।

समान गुणस्तर प्राप्त गर्न, Google अनुवादकलाई आवश्यक म्यानुअल सम्पादनको मात्रा क्रमशः `2.67` गुणा र `3.15` गुणा हो `ChatGPT`
...
उपकरणले केवल शब्दकोश मानहरू अनुवाद गर्दछ `YAML` शब्दकोश कुञ्जीहरू होइन।

`YAML` आधारमा, तपाइँ सजिलैसँग विभिन्न प्रोग्रामिङ भाषाहरूको लागि अन्तर्राष्ट्रिय समाधानहरू निर्माण गर्न सक्नुहुन्छ।

## हेडर कन्फिगरेसनलाई समर्थन `HOGO`

स्ट्याटिक ब्लगको हेडर कन्फिगरेसनलाई समर्थन गर्दछ [HOGO](https://github.com/gohugoio/hugo) `title` , `summary` र `description` क्षेत्रहरू अनुवादित छन्।

## चर नामहरू अनुवाद नगर्नुहोस्

इमेल टेम्प्लेटको रूपमा प्रयोग गरिएको, `YAML` भाषा फाइल कन्फिगरेसनको `Markdown` , त्यहाँ चर प्यारामिटरहरू हुनेछन् (उदाहरणका लागि: रिचार्ज `${amount}` प्राप्त भएको छ)।

यस प्रकारको चर नामलाई अंग्रेजी अनुवादको रूपमा लिइने छैन `${varname}`

## चीन, जापान र कोरियाको लागि अनुवाद अनुकूलन

### अङ्ग्रेजीमा अनुवाद गर्दा, शीर्षकको पहिलो अक्षर स्वतः क्यापिटल हुन्छ।

चीन, जापान र कोरियामा अपरकेस वा लोअरकेस अक्षरहरू छैनन्, तर अङ्ग्रेजी शीर्षकहरूले सामान्यतया पहिलो अक्षरलाई क्यापिटल गर्छ।

`i18` `MarkDown` शीर्षकहरू पहिचान गर्न सक्छ, र केस-संवेदनशील भाषामा अनुवाद गर्दा स्वचालित रूपमा पहिलो अक्षरलाई क्यापिटलाइज गर्नेछ।

उदाहरणका लागि `Optimized for Reading Experience` को रूपमा अनुवाद गरिनेछ `为阅读体验而优化`
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` मा अनुवाद :

<img alt="" src="//p.3ti.site/1720199391.avif">

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` मा अनुवाद :

`faucon` रूपमा अनुवाद गरिएको `Falcon` र `Llama` `lama` अनुवाद गरिएको छ।

<img alt="" src="//p.3ti.site/1720199451.avif">

### DeepL अनुवाद

`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` मा अनुवाद :

<img alt="" src="//p.3ti.site/1720199550.avif">

माथिको फ्रेन्चमा DeepL (उचित नामहरू पुन: लेख्ने र अजीब थप्ने `... ` ):
...
को अनुवादले चिनियाँ, जापानी र कोरियाली कागजातहरूमा अङ्ग्रेजी सर्तहरू पहिचान गर्नेछ र सर्तहरूलाई यथावत राख्नेछ `i18`
...
उदाहरणका लागि: `Cristiano Ronaldo` को रूपमा अनुवाद गरिनेछ `C罗`

## बहु-भाषा वेबसाइट निर्माण गर्न सकिन्छ `i18n.site`

बहु-भाषा वेबसाइट [`i18n.site`](/i18n.site) लागि कमाण्ड लाइन उपकरणमा एकीकृत छ `i18`

विवरणका लागि कागजात हेर्नुहोस् [`i18n.site`](/i18n.site)

## कोड खुला स्रोत

क्लाइन्ट पूर्ण रूपमा खुला स्रोत हो, र सर्भर साइड खुला स्रोत हो [स्रोत कोड हेर्न यहाँ क्लिक गर्नुहोस्](/i18n.site/src) 90

हामी खुला स्रोत कोडको विकास र अनुवादित पाठहरूको प्रूफरीडिङमा सहभागी हुन स्वयंसेवकहरू खोजिरहेका छौं।

यदि तपाइँ इच्छुक हुनुहुन्छ भने, कृपया [→ तपाइँको प्रोफाइल भर्न यहाँ क्लिक गर्नुहोस्](https://ggl.link/i18n) र त्यसपछि संचारको लागि [मेलिङ सूचीमा](https://groups.google.com/u/2/g/i18n-site) सामेल हुनुहोस्।
...
हाम्रो सामाजिक खाताहरू पालना गर्न [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) स्वागत / [X.COM: @i18nSite](https://x.com/i18nSite)

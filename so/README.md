<h1 style="display:flex;justify-content:space-between">i18n.site xalal caalami ah<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Sharaxaada Mashruuca

Goobtani waxay hadda bixisaa laba qalab khadka taliska oo furan:
...
U tarjun `Markdown` `YAML` u tarjum aaladda khadka taliska ( [source code](https://github.com/i18n-site/rust/tree/main/i18) ) ee luuqado badan.

Si fiican u ilaalin kara qaabka `Markdown` Wuxuu aqoonsan karaa wax ka beddelka faylka oo kaliya wuu tarjumi karaa faylasha la beddelay.

Turjumaada waa la tafatiri karaa

Wax ka beddel qoraalka asalka ah oo mashiinka-tarjum mar kale, wax ka beddelka buug-gacmeedka ee tarjumaada dib looma qori doono (haddii cutubkan qoraalka asalka ah aan wax laga beddelin).

Waxaan wadaagnaa " `UNIX` walba waa Fayl " waxaanan ku maarayn karnaa tarjumaadaha boqollaal luqadood anagoon soo bandhigin xalal adag oo heer ganacsi ah.

Waxaad isticmaali kartaa qalabka ugu caansan si `Markdown` tarjumaada (laakin ma ku dari kartid ama ma tirtiri kartid cutubyada), oo aad isticmaasho habka ugu caansan ee lagu maamulo nooca.

Saldhig kood ayaa loo abuuri karaa il furan oo loogu talagalay faylalka luqadda, iyadoo la kaashanayo nidaamka `Pull Request` , isticmaalayaasha caalamiga ah waxay ka qayb qaadan karaan hagaajinta joogtada ah Isku xirka aan kala go'a [github](//github.com) iyo bulshooyinka kale ee il furan.

[→ Hagaha isticmaalaha, fadlan akhri dukumentiga mashruuca](/i18) .

## Xindaya Turjumaada Tayada Sare Leh

Waxaan soo saarnay jiil cusub oo tignoolajiyada tarjumaadda oo isku daraysa faa'iidooyinka farsamada ee moodooyinka tarjumaadda mashiinka dhaqameed iyo moodooyinka luqadda waaweyn si tarjumaada looga dhigo mid sax ah, siman oo qurux badan.
...
Si loo gaaro isla tayadaas, qadarka tafatirka `2.67` ee Google Translate u `3.15` yahay iyo `ChatGPT`
...
Si sax ah u taagan, oo loo habeeyay waayo-aragnimada akhriska, oo lagu dhex daray tarjumaada [i18](#i18) waa doorashada ugu fiican ee lagu dhisayo goobta dukumeenti mashruuca.
...
Mareegtan waxaa loo sameeyay iyadoo lagu salaynayo qaabkan oo ay ku jiraan isticmaale, lacag bixin iyo hawlo kale ( [koodka isha](/i18n.site/src) ).

[→ Hagaha isticmaalaha, fadlan akhri dukumentiga mashruuca](/i18n.site) .

## La Xidhiidh

Fadlan <button onclick="mailsub()">dhagsii iimaylkan si aad isu diiwaan geliso cusboonaysiinta badeecada</button> oo <button onclick="webpush()">aad awood u yeelato riixitaanka browser-ka</button> Waxaan ku ogaysiin doonaa marka alaabta cusub la sameeyo.

Sidoo kale ku soo dhawoow inaad raacdo [i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) / [X.COM: @i18nSite](https://x.com/i18nSite)

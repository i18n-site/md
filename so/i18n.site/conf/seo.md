...
## Isku Xidhka Daruuraha Caqliga Leh Ee Baidu
...
Intaa waxaa dheer, qaanuunka beddelka `cloudflare` ee kor ku xusan, `index.html` ayaa loo beddelay `file/your_bucketname/index.html` , iyo qaabeynta kale ayaa isku mid ah.

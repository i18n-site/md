...
## Habee Kaydinta Shayga Si Aad U Soo Dejiso Faylasha Taagan

Faylasha taagan waxaa lagu soo saari karaa gudaha, laakiin habka caadiga ah waa in lagu dhejiyo kaydinta shay.
...
Qaabeynta, fadlan u beddel `i18n.site` qiimaha `host:` ee `.i18n/htm/ol.yml` , bakhaarro shay oo badan ayaa lagu habeyn karaa hoosta `s3` , iyo goobta `region` waa ikhtiyaari (dukaamada shay badan uma baahna inay dejiyaan goobtan).

Kadibna orod `i18n.site -n` si aad dib u daabacdo mashruuca.

Haddii aad wax ka beddeshay `~/.config/i18n.site.yml` oo aad rabto in aad dib u soo dhejiso, fadlan isticmaal amarka soo socda ee buugga xididka mashruuca si aad u nadiifiso kaydka gelinta :
...
`URL redirect` Dooro jihaynta firfircoon, fadlan wax ka beddel `/en` ee jihaynta `concat("/en",http.request.uri.path,".htm")` una beddel luqadda caadiga ah ee aad rabto in matoorada goobidda lagu daro.
...
Kadibna u samee qoraalka [EdgeJS geesaha](//console.bce.baidu.com/cdn/#/cdn/ejs/list) sida soo socota
...
Sababtoo ah `R2` `cloudflare` geli karo magac domain la habeeyey, kaydinta shayga qolo saddexaad waxa loo baahan yahay in la isticmaalo si loo dhigo galalka taagan.

Halkan waxaan [backblaze.com](https://www.backblaze.com) soo qaadanaynaa tusaale ahaan si aan u muujino sida loo xiro walxaha dhinac saddexaad si loogu kaydiyo `cloudflare` .

Samee baaldi at `backblaze.com` , soo bixi fayl kasta, guji si aad u baadho faylka, oo aad u hesho magaca domain ee `Friendly URL` , kaas oo ah `f003.backblazeb2.com` halkan.
...
`Rewrite to` door firfircoon oo wax ka beddel `your_bucketname` ee `concat("/file/your_bucketname",http.request.uri.path)` magaca baaldigaaga.

...
Haddii aad isticmaasho jawi is-dhexgalka joogtada ah si aad u daabacdo, looma baahna in lagu rakibo `nodejs` , kaliya nuqul ka samee oo daabac ogolaanshaha `~/.npmrc` deegaanka.
...
Ka dib, adeegso kaydinta shayga daruuraha iibiya ee dhul weynaha + `CDN` Geli waxa soo socda `out/ol/htm` .

...
Xusuusnow, **tirada xariiqyada tarjumaadda waa inay u dhigmaan xariiqyada qoraalka asalka ah** .
...
Mararka qaarkood beddelka laga bilaabo `HTML` → `MarkDown` ma aha waxa aan rabno, sida `<a href="/">Home</a>` oo loo beddelo `[Home](/)` .

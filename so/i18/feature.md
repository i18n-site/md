...
Waxay taageertaa tarjumaada isku dhafan HTML Markdown , waxa ku jira `<pre>` iyo `<code>` tags ee HTML ee ku dhex jira `MarkDown` lama turjumayo
...
Qalabku waxa uu tarjumaa qiyamka qaamuuska ee `YAML` , ma aha furayaasha qaamuuska.
...
DeepL turjun korka luqadda Faransiiska (sidoo kale dib u qorista magacyada saxda ah oo ku daraya `... ` aan caadi ahayn):

...
Waxay taageertaa tarjumaadda miisaska Markdown iyada oo aan waxyeello loo geysan qaabka;

Waxay taageertaa turjumaada HTML Markdown dhafan , waxa ku jira `<pre>` iyo `<code>` tags ee HTML ee ku dhex jira `MarkDown` lama turjumayo

## Wuxuu Aqoonsan Karaa Qaacidooyinka Xisaabta Oo Wuu Dhaafi Karaa Tarjumaada

Hababka xisaabta waa la aqoonsaday oo turjumaada waa la booday.
...
Faallooyinka tarjumaada waxay u baahan yihiin inay muujiyaan luqadda ` ``` ` ka dib, : ` ```rust ` .
...
## Wax Wax Ka Beddel Ah Ma Jiro, Tarjumaadna Ma Jirto
...
Waxaan soo saarnay jiil cusub oo tignoolajiyada turjumaada taas oo midaysa faa'iidooyinka farsamada ee moodooyinka turjumaada mashiinka dhaqameed iyo moodooyinka luqadaha waaweyn si tarjumaada looga dhigo mid sax ah, siman oo qurux badan.
...
[Riix halkan si aad u oggolaato oo si toos ah u i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) oo **aad u hesho gunno $50** .
...
Waxay `summary` qaabaynta madaxa `description` `title` [HOGO](https://github.com/gohugoio/hugo)
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` loo turjumay :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` loo turjumay Faransiis :
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` loo turjumay :

![](//p.3ti.site/1720199550.avif)

Waxa kor ku qoran DeepL loo turjumayo `... `
...
`i18` ayaa lagu dhex daray aaladda [`i18n.site`](/i18n.site) aad ee dhismaha bogga internetka ee luuqadaha badan.

Faahfaahinta ka eeg dukumeentiga [`i18n.site`](/i18n.site)

## Koodhka Isha Furan

Macmiilku gabi ahaanba waa furan yahay, dhinaca server 90 ka % ee koodkuna waa [il](/i18n.site/src) furan.

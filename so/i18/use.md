...
Waxaad u habayn kartaa `fromTo` kala duwan faylal-hoosaadyo kala : /
...
Jadwalka qaabeynta, luqadda isha ee tarjumaada buugaagta `blog` waa `zh` , luqadda isha ee `blog/your_file_name.md` `ja`

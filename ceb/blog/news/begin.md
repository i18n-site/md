...
Ang kasamtangan nga mga galamiton sa pagdumala sa paghubad kay bug-at kaayo alang sa mga programmer nga nagsalig sa bersyon `git` nga pagdumala, mas gusto nila ang command line.
...
Ang front-end, back-end, ug command line [nga mga code kay open source](https://i18n.site/i18n.site/c/src) (ang modelo sa paghubad dili pa open source).
...
Ipadala ang mail sa self-built SMTP [chasquid](https://github.com/albertito/chasquid)

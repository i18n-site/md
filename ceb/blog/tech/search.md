...
# Puro Front-End Inverted Full-Text Nga Pagpangita
...
1. Pre-built index files
   ...
   Madugangan niini ang oras sa paghulat sa tiggamit ug magamit ang daghang bandwidth.
...
Tungod sa mga kakulangan sa kasamtangan nga mga solusyon, `i18n.site` nakahimo og usa ka bag-o nga puro front-end full-text nga solusyon sa pagpangita, nga adunay mosunod nga mga kinaiya :
...
1. Nagsuporta sa pagpangita sa prefix, nga makapakita sa mga resulta sa pagpangita sa tinuod nga panahon samtang ang user nag-type.
1. Anaa Offline
...
Niining paagiha, ang incremental indexing mahimong makab-ot ug ang gidaghanon sa kalkulasyon maminusan.

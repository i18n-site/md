...
Ang pagdugang ug bisan unsang attribute gawas sa `href` sa `a` tag, sama sa `<a class="A" href="/">Home</a>` , makalikay niini nga pagkakabig.

## `./i18n/hash` Nga Mga Panagsumpaki Sa Ubos

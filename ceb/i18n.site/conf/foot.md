...
Sayon ang paghimo sa mga sangkap sa web, sama sa naandan nga `<x-img>` .
...
Gamit ang `${I18N.xxx}` nga susama niining paagi sa pagsulat, inubanan sa `i18n.yml` , mahimo nimong makab-ot ang multi-language internationalization sa footer.

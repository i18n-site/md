...
* `i18n.addon/toc` :
  Paghimo og direktoryo nga indeks sa `json` base sa `TOC` , gipagana pinaagi sa default
...
Diin `__CONF__` mapulihan sa ngalan sa kasamtangan nga configuration (sama sa `dev` o `ol` ).

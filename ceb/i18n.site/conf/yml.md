...
### `use: Md` , Usa Ka Template Sa File Nga Walay Outline
...
Ang paagi sa pagsulat sa ibabaw katumbas sa `url: xxx` , ug ang katugbang nga file niini mao ang `en/xxx/TOC` .

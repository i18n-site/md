...
* Standalone / [atomgit](https://atomgit.com/i18n/18x) [github](https://github.com/i18n-site/18x)
...
* Universal base / [atomgit](https://atomgit.com/i18n/lib) [github](https://github.com/i18n-site/lib)
* Librarya base / [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* Dili kinahanglan nga i-package / direkta nga gi-refer nga mga librarya [atomgit](https://atomgit.com/i18n/x) atubangan [github](https://github.com/i18n-site/x)
...
Kini nga backend mao ang backend sa i18n.site nga website mismo, lakip ang tiggamit, pagbayad, pagduso sa mensahe ug uban pang mga sistema.
...
* [atomgit](https://atomgit.com/i18n-ops/ops) / deployment script [github](https://github.com/i18n-ops/ops)
* ubuntu [github](https://github.com/i18n-ops/ubuntu) / [atomgit](https://atomgit.com/i18n-ops/ubuntu)
* / nga [atomgit](https://atomgit.com/i18n/cron) buluhaton [github](https://github.com/i18n-cron/cron)

...
Gigamit namo [vscode](https://code.visualstudio.com/) para isulat `MarkDown` , ug i-install usab ang plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) aron ma-preview sa tinuod nga oras samtang nagsulat.

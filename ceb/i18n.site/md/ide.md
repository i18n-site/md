...
Gigamit namo ang [vscode](https://code.visualstudio.com/) para isulat `MarkDown` ug i-install ang plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) para ma-preview sa tinuod nga oras samtang nagsulat.

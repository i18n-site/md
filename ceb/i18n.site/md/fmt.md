...
Ang tradisyonal nga `MarkDown` nga mga punto sa anchor gihimo base sa sulud sa teksto Sa kaso sa daghang pinulongan, kini nga solusyon dili mahimo.
...
Timan-i nga ang `<style>` gihubit usab sa `<pre>` sa ibabaw.
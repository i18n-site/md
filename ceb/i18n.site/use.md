...
Una [i-klik dinhi github para makamugna ug organisasyon](https://github.com/account/organizations/new?plan=free) `i18n-demo`

Dayon paghimo og bodega `i18n-demo.github.io` ubos niini nga organisasyon (palihug ilisan ang `i18n-demo` sa ngalan sa organisasyon nga imong gibuhat):
...
Palihug i-klik `Add Account` aron mahatagan ug access ang organisasyon `i18n-demo` .
...
Kini nga mga deployment optimization solutions mas komplikado ug ipaila sa lain nga mga kapitulo sa umaabot.
...
Palihug idugang ang usa ka configuration nga susama sa mosunod sa `server` paragraph sa nginx Palihog usba `/root/i18n/md/out/ol/htm` ngadto sa dalan sa imong kaugalingong proyekto `out/ol/htm` :

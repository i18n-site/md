...
## <a rel=id href="#ha" id="ha"></a> Front-end taas nga pagkaanaa
...
Ang prinsipyo mao ang: intercept nga mga hangyo nga adunay [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , sulayi pag-usab ang napakyas nga mga hangyo sa uban nga `CDN` , ug mapahiangay nga makapahimo sa labing paspas nga pagtubag nga gigikanan nga site ingon ang default nga gigikanan sa pagkarga.
...
`404` nga panid adunay usa ka cute nga gamay nga naglutaw nga multo, ang mga mata niini molihok gamit ang mouse, [➔ Pag-klik dinhi aron makita](/404) ,

...
windows System, thov [nyem qhov no mus download tau thiab nruab `git bash`](https://git-scm.com/download/win) ua ntej.
...
Tsis tas li ntawd, koj yuav tsum [i18n.site/payBill](//i18n.site/payBill) ib daim npav rho nyiaj rau kev them nyiaj (tsis tas yuav them rov qab, lub vev xaib yuav txiav tawm tus nqi raws li kev siv, [saib lub vev xaib rau tus nqi](/#price) ).

## Siv

### Demo Qhov Project

Thov xa mus rau qhov project `i18` [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18)
...
Koj tuaj yeem teeb tsa sib txawv `fromTo` rau cov npe sib txawv ntawm cov ntaub : /
...
Nyob rau hauv lub rooj configuration no, lub hauv paus lus ntawm catalog `blog` txhais lus yog `zh` , thiab lub hauv paus lus ntawm `blog/your_file_name.md` txhais lus yog `ja` .

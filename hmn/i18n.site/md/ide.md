...
Peb siv [vscode](https://code.visualstudio.com/) los sau `MarkDown` , thiab tseem nruab lub plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) los saib ua ntej hauv lub sijhawm thaum sau.
...
Siv [PicList](https://github.com/Kuingsmile/PicList) txhawm rau upload cov duab, nco ntsoov teem lub upload shortcut key, thiab upload lub screenshot nrog ib nias.

...
Qhov kev daws teeb meem thauj tog rau nkoj pom zoo nrog `i18n.site` yog txhawm rau ntxig cov ntawv zoo ib yam li `<a rel=id href="#xxx" id="xxx"></a>` hauv `MarkDown` rau manually tsim qhov chaw thauj tog rau nkoj taw tes.
...
Ua ke ob lub ntsiab lus no, koj tuaj yeem sau tau yooj yim `HTML` hauv `MarkDown` kom ua tiav ntau yam khoom siv.

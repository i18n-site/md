...
Ṣe atilẹyin itumọ ti HTML Markdown , akoonu ti o wa ninu awọn aami `<pre>` ati `<code>` ti HTML ti a fi sii ni `MarkDown` ko ni itumọ
...
Awọn asọye itumọ nilo lati tọka ede lẹhin ` ``` ` , : ` ```rust ` .
...
Fun awọn olupilẹṣẹ ti o faramọ pẹlu `git` , `vim` , ati `vscode` , lilo awọn irinṣẹ wọnyi lati ṣatunkọ awọn iwe aṣẹ ati ṣakoso awọn ẹya yoo laiseaniani mu iye owo ikẹkọ pọ si.
...
Sibẹsibẹ, wọn ko ṣe atilẹyin idamo awọn iyipada faili ati tumọ awọn faili ti a yipada nikan lati dinku awọn idiyele ati mu iṣẹ ṣiṣe pọ si.
...
[Tẹ ibi lati fun laṣẹ ati tẹle i18n.site s github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) ati **gba ajeseku $50** .
...
Ṣe atilẹyin iṣeto akọsori ti bulọọgi [HOGO](https://github.com/gohugoio/hugo) , eyiti o tumọ awọn aaye `title` , `summary` ati `description` nikan.

## Ma Ṣe Tumọ Awọn Orukọ Oniyipada
...
Itumọ si `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` tumọ si Faranse :
...
Itumọ si `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

DeepL eyi ti o wa loke si Faranse (tun tun kọ awọn orukọ to dara ati fifi `... ` kun):
...
## Le Ni Idapo Pelu Diẹ Ẹ Sii Ju Awọn Ede `i18n.site` Lati Kọ Oju Opo Wẹẹbu Kan
...
Onibara jẹ orisun ṣiṣi patapata, ati ẹgbẹ 90 % ti koodu naa jẹ orisun ṣiṣi [Tẹ ibi lati wo koodu orisun](/i18n.site/src) .

...
Nitori awọn ailagbara ti awọn solusan ti o wa tẹlẹ, `i18n.site` ti ṣe agbekalẹ ojuutu wiwa ọrọ-ipari iwaju mimọ tuntun, eyiti o ni awọn abuda wọnyi :

1. Ṣe atilẹyin wiwa ede-pupọ ati pe o jẹ iwọn kekere ti ekuro lẹhin iṣakojọpọ `gzip` jẹ `6.9KB` (fun lafiwe, iwọn `lunrjs` jẹ `25KB` ).

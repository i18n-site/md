...
Iwaju [svelte](https://svelte.dev) [stylus](https://stylus-lang.com) , [pug](https://github.com/pugjs/pug) , [vite](https://github.com/vitejs/vite)
...
Laini aṣẹ [fjall](https://github.com/fjall-rs/fjall) [boa_engine fi sii js](https://docs.rs/boa_engine)

olupin [contabo](https://my.contabo.com) VPS

database [kvrocks](https://kvrocks.apache.org) [mariadb](https://mariadb.org) .

Fi ifiweranṣẹ ranṣẹ si ti ara ẹni SMTP [chasquid](https://github.com/albertito/chasquid)

## Pe Wa

Nigbati awọn ọja tuntun ba ṣe ifilọlẹ, awọn iṣoro jẹ eyiti ko ṣeeṣe.

Lero lati kan si wa nipasẹ Google [groups.google.com/u/2/g/i18n-site](https://groups.google.com/u/2/g/i18n-site) :
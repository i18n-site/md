...
Nigbati `User-Agent` ti ibeere iwọle ba lo nipasẹ ẹrọ wiwa kiri, ibeere naa yoo darí si oju-iwe aimi nipasẹ `302` .
...
Ni iṣeto ni, jọwọ yi `i18n.site` pada si iye ti `host:` ni `.i18n/htm/ol.yml` , awọn ile itaja ohun elo pupọ le tunto labẹ `s3` , ati aaye `region` jẹ aṣayan (ọpọlọpọ awọn ile itaja ohun elo ko nilo lati ṣeto aaye yii).
...
Lẹhinna ṣẹda iwe afọwọkọ ni [EdgeJS eti](//console.bce.baidu.com/cdn/#/cdn/ejs/list) bi atẹle
...
Nitori `R2` `cloudflare` wọle nipasẹ orukọ ìkápá ti a ṣe adani, ibi ipamọ ohun ẹnikẹta nilo lati lo lati gbe awọn faili aimi.

Nibi a [backblaze.com](https://www.backblaze.com) bi apẹẹrẹ lati ṣe afihan bi o ṣe le di awọn nkan ẹnikẹta lati wa ni ipamọ ni `cloudflare` .

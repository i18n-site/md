...
* `foot.css` :
* `import.css` : ara `i18n.site` fun gbogbo aaye naa
* `conf.css` Awọn aami : ati awọn akọwe

### Aami Font

Aami ẹlẹsẹ jẹ ipilẹṣẹ nipasẹ ṣiṣẹda fonti kan ti `F` iconfont.cn [Ẹya Gẹẹsi](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).

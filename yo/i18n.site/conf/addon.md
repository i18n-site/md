...
Akoko asiko `js` ti a ṣe sinu da lori idagbasoke atẹle [boa](https://github.com/boa-dev/boa) , ati awọn iṣẹ ti a ṣe sinu rẹ jẹ atẹle :

* `wPath(path, txt)` Kọ si :
* `rTxt(path)` : faili ọrọ
* `rBin(path)` : faili alakomeji

...
Ti ọna kan ba wọle ati pe a ko tunto asọtẹlẹ ọna rẹ ni `nav:` , faili `MarkDown` ti o baamu si ọna naa yoo jẹ ti kojọpọ nipasẹ aiyipada ati jigbe ni lilo awoṣe `Md` .

Fun apẹẹrẹ, ti `/test` ba wọle, ati pe `nav:` tunto laisi ọna yii, ati pe ede oju-iwe jẹ Gẹẹsi (koodu `en` ), `/en/test.md` yoo jẹ ti kojọpọ nipasẹ aiyipada ati ṣe ni lilo awoṣe `Md` .
...
#### Ise Agbese Ẹyọkan (Awọn Faili Lọpọlọpọ)

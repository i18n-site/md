...
Tẹ `code xxx.md` sii ninu laini aṣẹ lati pe `vscode` lati ṣii faili `Markdown` .

Lo [PicList](https://github.com/Kuingsmile/PicList) lati gbe awọn aworan silẹ, ranti lati ṣeto bọtini ọna abuja ikojọpọ, ati gbe sikirinifoto pẹlu titẹ kan.

O ṣe atilẹyin didakọ orukọ faili laifọwọyi si ọna kika `Markdown` lẹhin ikojọpọ, eyiti o mu imudara dara gaan.

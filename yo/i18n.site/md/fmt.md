...
Ojutu ojuami oran ti o gba pẹlu `i18n.site` ni lati fi ọrọ sii iru si `<a rel=id href="#xxx" id="xxx"></a>` ni `MarkDown` lati ṣẹda pẹlu ọwọ aaye oran ipo.
...
`HTML` le wa ni ifibọ sinu koodu `pug` .
...
O le tọka si imuse ni [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) koodu naa jẹ atẹle :

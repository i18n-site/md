...
Lẹhin ṣiṣiṣẹ, itumọ ati awọn faili kaṣe yoo jẹ ipilẹṣẹ. Jọwọ ranti lati ṣafikun `git add . ` si ibi ipamọ ninu ilana `md`
...
Nibi, `dev` tumọ si pe o da lori faili iṣeto `.i18n/htm/dev.yml` .
...
Si akoonu ti ara ẹni, ni afikun si lilo olupin tirẹ `CDN` aṣayan miiran ti o wọpọ ni lati lo `S3` + .
...
Kọkọ `i18n-demo` [github lati ṣẹda ajọ kan](https://github.com/account/organizations/new?plan=free) .
...
[cloudflare page](//pages.cloudflare.com) a bawe pẹlu `github page` , o pese ọna atunṣe ati pe o jẹ ọrẹ diẹ si Ilu China ati pe o wa ni iraye si diẹ sii.
...
#### Ṣiṣe Imuṣiṣẹ Oju Opo Wẹẹbu Ni Oluile China
...
Nitori igbasilẹ `MX` ati igbasilẹ `CNAME` ko le gbepọ, ti o ba fẹ lati gba awọn apamọ orukọ ašẹ ni akoko kanna, o nilo lati ṣe ifowosowopo pẹlu [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten) afọwọkọ si ipele `CNAME` sinu igbasilẹ `A` .
...
Ṣafikun orukọ ìkápá `CNAME` `CDN` `*.xxx.com` [CDN](https://cdn.console.aliyun.com/domain/list)
...
Labẹ awọn `.i18n` liana ni o wa iṣeto ni awọn faili, translation kaṣe, ati be be lo ti `i18n.site` Wo nigbamii ti ipin ["Eto"](/i18n.site/conf) fun awọn alaye.

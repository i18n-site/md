...
Phetolelo ea nalane e lokollotsoeng ke sephutheloana sa `npm` e bolokiloe ho `.i18n/v/ol/v.hash` .

Haeba ka phoso u hlakola `.i18n/v/ol` , sephutheloana `npm` se ke ke sa lokolloa.

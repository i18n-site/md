...
`i18n.site` e tla phatlalatsa litaba tsa sebaka sa marang-rang ho `npmjs.com` ka ho sa feleng, ka thuso [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) le litaba tse ling tse `CDN` tse kentsoeng ho `npm` .
...
Ka kamehla, [lifonti tse fapaneng tsa li-axis tse peli tsa Alimama , le lifonti tse ling tsa marang-rang](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) lumelletsoe leqepheng la tepo ho kopanya boiphihlelo ba ho bala ba basebelisi lipolaneteng tse fapaneng.

...
Tharollo ea ntlha ea anchor eo ho lumellanoeng ka eona le `i18n.site` ke ho kenya mongolo o ts'oanang le `<a rel=id href="#xxx" id="xxx"></a>` ho `MarkDown` ho iketsetsa sebaka sa ho ema.
...
`HTML` e ka kenngoa ka har'a khoutu `pug` .

Litaba tsa likarolo `<pre>` li ke ke tsa fetoleloa.

Ho kopanya lintlha tsena tse peli, o ka ngola `HTML` ho `MarkDown` habonolo ho fihlela litlamorao tse fapaneng.

O ka bua ka ts'ebetsong ho [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) khoutu e tjena :

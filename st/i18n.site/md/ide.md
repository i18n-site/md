# Khothaletso Ea Mohlophisi

E mong le e mong o na le mohlophisi oa hae eo a e ratang haholo Mona re arolelana mekhoa ea rona `Markdown` e molemohali.

Re sebelisa [vscode](https://code.visualstudio.com/) ho ngola `MarkDown` , hape re kenya plug-in [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ho bona esale pele ka nako ea nnete ha re ntse re ngola.

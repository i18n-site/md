...
Ho na le lifaele tse tharo tse `css` tlasa `md/.i18n/htm` morerong oa demo.
...
Letšoao la botlaaseng le hlahisoa ka ho theha mohala o bitsoang iconfont.cn ( mofuta `F` [Senyesemane](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
Ho bonolo ho etsa likarolo tsa tepo, joalo ka `<x-img>` tloaelo0 .

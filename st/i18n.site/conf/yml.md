...
U ka fetola `use: Toc` ho tlhophiso e ka holimo ho `use: Md` , tsamaisa `i18n.site` bukeng ea `md` hape, ebe u etela URL ea tlhahiso-pele ho bona liphetoho tse leqepheng la lehae.

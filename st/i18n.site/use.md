...
[Tlanya mona pele github Ho theha mokhatlo](https://github.com/account/organizations/new?plan=free) Lebitso le latelang la mokhatlo ke `i18n-demo` e le mohlala.
...
Haeba u sebelisa `i18n.site` ho hlahisa sebaka sa hau sa marang-rang e le sebaka sa hau sa marang-rang se ka sehloohong, hangata u hloka ho hlophisa redirection ea pan-domain, ke hore, ho tsamaisa phihlello ho `*.xxx.com` (ho kenyeletsoa `www.xxx.com` ) ho `xxx.com` .

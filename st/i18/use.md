...
## windows Qala Ho Kenya git bash
...
`fromTo` e fapaneng e ka hlophisoa bakeng sa li-subdirectories tse / Pontšo e ngotsoe ka tsela e latelang :
...
Tafoleng ena ea litlhophiso, puo ea mohloli bakeng sa phetolelo `blog` ke `zh` , 'me puo ea mohloli bakeng sa phetolelo ea directory `blog/your_file_name.md` ke `ja` .

### Hlokomoloha Faele

Ka linako tsohle, lifaele tsohle tse qalang ka `.md` le `.yml` bukeng ea puo ea mohloli li tla fetoleloa.

Haeba u batla ho hlokomoloha lifaele tse itseng 'me u se ke ua li fetolela (joaloka lingoloa tse sa phethoang), u ka sebelisa `ignore` sebopeho sa lebala.

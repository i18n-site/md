...
windows , ka kopo [tlanya mona ho jarolla le ho kenya `git bash`](https://git-scm.com/download/win) pele.
...
Ka kopo sheba morero oa [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) ho ithuta ho hlophisa `i18` phetolelo.
...
O ka hlophisa `fromTo` e fapaneng bakeng sa li / subdirectories tse fapaneng Pontšo e ngotsoe ka tsela e latelang :
...
Lethathamong lena la litlhophiso, puo ea mohloli oa lethathamo la phetolelo ea `blog` ke `zh` , 'me puo ea mohloli oa phetolelo `blog/your_file_name.md` ke `ja` .
...
`ignore` e sebelisa [globset](https://docs.rs/globset/latest/globset/#syntax) a tšoanang le a faele `.gitignore` .

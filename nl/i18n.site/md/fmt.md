...
De door `i18n.site` afgesproken aanpak voor ankerpunten is het handmatig invoegen van teksten zoals `<a rel=id href="#xxx" id="xxx"></a>` in `Markdown` om定位锚点 aan te maken.
...
Door deze twee aspecten te combineren, kan het gemakkelijk zijn om `HTML` in `Markdown` te schrijven en verschillende weergave-effecten te bereiken.

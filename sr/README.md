...
Омогућава вам да брзо направите међународне документе и блогове који подржавају [стотине језика](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .
...
Маркдовн превод се може користити независно или са вишејезичним генератором статичких сајтова да бисте брзо направили веб локацију.

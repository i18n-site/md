...
Претплаћујемо се на филозофију `UNIX` Све је датотека " и можемо " управљамо преводима на стотине језика без увођења сложених и гломазних решења на нивоу предузећа!
...
База кода се може креирати као опен соурце за језичке датотеке, а уз помоћ `Pull Request` процеса глобални корисници могу учествовати у континуираној оптимизацији превода. Беспрекорна веза [github](//github.com) друге заједнице отвореног кода.
...
[Кликните овде да ауторизујете и аутоматски пратите github i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) и **добијете бонус $50** !
...
<p style="text-align:right">──Библија·Постанак</p>
...
Маркдовн сајтови за превод и документацију су само почетак.

...
## <a rel=id href="#project" id="project"></a> Опис пројекта

Ова страница тренутно нуди два алата командне линије отвореног кода:

* [i18 : MarkDown за превођење командне линије](/i18/feature)
...
Преведите `Markdown` и `YAML` у алатку командне линије ( [изворни код](https://github.com/i18n-site/rust/tree/main/i18) ) на више језика.
...
Делимо " `UNIX` је датотека " и можемо да управљамо преводима на стотине језика без увођења сложених и гломазних решења на нивоу предузећа.

Можете да користите најпознатије алатке за `Markdown` превода (али не можете да додајете или бришете пасусе) и користите најпознатији начин за контролу верзија.

База кода може бити креирана као отворени извор за језичке датотеке, а уз помоћ процеса `Pull Request` , глобални корисници могу учествовати у континуираној оптимизацији превода. Беспрекорна веза [github](//github.com) друге заједнице отвореног кода.

[→ За упутство за употребу, прочитајте пројектну документацију](/i18) .
...
Чисто статичан, оптимизован за искуство читања и интегрисан са преводом [i18](#i18) најбољи је избор за прављење сајта пројектног документа.
...
Ова веб локација је развијена на основу овог оквира и укључује корисничке, платне и друге функције ( [изворни код](/i18n.site/src) ).

[→ За упутство за употребу, прочитајте пројектну документацију](/i18n.site) .

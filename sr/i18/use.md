...
Молимо погледајте демо [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) да научите конфигурацију `i18` превода.
...
Међу њима, садржај `.i18n/cache/.gitignore` је следећи :
...
То значи да се све датотеке у директоријуму `.i18n/cache/` (осим `.i18n/cache/.gitignore` ) игноришу.
...
У овој табели конфигурације, изворни језик превода каталога `blog` је `zh` , а изворни језик превода `blog/your_file_name.md` је `ja` .

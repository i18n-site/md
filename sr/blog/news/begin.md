...
brief: |
  Тренутно су имплементирана два алата командне линије отвореног кода: и18 (алатка за превођење командне линије МаркДовн) и и18н.сите (генератор сајтова за статички документ на више језика)
...
Превод се може мењати у оригиналном тексту, а када се поново машински преведе, ручне измене превода неће бити преписане (ако овај пасус оригиналног текста није измењен).

# И18н.сите МаркДовн Конвенција Писања
...
## Слике/Видео Записи/Линкови На Више Језика

Након што се `MarkDown` конвертује у `HTML` , `$LANG` у атрибутима `src` и `href` ће бити замењено тренутним [кодом језика](/i18/LANG_CODE) .

Помоћу ове променљиве можете постићи вишејезичност слика/видео снимака/линкова.
...
Истовремено, можете да погледате следећу конфигурацију, измените датотеку и конфигуришете да се отпремљена датотека аутоматски компримује на `avif` да бисте смањили величину слике.

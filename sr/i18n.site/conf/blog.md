...
Подаци о аутору могу бити написани у мета-информацијама чланка, као што су:
...
`name` , `url` и `title` су сви опциони. Ако `name` није постављено, име кључа (овде `marlowe` ) ће се користити као `name` .

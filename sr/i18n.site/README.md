...
`i18n.site` је генератор сајта докумената и оквир за развој веб странице.

Нова парадигма развоја веб страница која узима `MarkDown` као центар и користи фронт-енд компоненте за убризгавање интерактивности.
...
<button onclick="mailsub()">Кликните на ову е-пошту да бисте се претплатили на ажурирања производа</button> и <button onclick="webpush()">омогућили пусх претраживач</button> . Обавестићемо вас када буду направљена ажурирања производа.

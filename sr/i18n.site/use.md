...
Прво [кликните github да бисте направили организацију](https://github.com/account/organizations/new?plan=free) . Следећи назив организације је `i18n-demo` .
...
Молимо додајте конфигурацију сличну следећој у `server` параграфу nginx Молимо вас да промените `/root/i18n/md/out/ol/htm` у путању вашег сопственог пројекта `out/ol/htm` :

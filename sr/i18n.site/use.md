...
Затим унесите `docker` директоријум и покрените `./up.sh` , а затим посетите да бисте локално прегледали [https://127.0.0.1](https://127.0.0.1)
...
Затим конфигуришите садржај у директоријуму `md/out/ol/v` на путању префикса УРЛ адресе постављену у `v:` .
...
Страницу за улазак на веб локацију потребно је само једном применити и нема потребе да се поново поставља страница за улазак на веб локацију за накнадна ажурирања садржаја.
...
Након везивања по први пут, потребно је да сачекате неколико минута пре него што му можете приступити.
...
Затим користите складиште објеката добављача у облаку у континенталној + `CDN` Поставите следећи садржај `out/ol/htm` !

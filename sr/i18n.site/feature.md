...
`i18n.site` ће подразумевано објавити садржај сајта на `npmjs.com` , уз помоћ [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) и другог вишеструког садржаја `CDN` учитаног на `npm` !
...
Слика изнад приказује вишејезичност `RSS` [inoreader.com](//inoreader.com) претплату `i18n.site` .

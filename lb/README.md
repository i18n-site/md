<h1 style="display:flex;justify-content:space-between">i18n.site International Léisungen<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
Och wann de Browser eng agebaute Iwwersetzung huet, kënnen d'Sichmaschinn nach ëmmer net iwwer Sproochen ufroen.
...
## <a rel=id href="#project" id="project"></a> Projet Beschreiwung

Dëse Site bitt de Moment zwee Open Source Kommandozeil Tools:
...
Iwwersetzt `Markdown` an `YAML` an e Kommandozeil-Tool ( [Quellcode](https://github.com/i18n-site/rust/tree/main/i18) ) a verschidde Sproochen.

Kann de Format perfekt erhalen `Markdown` Kann Dateimodifikatioune identifizéieren an nëmmen geännert Dateien iwwersetzen.

D'Iwwersetzung ass editable.

Ännert den Originaltext an iwwersetzt et nach eng Kéier, déi manuell Ännerunge vun der Iwwersetzung ginn net iwwerschriwwen (wann dëse Paragraf vum Originaltext net geännert gouf).

Mir deelen " Philosophie `UNIX` Alles ass e Fichier " a kënne Iwwersetzungen an Honnerte vu Sprooche verwalten ouni komplex an ëmständlech Léisungen op Enterprise-Niveau aféieren.

Dir kënnt déi bekanntst Tools benotze fir d'Iwwersetzung `Markdown` (awer Dir kënnt Paragrafen net derbäisetzen oder läschen), a benotzt de bekanntste Wee fir Versiounskontrolle ze maachen.

Eng Codebasis kann als Open Source fir Sproochdateien erstallt ginn, a mat der Hëllef vum `Pull Request` Nahtlos [github](//github.com) An aner Open Source Gemeinschaften.

[→ Fir Benotzerguide, liest w.e.g. d'Projetdokumentatioun](/i18) .

## Xindaya Héichqualitativ Iwwersetzung
...
Blann Tester weisen datt eis Iwwersetzungsqualitéit wesentlech besser ass am Verglach mat ähnlechen Servicer.

Fir déi selwecht Qualitéit z'erreechen, `3.15` de Betrag vun `2.67` manueller Redaktioun erfuerderlech vu Google Translate a `ChatGPT`
...
Reng statesch, optimiséiert fir Lieserfarung, an integréiert mat der Iwwersetzung vun [i18](#i18) et ass déi bescht Wiel fir e Projet Dokument Site ze bauen.
...
Dës Websäit gëtt op Basis vun dësem Kader entwéckelt an enthält Benotzer, Bezuelung an aner Funktiounen ( [Quellcode](/i18n.site/src) ) En detailléierte Tutorial gëtt méi spéit geschriwwe ginn.

[→ Fir Benotzerguide, liest w.e.g. d'Projetdokumentatioun](/i18n.site) .
...
[i18n-site.bsky.social](https://bsky.app/profile/i18n-site.bsky.social) / eis sozial Konten ze verfollegen [X.COM: @i18nSite](https://x.com/i18nSite)

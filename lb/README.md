...
Mat sozialen Medien an Email sinn d'Leit gewinnt sech op Informatiounsquellen an hirer eegener Mammesprooch ze fokusséieren.
...
<button onclick="mailsub()">Klickt w.e.g. op dës E-Mail fir op Produktupdates ze abonnéieren</button> an <button onclick="webpush()">de Browser Push z'aktivéieren</button> Mir informéieren Iech wann d'Produkter aktualiséiert ginn.
...
> Si soten: Kommt, baut en Tuerm, deen den Himmel erreecht a mécht d'Mënschheet berühmt.
>
> Den HÄR huet dat gesinn a sot: "All Mënschen hunn déiselwecht Sprooch a Rass. Elo, datt dëst fäerdeg bruecht ass, wäert alles gemaach ginn."
>
...
Markdown Iwwersetzung an Dokumentatioun Site si just den Ufank.

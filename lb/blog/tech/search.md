...
Wéinst de Mängel vun existente Léisungen huet `i18n.site` eng nei pure Front-End Volltext Sichléisung entwéckelt, déi folgend Charakteristiken huet :
...
1. Ënnerstëtzt Präfix Sich, déi d'Sichresultater an Echtzäit weisen kann während de Benotzer tippt.
1. Offline Verfügbar
...
De Sichkär benotzt den `prefix` Tabelle fir dat lescht Wuert no der Wuertsegmentatioun fir all Wierder ze fannen, déi domat virgeschriwwe sinn, a sichen an der Sequenz.

...
D'Mapping tëscht der Iwwersetzung an dem Originaltext ass un den Token gebonnen Erstellt en neit Token an [i18n.site/token](//i18n.site/token) läscht `.i18h/hash` , an iwwersetzt nach eng Kéier fir déi konfus Mapping ze läschen (awer dëst wäert all manuell Upassunge vun der Iwwersetzung verléieren).

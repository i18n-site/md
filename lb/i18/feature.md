...
Iwwersetzungskommentarer mussen d'Sprooch no ` ``` ` uginn, : ` ```rust ` .
...
Ënnerstëtzt d'Headerkonfiguratioun vum [HOGO](https://github.com/gohugoio/hugo) statesche Blog, deen nëmme Felder `title` , `summary` an `description` iwwersetzt.
...
`ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` op Japanesch :

![](//p.3ti.site/1720199391.avif)

`Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` op Franséisch :
...
`ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` op Japanesch :

![](//p.3ti.site/1720199550.avif)

Iwwersetzung vun den uewe DeepL op Franséisch (och déi eegen Nimm ëmschreiwen an déi komesch `... ` bäizefügen):
...
De Client ass komplett Open Source, an de Server 90 % vum Code ass Open Source [Klickt hei fir de Quellcode ze gesinn](/i18n.site/src) .

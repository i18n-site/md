...
Fir wéi mathematesch Formelen ze schreiwen, kuckt w.e.g. op [" Github Iwwert mathematesch Ausdréck schreiwen"](https://docs.github.com/get-started/writing-on-github/working-with-advanced-formatting/writing-mathematical-expressions#about-writing-mathematical-expressions) .
...
China, Japan a Korea hu keng grouss Buschtawen oder kleng Buschtawen, mee Englesch Titelen allgemeng den éischte Buschtaf Kapital.
...
`i18` ass integréiert an de Multi-Sprooch Websäit Gebai Kommandozeil Tool [`i18n.site`](/i18n.site) .

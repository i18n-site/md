...
Domain Numm gehost fir [cloudflare](//www.cloudflare.com)
...
Well `R2` `cloudflare` vun engem personaliséierten Domain Numm zougänglech ass, muss eng Drëtt Partei Objektlagerung benotzt ginn fir statesch Dateien ze placéieren.

Hei [backblaze.com](https://www.backblaze.com) mir e Beispill fir ze demonstréieren wéi Dir Drëtt-Partei-Objete verbënnt fir op `cloudflare` ze späicheren.

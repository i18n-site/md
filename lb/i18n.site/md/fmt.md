...
D'Verankerungsléisung, déi mat `i18n.site` ausgemaach ass, ass den Text ähnlech wéi `<a rel=id href="#xxx" id="xxx"></a>` an `MarkDown` anzeginn fir de Positionéierungsankerpunkt manuell ze kreéieren.

...
可以参考 [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) 中的实现，代码如下:
...
`MarkDown`中转为`HTML`之后，`src`和`href`属性中的`$LANG`会被替换成当前[语言代码](/i18/LANG_CODE)。

借此变量，即可实现图片/视频/链接的多语言化。

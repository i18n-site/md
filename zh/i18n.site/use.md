...
编辑`md/.i18n/htm/ol.yml`，修改[`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7)的值`YOUR_NPM_PACKAGE`为你自己的`npm`包名，任何 [npmjs.com](//npmjs.com) 上未被占用的包名都可以。

# I18N.SITE · 文档无国界 <img src="//ok0.pw/5l" style="float:right;width:42px;margin-top:6px">

I18N.SITE，支持自动翻译成 [133 种不同的语言](https://github.com/i18n-site/node/blob/main/lang/src/index.js) 的静态站点生成器。

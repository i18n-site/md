...
3Ti.Site，Markdown 翻译 + 多语言静态站点生成，能让您的网站支持 [上百种语言](https://github.com/i18n-site/node/blob/main/lang/src/index.js) 。
...
可完美保留原格式的 Markdown 翻译脚本。

该粗体的部分译文里还是粗体。列表，标号，标题一个不丢。

如果 Markdown 里有示例代码，示例代码会原封不动保留。

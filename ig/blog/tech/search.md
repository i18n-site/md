...
brief: |
  ...
  Edemede a na-ewebata mmejuputa teknụzụ nchọta ederede zuru oke n'ihu, gụnyere ntụgharị ntụgharị nke IndexedDB wuru, ọchụchọ prefix, njikarịcha nkebi okwu na nkwado asụsụ ọtụtụ.
...
* `rindex` : Okwu id - Akwụkwọ id : N'usoro nke nọmba akara
...
Ka ịzenarị mfu data n'eleghị anya n'ihu nke edemede asọmpi kpatara, ị nwere ike rụtụ aka na koodu `coffeescript` dị n'okpuru wee tinye cache `ing` n'etiti ịgụ na ide iji gbochie ndị na-asọmpi.
...
Nchọgharị kernel ga-eji tebụl `prefix` maka okwu ikpeazụ ka nkebi okwu gachara chọta okwu niile ejiri ya prefixed, wee chọọ n'usoro.
...
Nchọgharị ederede zuru oke etinyere na njedebe ihu, ọ nweghị ihe nkesa achọrọ. Ọ dabara nke ọma maka obere weebụsaịtị dị ka akwụkwọ na blọọgụ nkeonwe.

`i18n.site` Mepee isi mmalite nke nchọta n'ihu dị ọcha mepụtara, obere nha na nzaghachi ngwa ngwa, na-edozi adịghị ike nke nchọta ederede zuru oke dị ugbu a ma na-enye ahụmịhe onye ọrụ ka mma.
...
Mgbe emechara, a ga-ewepụta faịlụ ntụgharị na cache biko cheta itinye `git add . ` na ebe nchekwa na ndekọ `md` .
...
Ebe `--save` na-anọchite nọmba ụdị mwepụta mmelite.
...
Iji ọdịnaya nke onwe, na mgbakwunye na iji ihe nkesa nke gị, nhọrọ ọzọ a na `CDN` ahụkarị bụ iji `S3` +
...
E jiri ya [cloudflare page](//pages.cloudflare.com) `github page` , ọ na-enye ndị na-edegharị ụzọ ma na-enwekwu enyi na China ma na-atụ aro ka ị jiri ya.
...
Iwu dị na foto a dị n'elu bụ ndị a, biko dochie `i18n.site` n'ahịrị mbụ dị n'okpuru ebe a na aha ngalaba.
...
Mgbe `CDN` , jiri ihe nchekwa ihe nke ndị na-ere igwe ojii na China `out/ol/htm` +
...
Tinye ngalaba aha na [Alibaba Cloud CDN](https://cdn.console.aliyun.com/domain/list) wee tụọ ngalaba aha `*.xxx.com` ruo `CNAME` na Alibaba Cloud `CDN` .

...
Aha ndekọ aha nke `demo.i18n.site` code base clone ga-abụrịrị `md` iji mee ka nlele mpaghara jiri `docker` dị mfe.
...
N'ikpeazụ, **hazie oge cache nke ụzọ ahụ na-ejedebe na `/.v` ruo `1s`** , ma ọ bụghị ya, enweghị ike ịnweta ọdịnaya ewepụtara ọhụrụ ozugbo.
...
Ọ bụrụ na ị na-eji `i18n.site` iji wepụta webụsaịtị dị ka ebe nrụọrụ weebụ kachasị gị, ị ga-achọkarị ịhazi redirection pan-domain, ya bụ, redirect nweta `*.xxx.com` (gụnyere `www.xxx.com` ) gaa na `xxx.com` .

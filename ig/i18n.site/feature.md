...
## Ntụgharị Asụsụ Jikọtara `I18`

Ihe omume a arụnyere n'ime `i18` , biko hụ [➔ `i18`](/i18) maka ojiji a kapịrị ọnụ.
...
Site na `i18n.site` , a ga- `npm` ọdịnaya saịtị na `npmjs.com` , site n'enyemaka nke [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) yana ọtụtụ `CDN` .
...
Ụkpụrụ bụ: mechie arịrịọ site n'enyemaka nke [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , ọ bụrụ na arịrịọ ahụ adaghị, gbalịa ọzọ na `CDN` ọzọ, ma mee ka ọdụ ụgbọ elu na-aza ngwa ngwa dị ka isi mmalite nbudata.
...
> Ọ na-ahapụ ịchọ mma na-enweghị isi ma na-enye ọdịnaya n'ụdị ya kachasị ọcha.
...
Site na ndabara, [Alimama dual-axis variable rectangular fonts](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) -enyere aka na ibe weebụ iji jikọta ahụmịhe ọgụgụ nke ndị ọrụ na nyiwe dị iche iche.
...
`404` mmụọ mara mma na-ese n'elu ibe, anya ya ga-eji òké na-agagharị, [➔ Pịa ebe a ka ịlele](/404) ,
...
Enwere ọtụtụ obere ihe ndị dị mkpa ma ọ bụghị ngwa ngwa Ndị otu mmepe ga-ekenye ọrụ omume dịka teknụzụ ị dị mma, ma melite akwụkwọ mmepe mgbe ị na-ekenye ihe ndị a chọrọ.

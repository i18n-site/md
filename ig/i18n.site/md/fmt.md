...
A na-ewepụta isi arịlịka `MarkDown` sitere na ọdịnaya ederede N'ihe gbasara asụsụ ọtụtụ, ngwọta a agaghị ekwe omume.
...
A gaghị atụgharị asụsụ ọdịnaya n'ime ihe `<pre>` .

Ijikọta isi ihe abụọ a, ị nwere ike dee `HTML` n'ime `MarkDown` ngwa ngwa iji nweta mmetụta ngosi dị iche iche.

Ị nwere ike na-ezo aka na mmejuputa iwu na [github.com/i18n-site/md/en/README.md](https://raw.githubusercontent.com/i18n-site/md/main/en/README.md) koodu dị ka ndị a :

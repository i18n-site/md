...
Na nhazi, biko gbanwee `i18n.site` na uru nke `host:` na `.i18n/htm/ol.yml` , ọtụtụ ụlọ ahịa ihe nwere ike ịhazi n'okpuru `s3` , na mpaghara `region` bụ nhọrọ (ọtụtụ ụlọ ahịa ihe adịghị mkpa ịtọ ebe a).
...
Mgbe ahụ mepụta script na [EdgeJS ihu](//console.bce.baidu.com/cdn/#/cdn/ejs/list) dị ka ndị a
...
N'ihi na `cloudflare` ịnweta `R2` n'ime aha ngalaba ahaziri ahazi, ekwesịrị iji nchekwa ihe ndị ọzọ idowe faịlụ static.
...
Megharịa `cloudflare` nke `SSL` → ọnọdụ nzuzo, ka ọ bụrụ `Full`

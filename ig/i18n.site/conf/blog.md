...
A haziri faịlụ ngosi dị ka ndị a:
...
Enwere ike dee ozi ndị odee n'ime ozi meta nke akụkọ a, dịka:

```yml
author: marlowe
```

Mgbe ahụ dezie `author.yml` n'ime akwụkwọ ndekọ asụsụ isi wee tinye ozi odee, dịka :

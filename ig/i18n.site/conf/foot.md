...
Biko rụtụ aka na ihe ndị a, a na-ede ụdị ahụ n'ime `.css` kwekọrọ, na mmekọrịta ahụ na-enweta site na ịmepụta ihe ntanetịime weebụ.
...
* `foot.css` :
* `import.css` : Ụdị `i18n.site` maka saịtị ahụ dum
* `conf.css` akara : na mkpụrụedemede

### Akara Ngosi Font

Emepụtara akara ngosi n'okpuru site na ịmepụta mkpụrụedemede aha ya `F` iconfont.cn [ụdị Bekee](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
Ebe `${I18N.C}` kwekọrọ na `en/i18n.yml` :

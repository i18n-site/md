...
Na-akwado ntụgharị asụsụ HTML Markdown , ọdịnaya dị na mkpado `<pre>` na `<code>` nke HTML agbakwunyere na `MarkDown` adịghị atụgharị ya
...
Nkọwa ntụgharị asụsụ kwesịrị igosi asụsụ mgbe ` ``` ` gachara, dị : ` ```rust ` .
...
Enwekwara ụfọdụ ngwaọrụ ntụgharị asụsụ ahịrị iwu, dị ka [translate-shell](https://github.com/soimort/translate-shell)
...
## Nkwado Ntụgharị Asụsụ `HOGO` Nhazi Nkụnye Eji Isi Mee

Na-akwado nhazi nkụnye `title` `summary` `description` nke [HOGO](https://github.com/gohugoio/hugo)
...
`i18` nwere ike ịmata aha na `MarkDown` , ma ga-edepụta mkpụrụedemede mbụ na-akpaghị aka mgbe ị na-atụgharị n'asụsụ nwere mmetụta.

Dịka ọmụmaatụ, a ga-atụgharị `为阅读体验而优化` ka ọ bụrụ `Optimized for Reading Experience` .
...
Atụgharịrị n'asụsụ `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

Atụgharịrị na `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :
...
Atụgharịrị n'asụsụ `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

Ntụgharị asụsụ nke dị n'elu ka ọ bụrụ DeepL (na-edegharịkwa aha ndị kwesịrị ekwesị yana ịgbakwunye `... ` dị njọ):
...
`i18` na-etinye n'ime [`i18n.site`](/i18n.site) ọrụ ahịrị iwu iwu webụsaịtị ọtụtụ asụsụ.

Hụ akwụkwọ [`i18n.site`](/i18n.site) maka nkọwa.

## Koodu Mepere Emepe

Onye ahịa na-emeghe kpamkpam, na 90 nkesa % nke koodu ahụ bụ isi mmalite [Pịa ebe a ka ịlele koodu mmalite](/i18n.site/src) .

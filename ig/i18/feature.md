...
Na-akwado ntụgharị asụsụ agwakọtara HTML , ọdịnaya dị Markdown mkpado `<pre>` na `<code>` nke HTML agbakwunyere na `MarkDown` adịghị atụgharị ya
...
Na-akwado nhazi nkụnye eji isi [HOGO](https://github.com/gohugoio/hugo) nke ụdị blọọgụ static, na-atụgharịkwa naanị mpaghara `title` , `summary` , `brief` , na `description` .
...
Onye ahịa na-emeghe kpamkpam, na akụkụ 90 % nke koodu ahụ bụ isi mmalite [Pịa ebe a ka ịlele koodu mmalite](/i18n.site/src) .

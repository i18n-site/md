...
windows , biko [pịa ebe a ka ibudata na wụnye `git bash`](https://git-scm.com/download/win) mbụ.
...
Ị nwere ike hazie `fromTo` dị iche iche maka / subdirectories dị iche iche edere dị ka ndị a :
...
Na tebụl nhazi a, asụsụ isi mmalite nke ntụgharị asụsụ katalọgụ `blog` bụ `zh` , na asụsụ isi mmalite nke ntụgharị `blog/your_file_name.md` bụ `ja` .
...
`ignore` na-eji otu [globset](https://docs.rs/globset/latest/globset/#syntax) ahụ dị ka faịlụ `.gitignore` .

...
Браузерде кірістірілген аударма болса да, іздеу жүйелері әлі де тілдер бойынша сұрау жасай алмайды.
...
## <a rel=id href="#project" id="project"></a> Жоба Сипаттамасы

Бұл сайт қазіргі уақытта екі ашық бастапқы пәрмен жолы құралын ұсынады:

* [i18 : MarkDown Пәрмен жолын аудару құралы](/i18/feature)
...
`Markdown` және `YAML` пәрмен жолының құралына ( [бастапқы код](https://github.com/i18n-site/rust/tree/main/i18) ) бірнеше тілге аударыңыз.

пішімін тамаша сақтай алады `Markdown` Файл өзгертулерін анықтай алады және тек өзгертілген файлдарды аудара алады.
...
Біз " Бәрі файл " `UNIX` бөлісеміз және кәсіпорын деңгейіндегі күрделі және қолайсыз шешімдерді енгізбестен жүздеген тілдегі аудармаларды басқара аламыз.

Аударманы `Markdown` үшін ең таныс құралдарды пайдалануға болады (бірақ абзацтарды қосу немесе жою мүмкін емес) және нұсқаны басқарудың ең таныс әдісін пайдалануға болады.

Кодтық базаны тілдік файлдар үшін ашық дереккөз ретінде жасауға болады және `Pull Request` процесінің көмегімен жаһандық пайдаланушылар аудармаларды үздіксіз оңтайландыруға қатыса алады. Үздіксіз байланыс және басқа да ашық бастапқы қауымдастықтар [github](//github.com)

[→ Пайдаланушы нұсқаулығын алу үшін жоба құжаттамасын оқыңыз](/i18) .
...
Таза статикалық, оқу тәжірибесі үшін оңтайландырылған және [i18](#i18) бұл жобалық құжат сайтын құру үшін ең жақсы таңдау.

Негізгі алдыңғы жақтау жүйесі қосымша өңдеуге оңай толық қосылатын модульді қабылдайды, қажет болған жағдайда, back-end функцияларын біріктіруге болады.

Бұл веб-сайт осы негізге негізделген және пайдаланушы, төлем және басқа функцияларды қамтиды ( [бастапқы код](/i18n.site/src) ) Толық оқулық кейінірек жазылады.

[→ Пайдаланушы нұсқаулығын алу үшін жоба құжаттамасын оқыңыз](/i18n.site) .
...
>
> Содан келіп, адам баласы бір-бірінің тілін түсінбей, әр жерге тарап кетті.
...
Сыйақы төлей алатын көп тілді билет жүйесі;

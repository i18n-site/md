...
Әлеуметтік желілер мен электрондық пошта арқылы адамдар өздерінің ана тілінде ақпарат көздеріне назар аударуға дағдыланған.
...
* [i18n.site : статикалық веб-сайт генераторы](/i18n.site)
...
Біз `UNIX` философиясына жазыламыз " Барлығы файл " және күрделі және күрделі кәсіпорын деңгейіндегі шешімдерді енгізбестен жүздеген тілдерге аудармаларды басқара аламыз.
...
#### <a rel=id href="#price" id="price"></a> Өте бәсекеге қабілетті баға
...
<button onclick="mailsub()">Өнім жаңартуларына жазылу үшін осы электрондық поштаны басыңыз</button> <button onclick="webpush()">және</button> өнімдер жаңартылған кезде біз сізге хабарлаймыз.
...
Біз тілді оқшаулаусыз Интернетті құрғымыз келеді.
Барша адамзат ортақ арманмен бас қосады деп сенеміз.

Markdown аудармасы және құжаттама сайты тек бастамасы ғана.
Мазмұнды жариялауды әлеуметтік желіге синхрондау;
Екі тілді пікірлер мен сөйлесу бөлмелерін қолдайды;

...
Әркімнің өзінің сүйікті редакторы бар. Мұнда біз `Markdown` үздік тәжірибемізбен бөлісеміз.

Біз `MarkDown` жазу үшін [vscode](https://code.visualstudio.com/) , сонымен қатар жазу кезінде нақты уақытта алдын ала қарау үшін [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) плагинін орнатамыз.

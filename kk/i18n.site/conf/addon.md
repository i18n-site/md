...
Нұсқаны түзеткіңіз келсе, `i18n.addon/toc@0.1.3` деп жаза аласыз.
...
* `lang_li` : тізімі, бірінші тіл - бастапқы тіл
* `changed` : файлдар
* `root` : түбірлік каталогы
...
Кірістірілген `js` жұмыс уақыты [boa](https://github.com/boa-dev/boa) -нің екінші реттік дамуына негізделген, ал кірістірілген функциялар келесідей :

* `wPath(path, txt)` файлға :
* `rTxt(path)` Мәтіндік файлды :
* `rBin(path)` екілік файлды :

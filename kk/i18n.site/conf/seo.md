...
`i18n.site` жаңартылмайтын бір бет архитектурасын қабылдайды. Іздеу индексін жеңілдету үшін тексеріп шығушылар тексеріп шығу үшін бөлек статикалық бет және `sitemap.xml` жасалады.

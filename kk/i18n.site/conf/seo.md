...
Статикалық файлдарды жергілікті түрде жасауға болады, бірақ неғұрлым кең тараған тәсіл оларды нысан жадына жүктеп салу болып табылады.
...
Конфигурацияда `i18n.site` мәнін `host:` in `.i18n/htm/ol.yml` мәніне өзгертіңіз, бірнеше нысан қоймаларын `s3` астында конфигурациялауға болады және `region` өрісі міндетті емес (көптеген нысандар қоймаларында бұл өрісті орнату қажет емес).
...
### `cloudflare R2` Теңшелетін Домен Атауы Арқылы Қол Жеткізу Мүмкін Емес

`R2` теңшелген домен аты арқылы кіру `cloudflare` , статикалық файлдарды орналастыру үшін үшінші тарап нысан қоймасын пайдалану қажет.

Мұнда біз `cloudflare` -де сақталатын үшінші тарап нысандарын қалай байланыстыру керектігін көрсету үшін мысал ретінде [backblaze.com](https://www.backblaze.com) .
...
Домен атауын `cloudflare` -де `CNAME` ден `f003.backblazeb2.com` өзгертіңіз және проксиді қосыңыз.

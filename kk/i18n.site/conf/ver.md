...
Іздеу жүйелерімен индекстелген беттерде тым көп нұсқа нөмірлерінің кедергісін тудырмау үшін құжаттың нұсқа нөмірін негізгі жаңартулар шығарылған кезде ғана өзгерту ұсынылады (мысалы, `v1` , `v2` ).
...
[https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) , демонстрациялық жобадағы `blog` ге сәйкес келетін индекс файлы :
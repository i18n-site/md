...
`md/.i18n/htm/ol.yml` мәнін өңдеңіз және [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` [npmjs.com](//npmjs.com) өзіңіздің `npm` бума атауы ретінде өзгертіңіз.

Содан кейін `md/.i18n/htm/ol.package.json` өзгертіңіз

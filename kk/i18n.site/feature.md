...
`i18n.site` `npmjs.com` бойынша сайт мазмұнын , [unpkg.com](//unpkg.com) [jsdelivr.com](//jsdelivr.com) және `npm` ке жүктелген басқа `CDN` мазмұнды жариялайды.
...
Принцип: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) бар сұрауларды тоқтату, басқа `CDN` лерде сәтсіз сұрауларды қайталау және әдепкі жүктеу көзі ретінде ең жылдам жауап беретін бастапқы торапты бейімдеу арқылы қосу.
...
Веб-сайт бір беттік қолданба архитектурасын қабылдайды, беттерді ауыстырған кезде жаңартусыз және өте жылдам жүктеледі.
...
Жоғары жылжытыңыз және жасырын шарлау қайтадан пайда болады.
...
Маңызды, бірақ шұғыл емес көптеген шағын талаптар бар. Әзірлеу тобы сіз жақсы меңгерген технологияға сәйкес тәжірибе тапсырмаларын тағайындайды және талаптарды тағайындау кезінде әзірлеу құжаттарын жақсартады.
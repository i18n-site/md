...
`i18n.site` `npmjs.com` бойынша сайт мазмұнын , [jsdelivr.com](//jsdelivr.com) көмегімен және `npm` [unpkg.com](//unpkg.com) жүктелген бірнеше `CDN` мазмұнды жариялайды.
...
Жоғарыдағы сурет `i18n.site` жазылымын [inoreader.com](//inoreader.com) көп тілді `RSS` көрсетеді.
...
`404` бетінде кішкентай сүйкімді жүзбелі елес бар, оның көздері тінтуірмен қозғалады, [➔ Көру үшін осы жерді басыңыз](/404) ,

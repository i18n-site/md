...
## `YAML` `HTML` : `Markdown` Ге Айналуын Қалай Болдырмауға Болады
...
`a` тегіне `<a class="A" href="/">Home</a>` сияқты `href` ден басқа кез келген төлсипатты қосу бұл түрлендіруді болдырмайды.

...
аралас HTML аудармасын қолдайды, `MarkDown` ішіне енгізілген HTML `<pre>` Markdown `<code>` тегтеріндегі мазмұн аударылмайды
...
Клиент толығымен ашық бастапқы код, 90 кодтың % сервері [бастапқы кодты көру үшін осы жерді басыңыз](/i18n.site/src) .

...
Markdown HTML қолдайды, `MarkDown` ішіне енгізілген HTML `<pre>` және `<code>` тегтеріндегі мазмұн аударылмайды
...
Тек `title` , `summary` және `description` өрістерін аударатын статикалық блог [HOGO](https://github.com/gohugoio/hugo) тақырып конфигурациясын қолдайды.

...
windows Жүйе, алдымен [`git bash` жүктеп алу және орнату үшін осы жерді басыңыз](https://git-scm.com/download/win) .
...
Олардың ішінде `.i18n/cache/.gitignore` мазмұны төмендегідей :
...
Бұл `.i18n/cache/` каталогындағы ( `.i18n/cache/.gitignore` -тен басқа) барлық файлдар еленбейді дегенді білдіреді.

Егер нұсқаны басқару бағдарламалық құралы `git` болмаса, оны осы конфигурацияға сәйкес елемеуіңізді өтінеміз.
...
Мысалы, қытай тілін ағылшын тіліне аударғыңыз келсе, осы жолды `zh: en` деп қайта жазыңыз.
...
Бұл конфигурация кестесінде каталог `blog` аудармасының бастапқы тілі `zh` , ал `blog/your_file_name.md` аудармасының бастапқы тілі `ja` .
...
Бірақ аударма жолдары мен түпнұсқа мәтін бір-біріне сәйкес келуі керек екенін ескеріңіз. Яғни, аударманы құрастырған кезде жолдарды қосуға немесе жоюға болмайды. Әйтпесе, ол аударманы өңдеу кэшінде шатасуға әкеледі.

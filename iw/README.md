# I18N.SITE · שפה ללא גבולות<img Src="//ok0.pw/5l" Style="float:right;width:42px;margin-Top:6px">

I18N.SITE, מחולל אתרים סטטי התומך בתרגום אוטומטי ליותר [ממאה שפות שונות](https://github.com/i18n-site/node/blob/main/lang/src/index.js) .

...
ഡെമോ പ്രോജക്റ്റിലെ `.i18n/htm/ol.yml` കോൺഫിഗറേഷൻ ഫയൽ ഉദാഹരണമായി എടുക്കുക
...
ദയവായി ആദ്യം മുകളിലെ `host:` യുടെ മൂല്യം `i18n.site` പോലെ നിങ്ങളുടെ ഡൊമെയ്ൻ നാമത്തിലേക്ക് പരിഷ്ക്കരിക്കുക.
...
കോൺഫിഗറേഷനിൽ, ദയവായി `i18n.site` `.i18n/htm/ol.yml` ലെ `host:` ൻ്റെ മൂല്യത്തിലേക്ക് മാറ്റുക, ഒന്നിലധികം ഒബ്ജക്റ്റ് സ്റ്റോറുകൾ `s3` കീഴിൽ കോൺഫിഗർ ചെയ്യാം, കൂടാതെ `region` ഫീൽഡ് ഓപ്ഷണലാണ് (പല ഒബ്ജക്റ്റ് സ്റ്റോറുകൾക്കും ഈ ഫീൽഡ് സജ്ജീകരിക്കേണ്ടതില്ല).
...
തുടർന്ന് ഇനിപ്പറയുന്ന രീതിയിൽ [EdgeJS](//console.bce.baidu.com/cdn/#/cdn/ejs/list) സൃഷ്ടിക്കുക
...
ഉദാഹരണത്തിന്, [Huawei DNS](https://www.huaweicloud.com) സൗജന്യ പ്രാദേശിക വിശകലനം നൽകുന്നു, ഇതിലൂടെ മെയിൻലാൻഡ് ചൈനീസ് ട്രാഫിക്കിന് Baidu സ്മാർട്ട് ക്ലൗഡിലൂടെയും അന്താരാഷ്ട്ര ട്രാഫിക്കിന് `cloudflare` വഴിയും പോകാം.
...
`R2` ഡൊമെയ്ൻ നാമം ഉപയോഗിച്ച് ആക്സസ് ചെയ്യാൻ `cloudflare` , സ്റ്റാറ്റിക് ഫയലുകൾ സ്ഥാപിക്കാൻ ഒരു മൂന്നാം കക്ഷി ഒബ്ജക്റ്റ് സ്റ്റോറേജ് ഉപയോഗിക്കേണ്ടതുണ്ട്.

മൂന്നാം കക്ഷി ഒബ്ജക്റ്റുകൾ `cloudflare` -ൽ സംഭരിക്കുന്നതെങ്ങനെയെന്ന് കാണിക്കാൻ ഞങ്ങൾ ഇവിടെ ഒരു ഉദാഹരണമായി [backblaze.com](https://www.backblaze.com) .
...
കൂടാതെ, മുകളിലുള്ള `cloudflare` കൺവേർഷൻ റൂളിൽ, `index.html` എന്നത് `file/your_bucketname/index.html` ആയി മാറ്റുകയും മറ്റ് കോൺഫിഗറേഷനുകൾ അതേപടി തുടരുകയും ചെയ്യുന്നു.

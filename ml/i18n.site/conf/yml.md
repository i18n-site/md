...
`news/begin.md` എന്നത് `Our Product is Online !` നോട് യോജിക്കുന്നു
...
ഡ്രോപ്പ്-ഡൗൺ മെനുവും കാറ്റലോഗ് ഔട്ട്ലൈൻ പ്രോജക്റ്റ് നാമവും `Deme Two` `Your Project slogan` താഴെ അതിൻ്റെ പ്രോജക്റ്റ് ടാഗ്ലൈൻ ഉണ്ടെന്ന് നിങ്ങൾക്ക് കാണാൻ കഴിയും :

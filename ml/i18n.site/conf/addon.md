...
ബിൽറ്റ്-ഇൻ `js` റൺടൈം [boa](https://github.com/boa-dev/boa) എന്നതിൻ്റെ ദ്വിതീയ വികസനത്തെ അടിസ്ഥാനമാക്കിയുള്ളതാണ്, കൂടാതെ ബിൽറ്റ്-ഇൻ ഫംഗ്ഷനുകൾ ഇനിപ്പറയുന്നവയാണ് :

...
ഈ രണ്ട് പോയിൻ്റുകൾ സംയോജിപ്പിച്ച്, വിവിധ ഡിസ്പ്ലേ ഇഫക്റ്റുകൾ നേടുന്നതിന് നിങ്ങൾക്ക് `MarkDown` -ൽ `HTML` എളുപ്പത്തിൽ എഴുതാം.
...
## ഒന്നിലധികം ഭാഷകളിലെ ചിത്രങ്ങൾ/വീഡിയോകൾ/ലിങ്കുകൾ

`MarkDown` `HTML` ആക്കി മാറ്റിയ ശേഷം, `src` , `href` ആട്രിബ്യൂട്ടുകളിലെ `$LANG` എന്നത് നിലവിലെ [ഭാഷാ കോഡ്](/i18/LANG_CODE) ഉപയോഗിച്ച് മാറ്റിസ്ഥാപിക്കും.

ഈ വേരിയബിൾ ഉപയോഗിച്ച്, നിങ്ങൾക്ക് ചിത്രങ്ങൾ/വീഡിയോകൾ/ലിങ്കുകളുടെ ബഹുഭാഷാവൽക്കരണം നേടാനാകും.
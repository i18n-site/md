...
`MarkDown` എഴുതാൻ ഞങ്ങൾ ഉപയോഗിക്കുന്നു [vscode](https://code.visualstudio.com/) കൂടാതെ എഴുതുമ്പോൾ തത്സമയം പ്രിവ്യൂ ചെയ്യാൻ പ്ലഗ്-ഇൻ [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) ഇൻസ്റ്റാൾ ചെയ്യുന്നു.
...
ചിത്രങ്ങൾ അപ്ലോഡ് ചെയ്യാൻ [PicList](https://github.com/Kuingsmile/PicList) ഉപയോഗിക്കുക, അപ്ലോഡ് കുറുക്കുവഴി കീ സജ്ജീകരിക്കാനും ഒറ്റ ക്ലിക്കിൽ സ്ക്രീൻഷോട്ട് അപ്ലോഡ് ചെയ്യാനും ഓർമ്മിക്കുക.

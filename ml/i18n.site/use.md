...
`md/.i18n/htm/ol.yml` എഡിറ്റ് ചെയ്ത് നിങ്ങളുടെ സ്വന്തം `npm` പാക്കേജ് പേരിലേക്ക് `v: //unpkg.com/i18n.site` -ൽ `i18n.site` മാറ്റുക.

[npmjs.com](//npmjs.com) ഉപയോഗശൂന്യമായ പാക്കേജ് നാമം ഉപയോഗിക്കുക.

പാക്കേജ് `npm` അടിസ്ഥാനമാക്കി പ്രസിദ്ധീകരിക്കുമ്പോൾ, `v:` മൂല്യത്തിൻ്റെ പ്രിഫിക്സിന് `/.v` **`//unpkg.com/` ഉറപ്പാക്കുക** , പുതിയ റിലീസുകൾ സമയബന്ധിതമായി കാണുന്നതിന് ഈ പ്രിഫിക്സ് പാതയ്ക്ക് കീഴിൽ `i18n.site` ൻ്റെ കാഷെ സമയം പ്രത്യേകം ഒപ്റ്റിമൈസ് ചെയ്തിട്ടുണ്ട്.

വിവർത്തനം ചെയ്യാനും പ്രസിദ്ധീകരിക്കാനും `md` ഡയറക്ടറിയിൽ `i18n.site --npm` അല്ലെങ്കിൽ `i18n.site -n` പ്രവർത്തിപ്പിക്കുക.

പ്രസിദ്ധീകരിക്കാൻ നിങ്ങൾ തുടർച്ചയായ സംയോജന അന്തരീക്ഷം ഉപയോഗിക്കുകയാണെങ്കിൽ, `nodejs` ഇൻസ്റ്റാൾ ചെയ്യേണ്ട ആവശ്യമില്ല, ലോഗിൻ ചെയ്ത് പ്രസിദ്ധീകരിക്കാനുള്ള അനുമതി `~/.npmrc` പരിസ്ഥിതിയിലേക്ക് പകർത്തുക.
...
`S3` സെർവറിൽ ലോഗിൻ `S3` നിങ്ങൾക്ക് [rclone](https://rclone.org)
...
`out/ol/htm` ലേഖനത്തിലെ ഉള്ളടക്കം പ്രസിദ്ധീകരിക്കുമ്പോൾ, ഈ ഡയറക്ടറി നൽകി പ്രവർത്തിപ്പിക്കുക :
...
nginx `/root/i18n/md/out/ol/htm` `server` ഖണ്ഡികയിൽ ഇനിപ്പറയുന്നതിന് സമാനമായ `out/ol/htm` കോൺഫിഗറേഷൻ ചേർക്കുക.
...
സോഴ്സ് ലാംഗ്വേജ് ഡയറക്ടറി, `en` -ൽ `fromTo` ഇൻ `.i18n/conf.yml` കോൺഫിഗറേഷൻ ഫയലുമായി ബന്ധപ്പെട്ടിരിക്കുന്നു

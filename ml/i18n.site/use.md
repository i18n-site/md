...
`md/.i18n/htm/ol.yml` എഡിറ്റ് ചെയ്ത് നിങ്ങളുടെ സ്വന്തം `npm` പാക്കേജ് പേരായി [`md:`](//github.com/i18n-site/demo.i18n.site/blob/main/.i18n/htm/ol.yml#L7) `YOUR_NPM_PACKAGE` മൂല്യം മാറ്റുക [npmjs.com](//npmjs.com)

തുടർന്ന് `md/.i18n/htm/ol.package.json` പരിഷ്കരിക്കുക

...
Prevajalska ukazna vrstica `i18n.site` bo namestila datoteko konvencije paketa vtičnikov in jo nato izvedla.
...
* `rDir(dirpath)` : Preberite imenik, vrnjena vrednost je matrika : , seznam datotek

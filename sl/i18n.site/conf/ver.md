...
V demo projektu lahko poleg `en/demo2/v` vidite tudi, da so prazne datoteke `v` v imenikih `en/blog` in `en/demo1` .

Prazna `v` ne bo prikazana v orisu stranske vrstice, vendar dokler obstaja datoteka `v` , bo ustvarjen neodvisen indeks za datoteke v imeniku in podimenikih.

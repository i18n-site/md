# i18n.site: Čisto Statično Večjezično Ogrodje Spletnega Mesta

`i18n.site` večjezični, povsem statični generator spletnih mest z dokumenti.

Trenutno je na voljo na začetku, vendar so pomembne funkcije še vedno v razvoju. Za podrobnosti glejte [razvojni načrt](/i18n.site/c/roadmap) .
...
`i18n.site` je moj ponovni razmislek o modelu razvoja spletnega mesta.

To je generator spletnega mesta z dokumenti in okvir za razvoj spletnega mesta.

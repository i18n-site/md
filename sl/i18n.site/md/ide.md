...
Vsakdo ima svojega najljubšega urejevalnika. Tukaj delimo svoje najboljše prakse `Markdown`
...
Vnesite `code xxx.md` v ukazno vrstico, da pokličete `vscode` open `Markdown` file.
...
Podpira samodejno kopiranje formata imena datoteke `Markdown` po nalaganju, kar močno izboljša učinkovitost.

Hkrati se lahko obrnete na naslednjo konfiguracijo, spremenite datoteko in konfigurirate naloženo datoteko tako, da se samodejno stisne na `avif` , da se zmanjša velikost slike.

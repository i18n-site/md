...
Uporabljamo [vscode](https://code.visualstudio.com/) write `MarkDown` in namestimo tudi vtičnik [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) za predogled v realnem času med pisanjem.

Kot je prikazano spodaj, z desnim klikom v urejevalniku odprete okno za predogled.

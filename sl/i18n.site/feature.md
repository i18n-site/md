...
## Integrirano `I18` Prevajanje

Program ima vgrajen prevod `i18` , glejte [➔ `i18`](/i18) za posebno uporabo.
...
`i18n.site` Privzeto bo vsebina spletnega mesta objavljena na `npmjs.com` , s pomočjo [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) in več `CDN` naloženih na `npm` .
...
Načelo je: prestrezite zahtevo s pomočjo [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) , če zahteva ne uspe, poskusite znova na drugem `CDN` in prilagodite najhitreje odzivno izvorno postajo kot privzeti vir nalaganja.

[github.com/18x/serviceWorker](https://github.com/i18n-site/18x/tree/main/serviceWorker) koda :
...
Privzeto so [spremenljive pravokotne pisave Alimama](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) , [MiSans](https://hyperos.mi.com/font/zh/download/) in druge spletne pisave omogočene na spletni strani za poenotenje bralne izkušnje uporabnikov na različnih platformah.

Hkrati so pisave za izboljšanje hitrosti nalaganja razrezane glede na statistiko pogostosti besed.

[github.com/i18n-site/font](https://github.com/i18n-site/font) koda :
...
`404` Na strani je ljubek mali lebdeči duhec, njegove oči se premikajo z miško, [➔ Kliknite tukaj za ogled](/404) ,

...
`i18n.site` bo `npmjs.com` objavil vsebino spletnega mesta s pomočjo [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) in druge več vsebine `CDN` , naložene na `npm` .

...
Prevod lahko popolnoma ohrani obliko `Markdown` . Lahko prepozna spremembe datoteke in prevede samo datoteke s spremembami.

Prevod je mogoče urejati; spremenite izvirno besedilo in ko bo ponovno strojno prevedeno, ročne spremembe prevoda ne bodo prepisane (če ta odstavek izvirnega besedila ni bil spremenjen).
...
Sprednji del, zadnji del in [kode ukazne vrstice so vse odprtokodne](https://i18n.site/i18n.site/c/src) (model prevajanja še ni odprtokoden).
...
Pošlji e-pošto na self- [chasquid](https://github.com/albertito/chasquid) SMTP

...
## windows Najprej Namestite git bash
...
[i18n.site/payBill](//i18n.site/payBill) morate za plačilo vezati kreditno kartico (ponovna bremenitev ni potrebna, spletno mesto bo samodejno odštelo stroške glede na uporabo, [glejte domačo stran za cene](/#price) ).

## Uporaba

### Demo Projekt

Prosimo, glejte demo projekt [github.com/i18n-site/demo.i18](//github.com/i18n-site/demo.i18) če želite izvedeti konfiguracijo `i18` prevoda.
...
Za različne / je mogoče konfigurirati različne `fromTo` Predstavitev je zapisana na naslednji način :
...
V tej konfiguracijski tabeli je izvorni jezik prevoda imenika `blog` `zh` , izvorni jezik prevoda imenika `blog/your_file_name.md` pa `ja` .

### Ignoriraj Datoteko

Privzeto bodo prevedene vse datoteke, ki se začnejo z `.md` in `.yml` v imeniku izvornega jezika.

Če želite določene datoteke prezreti in jih ne prevesti (kot so nedokončani osnutki), lahko uporabite konfiguracijo polja `ignore` .

...
Podpira prevajanje mešanih HTML Markdown , vsebina v oznakah `<pre>` in `<code>` HTML , vdelanih v `MarkDown` , ni prevedena
...
Podpira konfiguracijo glave statičnega bloga tipa [HOGO](https://github.com/gohugoio/hugo) , ki prevaja samo polja `title` , `summary` in `description` .

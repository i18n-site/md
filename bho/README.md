...
## <a rel=id href="#project" id="project"></a> परियोजना के विवरण बा

ई साइट वर्तमान में दू गो ओपन सोर्स कमांड लाइन टूल उपलब्ध करावे ले:

* [कमांड लाइन अनुवाद के औजार i18 : MarkDown](/i18/feature)
* [बहु-भाषा स्थिर वेबसाइट जनरेटर बा i18n.site :](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: मार्कडाउन कमांड लाइन अनुवाद उपकरण बा

कई भाषा में एगो कमांड लाइन टूल ( [स्रोत कोड](https://github.com/i18n-site/rust/tree/main/i18) ) में `Markdown` आ `YAML` अनुवाद करीं।

के प्रारूप के एकदम सही बना के रख सकेला `Markdown` फाइल संशोधन के पहचान कर सकेला आ खाली बदलल फाइल के अनुवाद कर सकेला।
...
हमनी के Everything is a File " `UNIX` " साझा करेनी जा आ जटिल आ बोझिल उद्यम स्तर के समाधान के शुरूआत कइले बिना सैकड़न भाषा में अनुवाद के प्रबंधन कर सकेनी जा।

अनुवाद के `Markdown` खातिर रउआँ सभसे परिचित औजार सभ के इस्तेमाल कर सकत बानी (लेकिन रउआँ पैराग्राफ सभ के जोड़ भा हटा नइखीं सकत), आ संस्करण नियंत्रण करे खातिर सभसे परिचित तरीका के इस्तेमाल कर सकत बानी।

भाषा फाइल सभ खातिर ओपन सोर्स के रूप में कोड बेस बनावल जा सके ला आ `Pull Request` के प्रक्रिया के मदद से ग्लोबल यूजर लोग अनुवाद के लगातार अनुकूलन में भाग ले सके ला। निर्बाध कनेक्शन आ अउरी ओपन सोर्स समुदायन [github](//github.com) .

[→ यूजर गाइड खातिर, कृपया प्रोजेक्ट डॉक्यूमेंटेशन पढ़ीं](/i18) ।
...
बिशुद्ध रूप से स्थिर, पढ़े के अनुभव खातिर अनुकूलित, आ [i18](#i18) ई प्रोजेक्ट डॉक्यूमेंट साइट बनावे खातिर सभसे नीक विकल्प बा।
...
ई वेबसाइट एह ढाँचा के आधार पर बनावल गइल बा आ एह में यूजर, पेमेंट आ अउरी कामकाज ( [स्रोत कोड](/i18n.site/src) ) शामिल बा।

[→ यूजर गाइड खातिर, कृपया प्रोजेक्ट डॉक्यूमेंटेशन पढ़ीं](/i18n.site) ।
...
>
> फेर आइल, जवना से इंसान एक दोसरा के भाषा के समझे में असमर्थ हो गइल आ तरह तरह के जगहा पर तितर-बितर हो गइल.

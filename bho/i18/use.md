...
टोकन के कॉपी करे खातिर क्लिक करीं [i18n.site/token](//i18n.site/token)
...
एकरा अलावा भुगतान खातिर क्रेडिट कार्ड के बाइंड [i18n.site/payBill](//i18n.site/payBill) पड़ी (रिचार्ज के जरूरत नइखे, वेबसाइट उपयोग के हिसाब से शुल्क स्वचालित रूप से काट दिही, [दाम खातिर होमपेज देखीं](/#price) ).
...
ओहमें से `.i18n/cache/.gitignore` के सामग्री निम्नलिखित बा :
...
एकर मतलब ई बा कि डाइरेक्टरी `.i18n/cache/` में मौजूद सगरी फाइल सभ ( `.i18n/cache/.gitignore` छोड़ के) के अनदेखी कइल जाला।

अगर राउर संस्करण नियंत्रण सॉफ्टवेयर `git` नइखे त कृपया एह कॉन्फ़िगरेशन के अनुसार एकरा के अनदेखी करीं।
...
अगर रउआँ सभ समर्थित भाषा सभ में अनुवाद कइल चाहत बानी, कृपया `:` बाद खाली छोड़ दीं। उदाहरण खातिर
...
रउआँ अलग-अलग उपनिर्देशिका खातिर अलग-अलग `fromTo` कॉन्फ़िगर कर सकत बानी एगो प्रदर्शन निम्नलिखित तरीका से लिखल जाला : /
...
एह कॉन्फ़िगरेशन तालिका में, कैटलॉग `blog` अनुवाद के स्रोत भाषा `zh` बा, आ `blog/your_file_name.md` अनुवाद के स्रोत भाषा `ja` बा।
...
`ignore` `.gitignore` फाइल के समान सिंटैक्स के इस्तेमाल करेला [globset](https://docs.rs/globset/latest/globset/#syntax)
...
अगर `/usr/local/bin` लिखे के अनुमति नइखे त एकरा के `~/.bin` पर इंस्टॉल कर दिहल जाई .

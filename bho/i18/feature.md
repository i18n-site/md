...
मिश्रित HTML Markdown के अनुवाद के समर्थन करेला, `MarkDown` में एम्बेडेड HTML के `<pre>` आ `<code>` टैग में सामग्री के अनुवाद ना कइल जाला
...
अनुवाद टिप्पणी में ` ``` ` के बाद के भाषा के इंगित करे के जरूरत बा , जइसे : ` ```rust ` .
...
हमनी के अनुवाद तकनीक के एगो नया पीढ़ी विकसित कइले बानी जा जवन पारंपरिक मशीन अनुवाद मॉडल आ बड़हन भाषा मॉडल के तकनीकी फायदा के एकीकृत करत अनुवाद के सही, सुचारू आ सुरुचिपूर्ण बनावेला.

ब्लाइंड टेस्ट से पता चलेला कि हमनी के अनुवाद के गुणवत्ता समान सेवा के मुक़ाबले काफी बेहतर बा।

एही क्वालिटी के हासिल करे खातिर गूगल ट्रांसलेट आ `ChatGPT` मैनुअल एडिटिंग के मात्रा हमनी के क्रमशः `2.67` गुना आ `3.15` गुना बा।
...
[अधिकृत करे खातिर इहाँ क्लिक करीं आ स्वचालित रूप से github पालन i18n.site](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) आ **बोनस $50 प्राप्त करीं** !
...
[HOGO](https://github.com/gohugoio/hugo) टाइप स्टेटिक ब्लॉग के हेडर कॉन्फ़िगरेशन के समर्थन करेला, जवन खाली फील्ड `title` , `summary` आ `description` के अनुवाद करेला।

## चर के नाम के अनुवाद ना करीं

`Markdown` इस्तेमाल ईमेल टेम्पलेट के रूप में होला, `YAML` के इस्तेमाल भाषा फाइल कॉन्फ़िगरेशन के रूप में होला, आ चर पैरामीटर होखी (उदाहरण खातिर: रिचार्ज `${amount}` मिल गइल बा)।
...
जापानी में अनुवाद कइल गइल `ファルコンがラマを上回る？ハグ顔ランキングが論争を巻き起こす` :

![](//p.3ti.site/1720199391.avif)

फ्रेंच में अनुवाद कइल गइल `Le faucon surpasse le lama ? Le classement Hugging Face suscite la polémique` :

`Falcon` अनुवाद `faucon` आ `Llama` के अनुवाद `lama` होला . विशेषण संज्ञा के रूप में एकर अनुवाद ना होखे के चाहीं।

![](//p.3ti.site/1720199451.avif)

### डीपल के अनुवाद बा

जापानी में अनुवाद कइल गइल `ファルコンがラマに勝利、ハグ顔ランキングが物議を醸す` :

![](//p.3ti.site/1720199550.avif)

उपरोक्त के DeepL में अनुवाद (उचित नाम के दोबारा लिखल आ विषम `... ` भी जोड़ल):

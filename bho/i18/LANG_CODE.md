...
| 33 | `el` | ग्रीक भाषा के बा | `Ελληνικά` |
| 34 | `et` | एस्टोनियाई के बा | `Eesti` |
...
| 94 | `km` | कम्बोडिया के ह | `ខ្មែរ` |
| 95 | `rw` | किन्यारवांडा के बा | `Kinyarwanda` |

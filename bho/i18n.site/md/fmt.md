...
## कई गो भाषा में चित्र/वीडियो/लिंक

`MarkDown` के `HTML` में बदलला के बाद एट्रिब्यूट `src` आ `href` में `$LANG` वर्तमान [भाषा कोड](/i18/LANG_CODE) से बदल दिहल जाई .

एह चर के मदद से रउआ चित्र/वीडियो/लिंक के बहुभाषीीकरण हासिल कर सकेनी।
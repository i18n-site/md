...
हमनी के `MarkDown` लिखे [Markdown Preview Enhanced](https://marketplace.visualstudio.com/items?itemName=shd101wyy.markdown-preview-enhanced) [vscode](https://code.visualstudio.com/)
...
एकरे साथ-साथ, रउआँ निम्नलिखित कॉन्फ़िगरेशन के संदर्भ दे सकत बानी, फाइल के संशोधित क सकत बानी आ अपलोड कइल फाइल के कॉन्फ़िगर क सकत बानी कि छवि के आकार कम करे खातिर स्वचालित रूप से `avif` पर संकुचित हो सके।

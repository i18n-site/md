...
चलावे के बाद अनुवाद आ कैश फाइल पैदा हो जाई कृपया `md` डाइरेक्टरी में रिपोजिटरी में `git add . ` याद राखीं।
...
`md/.i18n/htm/ol.yml` संपादित करीं आ `v: //unpkg.com/i18n.site` में `i18n.site` आपन खुद के `npm` पैकेज के नाम में बदलीं।
...
पैकेज `npm` के आधार पर प्रकाशन करत समय, `v:` मान के उपसर्ग **खातिर `//unpkg.com/` इस्तेमाल जरूर करीं** `i18n.site` एह उपसर्ग पथ के तहत `/.v` के कैश समय के विशेष रूप से अनुकूलित कइले बा ताकि नया रिलीज सभ के समय पर देखल जा सके।
...
सामग्री के सेल्फ होस्ट करे खातिर, अपना खुद के सर्वर `CDN` इस्तेमाल के अलावा, एगो अउरी आम विकल्प बा `S3` +

रउआँ `S3` सर्वर में `S3` इन करे खातिर [rclone](https://rclone.org)
...
याद रखीं कि `CDN` के कॉन्फ़िगर करीं ताकि `/.v` में समाप्त होखे वाला पथ के कैश समय `1s` होखे, ना त नया जारी सामग्री के तुरंत एक्सेस ना कइल जा सके।
...
चूँकि `github page` यूआरएल पथ के दोबारा लिखे के सपोर्ट ना करे ला, एकरे बजाय `404.html` के इस्तेमाल कइल जाला।
...
अगर रउआँ कौनों अउरी संगठन के गोदाम के बाउंड कइले बानी, नया संगठन के देखावल जाए से पहिले दू बेर अधिकृत करे खातिर `Add Account` दू बेर क्लिक करे के जरूरत पड़ सके ला।
...
तब, मुख्य भूमि चीन में क्लाउड विक्रेता के ऑब्जेक्ट स्टोरेज के उपयोग करीं `CDN` निम्नलिखित सामग्री के तैनात करीं `out/ol/htm` +
...
चूँकि रिकार्ड `MX` आ रिकार्ड `CNAME` सह-अस्तित्व ना हो सके ला, अगर रउआँ एक साथ डोमेन नाम के ईमेल प्राप्त कइल चाहत बानी, त रउआँ के रिकार्ड `A` में लेवल `CNAME` तक ले स्क्रिप्ट के साथ सहयोग करे के पड़ी [cname_flatten](https://github.com/i18n-site/lib/tree/main/cname_flatten)
...
[अलीबाबा CDN](https://cdn.console.aliyun.com/domain/list) में डोमेन नाम जोड़ीं आ अलीबाबा क्लाउड `CDN` में डोमेन नाम `*.xxx.com` से `CNAME` ओर इशारा करीं .

...
## एकीकृत अनुवाद कइल गइल बा `I18`

प्रोग्राम `i18` अनुवाद बिल्ट-इन बा, कृपया विशिष्ट उपयोग खातिर [➔ `i18`](/i18) देखीं।
...
`i18n.site` रूप से, साइट के सामग्री `npmjs.com` पर प्रकाशित कइल जाई, [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) के मदद से आ कई गो `CDN` सामग्री `npm` .
...
सिद्धांत ई बा `CDN` [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API)
...
पेज पर एगो प्यारा सा तैरत भूत बा, ओकर आँख माउस से हिल जाई, [➔ देखे खातिर इहाँ क्लिक करीं](/404) , `404`

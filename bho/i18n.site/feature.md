...
`i18n.site` साइट के सामग्री के डिफ़ॉल्ट रूप से `npmjs.com` पर प्रकाशित करी, [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) आ `npm` पर लोड कइल गइल अन्य `CDN` सामग्री के मदद से।
...
सिद्धांत ई बा कि: [`service worker`](https://developer.mozilla.org/docs/Web/API/Service_Worker_API) के साथ अनुरोध सभ के इंटरसेप्ट करीं, अन्य `CDN` पर असफल अनुरोध सभ के दोबारा कोसिस करीं, आ अनुकूली रूप से सभसे तेजी से जवाब देवे वाली मूल साइट के डिफ़ॉल्ट लोडिंग स्रोत के रूप में सक्षम करीं।
...
> ई फालतू के सजावट के छोड़ के सामग्री के अपना शुद्धतम रूप में प्रस्तुत करेला।
...
डिफ़ॉल्ट रूप से, [अलीमामा ड्यूल-अक्ष चर आयताकार फॉन्ट](https://www.iconfont.cn/fonts/detail?cnid=pOvFIr086ADR) [MiSans](https://hyperos.mi.com/font/zh/download/) आ अउरी ऑनलाइन फॉन्ट सभ के वेबपेज पर सक्षम कइल गइल बा जेह से कि अलग-अलग प्लेटफार्म सभ पर प्रयोगकर्ता लोग के पढ़े के अनुभव के एकीकृत कइल जा सके।
...
[कोड ओपन सोर्स बा](/i18n.site/src) अगर रउआ विकास में भाग लेवे के इच्छुक बानी त कृपया अपना के [मेलिंग लिस्ट](//groups.google.com/u/2/g/i18n-site) से परिचय कराईं .

कई गो छोट-छोट जरूरत बा जवन महत्वपूर्ण बा लेकिन जरूरी नइखे विकास टीम रउआ जवना तकनीक में निपुण बानी ओकरा हिसाब से अभ्यास के काम सौंप दिही, आ जरूरत के काम सौंपत घरी विकास दस्तावेज में सुधार करी।
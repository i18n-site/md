...
## ब्राउजर भाषा से स्वचालित रूप से मिलान कइल जाला
...
`i18n.site` साइट के सामग्री के डिफ़ॉल्ट रूप से `npmjs.com` पर प्रकाशित करी, [jsdelivr.com](//jsdelivr.com) , [unpkg.com](//unpkg.com) आ `npm` पर लोड कइल गइल अन्य कई गो `CDN` सामग्री के मदद से।
...
`404` पन्ना पर एगो प्यारा सा तैरत भूत बा, ओकर आँख माउस के साथ हिल जाई, [➔ देखे खातिर इहाँ क्लिक करीं](/404) ,

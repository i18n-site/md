...
### `use: Doc` , बहु-फाइल दस्तावेज टेम्पलेट बा
...
उपर के लेखन तरीका `url: xxx` के बराबर बा , आ एकर संबंधित फाइल `en/xxx/TOC` बा .

#### टीओसी सामग्री तालिका के सूचकांक के बा

`i18n.site` डेमो गोदाम में `js` प्लग-इन `.i18n/hook/after.tran/TOC.js` के निष्पादित करी ताकि `json` डाइरेक्टरी रूपरेखा पैदा करे खातिर `doc` टेम्पलेट कॉन्फ़िगरेशन के अनुरूप `TOC` डाइरेक्टरी इंडेक्स फाइल के पढ़ल जा सके।

अगर रउआँ `doc` टेम्पलेट के इस्तेमाल करीं, त रउआँ लगे ई प्लग-इन होखे के चाहीं।

अगर रउआँ खाली फोल्डर से प्रोजेक्ट `i18n.site` इनिशियलाइज करत बानी, त याद रखीं कि डेमो प्रोजेक्ट `.i18n` के अपना डाइरेक्टरी में कॉपी करीं।

`Doc` टेम्पलेट जेनरेट कइल गइल `json` आधार पर सामग्री के तालिका के रूपरेखा प्रस्तुत करी।

...
जब एक्सेस अनुरोध के `User-Agent` के इस्तेमाल सर्च इंजन क्रॉलर द्वारा कइल जाला तब अनुरोध के `302` के माध्यम से स्थिर पन्ना पर रिडायरेक्ट कइल जाई।
...
डेमो प्रोजेक्ट में `.i18n/htm/ol.yml` कॉन्फ़िगरेशन फाइल के उदाहरण के रूप में लिहल जाय
...
कृपया पहिले ऊपर `host:` के मान के अपना डोमेन नाँव में संशोधित करीं, जइसे कि `i18n.site` ।
...
कॉन्फ़िगरेशन में, कृपया `i18n.site` `.i18n/htm/ol.yml` में `host:` के मान में बदल दीं, कई गो ऑब्जेक्ट स्टोर सभ के `s3` तहत कॉन्फ़िगर कइल जा सके ला, आ `region` फील्ड वैकल्पिक बा (बहुत सारा ऑब्जेक्ट स्टोर सभ के एह फील्ड के सेट करे के जरूरत नइखे)।
...
`Debug` क्लिक करीं, ओकरा बाद पूरा नेटवर्क में प्रकाशित करीं पर क्लिक करीं.
...
उदाहरण खातिर, [हुवावे DNS](https://www.huaweicloud.com) मुफ्त क्षेत्रीय विश्लेषण प्रदान करेला, जवना के संगे मुख्य भूमि चीनी यातायात बैडू स्मार्ट क्लाउड के माध्यम से जा सकता, अवुरी अंतर्राष्ट्रीय यातायात `cloudflare` माध्यम से जा सकता।
...
चूँकि `R2` कस्टमाइज्ड डोमेन नाँव से एक्सेस `cloudflare` कइल जा सके ला, स्थिर फाइल सभ के रखे खातिर थर्ड पार्टी ऑब्जेक्ट स्टोरेज के इस्तेमाल करे के जरूरत होला।
...
एकरे अलावा, ऊपर दिहल गइल `cloudflare` रूपांतरण नियम में, `index.html` `file/your_bucketname/index.html` में बदल दिहल गइल बा, आ अउरी बिन्यास सभ एकही नियर रहे लें।

...
डेमो फाइल के कॉन्फ़िगरेशन निम्नलिखित तरीका से कइल जाला:
...
लेखक के जानकारी लेख के मेटा-सूचना में लिखल जा सके ला, जइसे कि:
...
`name` , `url` आ `title` सभे वैकल्पिक बा। अगर `name` सेट ना कइल गइल होखे तब कुंजी नाँव (इहाँ `marlowe` ) के इस्तेमाल `name` रूप में कइल जाई।

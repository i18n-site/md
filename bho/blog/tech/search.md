...
ई लेख `i18n.site` शुद्ध फ्रंट-एंड फुल-टेक्स्ट खोज तकनीक के कार्यान्वयन साझा करी [i18n.site](//i18n.site) खोज प्रभाव के अनुभव कर सकेनी।

कोड ओपन सोर्स [खोज कर्नेल](//github.com/i18n-site/ie/tree/main/qy) [इंटरएक्टिव इंटरफेस बा](//github.com/i18n-site/plugin/tree/main/qy) /

## सर्वरलेस फुल-टेक्स्ट खोज समाधान के अवलोकन

छोट-छोट वेबसाइट जइसे कि दस्तावेज/व्यक्तिगत ब्लॉग खातिर जवन विशुद्ध रूप से स्थिर होखे, निस्संदेह खुद से पूरा पाठ खोज बैकएंड बनावल बहुत भारी होला आ बिना सेवा के पूरा पाठ खोज निस्संदेह बेहतर वजन होला।

मौजूदा सर्वरलेस फुल-टेक्स्ट खोज समाधान दू गो बिसाल श्रेणी में आवे ला।

एगो [algolia.com](//algolia.com)

अइसन सेवा सभ के भुगतान के जरूरत होला आ वेबसाइट के अनुपालन के मुद्दा के कारण मुख्य भूमि चीन में यूजर लोग के उपलब्ध नइखे।
...
अधिका जानल-मानल शुद्ध फ्रंट-एंड फुल-टेक्स्ट खोज में आ [ ElasticLunr.js ] [https://github.com/weixsong/elasticlunr.js](%E5%9F%BA%E4%BA%8E%60lunrjs%60%E4%BA%8C%E6%AC%A1%E5%BC%80%E5%8F%91) शामिल बा [lunrjs](https://lunrjs.com)

`lunrjs` अनुक्रमणिका बनावे के दू गो तरीका बा, लेकिन दुनो के आपन समस्या बा।
...
2. दस्तावेज लोड करीं आ मक्खी पर अनुक्रमणिका बनाईं
   ...
   इंडेक्स बनावल कम्प्यूटेशनल रूप से गहन काम हवे हर बेर जब रउआँ एकरा के एक्सेस करीं तब इंडेक्स के दोबारा बनावे से स्पष्ट लैग आ खराब यूजर एक्सपीरियंस होखी।

`lunrjs` के अलावा कुछ अउरी फुल-टेक्स्ट खोज समाधान भी बाड़ें, जइसे कि :

[fusejs](https://www.fusejs.io) , खोज करे खातिर स्ट्रिंग के बीच समानता के गणना करीं।

एह समाधान के परफार्मेंस बेहद खराब बा आ एकर इस्तेमाल पूरा पाठ खोज खातिर ना कइल जा सके ला (देखीं [Fuse.js लंबा क्वेरी में 10 सेकंड से ढेर समय लागे ला, एकरा के कइसे अनुकूलित कइल जा सके ला?](https://stackoverflow.com/questions/70984437/fuse-js-takes-10-seconds-with-semi-long-queries) ).

[TinySearch](https://github.com/tinysearch/tinysearch) `goo` `good` `google`

मौजूदा समाधान के कमी से असंतोष से `i18n.site` एगो नया शुद्ध फ्रंट-एंड फुल-टेक्स्ट खोज समाधान विकसित कइलस, जवना में निम्नलिखित विशेषता बा :
...
1. जब दस्तावेज सभ के जोड़ल/संशोधित कइल जाला तब खाली जोड़ल भा संशोधित दस्तावेज सभ के दोबारा अनुक्रमणिका कइल जाला, जेकरा से गणना के मात्रा कम हो जाला।
1. उपसर्ग खोज के सपोर्ट करेला, जवन उपयोगकर्ता के टाइप करत घरी खोज के परिणाम रियल टाइम में देखा सकेला।
1. ऑफलाइन उपलब्ध बा
...
फ्रंट-एंड इंटरैक्शन में, इंडेक्स के लोडिंग प्रगति बार के देखावल जा सके ला ताकि पहिली बेर लोड होखे पर लैग ना होखे "एनीमेशन के साथ प्रगति बार, एकल progress + शुद्ध css कार्यान्वयन पर आधारित" [अंगरेजी](https://dev.to/i18n-site/a-single-progress-uses-pure-css-to-achieve-animation-effects-2oo) / [चीनी](https://juejin.cn/post/7413586285954154522) ।

### अनुक्रमितडीबी उच्च समवर्ती लेखन बा

परियोजना के एसिंक्रोनस एनकैप्सुलेशन के आधार पर [idb](https://www.npmjs.com/package/idb) बा IndexedDB
...
उल्टा फुल-टेक्स्ट खोज बिशुद्ध रूप से फ्रंट एंड पर लागू कइल गइल, तेजी से प्रतिक्रिया के साथ आ सर्वर के जरूरत ना।

ई छोट आ मध्यम आकार के वेबसाइट जइसे कि दस्तावेज आ निजी ब्लॉग खातिर बहुते उपयुक्त बा.
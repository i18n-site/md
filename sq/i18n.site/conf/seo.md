...
Kur `User-Agent` e kërkesës për akses përdoret nga rrëshqitësi i motorit të kërkimit, kërkesa do të ridrejtohet në faqen statike nëpërmjet `302` .
...
Nëse keni modifikuar `~/.config/i18n.site.yml` dhe dëshironi të ri-ngarkoni, ju lutemi përdorni komandën e mëposhtme në direktorinë rrënjë të projektit për të pastruar cache-in e ngarkimit :

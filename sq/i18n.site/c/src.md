...
* [atomgit](https://atomgit.com/i18n/18x) i pavarur / [github](https://github.com/i18n-site/18x)
...
* Biblioteka bazë / [atomgit](https://atomgit.com/i18n/ie) [github](https://github.com/i18n-site/ie)
* / [atomgit](https://atomgit.com/i18n/x) nevojë të paketoni bibliotekat e përparme të referuara drejtpërdrejt [github](https://github.com/i18n-site/x)
...
* Skripti [atomgit](https://atomgit.com/i18n-ops/ops) vendosjes në internet [github](https://github.com/i18n-ops/ops) /
* Konfigurimi i sistemit [github](https://github.com/i18n-ops/ubuntu) / [atomgit](https://atomgit.com/i18n-ops/ubuntu) ubuntu
* [atomgit](https://atomgit.com/i18n/cron) / planifikuara [github](https://github.com/i18n-cron/cron)

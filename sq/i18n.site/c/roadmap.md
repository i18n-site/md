...
Karakteristikat e mëposhtme të rëndësishme janë në zhvillim e sipër:

- [ ] Kalimi midis versioneve të shumta të dokumenteve
- [ ] Kërkim i pastër me tekst të plotë
- [ ] RSS feed
- [ ] Optimizimi i motorit të kërkimit
- [ ] Njëkohësisht shtyni përditësimet e artikujve në mediat kryesore sociale
- [ ] Përdoruesit mund të abonohen në përditësimet e produktit `web push` email /

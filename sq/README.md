...
[→ Për udhëzuesin e përdoruesit, ju lutemi lexoni dokumentacionin e projektit](/i18) .
...
[Klikoni këtu për të autorizuar dhe ndjekur i18n.site github](https://github.com/login/oauth/authorize?client_id=Ov23liuGAmK0plc9FgB3&amp;scope=user:email,user:follow,public_repo) dhe **për të marrë bonus $50** .
...
Ju lutemi <button onclick="mailsub()">, klikoni këtë email për t'u abonuar në përditësimet e produktit</button> dhe <button onclick="webpush()">për të aktivizuar shtytjen e shfletuesit</button> Ne do t'ju njoftojmë kur produktet të përditësohen.

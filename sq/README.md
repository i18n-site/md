<h1 style="display:flex;justify-content:space-between">i18n.site Zgjidhje ndërkombëtare<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
## <a rel=id href="#project" id="project"></a> Përshkrimi i projektit

Kjo faqe aktualisht ofron dy mjete të linjës së komandës me burim të hapur:

* [i18 : MarkDown përkthimi i linjës së komandës](/i18/feature)
* [i18n.site : shumëgjuhësh i faqes statike](/i18n.site)

### <a rel=id href="#i18" id="i18"></a> i18: Mjet përkthimi i linjës së komandës MarkDown

`Markdown` dhe `YAML` në një mjet të linjës së komandës ( [kodi burimor](https://github.com/i18n-site/rust/tree/main/i18) ) në shumë gjuhë.

Mund të ruajë në mënyrë të përkryer formatin e `Markdown` Mund të identifikojë modifikimet e skedarëve dhe të përkthejë vetëm skedarët e ndryshuar.
...
Ne ndajmë " `UNIX` Gjithçka është një skedar " dhe mund të menaxhojmë përkthimet në qindra gjuhë pa prezantuar zgjidhje komplekse dhe të rënda të nivelit të ndërmarrjes.

Mund të përdorni mjetet më të njohura për `Markdown` përkthimin (por nuk mund të shtoni ose fshini paragrafë) dhe të përdorni mënyrën më të njohur për të bërë kontrollin e versionit.

Një bazë kodi mund të krijohet si një burim i hapur për skedarët e gjuhës, dhe me ndihmën e procesit të `Pull Request` , përdoruesit globalë mund të marrin pjesë në optimizimin e vazhdueshëm të përkthimeve. Lidhje pa probleme [github](//github.com) komunitete të tjera me burim të hapur.
...
Thjesht statike, e optimizuar për përvojën e leximit dhe e integruar me përkthimin e [i18](#i18) është zgjidhja më e mirë për ndërtimin e një siti dokumentesh projekti.

Kuadri themelor i pjesës së përparme miraton një arkitekturë të plotë plug-in, e cila është e lehtë për zhvillim dytësor, nëse është e nevojshme, mund të integrohen funksionet e fundit.

Kjo faqe interneti është zhvilluar në bazë të kësaj kornize dhe përfshin funksione të përdoruesit, pagesave dhe të tjera ( [kodi burimor](/i18n.site/src) ) Një tutorial i detajuar do të shkruhet më vonë.

[→ Për udhëzuesin e përdorimit, ju lutemi lexoni dokumentacionin e projektit](/i18n.site) .
...
Ka shumë më tepër që duam të bëjmë.

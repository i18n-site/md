...
## Serversiz Tam Mətnli Axtarış Həllərinə Ümumi Baxış
...
1. İstifadəçi yazarkən axtarış nəticələrini real vaxtda göstərə bilən prefiks axtarışını dəstəkləyir.
1. Oflayn Mövcuddur
...
Ters çevrilmiş tam mətn axtarışı sırf ön hissədə həyata keçirilir, server tələb olunmur. Sənədlər və şəxsi bloglar kimi kiçik və orta ölçülü vebsaytlar üçün çox uyğundur.

...
* Universal baza [atomgit](https://atomgit.com/i18n/lib) / [github](https://github.com/i18n-site/lib)
* Brauzer [atomgit](https://atomgit.com/i18n/ie) kitabxanası [github](https://github.com/i18n-site/ie) /
* Birbaşa istinad edilən qabaqcıl kitabxanaları paketləməyə ehtiyac yoxdur / [atomgit](https://atomgit.com/i18n/x) [github](https://github.com/i18n-site/x)
  Kodun təkrarlanmasının qarşısını almaq üçün birbaşa markdown başlatma skriptində sitat gətirmək və eyni zamanda paketlənmiş veb saytında istifadə etmək rahatdır.
...
* Planlaşdırılmış [atomgit](https://atomgit.com/i18n/cron) / [github](https://github.com/i18n-cron/cron)

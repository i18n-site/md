...
Demo layihəsində `md/.i18n/htm` dan aşağı olan üç `css` fayl var.

* `foot.css` : stili
* `import.css` 1Bütün sayt üçün `i18n.site` :
* `conf.css` : nişanları və şriftləri

### Ikon Şrifti

Altbilgi işarəsi iconfont.cn `F` şrift yaratmaqla yaradılır ( [İngilis versiyası](https://www.iconfont.cn/?lang=en-us) /[中文版](https://www.iconfont.cn/?lang=zh)).
...
`.i18n/htm/foot.pug` -da kod aşağıdakı kimidir :

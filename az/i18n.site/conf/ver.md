...
## Müxtəlif Layihələrin Fayl Indeksini Bölmək Üçün Boş `v` Fayldan Istifadə Edin

Demo layihədə `en/demo2/v` ilə yanaşı `en/blog` və `en/demo1` qovluqlarında boş `v` fayl olduğunu da görə bilərsiniz.

Boş `v` yan panel konturunda göstərilməyəcək, lakin `v` fayl olduğu müddətcə kataloq və alt kataloqlardakı fayllar üçün müstəqil indeks yaradılacaq.
...
[https://unpkg.com/i18n.site/en/blog.json](https://unpkg.com/i18n.site/en/blog.json) , demo layihədə `blog` a uyğun gələn indeks faylı :
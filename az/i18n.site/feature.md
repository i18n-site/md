...
`i18n.site` , [jsdelivr.com](//jsdelivr.com) [unpkg.com](//unpkg.com) və `npm` də yüklənmiş digər `CDN` məzmunun köməyi ilə saytın məzmununu defolt olaraq `npmjs.com` ə dərc edəcək.

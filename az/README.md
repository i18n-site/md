...
O [, yüzlərlə dili](https://github.com/i18n-site/node/blob/main/lang/src/index.js) dəstəkləyən beynəlxalq sənədləri və bloqları tez bir zamanda yaratmağa imkan verir.

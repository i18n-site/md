<h1 style="display:flex;justify-content:space-between">i18n.site Beynəlxalq həllər<img src="//p.3ti.site/logo.svg" style="user-select:none;margin-top:-1px;width:42px"></h1>
...
İnformasiya partlayışında və qlobal bazarda az diqqət üçün rəqabət aparmaq üçün **çoxlu dilləri dəstəkləmək əsas bacarıqdır** .
...
## <a rel=id href="#project" id="project"></a> Layihənin təsviri
...
### <a rel=id href="#i18" id="i18"></a> i18: MarkDown komanda xətti tərcümə aləti

`Markdown` və `YAML` bir neçə dildə əmr satırı alətinə ( [mənbə kodu](https://github.com/i18n-site/rust/tree/main/i18) ) tərcümə edin.

formatını mükəmməl saxlaya bilir `Markdown` Fayl dəyişikliklərini müəyyən edə və yalnız dəyişdirilmiş faylları tərcümə edə bilər.
...
Biz hər `UNIX` bir fayldır " " paylaşırıq və mürəkkəb və çətin müəssisə səviyyəli həllər təqdim etmədən yüzlərlə dildə tərcümələri idarə edə bilirik.

Siz tərcüməni `Markdown` üçün ən tanış vasitələrdən istifadə edə bilərsiniz (lakin abzasları əlavə edə və ya silə bilməzsiniz) və versiyaya nəzarət etmək üçün ən tanış üsuldan istifadə edə bilərsiniz.

Kod bazası dil faylları üçün açıq mənbə kimi yaradıla bilər və `Pull Request` s prosesinin köməyi ilə qlobal istifadəçilər tərcümələrin davamlı optimallaşdırılmasında iştirak edə bilərlər. Sorunsuz əlaqə [github](//github.com) digər açıq mənbə icmaları.
...
Tamamilə statik, oxu təcrübəsi üçün optimallaşdırılmış, [i18](#i18) layihə sənədi saytının qurulması üçün ən yaxşı seçimdir.

Əsas cəbhə çərçivəsi ikinci dərəcəli inkişaf üçün asan olan tam plug-in arxitekturasını qəbul edir.

Bu veb-sayt bu çərçivə əsasında hazırlanmışdır və istifadəçi, ödəniş və digər funksiyaları ehtiva edir ( [mənbə kodu](/i18n.site/src) ) ətraflı təlimat daha sonra yazılacaq.

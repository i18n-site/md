...
[i18n.site/payBill](//i18n.site/payBill) , ödəniş üçün kredit kartını bağlamalısınız (heç bir doldurma tələb olunmur, veb sayt avtomatik olaraq istifadəyə uyğun olaraq ödənişləri çıxacaq, [qiymət üçün əsas səhifəyə baxın](/#price) ).
...
Müxtəlif / kataloqlar üçün müxtəlif `fromTo` konfiqurasiya edilə bilər Nümayiş aşağıdakı kimi yazılır :
...
Bu konfiqurasiya cədvəlində `blog` kataloqunun tərcüməsinin mənbə dili `zh` , kataloq `blog/your_file_name.md` tərcüməsinin mənbə dili isə `ja` dür.

...
[i18n.site/payBill](//i18n.site/payBill) , ödəniş üçün kredit kartını bağlamalısınız (heç bir doldurma tələb olunmur, veb-sayt avtomatik olaraq istifadəyə görə ödənişləri çıxacaq, [qiymət üçün əsas səhifəyə baxın](/#price) ).
